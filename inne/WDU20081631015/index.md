...
- **2)** w art. 28: ust. 1 i 2 otrzymują brzmienie: „
    - **a)**
...
- **3)** w art. 32: w ust. 3 pkt 2 otrzymuje brzmienie: „
    - **a)**

- **2)** ubezpieczenia w instytucji ubezpieczeniowej członków ochotniczej straży pożarnej i młodzieżowej drużyny pożarniczej; ubezpieczenie może być imienne lub zbiorowe nieimienne. ” , ust. 3a otrzymuje brzmienie: „
    - **b)**

3a. Wójt (burmistrz, prezydent miasta) może zatrudnić komendanta gminnego ochrony przeciwpożarowej. Na stanowisku komendanta gminnego ochrony przeciwpożarowej może być także zatrudniony komendant gminny związku ochotniczych straży pożarnych. ” , po ust. 3a dodaje się ust. 3b w brzmieniu: „
...
- **2)** w art. 13: w ust. 6 po pkt 8 dodaje się pkt 8a w brzmieniu: „
    - **a)**

- **8a)** współdziałanie z komendantem gminnym związku ochotniczych straży pożarnych; ” , w ust. 7 pkt 1 otrzymuje brzmienie: „
    - **b)**
...
- **2)** w art. 95a: ust. 1 otrzymuje brzmienie: „
    - **a)**

1. Kierującym pojazdem uprzywilejowanym może być osoba, z zastrzeżeniem ust. 2–4, która:

- **1)** ukończyła 21 lat;
- **2)** posiada zaświadczenie wydane przez pracodawcę, potwierdzające jej zatrudnienie oraz spełnienie wymagań w zakresie badań lekarskich, o których mowa w art. 122 ust. 2, i psychologicznych, o których mowa w art. 124 ust. 2. ” , dodaje się ust. 4 w brzmieniu: „
    - **b)**
