...
- **7)** w art.15: 1) składniki majątkowe uznawane za środki trwałe oraz wartości niematerialne i prawne, sposób ustalania ich wartości początkowej, szczegółowe zasady i stawki amortyzacji, a także tryb i terminy aktualizacji wyceny środków trwałych, 2) szczegółowe zasady i tryb: a) zaliczania składników majątkowych do środków trwałych albo wartości niematerialnych i prawnych, a także zmniejszania kosztów uzyskania przychodów, w przypadku gdy składniki te, ze względu na przewidywany okres używania, nie zostały uprzednio zaliczone do tych środków albo wartości, b) naliczania odsetek za okres, w którym składniki majątkowe określone pod lit. a) nie były zaliczone do środków trwałych albo wartości niematerialnych i prawnych.",
