...
- **2)** w art. 5a:
    ...
    - **b)** w ust. 4 pkt 8 otrzymuje brzmienie: „8) wysokość środków planowanych na realizację programu;”;
...
- **7)** w art. 15:
    ...
    - **b)** po ust. 2d dodaje się ust. 2da w brzmieniu:
      ...
      > 1) żadna organizacja nie wskaże osób do składu komisji konkursowej lub 2) wskazane osoby nie wezmą udziału w pracach komisji konkursowej, lub 3) wszystkie powołane w skład komisji konkursowej osoby podlegają wyłączeniu na podstawie art. 15 ust. 2d lub art. 15 ust. 2f.”,  
...
- **11)** po art. 22 dodaje się art. 22a w brzmieniu:
  ...
  > a) na wniosek ministra właściwego do spraw zabezpieczenia społecznego, b) z urzędu przez właściwy sąd rejestrowy.  
...
- **16)** w art. 45 ust. 3 otrzymuje brzmienie: „3. Korzystający może pokrywać koszty szkoleń wolontariuszy w zakresie wykonywanych przez nich świadczeń określonych w porozumieniu, o którym mowa w art. 44 ust. 1.”.
