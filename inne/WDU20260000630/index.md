---
title: Rozporządzenie Ministra Nauki i Szkolnictwa Wyższego z dnia 30 kwietnia 2026 r. w sprawie sporządzania wykazu wydawnictw monografii naukowych oraz wykazu czasopism naukowych i recenzowanych materiałów z konferencji międzynarodowych
address: WDU20260000630
eli: DU/2026/630
publisher: DU
year: 2026
pos: 630
...
# RZECZYPOSPOLITEJ POLSKIEJ Poz. 630 ROZPORZĄDZENIE MINISTRA NAUKI I SZKOLNICTWA WYŻSZEGO z dnia 30 kwietnia 2026 r.

| Pole | Wartość |
|---|---|
| Adres publikacyjny | Dz.U. 2026 poz. 630 |
| ISAP | WDU20260000630 |
...
| Źródło | [ISAP](https://isap.sejm.gov.pl/isap.nsf/DocDetails.xsp?id=WDU20260000630) · [PDF](https://api.sejm.gov.pl/eli/acts/DU/2026/630/text.pdf) |

w sprawie sporządzania wykazu wydawnictw monografii naukowych oraz wykazu czasopism naukowych i recenzowanych materiałów z konferencji międzynarodowych Na podstawie art. 267 ust. 2 pkt 2 ustawy z dnia 20 lipca 2018 r. – Prawo o szkolnictwie wyższym i nauce (Dz. U.
z 2024 r. poz. 1571, z późn. zm. ) zarządza się, co następuje:

**§ 1.** Rozporządzenie określa sposób sporządzania:

- **1)** wykazu wydawnictw publikujących recenzowane monografie naukowe, zwanych dalej „wydawnictwami”,
- **2)** wykazu czasopism naukowych i recenzowanych materiałów z konferencji międzynarodowych, o których mowa w art. 265 ust. 9 pkt 2 ustawy z dnia 20 lipca 2018 r. – Prawo o szkolnictwie wyższym i nauce, zwanego dalej „wykazem czasopism” – oraz ustalania i przypisywania im liczby punktów.

**§ 2.**

1. W celu sporządzenia projektu wykazu wydawnictw Komisja Ewaluacji Nauki, zwana dalej „KEN”, po zasięgnięciu opinii komitetów naukowych, o których mowa w art. 34 ustawy z dnia 30 kwietnia 2010 r. o Polskiej Akademii Nauk (Dz. U. z 2026 r. poz. 168), sporządza trzy listy.
...
1. KEN sporządza projekt wykazu wydawnictw i przypisuje wydawnictwom ujętym na liście, o której mowa w § 2:
...
**§ 4.** Minister sporządza wykaz wydawnictw na podstawie projektu wykazu wydawnictw przekazanego przez KEN.

**§ 5.** W wykazie wydawnictw ujmuje się:
...
- **1)** czasopisma naukowe, które zostały ujęte w:
    ...
    - **b)** którymkolwiek z następujących indeksów bazy Web of Science: – Science Citation Index Expanded, – Social Sciences Citation Index, – Arts & Humanities Citation Index, – Emerging Sources Citation Index;
...
**§ 7.** Do celów związanych ze sporządzaniem wykazu czasopism czasopisma naukowe ocenia się w dyscyplinach naukowych.

**§ 8.**

1. Czasopisma naukowe ocenia się w dwóch etapach.
...
1. Ocena bibliometryczna czasopism naukowych, o których mowa w § 6 ust. 1 pkt 1, jest dokonywana w oparciu o wartości centylowe wyliczone na podstawie wartości wskaźników wpływu.
...
1. KEN wybiera wskaźnik wpływu spośród wskaźników, o których mowa w § 9 ust. 2, i ustala w przypadku wyboru:
...
1. Ekspert dokonuje wstępnej selekcji czasopism naukowych, o których mowa w § 6 ust. 2, posiadających krajową i międzynarodową renomę, wywierających szczególny wpływ na rozwój danej dyscypliny naukowej oraz spełniających etyczne i naukowe standardy, proponowanych do ujęcia w wykazie czasopism w ramach reprezentowanej przez siebie dyscypliny naukowej i dla każdego z tych czasopism sporządza uzasadnienie obejmujące ocenę spełniania przez nie tych wymagań.
...
1. Ekspert dokonuje wyboru czasopism naukowych proponowanych do zakwalifikowania do oceny eksperckiej spośród czasopism naukowych, które zostały zaproponowane do przypisania do reprezentowanej przez niego dyscypliny naukowej.
...
1. KEN przekazuje listę, o której mowa w § 12 ust. 8, ekspertom.
...
1. W przypadku przypisania czasopismu naukowemu zgodnie z § 13 ust. 5 lub 6 różnej liczby punktów w ramach poszczególnych dyscyplin naukowych, do których KEN zaproponowała przypisać to czasopismo, KEN:
...
- **1)** przypisuje materiałom z konferencji:
    ...
    - **e)** 20 punktów, jeżeli konferencja naukowa posiada kategorię Australasian albo Regional – według International CORE Conference Rankings: ICORE;
...
1. KEN sporządza projekt wykazu czasopism, zamieszczając w nim:

- **1)** czasopisma naukowe, którym przypisano punkty zgodnie z:
    - **a)** § 10 ust. 2 i 3,
    - **b)** § 11 ust. 4 – z uwzględnieniem zmian przypisanej punktacji dokonanych zgodnie z § 13 ust. 5 i 6, § 14 ust. 1 oraz § 15 ust. 1 pkt 2 i 3;
...
**§ 18.** Minister sporządza wykaz czasopism na podstawie projektu wykazu czasopism przekazanego przez KEN.

**§ 19.** W wykazie czasopism ujmuje się:
...
- **1)** w ramach oceny bibliometrycznej – KEN przypisuje punkty zgodnie z:
    ...
    - **b)** § 10 ust. 3: – pkt 1 – w przypadku czasopism niemających wyliczonego wskaźnika wpływu, – pkt 2 – w przypadku czasopism, o których mowa w § 6 ust. 1 pkt 3;
...
**§ 21.** Traci moc rozporządzenie Ministra Nauki i Szkolnictwa Wyższego z dnia 7 listopada 2018 r. w sprawie sporządzania wykazów wydawnictw monografii naukowych oraz czasopism naukowych i recenzowanych materiałów z konferencji międzynarodowych (Dz. U. z 2020 r. poz. 349).

**§ 22.** Rozporządzenie wchodzi w życie po upływie 14 dni od dnia ogłoszenia. Minister Nauki i Szkolnictwa Wyższego: M. Kulasek
