...
# Rozporządzenie Ministra Zdrowiaz dnia 16 stycznia 2014 r. w sprawie Krajowego Ośrodka Zapobiegania Zachowaniom Dyssocjalnym

| Pole | Wartość |
|---|---|
| Adres publikacyjny | Dz.U. 2014 poz. 89 |
| ISAP | WDU20140000089 |
...
| Źródło | [ISAP](https://isap.sejm.gov.pl/isap.nsf/DocDetails.xsp?id=WDU20140000089) · [PDF](https://api.sejm.gov.pl/eli/acts/DU/2014/89/text.pdf) |

Treść rozporządzenia
Na podstawie art. 8 ustawy z dnia 22 listopada 2013 r. o postępowaniu wobec osób z zaburzeniami psychicznymi stwarzających zagrożenie życia, zdrowia lub wolności seksualnej innych osób (Dz. U. z 2014 r. poz. 24) zarządza się, co następuje:
§ 1.
...
1)
sale jednoosobowe przeznaczone dla osób umieszczonych;
2)
świetlica;
3)
stołówka;
...
1)
węzeł sanitarny z systemem czujników ruchu połączonych z dyżurką pielęgniarską i stanowiskiem podglądu i dozoru prowadzonego przez pracowników służby ochrony oraz oddzielony od sali ścianami działowymi murowanymi, uniemożliwiającymi podgląd z korytarza, składający się z wykonanych ze stali nierdzewnej:
a)
muszli klozetowej,
b)
...
natrysku (prysznica);
2)
łóżko przymocowane trwale do podłogi, pozwalające na dostęp z trzech stron, w tym dwóch dłuższych, i dające możliwość zastosowania przymusu bezpośredniego w postaci izolacji oraz założenia pasów obezwładniających lub kaftana bezpieczeństwa;
3)
...
c)
28 pracowników służby ochrony – przy czym łączna liczba personelu nie może przekroczyć 77 osób.
§ 6.
1.
