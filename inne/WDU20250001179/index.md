...
- **10)** w art. 32 ust. 1 otrzymuje brzmienie:
  ...
  > 1) 5 lat od dnia ich zgromadzenia – w przypadku danych PNR pasażerów lotów pozaunijnych, 2) 3 lata od dnia ich zgromadzenia – w przypadku danych PNR pasażerów lotów wewnątrzunijnych – a po upływie tego okresu podlegają niezwłocznie trwałemu usunięciu w sposób zautomatyzowany przy wykorzystaniu KSI PNR.”;  
- **11)** w art. 33:
...
- **13)** w art. 65:
    ...
    - **b)** po ust. 3 dodaje się ust. 3a–3c w brzmieniu:
      ...
      > 1) zapewnił warunki techniczne umożliwiające sprawne i skuteczne przekazywanie przez niego danych PNR do JIP oraz 2) przekazał do JIP wszystkie dane PNR pasażerów lotów objętych takim obowiązkiem począwszy od dnia wykonania pierwszego lotu PNR – administracyjnej kary pieniężnej za takie naruszenie nie nakłada się.”;  

- **14)** art. 66 otrzymuje brzmienie:

  > „Art. 66.  
  > 1. Przewoźnik lotniczy, który nie dopełnia obowiązków określonych w art. 10 ust. 1 w terminie, o którym mowa w tym przepisie, podlega administracyjnej karze pieniężnej w wysokości 5000 zł za każde takie naruszenie.  
