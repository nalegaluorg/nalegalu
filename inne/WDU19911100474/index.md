...
- **1)** w art. 1 ust. 3 otrzymuje brzmienie: "3. Pracę uważa się za wykonywaną stale, jeżeli trwa nieprzerwanie co najmniej 30 dni.",
...
- **3)** w art. 29 ust. 3 otrzymuje brzmienie: "3. Współpracę uważa się za wykonywaną stale, jeżeli trwa nieprzerwanie co najmniej 30 dni.",
- **4)** w art. 38 w ust. 1 skreśla się wyrazy "kontynuowania ubezpieczenia";
- **5)** dodaje się art. 38 w brzmieniu: "Art. 38 .Przepisy ustawy stosuje się odpowiednio do osób wykonujących pracę na podstawie umowy agencyjnej lub umowy zlecenia na rzecz innych niż uspołecznione zakłady pracy i osób fizycznych oraz do osób z nimi współpracujących."
