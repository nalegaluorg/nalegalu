...
2. Do zadań strażnika odpowiedzialnego za prowadzenie gospodarki straży należy szczególności:
l) prowadzenie stanu wydania — przyjęcia oraz karty rozchodu amunicji;
2) sprawdzanie poprawności sposobu przechowywania znajdującej się magazynie;
3) sprawdzanie stanu zabezpieczenia pomieszczenia magazynu broni;
4) niezwłoczne informowanie bezpośredniego przełożonego o ujawnionych nieprawidłowościach stanie uzbrojenia, sposobie jego przechowywania oraz stanie wyposażenia magazynu broni;
5) kontrola okresu ważności legalizacji sprzętu gaśniczego znajdującego się magazynie broni;
6) zapewnienie właściwego stanu sanitarno-porządkowego magazynie broni.
$ 4. 1. Broń palną amunicję przechowuje się magazynie broni.
2. Magazyn może być umiejscowiony siedzibie straży lub obiekcie chronionym przez straż.
5 Minister Spraw Wewnętrznych kieruje działem administracji rządowej — sprawy wewnętrzne, na podstawie $ 1 ust. 2 rozporządzenia
3) jest wyposażony specjalne zabezpieczenia, tym co najmniej:
a) drzwi o zwiększonej odporności na włamanie minimum klasy € wg PN-90/B-92270 lub spełniające równorzędne wymagania,
b) okna osłonięte siatką stalową o wymiarach oczek maksymalnie 10 mm x 10 mm wykonaną drutu o średnicy nie mniejszej niż 2,5 mm oraz na stałe zamocowanymi murze kratami metalowymi wykonanymi prętów stalowych o średnicy nie mniejszej niż 12 mm lub płaskowników stalowych o przekroju poprzecznym nie mniejszym niż 8 mm x 30 mm. Odstęp między prętami kracie nie może przekraczać wymiarów 120 mm x 120 mm, płaskowników — 80 mm poziomie 240 mm pionie. Zamiast siatki krat dopuszcza się zamontowanie atestowanych szyb specjalnych, szczególności kuloodpornych, odpowiedniej klasy, bez możliwości otwierania,
...
3. Wzór stanu stanowi załącznik nr 1 do rozporządzenia.
$ 8. 1. Wydawanie zdawanie podlegają rejestracji książce wydania-przyjęcia amunicji.
