...
- - pkt 2 otrzymuje brzmienie: „ 2) Agencja Rynku Rolnego - w przypadku działania, o którym mowa w art. 3 ust. 1 pkt 3; ” ,
...
w art. 19 dotychczasową treść oznacza się jako ust. 1 i dodaje się ust. 2 i 3 w brzmieniu:
...
w art. 26 w ust. 2 pkt 1 i 2 otrzymują brzmienie:
...
w art. 38 w ust. 4 zdanie drugie otrzymuje brzmienie: „ Do postępowania w tych sprawach stosuje się odpowiednio przepisy art. 27 oraz art. 29 ust. 1 pkt 1. ” ;
...
gdy zadanie ujęte w zestawieniu rzeczowo-finansowym operacji jest wykonywane na podstawie art. 3 ust. 4 ustawy z dnia 26 marca 1982 r. o scalaniu i wymianie gruntów ([Dz. U. z 2014 r. poz. 700](https://api.sejm.gov.pl/eli/acts/DU/2014/700/text.html) oraz [z 2015 r. poz. 349](https://api.sejm.gov.pl/eli/acts/DU/2015/349/text.html)).
...
w art. 46 w ust. 1 w pkt 2 lit. a otrzymuje brzmienie:
...
- - pkt 2 otrzymuje brzmienie: „ 2) opracowanie planu działania i dwuletnich planów operacyjnych oraz ich zmian we współpracy z jednostkami wymienionymi w ust. 1 pkt 2-4, podmiotami wdrażającymi i agencją płatniczą; ” ,

- - dodaje się pkt 3 w brzmieniu: „ 3) realizację planu działania na poziomie krajowym na podstawie dwuletnich planów operacyjnych. ” ,
...
w art. 57 w ust. 4 pkt 2 otrzymuje brzmienie:
...
po art. 57 dodaje się art. 57a-57h w brzmieniu:
...
W ustawie z dnia 18 grudnia 2003 r. o krajowym systemie ewidencji producentów, ewidencji gospodarstw rolnych oraz ewidencji wniosków o przyznanie płatności ([Dz. U. z 2015 r. poz. 807](https://api.sejm.gov.pl/eli/acts/DU/2015/807/text.html) i [1419](https://api.sejm.gov.pl/eli/acts/DU/2015/1419/text.html) oraz [z 2016 r. poz. 1605](https://api.sejm.gov.pl/eli/acts/DU/2016/1605/text.html)) w art. 7 w ust. 1 pkt 6 otrzymuje brzmienie:

„

### 6)

numer rachunku bankowego producenta lub osoby, o której mowa w pkt 5, lub rachunku producenta lub tej osoby prowadzonego w spółdzielczej kasie oszczędnościowo-kredytowej.

” .

### Art. 3.

W ustawie z dnia 6 grudnia 2006 r. o zasadach prowadzenia polityki rozwoju ([Dz. U. z 2016 r. poz. 383](https://api.sejm.gov.pl/eli/acts/DU/2016/383/text.html), [1250](https://api.sejm.gov.pl/eli/acts/DU/2016/1250/text.html), [1948](https://api.sejm.gov.pl/eli/acts/DU/2016/1948/text.html) i [1954](https://api.sejm.gov.pl/eli/acts/DU/2016/1954/text.html)) w art. 14kc po ust. 2 dodaje się ust. 2a w brzmieniu:

„

### 2a.

Minister właściwy do spraw rozwoju wsi współpracuje z Komisją Europejską w zakresie oceny przekazanego jej projektu zmiany programu realizowanego z wykorzystaniem środków Europejskiego Funduszu Rolnego na rzecz Rozwoju Obszarów Wiejskich.
...
W ustawie z dnia 5 lutego 2015 r. o płatnościach w ramach systemów wsparcia bezpośredniego ([Dz. U. poz. 1551](https://api.sejm.gov.pl/eli/acts/DU/2015/1551/text.html) oraz [z 2016 r. poz. 337](https://api.sejm.gov.pl/eli/acts/DU/2016/337/text.html), [1579](https://api.sejm.gov.pl/eli/acts/DU/2016/1579/text.html) i [2037](https://api.sejm.gov.pl/eli/acts/DU/2016/2037/text.html)) wprowadza się następujące zmiany:
...
w art. 41a w ust. 1 w części wspólnej wyrazy „może ją zmienić lub uchylić” zastępuje się wyrazami „zmienia ją”;
...
W ustawie z dnia 20 lutego 2015 r. o rozwoju lokalnym z udziałem lokalnej społeczności ([Dz. U. poz. 378](https://api.sejm.gov.pl/eli/acts/DU/2015/378/text.html)) wprowadza się następujące zmiany:
...
- - dodaje się pkt 3 i 4 w brzmieniu: „ 3) jest zgodna z zakresem tematycznym, o którym mowa w art. 19 ust. 4 pkt 1 lit. c; 4) jest objęta wnioskiem o udzielenie wsparcia, który został złożony w miejscu i terminie wskazanym w ogłoszeniu o naborze wniosków o udzielenie wsparcia, o którym mowa w art. 35 ust. 1 lit. b rozporządzenia nr 1303/2013. ” ,
...
spośród operacji, które są zgodne z LSR;
...
Informacja, o której mowa w ust. 5 pkt 1, zawiera dodatkowo wskazanie ustalonej przez LGD kwoty wsparcia, a w przypadku ustalenia przez LGD kwoty wsparcia niższej niż wnioskowana - również uzasadnienie wysokości tej kwoty.
...
Informacja, o której mowa w ust. 5 pkt 1, zawiera pouczenie, o którym mowa w ust. 6, także w przypadku ustalenia przez LGD kwoty wsparcia niższej niż wnioskowana.
...
w ust. 1 w pkt 3 po wyrazach „1303/2013” dodaje się przecinek i wyraz „albo” oraz dodaje się pkt 4 w brzmieniu:
...
negatywnej oceny zgodności operacji z LSR zawiera wskazanie, w jakim zakresie podmiot ubiegający się o wsparcie, o którym mowa w art. 35 ust. 1 lit. b rozporządzenia nr 1303/2013, nie zgadza się z tą oceną, oraz uzasadnienie stanowiska tego podmiotu;

### 2)

ustalenia przez LGD kwoty wsparcia niższej niż wnioskowana zawiera wskazanie, w jakim zakresie podmiot ubiegający się o wsparcie, o którym mowa w art. 35 ust. 1 lit. b rozporządzenia nr 1303/2013, nie zgadza się z tym ustaleniem, oraz uzasadnienie stanowiska tego podmiotu.
...
- - pkt 2 otrzymuje brzmienie: „ 2) protest pozostawia się bez rozpatrzenia również w przypadku, gdy nie spełnia wymagań określonych w ust. 4; ” ,
...
Do projektów grantowych i operacji własnych LGD przepisy ust. 3-6 stosuje się odpowiednio.
...
art. 5 i niezakończonymi przed dniem wejścia w życie niniejszej ustawy przepisy ustawy zmienianej w art. 5,

### 2)

art. 6 i niezakończonymi przed dniem wejścia w życie niniejszej ustawy przepisy ustawy zmienianej w art. 6
