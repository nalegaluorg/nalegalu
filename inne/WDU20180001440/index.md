...
c) pkt 8 i 9 otrzymują brzmienie: „8) któremu została przyznana jednolita płatność obszarowa w ramach systemów wsparcia bezpośredniego za rok, w którym jest składany wniosek o przyznanie pomocy, albo za rok poprzedzający rok złożenia wniosku o przyznanie pomocy oraz który złoży oświadczenie, że będzie ubiegał się o przyznanie jednolitej płatności obszarowej w ramach systemów wsparcia bezpośredniego za kolejne lata, w których zostanie objęty pomocą;
...
b) w ust. 5: – pkt 1–3 otrzymują brzmienie: „1) w przypadku unijnego systemu jakości, o którym mowa w § 3 pkt 3 lit. a:
