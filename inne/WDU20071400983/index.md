...
- **2)** w ust. 1 pkt 2 – powinien zawierać również: wskazanie tematu prowadzonych badań naukowych, rekomendację pracownika naukowego uprawnionego do prowadzenia badań naukowych w dyscyplinach nauk humanistycznych, społecznych, gospodarki lub prawa – w przypadku osób niebędących takimi pracownikami;
    - **a)**
    - **b)**

- **3)** w ust. 1 pkt 3 – powinien zawierać również: wskazanie tematu materiału prasowego, załączone upoważnienie redakcji albo wydawcy do wystąpienia z wnioskiem.
    - **a)**
    - **b)**
