...
- **9)** w art. 56: pkt 1 otrzymuje brzmienie: „
    - **a)**

- **1)** wybór prezesa Naczelnej Rady Adwokackiej, prezesa Wyższego Sądu Dyscyplinarnego, Rzecznika Dyscyplinarnego Adwokatury i przewodniczącego Wyższej Komisji Rewizyjnej; ” , po pkt 3 dodaje się pkt 3a w brzmieniu: „
    - **b)**

- **3a)** ustalanie liczby członków i zastępców członków Wyższego Sądu Dyscyplinarnego oraz sądów dyscyplinarnych; ” , w pkt 6 lit. a otrzymuje brzmienie: „ trybu wyborów do organów adwokatury i organów izb adwokackich oraz działania tych organów, z wyjątkiem regulaminów, o których mowa w art. 58 pkt 12 lit. i, ” ;
    - **c)**
    - **a)**
...
- **15)** w art. 72: w ust. 1 uchyla się pkt 8, po ust. 1 dodaje się ust. 1a w brzmieniu: „
    - **a)**
    - **b)**
...
- **17)** w art. 79: po ust. 1 dodaje się ust. 1a w brzmieniu: „
    - **a)**

1a. Aplikanta adwokackiego skreśla się z listy aplikantów również w razie orzeczenia przez sąd dyscyplinarny kary wydalenia z adwokatury. ” , ust. 3 otrzymuje brzmienie: „
...
- **19)** w art. 81: po ust. 3 dodaje się ust. 3a w brzmieniu: „
    - **a)**

3a. Obok kary dyscyplinarnej można orzec dodatkowo obowiązek przeproszenia pokrzywdzonego. Orzekając ten obowiązek, sąd dyscyplinarny określa sposób jego wykonania, odpowiedni ze względu na okoliczności sprawy. ” , ust. 6 otrzymuje brzmienie: „
...
- **32)** w art. 95j: ust. 2 otrzymuje brzmienie: „
    - **a)**

2. Postanowienie sądu dyscyplinarnego o tymczasowym zawieszeniu jest natychmiast wykonalne. Na postanowienie to przysługuje zażalenie. ” , dodaje się ust. 3 i 4 w brzmieniu: „
...
- **33)** w art. 95l: ust. 1 otrzymuje brzmienie: „
    - **a)**

1. Koszty postępowania dyscyplinarnego mają charakter zryczałtowany. ” , dodaje się ust. 3 w brzmieniu: „
...
- **34)** w art. 95ł: ust. 1 otrzymuje brzmienie: „
    - **a)**

1. Sąd dyscyplinarny niezwłocznie przesyła odpis prawomocnego orzeczenia właściwej okręgowej radzie adwokackiej, Ministrowi Sprawiedliwości i Naczelnej Radzie Adwokackiej. ” , po ust. 1 dodaje się ust. 1a-1c w brzmieniu: „
...
- **5)** po art. 292 dodaje się art. 293 w brzmieniu: „
...
1. Kadencja organów samorządu trwa cztery lata, jednakże organy są obowiązane działać do czasu ukonstytuowania się nowo wybranych organów. ” , ust. 3 otrzymuje brzmienie: „
...
- **12)** po art. 54 dodaje się art. 541 w brzmieniu: „
...
- **15)** w art. 60: w pkt 8 w lit. e średnik zastępuje się przecinkiem i dodaje się lit. f w brzmieniu: „ dotyczących szczegółowych zasad wykonywania zawodu radcy prawnego; ” , po pkt 9 dodaje się pkt 9a i 9b w brzmieniu: „
    - **a)**
    - **f)**
    - **b)**
...
- **16)** po art. 61 dodaje się art. 611 w brzmieniu: „
...
- **5)** pozbawienie prawa do wykonywania zawodu radcy prawnego, a w stosunku do aplikantów radcowskich – wydalenie z aplikacji. ” , ust. 2a otrzymuje brzmienie: „
    - **b)**

2a. Obok kary nagany i kary pieniężnej można orzec dodatkowo zakaz wykonywania patronatu na czas od roku do pięciu lat. ” , po ust. 2b dodaje się ust. 2ba w brzmieniu: „ 2ba. Karę pieniężną wymierza się w granicach od półtorakrotności do dwunastokrotności minimalnego wynagrodzenia za pracę obowiązującego w dacie popełnienia przewinienia dyscyplinarnego. ” , po ust. 2d dodaje się ust. 2e-2h w brzmieniu: „
...
- **19)** po art. 65 dodaje się art. 651 i art. 652 w brzmieniu: „
...
- **21)** art. 671 otrzymuje brzmienie: „
...
- **22)** po art. 671 dodaje się art. 672 w brzmieniu: „
...
- **24)** w art. 681 ust. 1 otrzymuje brzmienie: „
...
- **25)** art. 682 otrzymuje brzmienie: „
...
- **26)** po art. 682 dodaje się art. 683 i art. 684 w brzmieniu: „
...
- **29)** art. 701 otrzymuje brzmienie: „
...
- **30)** w art. 702 po ust. 1 dodaje się ust. 1a w brzmieniu: „
...
- **31)** art. 704 otrzymuje brzmienie: „
...
- **32)** w art. 706: ust. 1 otrzymuje brzmienie: „
    - **a)**
...
- **33)** w art. 71: ust. 1 i 2 otrzymują brzmienie: „
    - **a)**
...
2. Wykonanie kar dyscyplinarnych należy do dziekana rady okręgowej izby radców prawnych. ” , po ust. 2 dodaje się ust. 2a i 2b w brzmieniu: „
...
2b. W postępowaniu egzekucyjnym, o którym mowa w ust. 2a, czynności przewidziane dla wierzyciela podejmuje dziekan rady okręgowej izby radców prawnych tej izby, której ukarany był członkiem w dacie uprawomocnienia się rozstrzygnięcia w zakresie kary pieniężnej oraz kosztów postępowania dyscyplinarnego. ” , w ust. 4 wprowadzenie do wyliczenia otrzymuje brzmienie: „ O karach, o których mowa w art. 65 ust. 1 pkt 4 i 5, zawiadamia się: ” , w ust. 5 pkt 1 otrzymuje brzmienie: „
...
- **34)** art. 741 otrzymuje brzmienie: „
