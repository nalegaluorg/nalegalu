...
- **3)** towarzyszących usługom autobusowego i autokarowego transportu pasażerskiego, usługom wodnego transportu pasażerskiego oraz usługom lotniczego i kolejowego transportu pasażerskiego zakresie:
    ...
    - **b)** usług oferowanych lub świadczonych za pomocą urządzeń mobilnych, tym aplikacji mobilnych,
    - **c)** biletów elektronicznych i usług elektronicznych systemów sprzedaży biletów,
    - **d)** dostarczania informacji związanych z tymi usługami, tym informacji o podróży czasie rzeczywistym, przy czym odniesieniu do dostarczania tych informacji za pośrednictwem ekranów informacyjnych obowiązek ten dotyczy wyłącznie interaktywnych ekranów znajdujących się na terytorium Unii Europejskiej,
...
1. Spełnianie wymagań dostępności zakresie informacji o produkcie jest zapewnione, jeżeli:
...
**Art. 8.** Produkt, tym interfejs użytkownika, spełnia co najmniej następujące wymagania dostępności:
...
**Art. 11.** Poza spełnianiem wymagań dostępności, o których mowa art. 7 i art. 8, konsumenckie urządzenie końcowe z interaktywnymi zdolnościami obliczeniowymi wykorzystywane do oferowania lub świadczenia usług:

**Art. 12.**

1. Do oferowania lub świadczenia usług wykorzystuje się produkty spełniające wymagania dostępności określone art. 7–11.
...
1. Poza spełnianiem wymagań dostępności, o których mowa art. 12, ramach usług towarzyszących usługom autobusowego i autokarowego transportu pasażerskiego, usługom wodnego transportu pasażerskiego oraz usługom lotniczego i kolejowego transportu pasażerskiego informuje się o:

- **1)** zapewnieniu warunków niezbędnych do korzystania przez osoby ze szczególnymi potrzebami, tym o bieżącym stanie, odniesieniu do:
...
1. Wymagania dostępności mają zastosowanie wyłącznie zakresie, jakim zapewnienie zgodności z nimi:
...
3. Dokonując oceny, o której mowa ust. 2 pkt 2, podmiot gospodarczy stosuje następujące kryteria:
...
- **2)** szacowane koszty i korzyści dla podmiotu gospodarczego, tym odniesieniu do procesów wytwórczych i inwestycji, stosunku do szacowanej korzyści dla osób ze szczególnymi potrzebami, z uwzględnieniem liczby przypadków i częstotliwości korzystania z produktu albo usługi;
...
4. Przy obliczaniu kosztów netto, o których mowa ust. 3 pkt 1 i 3, uwzględnia się:
...
5. Podmiot gospodarczy sporządza dokumentację przebiegu oceny, o której mowa ust. 2, i dokonanych jej ramach ustaleń.

6. Podmiot gospodarczy przechowuje dokumentację przebiegu oceny, o której mowa ust. 2, i dokonanych jej ramach ustaleń, przez okres 5 lat od dnia:

- **1)** ostatniego udostępnienia na rynku produktu;
- **2)** zakończenia oferowania lub świadczenia usługi.

7. Na żądanie Prezesa Zarządu PFRON lub właściwego organu nadzoru rynku, o którym mowa art. 38 ust. 3, podmiot gospodarczy przekazuje uwierzytelnioną kopię dokumentacji przebiegu oceny, o której mowa ust. 2, i dokonanych jej ramach ustaleń.

8. W przypadku gdy wyniku dokonania oceny, o której mowa ust. 2, podmiot gospodarczy nie jest obowiązany do spełniania wymagań dostępności, informuje o tym niezwłocznie na piśmie właściwy organ nadzoru rynku, o którym mowa art. 38 ust. 3.

9. Przepisów ust. 5–8 nie stosuje się do mikroprzedsiębiorców dokonujących obrotu produktami. W przypadku gdy wyniku dokonania oceny, o której mowa ust. 2, mikroprzedsiębiorca dokonujący obrotu produktami nie jest obowiązany do spełniania wymagań dostępności, na żądanie Prezesa Zarządu PFRON lub właściwego organu nadzoru rynku, o którym mowa art. 38 ust. 3, przedstawia dokumenty lub wskazuje okoliczności mające znaczenie dla dokonania tej oceny.

10. W przypadku gdy wyniku dokonania oceny, o której mowa ust. 2 pkt 2, usługodawca nie jest obowiązany do spełniania wymagania dostępności, dokonuje tej oceny odniesieniu do usługi:

- **1)** nie rzadziej niż co 5 lat;
- **2)** każdorazowo:
    - **a)** gdy zakres usługi lub sposób jej oferowania lub świadczenia uległ zmianie,
    - **b)** na żądanie Prezesa Zarządu PFRON lub właściwego organu nadzoru rynku, o którym mowa art. 38 ust. 3.

11. W przypadku gdy podmiot gospodarczy, który celu zapewnienia spełniania wymagania dostępności produktu albo usługi otrzymał finansowanie z publicznych lub prywatnych źródeł innych niż zasoby własne, przepisu ust. 1 pkt 2 nie stosuje się do tego wymagania dostępności.
...
4. W przypadku zastosowania części norm zharmonizowanych lub specyfikacji technicznych dokumentacji technicznej produktu określa się, które części zostały zastosowane.

5. Producent przechowuje dokumentację techniczną produktu przez okres 5 lat od dnia wprowadzenia do obrotu tego produktu.

6. Jeżeli z dokonanej oceny zgodności produktu, o której mowa ust. 2, wynika, że produkt spełnia wymagania dostępności, przed jego wprowadzeniem do obrotu producent:

- **1)** sporządza formie pisemnej, postaci papierowej lub elektronicznej deklarację zgodności potwierdzającą zgodność produktu z wymaganiami dostępności, zwaną dalej „deklaracją zgodności”;
- **2)** umieszcza na produkcie lub jego tabliczce znamionowej sposób widoczny, czytelny i trwały oznakowanie CE.

7. W przypadku gdy umieszczenie na produkcie lub jego tabliczce znamionowej oznakowania CE sposób, o którym mowa ust. 6 pkt 2, jest niemożliwe lub nieuzasadnione ze względu na charakter produktu, oznakowanie CE umieszcza się na opakowaniu i dołączonych do produktu dokumentach sposób, o którym mowa ust. 6 pkt 2.

**Art. 24.**

1. Deklarację zgodności producent sporządza zgodnie z przepisami o systemach oceny zgodności i nadzoru rynku oraz załącznikiem III do decyzji Parlamentu Europejskiego i Rady nr 768/2008/WE z dnia 9 lipca 2008 r. sprawie wspólnych ram dotyczących wprowadzania produktów do obrotu, uchylającej decyzję Rady 93/465/EWG (Dz. Urz. UE L 218 z 13.08.2008, str. 82).

2. W deklaracji zgodności producent wykazuje spełnianie odpowiednich wymagań dostępności.

3. W przypadku gdy wyniku dokonania oceny, o której mowa art. 21 ust. 2, producent nie jest obowiązany do spełniania wymagań dostępności, deklaracji zgodności zawiera się informacje, które wymagania dostępności nie są spełnione.

4. Producent aktualizuje deklarację zgodności każdorazowo przypadku zmiany funkcji lub właściwości produktu.
...
1. Producent zapewnia istnienie procedur pozwalających na utrzymanie zgodności produktów ramach produkcji seryjnej z wymaganiami dostępności.

2. Producent uwzględnia procedurach, o których mowa ust. 1, zmiany projekcie produktu lub jego właściwościach oraz zmiany normach zharmonizowanych lub specyfikacjach technicznych, na podstawie których zadeklarowano zgodność produktu z wymaganiami dostępności.
...
3. Producent prowadzi formie pisemnej, postaci papierowej lub elektronicznej ewidencję produktów, które nie spełniają wymagań dostępności, i związanych z tym skarg, o których mowa art. 35 ust. 1.

4. Na żądanie Prezesa Zarządu PFRON lub właściwego organu nadzoru rynku, o którym mowa art. 38 ust. 3, producent, terminie określonym tym żądaniu, przekazuje informacje i dokumentację konieczne do wykazania spełniania przez produkt wymagań dostępności, formie pisemnej, postaci papierowej lub elektronicznej. Jeżeli dokument został sporządzony języku obcym, Prezes Zarządu PFRON lub właściwy organ nadzoru rynku, o którym mowa art. 38 ust. 3, może żądać przekazania tego dokumentu przetłumaczonego na język polski.

5. Producent współpracuje z Prezesem Zarządu PFRON lub właściwym organem nadzoru rynku, o którym mowa art. 38 ust. 3, celu usunięcia niezgodności produktu wprowadzonego przez niego do obrotu z wymaganiami dostępności, szczególności przez podejmowanie działań mających na celu zapewnienie spełniania przez produkt tych wymagań.

**Art. 28.**

1. Producent może wyznaczyć upoważnionego przedstawiciela.

2. Upoważniony przedstawiciel wykonuje obowiązki określone przez producenta pisemnym pełnomocnictwie, z wyjątkiem obowiązków, o których mowa art. 23 ust. 1–4 i art. 26 ust. 1 i 2.

3. Upoważniony przedstawiciel wykonuje co najmniej obowiązki, o których mowa art. 23 ust. 5, art. 24 ust. 7 i art. 27 ust. 4 i 5.

**Art. 29.** Importer ma obowiązek:

**Art. 30.** Dystrybutor ma obowiązek:

**Art. 31.** Importera lub dystrybutora traktuje się jak producenta, jeżeli wprowadzają do obrotu produkt pod własną nazwą lub własnym znakiem towarowym lub modyfikują produkt znajdujący się obrocie taki sposób, że może to mieć wpływ na jego zgodność z wymaganiami dostępności.
...
- **1)** regulaminie świadczenia usług lub innym równoważnym dokumencie podać do publicznej wiadomości formie pisemnej, postaci papierowej lub elektronicznej oraz sposób dostępny dla osób ze szczególnymi potrzebami określony art. 12 ust. 2 informacje:
    - **a)** o oferowanej i świadczonej usłudze,
    - **b)** niezbędne do korzystania z usługi,
    - **c)** o tym, jaki sposób usługa spełnia wymagania dostępności;
...
1. Na żądanie Prezesa Zarządu PFRON lub właściwego organu nadzoru rynku, o którym mowa art. 38 ust. 3, podmiot gospodarczy, terminie określonym tym żądaniu, przekazuje informacje pozwalające na identyfikację podmiotu gospodarczego, który dostarczył mu produkt lub któremu on dostarczył produkt ramach wykonywanej działalności gospodarczej, formie pisemnej, postaci papierowej lub elektronicznej.

2. Informacje, o których mowa ust. 1, zawierają imię i nazwisko lub nazwę (firmę) podmiotu gospodarczego, który dostarczył mu produkt lub któremu on dostarczył produkt, oraz jego adres, datę dostarczenia produktu i opis produktu.

3. Informacje, o których mowa ust. 1, podmiot gospodarczy przechowuje przez okres 5 lat odpowiednio od dnia dostarczenia mu produktu lub dostarczenia przez niego produktu.

4. W przypadku braku możliwości uzyskania od podmiotu gospodarczego informacji, o których mowa ust. 1, celu identyfikacji podmiotu gospodarczego, który dostarczył produkt podmiotowi gospodarczemu lub któremu podmiot gospodarczy dostarczył produkt ramach wykonywanej działalności gospodarczej, Prezes Zarządu PFRON lub właściwy organ nadzoru rynku, o którym mowa art. 38 ust. 3, mogą wystąpić do właściwego organu Krajowej Administracji Skarbowej o udostępnienie danych, o których mowa ust. 2, z ewidencji, o których mowa art. 109 ustawy z dnia 11 marca 2004 r. o podatku od towarów i usług (Dz. U. z 2024 r. poz. 361).
...
3. W przypadku gdy skarga została złożona do dystrybutora, dystrybutor przekazuje ją niezwłocznie do rozpatrzenia podmiotowi gospodarczemu, który przekazał mu produkt do udostępnienia na rynku, i powiadamia o tym konsumenta sposób wskazany zgodnie z art. 36 ust. 1 pkt 2.
...
3. W szczególnie skomplikowanych przypadkach uniemożliwiających rozpatrzenie skargi i udzielenie odpowiedzi terminie, o którym mowa ust. 2, podmiot gospodarczy tym terminie zawiadamia konsumenta sposób wskazany zgodnie z art. 36 ust. 1 pkt 2 o przyczynie zwłoki oraz wskazuje nowy termin rozpatrzenia skargi i udzielenia odpowiedzi, nie dłuższy niż 60 dni od dnia otrzymania skargi.

4. W przypadku niedotrzymania terminu określonego odpowiednio ust. 2 albo 3 skargę uważa się za rozpatrzoną zgodnie z żądaniem skarżącego. Podmiot gospodarczy realizuje żądanie skarżącego terminie nie dłuższym niż 6 miesięcy od dnia otrzymania skargi.
...
6. W przypadku gdy skarga nie została uwzględniona, odpowiedź, o której mowa ust. 2, zawiera również pouczenie o możliwości:

- **1)** odwołania się od stanowiska zawartego odpowiedzi, jeżeli podmiot gospodarczy przewiduje tryb odwoławczy, a także o sposobie i terminie wniesienia tego odwołania;
...
- **3)** złożenia zawiadomienia o niespełnianiu przez produkt albo usługę wymagań dostępności, o którym mowa art. 67.

#### Rozdział 5 Nadzór rynku zakresie spełniania wymagań dostępności produktów i usług
...
1. Na żądanie konsumenta Prezes Zarządu PFRON lub właściwy organ nadzoru rynku przekazują posiadane przez nich informacje o zgodności produktu lub usługi z wymaganiami dostępności lub informacje o ocenie dokonanej przez podmiot gospodarczy na podstawie art. 21 ust. 2, art. 23 ust. 2 lub art. 32 ust. 1, z zachowaniem zasad poufności, przepisów dotyczących tajemnic prawnie chronionych oraz ochrony danych osobowych, terminie 30 dni od dnia otrzymania żądania.

2. Informacje, o których mowa ust. 1, są przekazywane konsumentowi sposób zapewniający spełnianie minimalnych wymagań służących zapewnieniu dostępności, o których mowa art. 6 pkt 3 ustawy z dnia 19 lipca 2019 r. o zapewnianiu dostępności osobom ze szczególnymi potrzebami.
...
2. Jeżeli kontrolowany podmiot gospodarczy lub inne podmioty, o których mowa ust. 1, nie udzielają informacji lub nie współpracują toku kontroli, ustaleń dokonuje się na podstawie dowodów lub informacji dostępnych Prezesowi Zarządu PFRON lub właściwym organom nadzoru rynku.

3. Prezes Zarządu PFRON lub właściwy organ nadzoru rynku niezwłocznie informują na piśmie kontrolowany podmiot gospodarczy lub inne podmioty, o których mowa ust. 1, o ustaleniach dokonanych zgodnie z ust. 2.

**Art. 45.**

1. W toku kontroli osoba kontrolująca, zakresie objętym kontrolą, ma prawo szczególności:
...
- **3)** dokonywać oględzin produktów, pomieszczeń oraz budynków użyteczności publicznej, których są oferowane lub świadczone usługi, a także weryfikować sposób oferowania lub świadczenia usługi;
- **4)** sprawdzać spełnianie przez produkty i usługi wymagań dostępności;
- **5)** legitymować osoby, które biorą udział czynnościach kontrolnych, celu stwierdzenia ich tożsamości;
- **6)** żądać udzielenia, wyznaczonym terminie, pisemnych i ustnych wyjaśnień;
...
2. Prezes Zarządu PFRON lub właściwy organ nadzoru rynku ponoszą koszty badań, o których mowa ust. 1.

3. W celu poddania produktu badaniom, o których mowa ust. 1, Prezes Zarządu PFRON lub właściwy organ nadzoru rynku pobierają nieodpłatnie próbki produktu liczbie niezbędnej do przeprowadzenia badań.

4. Równocześnie z pobraniem próbki produktu należy pobrać i zabezpieczyć dodatkową próbkę liczbie odpowiadającej liczbie pobranej do badań, zwaną dalej „próbką kontrolną”.

5. Kontrolowany podmiot gospodarczy, u którego pobrano próbkę, jest obowiązany do przechowywania próbki kontrolnej warunkach uniemożliwiających zmianę jakości lub cech charakterystycznych produktu, do czasu jej zwolnienia spod zabezpieczenia przez Prezesa Zarządu PFRON lub właściwy organ nadzoru rynku. W przypadku wszczęcia postępowania, o którym mowa art. 53, próbkę kontrolną zwalnia się spod zabezpieczenia na wniosek Prezesa Zarządu PFRON lub właściwego organu nadzoru rynku.
...
- **2)** przechowanie próbki kontrolnej warunkach uniemożliwiających zmianę jakości lub cech charakterystycznych produktu jest niemożliwe.

7. Badanie próbki kontrolnej może odbywać się także na wniosek kontrolowanego podmiotu gospodarczego.

8. W przypadku, o którym mowa ust. 7, koszty badania próbki kontrolnej ponosi kontrolowany podmiot gospodarczy.
...
2. Wysokość opłat związanych z badaniami ustala, drodze decyzji, Prezes Zarządu PFRON lub właściwy organ nadzoru rynku.

3. Wysokość opłat związanych z badaniami ustala się na podstawie uzasadnionych kosztów poniesionych związku z badaniami produktu.

4. Opłaty związane z badaniami stanowią przychód Funduszu Dostępności, o którym mowa art. 35 ust. 1 ustawy z dnia 19 lipca 2019 r. o zapewnianiu dostępności osobom ze szczególnymi potrzebami.

5. W przypadku stwierdzenia, że produkt spełnia wymagania dostępności, opłaty związane z badaniami ponosi Skarb Państwa.

**Art. 49.**

1. Kontrolę przeprowadza się obecności kontrolowanego podmiotu gospodarczego lub osoby przez niego upoważnionej.

2. Kontrolowany podmiot gospodarczy lub osoba przez niego upoważniona są obowiązani do umożliwienia osobie kontrolującej przeprowadzenia kontroli, szczególności dokonania czynności kontrolnych, o których mowa art. 45 ust. 1 pkt 1–6 i 9.

3. Kontrolowany podmiot gospodarczy lub osoba przez niego upoważniona są obowiązani, zakresie objętym kontrolą, do:
...
2. Jeden egzemplarz protokołu kontroli doręcza się kontrolowanemu podmiotowi gospodarczemu lub osobie przez niego upoważnionej, a drugi egzemplarz protokołu kontroli pozostawia się aktach sprawy.

3. Kontrolowany podmiot gospodarczy lub osoba przez niego upoważniona mogą zgłosić do protokołu kontroli zastrzeżenia i uwagi terminie 10 dni roboczych od dnia otrzymania protokołu kontroli.

4. Osoba kontrolująca ustosunkowuje się do zastrzeżeń i uwag zgłoszonych do protokołu kontroli terminie 7 dni roboczych od dnia ich otrzymania.

5. Osoba kontrolująca może protokole kontroli, z urzędu lub na wniosek kontrolowanego podmiotu gospodarczego lub osoby przez niego upoważnionej, prostować błędy pisarskie i rachunkowe lub inne oczywiste omyłki.

6. Z czynności kontrolnych, o których mowa art. 45 ust. 1 pkt 3, 8 i 9 lub innych czynności kontrolnych niewymienionych art. 45 ust. 1, sporządza się odrębny protokół, który stanowi załącznik do protokołu kontroli.

7. Odrębny protokół, o którym mowa ust. 6, zawiera szczególności:
...
- **7)** podpis osoby, obecności której czynność kontrolna została dokonana.

**Art. 51.**

1. W przypadku gdy wyniku kontroli Prezes Zarządu PFRON lub właściwy organ nadzoru rynku ustalą, że produkt nie spełnia określonego wymagania dostępności:

- **1)** sprawdzają, czy podmiot gospodarczy dokonał oceny, o której mowa art. 21 ust. 2;
- **2)** dokonują analizy oceny, o której mowa art. 21 ust. 2, tym prawidłowego stosowania kryteriów, o których mowa art. 21 ust. 3;
...
**Art. 53.** Prezes Zarządu PFRON lub właściwy organ nadzoru rynku wszczynają z urzędu postępowanie, przypadku gdy podmiot gospodarczy nie przedstawił dowodów, o których mowa art. 52 ust. 1 pkt 1 lub ust. 2.

**Art. 54.** Prezes Zarządu PFRON lub właściwy organ nadzoru rynku mogą, drodze decyzji, przedłużyć okres obowiązywania zakazu, o którym mowa art. 52 ust. 1 pkt 2, do czasu zakończenia postępowania, o którym mowa art. 53.

**Art. 55.**

1. W przypadku gdy próbka kontrolna nie została zbadana toku kontroli, Prezes Zarządu PFRON lub właściwy organ nadzoru rynku mogą ją poddać badaniu z urzędu lub na wniosek podmiotu gospodarczego.
...
1. W przypadku gdy wyniku kontroli Prezes Zarządu PFRON lub właściwy organ nadzoru rynku ustalą, że produkt nie spełnia wymagań dostępności lub podmiot gospodarczy nie wykonał obowiązków, o których mowa art. 22, art. 23, art. 24 ust. 1–5 i 7, art. 25–27, art. 28 ust. 2 i 3, art. 29, art. 30 oraz art. 34 ust. 1–3, drodze decyzji:
...
2. Środki, o których mowa ust. 1, stosuje się, biorąc pod uwagę niespełnione wymagania dostępności lub niewykonane obowiązki.

3. Jeżeli decyzja, o której mowa ust. 1, dotyczy dystrybutora, środki, o których mowa ust. 1, mają zastosowanie wyłącznie wobec produktów, które udostępnił na rynku.

4. W decyzji, o której mowa ust. 1, Prezes Zarządu PFRON lub właściwy organ nadzoru rynku określają termin i sposób poinformowania przez podmiot gospodarczy o wykonaniu tej decyzji.

5. Jeżeli wymaga tego interes konsumenta, Prezes Zarządu PFRON lub właściwy organ nadzoru rynku nadają decyzji, o której mowa ust. 1, rygor natychmiastowej wykonalności.

6. W celu stwierdzenia, czy decyzja, o której mowa ust. 1, została wykonana, Prezes Zarządu PFRON lub właściwy organ nadzoru rynku mogą przeprowadzić kontrolę.
...
1. Organ celny przeprowadza kontrolę, o której mowa art. 25 ust. 3 rozporządzenia (UE) 2019/1020, produktów, które mają zostać objęte procedurą dopuszczenia do obrotu.

2. Do kontroli, o której mowa art. 25 ust. 3 rozporządzenia (UE) 2019/1020, organ celny stosuje przepisy art. 25 ust. 4, art. 26 ust. 1, 2 i 4 oraz art. 27 i art. 28 ust. 2 rozporządzenia (UE) 2019/1020.

3. Organ celny zawiadamia właściwy organ nadzoru rynku o zawieszeniu dopuszczenia do obrotu produktu, szczególności przekazuje informacje o tym produkcie, oraz wskazuje przesłanki tego zawieszenia, o których mowa art. 26 ust. 1 rozporządzenia (UE) 2019/1020.

4. Na wniosek właściwego organu nadzoru rynku organ celny udziela dodatkowych niezbędnych wyjaśnień.

5. Na wniosek organu celnego właściwy organ nadzoru rynku wydaje opinię zakresie spełniania przez produkt wymagań dostępności.
...
2. W przypadku gdy wyniku kontroli Prezes Zarządu PFRON lub właściwy organ nadzoru rynku ustalą, że usługa, o której mowa ust. 1, stwarza zagrożenie dla zdrowia lub bezpieczeństwa konsumentów, wzywają usługodawcę do powiadomienia konsumentów o tym fakcie, określając sposób tego powiadomienia, oraz wyznaczają termin na przedstawienie dowodów potwierdzających dokonanie tego powiadomienia.

**Art. 63.** Prezes Zarządu PFRON lub właściwy organ nadzoru rynku wszczynają z urzędu postępowanie, przypadku gdy usługodawca nie przedstawił dowodów, o których mowa art. 62 ust. 1 pkt 1 lub ust. 2.

**Art. 64.** Prezes Zarządu PFRON lub właściwy organ nadzoru rynku mogą, drodze decyzji, przedłużyć okres obowiązywania zakazu, o którym mowa art. 62 ust. 1 pkt 2, do czasu zakończenia postępowania, o którym mowa art. 63.

**Art. 65.**

1. W przypadku gdy wyniku kontroli Prezes Zarządu PFRON lub właściwy organ nadzoru rynku ustalą, że usługa nie spełnia wymagań dostępności lub nie zostały wykonane obowiązki, o których mowa art. 32 i art. 33, drodze decyzji:
...
3. W decyzji, o której mowa ust. 1, Prezes Zarządu PFRON lub właściwy organ nadzoru rynku określają termin i sposób poinformowania przez usługodawcę o wykonaniu tej decyzji.

4. Jeżeli wymaga tego interes konsumenta, Prezes Zarządu PFRON lub właściwy organ nadzoru rynku nadają decyzji, o której mowa ust. 1, rygor natychmiastowej wykonalności.

5. W celu stwierdzenia, czy decyzja, o której mowa ust. 1, została wykonana, Prezes Zarządu PFRON lub właściwy organ nadzoru rynku mogą przeprowadzić kontrolę.
...
- **1)** skargi;
- **2)** odpowiedzi na skargę albo informację, że nie została ona udzielona terminie określonym odpowiednio art. 37 ust. 2 i 3.

**Art. 68.**

1. Prezes Zarządu PFRON niezwłocznie, jednak nie później niż terminie 30 dni od dnia złożenia zawiadomienia:

- **1)** rozpatruje zawiadomienie albo
- **2)** przekazuje zawiadomienie właściwemu organowi nadzoru rynku, informując o tym składającego zawiadomienie, jeżeli zawiadomienie zawiera informacje, o których mowa art. 67 ust. 3.
...
3. Prezes Zarządu PFRON albo właściwy organ nadzoru rynku informują składającego zawiadomienie, jeżeli zawiadomienie zawiera informacje, o których mowa art. 67 ust. 3, formie pisemnej, postaci papierowej lub elektronicznej, o:

- **1)** wszczęciu kontroli oraz o pozasądowych procedurach rozstrzygania sporów, tym wskazują właściwy podmiot uprawniony zgodnie z przepisami ustawy z dnia 23 września 2016 r. o pozasądowym rozwiązywaniu sporów konsumenckich (Dz. U. poz. 1823), albo
- **2)** niezasadności zawiadomienia.

4. Prezes Zarządu PFRON albo właściwy organ nadzoru rynku informują składającego zawiadomienie, jeżeli przekazał on informacje, o których mowa art. 67 ust. 3, o wszczęciu postępowania, o którym mowa art. 53 lub art. 63.

5. W przypadku gdy Prezes Zarządu PFRON przekazał zawiadomienie właściwemu organowi nadzoru rynku, organ ten rozpatruje je niezwłocznie, jednak nie później niż terminie 30 dni od dnia otrzymania zawiadomienia od Prezesa Zarządu PFRON.
...
1. Prezes Zarządu PFRON opracowuje krajową strategię systemu nadzoru rynku zakresie zapewniania spełniania wymagań dostępności produktów.
...
- **1)** informacje zakresie:
    ...
    - **b)** ewentualnych blokad technologicznych lub barier dla innowacji zakresie dostępności produktów i usług,
...
- **2)** ocenę:
    ...
    - **b)** czy jest wskazane objęcie zakresem ustawy produktów lub usług innych niż wymienione art. 3 ust. 1 i 2 lub wyłączenie z tego zakresu niektórych produktów lub usług;
...
- **1)** producent, który:
    - **a)** wprowadza do obrotu produkt, który nie spełnia wymagań dostępności, o których mowa art. 7–11 lub art. 19,
    - **b)** nie przekazał Prezesowi Zarządu PFRON lub właściwemu organowi nadzoru rynku informacji lub dokumentacji, o których mowa art. 27 ust. 4, terminie określonym żądaniu, o którym mowa tym przepisie, albo przekazał informacje lub dokumentację nieprawdziwe lub wprowadzające błąd,
    - **c)** nie przedstawił dowodów, o których mowa art. 52 ust. 1 pkt 1, terminie określonym tym przepisie,
    - **d)** nie wykonał obowiązku określonego art. 23 ust. 2,
    - **e)** nie wykonał obowiązku określonego art. 27 ust. 2,

- **2)** usługodawca, który:
    - **a)** nie zapewnia spełniania wymagań dostępności oferowanych lub świadczonych usług, o których mowa art. 12–19,
...
4. Wysokość kar pieniężnych, o których mowa ust. 1 i 2, ustala się, uwzględniając zakres naruszenia przepisów ustawy, tym jego wagę, liczbę produktów albo usług niespełniających wymagań dostępności i liczbę osób, na które wpływa ono negatywnie.

5. Kary pieniężne, o których mowa ust. 1 i 2, uiszcza się terminie 14 dni od dnia, którym decyzja o nałożeniu kary pieniężnej stała się ostateczna, na rachunek bankowy Funduszu Dostępności, o którym mowa art. 35 ust. 1 ustawy z dnia 19 lipca 2019 r. o zapewnianiu dostępności osobom ze szczególnymi potrzebami.

6. Egzekucja kar pieniężnych, o których mowa ust. 1 i 2, następuje trybie przepisów o postępowaniu egzekucyjnym administracji, zakresie egzekucji należności pieniężnych.

7. Środki finansowe pochodzące z kar pieniężnych, o których mowa ust. 1 i 2, stanowią przychód Funduszu Dostępności, o którym mowa art. 35 ust. 1 ustawy z dnia 19 lipca 2019 r. o zapewnianiu dostępności osobom ze szczególnymi potrzebami.

#### Rozdział 7 Zmiany przepisach

**Art. 74.** W ustawie z dnia 21 marca 1991 r. o obszarach morskich Rzeczypospolitej Polskiej i administracji morskiej (Dz. U. z 2023 r. poz. 960, 1688 i 2029) art. 42 po ust. 3 dodaje się ust. 3a brzmieniu: „3a. Dyrektorzy urzędów morskich wykonują zadania określone ustawie z dnia 26 kwietnia 2024 r. o zapewnianiu spełniania wymagań dostępności niektórych produktów i usług przez podmioty gospodarcze (Dz. U. poz. 731).”.
...
**Art. 81.** W ustawie z dnia 22 listopada 2013 r. o systemie powiadamiania ratunkowego (Dz. U. z 2023 r. poz. 748) art. 10 po ust. 1 dodaje się ust. 1a brzmieniu: „1a. System teleinformatyczny, o którym mowa ust. 1, spełnia wymagania dostępności określone art. 13 ustawy z dnia 26 kwietnia 2024 r. o zapewnianiu spełniania wymagań dostępności niektórych produktów i usług przez podmioty gospodarcze (Dz. U. poz. 731).”.

**Art. 82.** W ustawie z dnia 5 sierpnia 2015 r. o rozpatrywaniu reklamacji przez podmioty rynku finansowego, o Rzeczniku Finansowym i o Funduszu Edukacji Finansowej (Dz. U. z 2023 r. poz. 1809, 1723 i 1843) wprowadza się następujące zmiany:
...
**Art. 88.** Ustawa wchodzi życie z dniem 28 czerwca 2025 r., z wyjątkiem art. 6 pkt 1, 2 i 5–9 oraz art. 39 pkt 6, które wchodzą życie po upływie 14 dni od dnia ogłoszenia. Prezydent Rzeczypospolitej Polskiej: A. Duda
