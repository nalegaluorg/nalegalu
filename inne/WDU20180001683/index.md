...
2) w § 4:
a) w ust. 1 pkt 1 i 2 otrzymują brzmienie: „1) której przedmiotem jest:
...
d) po ust. 2 dodaje się ust. 2a w brzmieniu: „2a. Pomoc na operację, o której mowa w ust. 1 pkt 1 lit. c, przyznaje się, jeżeli:
...
5) w § 6:
a) ust. 1 otrzymuje brzmienie: „1. Pomoc przyznaje się i wypłaca do wysokości limitu, który w okresie realizacji Programu Rozwoju Obszarów Wiejskich na lata 2014–2020 wynosi 5 500 000 złotych na jednego beneficjenta, z tym że w odniesieniu do:
...
9) w § 12 w ust. 2:
a) pkt 2–5 otrzymują brzmienie: „2) w skład grupy operacyjnej wchodzą różne podmioty należące do co najmniej 4 różnych kategorii wymienionych w § 3 ust. 1 pkt 1 – 2 punkty;
...
d) pkt 8 i 9 otrzymują brzmienie: „8) wnioskowana kwota pomocy wynosi:
...
b) dodaje się ust. 4 w brzmieniu: „4. W dniu zawarcia umowy osoba fizyczna wchodząca w skład grupy operacyjnej nieposiadającej zdolności prawnej składa:
...
b) ust. 1a otrzymuje brzmienie: „1a. Do wniosku o płatność dołącza się:
...
a) ust. 10 i 11 otrzymują brzmienie: „10. Krótkie podsumowanie operacji, zawierające opis celów i głównych zadań do zrealizowania oraz wskazanie oczekiwanych rezultatów (w języku polskim i angielskim).
...
a) ust. 10 i 11 otrzymują brzmienie: „10. Krótkie podsumowanie operacji, zawierające opis celów i głównych zadań, które zostały zrealizowane, oraz wskazanie uzyskanych w ich wyniku rezultatów (w języku polskim i angielskim).
