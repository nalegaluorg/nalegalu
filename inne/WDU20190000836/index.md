...
- **18)** po art. 11g dodaje się art. 11h w brzmieniu: „Art. 11h. W Agencji może być zatrudniona osoba, która: 1) korzysta z pełni praw publicznych; 2) nie była skazana prawomocnym wyrokiem za umyślne przestępstwo lub umyślne przestępstwo skarbowe.”;
...
- **21)** w art. 15:
    - **a)** ust. 2 otrzymuje brzmienie:
      ...
      > a) realizację zadań Agencji, w tym na współfinansowanie programów i projektów finansowanych z udziałem środków europejskich, b) finansowanie lub dofinansowanie inwestycji Agencji;  
