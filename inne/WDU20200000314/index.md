...
1) w § 6:
a) ust. 1 otrzymuje brzmienie: „1. Testy przeprowadzają komisje powoływane w:
...
b) po ust. 1 dodaje się ust. 1a w brzmieniu: „1a. Komisja, o której mowa w ust. 1 pkt 1, przeprowadza test również dla:
...
b) w ust. 2: – pkt 1 otrzymuje brzmienie: „1) Komendant Główny Straży Granicznej w stosunku do:
a) Komendanta BSWSG,
b) kierowników jednostek,
c) kierowników komórek organizacyjnych Komendy Głównej,
d) funkcjonariuszy pozostających w jego dyspozycji;”, – po pkt 1 dodaje się pkt 1a w brzmieniu: „1a) Komendant BSWSG w stosunku do:
