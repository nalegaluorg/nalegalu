...
- **2)** w art. 32: pkt 15 otrzymuje brzmienie: „
    - **a)**

- **15)** w art. 80c w ust. 1 pkt 8 otrzymuje brzmienie: „
- **8)** organom Krajowej Administracji Skarbowej;”; ” , ” , pkt 17 otrzymuje brzmienie: „
    - **b)**
...
- **2)** w art. 14 ust. 9f otrzymuje brzmienie: „ 9f. Jeżeli zasadność zwrotu wymaga dodatkowego zweryfikowania, złożenie do depozytu kwoty zwrotu różnicy podatku następuje po zakończeniu weryfikacji rozliczenia podatnika dokonywanej w ramach czynności sprawdzających, kontroli podatkowej, kontroli celno-skarbowej lub postępowania podatkowego.”; ” , ” , pkt 4 otrzymuje brzmienie: „
    - **b)**

- **4)** użyte w art. 33 w ust. 6 i w art. 37 w ust. 1a wyrazy „naczelnik urzędu celnego” zastępuje się wyrazami „naczelnik urzędu skarbowego właściwy do poboru kwoty należności celnych przywozowych wynikających z długu celnego”; ” , pkt 6 otrzymuje brzmienie: „
    - **c)**

- **6)** użyte w art. 33a w ust. 7 i 9, w różnym przypadku, wyrazy „organ celny” zastępuje się użytymi w odpowiednim przypadku wyrazami „naczelnik urzędu skarbowego właściwy do poboru kwoty należności celnych przywozowych wynikających z długu celnego”; ” , w pkt 9 lit. a otrzymuje brzmienie: „ ust. 1 otrzymuje brzmienie: „ 1. Podatnik jest obowiązany zapłacić różnicę między podatkiem wynikającym z decyzji naczelnika urzędu celno-skarbowego, o których mowa w art. 33 ust. 2 i 3 oraz w art. 34, a podatkiem:
    - **d)**
    - **a)**
...
- **11)** w art. 87: w ust. 2 zdanie drugie otrzymuje brzmienie: „ Jeżeli zasadność zwrotu wymaga dodatkowego zweryfikowania, naczelnik urzędu skarbowego może przedłużyć ten termin do czasu zakończenia weryfikacji rozliczenia podatnika dokonywanej w ramach czynności sprawdzających, kontroli podatkowej, kontroli celno-skarbowej lub postępowania podatkowego. ” , w ust. 4f pkt 2 otrzymuje brzmienie: „
    - **a)**
    - **b)**

- **2)** w przypadku wszczęcia kontroli celno-skarbowej w zakresie rozliczenia, którego dotyczy zabezpieczenie – do upływu terminu 3 miesięcy od dnia zakończenia tej kontroli, a jeżeli w tym terminie doszło do przekształcenia kontroli celno-skarbowej w postępowanie podatkowe w zakresie rozliczenia, którego dotyczy zabezpieczenie – do zakończenia tego postępowania;”; ” , ” , uchyla się pkt 12, po pkt 12 dodaje się pkt 12a w brzmieniu: „
    - **f)**
    - **g)**

- **12a)** użyte w art. 96 w ust. 9 w pkt 4, w art. 105b w ust. 1 w pkt 4, w ust. 11a, w ust. 14, w art. 105c w ust. 9c oraz w art. 112a w ust. 3 i 4, w różnej liczbie i różnym przypadku, wyrazy „organ podatkowy lub organ kontroli skarbowej” zastępuje się użytymi w odpowiedniej liczbie i odpowiednim przypadku wyrazami „naczelnik urzędu skarbowego, naczelnik urzędu celno-skarbowego, dyrektor izby administracji skarbowej lub Szef Krajowej Administracji Skarbowej”; ” , po pkt 13 dodaje się pkt 13a w brzmieniu: „
    - **h)**

- **13a)** użyte w art. 99 w ust. 12, w art. 109 w ust. 2 oraz w art. 110 wyrazy „naczelnik urzędu skarbowego lub organ kontroli skarbowej” zastępuje się wyrazami „organ podatkowy”; ” , pkt 15 otrzymuje brzmienie: „
    - **i)**

- **15)** w art. 105b w ust. 8 pkt 2 otrzymuje brzmienie: „
- **2)** wszczęcia kontroli celno-skarbowej w zakresie rozliczenia, którego dotyczy kaucja gwarancyjna – do upływu terminu 3 miesięcy od dnia zakończenia tej kontroli, a jeżeli w tym terminie doszło do przekształcenia kontroli celno-skarbowej w postępowanie podatkowe w zakresie rozliczenia, którego dotyczy kaucja gwarancyjna – do zakończenia tego postępowania;”; ” , ” , po pkt 16 dodaje się pkt 16a w brzmieniu: „
    - **j)**

- **16a)** w art. 111 w ust. 2 w zdaniu pierwszym wyrazy „naczelnik urzędu skarbowego lub organ kontroli skarbowej” zastępuje się wyrazami „naczelnik urzędu skarbowego lub naczelnik urzędu celno-skarbowego”; ” , uchyla się pkt 17, po pkt 17 dodaje się pkt 17a w brzmieniu: „
    - **k)**
    - **l)**
...
- **4)** w art. 53a: po ust. 4 dodaje się ust. 4a w brzmieniu: „
    - **a)**

4a. Osoby na stanowiska, o których mowa w art. 52 pkt 5, powołuje i odwołuje się według odrębnych przepisów. ” , ust. 5 i 6 otrzymują brzmienie: „
...
- **13)** w art. 202: po ust. 1 dodaje się ust. 1a w brzmieniu: „
    - **a)**

1a. W ramach postępowań kontrolnych, o których mowa w ust. 1 pkt 1, naczelnik urzędu celno-skarbowego może, w drodze decyzji, dokonać zabezpieczenia zobowiązania podatkowego. Przepisy dotychczasowe stosuje się. ” , ust. 3 otrzymuje brzmienie: „
...
- **17)** w art. 260: po pkt 2 dodaje się pkt 2a w brzmieniu: „
    - **a)**

- **2a)** art. 112 pkt 2–4, które wchodzą w życie z dniem 27 lutego 2017 r.; ” , w pkt 3 kropkę zastępuje się średnikiem i dodaje się pkt 4 w brzmieniu: „
    - **b)**
...
- **1)** w art. 21: uchyla się ust. 4, uchyla się ust. 7;
    - **a)**
    - **b)**
...
4. W przypadku funkcjonariusza powołanie albo odwołanie następuje odpowiednio z dniem wskazanym w akcie powołania albo odwołania. ” , ust. 7 otrzymuje brzmienie: „
