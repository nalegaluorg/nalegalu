...
- **2)** suplementy diety,
- **3)** środki spożywcze wzbogacane substancjami określonymi na podstawie art. 9 ust. 4 pkt 3 niu do obrotu określonych środków spożywczych, przedkładając równocześnie wzór ich etykiety.”;
...
- **22)** w art. 28:
    - **a)** ust. 2 otrzymuje brzmienie: sprawdzenia:
...
- **32)** w art. 40:
    - **a)** po ust. 2 dodaje się ust. 2a w brzmieniu: do spraw rolnictwa, o których mowa w ust. 1 i 2, obejmują zarządzanie ryzykiem w zakresie dotyczącym bezpieczeństwa żywności przy udziale organów urzędowej kontroli żywności.”,
...
- **3)** po dwóch przedstawicieli ministra właściwego do spraw zdrowia oraz ministra właściwego do spraw rolnictwa, wiska oraz Prezesa Urzędu Ochrony Konkurencji i Konsumentów.
...
2. Główny Inspektor Sanitarny kieruje siecią systemu RASFF oraz: „KPK”,
...
- **1)** składowania w miejscu i na warunkach określonych przez państwowego granicznego inspektora sanitarnego do czasu uzyskania wyników badań pobranych próbek albo kontroli jakości zdrowotnej przez właściwy organ Państwowej Inspekcji Sanitarnej.
...
- **2)** w porozumieniu z ministrem właściwym do spraw finansów publicznych - sposób współpracy organów Państwowej Inspekcji Sanitarnej z organami celnymi w zakresie granicznej kontroli sanitarnej państwa i zapewnienie właściwej jakości zdrowotnej artykułów, o których mowa w ust. 1.
...
- **41)** w art. 61:
    - **a)** uchyla się pkt 1, „2) art. 10 ust. 3, art. 28 ust. 2-4, art. 30 oraz art. 48 ust. 1 w zakresie wprowadzania zasad systemu HACCP obowiązują od dnia uzyskania przez Rzeczpospolitą Polską członkostwa w Unii Europejskiej.”;
