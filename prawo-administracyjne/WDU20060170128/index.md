...
*USTAWA z dnia 27 stycznia 2006 r.*

| Pole | Wartość |
|---|---|
| Adres publikacyjny | Dz.U. 2006 nr 17 poz. 128 |
| ISAP | WDU20060170128 |
| Typ aktu | Ustawa |
| Status | obowiązujący |
| W mocy | tak |
...
- **1)** w art. 26 ust. 1 otrzymuje brzmienie: „1. W razie konieczności przeprowadzenia wyborów danej rady przed upływem kadencji z przyczyn określonych w ustawach, wybory zarządza się i przeprowadza w ciągu 90 dni od wystąpienia tej przyczyny. Przepisy art. 25 stosuje się odpowiednio, z tym że w kalendarzu wyborczym terminy wykonania czynności wyborczych mogą być krótsze od przewidzianych w ustawie.”;
- **2)** w art. 196 ust. 3 otrzymuje brzmienie: „3. Wyborów przedterminowych nie przeprowadza się, jeżeli ich data przypadałaby w okresie 12 miesięcy przed zakończeniem kadencji rad.”.
