...
| Pole | Wartość |
|---|---|
| Adres publikacyjny | Dz.U. 2011 nr 161 poz. 966 |
| ISAP | WDU20111610966 |
| Typ aktu | Ustawa |
| Status | akt objęty tekstem jednolitym |
| W mocy | tak |
...
| Źródło | [ISAP](https://isap.sejm.gov.pl/isap.nsf/DocDetails.xsp?id=WDU20111610966) · [PDF](https://api.sejm.gov.pl/eli/acts/DU/2011/966/text.pdf) |
...
- **3)** art. 4–6 otrzymują brzmienie: „Art. 4. 1. Prezes Rady Ministrów i ministrowie prowadzą odpowiednio wykazy prac legislacyjnych obejmujące projekty rozporządzeń Prezesa Rady Ministrów i ministrów.
...
- **b)** w ust. 4 pkt 1 otrzymuje brzmienie: „1) imiona i nazwiska oraz adresy osób uprawnionych do reprezentowania tego podmiotu w pracach nad projektem założeń projektu ustawy, projektem ustawy lub projektem rozporządzenia;”,
- **c)** ust. 6 i 7 otrzymują brzmienie: „6. Podmioty, które zgłosiły zainteresowanie pracami nad projektem założeń projektu ustawy, projektem ustawy lub projektem rozporządzenia, są obowiązane zgłosić zmiany danych podlegających zgłoszeniu w terminie 7 dni od dnia ich wystąpienia odpowiednio organowi odpowiedzialnemu za:
- **1)** przedłożenie projektu założeń projektu ustawy lub projektu ustawy Radzie Ministrów;
- **2)** opracowanie projektu rozporządzenia.
