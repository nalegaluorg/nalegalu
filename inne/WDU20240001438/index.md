...
| Źródło | [ELI HTML](https://eli.gov.pl/api/acts/DU/2024/1438/text.html) · [ELI API](https://api.sejm.gov.pl/eli/acts/DU/2024/1438) |

## Spis treści

- [Treść rozporządzenia](#part_1) [Rozdział 1 - Przepisy ogólne](#chpt_1) [Rozdział 2 - Pomoc w ramach wyłączeń grupowych na prowadzenie badań podstawowych, badań przemysłowych i eksperymentalnych prac rozwojowych oraz przygotowanie studiów wykonalności](#chpt_2) [Rozdział 3 - Pomoc w ramach wyłączeń grupowych na wspieranie innowacyjności](#chpt_3) [Rozdział 4 - Pomoc w ramach wyłączeń grupowych na prowadzenie badań podstawowych, badań przemysłowych i eksperymentalnych prac rozwojowych w sektorze rybołówstwa i akwakultury](#chpt_4) [Rozdział 5 - Pomoc w ramach wyłączeń grupowych na wspieranie przedsiębiorców rozpoczynających prowadzenie działalności B+R+I](#chpt_5) [Rozdział 6 - Pomoc w ramach wyłączeń grupowych na usługi doradcze](#chpt_6) [Rozdział 7 - Pomoc w ramach wyłączeń grupowych na wspieranie wdrażania wyników badań podstawowych, badań przemysłowych i eksperymentalnych prac rozwojowych przez finansowanie inwestycji początkowych oraz inwestycji początkowych, które zapoczątkowują nową działalność gospodarczą na danym obszarze](#chpt_7) [Rozdział 8 - Pomoc de minimis](#chpt_8) [Rozdział 9 - Przepis przejściowy i przepis końcowy](#chpt_9)

TOC

## Treść rozporządzenia

Na podstawie art. 34l ust. 2 ustawy z dnia 21 lutego 2019 r. o Sieci Badawczej Łukasiewicz ([Dz. U. z 2024 r. poz. 925](https://api.sejm.gov.pl/eli/acts/DU/2024/925/text.html) i [1089](https://api.sejm.gov.pl/eli/acts/DU/2024/1089/text.html)) zarządza się, co następuje:
...
określenia w dokumentacji, o której mowa w art. 10 ust. 1 ustawy z dnia 29 września 1994 r. o rachunkowości ([Dz. U. z 2023 r. poz. 120](https://api.sejm.gov.pl/eli/acts/DU/2023/120/text.html), [295](https://api.sejm.gov.pl/eli/acts/DU/2023/295/text.html) i [1598](https://api.sejm.gov.pl/eli/acts/DU/2023/1598/text.html) oraz [z 2024 r. poz. 619](https://api.sejm.gov.pl/eli/acts/DU/2024/619/text.html)), sposobu zapewnienia rozdzielności rachunkowej, w tym określenia metod przypisywania przychodów i kosztów, zgodnie z pkt 1.
