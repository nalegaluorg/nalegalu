...
- **1)** w art. 3 po ust. 1 dodaje się ust. 1a w brzmieniu: „1a. Przepisy ustawy stosuje się do kontroli przez Inspekcję Transportu Drogowego:
...
- **4)** w art. 46: 43, oraz wpływy z opłat z tytułu:”,
    - **a)** w ust. 1 wprowadzenie do wyliczenia otrzymuje brzmienie: „Wpływy uzyskane z opłat, o których mowa w art. 41 ust. 1 pkt 7–9 i art.
...
- **6)** w art. 50: 13 ust. 1 pkt 3 ustawy z dnia 21 marca 1985 r. o drogach publicznych;”,
    - **a)** w pkt 1 po lit. i średnik zastępuje się przecinkiem i dodaje się lit. j w brzmieniu: „j) prawidłowości uiszczenia opłaty elektronicznej, o której mowa w art.
    - **b)** uchyla się pkt 9;

- **7)** art. 51 otrzymuje brzmienie: „Art. 51. 1. Zadania Inspekcji Transportu Drogowego określone w niniejszym rozdziale wykonują następujące organy:
...
- **9)** art. 56 otrzymuje brzmienie: „Art. 56. 1. Inspektor ma prawo do nakładania i pobierania kar pieniężnych oraz grzywien w drodze mandatów karnych:
...
- **10)** w art. 68 ust. 1 otrzymuje brzmienie: „1. Kontroli, o której mowa w art. 50 i art. 87, z zastrzeżeniem ust. 2, podlegają:
...
- **11)** w art. 69:
    ...
    - **b)** ust. 3a otrzymuje brzmienie: „3a. Minister właściwy do spraw transportu, w porozumieniu z ministrem właściwym do spraw finansów publicznych, mając na względzie zakres zadań i sposób ich realizacji przez osoby, o których mowa w ust. 2, określi, w drodze rozporządzenia:
...
- **12)** w art. 76:
    - **a)** po ust. 2 dodaje się ust. 2a–2c w brzmieniu: „2a. Zatrudnienie pracownika Inspekcji na stanowisku inspektora następuje w ramach służby nadzoru nad ruchem drogowym, służby kontroli opłat drogowych albo służby kontroli transportu drogowego.
...
- **14)** w art. 80:
    - **a)** ust. 2 otrzymuje brzmienie: „2. W ewidencji gromadzi się odpowiednio do rodzaju, przedmiotu i zakresu przeprowadzonej kontroli w szczególności:
