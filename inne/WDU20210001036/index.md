...
# RZECZYPOSPOLITEJ POLSKIEJ Poz. 1036 ROZPORZĄDZENIE MINISTRA EDUKACJI I NAUKI z dnia 4 czerwca 2021 r.
...
- **1)** w „BRANŻY BUDOWLANEJ (BUD)” pozycja dotycząca zawodu „Technik gazownictwa” o symbolu cyfrowym 311913 otrzymuje brzmienie: Technik 311913 IV energii X BUD.28. 4 X gazownictwa Organizacja i wykonywanie robót związanych z budową i eksploatacją sieci gazowych BUD.29. 4 X Organizacja i wykonywanie robót związanych z budową i eksploatacją instalacji gazowych
- **2)** w „BRANŻY MECHANICZNEJ (MEC)” pozycja dotycząca zawodu „Technik spawalnictwa” o symbolu cyfrowym 311516 otrzymuje brzmienie: Technik 311516 V gospodarki, X X MEC.03. 3 X spawalnictwa gospodarki Montaż i obsługa maszyn morskiej i urządzeń albo MEC.04. 3 X Montaż systemów rurociągowych albo MEC.08. 3 X Wykonywanie i naprawa elementów maszyn, urządzeń i narzędzi albo TWO.03. 3 X Wykonywanie i montaż elementów kadłuba jednostek pływających MEC.10. 5 X Organizacja i wykonywanie prac spawalniczych
