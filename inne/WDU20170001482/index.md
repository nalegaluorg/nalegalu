...
# RZECZYPOSPOLITEJ POLSKIEJ Poz. 1482 ROZPORZĄDZENIE MINISTRA SPRAW WEWNĘTRZNYCH I ADMINISTRACJI z dnia 13 lipca 2017 r.
...
w sprawie używania wyrobów tytoniowych na terenie obiektów jednostek organizacyjnych lub organów podległych lub nadzorowanych przez ministra właściwego do spraw wewnętrznych oraz urzędu obsługującego tego ministra Na podstawie art. 5a ust. 2 ustawy z dnia 9 listopada 1995 r. o ochronie zdrowia przed następstwami używania tytoniu i wyrobów tytoniowych (Dz. U. z 2017 r. poz. 957) zarządza się, co następuje:
...
§ 3. 1. Używanie wyrobów tytoniowych w obiektach jest dopuszczalne tylko w miejscach wyznaczonych do tego celu przez kierowników tych obiektów, spełniających wymagania określone dla palarni w rozumieniu art. 2 pkt 15 ustawy z dnia 9 listopada 1995 r. o ochronie zdrowia przed następstwami używania tytoniu i wyrobów tytoniowych.
...
§ 5. 1. W pomieszczeniach hotelowych i innych ośrodkach czasowego pobytu używanie wyrobów tytoniowych jest możliwe w palarniach lub w pokojach służących celom mieszkalnym, wyznaczonych przez zarządzających tymi obiektami.
...
§ 6. 1. Zabrania się używania wyrobów tytoniowych w oznakowanych środkach przewozu osób używanych przez podmioty, o których mowa w § 1.
...
§ 8. 1. Używanie wyrobów tytoniowych jest możliwe w palarniach lub w pomieszczeniach służących celom mieszkalnym, wyznaczonych przez zarządzających tymi obiektami:
