...
- **2)** w art. 27: w ust. 3 w pkt 4 średnik zastępuje się kropką i uchyla się pkt 5 i 6, po ust. 3 dodaje się ust. 3a i 3b w brzmieniu: „
    - **a)**
    - **b)**

3a. W trakcie wykonywanej kontroli Prezes Urzędu może, w drodze decyzji administracyjnej, dokonać:

- **1)** zabezpieczenia statku powietrznego, w celu niedopuszczenia do jego używania, jeżeli: statek ten znajduje się w nieodpowiednim stanie technicznym, jest używany przez osoby nieuprawnione lub w przypadku gdy stwierdzono naruszenie zasad bezpiecznego użytkowania statków powietrznych, statek ten zagrożony jest aktem bezprawnej ingerencji, nie okazano dokumentu stwierdzającego zawarcie umowy obowiązkowego ubezpieczenia odpowiedzialności cywilnej lub stwierdzającego opłacenie składki tego ubezpieczenia – jeżeli obowiązek zawarcia umowy obowiązkowego ubezpieczenia odpowiedzialności cywilnej wynika z przepisów dotyczących ubezpieczeń w odniesieniu do przewoźników lotniczych i użytkowników statków powietrznych;
    - **a)**
    - **b)**
    - **c)**
