...
source: "eli-html"
---
# Rozporządzenie Ministra Cyfryzacjiz dnia 28 września 2023 r. w sprawie określenia grup nauczycieli, wychowawców i innych pracowników pedagogicznych uprawnionych do otrzymania wsparcia sfinansowanego ze środków publicznych [1) Minister Cyfryzacji kieruje działem administracji rządowej - informatyzacja, na podstawie § 1 ust. 2 rozporządzenia Prezesa Rady Ministrów z dnia 26 kwietnia 2023 r. w sprawie szczegółowego zakresu działania Ministra Cyfryzacji (Dz. U. poz. 792).](#gloss-0:1:)

| Pole | Wartość |
|---|---|
| Adres publikacyjny | Dz.U. 2023 poz. 2071 |
| ISAP | WDU20230002071 |
...
| Źródło | [ELI HTML](https://eli.gov.pl/api/acts/DU/2023/2071/text.html) · [ELI API](https://api.sejm.gov.pl/eli/acts/DU/2023/2071) |

## Treść rozporządzenia

Na podstawie art. 2 ust. 2 ustawy z dnia 7 lipca 2023 r. o wsparciu rozwoju kompetencji cyfrowych uczniów i nauczycieli ([Dz. U. poz. 1369](https://api.sejm.gov.pl/eli/acts/DU/2023/1369/text.html)) zarządza się, co następuje:
...
kolejność otrzymania wsparcia przez grupy, o których mowa w pkt 1.

### § 2.

### 1.

Określa się następujące grupy nauczycieli, wychowawców i innych pracowników pedagogicznych ze szkół, o których mowa w § 1 pkt 1, którzy są uprawnieni do otrzymania wsparcia polegającego na otrzymaniu jednorazowych świadczeń w formie bonów na zakup laptopów lub laptopów przeglądarkowych:
...
Określa się następującą kolejność wsparcia dla grup, o których mowa w ust. 1:

### 1)

pkt 1 - na dzień 10 października 2023 r.,

### 2)

pkt 2 - na dzień 11 października 2023 r.,

### 3)

pkt 3 - na dzień 12 października 2023 r.,

### 4)

pkt 4 - na dzień 13 października 2023 r.
