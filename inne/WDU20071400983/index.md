...
- **2)** art. 36 otrzymuje brzmienie:
  ...
  > a) wskazanie tematu prowadzonych badań naukowych, b) rekomendację pracownika naukowego uprawnionego do prowadzenia badań naukowych w dyscyplinach nauk humanistycznych, społecznych, gospodarki lub prawa w przypadku osób niebędących takimi pracownikami;  
  > 3) w ust. 1 pkt 3 - powinien zawierać również:  
  > a) wskazanie tematu materiału prasowego, b) załączone upoważnienie redakcji albo wydawcy do wystąpienia z wnioskiem.  
