...
# RZECZYPOSPOLITEJ POLSKIEJ Poz. 763 ROZPORZĄDZENIE MINISTRA GOSPODARKI MORSKIEJ I ŻEGLUGI ŚRÓDLĄDOWEJ z dnia 17 kwietnia 2020 r.
...
w sprawie rejestracji jachtów i innych jednostek pływających o długości do 24 m Na podstawie art. 13 ustawy z dnia 12 kwietnia 2018 r. o rejestracji jachtów i innych jednostek pływających o długości do 24 m (Dz. U. poz. 1137 oraz z 2019 r. poz. 1716) zarządza się, co następuje:
...
§ 3. 1. Informacją o rodzaju napędu jednostki pływającej jest:
...
§ 5. 1. Dokumentem lub materiałem potwierdzającym informacje:
...
§ 10. 1. Numer rejestracyjny jednostki pływającej tworzą:
...
Minister Gospodarki Morskiej i Żeglugi Śródlądowej: M. Gróbarczyk WZÓR …………………… ZAŚWIADCZENIE Certificate …………………………… ………………………………… Załącznik nr 2 WZÓR DOKUMENTU REJESTRACYJNEGO JEDNOSTKI PŁYWAJĄCEJ Wzór dokumentu rejestracyjnego jednostki pływającej Załącznik nr 2 Awers Wzór dokumentu rejestracyjnego Awers jednostki pływającej Awers Rewers Rewers Rewers
...
1. Dokument 1) PN-ISO/IEC rejestracyjny 7810 : 2006. jednostki Karty identyfikacyjne. pływającej ma Charakterystyki formę karty formatu fizyczne; ID1 (układ poziomy) o wymiarach 53,98 x 85,60 mm, promieniu zaokrągleń 3,18 mm i grubości 0,76 mm (+80 μm/-300 μm),
1. której Dokument 2) PN-EN inne właściwości rejestracyjny ISO/IEC 10373 fizyczne jednostki : 2008. i chemiczne pływającej Karty identyfikacyjne. odpowiadają ma formę karty standardom Metody formatu testowania. określonym ID1 (układ w poziomy) normach: o wymiarach 53,98 × 85,60 mm, promieniu zaokrągleń 3,18 mm i grubości 0,76 mm (+80 μm/−300 μm), której inne właściwości fizyczne i chemiczne 2. Dokument 1) PN-ISO/IEC odpowiadają rejestracyjny 7810 standardom : 2006. jednostki określonym Karty pływającej identyfikacyjne. w normach: wykonany Charakterystyki jest z poliwęglanu. fizyczne; Tworzywo wykorzystane do produkcji dokumentu nie wykazuje luminacji w promieniowaniu ultrafioletowym, umożliwia trwałe
1) naniesienie PN-ISO/IEC 2) PN-EN 7810 ISO/IEC szaty : 2006. 10373 graficznej, Karty : identyfikacyjne. 2008. danych Karty identyfikacyjne. Charakterystyki personalnych, Metody fizyczne; identyfikacyjnych testowania. oraz elementów zabezpieczających wewnątrz struktury wielowarstwowej karty.
2) 2. PN-EN Dokument ISO/IEC rejestracyjny 10373 : 2008. jednostki Karty identyfikacyjne. pływającej wykonany Metody testowania. jest z poliwęglanu. Tworzywo wykorzystane do 3. Barwa produkcji tła dokumentu dokumentu nie rejestracyjnego wykazuje luminacji jednostki w promieniowaniu pływającej jest ultrafioletowym, utrzymana w tonacji umożliwia niebiesko- trwałe
2. naniesienie beżowej Dokument z wielobarwnymi rejestracyjny szaty graficznej, jednostki nadrukami pływającej danych zabezpieczającymi, wykonany personalnych, jest z tj.: poliwęglanu. identyfikacyjnych Tworzywo wykorzystane oraz elementów do produkcji dokumentu zabezpieczających nie wykazuje luminacji wewnątrz w struktury promieniowaniu wielowarstwowej ultrafioletowym, karty. umożliwia trwałe naniesienie szaty graficznej, danych personalnych, identyfikacyjnych oraz elementów zabezpieczających wewnątrz struktury wielowarstwowej karty.
3. Barwa tła dokumentu rejestracyjnego jednostki pływającej jest utrzymana w tonacji niebieskobeżowej z wielobarwnymi nadrukami zabezpieczającymi, tj.:
