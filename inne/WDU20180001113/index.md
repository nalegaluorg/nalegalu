...
# RZECZYPOSPOLITEJ POLSKIEJ Poz. 1113 ROZPORZĄDZENIE MINISTRA SPRAW WEWNĘTRZNYCH I ADMINISTRACJI z dnia 5 czerwca 2018 r.
...
w sprawie umundurowania funkcjonariuszy Służby Ochrony Państwa Na podstawie art. 132 ust. 5 ustawy z dnia 8 grudnia 2017 r. o Służbie Ochrony Państwa (Dz. U. z 2018 r. poz. 138, 650 i 730) zarządza się, co następuje:
...
8) okres używalności przedmiotów umundurowania podlegających zwrotowi w przypadku zwolnienia ze służby – funkcjonariuszy Służby Ochrony Państwa, zwanych dalej „funkcjonariuszami”.
...
4) reprezentacyjnego;
5) specjalnego.
§ 3. 1. Przedmiotami umundurowania należącymi do ubioru galowego są:
1) beret;
2) czapka futrzana;
3) mundur;
...
§ 4. 1. Przedmiotami umundurowania należącymi do ubioru wyjściowego są:
1) beret;
2) czapka futrzana;
3) mundur;
4) koszula koloru białego z długimi rękawami;
...
§ 5. 1. Przedmiotami umundurowania należącymi do ubioru służbowo - polowego są:
1) czapka polowa;
2) czapka zimowa;
3) mundur polowy;
...
§ 6. 1. Przedmiotami umundurowania należącymi do ubioru reprezentacyjnego są:
1) beret;
2) czapka futrzana;
3) mundur;
4) koszula koloru białego z długimi rękawami;
...
§ 7. 1. Przedmiotami umundurowania należącymi do ubioru specjalnego są:
...
§ 8. 1. Nakryciami głowy z wizerunkiem orła są:
1) beret;
2) czapka polowa;
3) czapka futrzana;
4) czapka zimowa;
...
§ 9. 1. Do ubioru galowego i wyjściowego funkcjonariusze-kobiety zamiast obuwia typu męskiego koloru czarnego otrzymują obuwie damskie koloru czarnego – czółenka i kozaki.
...
§ 11. 1. Funkcjonariusze otrzymują przedmioty umundurowania zgodnie z normami zawartymi w zestawach.
2. Normy należności umundurowania oraz normy ubrania typu cywilnego są określone w załączniku nr 8 do rozporządzenia.
§ 12. 1. Przedmioty umundurowania wydaje się stosownie do okresów używalności.
...
§ 14. 1. Pierwsze wydanie przedmiotów umundurowania określonego w zestawie nr 1 norm należności określonych w załączniku nr 8 do rozporządzenia następuje w naturze, a w następnym roku zaopatrzeniowym funkcjonariusz otrzymuje za nie równoważnik pieniężny.
...
§ 15. 1. Rok zaopatrzeniowy trwa od dnia 1 kwietnia danego roku kalendarzowego do dnia 31 marca kolejnego roku kalendarzowego.
...
12) płaszcz letni w składzie ubioru galowego (Komendant Służby Ochrony Państwa, jego zastępcy i dyrektorzy zarządów) nosi się tak, aby odległość od podłoża do dolnej krawędzi płaszcza wynosiła (w zależności od wzrostu) 420–520 mm;
rękawy płaszcza powinny być na tyle długie, żeby zakrywały rękawy kurtki, jednak przy opuszczonej ręce nie powinny sięgać dalej niż do nasady kciuka;
...
§ 17. 1. Przedmioty umundurowania wchodzące w skład ubiorów funkcjonariusze noszą z uwzględnieniem okresu letniego trwającego od dnia 1 maja do dnia 31 października i okresu zimowego trwającego od dnia 1 listopada do dnia 30 kwietnia.
...
5) identyfikacyjne.
§ 20. 1. Oznaki stopni nosi się na:
1) beretach;
...
§ 21. 1. Oznakę Służby Ochrony Państwa nosi się na:
...
§ 22. 1. Oznaki przynależności państwowej nosi się:
...
§ 23. 1. Oznaki rozpoznawcze Służby Ochrony Państwa nosi się na:
...
§ 24. 1. Oznaki identyfikacyjne z nazwiskiem nosi się do wszystkich ubiorów bezpośrednio nad klapą prawej górnej kieszeni.
...
Minister Spraw Wewnętrznych i Administracji: wz. K. Kozłowski Załączniki do rozporządzenia Ministra Spraw Wewnętrznych i Administracji …….) Załącznik nr 1 WZORY UBIORU GALOWEGO WZORY UBIORU GALOWEGO
a) ubiór galowy funkcjonariusza z beretem
a) ubiór galowy funkcjonariusza z beretem
b) ubiór galowy funkcjonariusza z czapką futrzaną w płaszczu sukiennym
b) ubiór galowy funkcjonariusza z czapką futrzaną w płaszczu sukiennym
c) ubiór galowy funkcjonariusza w płaszczu letnim Załącznik nr 2 WZORY WZORY UBIORU UBIORU WYJŚCIOWEGO WYJŚCIOWEGO
a) ubiór a) ubiór wyjściowy wyjściowy funkcjonariusza funkcjonariusza z beretem z beretem
...
c) ubiór wyjściowy funkcjonariusza z beretem i w kurtce ochronnej z membraną paroprzepuszczalną
d) ubiór wyjściowy funkcjonariusza z koszulą koloru białego z krótkimi rękawami i naramiennikami oraz
d) z krawatem ubiór wyjściowy funkcjonariusza z koszulą koloru białego z krótkimi rękawami i naramiennikami oraz z krawatem
e) ubiór wyjściowy funkcjonariusza z koszulą koloru białego z krótkimi rękawami i naramiennikami oraz z krawatem
e) ubiór wyjściowy funkcjonariusza z koszulą koloru białego z krótkimi rękawami i naramiennikami oraz z krawatem Załącznik nr 3 WZORY UBIORU SŁUŻBOWO-POLOWEGO WZORY UBIORU SŁUŻBOWO-POLOWEGO
...
g) ubiór służbowo-polowy funkcjonariusza z czapką polową, koszulką z krótkimi rękawami i spodniami polowymi Załącznik nr 4 WZORY UBIORU REPREZENTACYJNEGO WZORY UBIORU REPREZENTACYJNEGO
a) ubiór reprezentacyjny funkcjonariusza
a) ubiór reprezentacyjny funkcjonariusza
b) ubiór reprezentacyjny funkcjonariusza w płaszczu sukiennym
b) ubiór reprezentacyjny funkcjonariusza w płaszczu sukiennym Załącznik nr 5 WZORY UBIORU SPECJALNEGO WZORY UBIORU SPECJALNEGO
a) ubiór funkcjonariusza wykonującego zadania ochronne z zakresu zabezpieczenia
a) ubiór funkcjonariusza wykonującego zadania ochronne z zakresu zabezpieczenia pirotechniczno-radiologicznego, pirotechniczno-radiologicznego, biochemicznego i sanitarnego biochemicznego w okresie letnim i sanitarnego w okresie letnim
...
j) ubiór funkcjonariusza obsługującego warsztaty remontowe i magazyny w okresie zimowym Załącznik nr 6 WZORY NAKRYĆ GŁOWY Z WIZERUNKAMI ORŁA WZORY NAKRYĆ GŁOWY Z WIZERUNKAMI ORŁA
1) beret
1) beret
2) czapka polowa
2) czapka polowa
...
4) czapka pirotechnika
5) czapka zimowa
5) czapka zimowa Załącznik nr 7 WZORY OBUWIA WZORY OBUWIA czółenka damskie czółenka damskie kozaki damskie kozaki damskie trzewiki trzewiki zimowe zimowe funkcjonariusza funkcjonariusza półbuty funkcjonariusza półbuty funkcjonariusza W M W M M W W W W Załącznik nr 10 SPOSÓB ROZMIESZCZENIA OZNAK STOPNI NA POCHEWKACH NA NARAMIENNIKI I PODKŁADKACH SPOSÓB ROZMIESZCZENIA OZNAK STOPNI NA POCHEWKACH NA NARAMIENNIKI I PODKŁADKACH
1) sposób 1) sposób rozmieszczenia rozmieszczenia oznak stopni oznak na pochewkach stopni na na pochewkach naramienniki: na naramienniki:
a) szeregowy SOP b) starszy szeregowy SOP c) kapral SOP
a) szeregowy SOP b) starszy szeregowy SOP c) kapral SOP
d) plutonowy d) plutonowy SOP SOP e) sierżant e) sierżant SOP SOP f) starszy f) starszy sierżant sierżant SOP SOP
g) młodszy g) młodszy chorąży chorąży SOP SOP h) h) chorąży chorąży SOP SOP i) starszy i) starszy chorąży chorąży SOP SOP
j) j) podporucznik podporucznik SOP SOP k) porucznik k) porucznik SOP SOP l) l) kapitan kapitan SOP SOP
m) major SOP n) podpułkownik SOP o) pułkownik SOP
m) major SOP n) podpułkownik SOP o) pułkownik SOP
p) generał brygady SOP r) generał dywizji SOP
p) generał brygady SOP r) generał dywizji SOP
2) 2) sposób sposób rozmieszczenia rozmieszczenia oznak oznak stopni stopni na podkładkach na podkładkach na mundury na i kurtki: mundury i kurtki:
a) szeregowy SOP b) starszy szeregowy SOP
a) szeregowy SOP b) starszy szeregowy SOP
c) kapral SOP c) kapral SOP d) plutonowy d) plutonowy SOP SOP
e) sierżant SOP e) sierżant SOP f) starszy f) sierżant starszy sierżant SOP SOP
g) młodszy g) chorąży młodszy SOP chorąży SOP h) chorąży h) SOP chorąży SOP
i) starszy chorąży i) starszy SOP chorąży SOP j) podporucznik j) podporucznik SOP SOP
k) porucznik k) SOP porucznik SOP l) kapitan SOP l) kapitan SOP
m) major SOP n) podpułkownik SOP
m) major SOP n) podpułkownik SOP
o) pułkownik SOP p) generał brygady SOP
o) pułkownik SOP p) generał brygady SOP
r) generał dywizji SOP
r) generał dywizji SOP
3) sposób rozmieszczenia oznak stopni na podkładkach na beretach:
3) sposób rozmieszczenia oznak stopni na podkładkach na beretach:
a) starszy a) szeregowy starszy szeregowy SOP SOP b) kapral b) kapral SOP SOP
c) plutonowy c) SOP plutonowy SOP d) sierżant SOP d) sierżant SOP
e) starszy sierżant SOP f) młodszy chorąży SOP
e) starszy sierżant SOP f) młodszy chorąży SOP
g) chorąży SOP g) chorąży SOP h) starszy h) starszy chorąży chorąży SOP SOP
i) podporucznik i) podporucznik SOP SOP j) porucznik j) porucznik SOP SOP
k) kapitan SOP k) kapitan SOP l) major SOP l) major SOP
m) podpułkownik m) podpułkownik SOP SOP n) n) pułkownik pułkownik SOP SOP
o) generał o) brygady generał SOP brygady SOP p) generał p) generał dywizji dywizji SOP SOP Załącznik nr 11 WZÓR OZNAKI SŁUŻBY OCHRONY PAŃSTWA WZÓR OZNAKI SŁUŻBY OCHRONY PAŃSTWA Dziennik Ustaw – 82 – Załącznik nr Poz. 12 1113 WZORY OZNAK PRZYNALEŻNOŚCI PAŃSTWOWEJ WZORY OZNAK PRZYNALEŻNOŚCI PAŃSTWOWEJ
...
3) oznaka przynależności państwowej w postaci naszywki z godłem Rzeczypospolitej Polskiej Załącznik nr 13 WZORY OZNAK ROZPOZNAWCZYCH SŁUŻBY OCHRONY PAŃSTWA WZORY OZNAK ROZPOZNAWCZYCH SŁUŻBY OCHRONY PAŃSTWA
a) oznaka rozpoznawcza SOP w kolorach kamuflażowych
a) oznaka rozpoznawcza SOP w kolorach kamuflażowych
b) oznaka rozpoznawcza SOP
b) oznaka rozpoznawcza SOP Załącznik nr 14 WZÓR OZNAKI IDENTYFIKACYJNEJ WZÓR OZNAKI IDENTYFIKACYJNEJ
a) długość – 80 mm,
b) szerokość – 13 mm,
