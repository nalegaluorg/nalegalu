...
- **2)** w art. 2 w ust. 1: pkt 33 otrzymuje brzmienie: „
    - **a)**

- **33)** uznany system certyfikacji – system certyfikacji gwarantujący spełnienie kryteriów zrównoważonego rozwoju określonych w art. 28b-28bc, zatwierdzony przez Komisję Europejską w drodze decyzji; ” , pkt 39 i 40 otrzymują brzmienie: „
    - **b)**
...
- **3)** w art. 22: ust. 2a otrzymuje brzmienie: „
    - **a)**
...
- **5)** w art. 28b: w ust. 1 wprowadzenie do wyliczenia otrzymuje brzmienie: „ Biokomponenty spełniają kryterium ograniczenia emisji gazów cieplarnianych, jeżeli ograniczenie emisji gazów cieplarnianych wynosi co najmniej: ” , ust. 2 otrzymuje brzmienie: „
    - **a)**
    - **b)**
...
- **3)** obszarów trawiastych o wysokiej bioróżnorodności: naturalnych, czyli obszarów trawiastych, które pozostaną takimi obszarami jeżeli nie dojdzie do interwencji człowieka i które zachowają naturalny skład gatunkowy oraz cechy i procesy ekologiczne, nienaturalnych, czyli obszarów trawiastych, które przestaną być takimi obszarami na skutek braku interwencji człowieka i są bogate gatunkowo oraz nie są zdegradowane, chyba że zbiory surowców rolniczych są konieczne, aby mogły zachować status obszarów trawiastych.
    - **a)**
    - **b)**
...
- **2)** w art. 9a: po ust. 7 dodaje się ust. 7a-7c w brzmieniu: „
    - **a)**
...
7c. Potwierdzenie spełnienia kryteriów zrównoważonego rozwoju, o których mowa w art. 28b-28bc ustawy o biokomponentach i biopaliwach ciekłych, odbywa się przez system bilansu masy, o którym mowa w art. 9s1 ust. 5. ” , w ust. 8b pkt 4 otrzymuje brzmienie: „
...
- **4)** art. 9s1 otrzymuje brzmienie: „ Art. 9s1.

1. Biopłyny mogą być zaliczone na poczet realizacji krajowego celu, o którym mowa w art. 20a ust. 2 pkt 1, wyłącznie wtedy, gdy spełniają one kryteria zrównoważonego rozwoju, o których mowa w art. 28b-28bd ustawy o biokomponentach i biopaliwach ciekłych. 900, 942, 1101 i 1662.
...
- **5)** w art. 20a w ust. 2: pkt 1 otrzymuje brzmienie: „
    - **a)**

- **1)** krajowy cel w zakresie udziału energii ze źródeł odnawialnych w końcowym zużyciu energii brutto; ” , po pkt 1 dodaje się pkt 1a w brzmieniu: „
    - **b)**
...
1. Minister właściwy do spraw gospodarki jest obowiązany do udostępniania informacji o kosztach i korzyściach wynikających ze stosowania urządzeń i systemów grzewczych, chłodniczych i elektrycznych, wykorzystujących energię ze źródeł odnawialnych.

2. Informacje, o których mowa w ust. 1, udostępnia się w formie ustnej, pisemnej lub elektronicznej. Minister właściwy do spraw gospodarki przy udziale jednostek samorządu terytorialnego opracowuje programy informacyjne, doradcze lub szkoleniowe informujące społeczeństwo o korzyściach i rozwiązaniach praktycznych związanych z rozwojem i wykorzystaniem energii ze źródeł odnawialnych. Minister właściwy do spraw gospodarki zapewnia dostęp do informacji i wytycznych o sposobach optymalnego połączenia odnawialnych źródeł energii, wysoko efektywnych technologii oraz systemów grzewczych i chłodniczych. ” ;
...
- **9)** w art. 52: ust. 1 otrzymuje brzmienie: „
    - **a)**

1. Producenci i importerzy urządzeń, w tym urządzeń wykorzystujących energię z odnawialnych źródeł energii, określają w dokumentacji technicznej wielkość zużycia paliw i energii, odniesioną do uzyskiwanej wielkości efektu użytkowego urządzenia w typowych warunkach użytkowania, zwaną dalej „efektywnością energetyczną”. ” , po ust. 1 dodaje się ust. 1a w brzmieniu: „

- **b)**

1a. W przypadku instalacji wykorzystujących do wytwarzania energii biomasę, dokumentacja, o której mowa w ust. 1, wskazuje czy w przypadku ich zastosowania w samodzielnych lokalach mieszkalnych lub lokalach o innym przeznaczeniu w rozumieniu ustawy, o której mowa w art. 51 ust. 2, zapewni sprawność przemiany energetycznej wynoszącą co najmniej 85%, a w przypadku zastosowania ich w instalacjach przemysłowych co najmniej 70%. ” , ust. 2 otrzymuje brzmienie: „
