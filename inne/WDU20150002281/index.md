...
- **3)** w art. 80c: w ust. 1 uchyla się pkt 17, ust. 2 otrzymuje brzmienie: „
    - **a)**
    - **b)**

2. Dane lub informacje o pojazdach, o których mowa w art. 73 ust. 3, udostępnia się wyłącznie podmiotom określonym w ust. 1 pkt 1–8 oraz w ust. 2a. ” , po ust. 2 dodaje się ust. 2a w brzmieniu: „

- **c)**

2a. Dane lub informacje zgromadzone w ewidencji udostępnia się także ministrowi właściwemu do spraw wewnętrznych, w celu realizacji jego ustawowych zadań, za pomocą urządzeń teletransmisji danych, bez konieczności składania pisemnego wniosku. ” , po ust. 7 dodaje się ust. 7a w brzmieniu: „

- **d)**

7a. Decyzji, o której mowa w ust. 7, nie wydaje się w przypadku, o którym mowa w ust. 2a. ” ;

- **4)** w art. 80d w ust. 1 w pkt 1 lit. a otrzymuje brzmienie: „ podmiotów, o których mowa w art. 80c ust. 1, 3 i 6a, oraz ministra właściwego do spraw wewnętrznych, ” ;
    - **a)**
...
- **7)** w art. 100c: po ust. 1a dodaje się ust. 1b w brzmieniu: „
    - **a)**

1b. Dane zgromadzone w ewidencji udostępnia się także ministrowi właściwemu do spraw wewnętrznych, w celu realizacji jego ustawowych zadań, za pomocą urządzeń teletransmisji danych, bez konieczności składania pisemnego wniosku. ” , dodaje się ust. 6 w brzmieniu: „
...
- **1)** konta ubezpieczonych, z których każde jest oznaczone numerem PESEL; ” , w ust. 4 pkt 1 otrzymuje brzmienie: „
    - **b)**
...
- **6)** w art. 189: ust. 1 otrzymuje brzmienie: „
    - **a)**

1. Organami właściwymi w sprawach:

- **1)** telekomunikacji są minister właściwy do spraw informatyzacji i Prezes UKE;
- **2)** poczty są minister właściwy do spraw łączności i Prezes UKE. ” , w ust. 2 wprowadzenie do wyliczenia otrzymuje brzmienie: „ Organy właściwe w sprawach telekomunikacji prowadzą politykę regulacyjną, mając na celu w szczególności: ” ;
    - **b)**

- **7)** w art. 190: ust. 2 i 2a otrzymują brzmienie: „
    - **a)**
...
2a. Minister właściwy do spraw łączności opiniuje sprawozdanie w zakresie działalności pocztowej i przekazuje opinię ministrowi właściwemu do spraw informatyzacji w terminie 20 dni od przedstawienia sprawozdania przez Prezesa UKE. ” , po ust. 2a dodaje się ust. 2b i 2c w brzmieniu: „
...
2c. Prezes UKE przekazuje na żądanie ministra właściwego do spraw informatyzacji i ministra właściwego do spraw łączności informacje o swojej działalności. ” , ust. 4b otrzymuje brzmienie: „

- **c)**

4b. Informację o odwołaniu Prezesa UKE wskazującą powody jego odwołania podaje się do publicznej wiadomości przez ogłoszenie jej treści na stronie podmiotowej Biuletynu Informacji Publicznej ministra właściwego do spraw informatyzacji i ministra właściwego do spraw łączności. ” , ust. 8 otrzymuje brzmienie: „
...
- **1)** przeprowadzaniu kontroli, w tym na badaniu: prawidłowości prowadzonych przez wojewodę postępowań administracyjnych, terminowości załatwiania spraw z zakresu spraw określonych w ustawie;
    - **a)**
    - **b)**
...
2. Wojewoda sprawuje nadzór nad działalnością organów gmin w zakresie realizacji obowiązków określonych w ustawie. ” , dodaje się ust. 3–5 w brzmieniu: „
...
- **7)** w art. 124: ust. 10 otrzymuje brzmienie: „
    - **a)**

10. Minister właściwy do spraw transportu określi, w drodze rozporządzenia, terminy wymiany praw jazdy, o których mowa w ust. 4. ” , dodaje się ust. 12 w brzmieniu: „
...
1. Rejestr stanu cywilnego jest prowadzony przez ministra właściwego do spraw informatyzacji, w systemie teleinformatycznym. ” , ust. 3 otrzymuje brzmienie: „
