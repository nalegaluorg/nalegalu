...
- **2)** art. 3a otrzymuje brzmienie:
  ...
  > 1) od dnia wskazanego w oświadczeniu ubezpieczonego, nie wcześniej jednak niż od dnia, w którym to oświadczenie zostało złożone Kasie, albo 2) od pierwszego dnia okresu ubezpieczenia, za który składka nie została opłacona.  
...
- **7)** w art. 17:
    ...
    - **b)** dodaje się ust. 3–5 w brzmieniu:
      ...
      > „3. W przypadku gdy okres podlegania ubezpieczeniu emerytalnorentowemu jest krótszy niż miesiąc, wysokość składki oblicza się proporcjonalnie do liczby dni podlegania ubezpieczeniu w tym miesiącu.  
...
- **8)** w art. 19:
    ...
    - **b)** w ust. 2 pkt 2 otrzymuje brzmienie: „2) podlegał ubezpieczeniu emerytalno-rentowemu przez okres co najmniej 30 lat;”,
