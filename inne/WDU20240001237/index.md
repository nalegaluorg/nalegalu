...
2. Przed wydaniem postanowienia sąd wysłuchuje podmiotu, który zgodnie z treścią wniosku znajduje się posiadaniu środka dowodowego, lub żąda od niego oświadczenia na piśmie.

3. Jeżeli wniosek dotyczy wyjawienia lub wydania przez stronę przeciwną lub osobę trzecią środka dowodowego znajdującego się aktach sprawy prowadzonej przez organ ochrony konsumentów, tym organ ochrony konsumentów innego państwa członkowskiego Unii Europejskiej, przed wydaniem postanowienia sąd informuje o wniosku ten organ i wyznacza termin, którym organ może przedstawić stanowisko co do tego, czy nie zachodzi przesłanka, o której mowa art. 16c ust. 1 pkt 2.

**Art. 16c.**

1. Sąd oddala wniosek o wyjawienie lub wydanie środka dowodowego, jeżeli:

- **1)** wniosek nie spełnia wymagań, o których mowa art. 16a, lub
- **2)** wyjawienie lub wydanie środka dowodowego byłoby nieproporcjonalne.

2. Dokonując oceny, czy wyjawienie lub wydanie środka dowodowego byłoby nieproporcjonalne, sąd bierze pod uwagę słuszne interesy stron oraz osoby trzeciej, która według treści wniosku znajduje się posiadaniu środka dowodowego, a szczególności:

- **1)** zakres, jakim wniosek o wyjawienie lub wydanie środka dowodowego uzasadniają już stwierdzone fakty i dostępne dowody;
...
- **4)** zakres, jakim środek dowodowy dotyczy informacji stanowiącej tajemnicę przedsiębiorstwa lub inną tajemnicę podlegającą ochronie prawnej na podstawie odrębnych przepisów, szczególności odnoszących się do osób trzecich, oraz dostępne środki ochrony takich informacji.

3. Jeżeli wniosek dotyczy środka dowodowego znajdującego się aktach sprawy prowadzonej przez organ ochrony konsumentów, tym organ ochrony konsumentów innego państwa członkowskiego Unii Europejskiej, dokonując oceny, o której mowa ust. 2, sąd bierze pod uwagę także to, czy:
...
- **2)** obciążyć tę stronę obowiązkiem zwrotu kosztów postępowania całości lub części, niezależnie od wyniku sprawy.

2. Niezależnie od środków, o których mowa ust. 1, sąd postanowieniu może także nałożyć na stronę grzywnę wysokości do 50 000 złotych.
...
5. Na postanowienie o nałożeniu grzywny, o którym mowa ust. 4, przysługuje zażalenie do sądu drugiej instancji.

6. W przypadku gdy postępowaniu grupowym z powództwa podmiotu upoważnionego osoba trzecia, posiadaniu której znajduje się środek dowodowy lub która może umożliwić jego zabezpieczenie, uchyla się od wykonania prawomocnego postanowienia nakazującego wyjawienie lub wydanie środka dowodowego lub dopuszcza się zniszczenia takiego środka celu udaremnienia jego wyjawienia lub wydania, sąd może nałożyć na tę osobę grzywnę wysokości do 50 000 złotych.

7. Niezależnie od grzywny nałożonej na podstawie ust. 6 sąd, celu przymuszenia osoby trzeciej do wykonania prawomocnego postanowienia nakazującego wyjawienie lub wydanie środka dowodowego, tym postanowieniu może nałożyć na tę osobę grzywnę wysokości do 10 000 złotych za każdy dzień opóźnienia wykonaniu prawomocnego postanowienia.

8. Na postanowienie o nałożeniu grzywny, o którym mowa ust. 7, przysługuje zażalenie do sądu drugiej instancji.

**Art. 16h.**

1. W przypadku gdy strona postępowaniu grupowym z powództwa podmiotu upoważnionego:
...
2. Jeżeli zasądzone świadczenie niepieniężne nie zostanie spełnione terminie 6 miesięcy, liczonym od dnia uprawomocnienia się wyroku, a tym czasie reprezentant grupy albo podmiot upoważniony nie wystąpi z wnioskiem o wszczęcie egzekucji, z wnioskiem o nadanie klauzuli wykonalności, a także o wszczęcie egzekucji, może wystąpić każdy z członków grupy.”;

- **21)** po art. 23 dodaje się art. 23a–23c brzmieniu: „Art. 23a. 1. W razie uwzględnienia powództwa postępowaniu grupowym sprawach o stwierdzenie stosowania praktyk naruszających ogólne interesy konsumentów sąd sentencji wyroku:
...
- **2)** uznaje praktykę pozwanego za naruszającą ogólne interesy konsumentów oraz wskazuje termin, którym pozwany zaniechał stosowania tej praktyki.

2. Sąd sentencji wyroku, o którym mowa ust. 1, może również nałożyć na pozwanego obowiązek złożenia jednokrotnego albo wielokrotnego oświadczenia odpowiedniej formie i o odpowiedniej treści o stosowaniu przez pozwanego praktyki naruszającej ogólne interesy konsumentów. Sąd wyznacza termin wykonania nałożonego obowiązku.

**Art. 23b.**

1. W przypadku opóźnienia wykonaniu prawomocnego wyroku wydanego sprawie o stwierdzenie stosowania praktyk naruszających ogólne interesy konsumentów sąd postanowieniu może nałożyć na pozwanego grzywnę wysokości do 5 000 000 złotych.
...
1. Podmiot upoważniony wpisany do rejestru jest uprawniony do wytaczania powództw ramach grupowych postępowań krajowych oraz grupowych postępowań transgranicznych.
...
3. Finansowanie zadań podmiotu upoważnionego odbywa się na zasadach określonych ustawie z dnia 24 kwietnia 2003 r. o działalności pożytku publicznego i o wolontariacie (Dz. U. z 2023 r. poz. 571 oraz z 2024 r. poz. 834).
