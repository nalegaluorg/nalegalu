...
- **1)** przekazywaniu informacji o: stanie zdrowia i rozwoju psychofizycznym ucznia, terminach i zakresie udzielania świadczeń profilaktycznej opieki zdrowotnej nad uczniami, możliwościach i sposobie kontaktowania się z osobami sprawującymi profilaktyczną opiekę zdrowotną nad uczniami;
    - **a)**
    - **b)**
    - **c)**

- **2)** informowaniu i wspieraniu rodziców lub pełnoletnich uczniów w: organizacji korzystania ze świadczeń profilaktycznej opieki zdrowotnej oraz opieki stomatologicznej nad uczniami, w tym profilaktycznych badań lekarskich, badań przesiewowych, przeglądów stomatologicznych oraz szczepień ochronnych, realizacji zaleceń lekarza podstawowej opieki zdrowotnej oraz lekarza dentysty;
    - **a)**
    - **b)**
