...
- **1)** w art. 3 w ust. 5: we wprowadzeniu do wyliczenia: – wyrazy „art. 9–11” zastępuje się wyrazami „art. 9–10a”, – przed wyrazami „art. 25” dodaje się wyrazy „art. 23b,”, pkt 5 otrzymuje brzmienie: „
    - **a)**
    - **b)**
...
- **5)** w art. 9: w ust. 1 i 2 wyraz „Prezes” zastępuje się wyrazami „Kierownik biura powiatowego”, w ust. 3 wyraz „Prezes” zastępuje się wyrazami „kierownik biura powiatowego”, uchyla się ust. 4;
    - **a)**
    - **b)**
    - **c)**
...
1. Obowiązkowemu wpisowi do rejestru podlegają zmiany danych wskazanych we wniosku o wpis koła gospodyń wiejskich do rejestru, a także zmiany statutu tego koła oraz listy jego członków. ” , ust. 3 otrzymuje brzmienie: „

- **b)**

3. W sprawie wpisu zmian, o których mowa w ust. 1, do rejestru stosuje się odpowiednio zasady i tryb przewidziane dla wpisu koła gospodyń wiejskich do rejestru. Wniosek o wpis zmian do rejestru składa się w terminie 30 dni od dnia wystąpienia tych zmian. ” , po ust. 3 dodaje się ust. 3a w brzmieniu: „

- **c)**

3a. W przypadku wystąpienia zmian, o których mowa w ust. 1, do wniosku o wpis zmian do rejestru dołącza się dokumenty potwierdzające ich wystąpienie. ” , ust. 4 otrzymuje brzmienie: „
...
- **1)** w przypadku dokumentów, które wymagają opatrzenia podpisem przez osobę trzecią: te dokumenty sporządzone w postaci elektronicznej, opatrzone kwalifikowanym podpisem elektronicznym, podpisem osobistym albo podpisem zaufanym albo elektroniczne kopie tych dokumentów zapisane w formacie określonym w przepisach wydanych na podstawie ust. 5;
    - **a)**
    - **b)**
...
- **13)** w art. 24 w ust. 1 w pkt 1 lit. a i b otrzymują brzmienie: „ działalności statutowej z tytułu składek członkowskich, darowizn, zapisów, dotacji, pomocy finansowej, nagród, sprzedaży wyrobów sztuki ludowej, w tym rękodzieła i rzemiosła ludowego i artystycznego, żywności regionalnej oraz biletów wstępu na występy artystyczne koła, ” ;
    - **a)**
    - **b)**

- **14)** w art. 25: w ust. 1 dodaje się zdanie drugie w brzmieniu: „ Nadzór jest sprawowany wyłącznie w zakresie zgodności działania kół gospodyń wiejskich z przepisami ustawy oraz przepisami wydanymi na jej podstawie. ” , w ust. 4 uchyla się pkt 1, w ust. 7 skreśla się wyrazy „gospodyń wiejskich”;
    - **a)**
    - **b)**
    - **c)**

- **15)** w art. 27: w ust. 1 pkt 3 otrzymuje brzmienie: „
    - **a)**

- **3)** jeżeli liczba członków koła osiągnie stan poniżej liczby określonej w art. 5 ust. 1 i liczba ta nie zostanie uzupełniona do wymaganej ustawą liczby członków koła w terminie 90 dni; ” , w ust. 3 wyrazy „Prezes Agencji Restrukturyzacji i Modernizacji Rolnictwa” zastępuje się wyrazami „dyrektor oddziału regionalnego Agencji Restrukturyzacji i Modernizacji Rolnictwa właściwy ze względu na siedzibę koła”, ust. 6 otrzymuje brzmienie: „
    - **b)**
    - **c)**
