...
- **2)** wskazuje kwotę środków przeznaczonych na: finansowanie tego programu oraz źródło jego finansowania, pokrycie uzasadnionych kosztów poniesionych przez operatora programu związanych z wykonywaniem jego zadań oraz źródło pokrycia tych kosztów, w wysokości niezbędnej do prawidłowej realizacji programu, nie wyższej niż 1% wysokości środków przeznaczonych na finansowanie programu.
    - **a)**
    - **b)**
