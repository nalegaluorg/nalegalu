...
- **3)** w art. 100a ust. 5 otrzymuje brzmienie: „5. Minister właściwy do spraw informatyzacji może zlecić, z wyłączeniem stosowania przepisów dotyczących zamówień publicznych, zadania związane z budową, rozwojem, wdrożeniem i utrzymaniem systemu teleinformatycznego obsługującego:
...
- **2)** w art. 8:
    - **a)** po ust. 1a dodaje się ust. 1b i 1c w brzmieniu: „1b. Operator OSE może korzystać z infrastruktury telekomunikacyjnej lub usług transmisji danych bez zachowania procedury, o której mowa w ust. 1, jeżeli:
