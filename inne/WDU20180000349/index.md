...
| Źródło | [ISAP](https://isap.sejm.gov.pl/isap.nsf/DocDetails.xsp?id=WDU20180000349) · [PDF](https://api.sejm.gov.pl/eli/acts/DU/2018/349/text.pdf) |

Treść rozporządzenia
Treść rozporządzenia
Na podstawie art. 89 ust. 1 pkt 1 ustawy z dnia 16 listopada 2016 r. o Krajowej Administracji Skarbowej (Dz. U. poz. 1947, z późn. zm.Zmiany wymienionej ustawy zostały ogłoszone w Dz. U. z 2016 r. poz. 2255, z 2017 r. poz. 88, 244, 379, 708, 768, 1086, 1321, 2409 i 2491 oraz z 2018 r. poz. 106 i 138.) zarządza się, co następuje:
Przepisy ogólne
§ 1.
...
§ 10.
Kontrola towarów przemieszczanych za pomocą stałych instalacji przesyłowych, takich jak rurociągi, gazociągi i sieć energetyczna, jest wykonywana przez porównanie danych zawartych w zgłoszeniu celnym z dokumentami stanowiącymi podstawę do ustalenia ilości lub masy tych towarów, określonymi w przepisach wydanych na podstawie art. 19 ust. 1 ustawy z dnia 19 marca 2004 r. – Prawo celne (Dz. U. z 2018 r. poz. 167). W trakcie kontroli funkcjonariusz kontroluje również stan zamknięć urzędowych.
§ 11.
1.
