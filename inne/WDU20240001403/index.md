...
art. 345 ust. 1 pkt 3, 6, 7 i 13-16 ustawy, zamieszczanych w wykazie osób ubiegających się o stopień naukowy doktora albo o stopień doktora w zakresie sztuki, zwanym dalej „wykazem osób ubiegających się o stopień doktora”,
...
art. 349 ust. 1 pkt 2, 3, 4 i 5 ustawy, zamieszczanych w bazie osób upoważnionych do podpisywania dokumentów, o których mowa w art. 78 ust. 3, art. 163 ust. 4 oraz art. 180 ust. 1 i 1a ustawy, zwanej dalej „bazą osób upoważnionych”;
...
dziedzinę nauki albo dziedzinę sztuki, zwane dalej „dziedziną”, albo dziedzinę i dyscyplinę naukową albo dyscyplinę artystyczną, zwane dalej „dyscypliną”, lub dyscypliny, w których został nadany tytuł profesora;

### 13)

uprawnienia równoważne z uprawnieniami wynikającymi z posiadania stopnia doktora habilitowanego, nabyte na podstawie decyzji, o której mowa w art. 226 ust. 2 ustawy:
...
dziedzinę i dyscyplinę, w których zostały nabyte,

### c)

nazwę podmiotu, w którym zostały nabyte.
...
nazwę podmiotu zatrudniającego albo podmiotu, na rzecz którego jest wykonywana działalność naukowa;
...
o oświadczeniu, o którym mowa w art. 265 ust. 5 ustawy:

### a)

wskazaną w nim dyscyplinę,
...
o oświadczeniu, o którym mowa w art. 265 ust. 13 ustawy:
...
osiągnięcia naukowe lub artystyczne przypisane do dyscypliny, która została w nim wskazana.
...
okres, na jaki został nawiązany,
...
przynależność pracownika - w przypadku zatrudnienia w:

### a)

uczelni - do grupy pracowników:
...
instytucie badawczym albo jednostce naukowej Polskiej Akademii Nauk - do grupy pracowników:
...
Centrum Łukasiewicz albo instytucie działającym w ramach Sieci Badawczej Łukasiewicz, zwanym dalej „instytutem Sieci Łukasiewicz” - do grupy pracowników pionu badawczego;
...
czy stanowisko pracy w Centrum Łukasiewicz albo w instytucie Sieci Łukasiewicz jest finansowane ze środków finansowych, o których mowa odpowiednio w art. 365 pkt 2a albo 13a ustawy.
...
okres zatrudnienia, w ramach którego doświadczenie zostało zdobyte;
...
W zakresie danych, o których mowa w art. 343 ust. 1 pkt 20 ustawy, w wykazie pracowników zamieszcza się następujące informacje:

### 1)

o orzeczonej karze dyscyplinarnej, o której mowa w art. 276 ust. 1 pkt 4-8 ustawy:
...
o orzeczeniu, o którym mowa w art. 180 ustawy z dnia 6 czerwca 1997 r. - Kodeks karny wykonawczy ([Dz. U. z 2024 r. poz. 706](https://api.sejm.gov.pl/eli/acts/DU/2024/706/text.html)):
...
datę, od której nastąpił zakaz zajmowania stanowiska albo wykonywania zawodu nauczyciela akademickiego,
...
W zakresie danych, o których mowa w art. 343 ust. 1 pkt 21 ustawy, w wykazie pracowników zamieszcza się następujące informacje:

### 1)

o uzyskanym patencie na wynalazek:
...
nazwę podmiotu albo podmiotów, które uzyskały patent,
...
dyscyplinę, o której mowa w art. 265 ust. 13 ustawy,
...
o uzyskanym prawie ochronnym na wzór użytkowy:
...
nazwę podmiotu albo podmiotów, które uzyskały prawo ochronne,
...
o uzyskanym wyłącznym prawie hodowcy do odmiany rośliny:
...
DOI ( Digital Object Identifier - cyfrowy identyfikator dokumentu elektronicznego), a w przypadku jego braku - adres strony internetowej zawierającej pełny tekst artykułu, jeżeli znajduje się w otwartym dostępie, albo adres strony internetowej zawierającej informacje o artykule,
...
imiona i nazwiska współautorów oraz - jeżeli są znane - numery ORCID,

### f)

czy jest to artykuł recenzyjny,

### g)

czy został opublikowany w recenzowanych materiałach z międzynarodowej konferencji naukowej - jeżeli tak, informacje dotyczące konferencji:
...
dotyczące otwartego dostępu ( Open Access ), w tym:
...
- daty udostępnienia artykułu naukowego w sposób otwarty, - czy udostępnienie nastąpiło przed opublikowaniem, w dniu opublikowania czy po opublikowaniu, - liczby miesięcy, jakie upłynęły od dnia opublikowania do dnia udostępnienia artykułu naukowego w sposób otwarty,

### m)

wysokość opłat za opublikowanie poniesionych przez podmiot, o którym mowa w lit. d, (wyrażoną w złotych) i źródło ich finansowania (środki finansowe, o których mowa w art. 365 pkt 2 ustawy, środki finansowe przyznane na realizację projektu w zakresie badań naukowych lub prac rozwojowych, inne);

### 5)

o monografii naukowej i redakcji naukowej monografii naukowej:
...
tytuł oraz ISBN - Międzynarodowy Znormalizowany Numer Książki ( International Standard Book Number ) lub ISMN - Międzynarodowy Znormalizowany Numer Druku Muzycznego ( International Standard Music Number ),
...
imiona i nazwiska współautorów i redaktorów oraz - jeżeli są znane - numery ORCID,
...
wysokość opłat za wydanie poniesionych przez podmiot, o którym mowa w lit. h, (wyrażoną w złotych) i źródło ich finansowania (środki finansowe, o których mowa w art. 365 pkt 2 ustawy, środki finansowe przyznane na realizację projektu w zakresie badań naukowych lub prac rozwojowych, inne);

### 6)

o rozdziale w monografii naukowej, jeżeli w monografii są wskazani autorzy rozdziału:
...
imiona i nazwiska pozostałych współautorów oraz - jeżeli są znane - numery ORCID,
...
o osiągnięciu artystycznym:

### a)

rodzaj określony w przepisach wydanych na podstawie art. 267 ust. 2 pkt 1 ustawy,
...
rok i nazwę państwa realizacji,

### g)

charakterystykę (maksymalnie 1200 znaków ze spacjami),

### h)

rok i nazwę państwa pierwszego upublicznienia,

### i)

zakres rozpowszechnienia (ogólnopolski, międzynarodowy),
...
czy osiągnięcie artystyczne ma być uwzględnione w ewaluacji jakości działalności naukowej, zwanej dalej „ewaluacją”.
...
datę ważności i numer Karty Polaka.
...
czy student realizuje kształcenie:
...
na studiach wspólnych;

### 5)

rok i semestr studiów, a w przypadku studiów prowadzonych w rozliczeniu rocznym - rok studiów:

### a)

które student zaliczył w danym roku akademickim,

### b)

na które student jest wpisany w danym roku akademickim;
...
uzyskanych po zaliczeniu kolejnych lat i semestrów studiów, a w przypadku studiów prowadzonych w rozliczeniu rocznym - lat studiów,

### b)

zaliczonych w wyniku potwierdzenia efektów uczenia się.
...
nazwę podmiotu prowadzącego albo podmiotów prowadzących szkołę doktorską;
...
datę wydania i numer prawomocnej decyzji o:
...
odmowie nadania stopnia doktora,

### c)

umorzeniu postępowania w sprawie nadania stopnia doktora;

### 3)

dziedzinę albo dziedzinę i dyscyplinę, której dotyczy decyzja, o której mowa w pkt 2;

### 4)

datę wydania i numer prawomocnej decyzji w sprawie stwierdzenia nieważności decyzji o nadaniu stopnia doktora albo prawomocnej decyzji uchylającej decyzję o nadaniu stopnia doktora i rozstrzygającej sprawę co do istoty;

### 5)

nazwę podmiotu, który wydał decyzję, o której mowa w pkt 2 i 4.
...
organ nadzorujący podmiot;

### 3)

numer identyfikacyjny REGON podmiotu;
...
numer podmiotu z Krajowego Rejestru Sądowego, zwanego dalej „KRS”, rejestru instytutów PAN albo ewidencji uczelni niepublicznych;
...
jednostkę podziału terytorialnego - nazwę i kod ulicy oraz nazwy miejscowości, gminy i województwa zgodnie z TERYT - krajowym rejestrem urzędowym podziału terytorialnego kraju, o którym mowa w art. 47 ustawy z dnia 29 czerwca 1995 r. o statystyce publicznej ([Dz. U. z 2023 r. poz. 773](https://api.sejm.gov.pl/eli/acts/DU/2023/773/text.html) oraz [z 2024 r. poz. 1222](https://api.sejm.gov.pl/eli/acts/DU/2024/1222/text.html)),
...
adres do doręczeń elektronicznych, o którym mowa w art. 2 pkt 1 ustawy z dnia 18 listopada 2020 r. o doręczeniach elektronicznych ([Dz. U. z 2024 r. poz. 1045](https://api.sejm.gov.pl/eli/acts/DU/2024/1045/text.html)), zwany dalej „adresem do doręczeń elektronicznych”;

### 7)

rodzaj podmiotu (uczelnia, instytut PAN, instytut badawczy, instytut międzynarodowy, Centrum Łukasiewicz, instytut Sieci Łukasiewicz, Polska Akademia Umiejętności, zwana dalej „PAU”, inny podmiot prowadzący głównie działalność naukową w sposób samodzielny i ciągły);
...
rodzaj (publiczna, niepubliczna, prowadzona przez kościół lub inny związek wyznaniowy),

### b)

przynależność do grupy uczelni akademickich albo zawodowych;
...
nazwy podmiotów, z którymi są prowadzone studia wspólne albo studia wspólne interdyscyplinarne, ze wskazaniem podmiotu albo podmiotów odpowiedzialnych za wprowadzanie danych do Systemu POL-on;
...
datę zakończenia prowadzenia studiów;
...
w ramach indywidualnych studiów międzydziedzinowych, o których mowa w art. 59 ustawy,
...
wysokość w bieżącym roku akademickim opłaty (wyrażonej w złotych):
...
za powtarzanie zajęć na studiach stacjonarnych z powodu niezadowalających wyników w nauce,
...
czy na studiach jest realizowane kształcenie:
...
w ramach filologii obcej, ze wskazaniem języka tej filologii;
...
W zakresie danych, o których mowa w art. 346 ust. 1 pkt 5 ustawy, w wykazie instytucji zamieszcza się następujące informacje:
...
lata, za które ewaluacja jest przeprowadzana;

### 3)

dyscypliny, w których ewaluacja została przeprowadzona zgodnie z art. 265 ust. 4 ustawy;

### 4)

czy podmiot prowadzi badania naukowe lub prace rozwojowe na rzecz obronności i bezpieczeństwa państwa objęte ochroną informacji niejawnych, ze wskazaniem procentowego udziału czasu pracy poświęconego na tę działalność w czasie pracy związanym z działalnością naukową podmiotu ogółem w poszczególnych dyscyplinach;

### 5)

o których mowa w § 2 ust. 10;
...
tytułu każdego opisu wpływu (maksymalnie 150 znaków ze spacjami dla każdej wersji językowej),

### b)

streszczenia każdego opisu wpływu (maksymalnie 1000 znaków ze spacjami dla każdej wersji językowej),

### c)

wskazania roku, w którym ewaluacja, w której dany opis wpływu jest zgłaszany do oceny, jest przeprowadzana,

### d)

dyscypliny, której dotyczy każdy opis wpływu,

### e)

imion i nazwisk osób, które prowadziły działalność naukową objętą każdym opisem wpływu, oraz - jeżeli są znane - numerów ORCID,
...
charakterystyki wpływu działalności naukowej, w tym działalności, której wyniki są przedmiotem komercjalizacji, ze wskazaniem związku między działalnością naukową a tym wpływem oraz grupy społecznej będącej beneficjentem tego wpływu i obszaru, na który działalność naukowa ma największy wpływ (maksymalnie 5000 znaków ze spacjami dla każdej wersji językowej),
...
o realizowanych projektach w zakresie badań naukowych, prac rozwojowych lub upowszechniania nauki:
...
dyscypliny, w ramach których projekt jest realizowany w danym podmiocie, ze wskazaniem procentowego udziału tych dyscyplin w projekcie,
...
nazwę działania lub priorytetu, w ramach których projekt jest finansowany,
...
adres instytucji finansującej, a w przypadku instytucji zagranicznej - jeżeli jest znany,
...
W zakresie danych, o których mowa w art. 346 ust. 1 pkt 11 i 12 ustawy, w wykazie instytucji zamieszcza się następujące informacje:
...
dotyczące ewaluacji jakości kształcenia w szkole doktorskiej:
...
o których mowa w § 2 ust. 10, dotyczące osiągnięć naukowych i artystycznych doktorantów;

### 3)

o organie nadającym stopnie w uczelni:
...
okres posiadania uprawnień do nadawania stopni.
...
źródła pochodzenia środków, w tym wysokość środków z:
...
o przychodach z usług badawczych świadczonych na zlecenie podmiotów nienależących do systemu szkolnictwa wyższego i nauki:
...
czy przychód został uzyskany przez inny podmiot utworzony przez ten podmiot w celu komercjalizacji,

### e)

dyscypliny, w ramach których przychód został uzyskany, ze wskazaniem procentowego udziału danej dyscypliny w tym przychodzie,
...
pkt 1-5 i 7, w terminie 7 dni od dnia utworzenia podmiotu, a w przypadku uczelni niepublicznej - od dnia wpisania do ewidencji uczelni niepublicznych;

### 2)

pkt 9, nie wcześniej niż po upływie roku od dnia utworzenia podmiotu.

### 3.

Wniosek o założenie konta w Systemie POL-on dla podmiotu, o którym mowa w ust. 1 pkt 1-5 i 7, zawiera:
...
jednostkę podziału terytorialnego, o której mowa w § 5 ust. 1 pkt 6 lit. e,
...
numer identyfikacyjny REGON, NIP albo numer z KRS, jeżeli został nadany;
...
Wniosek o założenie konta w Systemie POL-on dla podmiotu, o którym mowa w ust. 1 pkt 9, zawiera:
...
liczbę osób zatrudnionych w ramach stosunku pracy, w przeliczeniu na pełny wymiar czasu pracy, prowadzących działalność naukową;
...
informacje o projektach w zakresie badań naukowych, prac rozwojowych lub upowszechniania nauki realizowanych w okresie 24 miesięcy poprzedzających miesiąc złożenia wniosku:
...
czy projekt jest realizowany samodzielnie czy we współpracy z innymi podmiotami,

### e)

w przypadku projektu realizowanego we współpracy z innymi podmiotami - nazwy podmiotów biorących udział w realizacji projektu albo tworzących konsorcjum;
...
Do wniosku o założenie konta w Systemie POL-on podmiot, o którym mowa w ust. 1 pkt 9, dołącza informację o złożeniu, na podstawie art. 30 ust. 1 pkt 3 ustawy z dnia 29 czerwca 1995 r. o statystyce publicznej, sprawozdania o działalności badawczej i rozwojowej (B+R) GUS PNT-01 za rok poprzedzający rok złożenia wniosku.
...
wprowadzają dane do wykazu pracowników w terminie 30 dni od dnia zatrudnienia nauczyciela akademickiego, innej osoby prowadzącej zajęcia, osoby prowadzącej działalność naukową lub biorącej udział w jej prowadzeniu, zwanych dalej łącznie „pracownikami”;

### 2)

aktualizują dane w wykazie pracowników w terminie 30 dni od dnia zaistnienia zmiany albo uzyskania informacji o zmianie;

### 3)

oznaczają dane w wykazie pracowników jako archiwalne w terminie 30 dni od dnia ustania zatrudnienia pracownika.

### 2.

Do wykazu pracowników dane, o których mowa w art. 343 ust. 1:
...
Rektor albo minister usuwa z wykazu pracowników dane, o których mowa w art. 343 ust. 1 pkt 20 ustawy, niezwłocznie po powzięciu informacji o:

### 1)

zatarciu kary dyscyplinarnej;

### 2)

uchyleniu orzeczenia o ukaraniu karą dyscyplinarną;
...
Danych służących upowszechnianiu wyników działalności naukowej, o których mowa w art. 343 ust. 1 pkt 1, 3, 8, 10, 13, 18, 19 i 21 ustawy, nie usuwa się.

### 8.

Przewodniczący Rady Doskonałości Naukowej wprowadza do wykazu pracowników dane o utracie tytułu profesora w terminie 21 dni od dnia doręczenia prawomocnego orzeczenia sądu, o którym mowa w art. 231 ust. 1 ustawy.
...
wprowadzają dane do wykazu studentów w terminie 30 dni od dnia rozpoczęcia nowego cyklu kształcenia w danym roku akademickim;

### 2)

aktualizują dane w wykazie studentów, o których mowa w art. 344 ust. 1 pkt 8 ustawy, w terminie 30 dni od dnia zakończenia semestru studiów, a w przypadku studiów prowadzonych w rozliczeniu rocznym - od dnia zakończenia roku studiów, a pozostałe dane dotyczące studenta - w terminie 30 dni od dnia uzyskania informacji o zmianie;

### 3)

oznaczają dane w wykazie studentów jako archiwalne w terminie 30 dni od dnia ukończenia studiów albo uprawomocnienia się decyzji o skreśleniu z listy studentów.
...
wprowadzają do wykazu osób ubiegających się o stopień doktora dane:
...
aktualizują dane w wykazie osób ubiegających się o stopień doktora w terminie 21 dni od dnia zaistnienia zmiany albo uzyskania informacji o zmianie;

### 3)

oznaczają dane w wykazie osób ubiegających się o stopień doktora jako archiwalne w terminie 21 dni od dnia, w którym decyzja:
...
Danych służących upowszechnianiu wyników działalności naukowej, o których mowa w art. 345 ust. 1 pkt 1, 3, 12, 13 i 16 ustawy, nie usuwa się.

### § 12.

### 1.

Rektor, dyrektor instytutu PAN, dyrektor instytutu badawczego, dyrektor instytutu międzynarodowego, prezes PAU i osoba kierująca innym podmiotem prowadzącym głównie działalność naukową w sposób samodzielny i ciągły posiadającym siedzibę na terytorium Rzeczypospolitej Polskiej:

### 1)

wprowadzają dane, o których mowa w art. 346 ust. 1 pkt 6 i 7 ustawy, do wykazu instytucji w terminie 21 dni od dnia utworzenia studiów na określonym kierunku, poziomie i profilu;

### 2)

wprowadzają dane, o których mowa w art. 346 ust. 1 pkt 11 ustawy, do wykazu instytucji w zakresie, o którym mowa w § 5 ust. 4 pkt 1:

### a)

lit. a-i, w terminie 21 dni od dnia utworzenia szkoły doktorskiej,

### b)

lit. j, w terminie 21 dni od dnia, w którym uchwała w sprawie oceny jakości kształcenia w szkole doktorskiej stała się ostateczna;

### 3)

aktualizują dane w wykazie instytucji, o których mowa w art. 346 ust. 1:
...
oznaczają dane, o których mowa w art. 346 ust. 1 pkt 6 i 7 ustawy, jako archiwalne w terminie 21 dni od dnia zaprzestania prowadzenia studiów.

### 2.

Prezes Centrum Łukasiewicz i dyrektor instytutu Sieci Łukasiewicz aktualizują w wykazie instytucji dane, o których mowa w art. 346 ust. 1:
...
Jeżeli prowadzenie studiów rozpoczęto po dniu 15 lutego, dane, o których mowa w art. 346 ust. 1 pkt 10 ustawy, minister wprowadza do dnia 15 lutego następnego roku.

### 5.

Dane w wykazie instytucji nie są archiwizowane i nie są usuwane, z wyjątkiem danych, o których mowa w art. 346 ust. 1 pkt 6 i 7 ustawy, które są przechowywane przez okres 20 lat, liczony od roku następującego po roku, w którym nastąpiło oznaczenie tych danych jako archiwalne.
...
wprowadzają do bazy dokumentów w postępowaniach awansowych dane osób ubiegających się o:
...
aktualizują dane w bazie dokumentów w postępowaniach awansowych niezwłocznie po zaistnieniu zmiany albo po uzyskaniu informacji o zmianie.
...
wprowadzają dane do bazy osób upoważnionych niezwłocznie po objęciu funkcji przez osobę upoważnioną do podpisywania dokumentów albo po wprowadzeniu wzoru pieczęci urzędowej lub wzoru dokumentu;

### 2)

aktualizują dane w bazie osób upoważnionych niezwłocznie po zaistnieniu zmiany;

### 3)

oznaczają dane w bazie osób upoważnionych jako archiwalne niezwłocznie po zakończeniu sprawowania funkcji przez osobę upoważnioną do podpisywania dokumentów albo po wprowadzeniu nowego wzoru pieczęci urzędowej lub nowego wzoru dokumentu.
...
składane w trybie art. 427 ust. 1 ustawy, w terminie 21 dni od dnia otrzymania wezwania ministra do złożenia danego sprawozdania;

### 4)

raporty z wykorzystania środków finansowych, o których mowa w art. 365 pkt 2a, 2b oraz pkt 4 lit. c i d ustawy, w terminie do dnia 30 kwietnia roku następującego po roku, na który środki finansowe zostały przyznane;
...
art. 373 ust. 1 pkt 3 i ust. 3 pkt 4 ustawy, w terminie:
...
Publicznie dostępne przez stronę internetową Systemu POL-on są dane, o których mowa w:

### 1)

art. 343 ust. 1 pkt 1, 3, 8, 10, 13, 18, 19, pkt 20 - w zakresie informacji o prawomocnym orzeczeniu kary dyscyplinarnej - i pkt 21 ustawy;
...
art. 348 ust. 1 ustawy, z wyłączeniem numerów PESEL i numerów dokumentów potwierdzających tożsamość osób ubiegających się o stopień albo o tytuł profesora.
...
Rozporządzenie wchodzi w życie z dniem następującym po dniu ogłoszenia.[3) Niniejsze rozporządzenie było poprzedzone rozporządzeniem Ministra Nauki i Szkolnictwa Wyższego z dnia 6 marca 2019 r. w sprawie danych przetwarzanych w Zintegrowanym Systemie Informacji o Szkolnictwie Wyższym i Nauce POL-on (Dz. U. z 2022 r. poz. 700), które traci moc z dniem wejścia w życie niniejszego rozporządzenia, na podstawie art. 38 ustawy z dnia 28 lipca 2023 r. o zmianie ustawy - Karta Nauczyciela oraz niektórych innych ustaw (Dz. U. poz. 1672 oraz z 2024 r. poz. 123).](#gloss-0:3:)
