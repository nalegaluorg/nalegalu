...
§ 2. Pomiarów ilości wodoru odnawialnego dokonuje się przy użyciu urządzeń pomiarowo-rozliczeniowych, których właściwości metrologiczne zostały potwierdzone przez wykonanie wzorcowania.
§ 3. 1. Dane dotyczące ilości wodoru odnawialnego rejestruje się w książce rejestrowej z ponumerowanymi kartami dziennymi albo z zastosowaniem elektronicznego systemu przetwarzania danych.
