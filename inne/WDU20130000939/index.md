...
| Pole | Wartość |
|---|---|
| Adres publikacyjny | Dz.U. 2013 poz. 939 |
| ISAP | WDU20130000939 |
| Typ aktu | Ustawa |
| Status | akt objęty tekstem jednolitym |
| W mocy | tak |
...
- **1)** w art. 2 w ust. 1:
    ...
    - **b)** pkt 23a otrzymuje brzmienie: „23a) pośredniczący podmiot węglowy – podmiot mający siedzibę lub miejsce zamieszkania na terytorium kraju:
    ...
    - **c)** po pkt 23b dodaje się pkt 23c w brzmieniu: „23c) finalny nabywca węglowy – podmiot, który:
...
- **2)** w art. 9a:
    - **a)** ust. 1 otrzymuje brzmienie: „1. W przypadku wyrobów węglowych przedmiotem opodatkowania akcyzą jest:
...
- **7)** powstanie ubytków wyrobów węglowych.”,
    - **b)** dodaje się ust. 4 i 5 w brzmieniu: „4. W przypadku sprzedaży wyrobów węglowych sprzedawca jest obowiązany ustalić, czy sprzedaje te wyroby pośredniczącemu podmiotowi węglowemu czy finalnemu nabywcy węglowemu.
...
- **6)** art. 31a otrzymuje brzmienie: „Art. 31a. 1. Zwalnia się od akcyzy czynności podlegające opodatkowaniu, których przedmiotem są wyroby węglowe przeznaczone do celów opałowych:
...
- **7)** w art. 38:
    - **a)** w ust. 1: – pkt 1 i 2 otrzymują brzmienie: „1) wzór oraz sposób ewidencjonowania i stosowania dokumentu dostawy, w tym w przypadkach, o których mowa w art. 31a ust. 5 oraz w art. 42 ust. 1a, oraz podmioty, które wystawiają dokument dostawy,

- **2)** szczegółowy zakres danych, jakie powinna zawierać ewidencja wyrobów akcyzowych objętych zwolnieniem od akcyzy ze względu na ich przeznaczenie i sposób jej prowadzenia, w tym termin dokonania wpisów do tej ewidencji,”, – pkt 4 otrzymuje brzmienie: „4) warunki i sposób zwrotu wyrobów akcyzowych zwolnionych od akcyzy ze względu na przeznaczenie”,
    - **b)** w ust. 2: – pkt 1–3 otrzymują brzmienie: „1) dodatkowe warunki i tryb stosowania zwolnień, o których mowa w art. 30, art. 31a i art. 32, w szczególności w zakresie ewidencjonowania i dokumentowania uprawnienia do stosowania zwolnień,
...
- **10)** po art. 91 dodaje się art. 91a w brzmieniu: „Art. 91a. 1. Pośredniczący podmiot węglowy dokonujący sprzedaży wyrobów węglowych na terytorium kraju finalnemu nabywcy węglowemu jest obowiązany prowadzić ewidencję wyrobów węglowych zawierającą następujące dane:
