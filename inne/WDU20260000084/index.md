...
- **3)** § 6 otrzymuje brzmienie:
  ...
  > „§ 6.  
  > 1. Zwrot kosztów zamieszkania faktycznie poniesionych w wysokości określonej w fakturze potwierdzającej najem nie może przekraczać:  
...
- **7)** w § 10:
    ...
    - **b)** w ust. 2: – pkt 4 otrzymuje brzmienie: „4) urlopu, niezależnie od podstawy powstania prawa do urlopu;”, – w pkt 6 kropkę zastępuje się średnikiem i dodaje się pkt 7 i 8 w brzmieniu:
...
**§ 3.** Rozporządzenie wchodzi w życie pierwszego dnia miesiąca następującego po miesiącu ogłoszenia. Minister Sprawiedliwości: W. Żurek
