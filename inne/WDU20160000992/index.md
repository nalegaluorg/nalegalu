...
1) w § 3 w pkt 6 kropkę zastępuje się średnikiem i dodaje się pkt 7 i 8 w brzmieniu: „7) znanego dostawcy zaopatrzenia pokładowego określa załącznik nr 7 do rozporządzenia;
...
b) dodaje się ust. 4 i 5 w brzmieniu: „4. Program ochrony znanego dostawcy zaopatrzenia pokładowego i program ochrony znanego dostawcy zaopatrzenia portu lotniczego jest przedstawiany do zatwierdzenia podmiotowi, który dokonuje wyznaczenia.
...
b) w pkt 4.6 dodaje się ppkt 4.6.5 i 4.6.6 w brzmieniu: „4.6.5. Kategorie przedmiotów zabronionych do wnoszenia do strefy zastrzeżonej.
4.6.6. Zwolnienia z zakazu wnoszenia przedmiotów zabronionych do strefy zastrzeżonej.”,
c) dodaje się pkt 4.14 i 4.15 w brzmieniu: „4.14. Lokalizacja oraz organizacja, sposób i warunki dostępu do stanowiska rozpoznania i neutralizacji materiałów i urządzeń wybuchowych.
...
6) w załączniku nr 6 do rozporządzenia dodaje się pkt 11 w brzmieniu: „11. Wewnętrzny system kontroli jakości w zakresie ochrony lotnictwa cywilnego
...
Minister Infrastruktury i Budownictwa: A. Adamczyk SZCZEGÓŁOWE WYMAGANIA DOTYCZĄCE PROGRAMU OCHRONY ZNANEGO DOSTAWCY ZAOPATRZENIA POKŁADOWEGO
