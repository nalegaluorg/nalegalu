...
1. Dane, o których mowa art. 18a 1 pkt 6 oraz 3 pkt 1–7, są wprowadzane do Centralnego Rejestru Wyborców przez wójta bezpośrednio systemie teleinformatycznym.

2. Dane, o których mowa art. 18a 1 pkt 7 i 3 pkt 8, są wprowadzane do Centralnego Rejestru Wyborców przez organ sporządzający spis wyborców lub burmistrza dzielnicy Śródmieście miasta stołecznego Warszawy przypadku, o którym mowa art. 34, bezpośrednio systemie teleinformatycznym.

3. Dane, o których mowa art. 18a 1 pkt 12 i 3 pkt 13, są wprowadzane do Centralnego Rejestru Wyborców przez ministra właściwego do spraw informatyzacji bezpośrednio systemie teleinformatycznym.

**Art. 18c.**

1. Dane, o których mowa art. 18a 1, usuwa się niezwłocznie przypadku:

- **1)** śmierci;
- **2)** utraty obywatelstwa polskiego.

2. Usunięcie danych przypadkach, o których mowa 1, następuje na podstawie przekazanej przez rejestr PESEL informacji o zarejestrowaniu zdarzenia zgodnie z art. 10 ust. 3 ustawy z dnia 24 września 2010 r. o ewidencji ludności.

3. W przypadku zmiany danych, o których mowa art. 18a 1 pkt 1–5, rejestrze PESEL następuje ich automatyczna aktualizacja Centralnym Rejestrze Wyborców.

**Art. 18d.**

1. Dane, o których mowa art. 18a 3, usuwa się niezwłocznie przypadku:
...
2. Usunięcie danych przypadkach, o których mowa 1 pkt 1 lub 2, następuje na podstawie przekazanej przez rejestr PESEL informacji o zarejestrowaniu zdarzenia zgodnie z art. 10 ust. 3 ustawy z dnia 24 września 2010 r. o ewidencji ludności.

3. W przypadku zmiany danych, o których mowa art. 18a 3 pkt 1–6, rejestrze PESEL następuje ich automatyczna aktualizacja Centralnym Rejestrze Wyborców.

**Art. 18e.** Do weryfikacji prawidłowości danych osobowych zawartych Centralnym Rejestrze Wyborców oraz stwierdzania niezgodności tych danych ze stanem faktycznym stosuje się art. 11 ustawy z dnia 24 września 2010 r. o ewidencji ludności.”;

**Art. 22.**

1. Wyborca może wnieść do właściwego miejscowo wójta reklamację na nieprawidłowości Centralnym Rejestrze Wyborców, jeżeli nie został on ujęty Centralnym Rejestrze Wyborców lub nie ujęto go żadnym obwodzie głosowania albo został on nieprawidłowo ujęty obwodzie głosowania.
...
4. W celu rozpatrzenia reklamacji dane wyborcy wnoszącego reklamację mogą być sprawdzane rejestrze PESEL.

5. Decyzję, wraz z uzasadnieniem, doręcza się niezwłocznie wyborcy wnoszącemu reklamację.

6. Na decyzję nieuwzględniającą reklamacji lub powodującą skreślenie z obwodu głosowania wyborca wnoszący reklamację może wnieść, terminie 3 dni od dnia doręczenia decyzji, skargę za pośrednictwem wójta do właściwego miejscowo sądu rejonowego. Przepisy art. 20 4 i 5 stosuje się odpowiednio.
...
- **1)** dane, o których mowa art. 18a 1 i 3, dotyczące osób, które wykonały obowiązek meldunkowy na terenie danej gminy lub posiadają adres stałego zamieszkania tej gminie;
...
2. Dane, o których mowa 1, są udostępniane trybie teletransmisji danych, po złożeniu wniosku przez wójta do ministra właściwego do spraw informatyzacji. Do wniosku wójt załącza oświadczenie o posiadaniu przez gminę zabezpieczeń technicznych i organizacyjnych właściwych dla przetwarzania danych osobowych, szczególności uniemożliwiających dostęp osób nieuprawnionych do przetwarzania danych osobowych i wykorzystanie danych niezgodnie z celem ich uzyskania oraz dokumenty, z których wynika data planowanego przeprowadzenia wyborów.

3. Dane, o których mowa 1, po przeprowadzeniu wyborów do organów jednostek pomocniczych i jednostek niższego rzędu gmina usuwa z systemu teleinformatycznego.”;

- **22)** art. 26 1–11 otrzymują brzmienie: „§ 1. Wyborcę, któremu przysługuje prawo wybierania, ujmuje się spisie wyborców sporządzanym Centralnym Rejestrze Wyborców stałym obwodzie głosowania, którym dana osoba jest ujęta z urzędu lub na wniosek.
...
3. Spis wyborców służy do przeprowadzania głosowania wyborach, które zostały zarządzone.

4. Wyborca może być ujęty tylko jednym spisie wyborców.
...
7. W spisie wyborców, części B, zamieszcza się dane obywateli Unii Europejskiej niebędących obywatelami polskimi, uprawnionych do korzystania z praw wyborczych wyborach, które zostały zarządzone Rzeczypospolitej Polskiej, zakresie:
...
- **23)** art. 28 otrzymuje brzmienie: „Art. 28. 1. Wyborca może zmienić miejsce głosowania danych wyborach. Wniosek sprawie zmiany miejsca głosowania składa okresie od 44 dnia przed dniem wyborów do 3 dnia przed dniem wyborów.

2. Przepisu 1 nie stosuje się wyborach do organów stanowiących jednostek samorządu terytorialnego oraz wyborach wójtów.
...
4. Wniosek, o którym mowa 1, może zostać złożony na piśmie utrwalonym postaci:

- **1)** papierowej, opatrzonym własnoręcznym podpisem do urzędu gminy właściwego dla wybranego stałego obwodu głosowania na obszarze gminy, której wyborca przebywać będzie dniu wyborów;
- **2)** elektronicznej, opatrzonym kwalifikowanym podpisem elektronicznym, podpisem zaufanym albo podpisem osobistym, przy użyciu usługi elektronicznej udostępnionej przez ministra właściwego do spraw informatyzacji, po uwierzytelnieniu tej osoby sposób określony art. 20a ust. 1 ustawy z dnia 17 lutego 2005 r. o informatyzacji działalności podmiotów realizujących zadania publiczne.

5. Wniosek, o którym mowa 1, zawiera nazwisko, imię (imiona), obywatelstwo, numer ewidencyjny PESEL wnioskodawcy i adres przebywania dniu wyborów.

6. Złożenie wniosku o zmianę miejsca głosowania skutkuje ujęciem wyborcy spisie obwodzie głosowania właściwym dla adresu przebywania i skreśleniem ze spisu stałym obwodzie głosowania właściwym dla adresu zameldowania na pobyt stały lub adresu stałego zamieszkania.

7. W wyborach Prezydenta Rzeczypospolitej, których przeprowadza się głosowanie ponowne, okresie między 13 a 3 dniem przed ponownym głosowaniem, wyborca może zmienić miejsce głosowania na swój wniosek złożony sposób określony 4. Przepis 6 stosuje się odpowiednio.”;

- **24)** po art. 28 dodaje się art. 28a brzmieniu: „Art. 28a. 1. Wyborca niepełnosprawny ujmowany jest, po złożeniu wniosku o zmianę miejsca głosowania, spisie wyborców wybranym przez wyborcę stałym obwodzie głosowania gminy właściwej dla adresu zameldowania na pobyt stały lub adresu stałego zamieszkania, którym lokal obwodowej komisji wyborczej dostosowany jest do potrzeb wyborców niepełnosprawnych, jeżeli lokal obwodowej komisji wyborczej właściwej dla adresu zameldowania na pobyt stały lub adresu stałego zamieszkania wyborcy nie spełnia tych warunków. Przepisy art. 28 1 i 4–7 stosuje się odpowiednio.

2. W wyborach do organów stanowiących jednostek samorządu terytorialnego wniosek, o którym mowa 1, może dotyczyć wyłącznie lokalu obwodowej komisji wyborczej dostosowanego do potrzeb wyborców niepełnosprawnych położonego okręgu wyborczym właściwym dla adresu zameldowania na pobyt stały lub adresu stałego zamieszkania wyborcy. Jedynie przypadku gdy tym okręgu wyborczym nie ma takiego lokalu wyborczego, wniosek może dotyczyć lokalu obwodowej komisji wyborczej dostosowanego do potrzeb wyborców niepełnosprawnych położonego innym okręgu wyborczym.
...
- **29)** art. 32 otrzymuje brzmienie: „Art. 32. 1. Wyborca zmieniający miejsce pobytu przed dniem wyborów otrzymuje, na wniosek złożony do dowolnie wybranego urzędu gminy, zaświadczenie o prawie do głosowania miejscu pobytu dniu wyborów.

2. Wniosek, o którym mowa 1, składa się na piśmie utrwalonym postaci papierowej, opatrzonym własnoręcznym podpisem okresie od 44 dnia przed dniem wyborów do 3 dnia przed dniem wyborów.

3. Odbiór zaświadczenia o prawie do głosowania wydanego przez wójta wybranej gminy następuje przez wyborcę lub upoważnioną przez niego osobę urzędzie gminy, do którego złożono wniosek.

4. Wyborca, któremu wydano zaświadczenie o prawie do głosowania, jest skreślany ze spisu wyborców, którym został on ujęty.
...
- **5)** wskazanie, jakich wyborach wyborca jest uprawniony do głosowania;
- **6)** obywatelstwo, jeżeli zaświadczenie jest wydawane obywatelowi Unii Europejskiej niebędącemu obywatelem polskim uprawnionym do głosowania wyborach do Parlamentu Europejskiego.

6. Przepisu 1 nie stosuje się wyborach do organów stanowiących jednostek samorządu terytorialnego oraz wyborach wójtów.

7. W wyborach uzupełniających do Senatu przepis 1 ma zastosowanie tylko do wyborców stale zamieszkałych na obszarze okręgu wyborczego, którym przeprowadza się wybory uzupełniające.
...
1. Wójt gminy wiejskiej lub miejsko-wiejskiej rozumieniu art. 21a ust. 1 pkt 2 ustawy z dnia 13 listopada 2003 r. o dochodach jednostek samorządu terytorialnego (Dz. U. z 2022 r. poz. 2267) dniu wyborów organizuje bezpłatny gminny przewóz pasażerski dla wyborców ujętych spisie wyborców stałym obwodzie głosowania położonym na obszarze danej gminy, jeżeli ramach tej gminy:

- **1)** nie funkcjonuje dniu wyborów publiczny transport zbiorowy, o którym mowa art. 4 ust. 1 pkt 14 ustawy z dnia 16 grudnia 2010 r. o publicznym transporcie zbiorowym, albo
- **2)** najbliższy przystanek komunikacyjny, o którym mowa art. 4 ust. 1 pkt 13 ustawy z dnia 16 grudnia 2010 r. o publicznym transporcie zbiorowym, oddalony jest o ponad 1,5 km od lokalu wyborczego.
...
**Art. 4.** W ustawie z dnia 24 maja 2000 r. o Krajowym Rejestrze Karnym (Dz. U. z 2023 r. poz. 159) art. 6 ust. 1a otrzymuje brzmienie: „1a. Informacje, o których mowa ust. 1 pkt 3b–3e, przekazuje się niezwłocznie, nie później jednak niż terminie 3 dni.”.
...
1. Do dnia określonego komunikacie Prezesa Rady Ministrów wydanym na podstawie art. 15 ust. 1 pkt 7:

- **1)** przez numer ewidencyjny PESEL, o którym mowa art. 5 pkt 10 ustawy zmienianej art. 1, odniesieniu do obywateli Zjednoczonego Królestwa Wielkiej Brytanii i Irlandii Północnej należy rozumieć numer paszportu lub innego dokumentu stwierdzającego tożsamość;
- **2)** część B rejestru wyborców, o którym mowa art. 18 9 ustawy zmienianej art. 1, obejmuje również obywateli Zjednoczonego Królestwa Wielkiej Brytanii i Irlandii Północnej stale zamieszkałych na obszarze gminy i uprawnionych do korzystania z praw wyborczych Rzeczypospolitej Polskiej;
- **3)** część B spisu wyborców, o którym mowa art. 26 8 ustawy zmienianej art. 1, obejmuje również obywateli Zjednoczonego Królestwa Wielkiej Brytanii i Irlandii Północnej stale zamieszkałych na obszarze gminy i uprawnionych do korzystania z praw wyborczych Rzeczypospolitej Polskiej.
...
1. Dotychczasowe przepisy wykonawcze wydane na podstawie art. 25 oraz art. 33 ustawy zmienianej art. 1 zachowują moc do dnia wejścia życie przepisów wykonawczych wydanych odpowiednio na podstawie art. 32a oraz art. 32b ustawy zmienianej art. 1 i mogą być zmieniane na podstawie przepisów dotychczasowych.

2. Dotychczasowe przepisy wykonawcze wydane na podstawie art. 142 7 oraz art. 154 7 ustawy zmienianej art. 1 zachowują moc do dnia wejścia życie przepisów wykonawczych wydanych na podstawie art. 142 7 oraz art. 154 7 ustawy zmienianej art. 1, brzmieniu nadanym niniejszą ustawą, jednak nie dłużej niż przez 6 miesięcy od dnia wejścia życie niniejszej ustawy.

3. Dotychczasowe przepisy wykonawcze wydane na podstawie art. 34 oraz art. 38 ustawy zmienianej art. 2 zachowują moc do dnia wejścia życie przepisów wykonawczych wydanych na podstawie art. 34 oraz art. 38 ustawy zmienianej art. 2, brzmieniu nadanym niniejszą ustawą, jednak nie dłużej niż przez 6 miesięcy od dnia wejścia życie niniejszej ustawy.
...
3. Komisarz wyborczy terminie 3 miesięcy od dnia wejścia życie niniejszej ustawy dokonuje podziału stałego obwodu głosowania celu utworzenia stałego obwodu głosowania obejmującego miejscowość, o której mowa ust. 1.

4. Jeżeli miejscowości, o której mowa ust. 1, nie ma możliwości zorganizowania lokalu obwodowej komisji wyborczej, komisarz wyborczy odstępuje od dokonania podziału, o którym mowa ust. 3, i przesyła Państwowej Komisji Wyborczej informację, której przedstawia uzasadnienie wskazujące przyczynę odstąpienia od dokonania tego podziału. Państwowa Komisja Wyborcza może nakazać dokonanie podziału, o ile stwierdzi, że możliwość taka istnieje.

**Art. 17.**

1. Członkowie Państwowej Komisji Wyborczej, o których mowa art. 157 2 pkt 3 ustawy zmienianej art. 1, oraz komisarze wyborczy urodzeni przed dniem 1 sierpnia 1972 r., którzy dniu wejścia życie niniejszej ustawy pełnią swoją funkcję, mają obowiązek złożenia oświadczenia lustracyjnego albo informacji o uprzednim złożeniu oświadczenia lustracyjnego terminie trzech miesięcy od dnia wejścia życie niniejszej ustawy.
