...
- **18)** po rozdziale 2 dodaje się rozdział 2a w brzmieniu: „Rozdział 2a Zamknięte użycie GMM
...
- **c)** ust. 9 otrzymuje brzmienie: „9. Do I kategorii zamkniętego użycia GMO mogą zostać zaliczone jedynie te działania, w których:
...
- **21)** uchyla się art. 18–20;
- **22)** art. 21 otrzymuje brzmienie: „Art. 21. 1. Prowadzenie zamkniętego użycia GMO wymaga uzyskania zgody ministra właściwego do spraw środowiska.
...
- **29)** art. 32 otrzymuje brzmienie: „Art. 32. Dokonujący zamkniętego użycia GMO jest obowiązany do niezwłocznego poinformowania ministra właściwego do spraw środowiska o:
...
- **31)** art. 34 i art. 35 otrzymują brzmienie: „Art. 34. 1. Tworzy się Rejestr Zamkniętego Użycia Organizmów Genetycznie Zmodyfikowanych.
...
**Art. 15.** Decyzje ostateczne w sprawie zgody na zamierzone uwolnienie organizmów genetycznie zmodyfikowanych do środowiska wydane przed dniem wejścia w życie niniejszej ustawy na podstawie przepisów ustawy zmienianej w art. 1 zachowują moc do dnia upływu terminu, na który zostały wydane.
...
**Art. 18.** Ustawa wchodzi w życie po upływie 30 dni od dnia ogłoszenia. Prezydent Rzeczypospolitej Polskiej: B. Komorowski
