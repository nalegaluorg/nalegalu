...
- **1)** dane personalne: nazwisko, imiona, imiona i nazwiska poprzednie, imiona rodziców i nazwisko rodowe matki, datę i miejsce urodzenia, płeć, pseudonim, adres miejsca zameldowania, adres miejsca pobytu, cechy dokumentów tożsamości: rodzaj dokumentu, datę wystawienia dokumentu, organ wystawiający dokument, numer, serię dokumentu, numer ewidencyjny Powszechnego Elektronicznego Systemu Ewidencji Ludności (PESEL) lub obywatelstwo, w przypadku cudzoziemca nieposiadającego numeru PESEL, numer identyfikacji podatkowej NIP, numer identyfikacyjny REGON, ” ;
    - **a)**
    - **b)**
    - **c)**
    - **d)**
...
- **13)** w art. 28: w ust. 1 w zdaniu pierwszym skreśla się wyrazy „wraz z uzasadnieniem”, skreśla się ust. 3;
    - **a)**
    - **b)**
...
- **8)** gromadzenie, przetwarzanie i przekazywanie informacji kryminalnych, ” po pkt 8 dodaje się pkt 9 w brzmieniu: „
    - **b)**
