...
# RZECZYPOSPOLITEJ POLSKIEJ Warszawa, dnia 14 stycznia 2013 r.
...
ROZPORZĄDZENIE MINISTRA TRANSPORTU, BUDOWNICTWA I GOSPODARKI MORSKIEJ z dnia 4 grudnia 2012 r.
w sprawie oznakowania nawigacyjnego polskich obszarów morskich Na podstawie art. 86 ust. 6 ustawy z dnia 18 sierpnia 2011 r. o bezpieczeństwie morskim (Dz. U. Nr 228, poz. 1368 oraz z 2012 r. poz. 1068) zarządza się, co następuje: § 1. Rozporządzenie określa sposób oznakowania nawigacyjnego polskich obszarów morskich.
...
a) nabieżniki grupa dwóch lub więcej stałych znaków albo świateł, znajdująca się w tej samej płaszczyźnie pionowej, tworząca linię, którą statki mogą podążać nie zmieniając namiaru na nie; nabieżniki stosuje się przede wszystkim do wskazywania: osi bądź krawędzi torów wodnych, linii granic na akwenach, wąskich przejść, obszarów niebezpiecznych dla nawigacji,
b) światła sektorowe stałe znaki nawigacyjne o dowolnej konstrukcji, wyposażone w światło o różnych kolorach lub charakterystykach, pokazywanych w określonych namiarach, stosowane między innymi do wskazywania statkom: kierunku podejścia na torach wodnych, miejsc, w których przecinają się różne tory wodne, punktów, w których należy wykonać zwrot, niebezpieczeństw nawigacyjnych lub innych miejsc ważnych dla prowadzenia nawigacji, obszarów, których należy unikać,
c) latarnie morskie,
...
1. Pławyy znajdująące się na następuujjące cechy: YCH 1 rozporząd krawędzia dzenia) ach torów Rys.
Rys.
wodnych
2. Znaki pr
4. Główny kanałów rawej strony tor w lewo powinny p 8 y posiadać Rys. 1. Znaki lewej strony Rys. 2. Znaki prawej strony Rozdzielenie toru Rys. 3. Główny tor w prawo Rys. 4. Główny tor w lewo
1. Pławy znajdujące się na krawędziach torów wodnych kanałów powinny posiadać następujące cechy:
...
d) materiał odblaskowy (jeżeli jest przewidziany) zielony, poziomy pas lub zielony trójkąt,
e) światło (jeżeli jest przewidziane) zielone, błyskowe złożone FI (2+1).
Znaki kardynalne (§ 4 ust. 1 pkt 2 rozporządzenia) Rys. 5
3. Znaki kardynalne (rys. 5) powinny posiadać następujące cechy:
...
Znaki odosobnionego niebezpieczeństwa (§ 4 ust. 1 pkt 3 rozporządzenia) Rys. Rys. 6 6
4. Znaki odosobnionego niebezpieczeństwa (rys. 6) powinny posiadać następujące cechy:
...
3) znak kuliste;
4) mater pionowe
5) świat blaskow Znaki s szczytowy riał odblask e;
tło (jeżeli j we LFI 10 specjalne (§ y pojedyn kowy (jeże jest przewi s, względni § 4 ust. 1 pk ncza, czerw eli jest prz dziane) b ie litera kod kt 5 rozporz wona kula zewidziany) białe, izofa du Morse’a „ ządzenia) stosowany czerwon azowe Iso „A” Mo ( y jest na p ne i białe o albo prze A).
pławach inn pasy pozio erywane nych niż ome lub Oc, lub
2) kolorr czarny, zz jednym luub więcej szzerokimi, pooziomymi, cczerwonymii pasami;
3) znak szczytowyy dwie czzarne kule jjedna nad ddrugą, przy czym znakk powinien być tak duży, jaak to tylko mmożliwe i z wyraźnym prześwitemm pomiędzy kulami;
4) materriał odblasskowy (jeżeli jest prrzewidzianyy) jednaa lub więccej par pozziomych niebieskko-czerwonnych pasów;
5) świattło (jeżeli jeest przewidzziane) biaałłe, błyskowwe grupowe FI(2).
Znaki bbezpiecznejj wody (§ 44 ust. 1 pkt 44 rozporząddzenia) Rys. 7
5. Pławyy będące znnakami bezppiecznej woody (rys. 7) powinny poosiadać nasttępujące cecchy:
1) ksztaałt kulisty,, kolumnowwy lub drążkkowy;
2) kolorr czerwonne i białe pioonowe pasyy;
12 Rys. 7
5. Pławy będące znakami bezpiecznej wody (rys. 7) powinny posiadać następujące cechy:
...
6. 1. Pławy będące znakami specjalnymi (rys. 8) powinny posiadać następujące cechy:
...
6. 2. Zastosowanie znaków specjalnych do dodatkowego oznakowania akwenu lub przeszkody, innych niż wymienione w § 4 ust. 1 pkt 5 rozporządzenia, nie może kolidować z wymaganiami oznakowania nawigacyjnego określonymi w rozporządzeniu.
Znak „tymczasowa pława wrakowa” (§ 4 ust. 1 pkt 6 rozporządzenia)
6.2. Zasstosowanie znaków specjalnychh do doddatkowego oznakowaania akweenu lub przeszkkody, innychh niż wymieenione w § 4 ust. 1 pktt 5 rozporząądzenia, niee może koliidować z wymagaaniami oznaakowania naawigacyjnego określonnymi w rozpporządzeniuu.
Znak „ttymczasowwa pława wrrakowa” (§§ 4 ust. 1 pkkt 6 rozporzządzenia) Rys. 9
7. Znakk „tymczasowwa pława wwrakowa” (rrys. 9) powiinnien posiaadać następuujące cechyy:
1) ksztaałt kolumnowwy lub drążżkowy;
2) kolorr niebieskkie i żółte piionowe pasyy, równe pood względemm liczby i rrozmiarów (od 4 do 8 pasóww);
3) znak szczytowyy (jeżeli jestt przewidziiany) pojeedynczy żóółty krzyż ww pozycji ppionowej (rys. 9);;
4) materriał odblaskkowy (jeżelii jest przewwidziany) ppionowe, żóółte i niebiesskie pasy;
5) świattło zmiennnobarwne ww kolorze żóółtym i niebbieskim, przzerywane - AAl.Oc.BuY.3s.
Inne znnaki (§ 4 ustt. 1 pkt 7 roozporządzennia) Rys. 9
7. Znak „tymczasowa pława wrakowa” (rys. 9) powinnien posiadać następujące cechy:
...
Inne znaki (§ 4 ust. 1 pkt 7 rozporządzenia) Rys. 10
8. Nabieeżniki składdają się z ddwóch lub wwięcej stałych znaków albo świateeł, znajdująących się w tej saamej płaszczzyźnie pionoowej tworząąc linię nabbieżnika (ryss. 10).
Konstruukcje nabieżżników moggą być dowoolnego kszttałtu lub kolloru, dobrannego w takii sposób, aby wyrróżniały sięę z otoczeniia i nie moggły być pommylone z innnymi, poblliskimi obieektami mogą ww tym celu być też wyyposażone ww znaki dzzienne. Jeślii nabieżnikii wyposażoone są w światła, powinny bbyć to świaatła rytmiczzne o tej samej charaakterystyce świecenia, o ile to możliwee zsynchroonizowane zze sobą, coo ułatwia iich rozróżnnienie spośrród innychh świateł znajdująących się naa obszarze pprzyległym..
Rys. 10
8. Nabieżniki składają się z dwóch lub więcej stałych znaków albo świateł, znajdujących się w tej samej płaszczyźnie pionowej, tworząc linię nabieżnika (rys. 10).
Konstrukcje nabieżników mogą być dowolnego kształtu lub koloru, dobranego w taki sposób, aby wyróżniały się z otoczenia i nie mogły być pomylone z innymi, pobliskimi obiektami mogą w tym celu być też wyposażone w znaki dzienne.
Jeśli nabieżniki wyposażone są w światła, powinny być to światła rytmiczne o tej samej charakterystyce świecenia, o ile to możliwe zsynchronizowane ze sobą, co ułatwia ich rozróżnienie spośród innych świateł znajdujących się na obszarze przyległym.
Rys. 11
9. Światła sektorowe (rys. 11) posiadają dowolną konstrukcję i świecą światłem o różnych kolorach lub charakterystykach, Rys. 12
10. Lattarnie morskie mogą bbyć dowolnnego koloru lub ksztaałtu, mogą posiadać tteż znak dziennyy w celu icch łatwiejszzej identyfiikacji (rys. 12). Świattło latarń mmorskich mmoże być koloru bbiałego, czeerwonego luub zieloneggo o dowolnnej charakteerystyce błyyskowej, izoofazowej lub przzerywanej, dobranej ttak, aby uułatwiała iddentyfikacjęę latarni. KKonstrukcjaa latarni morskieej może słłużyć takżee do zamoontowania na niej innnych urząądzeń oznaakowania nawigaccyjnego np.. rakonów, Systemu AAIS, elektroonicznych uurządzeń doo określaniaa pozycji lub innyych.
Rys. 12
10. Latarnie morskie mogą być dowolnego koloru lub kształtu, mogą posiadać też znak dzienny w celu ich łatwiejszej identyfikacji (rys. 12). Światło latarń morskich może być koloru białego, czerwonego lub zielonego o dowolnej charakterystyce błyskowej, izofazowej lub przerywanej, dobranej tak, aby ułatwiała identyfikację latarni. Konstrukcja latarni morskiej może służyć także do zamontowania na niej innych urządzeń oznakowania nawigacyjnego np. rakonów, Systemu AIS, elektronicznych urządzeń do określania pozycji lub innych.
Rys. 13 Rys. 13
10. 1. Stałe znaki nawigacyjne mogą pełnić funkcję znaków bocznych, kardynalnych i specjalnych, powinny wtedy posiadać kolor i światło właściwe dla tych znaków. Konstrukcje mogą przyjmować kształt dowolny, nie powinny one jednak utrudniać identyfikacji koloru znaku i w miarę możliwości powinny posiadać odpowiedni znak szczytowy (rys. 13).
Rys. 14
10. 2. Jeżeli stały znak nawigacyjny pełni inną funkcję, to kolor jego konstrukcji oraz kolor i rytm światła nie powinny kolidować ze znakami wymienionymi w ust. 1 (rys. 14).
...
11. 1. Jeżeli w celu oznakowania nowego niebezpieczeństwa zastosowano znak boczny, to powinien on być wyposażony w światło migające Q lub szybko migające VQ o kolorze właściwym dla znaku bocznego. W przypadku zastosowania znaków kardynalnych i odosobnionego niebezpieczeństwa powinny one posiadać światło o charakterystyce właściwej dla wybranego systemu.
11. 2. Na znaku nawigacyjnym oznaczającym nowe niebezpieczeństwo może być zainstalowany rakon z literą kodu Morse’a „D” Mo (D), dający na ekranie radarowym echo o długości odpowiadającej 1 Mm, lub transponder AIS.
Rys. 14
10.2. Jeeżeli stały znnak nawigaccyjny pełni inną funkcjję to kolor jego konstruukcji oraz kkolor i rytm śwwiatła nie poowinny kolidować ze znnakami wymmienionymii w ust. 1 (rrys. 14).
Znaki ddotyczące nnowego niebbezpieczeńństwa (§ 4 uust. 4 rozporrządzenia)
11. Jeżżeli niebezppieczeństwoo jest szczzególnie pooważne, przzynajmniej jeden ze znaków oznaczaających to niebezpieeczeństwo powinien być zdubllowany. Jeednocześniee każdy dublująccy znak nawwigacyjny ppowinien byyć we wszysstkich szczeegółach idenntyczny ze znakiem zasadnicczym.
11.1. Jeeżeli w celuu oznakowaania noweggo niebezpieczeństwa zastosowanno znak booczny, to powinieen on być wwyposażonyy w światło migające –– Q lub szyybko migająące VQ oo kolorze właściwwym dla zznaku boczznego. W przypadku zastosowaania znakóów kardynaalnych i odosobnnionego nieebezpieczeńństwa powinnny one posiadać światło o charakktterystyce wwłaściwej dla wybbranego systtemu.
11.2. Naa znaku nawigacyjnnym oznaaczającym nowe nieebezpieczeńństwo mooże być zainstalowany rakoon z literą kkodu Morse’a „D” MMo (D), dający na ekrannie radarowyym echo o długości odpowiaadającej 1 MMm lub trannsponder AIIS.
19
1. Przejścia żeglowne pod stałymi mostami wymagają dodatkowego oznakowania, w szczególności w sytuacji ograniczonego prześwitu pod mostem, małych głębokości wody czy możliwości kolizji z filarem mostu.
2. 1. W przypadkach określonych w ust. 1 części B załącznika, jeżeli okaże się, że konieczne lub pożądane jest wskazanie statkom najbardziej odpowiedniego miejsca przejścia pod mostem, oznakowuje się „najlepszy punkt przejścia”.
2. 2. Najlepszy punkt przejścia określa właściwy dyrektor urzędu morskiego przy uwzględnieniu następujących czynników:
...
3. Sposób oznakowania przejść żeglownych pod mostami powinien być zgodny z powszechnie przyjętym kierunkiem oznakowania toru wodnego przez znaki systemu bocznego.
4. Oznakowanie dzienne (jeśli jest wymagane) powinno charakteryzować się następującymi cechami:
1) jeżeli żegluga odbywa się na całej rozpiętości przejścia (przęsła), znaki powinny być umieszczone na filarach mostu;
jeżeli żegluga jest możliwa tylko w części rozpiętości przęsła, to znaki powinny być umieszczone na lub pod przęsłem tak, by wskazywały granice części żeglownej; znaki, o ile to możliwe, powinny być rozmieszczone na płaszczyźnie prostokąta tak, aby wszystkie jego wierzchołki były widoczne przed wejściem pod most (umożliwia to kapitanowi ciągłą ocenę położenia jednostki względem osi toru);
2) granice przejścia powinny być oznakowane w następujący sposób:
a) lewa strona tablica pokazująca czerwony kwadrat na białym tle (rys. 15), Rys. 15
b) prawwa strona ttablica pokaazująca zieloony trójkąt do góryy, na białymm tle (rys. 166);
równoboczny, wierzchhołkiem skierowany Rys. 15
b) prawa strona tablica pokazująca zielony trójkąt równoboczny, wierzchołkiem skierowany do góry, na białym tle (rys. 16);
b) praw do góry
3) najlep czerwon Wymiar a 1000 wa strona t y, na białym pszy punkt no-białe pas tablica poka m tle (rys. 16 t przejścia ry w mm b 600 sy (rys. 17).
azująca zielo
6);
może być c 750 .
ony trójkąt równoboczny, wierzchhołkiem skierowany Rys. 16 ć wskazanyy przez okkrągłą tabliccę pomalowwaną w Rys. 17 d e f 650 1050 150 21 Rys. 16
3) najlepszy punkt przejścia może być wskazany przez okrągłą tablicę pomalowaną w czerwono-białe pasy (rys. 17).
Rys. 17 Wymiary w mm a b c d e f 1000 600 750 650 1050 150
...
6. 1. Każdy most powinien być wyposażony w znak informujący o prześwicie pod konstrukcją dla średniego stanu wody. Znak taki stanowi tablica (rys. 18) pokazująca pochylony kwadrat koloru żółtego, na którym podana jest wartość prześwitu wyrażona w metrach i dziesiątkach metra (liczba jest koloru czarnego) w odniesieniu do średniego stanu wody. Tablica powinna być umieszczona na przęśle nad przejściem. Po obu stronach mostu powinny być ustawione tablice wskazujące na aktualny oraz średni stan wody.
Rys. 18 Wymiary w mm g h k l m n p q 900 500 400 300 240 700 55 45 konstruk pochylo metrach wody. T powinny kcją dla śr ony kwadra h i dziesiątk Tablica pow y być ustaw redniego st at koloru żó kach metra winna być u wione tablic tanu wody ółtego, na k (liczba jest umieszczona e wskazując . Znak tak którym pod t koloru cza a na przęśle ce na aktual ki stanowi dana jest w arnego) w o e nad przej lny oraz śre tablica (ry wartość prze odniesieniu ściem. Po o edni stan wo ys. 18) pok eświtu wyra do średnieg obu stronac ody.
22 kazująca ażona w go stanu ch mostu
6. 2. Na torach wodnych, które stanowią zarówno morską, jak i śródlądową drogę wodną, zamiast znaku, o którym mowa w ust. 6. 1, może być zamiennie stosowany znak żeglugi śródlądowej, informujący o ograniczonej wysokości prześwitu nad zwierciadłem wody (rys. 19). Dodatkowo stosowany może być znak informujący o ograniczonej głębokości (rys. 20) oraz znak informujący o ograniczonej szerokości przejścia (rys. 21).
zamiastt znaku, o którym moowa w ust. 6.1, może być zamieennie stosowwany znak żeglugi śródlądoowej, informmujący o oograniczonejj wysokoścci prześwituu nad zwierrcciadłem woody (rys.
19). Doodatkowo sttosowany mmoże być znnak informuujący o ograniczonej ggłębokości ((rys. 20) oraz znaak informujący o ogranniczonej szeerokości przzejścia (rys. 21).
Rys. 19 Rys. 20 Rys. 21 23 Rys. 19 Rys. 20 Rys. 21 Na powyższe znaki można nanieść liczby wskazujące odpowiednio wysokość, głębokość i szerokość przejścia. Cyfry powinny być koloru czarnego.
7. Rozmiary tablic przedstawionych na rysunkach 15–21 części B załącznika mogą być zmienione stosownie do sytuacji za zgodą służb oznakowania nawigacyjnego właściwego urzędu morskiego.
8. W warunkach ograniczonej widoczności do ostrzeżenia statku o istnieniu mostu mogą być stosowane jeden lub więcej sygnałów mgłowych, tj. sygnałów dźwiękowych emitowanych w warunkach ograniczonej widoczności. W tym celu może być używany dowolny typ sygnału mgłowego. Jeżeli używanych jest wiele sygnałów mgłowych umieszczonych
...
10. Falochrony wejściowe do portów i basenów portowych mogą być oznakowane za pomocą świateł ostrzegawczych umiejscowionych na słupach, masztach. Kolorystyka konstrukcji znaków może być dowolna, lecz niekolidująca ze znakami bocznymi. Światła powinny posiadać światło pomarańczowe o charakterystyce stałej. Jeżeli jest to uzasadnione z punktu widzenia nawigacyjnego, za pomocą protokołu Systemu AIS powinny być transmitowane dane na temat prędkości, kierunku wiatru i prądu morskiego.
11. Konstrukcje „offshore” powinny być oznakowane przez jedno lub więcej świateł białych o charakterystyce: litera „U” w kodzie Morse’a okres 15 s Mo (U) 15 s, w ten sposób, by co najmniej jedno światło było widoczne przez zbliżające się z dowolnego kierunku statki. Światła te powinny być zsynchronizowane ze sobą, posiadać minimalną światłość 1400 kandeli i być zainstalowane na wysokości od 6 do 30 m ponad średnim poziomem morza MSL (Mean Sea Level).
Dywergencja pionowa świateł powinna być dobrana w taki sposób, aby były one widziane przez statki od granicy maksymalnego zasięgu świateł do samej oznakowywanej konstrukcji „offshore”. Każda konstrukcja „offshore” może być również wyposażona w tablice identyfikujące jej nazwę lub numer, które powinny być łatwo zauważalne ze wszystkich kierunków podczas dnia i w nocy (poprzez zastosowanie podświetlenia lub materiałów odblaskowych) tablice powinny być koloru żółtego z czarnymi symbolami (literami lub cyframi) o wysokości 1 m.
12. Na konstrukcji „offshore” powinny być zainstalowane dodatkowo:
1) rakon jeśli zachodzi konieczność identyfikacji konkretnej konstrukcji spośród innych, może być ona wyposażona w rakon o literze w kodzie Morse’a i zasięgu określonych przez dyrektora właściwego terytorialnie urzędu morskiego;
każdy rakon zainstalowany na konstrukcji, która nie została jeszcze umieszczona na mapach morskich, powinien pokazywać literę „D” w kodzie Morse’a;
...
13. Jeśli w bezpośredniej bliskości znajduje się duża liczba konstrukcji „offshore”, a bezpieczeństwo żeglugi może zostać zapewnione bez konieczności wyposażania każdej indywidualnej konstrukcji w światła nawigacyjne lub sygnały mgłowe, dyrektor właściwego terytorialnie urzędu morskiego może wyrazić zgodę na odstąpienie od tego obowiązku.
14. Jeśli zachodzi konieczność oznakowania nawigacyjnego całego akwenu, na którym znajduje się grupa konstrukcji „offshore”, lub oznakowania przejścia pomiędzy poszczególnymi konstrukcjami albo oznakowania akwenu, na którym konstrukcje są wznoszone lub demontowane, a także oznakowania podwodnych przeszkód nawigacyjnych, należy użyć znaków nawigacyjnych opisanych w rozporządzeniu.
15. Morskie elektrownie wiatrowe powinny być oznakowane zgodnie ze sposobem oznakowania nawigacyjnego przyjętym w rozporządzeniu, tak aby były odróżnialne w ciągu dnia i w nocy, a ponadto spełniały podane niżej warunki:
...
16. Morskie farmy hodowlane, jeśli stanowią przeszkodę nawigacyjną, powinny być oznakowane przy użyciu znaków specjalnych, bocznych, kardynalnych lub ich kombinacji. Dopuszcza się też zastosowanie rakonów, Systemu AIS i reflektorów radarowych jako uzupełnienie oznakowania nawigacyjnego morskich farm hodowlanych. Morska farma hodowlana (lub grupa farm) powinna być oznakowana zależnie od jej rozmiarów i lokalizacji. W niektórych przypadkach wystarczające będzie oznakowanie jedynie części obszaru lub jego środka.
...
## CZĘŚĆ A. SPOSÓB ROZMIESZCZENIA, KONSTRUKCJA, KSZTAŁT, KOLORYSTYKA, CHARAKTERYSTYKA ŚWIATEŁ I ZNAKI SZCZYTOWE ZNAKÓW NAWIGACYJNYCH Znaki boczne (§ 4 ust. 1 pkt 1 rozporządzenia) ZNAKÓÓW NAWIIGACYJNY Znaki bboczne (§ 44 ust. 1 pkt 1 Rys. 1. Znaki lewejj strony Rozdzieelenie toru Rys. 3. Główny torr w prawo
