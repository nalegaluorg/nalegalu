...
source: "eli-html"
---
# Rozporządzenie Ministra Kultury i Dziedzictwa Narodowegoz dnia 23 października 2015 r. w sprawie wykazu źródeł, których sprawdzenie jest wymagane w ramach starannych poszukiwań uprawnionych do utworów i przedmiotów praw pokrewnych, które mogą być uznane za osierocone, oraz sposobu dokumentowania informacji o wynikach starannych poszukiwań [2) Niniejsze rozporządzenie wdraża dyrektywę Parlamentu Europejskiego i Rady 2012/28/UE z dnia 25 października 2012 r. w sprawie niektórych dozwolonych sposobów korzystania z utworów osieroconych (Dz. Urz. UE L 299 z 27.10.2012, str. 5).](#gloss-0:2:)
...
| Źródło | [ELI HTML](https://eli.gov.pl/api/acts/DU/2015/1823/text.html) · [ELI API](https://api.sejm.gov.pl/eli/acts/DU/2015/1823) |

## Spis treści

- [Treść rozporządzenia](#part_1)

- [Załącznik - Wykaz źródeł, których sprawdzenie jest wymagane w ramach starannych poszukiwań, o których mowa w art. 356 ust. 1 ustawy z dnia 4 lutego 1994 r. o prawie autorskim i prawach pokrewnych (Dz. U. z 2006 r. nr 90, poz. 631, z późn. zm.)](#part_2)
...
wykaz źródeł, których sprawdzenie jest wymagane w ramach starannych poszukiwań, o których mowa w art. 356 ust. 1 ustawy z dnia 4 lutego 1994 r. o prawie autorskim i prawach pokrewnych;

### 2)

sposób dokumentowania informacji o wynikach starannych poszukiwań przez podmioty wymienione w art. 355 ust. 2 ustawy z dnia 4 lutego 1994 r. o prawie autorskim i prawach pokrewnych.
...
kartoteki wzorcowe haseł osobowych oraz katalogi:
...
informacje będące w posiadaniu następujących izb i stowarzyszeń twórców i wydawców:
...
następujące bazy danych i rejestry utworów publikowanych w formie drukowanej:
...
informacje będące w posiadaniu następujących organizacji zbiorowego zarządzania prawami autorskimi:
...
informacje będące w posiadaniu wydawcy danej publikacji, o ile w dalszym ciągu wydawca ten istnieje w czasie prowadzenia starannych poszukiwań;
...
źródła, o których mowa w pkt 1 lit. a,

### b)

baza ISSN (International Standard Serial Number) dla publikacji periodycznych, prowadzona przez Bibliotekę Narodową,
...
w zależności od formy publikacji - źródła, o których mowa w pkt 1 lub 2,

### b)

w przypadku utworów fotograficznych informacje będące w posiadaniu Związku Polskich Artystów Fotografików oraz w zależności od szczególnej tematyki lub charakteru utworu:
...
w przypadku utworów plastycznych informacje będące w posiadaniu Związku Polskich Artystów Plastyków;
...
katalog Filmoteki Narodowej w Warszawie,

### b)

informacje będące w posiadaniu następujących izb i stowarzyszeń:
...
bazy danych, kartoteki haseł wzorcowych oraz katalogi:
...
następujące bazy danych powiązane z właściwymi normami i identyfikatorami:
...
wykazy twórców i inne informacje znajdujące się na opakowaniu egzemplarza utworu,

### f)

informacje będące w posiadaniu następujących organizacji zbiorowego zarządzania:
...
następujące internetowe bazy danych o utworach, o ile są one ogólnodostępne: www.filmpolski.pl, www.filmweb.pl, www.stopklatka.pl, www.imdb.com,

### h)

bazy danych zawierające informacje identyfikujące zbiory programowe oraz archiwa dokumentacji aktowej Telewizji Polskiej S.A.;
...
wykazy twórców i inne informacje znajdujące się na opakowaniu egzemplarza fonogramu,
...
bazy danych i katalogi zbiorów muzycznych Biblioteki Narodowej w Warszawie,
...
bazy danych zawierające informacje identyfikujące zbiory programowe oraz archiwa dokumentacji aktowej publicznych organizacji radiowych.
