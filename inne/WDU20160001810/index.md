...
| Źródło | [ELI HTML](https://eli.gov.pl/api/acts/DU/2016/1810/text.html) · [ELI API](https://api.sejm.gov.pl/eli/acts/DU/2016/1810) |

## Treść ustawy

### Art. 1.

W ustawie z dnia 21 czerwca 1996 r. o urzędach i izbach skarbowych ([Dz. U. z 2015 r. poz. 578](https://api.sejm.gov.pl/eli/acts/DU/2015/578/text.html)) po art. 8b dodaje się art. 8c w brzmieniu:
...
W ustawie z dnia 13 października 1998 r. o systemie ubezpieczeń społecznych ([Dz. U. z 2016 r. poz. 963](https://api.sejm.gov.pl/eli/acts/DU/2016/963/text.html), [1247](https://api.sejm.gov.pl/eli/acts/DU/2016/1247/text.html), [1579](https://api.sejm.gov.pl/eli/acts/DU/2016/1579/text.html) i [1807](https://api.sejm.gov.pl/eli/acts/DU/2016/1807/text.html)) w art. 50 dodaje się ust. 17 w brzmieniu:

„

### 17.

Zakład udostępnia ministrowi właściwemu do spraw finansów publicznych na jego żądanie dane:

### 1)

dotyczące ubezpieczonego:
...
identyfikator miejscowości według krajowego rejestru urzędowego podziału terytorialnego kraju (TERYT) adresu zameldowania - do najniższego posiadanego poziomu,

### c)

identyfikator miejscowości według krajowego rejestru urzędowego podziału terytorialnego kraju (TERYT) adresu korespondencji - do najniższego posiadanego poziomu,

### d)

NIP i numer identyfikacyjny REGON, a jeżeli płatnikowi składek nie nadano tych numerów lub jednego z nich - numer PESEL lub serię i numer dowodu osobistego albo paszportu,

### e)

numer płatnika w Krajowym Rejestrze Sądowym,
...
wymiar czasu pracy w szczególnych warunkach lub o szczególnym charakterze,
...
liczba dni zasiłkowych oraz liczba wypłat;

### 2)

dotyczące osób zgłaszanych przez ubezpieczonego do ubezpieczenia zdrowotnego:
...
liczba pracowników, za których jest opłacana składka na Fundusz Emerytur Pomostowych,
...
dotyczące uprawnionych do świadczeń z ubezpieczeń społecznych oraz świadczeń wypłacanych przez Zakład na mocy odrębnych przepisów:
...
wysokość dodatków przysługujących do świadczenia
