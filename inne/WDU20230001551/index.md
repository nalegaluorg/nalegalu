...
eksploatowanych na wodach dydaktyczne 2. Mapy nawigacyjne dla obszarów stosowania Kodeksu popolarnych – stopień larnego.
podstawowy oraz stopień 3. Publikacje nawigacyjne odpowiednie do rejonu ćwiczeń.
wyższy Ćwiczenia Symulator operacyjny mostka nawigacyjnego umożliwiający praktyczne symulację akwenu polarnego o różnych stopniach zalodzenia różnymi formami lodu.
42 w zakresie statków Pomoce Zestaw schematów instalacji statkowych maszyn napędopodlegających kodeksowi IGF – dydaktyczne wych, maszyn pomocniczych do wytwarzania energii oraz stopień podstawowy maszyn innego przeznaczenia, wykorzystujących jako paliwo gaz lub paliwo o niskiej temperaturze zapłonu.
...
Ćwiczenia Poligon pożarowy wyposażony w stacjonarny system gaszepraktyczne nia proszkiem (DCP).
43 w zakresie statków Pomoce 1. Zestaw schematów instalacji statkowych maszyn napędopodlegających kodeksowi IGF – dydaktyczne wych, maszyn pomocniczych do wytwarzania energii oraz stopień wyższy maszyn innego przeznaczenia, wykorzystujących jako paliwo gaz lub paliwo o niskiej temperaturze zapłonu.
2. Karta charakterystyki (SDS).
3. Lista kontrolna bunkrowania.
Ćwiczenia Symulator programowy do obsługi systemów i urządzeń znajpraktyczne dujących się na statkach podlegających kodeksowi IGF z możliwością symulacji sytuacji awaryjnych.
44 dydaktyczne dla instruktora Symulator Rodzaj wykorzystywanego na zajęciach symulatora zależy szkolącego i egzaminującego od zakresu zajęć, do którego przygotowywana jest osoba na symulatorach szkolona.
2) załącznik nr 3 do rozporządzenia otrzymuje brzmienie określone w załączniku do niniejszego rozporządzenia.
§ 2. Rozporządzenie wchodzi w życie po upływie 14 dni od dnia ogłoszenia.
Minister Infrastruktury: A. Adamczyk OBJAŚNIENIA SKRÓTÓW
...
25) Konwencja COLREG – Konwencja w sprawie międzynarodowych przepisów o zapobieganiu zderzeniom na morzu z 1972 roku, sporządzona w Londynie dnia 20 października 1972 r. (Dz. U. z 1977 r. poz. 61 i 62 oraz z 1984 r.
