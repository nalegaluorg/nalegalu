...
# RZECZYPOSPOLITEJ POLSKIEJ Poz. 232 ROZPORZĄDZENIE MINISTRA SPRAW WEWNĘTRZNYCH I ADMINISTRACJI z dnia 24 stycznia 2018 r.
...
w sprawie przechowywania, ewidencjonowania oraz pobierania broni palnej i amunicji oraz środków przymusu bezpośredniego w Biurze Nadzoru Wewnętrznego Na podstawie art. 11r ust. 3 ustawy z dnia 21 czerwca 1996 r. o szczególnych formach sprawowania nadzoru przez ministra właściwego do spraw wewnętrznych (Dz. U. poz. 491, z późn. zm. ) zarządza się, co następuje:
§ 1. Rozporządzenie określa:
1) wymogi przechowywania,
2) sposoby ewidencjonowania oraz
3) tryb pobierania – broni palnej, amunicji i środków przymusu bezpośredniego w Biurze Nadzoru Wewnętrznego.
§ 2. 1. Broń palną i amunicję przechowuje się w szafach metalowych lub sejfach specjalnie przeznaczonych do przechowywania broni palnej i amunicji, umieszczonych w odpowiednio przystosowanym do tego celu pomieszczeniu, zwanym dalej „magazynem broni”.
...
§ 3. W przypadkach, o których mowa w § 2 ust. 2:
...
§ 4. 1. Magazyn broni umiejscawia się w siedzibie Inspektora Nadzoru Wewnętrznego.
...
§ 5. W przypadku, o którym mowa w § 4 ust. 1, magazyn broni wymaga:
...
§ 6. 1. Broń palną przechowuje się rozładowaną, zabezpieczoną zgodnie z zaleceniami producenta, z odłączonym magazynkiem, kompletną i czystą, a jednostki broni nieprzydzielone i nieużytkowane – w odpowiedni sposób zakonserwowane.
...
§ 7. 1. Warunki przechowywania broni palnej uwzględniają wymagania jej producenta w zakresie zapewnienia właściwego stanu technicznego.
...
§ 8. 1. Broń palna i amunicja przechowywana w magazynie broni podlega ewidencjonowaniu w książce stanu broni palnej i amunicji.
...
§ 9. Dostęp do magazynu broni, nadzór nad przechowywanym w nim wyposażeniem oraz uprawnienie do wydawania i rozliczania pobranego wyposażenia przysługuje osobom upoważnionym przez Inspektora Nadzoru Wewnętrznego.
§ 10. 1. Pobieranie, wydawanie oraz zdawanie broni palnej i amunicji podlega ewidencjonowaniu w książce pobrania, wydania-przyjęcia broni palnej i amunicji, która jest przechowywana w magazynie broni.
2. Wzór książki pobrania, wydania-przyjęcia broni palnej i amunicji jest określony w załączniku nr 2 do rozporządzenia.
§ 11. 1. Kajdanki, przedmioty przeznaczone do obezwładniania osób za pomocą energii elektrycznej, środki przeznaczone do pokonywania zamknięć budowlanych i innych przeszkód, w tym materiały wybuchowe, przechowuje się w pomieszczeniach znajdujących się w siedzibie Inspektora Nadzoru Wewnętrznego w sposób uniemożliwiający dostęp osobom nieuprawnionym.
...
§ 12. 1. Środki przymusu bezpośredniego, o których mowa w § 11 ust. 1, są ewidencjonowane w książce ewidencji środków przymusu bezpośredniego prowadzonej w Biurze Nadzoru Wewnętrznego.
2. Wzór książki ewidencji, o której mowa w ust. 1, jest określony w załączniku nr 3 do rozporządzenia.
§ 13. 1. Pobieranie, wydawanie oraz zdawanie środków przymusu bezpośredniego przechowywanych w pomieszczeniach znajdujących się w siedzibie Inspektora Nadzoru Wewnętrznego podlega ewidencjonowaniu w książce pobrania, wydania-przyjęcia środków przymusu bezpośredniego, która jest przechowywana w miejscu wskazanym przez Inspektora Nadzoru Wewnętrznego.
