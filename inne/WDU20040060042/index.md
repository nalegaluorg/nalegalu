...
- **1)** w art. 1:
    - **a)** w ust. 1 pkt 2 i 3 otrzymują brzmienie: „2) zmiany umów wymienionych w pkt 1, jeżeli powodują one podwyższenie podstawy opodatkowania podatkiem od czynności cywilnoprawnych, z zastrzeżeniem ust. 3 pkt 4, 3) orzeczenia sądów, w tym również polubownych, oraz ugody, jeżeli wywołują one takie same skutki prawne, jak czynności cywilnoprawne wymienione w pkt 1 lub 2.”,
