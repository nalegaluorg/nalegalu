...
| Pole | Wartość |
|---|---|
| Adres publikacyjny | Dz.U. 2011 nr 92 poz. 528 |
| ISAP | WDU20110920528 |
| Typ aktu | Ustawa |
| Status | akt objęty tekstem jednolitym |
| W mocy | tak |
...
- **9)** w art. 11: ust. 1–3 otrzymują brzmienie: „
    - **a)**
...
3. Wyrób nie może zostać wprowadzony do użytku bez przeprowadzenia działań wymienionych w art. 7, 8 albo 9, określonych w przepisach wydanych na podstawie art. 10 ust. 1 pkt 2. ” , dodaje się ust. 5 w brzmieniu: „
...
1. Akredytacji OiB udziela Minister Obrony Narodowej na wniosek jednostki organizacyjnej spełniającej wymagania określone w art. 14 ust. 1. ” , ust. 3 otrzymuje brzmienie: „

- **b)**

3. Minister Obrony Narodowej, w terminie nie dłuższym niż 6 miesięcy od dnia złożenia wniosku, udziela albo odmawia udzielenia akredytacji OiB. ” , ust. 5 otrzymuje brzmienie: „

- **c)**

5. Jeżeli po udzieleniu akredytacji OiB jednostka badawcza lub jednostka certyfikująca przestała spełniać którykolwiek z wymogów dotyczących udzielenia akredytacji OiB, o których mowa w art. 14 ust. 1, Minister Obrony Narodowej może ograniczyć zakres akredytacji, zawiesić albo cofnąć akredytację. ” , po ust. 5 dodaje się ust. 5a w brzmieniu: „

- **d)**

5a. Okres ograniczenia zakresu akredytacji OiB lub zawieszenia akredytacji OiB nie może być dłuższy niż 1 rok. ” , ust. 6 i 7 otrzymują brzmienie: „
...
- **15)** w art. 26: po ust. 4 dodaje się ust. 4a w brzmieniu: „
    - **a)**

4a. Maksymalne wysokości opłat za czynności związane z badaniami na potrzeby oceny zgodności wyrobów lub certyfikacją, powinny uwzględniać uzasadnione koszty, które nie mogą przekroczyć 120% wysokości kosztów obliczonych z uwzględnieniem ust. 3 i 4. ” , ust. 5 otrzymuje brzmienie: „
