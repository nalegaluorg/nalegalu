...
- **4)** w art. 95d: ust. 1–1b otrzymują brzmienie: „
    - **a)**
...
- **1)** polegającej na utworzeniu na obszarze województwa: nowego podmiotu leczniczego, nowych jednostek lub komórek organizacyjnych zakładu leczniczego podmiotu leczniczego,
    - **a)**
    - **b)**
...
1b. Przez inną inwestycję, o której mowa w ust. 1 pkt 2, rozumie się roboty budowlane w rozumieniu art. 3 pkt 7 ustawy z dnia 7 lipca 1994 r. – Prawo budowlane (Dz. U. z 2020 r. poz. 1333 i 2127) lub wyposażenie zakładu leczniczego podmiotu leczniczego, jeżeli działania te stanowią główny cel tej inwestycji. ” , ust. 1d i 1e otrzymują brzmienie: „
...
1e. Odpowiednio Minister Obrony Narodowej albo minister właściwy do spraw wewnętrznych, w porozumieniu z ministrem właściwym do spraw zdrowia, rozstrzyga, czy inwestycja będzie realizowana na potrzeby określone w ust. 1d. ” , w ust. 3 w pkt 6 kropkę zastępuje się średnikiem i dodaje się pkt 7 w brzmieniu: „

- **c)**
- **7)** podmiot leczniczy, który zamierza realizować inwestycję, której wartość kosztorysowa na dzień złożenia wniosku o wydanie takiej opinii przekracza 50 mln zł. ” , w ust. 4 wprowadzenie do wyliczenia otrzymuje brzmienie: „ Do określenia wartości inwestycji, o których mowa w ust. 1, zalicza się następujące rodzaje poniesionych lub planowanych kosztów na dzień złożenia wniosku: ” ;
    - **d)**
...
- **6)** po art. 95e dodaje się art. 95ea-95ec w brzmieniu: „ Art. 95ea.
...
- **9)** po art. 95g dodaje się art. 95ga w brzmieniu: „ Pozytywna opinia o celowości inwestycji jest ważna 3 lata od dnia jej wydania. ” ;
- **10)** w art. 95i: w ust. 3 zdanie pierwsze otrzymuje brzmienie: „ Protest wnosi się w postaci elektronicznej opatrzony kwalifikowanym podpisem elektronicznym, podpisem zaufanym lub podpisem osobistym. ” , w ust. 8 pkt 8 otrzymuje brzmienie: „
    - **a)**
    - **b)**
...
- **2)** w art. 16j: ust. 2 i 2a otrzymują brzmienie: „
    - **a)**
...
- **4)** po art. 19i dodaje się art. 19ia w brzmieniu: „ Art. 19ia.
...
- **3)** w art. 28 w pkt 1: w lit. c skreśla się wyrazy „pkt 40,”, w lit. d średnik zastępuje się przecinkiem i dodaje się lit. e w brzmieniu: „ pkt 40, który wchodzi w życie z dniem 31 grudnia 2022 r.; ” .
    - **a)**
    - **b)**
    - **e)**
