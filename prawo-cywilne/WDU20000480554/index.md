...
- **30)** w art. 393 oraz w art. 393 w § 1 wyrazy „zaskarżony wyrok” zastępuje się wyrazami „zaskarżone orzeczenie”; stępuje się użytym w odpowiednim przypadku wyrazem „orzeczenie”;
...
§ 4. Powództwo wzajemne jest niedopuszczalne. przyczyn niedopuszczalne, jak również zarzuty, których braków pozwany nie usunął w terminie.
...
§ 3. Strona obecna na posiedzeniu, na którym ogłoszono wyrok, może po jego ogłoszeniu w oświadczeniu złożonym do protonia się prawa do wniesienia apelacji przez wszystkich uprawnionych wyrok staje się prawomocny. Art. 505 9 §1. Apelację można oprzeć wyłącznie na zarzutach:
...
- **62)** art. 518 otrzymuje brzmienie: istoty sprawy przysługuje apelacja. Na inne postanowienia sądu pierwszej instancji, w wypadkach wskazanych w ustawie, przysługuje zażalenie.”;
...
- **66)** w art. 765:
    - **a)** § 2 otrzymuje brzmienie: „§2. Sposób udzielania pomocy komornikowi przy wykonywaniu czynności egzekucyjnych, przypadki, w których należy udzielić komornikowi pomocy, sposób postępowania, tryb występowania o udzielenie pomocy, sposób jej realizacji, a także sposób dokumentowania wykonywadzenia:
...
- **68)** w art. 893 w § 1 zdanie czwarte otrzymuje brzmienie: nistrem właściwym do spraw łączności oraz Ministrem Sprawiedliwości określi, w drodze rozporządzenia, tryb zawiadamiania placówek banków, urzędów pocztowo-telekomunikacyjnych i innych placówek, uwzględniając dane zawarte w zawiadomieniu.”;
...
**Art. 4.** W ustawie z dnia 29 sierpnia 1997 r. o komornikach sądowych i egzekucji (Dz.U. Nr 133, poz. 882 i z 1999 r. Nr 110, poz. 1255) art. 69 otrzymuje brzmienie: „Art. 69. Minister Sprawiedliwości, po zasięgnięciu opinii Krajowej Rady Komorniczej określi, w drodze rozporządzenia, szczegółowe przepisy o biurowości i ewidencji operacji finansowych kancelarii komorniczych. W rozporządzeniu należy uwzględnić potrzeby szczegółowej ewidencji spraw prowadzonych w kancelarii, uwidocznienia przebiegu czynności, zapewnienia przejrzystości wpisów oraz odzwierciedlenia wszystkich operacji finansowych dokontroli poprawności dokonywanych operacji finansowych.”.
