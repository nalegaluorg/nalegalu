...
- **1)** warunki nabywania utraty prawa do nauczycielskich świadczeń kompensacyjnych zwanych dalej „świadczeniami”;
- **2)** zasady:
    - **a)** ustalania wysokości świadczeń,
    - **b)** postępowania sprawach świadczenia,
    - **c)** wypłaty świadczeń,
...
- **1)** nauczyciel nauczycieli, wychowawców innych pracowników pedagogicznych zatrudnionych w: 350, późn. zm. );
    ...
    - **g)** publicznych niepublicznych placówkach artystycznych, których 5 dnia 14 grudnia 2016 Prawo oświatowe,
...
- **1)** poprzedzającym dzień nabycia prawa do emerytury, która jest ustalona decyzją organu rentowego lub innego organu emerytalno-rentowego, określonego odrębnych przepisach;
- **2)** poprzedzającym dzień osiągnięcia przez uprawnionego wieku:
    - **a)** 60 lat przypadku kobiet,
    - **b)** 65 lat przypadku mężczyzn jeżeli uprawniony nie ma prawa do emerytury ustalonego decyzją organu rentowego lub innego organu emerytalno-rentowego, określonego odrębnych przepisach;
...
- **1)** uprawnionego,
- **2)** członka rodziny uprawnionego przysługuje zasiłek pogrzebowy na zasadach określonych 77–81 99 emeryturach rentach FUS.
