...
# RZECZYPOSPOLITEJ POLSKIEJ Poz. 211 ROZPORZĄDZENIE MINISTRA EDUKACJI I NAUKI z dnia 27 stycznia 2021 r.
...
1) w „BRANŻY BUDOWLANEJ (BUD)” po pozycji dotyczącej zawodu „Technik budowy dróg” o symbolu cyfrowym 311216 dodaje się pozycję dotyczącą zawodu „Technik dekarstwa” o symbolu cyfrowym 311221 w brzmieniu: Technik 311221 IV budownictwa, X X BUD.03. 3 X dekarstwa planowania Wykonywanie robót i zagospodarowania dekarsko-blacharskich przestrzennego oraz mieszkalnictwa BUD.27. 4 X Organizacja i kontrola wykonywania pokryć dachowych oraz sporządzanie kosztorysów
2) w „BRANŻY ELEKTRONICZNO-MECHATRONICZNEJ (ELM)” po pozycji dotyczącej zawodu „Technik mechatronik” o symbolu cyfrowym 311410 dodaje się pozycję dotyczącą zawodu „Technik robotyk” o symbolu cyfrowym 311413 w brzmieniu: Technik 311413 V gospodarki X ELM.07. 4 X robotyk Montaż, uruchamianie i obsługa systemów robotyki ELM.08. 5 X Eksploatacja i programowanie systemów robotyki
3) w „BRANŻY FRYZJERSKO-KOSMETYCZNEJ (FRK)” po pozycji dotyczącej zawodu „Fryzjer” o symbolu cyfrowym 514101 dodaje się pozycję dotyczącą zawodu „Podolog” o symbolu cyfrowym 323014 w brzmieniu: Podolog 323014 V gospodarki 2* FRK.05. 5 * Kształcenie Świadczenie usług w szkole w zakresie zabiegów prowadzone podologicznych wyłącznie w formie dziennej lub stacjonarnej
...
5) w „BRANŻY OPIEKI ZDROWOTNEJ (MED)” pozycja dotycząca zawodu „Opiekun medyczny” o symbolu cyfrowym 532102 otrzymuje brzmienie: Opiekun 532102 V zdrowia 1,5* MED.14. 5 * Kształcenie medyczny Świadczenie usług w szkole medyczno- prowadzone -pielęgnacyjnych wyłącznie i opiekuńczych osobie w formie chorej i niesamodzielnej dziennej lub stacjonarnej
6) w „BRANŻY PRZEMYSŁU MODY (MOD)” po pozycji dotyczącej zawodu „Technik przemysłu mody” o symbolu cyfrowym 311941 dodaje się pozycję dotyczącą zawodu „Technik stylista” o symbolu cyfrowym 311946 w brzmieniu: Technik 311946 IV gospodarki X X MOD.03. 3 X stylista Projektowanie i wytwarzanie wyrobów odzieżowych MOD.15. 4 X Stylizacja ubioru i kreacja wizerunku
