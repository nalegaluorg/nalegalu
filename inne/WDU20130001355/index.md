...
- **3)** korpus szeregowych zawodowych. ” , uchyla się ust. 4;
    - **b)**
...
1b. Członek składu orzekającego wojskowej komisji lekarskiej może zgłosić na piśmie sprzeciw wobec projektu orzeczenia wojskowej komisji lekarskiej. ” , po ust. 3 dodaje się ust. 3a w brzmieniu: „
...
1. Osobę, która zgłosiła chęć pełnienia zawodowej służby wojskowej, wojskowy komendant uzupełnień kieruje do wojskowej pracowni psychologicznej w celu przeprowadzenia badań psychologicznych oraz wydania orzeczenia psychologicznego o istnieniu lub braku przeciwwskazań do pełnienia tej służby. ” , ust. 7 otrzymuje brzmienie: „
...
- **1)** w korpusie oficerów zawodowych: oficera służby kontraktowej, który posiada tytuł zawodowy magistra lub równorzędny, stopień wojskowy równy lub bezpośrednio niższy od stopnia etatowego stanowiska służbowego, na jakie ma być wyznaczony, a w przypadku gdy stanowisko etatowe jest określone dwoma stopniami wojskowymi posiada stopień wojskowy równy lub bezpośrednio niższy od stopnia wojskowego, do którego ma być zaszeregowany po powołaniu do służby stałej, oraz posiada co najmniej dobrą ogólną ocenę w ostatniej opinii służbowej, oficera rezerwy, który spełnia łącznie następujące warunki: – posiada tytuł zawodowy magistra lub równorzędny, – posiada stopień wojskowy równy lub bezpośrednio niższy od stopnia etatowego stanowiska służbowego, na jakie ma być wyznaczony, a w przypadku gdy stanowisko etatowe jest określone dwoma stopniami wojskowymi posiada stopień wojskowy równy lub bezpośrednio niższy od stopnia wojskowego, do którego ma być zaszeregowany po powołaniu do zawodowej służby wojskowej, – pełnił przed zwolnieniem ze służby i przeniesieniem do rezerwy stałą lub kontraktową zawodową służbę wojskową;
    - **a)**
    - **b)**

- **2)** w korpusie podoficerów zawodowych: podoficera służby kontraktowej, który posiada stopień wojskowy równy lub bezpośrednio niższy od stopnia wojskowego stanowiska etatowego, do którego ma być zaszeregowany po powołaniu do służby stałej, oraz co najmniej dobrą ogólną ocenę w ostatniej opinii służbowej, podoficera rezerwy, który spełnia łącznie następujące warunki: – posiada wykształcenie średnie, – posiada stopień wojskowy równy lub bezpośrednio niższy od stopnia wojskowego stanowiska etatowego, do którego ma być zaszeregowany po powołaniu do zawodowej służby wojskowej, – pełnił przed zwolnieniem ze służby i przeniesieniem do rezerwy stałą lub kontraktową zawodową służbę wojskową. ” ;
    - **a)**
    - **b)**

- **9)** w art. 12: w ust. 1 pkt 1 i 2 otrzymują brzmienie: „
    - **a)**
...
- **2)** w korpusie podoficerów zawodowych – żołnierza służby kandydackiej, posiadającego wykształcenie średnie, mianowanego na stopień wojskowy kaprala (mata), po ukończeniu przez niego nauki w szkole podoficerskiej; ” , ust. 2 otrzymuje brzmienie: „
    - **b)**
...
1. Żołnierz zawodowy zwolniony z dotychczas zajmowanego stanowiska służbowego może być przeniesiony do rezerwy kadrowej organu określonego w ust. 3, jeżeli przewiduje się wyznaczenie go na inne stanowisko służbowe. ” , ust. 2 otrzymuje brzmienie: „

- **b)**

2. Okres pozostawania żołnierza zawodowego w rezerwie kadrowej nie może być jednorazowo dłuższy niż dwa lata dla żołnierza służby stałej i sześć miesięcy dla żołnierza służby kontraktowej. ” , w ust. 4 pkt 1 otrzymuje brzmienie: „

- **c)**
- **1)** ze skierowaniem żołnierza zawodowego na studia, kursy i szkolenie, czas pozostawania w rezerwie kadrowej obejmuje okres tych studiów oraz kursów i szkoleń; ” , w ust. 5 w pkt 2 kropkę zastępuje się średnikiem i dodaje się pkt 3 w brzmieniu: „
    - **d)**
...
1. Żołnierza zawodowego wyznacza się na stanowisko służbowe, w drodze decyzji, stosownie do potrzeb Sił Zbrojnych, w zależności od wymaganych kwalifikacji zawodowych, posiadanej oceny w opinii służbowej oraz modelu przebiegu służby w poszczególnych korpusach osobowych (grupach osobowych). ” , uchyla się ust. 2;

- **b)**
- **23)** w art. 36: w ust. 1 pkt 2 i 3 otrzymują brzmienie: „
    - **a)**

- **2)** podoficerów zawodowych – posiadanie wykształcenia średniego;
- **3)** oficerów zawodowych – posiadanie tytułu zawodowego magistra lub równorzędnego. ” , ust. 2 i 3 otrzymują brzmienie: „
    - **b)**
...
3. Do celów określonych w ust. 2 na równi ze świadectwem lub dyplomem uczelni wojskowej są traktowane świadectwa lub dyplomy zagranicznych oraz krajowych szkół i uczelni. ” , dodaje się ust. 4 w brzmieniu: „
...
- **24)** w art. 37: ust. 1 i 2 otrzymują brzmienie: „
    - **a)**
...
2. Kadencja na stanowisku służbowym trwa od dwóch do trzech lat. ” , po ust. 2 dodaje się ust. 2a w brzmieniu: „

- **b)**

2a. W przypadku gdy okres pozostający do osiągnięcia przez żołnierza zawodowego wieku, o którym mowa w art. 111 pkt 5 lub art. 111b ust. 2, jest krótszy niż dwa lata, można określić dla takiego żołnierza kadencję, której okres kończy się z dniem osiągnięcia przez niego wieku określonego w ustawie. ” , ust. 5 i 6 otrzymują brzmienie: „
...
6. Oficer zawodowy, o którym mowa w ust. 1, może powtarzać kadencję na tym samym stanowisku służbowym, z zastrzeżeniem art. 43 ust. 2. ” , uchyla się ust. 7, ust. 8 otrzymuje brzmienie: „
...
- **2)** nie zaszeregowuje się go do wyższego stopnia wojskowego na zajmowanym przez niego stanowisku służbowym;
- **3)** może być on zwolniony z zawodowej służby wojskowej. ” ;
- **26)** po art. 42 dodaje się art. 42a-42c w brzmieniu: „ Zmiana zaszeregowania, o której mowa w art. 40 ust. 3, art. 41 ust. 2 i art. 42 ust. 1, może nastąpić w ramach limitu awansowego określanego corocznie przez Ministra Obrony Narodowej.
...
- **28)** w art. 45: w ust. 1 pkt 3 otrzymuje brzmienie: „
    - **a)**

- **3)** gdy upłynął termin kadencji na stanowisku służbowym; ” , w ust. 2 pkt 2 otrzymuje brzmienie: „
    - **b)**

- **2)** wszczęcia kontrolnego postępowania sprawdzającego, o którym mowa w przepisach ustawy z dnia 5 sierpnia 2010 r. o ochronie informacji niejawnych (Dz. U. Nr 182, poz. 1228). ” , ust. 2b otrzymuje brzmienie: „
    - **c)**
...
- **38)** w art. 62: ust. 2 otrzymuje brzmienie: „
    - **a)**
...
- **4)** piętnastu dni roboczych – przy czwartym stopniu szkodliwości. ” , ust. 9 otrzymuje brzmienie: „
    - **b)**

9. Żołnierzowi zawodowemu skierowanemu przez właściwy organ na naukę oraz żołnierzowi, któremu udzielono pomocy w związku z pobieraniem nauki, przysługuje urlop szkoleniowy. ” , po ust. 9 dodaje się ust. 9a w brzmieniu: „

- **c)**

9a. Żołnierzowi zawodowemu pobierającemu naukę, niespełniającemu warunków do uzyskania pomocy, o której mowa w art. 52, można udzielić urlopu szkoleniowego. ” , ust. 11 otrzymuje brzmienie: „
...
- **47)** w art. 80: w ust. 1 w pkt 3 kropkę zastępuje się średnikiem i dodaje się pkt 4 i 5 w brzmieniu: „
    - **a)**
...
- **5)** dodatek funkcyjny – za pełnienie funkcji powierzonych w trybie określonym w art. 25a. ” , uchyla się ust. 1a, uchyla się ust. 5a i 5b, dodaje się ust. 5c-5f w brzmieniu: „
    - **b)**
    - **c)**
    - **d)**
...
- **49)** w art. 84: po ust. 1c dodaje się ust. 1d i 1e w brzmieniu: „
    - **a)**
...
1e. Warunkiem przyznania żołnierzowi zawodowemu zapomogi jest konieczność poniesienia wydatków pieniężnych spowodowanych zdarzeniem określonym w ust. 1 pkt 2. Przy przyznawaniu zapomogi uwzględnia się okoliczności mające wpływ na sytuację materialną żołnierza zawodowego i jego rodziny. ” , ust. 3 otrzymuje brzmienie: „
...
- **54)** w art. 96: po ust. 3 dodaje się ust. 3a w brzmieniu: „
    - **a)**

3a. W razie zbiegu uprawnień przysługujących sędziemu sądu wojskowego przeniesionemu w stan spoczynku do świadczenia pieniężnego, o którym mowa w art. 95 pkt 1, i uposażenia w stanie spoczynku, żołnierzowi przysługuje, według jego wyboru, tylko jedno z tych świadczeń. ” , ust. 7 otrzymuje brzmienie: „

- **b)**

7. Wypłaty świadczenia pieniężnego, o którym mowa w art. 95 pkt 1, zwrotu kosztów jednorazowego przejazdu żołnierza i członków jego rodziny oraz zwrotu kosztów przewozu urządzenia domowego do obranego przez żołnierza miejsca zamieszkania w kraju dokonuje wojskowy organ emerytalny właściwy dla adresu zameldowania żołnierza, a w razie braku adresu zameldowania – organ emerytalny właściwy dla adresu zameldowania żołnierza na pobyt czasowy. ” , ust. 9 otrzymuje brzmienie: „
...
- **1)** na własność: z chwilą wydania albo po upływie okresu używalności;
    - **a)**
    - **b)**
...
- **2)** podoficerskie: podoficerów młodszych: – kapral, – starszy kapral, – plutonowy, podoficerów: – sierżant, – starszy sierżant, – młodszy chorąży, podoficerów starszych: – chorąży, – starszy chorąży, – starszy chorąży sztabowy;
    - **a)**
    - **b)**
    - **c)**

- **3)** oficerskie: oficerów młodszych: – podporucznik, – porucznik, – kapitan, oficerów starszych: – major, – podpułkownik, – pułkownik, generalskie: – generał brygady, – generał dywizji, – generał broni, – generał.
    - **a)**
    - **b)**
    - **c)**
...
- **1)** szeregowych: marynarz, starszy marynarz;
    - **a)**
    - **b)**

- **2)** podoficerskie: podoficerów młodszych: – mat, – starszy mat, – bosmanmat, podoficerów: – bosman, – starszy bosman, – młodszy chorąży marynarki, podoficerów starszych: – chorąży marynarki, – starszy chorąży marynarki, – starszy chorąży sztabowy marynarki;
    - **a)**
    - **b)**
    - **c)**

- **3)** oficerskie: oficerów młodszych: – podporucznik marynarki, – porucznik marynarki, – kapitan marynarki, oficerów starszych: – komandor podporucznik, – komandor porucznik, – komandor, admiralskie: – kontradmirał, – wiceadmirał, – admirał floty, – admirał. ” .
    - **a)**
    - **b)**
    - **c)**
...
1. Podstawę wymiaru emerytury lub renty inwalidzkiej stanowi uposażenie należne żołnierzowi zawodowemu w ostatnim miesiącu pełnienia zawodowej służby wojskowej, z zastrzeżeniem ust. 1a-4 oraz art. 32b. ” , po ust. 1 dodaje się ust. 1a w brzmieniu: „
...
2. W przypadku, o którym mowa w ust. 1 pkt 3, zgoda żołnierza nie jest wymagana. Podoficera zawodowego i szeregowego zawodowego, którzy w dniu wejścia w życie niniejszej ustawy posiadali ogólną ocenę bardzo dobrą w ostatniej opinii służbowej i nie byli opiniowani na zasadach określonych w ustawie zmienianej w art. 1, uważa się za spełniających wymagania określone w art. 29 ustawy zmienianej w art. 1, w brzmieniu nadanym niniejszą ustawą.
