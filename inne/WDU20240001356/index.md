...
2. Wynagrodzenia osób nieobjętych mnożnikowymi systemami waloryzowane są średniorocznym wskaźnikiem wzrostu wynagrodzeń.

3. Średnioroczny wskaźnik wzrostu może być różny dla poszczególnych grup pracowników.
...
1. Średnioroczne wskaźniki wzrostu dla osób, których mowa art. 5 pkt 2, są corocznie przedmiotem negocjacji ramach Rady Dialogu Społecznego.

2. Rada Ministrów, terminie do dnia 15 czerwca każdego roku, przedkłada Radzie Dialogu Społecznego, a także ogólnokrajowym organizacjom związków zawodowych zrzeszających pracowników państwowej sfery budżetowej celu wyrażenia opinii, propozycję średniorocznych wskaźników wzrostu państwowej sferze budżetowej na rok następny. Wraz tą propozycją Rada Ministrów przedkłada informację o:

- **1)** prognozowanej dynamice produktu krajowego brutto;
- **2)** prognozowanych zmianach cen towarów usług konsumpcyjnych; prognozowanym wzroście gospodarce narodowej, tym sektorze przedsiębiorstw;
...
4. Jeżeli Rada Dialogu Społecznego uzgodni, drodze uchwały, wysokość średniorocznych wskaźników wzrostu państwowej sferze budżetowej, Rada Ministrów jest zobowiązana do uwzględnienia projekcie budżetowej zapewniających osiągnięcie uzgodnionej wysokości wskaźników.

5. Jeżeli terminie 30 dni od dnia otrzymania propozycji nie nastąpi uzgodnienie stanowiska Rady Dialogu Społecznego, Rada Ministrów przyjmie do projektu budżetowej średnioroczne wskaźniki wzrostu państwowej sferze budżetowej na rok następny, tym że nie mogą być one niższe od wskaźników zawartych propozycji, której mowa ust. 2.

6. Terminy, których mowa ust. 2, 3 5, Rada Dialogu Społecznego zmienia na wniosek przedstawiciela Rady Ministrów jej składzie, odpowiednio do zmiany terminu dokonanej na podstawie art. 19 ust. 2 dnia 24 lipca 2015 Radzie Dialogu Społecznego innych instytucjach dialogu społecznego (Dz. 2018 2232, późn. zm. ).

**Art. 8.**

1. Podwyższenie dla pracowników państwowej sfery budżetowej następuje ciągu 3 miesięcy po ogłoszeniu budżetowej, wyrównaniem od dnia 1 stycznia danego roku, zastrzeżeniem ust. 2.

2. Podwyższenie dla nauczycieli zatrudnionych szkołach placówkach prowadzonych przez organy administracji rządowej następuje terminie określonym zgodnie przepisami dnia 26 stycznia 1982 Karta Nauczyciela.
...
- **1)** (uchylony)
- **2)** kwoty bazowe; średnioroczne wskaźniki wzrostu państwowej sferze budżetowej;
- **4)** kwoty dla państwowych jednostek budżetowych, dla poszczególnych grup pracowników, których mowa art. 5, podziale na części działy klasyfikacji dochodów wydatków.
...
**Art. 31.** Traci moc ustawa dnia 23 grudnia 1994 kształtowaniu środków na wynagrodzenia państwowej sferze budżetowej (Dz. 1995 163, późn. zm. ).
