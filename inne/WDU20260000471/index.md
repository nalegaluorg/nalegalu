...
1. Organ kontroli obrotu prowadzi systemie teleinformatycznym, o którym mowa art. 3 pkt 3 ustawy z dnia 17 lutego 2005 r. o informatyzacji działalności podmiotów realizujących zadania publiczne (Dz. U. z 2025 r. poz. 1703 oraz z 2026 r. poz. 160), zwanym dalej „systemem”, rejestr:
...
- **2)** podmiotów korzystających z zezwoleń generalnych:
    - **a)** dane podmiotu zawarte oświadczeniu, o którym mowa art. 8 ust. 3,
    - **b)** numer krajowego zezwolenia generalnego lub numer generalnego unijnego zezwolenia na wywóz,
    - **c)** datę złożenia oświadczenia, o którym mowa art. 8 ust. 3,
    - **d)** planowany termin rozpoczęcia obrotu na podstawie krajowego zezwolenia generalnego przez dany podmiot.

3. Minister właściwy do spraw gospodarki jest administratorem danych oraz informacji gromadzonych i przetwarzanych rejestrze celu realizacji zadań wynikających z ustawy, tym danych osobowych rozumieniu art. 4 pkt 1 rozporządzenia Parlamentu Europejskiego i Rady (UE) 2016/679 z dnia 27 kwietnia 2016 r. sprawie ochrony osób fizycznych związku z przetwarzaniem danych osobowych i sprawie swobodnego przepływu takich danych oraz uchylenia dyrektywy 95/46/WE (ogólne rozporządzenie o ochronie danych) (Dz. Urz. UE L 119 z 04.05.2016, str. 1, z późn. zm. ).

4. Danych, o których mowa ust. 2, zgromadzonych rejestrze nie usuwa się, z wyłączeniem danych osobowych, które są przetwarzane przez okres 10 lat, z uwzględnieniem wymogów wynikających z przepisów prawa.

5. Minister właściwy do spraw gospodarki celu realizacji zadań określonych ustawie zapewnia utrzymanie i rozwój rejestru, tym:
...
**Art. 24b.** Organ kontroli obrotu dokonuje wpisu do rejestru niezwłocznie po wydaniu dokumentów, o których mowa art. 24a ust. 1 pkt 1 i 2, oraz złożeniu oświadczenia, o którym mowa art. 8 ust. 3, przez podmiot, który będzie korzystał z krajowego zezwolenia generalnego. W przypadku generalnego unijnego zezwolenia na wywóz wpisu do rejestru dokonuje się niezwłocznie po przekazaniu organowi kontroli obrotu przez podmiot powiadomienia o korzystaniu z takiego zezwolenia, terminie określonym rozporządzeniu 2021/821 odpowiednio dla każdego generalnego unijnego zezwolenia na wywóz.

**Art. 24c.**

1. Organ kontroli obrotu udostępnia podmiotowi, któremu udzielono zezwolenia indywidualnego lub zezwolenia globalnego, a także podmiotowi, który korzysta z krajowego zezwolenia generalnego lub generalnego unijnego zezwolenia na wywóz, dane z rejestru, o których mowa art. 24a ust. 2, za pośrednictwem systemu PIP, części dotyczącej tych podmiotów.

2. Podmioty, o których mowa ust. 1, składają wniosek o uzyskanie dostępu do danych z rejestru postaci elektronicznej za pośrednictwem systemu PIP.
...
- **3)** wskazanie, że dotyczy danych, o których mowa art. 24a ust. 2;
- **4)** kategorie podmiotów, o których mowa art. 24a ust. 2 pkt 2;
- **5)** prawa i obowiązki administratora danych;
- **6)** obowiązki podmiotu, z którym zawarto porozumienie, o których mowa ust. 4;
...
- **1)** przetwarzać dane wyłącznie celu niezbędnym dla utrzymania i rozwoju systemu;
...
- **4)** udzielać administratorowi danych pomocy realizacji praw osób, których dane dotyczą, zgodnie z prawami określonymi rozdziale III rozporządzenia Parlamentu Europejskiego i Rady (UE) 2016/679 z dnia 27 kwietnia 2016 r. sprawie ochrony osób fizycznych związku z przetwarzaniem danych osobowych i sprawie swobodnego przepływu takich danych oraz uchylenia dyrektywy 95/46/WE (ogólne rozporządzenie o ochronie danych);
...
- **6)** udostępniać administratorowi danych wszelkie informacje związane z weryfikacją prawidłowości realizacji porozumienia, o którym mowa ust. 1;
...
5. Podmiot, z którym zawarto porozumienie, może powierzyć przetwarzanie danych innemu podmiotowi przetwarzającemu każdorazowo wyłącznie na podstawie pisemnej umowy, przypadku gdy porozumienie, o którym mowa ust. 1, przewiduje takie prawo, na warunkach i zakresie przez nie określonych.

6. Powierzenie przetwarzania danych, o którym mowa ust. 5, następuje za zgodą administratora danych. Przepisy ust. 1, 3 i 4 stosuje się odpowiednio.”;
...
- **20)** art. 27c otrzymuje brzmienie: „Art. 27c. 1. Minister właściwy do spraw zagranicznych przekazuje roczną informację dotyczącą wywozu oraz transferu wewnątrzunijnego uzbrojenia z terytorium Rzeczypospolitej Polskiej właściwym organom Unii Europejskiej terminie do końca II kwartału następnego roku.

2. Minister właściwy do spraw zagranicznych publikuje informację, o której mowa ust. 1, terminie do końca III kwartału następnego roku.”;

- **21)** art. 33 ust. 2a otrzymuje brzmienie: „2a. Kto zamieszcza nieprawdziwe lub niepełne dane lub informacje we wniosku o wydanie zezwolenia indywidualnego albo zezwolenia globalnego, wniosku o wydanie certyfikatu importowego albo wniosku o wydanie poświadczenia oświadczenia końcowego użytkownika, podlega grzywnie, karze ograniczenia wolności albo karze pozbawienia wolności do lat 2.”.
...
**Art. 7.** Zezwolenia indywidualne, zezwolenia globalne, certyfikaty importowe oraz poświadczenia oświadczenia końcowego użytkownika wydane przed dniem wejścia życie niniejszej ustawy zachowują ważność przez okres, na jaki zostały wydane.

**Art. 8.** Dostęp, o którym mowa art. 24c ust. 1 ustawy zmienianej art. 1, do danych z rejestru, o którym mowa art. 24a ust. 1 ustawy zmienianej art. 1, obejmuje dane wpisane do tego rejestru od dnia wejścia życie niniejszej ustawy.

**Art. 9.**

1. Roczną informację, o której mowa art. 26 ust. 1 ustawy zmienianej art. 1 brzmieniu nadanym niniejszą ustawą, przekazuje się po raz pierwszy za 2026 r.

2. Roczny raport, o którym mowa art. 27a ust. 1 ustawy zmienianej art. 1 brzmieniu nadanym niniejszą ustawą, przekazuje się po raz pierwszy za 2026 r.

3. Roczną informację, o której mowa art. 27c ust. 1 ustawy zmienianej art. 1 brzmieniu nadanym niniejszą ustawą, przekazuje się po raz pierwszy za 2026 r.

**Art. 10.** Minimalna głębokość oznakowania, o której mowa art. 44 ust. 2aa ustawy zmienianej art. 2, nie dotyczy broni palnej, tym strzeleckiej broni palnej, i każdej istotnej części podlegającej oznakowaniu po raz pierwszy wprowadzonej do obrotu przed dniem wejścia życie niniejszego przepisu.

**Art. 11.**

1. Dotychczasowe przepisy wykonawcze wydane na podstawie art. 9 ust. 8 ustawy zmienianej art. 1 zachowują moc do dnia wejścia życie przepisów wykonawczych wydanych na podstawie art. 9 ust. 8 ustawy zmienianej art. 1 brzmieniu nadanym niniejszą ustawą, jednak niedłużej niż przez 6 miesięcy od dnia wejścia życie niniejszej ustawy.
