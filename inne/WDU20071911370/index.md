...
- **1)** w art. 2: uchyla się pkt 12, w pkt 13 kropkę zastępuje się średnikiem i dodaje się pkt 14 w brzmieniu: „
    - **a)**
    - **b)**
...
- **1)** wskaźnik G jest równy lub niższy od 40% wskaźnika Gg – mnożąc liczbę mieszkańców gminy przez liczbę stanowiącą sumę: liczby stanowiącej 99% różnicy między 40% wskaźnika Gg i wskaźnikiem G, liczby stanowiącej 41,97% wskaźnika Gg;
    - **a)**
    - **b)**

- **2)** wskaźnik G jest wyższy od 40% i nie wyższy od 75% wskaźnika Gg – mnożąc liczbę mieszkańców gminy przez liczbę stanowiącą sumę: liczby stanowiącej 83% różnicy między 75% wskaźnika Gg i wskaźnikiem G, liczby stanowiącej 12,92% wskaźnika Gg;
    - **a)**
    - **b)**
...
- **2)** 1% – rozdzielanej, w sposób określony w ust. 3, między powiaty wskazane przez ministra właściwego do spraw pracy, w których w roku budżetowym nie działa powiatowy urząd pracy, a zadania tej jednostki są realizowane przez inny powiat;
...
- **3)** dla powiatu spełniającego warunki, o których mowa w ust. 1 pkt 5, oblicza się różnicę między pianowanymi dochodami, obliczonymi w sposób określony w pkt 1, a planowanymi dochodami, obliczonymi w sposób określony w pkt 2;
...
2. Od kwoty, o której mowa w ust. 1, odlicza się 0,25% na rezerwę części oświatowej subwencji ogólnej. ” , ust. 5 otrzymuje brzmienie: „
...
- **2)** za lata poprzedzające rok budżetowy – podlegają zwrotowi do budżetu państwa i stanowią wydatek budżetów jednostek samorządu terytorialnego. ” , po ust. 7 dodaje się ust. 7a w brzmieniu: „
    - **d)**
...
- **2)** zobowiązuje do zwrotu nienależnej kwoty tej części subwencji, chyba że jednostka ta dokonała wcześniej zwrotu nienależnie otrzymanych kwot – w zakresie subwencji za lata poprzedzające rok budżetowy. ” , po ust. 1 dodaje się ust. 1a i 1b w brzmieniu: „
    - **b)**
...
- **24)** w art. 42: ust. 1 otrzymuje brzmienie: „
    - **a)**

1. Jednostki samorządu terytorialnego mogą otrzymywać dotacje z budżetu państwa na dofinansowanie zadań własnych objętych kontraktem wojewódzkim, o którym mowa w przepisach o rozwoju regionalnym. ” , w ust. 2 uchyla się pkt 1, ust. 3–6 otrzymują brzmienie: „
...
5. Rozliczenie i zwrot dotacji z budżetu państwa, o której mowa w ust. 2 pkt 2, następuje na zasadach określonych w ustawie z dnia 30 czerwca 2005 r. o finansach publicznych (Dz. U. Nr 249, poz. 2104, z późn. zm.).
