...
- **1)** w przypadku Centrum tworzonego przez jednostkę samorządu terytorialnego – na zasadach określonych w przepisach o finansach publicznych; ” , w pkt 2 lit. d otrzymuje brzmienie: „ innych dochodów własnych jednostki samorządu terytorialnego niż określone w lit. a ” ;
    - **b)**
    - **d)**
...
- **1)** dotacji pochodzącej z dochodów własnych jednostek samorządu terytorialnego, w tym przeznaczonych na realizację programu profilaktyki i rozwiązywania problemów alkoholowych, z zastrzeżeniem ust. 1a; ” , po ust. 1 dodaje się ust. 1a w brzmieniu: „
    - **b)**

1a. Przepis ust. 1 pkt 1 nie dotyczy Centrum działającego w formie jednostki budżetowej. ” , ust. 5 otrzymuje brzmienie: „
