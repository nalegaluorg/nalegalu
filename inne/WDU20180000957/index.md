...
- **1)** w art. 38: uchyla się pkt 2 i 3, dotychczasową treść oznacza się jako ust. 1 i dodaje się ust. 2 w brzmieniu: „
    - **a)**
    - **b)**
...
- **4)** w art. 80ba: w ust. 1 pkt 1 otrzymuje brzmienie: „
    - **a)**

- **1)** przez organ właściwy w sprawach rejestracji pojazdów – w zakresie danych, o których mowa w art. 80b ust. 1 pkt 1, pkt 2–5 z wyłączeniem daty zgonu, pkt 8 i 9, pkt 10 w zakresie terminu okresowego badania technicznego pojazdu w przypadku rejestracji pojazdu wcześniej niezarejestrowanego na terytorium Rzeczypospolitej Polskiej, pkt 12, 13, 17, 18 i 20; ” , ust. 3 otrzymuje brzmienie: „
    - **b)**
...
- **7)** w art. 129 w ust. 2: pkt 2 otrzymuje brzmienie: „
    - **a)**

- **2)** sprawdzania wymaganych dokumentów, o których mowa w art. 38, oraz zezwolenia, o którym mowa w art. 106 ust. 1 pkt 5 ustawy z dnia 5 stycznia 2011 r. o kierujących pojazdami; ” , po pkt 2 dodaje się pkt 21 w brzmieniu: „
    - **b)**
...
- **9)** w art. 132: ust. 1 otrzymuje brzmienie: „
    - **a)**

1. Policjant albo funkcjonariusz Straży Granicznej zatrzyma dowód rejestracyjny (pozwolenie czasowe) w razie:

- **1)** stwierdzenia lub uzasadnionego przypuszczenia, że pojazd: zagraża bezpieczeństwu w szczególności po wypadku drogowym, w którym zostały uszkodzone zasadnicze elementy nośne konstrukcji nadwozia, podwozia lub ramy, zagraża porządkowi ruchu, narusza wymagania ochrony środowiska;
    - **a)**
    - **b)**
    - **c)**
...
- **4)** uzasadnionego przypuszczenia, że dane dotyczące dowodu rejestracyjnego (pozwolenia czasowego) zawarte w centralnej ewidencji pojazdów nie odpowiadają stanowi faktycznemu. ” , po ust. 1 dodaje się ust. 1a-1c w brzmieniu: „
    - **b)**
...
1c. Zatrzymanie, o którym mowa w ust. 1a, następuje przez zatrzymanie okazanego dokumentu. ” , w ust. 2 zdanie trzecie otrzymuje brzmienie: „ Zezwolenie nie może być wydane w przypadkach, o których mowa w ust. 1 pkt 1 lit. a i c, a także w ust. 1a pkt 1 lit. a i c oraz pkt 6. ” , uchyla się ust. 3, w ust. 3a wyrazy „w ust. 1 pkt 7” zastępuje się wyrazami „w ust. 1 pkt 4”, ust. 4 otrzymuje brzmienie: „
...
- **12)** w art. 124: ust. 10 otrzymuje brzmienie: „
    - **a)**
...
- **2)** sposób postępowania w przypadku stwierdzenia rozbieżności między danymi zawartymi w dokumencie prawa jazdy a danymi znajdującymi się w centralnej ewidencji kierowców. ” , uchyla się ust. 12;
    - **b)**
...
- **4)** w art. 11: ust. 4 otrzymuje brzmienie: „
    - **a)**

4. W celu utworzenia centralnej ewidencji posiadaczy kart parkingowych do dnia określonego zgodnie z art. 10b ust. 2 powiatowe zespoły do spraw orzekania o niepełnosprawności przekazują dane i informacje zgromadzone w okresie od dnia 1 lipca 2014 r. do dnia określonego zgodnie z art. 10b ust. 2 w zakresie, o którym mowa w art. 100g ust. 1 ustawy zmienianej w art. 1 w brzmieniu nadanym niniejszą ustawą. ” , dodaje się ust. 5–7 w brzmieniu: „
...
- **5)** w art. 13: ust. 1 i 2 otrzymują brzmienie: „
    - **a)**
...
- **1)** wyjaśnieniu tej niezgodności w przypadku: wprowadzenia poprawnych danych do centralnej ewidencji kierowców, za pomocą systemu teleinformatycznego obsługującego ewidencję lub za pomocą systemu teleinformatycznego obsługującego zadania realizowane przez podmiot wprowadzający dane, stwierdzenia, że wprowadzone do centralnej ewidencji kierowców dane są poprawne;
    - **a)**
    - **b)**
...
- **3)** w pkt 18 w art. 132a: ust. 1 otrzymuje brzmienie: „
    - **a)**

1. Przepisy art. 132 ust. 1a pkt 1, 3, 4 i 7 oraz ust. 8 stosuje się odpowiednio do profesjonalnego dowodu rejestracyjnego, o którym mowa w art. 80s ust. 1. ” , w ust. 3 skreśla się wyrazy „oraz pkt 6”;
