...
# RZECZYPOSPOLITEJ POLSKIEJ Poz. 454 OBWIESZCZENIE MINISTRA EDUKACJI NARODOWEJ z dnia 31 października 2013 r.
...
1) § 2 rozporządzenia Ministra Edukacji Narodowej z dnia 29 grudnia 2010 r. zmieniającego rozporządzenie w sprawie organizacji kształcenia dzieci obywateli polskich czasowo przebywających za granicą (Dz. U. z 2011 r. Nr 1, poz. 1), który stanowi: „ § 2. Rozporządzenie wchodzi w życie z dniem ogłoszenia.”;
2) § 2−4 rozporządzenia Ministra Edukacji Narodowej z dnia 24 sierpnia 2011 r. zmieniającego rozporządzenie w sprawie organizacji kształcenia dzieci obywateli polskich czasowo przebywających za granicą (Dz. U. Nr 176, poz. 1050), które stanowią: „ § 2. Do spraw wszczętych i niezakończonych przed dniem wejścia w życie rozporządzenia stosuje się przepisy rozporządzenia, o którym mowa w § 1, w brzmieniu nadanym niniejszym rozporządzeniem. § 3. Kierownicy szkolnych punktów konsultacyjnych, którym powierzono stanowiska na podstawie dotychczasowych przepisów, zachowują je do końca okresu, na jaki je powierzono. § 4. Rozporządzenie wchodzi w życie z dniem 29 sierpnia 2011 r.”;
3) § 2 rozporządzenia Ministra Edukacji Narodowej z dnia 23 sierpnia 2012 r. zmieniającego rozporządzenie w sprawie organizacji kształcenia dzieci obywateli polskich czasowo przebywających za granicą (Dz. U. poz. 967), który stanowi: „ § 2. Rozporządzenie wchodzi w życie z dniem 30 sierpnia 2012 r.”. Minister Edukacji Narodowej: K. Szumilas
ROZPORZĄDZENIE MINISTRA EDUKACJI NARODOWEJ z dnia 31 sierpnia 2010 r.
w sprawie organizacji kształcenia dzieci obywateli polskich czasowo przebywających za granicą Na podstawie art. 22 ust. 1 pkt 3 ustawy z dnia 7 września 1991 r. o systemie oświaty (Dz. U. z 2004 r. Nr 256, poz. 2572, z późn. zm. ) zarządza się, co następuje:
...
1a. W przypadkach uzasadnionych warunkami kadrowymi lub lokalowymi w szkołach, o których mowa w ust. 1, za zgodą dyrektora Ośrodka, mogą nie być realizowane następujące przedmioty:
...
**§ 29.** Rozporządzenie wchodzi w życie po upływie 14 dni od dnia ogłoszenia , z wyjątkiem § 3 ust. 1, który wchodzi w życie z dniem 1 stycznia 2011 r. RAMY PROGRAMOWE KSZTAŁCENIA UZUPEŁNIAJĄCEGO DLA SZKOLNYCH PUNKTÓW KONSULTACYJNYCH I i II etap edukacyjny (szkoła podstawowa) Celem kształcenia ogólnego w szkole podstawowej jest:
...
- **3)** kształtowanie u uczniów postaw warunkujących sprawne i odpowiedzialne funkcjonowanie we współczesnym świecie. Do najważniejszych umiejętności zdobywanych przez ucznia w trakcie kształcenia ogólnego w szkole podstawowej należą:
...
- **11)** korzysta ze słowników i encyklopedii. II. Tworzenie wypowiedzi.
...
- **11)** zna i na ogół stosuje zasady ortografii i interpunkcji. III. Wiedza o Polsce. Uczeń:
...
4. Analiza i interpretacja tekstów kultury (uczeń zna teksty literackie i inne teksty kultury wskazane przez nauczyciela). Zgodnie z opisem umiejętności oraz kręgami tematycznymi (wartości). II. Tworzenie wypowiedzi.
...
- **9)** język nauki: III etap edukacyjny (gimnazjum) Cele kształcenia − wymagania ogólne I. Odbiór wypowiedzi i wykorzystanie zawartych w nich informacji. Uczeń samodzielnie dociera do informacji; rozumie komunikaty o coraz bardziej skomplikowanej organizacji − werbalne i niewerbalne; podejmuje refleksję nad znaczeniami słów i dąży do ich dokładnego rozumienia; krytycznie ocenia zawartość komunikatów. II. Analiza i interpretacja tekstów kultury. Uczeń doskonali sprawność analizy i interpretacji tekstów kultury; zyskuje nowe narzędzia, dzięki którym jego lektura jest coraz dojrzalsza, bardziej świadoma i samodzielna; poznaje nowe gatunki i konwencje literackie; wykorzystuje poznane pojęcia w refleksji o literaturze i wartościach; czyta teksty kultury odpowiadające charakterystycznej dla tego wieku wrażliwości − z zakresu literatury młodzieżowej i popularnej; stopniowo zaczyna poznawać dzieła klasyczne ważne dla kultury polskiej. III. Tworzenie wypowiedzi. Uczeń zyskuje coraz wyraźniejszą świadomość funkcji środków językowych, które służą formułowaniu wypowiedzi; zdobywa wiedzę o różnych odmianach polszczyzny i kształci umiejętność poprawnego wykorzystywania ich w różnych sytuacjach, pogłębia znajomość etyki mowy i etykiety języka; poznaje i tworzy nowe, coraz trudniejsze formy wypowiedzi. Treści nauczania − wymagania szczegółowe Kursywą zaznaczono treści nauczania dla uczniów na poziomie C biegłości językowej (poziom zaawansowany). I. Odbiór wypowiedzi i wykorzystanie zawartych w nich informacji.
    - **a)** podstawowe terminy z zakresu wiedzy o języku,
    - **b)** podstawowe terminy z zakresu wiedzy o literaturze,
    - **c)** podstawowe terminy historyczne i geograficzne.
...
- **9)** język nauki: Tabela diagnostyczna poziomu znajomości języka Kompetencje językowe (5–9 lat) Kompetencje A − poziom podstawowy B − poziom średni C − poziom (średnio zaawansowany) zaawansowany 1 2 3 4 Słuchanie Uczeń: Uczeń: Uczeń: − rozróżnia większość − rozróżnia głoski − rozróżnia wszystkie głosek istotnych dla współczesnej głoski współczesnej języka polskiego, polszczyzny z wyjątkiem polszczyzny, − rozumie proste polecenia, najtrudniejszych, − rozumie rozbudowane − rozumie proste − rozumie złożone polecenia, wypowiedzi monologowe polecenia, − rozumie złożone i dialogowe, o ile − rozumie proste wypowiedzi otrzymuje dodatkowe wypowiedzi monologowe wyjaśnienia, monologowe i dialogowe i dialogowe, − rozumie proste teksty bez dodatkowych − rozumie teksty literackie literackie wspierane wyjaśnień, (zwłaszcza pisane obrazkami, gestami, − rozumie proste teksty współczesną rekwizytami i inne teksty literackie (zwłaszcza polszczyzną) i inne kultury, o ile otrzymuje pisane współczesną teksty kultury dodatkowe wyjaśnienia polszczyzną), wspierane obrazkami, gestami, rekwizytami i inne teksty kultury Mówienie − wymawia poznane słowa − wymawia poznane słowa − poprawnie wymawia w sposób na ogół w sposób zrozumiały, słowa i zwroty, zrozumiały, − skutecznie porozumiewa − wypowiada się płynnie, − tworzy, z pomocą się w codziennych − opisuje, opowiada, nauczyciela, krótką sytuacjach, stosując charakteryzuje postać wypowiedź składającą właściwe formy literacką, się z prostych zdań, komunikowania się, − uczestniczy w rozmowie − porozumiewa się − uczestniczy w rozmowie, i w prostej dyskusji, w prostych sytuacjach wyraża w prosty sposób − stosuje formuły komunikacyjnych, własne zdanie, grzecznościowe, − stosuje podstawowe − formułuje kilkuzdaniową − recytuje wiersze, formuły grzecznościowe, wypowiedź, opowiada stosując pauzę − odtwarza z pamięci o własnych i intonację rymowanki i inne doświadczeniach, opisuje krótkie, proste teksty ludzi, przedmioty, miejsca i sytuacje, − formułuje życzenia i zaproszenie, − opowiada w prosty sposób akcję utworu oraz opisuje bohaterów i relacje między nimi, a także świat przedstawiony tekstów kultury, − stosuje formuły grzecznościowe, − recytuje wiersze 1 2 3 4 Czytanie − zna wszystkie litery − czyta na głos, − czyta na głos, poprawnie i odpowiadające im prawidłowo akcentując i wyraziście krótki głoski, wyrazy, i prosty tekst (także − dzieli wyraz na sylaby, − rozumie krótkie teksty nieznany), − czyta na głos i cicho użytkowe, − rozumie utwory proste, krótkie teksty, − rozpoznaje formy literackie i inne teksty − rozumie proste i krótkie użytkowe, np. życzenia, kultury, teksty użytkowe, zaproszenie, ogłoszenie, − określa podstawowe − rozumie proste i krótkie list, prostą instrukcję, elementy świata utwory literackie, − rozumie krótkie utwory przedstawionego wspierane materiałem literackie i inne teksty w utworze literackim lub ilustracyjnym, i inne kultury, innym tekście kultury, teksty kultury, − w tekście literackim − rozumie podstawowe − korzysta z obrazkowych zaznacza wybrane oraz przenośne słowników i encyklopedii fragmenty, określa czas znaczenie wyrazów i miejsce akcji, wskazuje w tekście, głównych bohaterów, − korzysta ze słowników − wyszukuje w tekście i encyklopedii potrzebne informacje, − korzysta z obrazkowych słowników i encyklopedii Pisanie − pisze wszystkie małe − przepisuje krótkie teksty, − pisze z pamięci i wielkie litery, dostrzega − pisze z pamięci (kilka (pojedyncze zdania) i ze różnicę między literą wyrazów) i ze słuchu słuchu (krótkie teksty), i głoską, (proste, krótkie teksty), − tworzy krótką − przepisuje wyrazy − z pomocą nauczyciela wypowiedź (dialog, i proste zdania, tworzy krótką opowiadanie, przepis), − pisze z pamięci wypowiedź (opis, list − tworzy wypowiedź na (pojedyncze wyrazy) i ze prywatny, życzenia, znane mu tematy (np. słuchu (proste zdania), po zaproszenie), związane z jego omówieniu pisowni − pisze według wzoru zainteresowaniami), z nauczycielem, proste teksty na znane − tworzy wypowiedź − tworzy, z pomocą mu tematy (np. związane związaną z poznanymi nauczyciela, krótką z jego utworami literackimi wypowiedź składającą zainteresowaniami), i innymi tekstami się z prostych zdań (opis, − pisze proste teksty kultury, pozdrowienia, życzenia), związane z poznanymi − stosuje podstawowe − pisze według wzoru utworami literackimi formuły krótki tekst o sobie, i innymi tekstami grzecznościowe, − stosuje podstawowe kultury, − zna i na ogół stosuje formuły grzecznościowe, − stosuje podstawowe zasady ortografii − dba o poprawność formuły grzecznościowe, i interpunkcji graficzną polskich liter − na ogół pisze poprawnie ortograficznie i stosuje podstawową interpunkcję Kompetencje językowe (10−13 lat) Kompetencje A − poziom podstawowy B − poziom średni (średnio C − poziom zaawansowany) zaawansowany 1 2 3 4 Słuchanie Uczeń: Uczeń: Uczeń: − rozróżnia większość − rozróżnia większość − rozróżnia wszystkie głosek języka polskiego głosek języka polskiego, głoski języka polskiego, (z wyjątkiem − rozumie złożone − rozumie złożone najtrudniejszych), polecenia, proste polecenia, proste − rozumie polecenia oraz instrukcje oraz instrukcje oraz proste wypowiedzi wypowiedzi wypowiedzi monologowe monologowe monologowe i dialogowe, i dialogowe, w tym i dialogowe, włącznie − rozumie proste, nadawane za pomocą z wypowiedziami współczesne utwory środków w dyskusjach, literackie wspierane audiowizualnych, − rozumie utwory ilustracjami, gestami, − rozumie utwory literackie literackie (z różnych rekwizytami i inne teksty (zwłaszcza pisane epok) i inne teksty kultury, współczesną kultury, − rozumie proste polszczyzną) i inne − rozumie rozbudowane wypowiedzi teksty kultury, wypowiedzi o charakterze − rozumie wypowiedzi o charakterze informacyjnym o charakterze informacyjnym i użytkowym informacyjnym i użytkowym i użytkowym Mówienie − wymawia poznane słowa − mówi w sposób na ogół − poprawnie wymawia w sposób na ogół zrozumiały, stosując słowa i zdania, zrozumiały, akcent zdaniowy, − wypowiada się płynnie − tworzy samodzielnie na − spontanicznie i w miarę i logicznie, ogół poprawną płynnie porozumiewa się − opisuje, opowiada, kilkuzdaniową w codziennych charakteryzuje postać wypowiedź, sytuacjach, stosując literacką, streszcza − porozumiewa się właściwe formy i relacjonuje zdarzenia, w typowych sytuacjach komunikowania się, − rozpoczyna dyskusję komunikacyjnych, − opowiada o własnych i uczestniczy w dyskusji − stosuje podstawowe doświadczeniach, opisuje nad poznanymi tekstami formuły grzecznościowe, ludzi, przedmioty, kultury, − odtwarza z pamięci miejsca i sytuacje, − stosuje zróżnicowane proste teksty − formułuje życzenia, formuły gratulacje, zaproszenie, grzecznościowe, − formułuje w miarę spójną − recytuje utwory wypowiedź na znane mu literackie, stosując tematy (np. związane właściwą modulację z jego zainteresowaniami) głosową oraz poznanymi utworami literackimi i innymi tekstami kultury, 1 2 3 4 − opowiada akcję utworu, opisuje bohaterów i relacje między nimi, a także świat przedstawiony tekstów kultury, w tym nazywa swoje reakcje czytelnicze i wyraża swój stosunek do postaci, − uczestniczy w rozmowie, wyraża własne zdanie i uzasadnia je, − stosuje zróżnicowane formuły grzecznościowe, − recytuje utwory literackie, dbając o prawidłowe akcentowanie i intonację Czytanie − zna wszystkie litery − czyta na głos, − czyta na głos, i odpowiadające im prawidłowo akcentując prawidłowo akcentując głoski języka polskiego, wyrazy, i stosuje akcent wyrazy, i zachowuje − czyta na głos i cicho zdaniowy, intonację zdania, proste teksty literackie − rozumie dłuższe teksty − czyta z pomocą i nieliterackie, informacyjne oraz nauczyciela wybrane − rozumie proste teksty użytkowe, utwory literackie informacyjne i użytkowe, − rozróżnia teksty (z różnych epok), − rozumie proste utwory informacyjne − rozumie utwory literackie oraz inne teksty i argumentacyjne, literackie, informacyjne, kultury, − odróżnia zdania użytkowe oraz inne − wskazuje w tekście informujące o faktach od teksty kultury, najważniejsze zdań wyrażających − odróżnia język literacki informacje, opinię, od nieliterackiego, − korzysta ze słowników − rozumie dłuższe utwory − wyodrębnia wszystkie dwujęzycznych literackie oraz inne teksty elementy świata i encyklopedii kultury, przedstawionego − rozpoznaje wpisanego w tekście literackim, w tekst literacki nadawcę − korzysta z informacji i odbiorcę, zawartych − rozpoznaje wybrane w encyklopediach oraz elementy świata słownikach przedstawionego jednojęzycznych w tekście literackim, i dwujęzycznych − korzysta ze szkolnych słowników oraz innych źródeł informacji, − rozróżnia oficjalną i nieoficjalną odmianę języka 1 2 3 4 Pisanie − poprawnie zapisuje − zapisuje dyktowane − sporządza notatkę wszystkie litery teksty, z tekstu czytanego, polskiego alfabetu, − opisuje wydarzenia, − swobodnie tworzy − przepisuje wyrazy swoje przeżycia wypowiedzi pisemne i proste zdania, i doświadczenia, w poznanych formach − pisze z pamięci i ze − tworzy wypowiedź gatunkowych, stosując słuchu wyrazy i proste związaną z poznanymi urozmaicone zdania, utworami literackimi słownictwo, − zapisuje proste i innymi tekstami kultury − stosuje w wypowiedzi informacje o sobie, oraz na znane mu tematy pisemnej odpowiednią − pisze według wzoru (np. o jego kompozycję i układ proste teksty na znane zainteresowaniach), graficzny, mu tematy (np. związane − tworzy proste − posługuje się oficjalną z jego wypowiedzi pisemne i nieoficjalną odmianą zainteresowaniami), w wybranych formach języka, − tworzy krótką, na ogół gatunkowych (opis, − pisze poprawnie pod poprawną, kilkuzdaniową charakterystyka, względem wypowiedź składającą opowiadanie, dialog, list ortograficznym się z prostych zdań (opis, prywatny, kartka i interpunkcyjnym dialog, pozdrowienia, z dziennika, ogłoszenie, życzenia), zaproszenie, życzenia, − stosuje podstawowe notatka), formuły grzecznościowe, − sporządza plan − na ogół pisze poprawnie wypowiedzi, ortograficznie i stosuje − stosuje formuły poprawną interpunkcję grzecznościowe, − pisze poprawnie pod względem ortograficznym i interpunkcyjnym Kompetencje językowe (od 14 lat) Kompetencje A − poziom podstawowy B − poziom średni (średnio C − poziom zaawansowany) zaawansowany 1 2 3 4 Słuchanie Uczeń: Uczeń: Uczeń: − rozróżnia większość − rozróżnia głoski języka − rozróżnia wszystkie głosek języka polskiego, polskiego z wyjątkiem głoski języka polskiego, − rozumie polecenia najtrudniejszych, − rozumie wypowiedzi i proste wypowiedzi − rozumie wypowiedzi o złożonej strukturze, monologowe monologowe w tym nadawane za i dialogowe, w tym i dialogowe, w tym pomocą środków nadawane za pomocą nadawane za pomocą audiowizualnych, środków środków i odbiera zawarte w nich audiowizualnych, audiowizualnych, informacje zarówno − rozumie proste utwory − rozumie utwory literackie jawne, jak i ukryte, literackie (zwłaszcza i inne teksty kultury, − rozumie utwory pisane współczesną − rozumie wypowiedzi literackie (z różnych polszczyzną) i inne informacyjne i użytkowe epok) i inne teksty teksty kultury, oraz odróżnia informacje kultury, − rozumie proste o faktach od opinii, − rozumie wypowiedzi wypowiedzi − rozumie intencję o charakterze informacyjne i użytkowe, wypowiedzi (np. popularnonaukowym − rozpoznaje intencję aprobatę, dezaprobatę, i publicystycznym, wypowiedzi (np. prowokację) oraz − rozumie jawną i ukrytą aprobatę, dezaprobatę) rozpoznaje środki intencję wypowiedzi wspomaganą intonacją językowe służące jej (sugestię i manipulację lub gestem wyrażeniu językową oraz ironię), − rozpoznaje środki językowe pełniące różne funkcje stylistyczne Mówienie − wymawia poznane słowa − mówi w sposób na ogół − poprawnie wymawia w sposób na ogół zrozumiały i stosuje słowa i zdania, zrozumiały, akcent zdaniowy, − wypowiada się − tworzy samodzielnie na − swobodnie spontanicznie, płynnie ogół poprawną i spontanicznie i logicznie, kilkuzdaniową porozumiewa się − prezentuje fabułę wypowiedź, w różnych sytuacjach, i charakteryzuje postać − porozumiewa się stosując właściwe formy mówiącą, wypowiada w typowych sytuacjach komunikowania się, się precyzyjnie komunikacyjnych, − formułuje spójną w rozmaitych formach, − w prosty sposób wypowiedź na tematy − w dyskusji, wystąpieniu wypowiada się (opisuje związane z otaczającą publicznym formułuje swoje reakcje) na temat rzeczywistością, swoje zdanie, uzasadnia poznanych tekstów opowiada o własnych je i broni go, podejmuje kultury, doświadczeniach, opisuje polemikę, − stosuje formuły ludzi, przedmioty, − przestrzega zasad grzecznościowe, miejsca i sytuacje, etykiety językowej, 1 2 3 4 − odtwarza teksty − streszcza, omawia dostosowuje sposób z pamięci przeczytane utwory wyrażania do stylu literackie i inne teksty właściwego dla danej kultury, wskazuje ich sytuacji, temat, problematykę, − recytuje utwory charakteryzuje postaci, literackie, interpretując przedstawia przebieg je głosowo akcji oraz tworzy spójne, dłuższe wypowiedzi na zadany lub wybrany przez siebie temat, − uczestniczy w dyskusji na znany sobie temat, potrafi przedstawić swój punkt widzenia i uzasadnia własne zdanie, − stosuje podstawowe zasady etykiety językowej, dostosowując odmianę i styl języka do sytuacji, w której się wypowiada, − recytuje utwory literackie, dbając o prawidłową intonację Czytanie − zna wszystkie litery − czyta na głos, − rozumie utwory i odpowiadające im prawidłowo akcentując literackie i inne teksty głoski, wyrazy, i stosuje akcent kultury, a w ich − czyta na głos i cicho zdaniowy, interpretacji uwzględnia proste teksty literackie − rozumie dłuższe teksty różne konteksty, i nieliterackie, informacyjne oraz − identyfikuje elementy − rozumie proste teksty użytkowe, konstrukcyjne struktury informacyjne i użytkowe, − rozpoznaje podstawowe tekstu literackiego − rozumie proste utwory funkcje wypowiedzi, i dostrzega relacje literackie oraz inne teksty − wyszukuje informacje między nimi, kultury, według wskazanego − odczytuje sens całego − wyodrębnia części kryterium i porządkuje tekstu i wydzielonych składowe całego tekstu je, fragmentów oraz ich i akapitu (wstęp, − rozumie dłuższe utwory funkcję na tle całości, rozwinięcie, literackie oraz inne teksty − rozpoznaje jawną zakończenie), kultury, i ukrytą intencję − odróżnia w prostym − wskazuje wypowiedzi, ironię tekście informacje ważne i charakteryzuje i manipulację językową, od drugorzędnych, podstawowe kategorie − czyta wybrane utwory − korzysta ze słowników świata przedstawionego, literackie (z różnych i encyklopedii rozpoznaje jawną epok), i ukrytą intencję − korzysta z rozmaitych wypowiedzi (np. źródeł informacji aprobatę, dezaprobatę, sugestię), 1 2 3 4 − dostrzega w wypowiedzi ewentualne przejawy manipulacji, − w tekście argumentacyjnym wskazuje tezę, argumenty, przykłady i wnioski Pisanie − poprawnie zapisuje − zapisuje dyktowane − sporządza notatkę wszystkie litery teksty, z tekstu słuchanego polskiego alfabetu, − tworzy podstawowe i czytanego, przepisuje wyrazy formy użytkowe (list − tworzy formy użytkowe i proste zdania, oficjalny, podanie, (list oficjalny, podanie, − pisze z pamięci i ze życiorys), życiorys, CV, list słuchu wyrazy i proste − opowiada motywacyjny), zdania, o rzeczywistych lub − przedstawia (opracowuje − zapisuje proste fikcyjnych zdarzeniach w pełni) dowolnie informacje o sobie, i doświadczeniach oraz wybrany temat, − w prosty sposób nazywa opisuje uczucia, zwracając uwagę na swoje emocje i opisuje − tworzy wypowiedzi strukturę wypowiedzi, swoje doświadczenia, pisemne w poznanych − wypowiada się − tworzy proste, formach gatunkowych, w różnych formach kilkuzdaniowe stosując urozmaicone gatunkowych (list wypowiedzi (opis, słownictwo, prywatny, dziennik, dialog, pozdrowienia, − tworzy spójną pod streszczenie, w tym życzenia, list prywatny, względem logicznym streszczenie tekstu krótka wiadomość), i składniowym argumentacyjnego, − tworzy kilkuzdaniową, wypowiedź na zadany sprawozdanie, na ogół poprawną, temat, rozprawka), stosując wypowiedź na znane mu − przedstawia własną urozmaicone tematy (np. związane opinię na temat słownictwo, z jego zainteresowaniami poznanych tekstów − analizuje i interpretuje lub doświadczeniami), kultury i uzasadnia ją, wskazane utwory − w prosty sposób − posługuje się oficjalną literackie oraz inne wypowiada się (opisuje i nieoficjalną odmianą teksty kultury, swoje reakcje) na temat języka, − stosuje formuły poznanych tekstów − stosuje formuły grzecznościowe kultury, grzecznościowe, odpowiednie do sytuacji, − stosuje formuły − pisze poprawnie pod − stosuje obowiązujące grzecznościowe, względem normy poprawnościowe, − na ogół pisze poprawnie ortograficznym posługując się pod względem i interpunkcyjnym, słownikami, ortograficznym posługując się − redaguje i edytuje i interpunkcyjnym, słownikiem własny tekst posługując się ortograficznym słownikiem ortograficznym Kręgi tematyczne 5−9 lat 10−13 lat od 14 lat 1 2 3 Ja i moi bliscy: Ja i moi bliscy: Ja i moi bli
portowe Podróże i turystyka: Podróże i turystyka: Podróże i turystyka: − wakacje; − wakacje, wypoczynek; − planowanie wypoczynku − ciekawostki turystyczne; − znane miejsca, obiekty; i podróży; − komunikacja lokalna − informacja turystyczna; − znane miejsca i zabytki; − środki transportu − informacja turystyczna; − baza turystyczna; − transport Środowisko naturalne: Środowisko naturalne: Środowisko naturalne: − pogoda, pory roku; − klimat, pogoda, pory roku; − klimat, pogoda, pory roku; − rośliny i zwierzęta − rośliny i zwierzęta; − świat roślin i zwierząt; − ochrona przyrody − krajobraz; − ekologia; − katastrofy naturalne; − przestrzeń kosmiczna Technika, media: Technika, media: Technika, media: − domowe urządzenia − odkrycia i wynalazki; − rozwój techniki i informatyki; techniczne; − urządzenia techniczne; − motoryzacja − telewizja, radio, Internet − radio, telewizja, prasa, i telekomunikacja; Internet − radio, telewizja, prasa, Internet Wiedza o Polsce: Wiedza o Polsce: Wiedza o Polsce: − symbole narodowe; − wybitni twórcy kultury − twórcy kultury i ich dzieła; − znani Polacy; i ich dzieła; − święta, tradycje i zwyczaje, − święta i zwyczaje; − święta, tradycje rocznice; − polonica w miejscu i zwyczaje; − polonica w miejscu zamieszkania − polonica w miejscu zamieszkania i okolicy zamieszkania Język nauki: Język nauki: Język nauki: − podstawowe terminy − podstawowe terminy − podstawowe terminy z zakresu wiedzy o języku; z zakresu wiedzy o języku; z zakresu wiedzy o języku; − podstawowe terminy − podstawowe terminy − podstawowe terminy z zakresu wiedzy z zakresu wiedzy z zakresu wiedzy o literaturze; o literaturze; o literaturze; − podstawowe terminy − podstawowe terminy − podstawowe terminy historyczne i geograficzne historyczne i geograficzne historyczne i geograficzne WIEDZA O POLSCE (elementy historii, geografii, wiedzy o społeczeństwie) II etap edukacyjny (klasy IV−VI szkoły podstawowej) Cele kształcenia − wymagania ogólne Uczeń zdobywa podstawowe wiadomości na temat historii Polski od przyjęcia chrześcijaństwa do czasów Solidarności i odzyskania suwerenności w 1989 r., które pozwolą mu lepiej poznać kraj jego pochodzenia oraz dostrzec związki teraźniejszości z przeszłością. Zdobywa podstawowe informacje o kulturze i społeczeństwie, a także geografii Polski; zdobyta wiedza pozwoli mu na identyfikację z kulturą i tradycją polską. Rozbudza swoje zainteresowania dziejami Polski, stawia pytania dotyczące przyczyn i skutków analizowanych wydarzeń historycznych i współczesnych; posługuje się zdobytymi pojęciami, przedstawiając własne stanowisko i próbując je uzasadnić. Treści nauczania − wymagania szczegółowe
    - **a)** terminy z zakresu wiedzy o języku,
    - **b)** terminy z zakresu wiedzy o literaturze,
    - **c)** terminy historyczne i geograficzne.
...
18. Wspólnota europejska. Uczeń opowiada o uczestnictwie Polski we wspólnocie europejskiej oraz rozpoznaje symbole unijne: flagę i hymn Unii Europejskiej (Oda do radości). III etap edukacyjny (gimnazjum) Cele kształcenia − wymagania ogólne w zakresie historii i wiedzy o społeczeństwie
...
