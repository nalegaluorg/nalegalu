...
source: "eli-html"
---
# Obwieszczenie Prezesa Rady Ministrówz dnia 24 marca 2015 r. w sprawie ogłoszenia jednolitego tekstu rozporządzenia Prezesa Rady Ministrów w sprawie przebiegu służby funkcjonariuszy Centralnego Biura Antykorupcyjnego
...
| Źródło | [ELI HTML](https://eli.gov.pl/api/acts/DU/2015/503/text.html) · [ELI API](https://api.sejm.gov.pl/eli/acts/DU/2015/503) |

## Spis treści

- [Treść obwieszczenia](#part_1)

- [Załącznik - Rozporządzenie Prezesa Rady Ministrów z dnia 27 września 2006 r. w sprawie przebiegu służby funkcjonariuszy Centralnego Biura Antykorupcyjnego](#part_2) [Rozdział 1 - Przepisy ogólne](#chpt_1) [Rozdział 2 - Nawiązanie stosunku służbowego](#chpt_2) [Rozdział 3 - Mianowanie na stanowisko służbowe, przenoszenie, odwoływanie i zwalnianie ze stanowiska służbowego](#chpt_3) [Rozdział 4 - Sposób usprawiedliwiania nieobecności w służbie](#chpt_4) [Rozdział 5 - Rodzaje informacji udzielanych przez funkcjonariusza](#chpt_5) [Rozdział 6 - Rozwiązanie i wygaśnięcie stosunku służbowego](#chpt_6)
...
Na podstawie art. 83 ustawy z dnia 9 czerwca 2006 r. o Centralnym Biurze Antykorupcyjnym ([Dz. U. z 2014 r. poz. 1411](https://api.sejm.gov.pl/eli/acts/DU/2014/1411/text.html) i [1822](https://api.sejm.gov.pl/eli/acts/DU/2014/1822/text.html)) zarządza się, co następuje:
...
### 3[2) Dodany przez § 1 pkt 1 rozporządzenia Prezesa Rady Ministrów z dnia 24 marca 2010 r. zmieniającego rozporządzenie w sprawie przebiegu służby funkcjonariuszy Centralnego Biura Antykorupcyjnego (Dz. U. Nr 56, poz. 340), które weszło w życie z dniem 23 kwietnia 2010 r.](#gloss-0:2:).
...
### 4[3) Dodany przez § 1 pkt 2 rozporządzenia, o którym mowa w odnośniku 2.](#gloss-0:3:).
...
### 11[4) W brzmieniu ustalonym przez § 1 pkt 3 rozporządzenia, o którym mowa w odnośniku 2.](#gloss-0:4:))

termin, w którym bezpośredni przełożony funkcjonariusza jest obowiązany rozliczyć funkcjonariusza z obowiązków służbowych.

### § 22a[5) Dodany przez § 1 pkt 4 rozporządzenia, o którym mowa w odnośniku 2.](#gloss-0:5:).
...
Rozporządzenie wchodzi w życie po upływie 14 dni od dnia ogłoszenia[6) Rozporządzenie zostało ogłoszone w dniu 29 września 2006 r.](#gloss-0:6:).
