...
# Ustawa z dnia 16 lipca 2004 r. o zmianie ustawy o emeryturach i rentach z Funduszu Ubezpieczeń Społecznych oraz niektórych innych ustaw
...
- **2)** art. 19a otrzymuje brzmienie: „ Kwota bazowa jest ustalana corocznie na podstawie art. 19 i obowiązuje od dnia 1 marca każdego roku kalendarzowego do końca lutego następnego roku kalendarzowego. ” ;
...
- **4)** w art. 89: ust. 1 otrzymuje brzmienie: „
    - **a)**

1. Wskaźnik waloryzacji jest równy wskaźnikowi cen towarów i usług konsumpcyjnych w okresie od roku kalendarzowego, w którym przeprowadzono ostatnią waloryzację, do roku poprzedzającego termin waloryzacji. ” , po ust. 2 dodaje się ust. 3–7 w brzmieniu: „
...
- **1)** należne od terminu waloryzacji kwoty: najniższej emerytury i renty, dodatku pielęgnacyjnego i dodatku dla sierot zupełnych;
    - **a)**
    - **b)**
