...
| Źródło | [ELI HTML](https://eli.gov.pl/api/acts/DU/2023/1679/text.html) · [ELI API](https://api.sejm.gov.pl/eli/acts/DU/2023/1679) |
...
W rozporządzeniu Ministra Infrastruktury i Rozwoju z dnia 7 maja 2015 r. w sprawie określenia obiektów, urządzeń i instalacji wchodzących w skład infrastruktury zapewniającej dostęp do portu o podstawowym znaczeniu dla gospodarki narodowej ([Dz. U. z 2023 r. poz. 1143](https://api.sejm.gov.pl/eli/acts/DU/2023/1143/text.html)) w § 3 wprowadza się następujące zmiany:

### 1)

w pkt 1 lit. d-h otrzymują brzmienie:
...
tor wodny w Kanale Polickim (Wąski Nurt) o długości 5,12 km, o podanych parametrach na odcinkach:
...
tor wodny w Kanale Wietlina (Ciasny Nurt) o długości 2,58 km, szerokości 70 m i głębokości technicznej 4,5 m;
...
w pkt 13 w lit. e w tiret trzecim średnik zastępuje się przecinkiem i dodaje się lit. f w brzmieniu:
...
w pkt 14 lit. c i d otrzymują brzmienie:

„

### c)

kotwicowisko „Raduń” o powierzchni 0,044 km2igłębokości od 8,0 m do 11,8 m,

### d)

kotwicowisko „Inoujście” o powierzchni 0,086 km2igłębokości od 2,0 m do 13,5 m;
