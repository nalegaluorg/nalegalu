...
| Pole | Wartość |
|---|---|
| Adres publikacyjny | Dz.U. 2021 poz. 1917 |
| ISAP | WDU20210001917 |
| Typ aktu | Ustawa |
| Status | akt objęty tekstem jednolitym |
| W mocy | tak |
...
| Źródło | [ISAP](https://isap.sejm.gov.pl/isap.nsf/DocDetails.xsp?id=WDU20210001917) · [PDF](https://api.sejm.gov.pl/eli/acts/DU/2021/1917/text.pdf) |
...
- **2)** podmiot prowadzący skład podatkowy, w którego miejscu prowadzenia albo w jego części będzie prowadzony skład podatkowy przez inny podmiot prowadzący skład podatkowy: sporządzi na dzień, w którym nastąpi cofnięcie zezwolenia na prowadzenie składu podatkowego, nie później niż w dniu następującym po tym dniu, wykaz wyrobów akcyzowych objętych procedurą zawieszenia poboru akcyzy znajdujących się w miejscu prowadzenia tego składu podatkowego albo w jego części, w których będzie prowadzony skład podatkowy przez inny podmiot prowadzący skład podatkowy, określający ilości wyrobów akcyzowych oraz kwotę akcyzy, która przypadałaby do zapłaty, gdyby te wyroby nie były objęte procedurą zawieszenia poboru akcyzy, niezwłocznie powiadomi właściwego naczelnika urzędu skarbowego o sporządzeniu wykazu, o którym mowa w lit. a;
    - **a)**
    - **b)**

- **3)** podmiot prowadzący skład podatkowy, któremu zostało wydane nowe zezwolenie na prowadzenie składu podatkowego albo zmienione zezwolenie na prowadzenie składu podatkowego: w dniu, w którym zacznie obowiązywać nowe zezwolenie na prowadzenie składu podatkowego albo zmienione zezwolenie na prowadzenie składu podatkowego, powiadomi właściwego naczelnika urzędu skarbowego, że wyroby akcyzowe objęte wykazem, o którym mowa w pkt 2 lit. a, znajdują się w prowadzonym przez niego składzie podatkowym, niezwłocznie dokona wpisów wyrobów akcyzowych objętych wykazem, o którym mowa w pkt 2 lit. a, do ewidencji wyrobów akcyzowych prowadzonej przez ten podmiot prowadzący skład podatkowy.
    - **a)**
    - **b)**
...
- **2)** przekazać właściwemu naczelnikowi urzędu skarbowego oryginał albo uwierzytelnioną kopię dokumentu potwierdzającego tytuł prawny, o którym mowa w pkt 1, niezwłocznie po jego uzyskaniu. ” , po ust. 8 dodaje się ust. 8a w brzmieniu: „
    - **b)**
...
- **4)** w art. 63: po ust. 3a dodaje się ust. 3b i 3c w brzmieniu: „
    - **a)**
...
- **2)** jeżeli zostały objęte zwolnieniem od akcyzy ze względu na ich przeznaczenie. ” , w ust. 6 po wyrazach „zgodnie z ust. 3a” dodaje się wyrazy „albo 3b”.
    - **b)**
