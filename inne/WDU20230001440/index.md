...
- **6)** 1. W przypadku gdy podmiot publiczny publikuje na stronie internetowej lub w aplikacji mobilnej zarejestrowane wcześniej multimedia nadawane na żywo, dostosowuje je do wymagań określonych w załączniku do ustawy w terminie 14 dni od dnia zakończenia nadawania.
...
1. 2 – Multimedia 1.2.3 – Audiodeskrypcja lub alternatywa tekstowa A dla mediów (nagranie)
...
2. 3 – Ataki padaczki 2.3.1 – Trzy błyski lub wartości poniżej progu A 2 – Funkcjonalność 2.4.1 – Możliwość pominięcia bloków A

2. 4.2 – Tytuł strony A

2. 4.3 – Kolejność fokusu A

2. 4 – Możliwość nawigacji 2.4.4 – Cel linku (w kontekście) A
...
3. 2.3 – Spójna nawigacja AA 3 – Zrozumiałość 3.2.4 – Spójna identyfikacja AA
...
3. 3.4 – Zapobieganie błędom (prawnym, finansowym, AA w danych)
