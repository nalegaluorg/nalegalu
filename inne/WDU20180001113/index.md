...
ROZPORZĄDZENIE MINISTRA SPRAW WEWNĘTRZNYCH I ADMINISTRACJI z dnia 5 czerwca 2018 r.
...
2) mianowan ia na stopień generała brygady albo generała dywizji Służby Ochrony Państwa.
...
14) kurtkę ochronną z membraną paroprzepuszczalną w składzie ubioru galowego i wyjściowego; w zależności od warunków atmosferycznych, można zakładać na głowę kaptur; Komendant Służby Ochrony Państwa może zezwolić na
...
Minister Spraw Wewnętrznych i Administracji: wz. K. Kozłowski WZORY UBIORU GALOWEGO
a) ubiór galowy funkcjonariusza z beretem
b) ubiór galowy funkcjonariusza z czapką futrzaną w płaszczu sukiennym
c) ubiór galowy funkcjonariusza w płaszczu letnim WZORY UBIORU WYJŚCIOWEGO
...
e) ubiór wyjściowy funkcjonariusza z koszulą koloru białego z krótkimi rękawami i naramiennikami oraz z krawatem WZORY UBIORU SŁUŻBOWO-POLOWEGO
...
g) ubiór służbowo-polowy funkcjonariusza z czapką polową, koszulką z krótkimi rękawami i spodniami polowymi WZORY UBIORU REPREZENTACYJNEGO
a) ubiór reprezentacyjny funkcjonariusza
b) ubiór reprezentacyjny funkcjonariusza w płaszczu sukiennym WZORY UBIORU SPECJALNEGO
...
j) ubiór funkcjonariusza obsługującego warsztaty remontowe i magazyny w okresie zimowym WZORY NAKRYĆ GŁOWY Z WIZERUNKAMI ORŁA
1) beret
2) czapka polowa
3) czapka futrzana
4) czapka pirotechnika
5) czapka zimowa WZORY OBUWIA czółenka damskie kozaki damskie trzewiki zimowe funkcjonariusza półbuty funkcjonariusza W W SPOSÓB ROZMIESZCZENIA OZNAK STOPNI NA POCHEWKACH NA NARAMIENNIKI I PODKŁADKACH
1) sposób rozmieszczenia oznak stopni na pochewkach na naramienniki:
a) szeregowy SOP b) starszy szeregowy SOP c) kapral SOP
d) plutonowy SOP e) sierżant SOP f) starszy sierżant SOP
g) młodszy chorąży SOP h) chorąży SOP i) starszy chorąży SOP
j) podporucznik SOP k) porucznik SOP l) kapitan SOP
...
c) kapral SOP d) plutonowy SOP
e) sierżant SOP f) starszy sierżant SOP
g) młodszy chorąży SOP h) chorąży SOP
i) starszy chorąży SOP j) podporucznik SOP
k) porucznik SOP l) kapitan SOP
...
a) starszy szeregowy SOP b) kapral SOP
c) plutonowy SOP d) sierżant SOP
e) starszy sierżant SOP f) młodszy chorąży SOP
g) chorąży SOP h) starszy chorąży SOP
i) podporucznik SOP j) porucznik SOP
m) podpułkownik SOP n) pułkownik SOP
k) kapitan SOP l) major SOP
o) generał brygady SOP p) generał dywizji SOP WZÓR OZNAKI SŁUŻBY OCHRONY PAŃSTWA WZORY OZNAK PRZYNALEŻNOŚCI PAŃSTWOWEJ
...
3) oznaka przynależności państwowej w postaci naszywki z godłem Rzeczypospolitej Polskiej WZORY OZNAK ROZPOZNAWCZYCH SŁUŻBY OCHRONY PAŃSTWA
b) oznaka rozpoznawcza SOP
a) oznaka rozpoznawcza SOP w kolorach kamuflażowych WZÓR OZNAKI IDENTYFIKACYJNEJ
a) długość 80 mm,
b) szerokość 13 mm,
...
#### Rozdział 2 Rodzaje, wzory, normy należności umundurowania i normy ubrania typu cywilnego § 2. Umundurowanie funkcjonariuszy składa się z następujących rodzajów ubiorów:

#### Rozdział 3 Sposób noszenia umundurowania § 16. Poszczególne przedmioty umundurowania nosi się:

#### Rozdział 4 Rodzaje i wzory oznak oraz sposób ich noszenia § 19. Funkcjonariusze noszą na umundurowaniu oznaki:

#### Rozdział 5 Przepis końcowy § 25. Rozporządzenie wchodzi w życie z dniem następującym po dniu ogłoszenia.
