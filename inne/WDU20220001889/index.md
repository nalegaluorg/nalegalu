...
source: "eli-html"
---
# Rozporządzenie Ministra Sprawiedliwościz dnia 31 sierpnia 2022 r. w sprawie pobytu nieletnich w schroniskach dla nieletnich

| Pole | Wartość |
|---|---|
| Adres publikacyjny | Dz.U. 2022 poz. 1889 |
| ISAP | WDU20220001889 |
...
| Źródło | [ELI HTML](https://eli.gov.pl/api/acts/DU/2022/1889/text.html) · [ELI API](https://api.sejm.gov.pl/eli/acts/DU/2022/1889) |

## Spis treści

- [Treść rozporządzenia](#part_1) [Rozdział 1 - Przepisy ogólne](#chpt_1) [Rozdział 2 - Szczegółowy tryb kierowania, przyjmowania, przenoszenia i zwalniania nieletnich ze schronisk](#chpt_2) [Rozdział 3 - Szczegółowe warunki pobytu nieletnich w schroniskach](#chpt_3) [Rozdział 4 - Uczestniczenie przez nieletnich w wykonywaniu praktyk religijnych i korzystaniu przez nich z posług religijnych](#chpt_4) [Rozdział 5 - Przepis końcowy](#chpt_5)

TOC

## Treść rozporządzenia

Na podstawie art. 320 ustawy z dnia 9 czerwca 2022 r. o wspieraniu i resocjalizacji nieletnich ([Dz. U. poz. 1700](https://api.sejm.gov.pl/eli/acts/DU/2022/1700/text.html)) zarządza się, co następuje:
...
szczegółowy tryb kierowania, przyjmowania, przenoszenia i zwalniania nieletnich ze schronisk dla nieletnich;

### 2)

szczegółowe warunki pobytu nieletnich w schroniskach dla nieletnich;
...
Ministerstwie Sprawiedliwości - rozumie się przez to komórkę organizacyjną Ministerstwa Sprawiedliwości wykonującą zadania z zakresu nadzoru pedagogicznego Ministra Sprawiedliwości nad schroniskami dla nieletnich;
...
sąd wykonujący środek tymczasowy, o którym mowa w art. 44 pkt 8 ustawy;
...
schronisko, do którego nieletni został skierowany.
...
orzeczenia o zastosowaniu wobec nieletniego środka tymczasowego, o którym mowa w art. 44 pkt 8 ustawy, albo postanowienia, o którym mowa w art. 301 ust. 3 ustawy;

### 2)

skierowania albo przeniesienia do schroniska;
...
schronisko, do którego nieletni ma zostać przeniesiony;

### 4)

schronisko, z którego nieletni ma zostać przeniesiony;
...
umieszczenia w zakładzie poprawczym, areszcie śledczym lub zakładzie karnym;

### 4)

upływu okresu pobytu oznaczonego w postanowieniu o zastosowaniu wobec nieletniego środka tymczasowego, o którym mowa w art. 44 pkt 8 ustawy, albo upływu okresu pobytu oznaczonego w postanowieniu o przedłużeniu pobytu nieletniego w schronisku.
...
zasad bezpieczeństwa i porządku wewnętrznego schroniska oraz regulaminów obowiązujących w schronisku;
