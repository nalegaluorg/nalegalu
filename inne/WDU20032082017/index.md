...
- **4)** wykonywaniu czynności 2 zakresu medycyny pracy, zapobieganiu i zwalczaniu chorób zakaźnych,
- **5)** sprawowaniu nadzoru nad artykułami żywnościowymi i produktami użytkowymi,
- **6)** stwierdzaniu zgonów,
- **7)** udziale w procesie leczenia pod nadzorem lub przy współpracy z lekarzem. ” , w ust. 2 zdanie wstępne otrzymuje brzmienie: „ Czynności określone w ust. 1 felczer wykonuje: ” ;
    - **b)**
...
2. Starszy felczer czynności określone w art. 2 ust. 1 wykonuje samodzielnie w zakładach opieki zdrowotnej. ” , uchyla się ust. 3;
