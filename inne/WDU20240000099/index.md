...
Parametr 2: „struktura i funkcja” ocenia się wg następującej skali: Parametr FV (właściwy) U1 (niezadowalający) U2 (zły) Niewielkie zaburzenia, np. Istotne, głębokie zaburzenia, np. W dobrym stanie, brak nieoptymalne brak właściwego znaczących zaburzeń, zachodzą zagospodarowanie, niewielkie zagospodarowania, zubożenie typowe dla siedliska procesy zubożenie strukturalne, strukturalne, brak typowych dla
