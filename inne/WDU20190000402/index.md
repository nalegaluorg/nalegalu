...
- **1)** § 4 otrzymuje brzmienie:
  ...
  > „§ 4.  
  > 1. Zajęcia dydaktyczno-wychowawcze w klasach dotychczasowej zasadniczej szkoły zawodowej, klasach dotychczasowego trzyletniego liceum ogólnokształcącego dla młodzieży oraz klasach dotychczasowego czteroletniego technikum są realizowane przez 5 dni w tygodniu.  
...
- **2)** w § 5:
    ...
    - **b)** w ust. 2 w pkt 1 lit. d otrzymuje brzmienie: „d) egzamin potwierdzający kwalifikacje w zawodzie lub egzamin zawodowy;”,
