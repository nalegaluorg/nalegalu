...
Warszawa, dnia 21 maja 2012 v r.
Poz. 556 o ROZPORZĄDZENIE RADY MINISTRÓW z dnia 27 grudnia g 2011 r.
w sprawie oceny okresowej bezpieczeństwa jądrowego obiektu jądrowego Na podstawie art. 37e ust. 11 ustawy z dnia 29 listopada 2000 r. – Prawo atomowe (Dz. U. z 2012 r. poz. 264) zarządza się, co następuje: .

**§ 1.** Rozporządzenie określa zakres oceny okresowej l bezpieczeństwa jądrowego obiektu jądrowego, zwanej dalej „oceną okresową”, oraz zakres raportu z oceny okresowej. c

**§ 2.** Ocena okresowa obejmuje:

- **1)** weryfikację rozwiązań projektowych i dokumentacji technicznej obiektu jądrowego oraz zmian wprowadzonych w obiekcie jądrowym od poprzedniej oceny okresowej, a w przypadku przeprowadzania oceny okresowej po raz pierwszy – od rozpoczęcia eksploatacji r obiektu jądrowego, z uwzględnieniem zastosowanej koncepcji bezpieczeństwa jądrowego oraz zgodności z wymaganiami bezpieczeństwa jądrowego obowiązującymi w czasie przeprowadzania oceny okresowej; .
- **2)** aktualny stan systemów, elementów konstrukcji i wyposażenia obiektu jądrowego mających istotne znaczenie dla zapewnienia bezpieczeństwa jądrowego i ochrony radiologicznej; w
...
- **5)** w deterministyczne analizy bezpieczeństwa obiektu jądrowego;
- **6)** probabilistyczne analizy bezpieczeństwa obiektu jądrowego;
- **7)** analizę zdarzeń wewnętrznych oraz zdarzeń zewnętrznych będących skutkiem działalności człowieka i skutkiem działania sił przyrody; w 8) doświadczenia z dotychczasowej eksploatacji ocenianego obiektu jądrowego;
...
- **13)** wpływ obiektu jądrowego na zdrowie ludzi oraz środowisko z punktu widzenia bezpieczeństwa jądrowego i ochrony radiologicznej. v

**§ 3.** Raport z oceny okresowej zawiera:

- **1)** opis przeprowadzonych analiz związanych z każdym z zagadnień, o których mowa w § 2, obejmujący: o
    ...
    - **d)** porównanie aktualnych wymagań bezpieczeństwa jądrowego g i ochrony radiologicznej związanych z danym zagadnieniem z wymaganiami obowiązującymi w czasie poprzedniej oceny okresowej, a w przypadku przeprowadzania pierwszej oceny okresowej – z wymaganiami obowiązującymi w czasie rozpoczęcia eksploatacji obiektu jądrowego,
    ...
    - **f)** wyniki przeprowadzonej analizy ze szczególnym uwzględnieniem obszarów wymagających działań naprawczych i korygujących, c
    - **g)** przewidywania dotyczące danego zagadnienia w okresie do następnej oceny okresowej;

- **2)** podsumowanie analiz, o których mowa w pkt 1, pozwalające na ogólną ocenę bezpieczeństwa obiektu jądrowego jako całości; r
...
**§ 4.** Rozporządzenie wchodzi w życie po upływie 14 dni od dnia ogłoszenia. w Prezes Rady Ministrów: D. Tusk w w
