...
- **1)** w art. 8 dodaje się ust. 8–10 w brzmieniu: „8. Odstrzał sanitarny zwierząt jest wykonywany z nakazu wydanego na podstawie przepisów o ochronie zdrowia zwierząt oraz zwalczaniu chorób zakaźnych zwierząt.
...
- **2)** w art. 29:
    ...
    - **b)** ust. 2 otrzymuje brzmienie: „2. Świadectwo broni na broń szczególnie niebezpieczną, o której mowa w:
...
- **1)** w art. 45:
    - **a)** w ust. 1 pkt 8c otrzymuje brzmienie: „8c) nakazać zarządcom dróg publicznych:
...
- **2)** w art. 46:
    - **a)** w ust. 3: – pkt 8d otrzymuje brzmienie: „8d) nakazuje zarządcom dróg publicznych:
    - **a)** zamykanie znajdujących się w pasach drogowych przejść dla zwierząt lub
    - **b)** wykonywanie przeszkód technicznych, w szczególności budowę ogrodzeń lub zabezpieczeń technicznych, lub
