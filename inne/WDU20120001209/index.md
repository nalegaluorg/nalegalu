...
- **1)** w art. 35a ust. 1 i 2 otrzymują brzmienie: „1. Nadawca może złożyć wniosek o udzielenie koncesji na kolejny okres, nie później niż 12 miesięcy przed wygaśnięciem posiadanej koncesji.
...
- **3)** art. 42 otrzymuje brzmienie: „Art. 42. 1. Za wpis programu do rejestru programów telewizyjnych rozpowszechnianych wyłącznie w systemie teleinformatycznym i programów rozprowadzanych podmiot zgłaszający program uiszcza opłatę w wysokości 100 zł za każdy program.
