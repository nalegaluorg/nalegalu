...
- **2)** w art. 38: w ust. 1: – pkt 1 otrzymuje brzmienie: „ 1) dokument stwierdzający uprawnienie do kierowania pojazdem inny niż wydane w kraju prawo jazdy albo pozwolenie na kierowanie tramwajem, jeżeli kierujący nie posiada wydanego w kraju prawa jazdy albo pozwolenia na kierowanie tramwajem; ” , – po pkt 4a dodaje się pkt 4b w brzmieniu: „ 4b) pokwitowanie zatrzymania: a) prawa jazdy albo pozwolenia na kierowanie tramwajem, b) dowodu rejestracyjnego albo pozwolenia czasowego, c) profesjonalnego dowodu rejestracyjnego – w okresie, w którym upoważnia ono do kierowania pojazdem albo jego używania; ” , po ust. 2b dodaje się ust. 2c w brzmieniu: „
    - **a)**
    - **b)**
...
- **5)** w art. 60: w ust. 1 po pkt 3 dodaje się pkt 3a i 3b w brzmieniu: „
    - **a)**

- **3a)** umieszczania na pojeździe tablic (tablicy) rejestracyjnych w innym miejscu niż konstrukcyjnie do tego przeznaczone;
- **3b)** umieszczania na pojeździe jednorzędowych zmniejszonych tablic rejestracyjnych, jeżeli pojazd nie posiada zmniejszonych wymiarów miejsca konstrukcyjnie przeznaczonego do umieszczenia tablicy rejestracyjnej; ” , po ust. 1 dodaje się ust. 1a w brzmieniu: „
    - **b)**
...
- **2)** wyznacza w ramach województwa dla każdego organu rejestrującego pojemność rejestracyjną dla tablic rejestracyjnych: tymczasowych oraz samochodowych jednorzędowych zmniejszonych i tymczasowych, dla pojazdu posiadającego zmniejszone wymiary miejsca konstrukcyjnie przeznaczonego do umieszczenia tablicy rejestracyjnej.
    - **a)**
    - **b)**
...
1. Czasowej rejestracji pojazdu dokonuje, w przypadkach określonych w ust. 2, organ rejestrujący właściwy ze względu na miejsce stałego zamieszkania (siedzibę) lub czasowego zamieszkania właściciela pojazdu, wydając decyzję o czasowej rejestracji pojazdu, pozwolenie czasowe i zalegalizowane tablice (tablicę) rejestracyjne. ” , po ust. 1 dodaje się ust. 1a w brzmieniu: „

- **b)**

1a. W przypadku, o którym mowa w ust. 2 pkt 2 lit. b, czasowej rejestracji może dokonać również organ rejestrujący właściwy ze względu na miejsce zakupu pojazdu lub jego odbioru na terytorium Rzeczypospolitej Polskiej. ” , po ust. 2b dodaje się ust. 2c-2f w brzmieniu: „
...
2f. Właściciel pojazdu albo podmiot, o którym mowa w art. 73 ust. 2 i 5, są obowiązani odebrać decyzję o rejestracji pojazdu i dowód rejestracyjny w terminie 30 dni od dnia złożenia wniosku o rejestrację pojazdu. ” , w ust. 5 skreśla się wyrazy „pozwolenie czasowe i”, dodaje się ust. 6 w brzmieniu: „
...
- **13)** w art. 75: w ust. 1 wyraz „starosta” zastępuje się wyrazami „organ rejestrujący”, w ust. 2 w zdaniu pierwszym skreśla się wyrazy „i nalepka kontrolna”;
    - **a)**
    - **b)**
...
- **1)** zasady współpracy w zakresie: określenia charakteru i zakresu zmian dostosowujących system teleinformatyczny, o którym mowa w ust. 1, do zmian w systemie teleinformatycznym obsługującym centralną ewidencję pojazdów, udostępniania ministrowi właściwemu do spraw informatyzacji informacji i doświadczenia technicznego, w tym dokumentacji, dotyczących systemu teleinformatycznego, o którym mowa w ust. 1, niezbędnych ministrowi do sprawowania nadzoru, o którym mowa w ust. 4;
    - **a)**
    - **b)**
...
- **18)** w art. 78: w ust. 1 po wyrazach „dowód rejestracyjny” dodaje się wyrazy „oraz zaświadczenie o przeprowadzonym badaniu technicznym pojazdu, jeżeli w dowodzie rejestracyjnym nie jest określony aktualny termin ważności badania technicznego”, w ust. 1 i 1a skreśla się wyrazy „i kartę pojazdu, jeżeli była wydana”, uchyla się ust. 3;
    - **a)**
    - **b)**
    - **c)**

- **19)** w art. 78a: w ust. 1 wyrazy „któremu powierzono pojazd w trybie przepisu art. 73 ust. 5, starosta” zastępuje się wyrazami „o którym mowa w art. 73 ust. 2 i 5, organ rejestrujący”, w ust. 2 w pkt 4 kropkę zastępuje się średnikiem i dodaje się pkt 5 w brzmieniu: „
    - **a)**
    - **b)**

- **5)** samochody osobowe w związku z koniecznością wykonania naprawy pojazdu wynikającej z uszkodzenia zasadniczych elementów nośnych konstrukcji: w przypadkach, o których mowa w art. 81 ust. 11 pkt 1 lit. b oraz pkt 6, w przypadku wystąpienia szkody istotnej. ” , w ust. 3 wyrazy „któremu powierzono pojazd w trybie przepisu art. 73 ust. 5” zastępuje się wyrazami „o którym mowa w art. 73 ust. 2 i 5”, w ust. 4 w zdaniu pierwszym po wyrazie „Pojazd” dodaje się wyrazy „, o którym mowa w ust. 2 pkt 1–4,”, po ust. 4 dodaje się ust. 4a-4c w brzmieniu: „
    - **a)**
    - **b)**
    - **c)**
    - **d)**
...
4c. Warunkiem dopuszczenia samochodu osobowego do ruchu po jego czasowym wycofaniu jest wykonanie dodatkowego badania technicznego pojazdu potwierdzone w centralnej ewidencji pojazdów. W przypadku braku w centralnej ewidencji pojazdów informacji o dodatkowym badaniu technicznym dopuszczenie do ruchu następuje na podstawie przedłożonego zaświadczenia o przeprowadzonym dodatkowym badaniu technicznym pojazdu. ” , w ust. 5 w zdaniu pierwszym wyrazy „któremu powierzono pojazd w trybie przepisu art. 73 ust. 5” zastępuje się wyrazami „o którym mowa w art. 73 ust. 2 i 5”;

- **f)**
- **20)** w art. 78b: w pkt 1 skreśla się wyrazy „i nalepki kontrolnej”, uchyla się pkt 2;
    - **a)**
    - **b)**

- **21)** w art. 79: po ust. 1 dodaje się ust. 1a w brzmieniu: „
    - **a)**

1a. W przypadku, o którym mowa w ust. 1 pkt 3, pojazd podlega wyrejestrowaniu na wniosek właściciela pojazdu będącego zbywcą albo nabywcą pojazdu wywożonego za granicę. ” , ust. 3 otrzymuje brzmienie: „

- **b)**

3. Organ rejestrujący dokonuje wyrejestrowania pojazdu z urzędu na podstawie informacji otrzymanej od administratora danych i informacji zgromadzonych w centralnej ewidencji pojazdów o przekazaniu przez stację demontażu lub punkt zbierania pojazdów danych, o których mowa w art. 80b ust. 1 pkt 16, niezwłocznie po dniu otrzymania tej informacji, jeżeli do tego dnia właściciel pojazdu nie złożył wniosku o wyrejestrowanie pojazdu na podstawie ust. 1 pkt 1 albo 6. ” , po ust. 3a dodaje się ust. 3b w brzmieniu: „
...
- **23)** w art. 80 w zdaniu pierwszym: skreśla się wyrazy „art. 77 ust. 3, art. 78 ust. 3,”, po wyrazach: – „art. 74 ust. 1,” dodaje się wyrazy „art. 74a ust. 1,”, – „art. 78 ust. 3” dodaje się wyrazy „, art. 78a ust. 1, art. 79 ust. 1”;
    - **a)**
    - **b)**

- **24)** w art. 80b: w ust. 1: – w pkt 6 uchyla się lit. a-d, – w pkt 8 w lit. b skreśla się przecinek i uchyla się lit. c, – w pkt 9 skreśla się wyrazy „, o nalepkach kontrolnych,”, – w pkt 22 kropkę zastępuje się średnikiem i dodaje się pkt 23 w brzmieniu: „ 23) o przekroczeniach terminów, o których mowa w art. 71 ust. 7 i art. 78 ust. 2 pkt 1. ” , w ust. 2 wyrazy „i 20–22” zastępuje się wyrazami „i 20–23”;
    - **a)**
    - **b)**

- **25)** w art. 80ba: w ust. 1: – w pkt 1 wyrazy „i 20” zastępuje się wyrazami „, 20 i 23”, – pkt 9 otrzymuje brzmienie: „ 9) przez stację demontażu lub punkty zbierania pojazdów – z wyłączeniem pojazdów, o których mowa w art. 73 ust. 3 – w zakresie danych, o których mowa w art. 80b ust. 1 pkt 16. ” , w ust. 1a wyrazy „i 20–22” zastępuje się wyrazami „i 20–23”;
    - **a)**
    - **b)**
...
- **27)** w art. 80cb w ust. 1 dodaje się zdanie drugie w brzmieniu: „ Raport z systemu teleinformatycznego potwierdza dane zgromadzone w ewidencji i nie wymaga podpisu ani pieczęci. ” ;
...
- **34)** w art. 129: w ust. 2: – po pkt 1 dodaje się pkt 1a w brzmieniu: „ 1a) ustalenia tożsamości kierującego pojazdem na podstawie danych z Rejestru Dowodów Osobistych; ” , – po pkt 21dodaje się pkt 22 w brzmieniu: „ 22) weryfikacji danych o kierującym pojazdem w centralnej ewidencji kierowców; ” , w ust. 4aa wyrazy „2, 21, 2a” zastępuje się wyrazami „2–2a”;
    - **a)**
    - **b)**

- **35)** w art. 129b w ust. 3: pkt 2 otrzymuje brzmienie: „
    - **a)**

- **2)** sprawdzania dokumentów, o których mowa w art. 38, oraz weryfikacji danych o: pojeździe, w tym danych o dokumentach pojazdu, w centralnej ewidencji pojazdów, kierującym pojazdem w centralnej ewidencji kierowców; ” , w pkt 7 kropkę zastępuje się średnikiem i dodaje się pkt 8 w brzmieniu: „
    - **a)**
    - **b)**
    - **b)**
...
- **37)** w art. 130a: w ust. 1 pkt 6 otrzymuje brzmienie: „
    - **a)**

- **6)** kierowania nim przez osobę nieposiadającą uprawnienia do kierowania pojazdami albo której zatrzymano prawo jazdy i nie ma możliwości zabezpieczenia pojazdu przez przekazanie go osobie znajdującej się w nim i posiadającej uprawnienie do kierowania tym pojazdem; przepisu nie stosuje się, jeżeli kierujący posiada pokwitowanie, o którym mowa w art. 135 ust. 4 lub 5 albo w art. 135a ust. 5 lub 6, upoważniające do kierowania pojazdem. ” , w ust. 2 w pkt 1 w lit. b po wyrazach „przy sobie” dodaje się wyraz „wymaganych”;
    - **b)**

- **38)** w art. 132: po ust. 1a dodaje się ust. 1aa w brzmieniu: „ 1aa. W stosunku do kierującego pojazdem, o którym mowa w art. 73 ust. 3, policjant, funkcjonariusz Straży Granicznej albo funkcjonariusz Służby Celno-Skarbowej zatrzyma dowód rejestracyjny (pozwolenie czasowe) w przypadkach, o których mowa w ust. 1a pkt 1–5 i 7. ” , ust. 1c otrzymuje brzmienie: „
    - **a)**
    - **b)**

1c. Zatrzymanie, o którym mowa w ust. 1a i 1aa, następuje przez zatrzymanie okazanego dokumentu. ” , po ust. 5 dodaje się ust. 5a w brzmieniu: „

- **c)**

5a. Zatrzymany dokument pojazdu, o którym mowa w art. 73 ust. 3, jest przesyłany niezwłocznie organowi, który go wydał. Zwrot zatrzymanego dokumentu następuje niezwłocznie po ustaniu przyczyny uzasadniającej jego zatrzymanie. ” , w ust. 6 po wyrazach „tej przyczyny” dodaje się wyrazy „oraz okazaniu pokwitowania, o którym mowa w art. 38 ust. 1 pkt 4b lit. b,”, po ust. 6 dodaje się ust. 6a w brzmieniu: „
...
- **39)** w art. 132a: w ust. 1 skreśla się wyrazy „oraz ust. 8”, ust. 4 otrzymuje brzmienie: „
    - **a)**
    - **b)**
...
- **44)** w art. 139: w ust. 1 wyrazy „art. 135–137” zastępuje się wyrazami „art. 135 i art. 135b-137 dotyczące wydanego w kraju prawa jazdy”, w ust. 2 wyrazy „art. 135” zastępuje się wyrazami „art. 135–135b”, w ust. 3 i 4 wyrazy „art. 135 ust. 1 i art. 136 ust. 1” zastępuje się wyrazami „art. 135 ust. 1, art. 135a ust. 1, art. 135b, art. 136 ust. 1 i 2 oraz art. 137 ust. 6 pkt 1”.
    - **a)**
    - **b)**
    - **c)**

**Art. 2.** W ustawie z dnia 20 maja 1971 r. – Kodeks wykroczeń (Dz. U. z 2019 r. poz. 821 i 1238 oraz z 2020 r. poz. 568, 956 i 1086) w art. 29 w § 3 skreśla się zdanie drugie i trzecie.

**Art. 3.** W ustawie z dnia 6 czerwca 1997 r. – Kodeks karny (Dz. U. z 2020 r. poz. 1444) w art. 43 uchyla się § 3.
...
- **1)** unieważnienia dowodu rejestracyjnego i zwrotu unieważnionego dowodu rejestracyjnego właścicielowi pojazdu; ” , w ust. 1a wyrazy „ust. 1, w zakresie tablic rejestracyjnych” zastępuje się wyrazami „ust. 1b”, po ust. 1a dodaje się ust. 1b w brzmieniu: „
    - **b)**
    - **c)**

1b. Przedsiębiorca prowadzący stację demontażu dokonuje zniszczenia tablic rejestracyjnych przyjętego pojazdu wycofanego z eksploatacji i zagospodarowuje je zgodnie z przepisami o odpadach. ” , ust. 2 i 3 otrzymują brzmienie: „
...
**Art. 7.** W ustawie z dnia 6 sierpnia 2010 r. o dowodach osobistych (Dz. U. z 2020 r. poz. 332, 695 i 875) w art. 66 w ust. 3 w pkt 14 kropkę zastępuje się średnikiem i dodaje się pkt 15 w brzmieniu: „
...
- **1)** zasady współpracy w zakresie: określenia charakteru i zakresu zmian dostosowujących system teleinformatyczny, o którym mowa w ust. 1, do zmian w systemie teleinformatycznym obsługującym centralną ewidencję kierowców, udostępniania ministrowi właściwemu do spraw informatyzacji informacji i doświadczenia technicznego, w tym dokumentacji, dotyczących systemu teleinformatycznego, o którym mowa w ust. 1, niezbędnych ministrowi do sprawowania nadzoru, o którym mowa w ust. 4;
    - **a)**
    - **b)**
...
- **3)** w art. 102: w ust. 1 pkt 1 otrzymuje brzmienie: „
    - **a)**

- **1)** upłynął termin ważności prawa jazdy lub pozwolenia na kierowanie tramwajem – jeżeli organ kontroli ruchu drogowego przekazał informację o zatrzymaniu dokumentu; ” , ust. 1c otrzymuje brzmienie: „
    - **b)**

