...
- **4)** w § 98:
    ...
    - **b)** po ust. 4 dodaje się ust. 4a w brzmieniu: „4a. Peronów nie lokalizuje się przy torach, po których ruch pociągów odbywa się z prędkością większą niż 200 km/h, z wyjątkiem przypadków, gdzie zastosowano środki techniczno-eksploatacyjne zapewniające dostęp z peronu do pociągu tylko w przypadku jego zatrzymania.”,
    - **c)** w ust. 11 wprowadzenie do wyliczenia otrzymuje brzmienie: „Strefę zagrożenia w rozumieniu technicznych specyfikacji interoperacyjności, o których mowa w ust. 1, wyznacza się w formie przyległego do krawędzi peronu pasa o stałej szerokości zapewniającej dostęp do pociągu, która powinna wynosić nie mniej niż:”.
