---
title: Ustawa z dnia 23 lipca 1999 r. o zmianie ustawy o zrekompensowaniu okresowego niepodwyższania płac w sferze budżetowej oraz utraty niektórych wzrostów lub dodatków do emerytur i rent.
address: WDU19990720801
eli: DU/1999/801
publisher: DU
year: 1999
pos: 801
...
| Pole | Wartość |
|---|---|
| Adres publikacyjny | Dz.U. 1999 nr 72 poz. 801 |
| ISAP | WDU19990720801 |
| Typ aktu | Ustawa |
| Status | akt objęty tekstem jednolitym |
| W mocy | tak |
...
| Wejście w życie | 1999-09-15 |
| Ostatnia zmiana | 2024-03-15 |
| Źródło | [ISAP](https://isap.sejm.gov.pl/isap.nsf/DocDetails.xsp?id=WDU19990720801) · [PDF](https://api.sejm.gov.pl/eli/acts/DU/1999/801/text.pdf) |
...
- **4)** w art. 5: w ust. 1 wyrazy „wartość należnych świadectw rekompensacyjnych” zastępuje się wyrazami „nominalną wartość rekompensaty”, w ust. 3 w zdaniu pierwszym wyrazy „wartości świadectw rekompensacyjnych” zastępuje się wyrazami „nominalnej wartości rekompensaty”;
    - **a)**
    - **b)**
...
- **12)** w art. 17 ust. 2 otrzymuje brzmienie: „

2. W spisie uprawnionych określa się wartość nominalną rekompensaty, jaka przysługuje uprawnionemu. ” ;

- **13)** w art. 18: w ust. 2 wyrazy „o przysługującej liczbie świadectw rekompensacyjnych” zastępuje się wyrazami „o nominalnej wartości rekompensaty”, w ust. 3 wyrazy „właściwej liczby przysługujących mu świadectw rekompensacyjnych” zastępuje się wyrazami „nominalnej wartości rekompensaty”;
    - **a)**
    - **b)**

- **14)** w art. 20: w ust. 1 wyrazy „o łącznej liczbie świadectw rekompensacyjnych” zastępuje się wyrazami „o nominalnej wartości rekompensaty”, w ust. 3 wyrazy „emitentowi świadectw” zastępuje się wyrazami „ministrowi właściwemu do spraw administracji publicznej”, a wyrazy „liczbie świadectw rekompensacyjnych” zastępuje się wyrazami „nominalnej wartości rekompensat”, w ust. 4 wyrazy „emitentowi” zastępuje się wyrazami „ministrowi właściwemu do spraw administracji publicznej”;
    - **a)**
    - **b)**
    - **c)**
...
- **16)** po art. 21 dodaje się art. 21a w brzmieniu: „ Spadkobiercy uprawnionych odbierają rekompensatę w instytucji, o której mowa w art. 21 ust. 2, po uprzednim okazaniu prawomocnego postanowienia o stwierdzeniu nabycia spadku po osobie uprawnionej. ” ;
...
- **18)** art. 23 i 24 otrzymują brzmienie: „
...
- **1)** w ust. 1 skreśla się wyrazy „oraz świadectwami rekompensacyjnymi, jeżeli statuty tych funduszy tak stanowią”;
- **2)** skreśla się ust. 2.
