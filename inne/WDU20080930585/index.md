...
**Art. 1.** W ustawie z dnia 30 kwietnia 2004 r. postępowaniu wsprawach dotyczących publicznej (Dz. U. z2007 r. 59, poz. 404) wprowadza następujące zmiany:
...
2. Podmiot ubiegający opomoc wrolnictwie lub rybołówstwie jest zobowiązany przedstawienia podmiotowi udzielającemu pomocy, wraz z wnioskiem udzielenie pomocy:

- **1)** wszystkich zaświadczeń rolnictwie, jakie otrzymał roku, którym ubiega pomoc, oraz wciągu 2 poprzedzających go lat obrotowych, albo oświadczenia wielkości rolnictwie otrzymanej tym okresie;
- **2)** wszystkich zaświadczeń rybołówstwie, jakie otrzymał roku, którym ubiega pomoc, oraz ciągu 2 poprzedzających go lat, albo oświadczenia wielkości pomocy rybołówstwie otrzymanej tym okresie;
- **3)** oświadczenia wielkości przeznaczeniu publicznej otrzymanej odniesieniu tych samych kosztów kwalifikujących objęcia pomocą, na pokrycie ma być przeznaczona rolnictwie lub rybołówstwie.

3. Prezes Urzędu przedstawia Komisji, na jej wniosek, informacje minimis.
