...
| Źródło | [ELI HTML](https://eli.gov.pl/api/acts/DU/2021/2460/text.html) · [ELI API](https://api.sejm.gov.pl/eli/acts/DU/2021/2460) |

## Spis treści

- [Treść rozporządzenia](#part_1) [Rozdział 1 - Przepisy ogólne](#chpt_1) [Rozdział 2 - Tryb przydzielania opiekunowi psa służbowego](#chpt_2) [Rozdział 3 - Tryb rekrutacji kandydatów na opiekuna psa służbowego wycofanego z użycia](#chpt_3) [Rozdział 4 - Tryb wycofywania z użycia psa służbowego](#chpt_4) [Rozdział 5 - Sposób utrzymania, zakres i sposób zapewnienia zabiegów profilaktycznych oraz sposób transportu psów służbowych oraz psów służbowych wycofanych z użycia](#chpt_5) [Rozdział 6 - Sposób wyżywienia, wysokość normy wyżywienia psa służbowego oraz wysokość normy wyżywienia psa służbowego wycofanego z użycia, w tym maksymalna wysokość normy w przypadku jej podwyższenia oraz wysokość dziennej stawki pieniężnej na wyżywienie zwierzęcia](#chpt_6) [Rozdział 7 - Tryb przyznawania, wypłacania oraz zwrotu ryczałtu na pokrycie kosztów wyżywienia psa służbowego lub psa służbowego wycofanego z użycia](#chpt_7) [Rozdział 8 - Tryb pokrywania kosztów zabiegów profilaktycznych i kosztów leczenia, w tym kosztów lekarstw, psa służbowego lub psa służbowego wycofanego z użycia](#chpt_8) [Rozdział 9 - Sposób sprawowania nadzoru oraz dokumentowania wykonywania czynności związanych z nadzorem nad psami służbowymi oraz psami służbowymi wycofanymi z użycia](#chpt_9) [Rozdział 10 - Tryb odbierania psa służbowego lub psa służbowego wycofanego z użycia opiekunowi lub organizacji społecznej](#chpt_10) [Rozdział 11 - Przepis końcowy](#chpt_11)

- [Załącznik nr 1 - Protokół przydzielenia psa służbowego (wzór)](#part_2)

- [Załącznik nr 2 - Protokół postępowania rekrutacyjnego kandydatów na opiekuna psa służbowego wycofanego z użycia (wzór)](#part_3)

- [Załącznik nr 3 - Protokół wycofania z użycia psa służbowego (wzór)](#part_4)

- [Załącznik nr 4 - Normy wyżywienia psów służbowych oraz psów służbowych wycofanych z użycia](#part_5)

- [Załącznik nr 5 - Notatka służbowa z przeprowadzenia kontroli prawidłowości utrzymania psów służbowych (wzór)](#part_6)

- [Załącznik nr 6 - Notatka służbowa z przeprowadzenia kontroli prawidłowości utrzymania psa służbowego wycofanego z użycia (wzór)](#part_7)

- [Załącznik nr 7 - Protokół odebrania psa służbowego nr ewidencyjny / psa służbowego wycofanego z użycia nr ewidencyjny opiekunowi / organizacji społecznej (wzór)](#part_8)

TOC

## Treść rozporządzenia

Na podstawie art. 245l ustawy z dnia 8 grudnia 2017 r. o Służbie Ochrony Państwa ([Dz. U. z 2021 r. poz. 575](https://api.sejm.gov.pl/eli/acts/DU/2021/575/text.html), [1728](https://api.sejm.gov.pl/eli/acts/DU/2021/1728/text.html) i [2333](https://api.sejm.gov.pl/eli/acts/DU/2021/2333/text.html)) zarządza się, co następuje:
...
powierzenie opieki nad psem służbowym wycofanym z użycia innemu opiekunowi psa służbowego albo innemu funkcjonariuszowi SOP, emerytowanemu funkcjonariuszowi SOP lub funkcjonariuszowi zwolnionemu ze służby w SOP, który ma ustalone prawo do policyjnej renty inwalidzkiej;
...
Psy służbowe oraz psy służbowe wycofane z użycia utrzymuje się w sposób zapewniający warunki określone w przepisach wydanych na podstawie art. 17 ust. 8 ustawy z dnia 21 sierpnia 1997 r. o ochronie zwierząt ([Dz. U. z 2020 r. poz. 638](https://api.sejm.gov.pl/eli/acts/DU/2020/638/text.html) oraz [z 2021 r. poz. 1718](https://api.sejm.gov.pl/eli/acts/DU/2021/1718/text.html) i [1728](https://api.sejm.gov.pl/eli/acts/DU/2021/1728/text.html)).
