...
| Źródło | [ELI HTML](https://eli.gov.pl/api/acts/DU/1949/118/text.html) · [ELI API](https://api.sejm.gov.pl/eli/acts/DU/1949/118) |
...
W razie późniejszego odnalezienia zaginionego rejestru czyni się w nim wzmiankę o założeniu nowego rejestru i składa się go w archiwum.

### Art. 19.

### 1.

Od wniosku o założenie rejestru spółdzielni pobiera się wpis stały w wysokości 300 zł.
...
Centralny Związek Spółdzielczy, centrale spółdzielni i centrale spółdzielczo-państwowe są wolne od wszelkich opłat w postępowaniu przed sądem rejestrowym.
