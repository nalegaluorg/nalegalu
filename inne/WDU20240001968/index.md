...
| Źródło | [ELI HTML](https://eli.gov.pl/api/acts/DU/2024/1968/text.html) · [ELI API](https://api.sejm.gov.pl/eli/acts/DU/2024/1968) |

## Treść rozporządzenia

Na podstawie art. 32 ust. 7 ustawy z dnia 25 czerwca 2010 r. o sporcie ([Dz. U. z 2024 r. poz. 1488](https://api.sejm.gov.pl/eli/acts/DU/2024/1488/text.html)) zarządza się, co następuje:
...
potwierdzenie osiągniętego wyniku sportowego uprawniającego do stypendium, wystawione odpowiednio przez właściwy polski związek sportowy, Polski Komitet Olimpijski lub Polski Komitet Paralimpijski - w przypadku stypendium, o którym mowa w art. 32 ust. 1 ustawy;
...
Wniosek o przyznanie stypendium, o którym mowa w art. 32a ust. 1 oraz art. 32b ust. 1 ustawy, składa się w terminach:
...
Członek kadry narodowej, który uczestniczył we współzawodnictwie sportowym objętym programem igrzysk olimpijskich, igrzysk paralimpijskich lub igrzysk głuchych, może otrzymać stypendium, o którym mowa w art. 32 ust. 1 ustawy, jeżeli:

### 1)

w igrzyskach olimpijskich, igrzyskach paralimpijskich lub igrzyskach głuchych zajął:

### a)

1. miejsce - do wysokości 3,54-krotności podstawy, o której mowa w art. 32 ust. 1b ustawy, zwanej dalej „podstawą”,

### b)

2. miejsce - do wysokości 3,21-krotności podstawy,

### c)

3. miejsce - do wysokości 2,89-krotności podstawy,

### d)

4. miejsce - do wysokości 2,44-krotności podstawy,
...
6. miejsce - do wysokości 1,95-krotności podstawy,

### g)

7. miejsce - do wysokości 1,75-krotności podstawy,

### h)

8. miejsce - do wysokości 1,40-krotności podstawy;
...
1. miejsce - do wysokości 2,37-krotności podstawy,

### b)

2. miejsce - do wysokości 2,13-krotności podstawy,

### c)

3. miejsce - do wysokości 1,89-krotności podstawy,

### d)

4. miejsce - do wysokości 1,61-krotności podstawy,

### e)

5. miejsce - do wysokości 1,48-krotności podstawy,

### f)

6. miejsce - do wysokości 1,36-krotności podstawy,

### g)

7. miejsce - do wysokości 1,23-krotności podstawy,

### h)

8. miejsce - do wysokości 1,11-krotności podstawy;
...
1. miejsce - do wysokości 1,48-krotności podstawy,

### b)

2. miejsce - do wysokości 1,31-krotności podstawy,

### c)

3. miejsce - do wysokości 1,19-krotności podstawy,

### d)

4. miejsce - do wysokości 1,11-krotności podstawy,

### e)

5. miejsce - do wysokości 0,92-krotności podstawy,

### f)

6. miejsce - do wysokości 0,80-krotności podstawy,

### g)

7. miejsce - do wysokości 0,62-krotności podstawy,

### h)

8. miejsce - do wysokości 0,49-krotności podstawy;

### 4)

uzyskał kwalifikację olimpijską, paralimpijską lub kwalifikację do igrzysk głuchych:

### a)

przy kwalifikacji imiennej - do wysokości 1,06-krotności podstawy,

### b)

przy kwalifikacji dla kraju - stypendium dla zawodników, którzy uzyskali kwalifikację, w kwocie do wysokości 0,59-krotności podstawy;

### 5)

w mistrzostwach świata w kategorii młodzieżowców zajął:

### a)

1. miejsce - do wysokości 1,06-krotności podstawy,

### b)

2. miejsce - do wysokości 0,83-krotności podstawy,

### c)

3. miejsce - do wysokości 0,71-krotności podstawy,

### d)

4., 5. lub 6. miejsce - do wysokości 0,49-krotności podstawy;

### 6)

w mistrzostwach Europy w kategorii młodzieżowców zajął:

### a)

1. miejsce - do wysokości 0,77-krotności podstawy,

### b)

2. miejsce - do wysokości 0,59-krotności podstawy,

### c)

3. miejsce - do wysokości 0,47-krotności podstawy,

### d)

4., 5. lub 6. miejsce - do wysokości 0,37-krotności podstawy;

### 7)

w mistrzostwach świata w kategorii juniorów zajął:

### a)

1. miejsce - do wysokości 0,84-krotności podstawy,

### b)

2. miejsce - do wysokości 0,72-krotności podstawy,
...
w mistrzostwach Europy w kategorii juniorów zajął:

### a)

1. miejsce - do wysokości 0,60-krotności podstawy,

### b)

2. miejsce - do wysokości 0,48-krotności podstawy,

### c)

3. miejsce - do wysokości 0,36-krotności podstawy.

### 2.

Członek kadry narodowej, który uczestniczył we współzawodnictwie sportowym nieobjętym programem igrzysk olimpijskich, igrzysk paralimpijskich lub igrzysk głuchych, może otrzymać stypendium, o którym mowa w art. 32 ust. 1 ustawy, jeżeli w:

### 1)

mistrzostwach świata w kategorii seniorów zajął:
...
2. miejsce - do wysokości 0,42-krotności podstawy,
...
mistrzostwach Europy w kategorii seniorów zajął:

### a)

1. miejsce - do wysokości 0,42-krotności podstawy,

### b)

2. miejsce - do wysokości 0,30-krotności podstawy,

### c)

3. miejsce - do wysokości 0,24-krotności podstawy.
...
od 5. do 6. miejsca - jak za zajęcie miejsca 5;

### 2)

od 5. do 8. miejsca - jak za zajęcie miejsca 6;

### 3)

od 7. do 8. miejsca - jak za zajęcie miejsca 7.

### § 7.

### 1.

Stypendium za osiągnięte wyniki sportowe, o których mowa w § 5 ust. 1 pkt 1, przyznaje się za zajęcie:

### 1)

od 1. do 3. miejsca - na okres do 24 miesięcy;

### 2)

od 4. do 8. miejsca - na okres do 18 miesięcy.

### 2.

Stypendium za osiągnięte wyniki sportowe, o których mowa w § 5 ust. 1 pkt 2 i 3, przyznaje się za zajęcie:

### 1)

od 1. do 3. miejsca - na okres do 18 miesięcy;

### 2)

od 4. do 8. miejsca - na okres do 12 miesięcy.
...
Stypendium za osiągnięte wyniki sportowe, o których mowa w § 5 ust. 1 pkt 4, przyznaje się na okres do końca miesiąca, w którym zakończono igrzyska olimpijskie, igrzyska paralimpijskie lub igrzyska głuchych.

### § 8.

### 1.

Wypłaty stypendium, o którym mowa w art. 32 ust. 1 i art. 32a ust. 1 ustawy, dokonuje właściwy polski związek sportowy, Polski Komitet Olimpijski lub Polski Komitet Paralimpijski ze środków przekazywanych na ten cel przez ministra.
...
Po otrzymaniu odpowiednio przez właściwy polski związek sportowy, Polski Komitet Olimpijski, Polski Komitet Paralimpijski lub Instytut Sportu - Państwowy Instytut Badawczy decyzji ministra o przyznaniu stypendium wypłata stypendium następuje do 15. dnia następnego miesiąca.
...
wszczętych i niezakończonych ostateczną decyzją przed dniem wejścia w życie niniejszego rozporządzenia,
...
Traci moc rozporządzenie Ministra Sportu i Turystyki z dnia 17 maja 2022 r. w sprawie stypendiów sportowych ([Dz. U. poz. 1298](https://api.sejm.gov.pl/eli/acts/DU/2022/1298/text.html) oraz [z 2023 r. poz. 2648](https://api.sejm.gov.pl/eli/acts/DU/2023/2648/text.html)).
