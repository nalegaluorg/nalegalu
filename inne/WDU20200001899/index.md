...
2. Po uzgodnieniu podmioty, o których mowa w ust. 1, składają wnioski do ministra właściwego do spraw administracji publicznej o włączenie swoich numerów telefonicznych do systemu. ” , ust. 4 otrzymuje brzmienie: „
...
- **5)** w art. 6: ust. 3 otrzymuje brzmienie: „
    - **a)**
...
- **3)** uwarunkowania lokalowe i techniczne funkcjonowania systemu na obszarze województwa. ” , dodaje się ust. 4 w brzmieniu: „
    - **b)**

4. Wojewoda informuje ministra właściwego do spraw administracji publicznej o utworzeniu oddziału centrum. ” ;

- **6)** w art. 8 w ust. 1: w pkt 1 lit. d i e otrzymują brzmienie: „ przekazanie, gdy zachodzi taka potrzeba, zgromadzonych danych drogą elektroniczną z wykorzystaniem systemu teleinformatycznego, a w uzasadnionych przypadkach – wraz z przekierowaniem połączenia telefonicznego zgodnie z kwalifikacją zgłoszenia do podmiotów ratowniczych, wymiana danych o zgłoszeniach alarmowych przetwarzanych w systemie teleinformatycznym, zgodnie z zakresem określonym w przepisach wydanych na podstawie art. 5 ust. 6 oraz art. 13 ust. 3, z podmiotami ratowniczymi lub podmiotami pomocniczymi; ” , w pkt 2 skreśla się wyrazy „, o którym mowa w art. 10,”, pkt 5 otrzymuje brzmienie: „
    - **a)**
    - **d)**
    - **e)**
    - **b)**
...
- **14)** w art. 19: w ust. 1 w pkt 4 kropkę zastępuje się średnikiem i dodaje się pkt 5 w brzmieniu: „
    - **a)**

- **5)** budowa, rozbudowa, utrzymanie i funkcjonowanie KCMSPR. ” , w ust. 2 pkt 2 otrzymuje brzmienie: „
    - **b)**

- **2)** podłączenie do sieci teleinformatycznej na potrzeby obsługi numerów alarmowych Policji, Państwowej Straży Pożarnej, dyspozytorni medycznej, dysponentów zespołów ratownictwa medycznego oraz podmiotów udostępniających informacje, dane lub usługi, o których mowa w art. 14; ” , ust. 3 otrzymuje brzmienie: „
    - **c)**
...
- **1)** starszego operatora numerów alarmowych, jeżeli: obsługiwała zgłoszenia alarmowe przez okres nie krótszy niż 2 lata przed dniem wejścia w życie niniejszej ustawy, uzyskała pozytywną opinię kierownika centrum powiadamiania ratunkowego lub jego zastępcy, na podstawie karty oceny pracy uzyskała wynik co najmniej 80%;
    - **a)**
    - **b)**
    - **c)**
...
- **3)** koordynatora-trenera, jeżeli spełnia warunek określony w pkt 1 lit. b oraz: obsługiwała zgłoszenia alarmowe przez okres nie krótszy niż 3 lata przed dniem wejścia w życie niniejszej ustawy, na podstawie karty oceny pracy uzyskała wynik co najmniej 90%, uczestniczyła w charakterze wykładowcy lub instruktora w co najmniej 2 szkoleniach.
    - **a)**
    - **b)**
    - **c)**
