...
- **1)** w art. 4: po pkt 34 dodaje się pkt 34a w brzmieniu: „
    - **a)**

- **34a)** pośredni certyfikat zgodności podsystemu – dokument wydany przez notyfikowaną jednostkę certyfikującą, potwierdzający, że podsystem na etapie jego projektowania i budowy jest zgodny z zasadniczymi wymaganiami dotyczącymi interoperacyjności kolei; ” , po pkt 35 dodaje się pkt 35a w brzmieniu: „
    - **b)**
...
- **2)** w art. 25a: w ust. 1 w pkt 2 lit. b otrzymuje brzmienie: „ aplikacje telematyczne. ” , w ust. 2 w pkt 2 lit. b otrzymuje brzmienie: „ aplikacje telematyczne. ” ;
    - **a)**
    - **b)**
    - **b)**
    - **b)**

- **3)** w art. 25c: po ust. 1 dodaje się ust. 1a w brzmieniu: „
    - **a)**

1a. Podsystemy mogą podlegać wstępnej ocenie zgodności z zasadniczymi wymaganiami dotyczącymi interoperacyjności kolei, określonymi w przepisach wydanych na podstawie art. 25t, na wniosek producenta podsystemu albo jego upoważnionego przedstawiciela, importera, inwestora, zarządcy infrastruktury lub przewoźnika kolejowego. ” , po ust. 2 dodaje się ust. 2a i 2b w brzmieniu: „
...
- **1)** projektowania;
- **2)** budowy. ” , po ust. 6 dodaje się ust. 6a-6c w brzmieniu: „
    - **c)**
...
6c. W przypadku wydania pośredniego certyfikatu zgodności podsystemu notyfikowana jednostka certyfikująca sprawdza prawidłowość tego certyfikatu pod względem wymagań TSI oraz dokonuje oceny elementów projektu i budowy nieuwzględnionych w tym certyfikacie. ” , ust. 7 otrzymuje brzmienie: „
...
- **3)** pośrednią deklarację weryfikacji zgodności podsystemu – dla podsystemu. ” , ust. 10 otrzymuje brzmienie: „
    - **e)**
