...
6.2. Kataster nieruchomości (ewidencja gruntów i budynków).
nieruchomości a księgami wieczystymi
6.3. Ewidencja sieci uzbrojenia terenu oraz mapa zasadnicza
6.4. Analizy (raporty, oceny) wpływu czynników środowiskowych
6.5. Mapy tematyczne
6.6. Inne źródła informacji o nieruchomościach
7. Gospodarka przestrzenna (6 godz.)
7.1. System planowania i zagospodarowania przestrzennego
7.2. Studium uwarunkowań i kierunków zagospodarowania
...
8.3.6. Ustalanie i aktualizacja opłat z tytułu użytkowania
...
11.3.1. Przypadki, w których przetwarzanie danych
...
5.4.1. Pojęcie dyskontowania, stopy dyskontowej
...
6.2.2. Estymacja parametrów metodą najmniejszych
...
1.1. Definicja rzeczoznawcy majątkowego oraz działalności nieruchomości
1.2. Nadawanie uprawnień zawodowych oraz uznawanie granicami Rzeczypospolitej Polskiej
...
10.2.2. Określenie wartości drzew oraz drzewostanów
...
15.5. Przykłady ekspertyz, opracowań i doradztwa V. SEMINARIUM DYPLOMOWE I EGZAMIN (10 GODZ.)
