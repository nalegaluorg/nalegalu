...
- **2)** minister właściwy do spraw wewnętrznych urzędu lub na wniosek Komendanta Głównego Policji albo Komendanta Głównego Straży Granicznej albo Komendanta Głównego Państwowej Straży Pożarnej albo Komendanta Służby Ochrony Państwa, jeżeli:
    ...
    - **b)** we wspólnej operacji, o której mowa pkt 1, biorą udział funkcjonariusze lub pracownicy więcej niż jednej służby,
    - **c)** wniosek dotyczy przedłużenia pobytu lub zwiększenia liczby funkcjonariuszy lub pracowników, o których mowa pkt 1,
    - **d)** przewidywany okres pobytu zagranicznych funkcjonariuszy lub pracowników państw niebędących członkami UE lub państw niestosujących dorobku Schengen, uczestniczących we wspólnym działaniu ratowniczym, nie przekracza 90 dni od dnia wjazdu na terytorium Rzeczypospolitej Polskiej, a ich liczba nie przekracza 20 osób,
    - **e)** we wspólnej operacji, o której mowa pkt 1, po polskiej stronie biorą udział wyłącznie funkcjonariusze lub pracownicy Służby Ochrony Państwa,
...
- **3)** Rada Ministrów, na wniosek ministra właściwego do spraw wewnętrznych, jeżeli:
    ...
    - **b)** wniosek dotyczy przedłużenia pobytu lub zwiększenia liczby funkcjonariuszy lub pracowników, o których mowa pkt 2 lit. d zwani dalej „organem wnioskującym”.
...
1. W przypadku pozytywnego rozpatrzenia wniosku przez organ państwa wysyłającego organ wnioskujący dokonuje organem państwa wysyłającego ustaleń dotyczących wspólnej operacji lub wspólnego działania ratowniczego i sporządza wykaz ustaleń, zwany dalej „wykazem”.

2. W wykazie określa się szczególności:
...
- **16)** liczbę i rodzaj sprzętu niezbędnego do przeprowadzenia wspólnej operacji lub wspólnego działania ratowniczego, tym służbowych środków transportowych, środków łączności, środków obserwacji technicznej, środków leczniczych oraz zwierząt;
...
- **19)** język lub języki komunikowania się zagranicznych funkcjonariuszy lub pracowników polskimi funkcjonariuszami lub pracownikami;
...
1. Wspólną operację lub wspólne działanie ratownicze koordynuje właściwy miejscowo komendant wojewódzki Policji albo komendant oddziału Straży Granicznej albo komendant wojewódzki Państwowej Straży Pożarnej albo osoba wskazana przez Komendanta Służby Ochrony Państwa albo osoba wyznaczona przez Komendanta Głównego Policji albo Komendanta Głównego Straży Granicznej albo Komendanta Głównego Państwowej Straży Pożarnej zależności od rodzaju służby, której funkcjonariusze lub pracownicy biorą udział we wspólnej operacji lub wspólnym działaniu ratowniczym.
...
1. Nadzór nad wspólną operacją lub wspólnym działaniem ratowniczym sprawuje Komendant Główny Policji albo Komendant Główny Straży Granicznej albo Komendant Główny Państwowej Straży Pożarnej albo Komendant Służby Ochrony Państwa zależności od rodzaju służby, której funkcjonariusze lub pracownicy biorą udział we wspólnej operacji lub wspólnym działaniu ratowniczym.
...
**Art. 8.** Zagraniczni funkcjonariusze lub pracownicy biorący udział we wspólnej operacji lub wspólnym działaniu ratowniczym korzystają ochrony prawnej przewidzianej dla funkcjonariuszy publicznych.
...
- **1)** noszenia munduru służbowego;
- **2)** posiadania i użycia sprzętu, o którym mowa art. 5 ust. 2 pkt 16;
- **3)** korzystania dróg, gruntów i zbiorników wodnych państwowych, komunalnych i prywatnych oraz komunalnych i prywatnych ujęć wodnych i środków gaśniczych zakresie niezbędnym do prowadzenia wspólnego działania ratowniczego.

2. Uprawnienia, o których mowa ust. 1 pkt 2 i 3, przysługują również zagranicznym pracownikom biorącym udział we wspólnym działaniu ratowniczym.
...
- **2)** Funkcjonariusze lub pracownicy Policji, Straży Granicznej, Państwowej Straży Pożarnej oraz Służby Ochrony Państwa mogą użyczać zagranicznym funkcjonariuszom lub pracownikom sprzętu niezbędnego do przeprowadzenia wspólnej operacji lub wspólnego działania ratowniczego.
