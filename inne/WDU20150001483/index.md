...
| Pole | Wartość |
|---|---|
| Adres publikacyjny | Dz.U. 2015 poz. 1483 |
| ISAP | WDU20150001483 |
...
**Art. 1.** Ustawa określa podstawowe cele i zasady normalizacji oraz jej organizację i finansowanie.

**Art. 2.** Ilekroć ustawie jest mowa o:

#### Rozdział 2 Cele i zasady normalizacji krajowej

**Art. 3.** Normalizacja krajowa prowadzona jest celu:
...
1. Polska Norma jest normą krajową, przyjętą drodze konsensu i zatwierdzoną przez krajową jednostkę normalizacyjną, powszechnie dostępną, oznaczoną na zasadzie wyłączności symbolem PN.

2. Polska Norma może być wprowadzeniem normy europejskiej lub międzynarodowej. Wprowadzenie to może nastąpić języku oryginału.
...
4. Organizację, zakres i sposób działania PKN określa statut nadany przez Prezesa Rady Ministrów drodze zarządzenia.
...
- **1)** PKN jest państwową jednostką budżetową.
...
- **2)** 1. Prezes Rady Ministrów powołuje Prezesa spośród osób wyłonionych drodze otwartego i konkurencyjnego naboru. Prezes Rady Ministrów odwołuje Prezesa.

2. Prezes Rady Ministrów powołuje 2 zastępców Prezesa, spośród osób wyłonionych drodze otwartego i konkurencyjnego naboru, na wniosek Prezesa. Prezes Rady Ministrów odwołuje zastępców Prezesa.
...
8. Członek zespołu oraz osoba, o której mowa ust. 7, mają obowiązek zachowania tajemnicy informacji dotyczących osób ubiegających się o stanowisko, uzyskanych trakcie naboru.
...
11. Wynik naboru ogłasza się niezwłocznie przez umieszczenie informacji biuletynach informacji publicznej, o których mowa ust. 4. Informacja o wyniku naboru zawiera:
...
12. Umieszczenie Biuletynie Informacji Publicznej Kancelarii Prezesa Rady Ministrów ogłoszenia o naborze oraz o wyniku tego naboru jest bezpłatne.

13. Zespół przeprowadzający nabór na stanowiska, o których mowa ust. 2, powołuje Prezes.

14. Do sposobu przeprowadzania naboru na stanowiska, o których mowa ust. 2, stosuje się odpowiednio ust. 3–12.
...
- **4)** Informacje o kandydatach, którzy zgłosili się do naboru, stanowią informację publiczną zakresie objętym wymaganiami określonymi ogłoszeniu o naborze.

**Art. 17c.**

- **4)** Termin do składania dokumentów, określony ogłoszeniu o naborze, nie może być krótszy niż 14 dni od dnia opublikowania tego ogłoszenia Biuletynie Informacji Publicznej.

**Art. 17d.**

- **4)** 1. Po upływie terminu do składania dokumentów określonego ogłoszeniu o naborze niezwłocznie upowszechnia się listę kandydatów, którzy spełniają wymagania formalne określone ogłoszeniu o naborze, przez umieszczenie jej miejscu powszechnie dostępnym jednostce organizacyjnej, której jest prowadzony nabór, a także przez opublikowanie jej Biuletynie Informacji Publicznej.
...
- **4)** 1. Sporządza się protokół przeprowadzonego naboru kandydatów do zatrudnienia na wolne stanowiska pracy PKN.
...
- **4)** 1. Informację o wyniku naboru upowszechnia się terminie 14 dni od dnia zatrudnienia wybranego kandydata albo zakończenia naboru, przypadku gdy jego wyniku nie doszło do zatrudnienia żadnego kandydata.
...
- **4)** Jeżeli stosunek pracy osoby wyłonionej drodze naboru ustał ciągu 3 miesięcy od dnia nawiązania stosunku pracy, można zatrudnić na tym samym stanowisku kolejną osobę spośród najlepszych kandydatów wymienionych protokole tego naboru. Przepisy art. 17f stosuje się odpowiednio.
...
- **4)** projektów dokumentów normalizacyjnych, których opracowywaniu uczestniczy PKN, na zasadach określonych przepisach wewnętrznych PKN.

5. (uchylony)

**Art. 19.**

1. W skład Rady wchodzą, liczbie nie więcej niż po 5 osób, przedstawiciele:
...
2. Prezes Rady Ministrów wskazuje organy administracji rządowej, które ze względu na zakres ich działania powinny być reprezentowane Radzie.
...
3. W skład komisji nie może zostać powołana osoba pozostająca wobec Prezesa PKN takim stosunku prawnym lub faktycznym, który może budzić uzasadnione wątpliwości co do jej bezstronności.
...
5. Prowadzenie sekretariatów, o których mowa ust. 4, PKN może powierzać drodze umowy innym jednostkom organizacyjnym, na koszt tych jednostek.

6. W umowach, o których mowa ust. 5, ustala się szczegółowe zasady i warunki prowadzenia sekretariatów komitetów technicznych. Umowy te mogą być również zawierane na realizację określonych celów, wymienionych art. 3.
