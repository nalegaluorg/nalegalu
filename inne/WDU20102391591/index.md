...
3) ochrony prawnej odmian roślin zasadach określonych ustawie dnia 26 czerwca 2003 o nasiennictwie (Dz. 2007 41, 271, późn. zm.
b) opisy botaniczne odmian wpisanych rejestru odmian,
c) l isty odmian rolniczych, warzywnych sadowniczych wpisanych rejestru odmian,
d) listy opisowe odmian, których umieszcza się informacje o plonach, cechach jakościowych użytkowych odmian,
e) nformacje o wynikach porejestrowego doświadczalnictwa odmianowego;
2) współpracuje z:
a) agranicznymi jednostkami odpowiedzialnymi za rejestrację odmian ochronę prawną odmian,
b) Międzynarodowym Związkiem Ochrony Nowych Odmian Roślin (UPOV), Komisją Europejską Wspólnotowym Urzędem Odmian Roślin (CPVO);
3) nformuje Komisję Europejską państwa członkowskie o wszystkich sprawach związanych rejestracją odmian.
...
2) określenie stanowiska, które był prowadzony nabór liczbę kandydatów;
3) imiona, nazwiska adresy nie więcej niż 3 najlepszych kandydatów uszeregowanych według poziomu spełniania przez nich wymagań określonych ogłoszeniu o naborze;
...
kowi statut, którym określa:
2. Fundusz statutowy Ośrodka stano1) organizację wewnętrzną centrali, wi równowartość mienia przekazanego Centralnemu Ośrodkowi dzień rozpoczęcia działalności.
2) siedziby organizację oddziałów terenowych,
3. Fundusz rezerwowy tworzy się zysku netto
3) kompetencje przeznacza pokrycie ewentualnych strat netto.
...
d) innych przychodów;
4. Nieruchomości stanowiące własność Skarbu
2) budżetu państwa formie dotacji: Państwa, będące trwałym zarządzie
...
#### Rozdział 3 2. Zbycie nieruchomości Ośrodka wymaga zgody ministra właściwego spraw rolnictwa Gospodarka finansowa Ośrodka ministra właściwego spraw Skarbu Państwa.
