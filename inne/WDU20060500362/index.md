...
- **2)** w art. 31 ust. 1 otrzymuje brzmienie: „1. Osoba fizyczna lub jednostka organizacyjna, która zamierza realizować:
...
- **3)** w art. 38 po ust. 4 dodaje się ust. 4a i 4b w brzmieniu: „4a. Wojewódzki konserwator zabytków może wystąpić z wnioskiem do właściwego miejscowo komendanta Policji o jej pomoc, jeżeli jest to niezb ędne do przeprowadzenia czynności kontrolnych.
...
- **9)** w art. 64 w ust. 1:
    - **a)** pkt 3-9 otrzymują brzmienie: „3) wykonanych ręcznie dowolną techniką i na dowolnym materiale dzieł malarstwa, nieobjętych kategoriami wskazanymi w pkt 4 i 5, które mają więcej niż 50 lat, ich wartość jest wyższa niż 150 000 euro oraz nie są własnością ich twórców;
...
- **10)** po art. 109 dodaje się art. 109a i 109b w brzmieniu: „Art. 109a. Kto podrabia lub przerabia zabytek w celu użycia go w obrocie zabytkami, podlega grzywnie, karze ograniczenia wolności albo pozbawienia wolności do lat 2.
