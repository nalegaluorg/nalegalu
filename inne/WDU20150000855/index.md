...
| Źródło | [ELI HTML](https://eli.gov.pl/api/acts/DU/2015/855/text.html) · [ELI API](https://api.sejm.gov.pl/eli/acts/DU/2015/855) |

## Treść ustawy

### Art. 1.

W ustawie z dnia 29 czerwca 1995 r. o statystyce publicznej ([Dz. U. z 2012 r. poz. 591](https://api.sejm.gov.pl/eli/acts/DU/2012/591/text.html), z późn. zm.[2) Zmiany tekstu jednolitego wymienionej ustawy zostały ogłoszone w Dz. U. z 2013 r. poz. 2 oraz z 2014 r. poz. 1161 i 1662.](#gloss-0:2:)) wprowadza się następujące zmiany:
...
rejestry urzędowe - rejestry publiczne w rozumieniu ustawy z dnia 17 lutego 2005 r. o informatyzacji działalności podmiotów realizujących zadania publiczne ([Dz. U. z 2014 r. poz. 1114](https://api.sejm.gov.pl/eli/acts/DU/2014/1114/text.html)) oraz inne rejestry i ewidencje prowadzone na podstawie ustaw lub wydanych na ich podstawie aktów wykonawczych, zawierające informacje o podmiotach gospodarki narodowej i ich działalności, informacje o osobach fizycznych, ich życiu i sytuacji oraz dotyczące zjawisk, zdarzeń i obiektów;
...
dane są zbierane ze wszystkich dostępnych źródeł określonych w ustawie i wydanych na jej podstawie aktach wykonawczych albo w odrębnych ustawach;

### 2)

są gromadzone dane statystyczne od podmiotów gospodarki narodowej i o tych podmiotach oraz ich działalności, a także dane statystyczne od osób fizycznych i o tych osobach, ich życiu i sytuacji, oraz dane statystyczne dotyczące zjawisk, zdarzeń i obiektów.
...
W ramach prowadzonych badań statystycznych dane od respondentów są zbierane metodą obserwacji pełnej, w tym w spisach powszechnych, lub metodą obserwacji reprezentacyjnej na wylosowanej lub dobranej celowo próbie danej zbiorowości.
...
w art. 13 ust. 1-5 otrzymują brzmienie:
...
Organy i podmioty, o których mowa w ust. 1, są obowiązane do:
...
Prezes Głównego Urzędu Statystycznego jest uprawniony do zgłaszania organom i podmiotom, o których mowa w ust. 1, wniosków dotyczących zawartości informacyjnej i wymogów jakości danych administracyjnych w celu umożliwienia wykorzystania tych danych na potrzeby statystyki publicznej.
...
w art. 15 w ust. 3 pkt 6 otrzymuje brzmienie:
...
Prezes Głównego Urzędu Statystycznego i Prezes Narodowego Banku Polskiego współdziałają ze sobą, prowadząc badania statystyczne na podstawie niniejszej ustawy, ustawy z dnia 29 sierpnia 1997 r. o Narodowym Banku Polskim (Dz. U. z 2013 r. poz. 908 i 1036 oraz z 2015 r. poz. 855) oraz ustawy z dnia 27 lipca 2002 r. - Prawo dewizowe ([Dz. U. z 2012 r. poz. 826](https://api.sejm.gov.pl/eli/acts/DU/2012/826/text.html), [z 2013 r. poz. 1036](https://api.sejm.gov.pl/eli/acts/DU/2013/1036/text.html) oraz [z 2015 r. poz. 855](https://api.sejm.gov.pl/eli/acts/DU/2015/855/text.html)).
...
Służby statystyki publicznej stanowią Prezes Głównego Urzędu Statystycznego, podlegli mu dyrektorzy urzędów statystycznych, jednostki przez niego nadzorowane utworzone na podstawie ustawy z dnia 27 sierpnia 2009 r. o finansach publicznych ([Dz. U. z 2013 r. poz. 885](https://api.sejm.gov.pl/eli/acts/DU/2013/885/text.html), z późn. zm.[3) Zmiany tekstu jednolitego wymienionej ustawy zostały ogłoszone w Dz. U. z 2013 r. poz. 938 i 1646, z 2014 r. poz. 379, 911, 1146, 1626 i 1877 oraz z 2015 r. poz. 238 i 532.](#gloss-0:3:)) oraz jednostki, o których mowa w art. 27.
...
Służby statystyki publicznej, realizując dla dobra publicznego zadania określone ustawą, są uprawnione do przetwarzania danych osobowych w rozumieniu ustawy z dnia 29 sierpnia 1997 r. o ochronie danych osobowych ([Dz. U. z 2014 r. poz. 1182](https://api.sejm.gov.pl/eli/acts/DU/2014/1182/text.html) i [1662](https://api.sejm.gov.pl/eli/acts/DU/2014/1662/text.html)) określonych w art. 35b ust. 1.
...
Upoważnia się służby statystyki publicznej do przetwarzania dla celów statystycznych następujących danych osobowych:
...
Dane osobowe, o których mowa w ust. 1, mogą być przetwarzane w ramach badań statystycznych, których celem jest otrzymanie informacji o życiu i sytuacji osób fizycznych lub o wybranych aspektach życia i sytuacji tych osób, obejmujących:
...
gospodarstwa domowe i rodziny, w tym ich skład i relacje;

### 19)

sytuację finansową i zamożność osób oraz gospodarstw domowych i rodzin;
...
szkolnictwo wyższe, w tym nauczycieli akademickich, studentów i doktorantów;
...
Dane, o których mowa w ust. 1, mogą być pozyskiwane bezpośrednio od osoby fizycznej, której dotyczą, lub pełnoletniego domownika albo z systemów informacyjnych administracji publicznej i rejestrów urzędowych.

### 4.

Badania statystyczne, w których osoby fizyczne udzielają bezpośrednio odpowiedzi, są prowadzone po uprzednim ich poinformowaniu o podstawie prawnej badania, celu badania i gwarancjach zachowania tajemnicy statystycznej oraz czy badanie jest prowadzone na zasadzie obowiązku czy dobrowolności.
...
wewnętrznych - z rejestru PESEL i centralnej ewidencji pojazdów,
...
pracy, zabezpieczenia społecznego i rodziny - z systemu monitoringu świadczeń społecznych (pomocy społecznej, wspierania rodziny i pieczy zastępczej, świadczeń z funduszu alimentacyjnego) i elektronicznego krajowego systemu monitoringu orzekania o niepełnosprawności,
...
nauki i szkolnictwa wyższego - ze zintegrowanego systemu informacji o nauce i szkolnictwie wyższym,
...
Zebrane w badaniach statystycznych dane osobowe w zakresie wymienionym w art. 35b ust. 1 pkt 1-5, 10-16 oraz 19-23 służby statystyki publicznej mogą gromadzić i przechowywać w formie operatów do badań statystycznych.

### 2.

Operaty do badań statystycznych, o których mowa w ust. 1, podlegają stałej i bieżącej aktualizacji w celu umożliwienia obserwacji statystycznej określonego zjawiska w czasie i przestrzeni, z zachowaniem szczególnych warunków bezpieczeństwa i bezwzględnej ochrony danych przewidzianej w art. 10.
...
W ustawie z dnia 29 sierpnia 1997 r. o Narodowym Banku Polskim ([Dz. U. z 2013 r. poz. 908](https://api.sejm.gov.pl/eli/acts/DU/2013/908/text.html) i [1036](https://api.sejm.gov.pl/eli/acts/DU/2013/1036/text.html)) w art. 23 wprowadza się następujące zmiany:

### 1)

użyty w ust. 5-8 w tej samej liczbie i przypadku wyraz „indywidualne” zastępuje się użytym w odpowiedniej liczbie i przypadku wyrazem „jednostkowe”;
...
W ustawie z dnia 27 lipca 2002 r. - Prawo dewizowe ([Dz. U. z 2012 r. poz. 826](https://api.sejm.gov.pl/eli/acts/DU/2012/826/text.html) oraz [z 2013 r. poz. 1036](https://api.sejm.gov.pl/eli/acts/DU/2013/1036/text.html)) art. 31 otrzymuje brzmienie:

„

### Art. 31.

Narodowy Bank Polski jest obowiązany do przestrzegania tajemnicy w zakresie danych jednostkowych uzyskanych od banków i rezydentów, w wykonaniu obowiązków określonych w art. 30 ust. 1, na zasadach określonych w art. 23 ust. 5-7 ustawy z dnia 29 sierpnia 1997 r. o Narodowym Banku Polskim ([Dz. U. z 2013 r. poz. 908](https://api.sejm.gov.pl/eli/acts/DU/2013/908/text.html) i [1036](https://api.sejm.gov.pl/eli/acts/DU/2013/1036/text.html) oraz [z 2015 r. poz. 855](https://api.sejm.gov.pl/eli/acts/DU/2015/855/text.html)).

” .

### Art. 4.

W ustawie z dnia 15 kwietnia 2011 r. o systemie informacji oświatowej ([Dz. U. z 2015 r. poz. 45](https://api.sejm.gov.pl/eli/acts/DU/2015/45/text.html) i [357](https://api.sejm.gov.pl/eli/acts/DU/2015/357/text.html)) art. 63 otrzymuje brzmienie:
...
W ustawie z dnia 28 kwietnia 2011 r. o systemie informacji w ochronie zdrowia ([Dz. U. z 2015 r. poz. 636](https://api.sejm.gov.pl/eli/acts/DU/2015/636/text.html) i [788](https://api.sejm.gov.pl/eli/acts/DU/2015/788/text.html)) w art. 23 w ust. 2 pkt 1 otrzymuje brzmienie:

„

### 1)

dane statystyczne, o których mowa w przepisach wydanych na podstawie art. 18 ustawy z dnia 29 czerwca 1995 r. o statystyce publicznej ([Dz. U. z 2012 r. poz. 591](https://api.sejm.gov.pl/eli/acts/DU/2012/591/text.html), z późn. zm.[4) Zmiany tekstu jednolitego wymienionej ustawy zostały ogłoszone w Dz. U. z 2013 r. poz. 2, z 2014 r. poz. 1161 i 1662 oraz z 2015 r. poz. 855.](#gloss-0:4:));
...
Przepisy art. 18 i art. 18a ustawy zmienianej w art. 1 w brzmieniu nadanym niniejszą ustawą stosuje się po raz pierwszy do programu badań statystycznych statystyki publicznej na rok 2018.

### 2.

Format, o którym mowa w art. 18a ust. 2 ustawy zmienianej w art. 1 w brzmieniu nadanym niniejszą ustawą, zostanie udostępniony po raz pierwszy do dnia 31 grudnia 2017 r. odpowiednio na stronie internetowej Głównego Urzędu Statystycznego i na stronie internetowej organu lub podmiotu, o których mowa w art. 20 ust. 2 pkt 1 ustawy zmienianej w art. 1.
