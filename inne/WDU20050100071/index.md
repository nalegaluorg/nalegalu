...
- **4)** w art. 11:
    - **a)** ust. 2 otrzymuje brzmienie:
      ...
      > 1) przypada w okresie ciąży, 2) powstała wskutek poddania się niezbędnym badaniom lekarskim przewidzianym dla kandydatów na dawców komórek, tkanek i narządów oraz zabiegowi pobrania komórek, tkanek i narządów, 3) powstała wskutek wypadku w drodze do pracy lub z pracy.”,  
    - **b)** uchyla się ust. 3;
...
- **6)** art. 19 otrzymuje brzmienie:
  ...
  > 3. Prezes Zakładu Ubezpieczeń Społecznych ogłasza w Dzienniku Urzędowym Rzeczypospolitej Polskiej „Monitor Polski”,  

  w terminie do ostatniego dnia każdego kwartału kalendarzowego, wskaźnik waloryzacji, obliczony według zasad określonych w ust. 2, obowiązujący w następnym kwartale.”;
