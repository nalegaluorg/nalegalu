...
| Pole | Wartość |
|---|---|
| Adres publikacyjny | Dz.U. 2014 poz. 1872 |
| ISAP | WDU20140001872 |
| Typ aktu | Ustawa |
| Status | obowiązujący |
| W mocy | tak |
...
- **1)** po art. 3 dodaje się art. 3a w brzmieniu: „Art. 3a. 1. Do postępowań w sprawach indywidualnych rozstrzyganych w drodze decyzji stosuje się przepisy Kodeksu postępowania administracyjnego, chyba że przepisy ustawy stanowią inaczej.
...
- **2)** po art. 10 dodaje się art. 10a w brzmieniu: „Art. 10a. Właściwy w sprawach dotyczących wpisu do ewidencji producentów i wykreślenia z tej ewidencji jest kierownik biura powiatowego Agencji, właściwy ze względu na miejsce zamieszkania lub siedzibę wnioskodawcy.”;
- **3)** w art. 11 ust. 1 otrzymuje brzmienie: „1. Wpisu producenta do ewidencji producentów dokonuje się, w drodze decyzji administracyjnej, na jego wniosek złożony do kierownika biura powiatowego Agencji właściwego miejscowo, na formularzu opracowanym i udostępnionym przez Agencję.”;
- **4)** w art. 12:
    - **a)** ust. 1 otrzymuje brzmienie: „1. W decyzji, o której mowa w art. 11 ust. 1, producentowi nadaje się numer identyfikacyjny.”,
    - **b)** ust. 4 otrzymuje brzmienie: „4. W przypadku małżonków oraz podmiotów będących współposiadaczami gospodarstwa rolnego nadaje się:
...
- **2)** odrębny numer identyfikacyjny od numeru, o którym mowa w pkt 1, jeżeli wnioskodawca prowadzi samodzielnie odrębne gospodarstwo rolne stanowiące zorganizowaną całość gospodarczą.”,
    - **c)** po ust. 4 dodaje się ust. 4a w brzmieniu: „4a. Wnioskodawcę, o którym mowa w ust. 4 pkt 2, wpisuje się do ewidencji producentów i nadaje mu się odrębny numer identyfikacyjny.”;

- **5)** w art. 13 uchyla się ust. 1–3;
- **6)** art. 17 otrzymuje brzmienie: „Art. 17. Minister właściwy do spraw rozwoju wsi określi, w drodze rozporządzenia, szczegółowe wymagania, jakie powinien spełniać wniosek o wpis do ewidencji producentów, uwzględniając dane, o których mowa w art. 7, oraz biorąc pod uwagę zapewnienie prawidłowego funkcjonowania systemu.”.
