...
| Pole | Wartość |
|---|---|
| Adres publikacyjny | Dz.U. 2009 nr 79 poz. 667 |
| ISAP | WDU20090790667 |
| Typ aktu | Ustawa |
| Status | akt objęty tekstem jednolitym |
| W mocy | tak |
...
1. Za każdego ubezpieczonego opłaca się miesięczną składkę w równej wysokości, z zastrzeżeniem ust. 3. ” , po ust. 2 dodaje się ust. 2a w brzmieniu: „

- **b)**

2a. W przypadku gdy okres podlegania ubezpieczeniu wypadkowemu, chorobowemu i macierzyńskiemu jest krótszy niż miesiąc, wysokość składki oblicza się proporcjonalnie do liczby dni podlegania temu ubezpieczeniu. ” , uchyla się ust. 3a, ust. 4 otrzymuje brzmienie: „
...
1. Składka miesięczna za każdego ubezpieczonego wynosi 10% emerytury podstawowej. ” , dodaje się ust. 3–5 w brzmieniu: „
...
- **2)** podlegał ubezpieczeniu emerytalno-rentowemu przez okres co najmniej 25 lat, z uwzględnieniem art. 20. ” , w ust. 2 pkt 2 otrzymuje brzmienie: „
    - **b)**

- **2)** podlegał ubezpieczeniu emerytalno-rentowemu przez okres co najmniej 30 lat; ” , ust. 3 otrzymuje brzmienie: „
    - **c)**
...
- **9)** w art. 21: ust. 2 otrzymuje brzmienie: „
    - **a)**
...
- **5)** 5 lat – jeżeli całkowita niezdolność do pracy w gospodarstwie rolnym powstała w wieku powyżej 30 lat. ” , ust. 8 otrzymuje brzmienie: „
    - **b)**
