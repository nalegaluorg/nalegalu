...
- **2)** art. 1 otrzymuje brzmienie:
  ...
  > „Art. 1.  
  > 1. Ustawa określa zasady i warunki przygotowania inwestycji w zakresie dróg publicznych w rozumieniu przepisów ustawy z dnia 21 marca 1985 r. o drogach publicznych (Dz. U. z 2004 r. Nr 204, poz. 2086, z późn. zm. ), zwanych dalej „drogami”,  

  w tym warunki lokalizacji i nabywania nieruchomości na ten cel, oraz budowy tych dróg, a także organy właściwe w tych sprawach. 2. W odniesieniu do dróg innych niż zarządzane przez Generalnego Dyrektora Dróg Krajowych i Autostrad uprawnienia, obowiązki i zadania Generalnego Dyrektora Dróg Krajowych i Autostrad wynikające z niniejszej ustawy wykonuje właściwy zarządca drogi.”;
...
- **4)** art. 3 otrzymuje brzmienie:
  ...
  > „Art. 3.  
  > 1. Właściwy zarządca drogi składa wniosek, o którym mowa w art. 2 ust. 1, po uzyskaniu opinii właściwych miejscowo zarządu województwa, zarządu powiatu oraz wójta (burmistrza, prezydenta miasta).  
...
- **8)** w art. 9:
    - **a)** ust. 1 otrzymuje brzmienie:
      ...
      > „1. Od decyzji o ustaleniu lokalizacji drogi stronie służy odwołanie do:  
...
- **12)** w art. 16:
    ...
    - **b)** ust. 2 i 3 otrzymują brzmienie:
      ...
      > „2. Decyzja o ustaleniu lokalizacji drogi określa termin wydania nieruchomości lub opróżnienia lokali i innych pomieszczeń. Termin ten nie może być krótszy niż 30 dni od dnia kiedy decyzja o ustaleniu lokalizacji drogi stała się ostateczna.  
...
4. W przypadku gdy decyzja, o której mowa w ust. 1, dotyczy nieruchomości zabudowanej, właściwy zarządca drogi jest obowiązany, w terminie faktycznego objęcia nieruchomości w posiadanie, do wskazania lokalu zamiennego.
...
- **15)** po art. 18 dodaje się art. 18a w brzmieniu: „Art. 18a. Stronie odwołującej się od decyzji ustalającej wysokość odszkodowania, wypłaca się, na jej wniosek, kwotę określoną w tej decyzji. Wypłata tej kwoty nie ma wpływu na prowadzone postępowanie odwoławcze.”;
- **16)** art. 19:
...
- **21)** art. 29 otrzymuje brzmienie: ,,Art. 29. Jeżeli budowa drogi wymaga wydania pozwolenia wodnoprawnego, odpowiednio wojewoda albo starosta wydają to pozwolenie w terminie nie dłuższym niż 30 dni od dnia złożenia wniosku o jego wydanie.”;
...
- **23)** w art. 32 ust. 1 i 2 otrzymują brzmienie: ,,1. Wojewoda w odniesieniu do dróg krajowych i wojewódzkich albo starosta w odniesieniu do dróg powiatowych i gminnych wydają decyzję o pozwoleniu na użytkowanie drogi na zasadach i w trybie przepisów - Prawa budowlanego, z zastrzeżeniem ust. 2.

2. W przypadku decyzji o pozwoleniu na budowę drogi posiadającej co najmniej dwie jezdnie, przy czym każdą z nich przeznaczoną dla jednego kierunku ruchu, wojewoda w odniesieniu do dróg krajowych i wojewódzkich albo starosta w odniesieniu do dróg powiatowych i gminnych, na wniosek inwestora, wydają decyzję o pozwoleniu na użytkowanie w odniesieniu do jezdni lub jej odcinka, na którym zakończono budowę.”;
...
**Art. 2.** W ustawie z dnia 12 stycznia 1991 r. o podatkach i opłatach lokalnych (Dz. U. z 2006 r. Nr 121, poz. 844) w art. 1b dodaje się ust. 3 w brzmieniu:
...
> 1) Skarbu Państwa oraz przekazanych Generalnej Dyrekcji Dróg Krajowych i Autostrad, 2) właściwych jednostek samorządu terytorialnego - regulują przepisy ustawy z dnia 10 kwietnia 2003 r. o szczególnych zasadach przygotowania i realizacji inwestycji w zakresie dróg publicznych (Dz. U. Nr 80, poz. 721, z późn. zm. ).”.  

**Art. 3.** W ustawie z dnia 21 sierpnia 1997 r. o gospodarce nieruchomościami (Dz.U. z 2004 r. Nr 261, poz. 2603, z późn. zm. ) w art. 129 ust. 5 otrzymuje brzmienie:
...
- **1)** uchyla się art. 24;
- **2)** w art. 48 pkt 1a otrzymuje brzmienie: „1a) art. 17 pkt 2, art. 22, art. 29 i art. 31, które wchodzą w życie z dniem 1 stycznia 2007 r.”.

**Art. 5.**

1. Do spraw wszczętych i niezakończonych do dnia wejścia w życie ustawy decyzją ostateczną stosuje się przepisy dotychczasowe.
...
**Art. 6.** Ustawa wchodzi w życie po upływie 14 dni od dnia ogłoszenia, z wyjątkiem art. 1 pkt 18 i art. 2 niniejszej ustawy, które wchodzą w życie z dniem 1 stycznia 2007 r.
