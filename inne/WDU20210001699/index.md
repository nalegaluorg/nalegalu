...
1) § 2–5 otrzymują brzmienie: „§ 2. 1. Nagrodę za znaczące osiągnięcia w zakresie działalności naukowej, dotyczącej w szczególności bezpieczeństwa obywateli lub ochrony ludności, przyznaje się nauczycielowi akademickiemu uczelni służb państwowych, który w poprzednim roku akademickim:
...
2) § 7 otrzymuje brzmienie: „§ 7. Nagrody są przyznawane w liczbie nie większej niż 6, w tym za:
...
3) w § 8 ust. 1 otrzymuje brzmienie: „1. Wysokość nagrody nie może przekroczyć, w przypadku nagrody za:
...
5) § 13 otrzymuje brzmienie: „§ 13. 1. Oceny wniosku o przyznanie nagrody dokonuje powołany przez ministra Zespół do Spraw Nagród Ministra dla Nauczycieli Akademickich Uczelni Służb Państwowych, zwany dalej „Zespołem”.
...
Minister Spraw Wewnętrznych i Administracji: M. Kamiński WZÓR WNIOSEK O PRZYZNANIE NAGRODY MINISTRA WŁAŚCIWEGO DO SPRAW WEWNĘTRZNYCH DLA NAUCZYCIELA AKADEMICKIEGO UCZELNI SŁUŻB PAŃSTWOWYCH
1. Dane wnioskodawcy: nazwa podmiotu występującego z wnioskiem adres nr telefonu / nr faksu / adres e-mail
2. Rodzaj nagrody :  indywidualna  nagroda za całokształt dorobku  zespołowa za znaczące osiągnięcia w zakresie działalności:  naukowej  dydaktycznej  wdrożeniowej  organizacyjnej
3. Dane kandydata do nagrody : imię (imiona) i nazwisko tytuł zawodowy / stopień naukowy / tytuł naukowy miejsce zatrudnienia zajmowane stanowisko (pełniona funkcja) reprezentowana dziedzina nauki reprezentowana dyscyplina naukowa udział procentowy w uzyskaniu osiągnięcia
4. Szczegółowy opis znaczących osiągnięć kandydata do nagrody :
5. Uzasadnienie :
6. Załączniki:
1) ………….;
2) ………….;
