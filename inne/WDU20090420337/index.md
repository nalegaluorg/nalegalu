...
- **1)** w art. 3 w ust. 2: dodaje się pkt 2a i 2b w brzmieniu: „
    - **a)**

- **2a)** wskazanie organu odpowiedzialnego za opracowanie projektu założeń projektu ustawy;
- **2b)** imię i nazwisko oraz stanowisko lub funkcję osoby odpowiedzialnej za opracowanie projektu założeń projektu ustawy; ” , dodaje się pkt 4a w brzmieniu: „
    - **b)**
...
- **2)** w przypadku prac nad projektem rozporządzenia – do organu odpowiedzialnego za opracowanie projektu rozporządzenia. ” , ust. 6 otrzymuje brzmienie: „
    - **b)**
