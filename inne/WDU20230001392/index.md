...
1. Na podstawie art. 16 ust. 1 zdanie pierwsze ustawy dnia 20 lipca 2000 ogłaszaniu aktów normatywnych niektórych innych aktów prawnych (Dz. 2019 1461) ogłasza się załączniku do niniejszego obwieszczenia jednolity tekst ustawy dnia 2 września szczególnym wsparciu podmiotów poszkodowanych związku sytuacją ekologiczną na rzece Odrze (Dz. 2014), uwzględnieniem zmiany wprowadzonej ustawą dnia 28 września zmianie ustawy wyrobie napojów spirytusowych rejestracji ochronie oznaczeń geograficznych napojów spirytusowych niektórych innych ustaw (Dz. 2015) zmian wynikających przepisów ogłoszonych przed dniem 29 czerwca 2023
...
1) prowadził na dzień 31 lipca pozarolniczą działalność oznaczoną według polskiej Klasyfikacji Działalności (PKD) 2007, jako przeważającą;
2) terminie do dnia 31 lipca był zgłoszony jako płatnik składek datą obowiązku opłacania składek nie późniejszą niż 1 lipca r.;
3) związku sytuacją ekologiczną na rzece Odrze, uzyskał przychód działalności rozumieniu przepisów podatkowych miesiącu wskazanym przepisach wydanych na podstawie art. 4 niższy co najmniej 50% stosunku do przychodu uzyskanego jednym dwóch miesięcy poprzedzających ten miesiąc albo analogicznym miesiącu roku poprzedniego;
4) terminie do dnia 31 lipca zgłosił co najmniej jedną osobę do ubezpieczeń emerytalnego rentowych datą powstania ubezpieczeń emerytalnego rentowych nie późniejszą niż 1 lipca co najmniej jedna osoba pozostawała tych ubezpieczeniach na ostatni dzień miesiąca wskazanego przepisach wydanych na podstawie art. 4;
5) terminie do dnia 31 lipca zgłosił do Zakładu Ubezpieczeń Społecznych, zwanego dalej „Zakładem”, co najmniej jeden adres prowadzenia pozarolniczej działalności na obszarze powiatów wskazanych przepisach wydanych na podstawie art. 4, na obszarze których znajdują się gminy, których na dzień 31 lipca była prowadzona pozarolnicza działalność.
2. Oceny spełnienia warunku, którym mowa ust. 1 pkt 1, zakresie oznaczenia prowadzonej jako przeważająca działalności pozarolniczej według Polskiej Klasyfikacji Działalności (PKD) 2007, dokonuje się na podstawie danych zawartych rejestrze REGON brzmieniu na dzień 31 lipca
...
1) imię nazwisko płatnika składek lub nazwę skróconą;
2) numer NIP REGON płatnika składek, a jeżeli nie nadano mu tych numerów lub jednego nich numer PESEL;
3) adres prowadzenia pozarolniczej działalności, którym mowa art. 3 ust. 1 pkt 5;
4) numer rachunku bankowego płatnika składek, którym mowa art. 7 ust. 1;
5) oświadczenie płatnika składek potwierdzające:
a) prowadzenie na dzień 31 lipca pozarolniczej działalności, oznaczonej kodem według Polskiej Klasyfikacji Działalności (PKD) 2007, jako przeważającej,
b) związku sytuacją ekologiczną na rzece Odrze, uzyskanie przychodu działalności rozumieniu przepisów podatkowych, miesiącu wskazanym przepisach wydanych na podstawie art. 4, niższego co najmniej 50% stosunku do przychodu uzyskanego jednym dwóch miesięcy poprzedzających ten miesiąc albo analogicznym miesiącu roku poprzedniego;
6) inne informacje niezbędne do ustalenia prawa do jednorazowego jego wypłaty;
7) podpis wnioskodawcy.
4. Oświadczenia, których mowa ust. 3 pkt 5, płatnik składek składa pod rygorem odpowiedzialności karnej za składanie fałszywych oświadczeń. W oświadczeniu jest zawarta klauzula następującej treści: „Jestem świadomy odpowiedzialności karnej za złożenie fałszywego oświadczenia”. Klauzula ta zastępuje pouczenie organu odpowiedzialności karnej za składanie fałszywych oświadczeń.
7. 1. Zakład wypłaca jednorazowe świadczenie niezwłocznie po wyjaśnieniu ostatniej okoliczności mającej wpływ na prawo do jego wysokość, na rachunek bankowy zewidencjonowany na koncie płatnika składek.
...
10. 1. Płatnik składek, który pobrał nienależnie jednorazowe świadczenie, jest obowiązany do jego zwrotu wraz odsetkami ustawowymi za opóźnienie, wysokości na zasadach określonych przepisami prawa cywilnego.
2. Zakład zobowiązuje płatnika składek do zwrotu nienależnie pobranego jednorazowego ustala kwotę nienależnie pobranego jednorazowego drodze decyzji.
...
4. Odsetki, których mowa ust. 1, są naliczane od pierwszego dnia miesiąca następującego po dniu wypłaty jednorazowego do dnia zwrotu.
5. Jeżeli wypłaty jednorazowego dokonano innemu płatnikowi składek niż uprawniony lub kwocie wyższej niż należna przyczyn leżących po stronie Zakładu, nie nalicza się odsetek, których mowa ust. 1.
6. Decyzji zobowiązującej do zwrotu nienależnie pobranego jednorazowego nie wydaje się później niż terminie 5 lat od dnia, którym wypłacono nienależne jednorazowe świadczenie.
7. Kwota nienależnie pobranego jednorazowego ustalona prawomocną decyzją kwoty odsetek kosztów upomnienia ulegają przedawnieniu upływem 3 lat od dnia, którym decyzja ustaleniu zwrocie nienależnie pobranego jednorazowego stała się prawomocna.
8. Kwota nienależnie pobranego jednorazowego ustalona prawomocną decyzją kwoty odsetek kosztów upomnienia podlegają potrąceniu wypłacanych świadczeń ubezpieczeń społecznych, a jeżeli prawo do świadczeń nie istnieje ściągnięciu trybie przepisów postępowaniu egzekucyjnym administracji.
9. Kwoty nienależnie pobranego jednorazowego podlegają zwrotowi łącznie odsetkami, których mowa ust. 1, na rachunek bankowy wskazany przez Zakład.
10. Zakład urzędu odstępuje od żądania zwrotu kwoty nienależnie pobranego jednorazowego świadczenia, która nie jest objęta układem ratalnym lub jej egzekucja okazała się bezskuteczna, jeżeli:
...
2) po upływie 14 dni od dnia umieszczenia decyzji, postanowienia, zawiadomienia, wezwania, informacji lub innego pisma sprawie jednorazowego na profilu informacyjnym przypadku ich nieodebrania.
12. Z jednorazowego nie dokonuje się potrąceń egzekucji.
13. Jednorazowe świadczenie nie stanowi podstawy wymiaru składki na ubezpieczenie zdrowotne rozumieniu przepisów ustawy dnia 27 sierpnia 2004 świadczeniach opieki zdrowotnej finansowanych ze środków publicznych (Dz. 2561, 2674 2770 2023 605, 650 658).
14. 1. Zakład informuje Szefa Krajowej Administracji Skarbowej obniżeniu przychodu wykazanym oświadczeniu płatnika składek, którym mowa art. 6 ust. 3 pkt 5 lit. b.
2. Szef Krajowej Administracji Skarbowej bada obniżenie przychodu okresie wskazanym oświadczeniu płatnika składek.
3. Szef Krajowej Administracji Skarbowej potwierdza obniżenie przychodów wskazane oświadczeniu lub informuje Zakład rozbieżnościach danymi posiadanymi przez Krajową Administracją Skarbową.
4. Wymiana informacji, których mowa ust. 1 3, następuje formie elektronicznej.
15. Zakład jest uprawniony do przetwarzania danych osobowych zakresie niezbędnym do ustalenia prawa do jednorazowego jego wypłaty.
16. 1. Główny Urząd Statystyczny przekazuje do Zakładu informację, czy płatnik składek na dzień 31 lipca prowadził pozarolniczą działalność oznaczoną według Polskiej Klasyfikacji Działalności (PKD) 2007, jako przeważającą.
Informacja zawiera imię nazwisko albo nazwę płatnika składek, jego NIP, REGON kod według Polskiej Klasyfikacji Działalności (PKD) 2007.
...
2. Zaświadczenie pomocy de minimis zamiast danych osoby upoważnionej do jego wydania zawiera treść „Zakład Ubezpieczeń Społecznych”.
29. 1. W roku wypłata jednorazowego koszty jego obsługi mogą być finansowane ze środków rezerwy dysponenta Funduszu Pracy.
2. Główny Urząd Statystyczny przekazuje po raz pierwszy informację, której mowa art. 16 ust. 1, wykaz, którym mowa art. 16 ust. 2, dniu następującym po dniu ogłoszenia ustawy.
30. W przypadku niedokonania płatności przez osobę uprawnioną za pomocą Polskiego Bonu Turystycznego, którym mowa ustawie zmienianej art. 26, terminie do dnia 30 września r., prawo do jej dokonania przysługuje od dnia wejścia życie niniejszej ustawy do dnia 31 marca 2023
31. Ustawa wchodzi życie dniem następującym po dniu ogłoszenia , mocą od dnia 1 sierpnia r., wyjątkiem art. 26 art. 30, które wchodzą życie dniem następującym po dniu ogłoszenia.
