...
# Rozporządzenie Prezesa Rady Ministrówz dnia 14 marca 2017 r. w sprawie określenia wzorów formularzy sprawozdawczych, objaśnień co do sposobu ich wypełniania oraz wzorów kwestionariuszy i ankiet statystycznych stosowanych w badaniach statystycznych ustalonych w programie badań statystycznych statystyki publicznej na rok 2017

| Pole | Wartość |
|---|---|
| Adres publikacyjny | Dz.U. 2017 poz. 837 |
| ISAP | WDU20170000837 |
...
| Źródło | [ISAP](https://isap.sejm.gov.pl/isap.nsf/DocDetails.xsp?id=WDU20170000837) · [PDF](https://api.sejm.gov.pl/eli/acts/DU/2017/837/text.pdf) |
...
§ 1.
1.
Określa się wzory formularzy sprawozdawczych i ankiet statystycznych do badań statystycznych, ustalonych w programie badań statystycznych statystyki publicznej na rok 2017, prowadzonych przez Prezesa Głównego Urzędu Statystycznego:
1)
...
138)
SG-01 – statystyka gminy: środki trwałe; załącznik do sprawozdania SG-01 statystyka gminy: środki trwałe;
139)
...
2.
Określa się wzory kwestionariuszy i ankiet statystycznych do badań statystycznych, ustalonych w programie badań statystycznych statystyki publicznej na rok 2017, prowadzonych przez Prezesa Głównego Urzędu Statystycznego na zasadzie dobrowolności udzielenia odpowiedzi:
1)
...
14)
ZD – ankieta, badanie aktywności ekonomicznej ludności w 2017 roku;
15)
...
§ 2.
1.
Określa się wzory formularzy sprawozdawczych do badań statystycznych, ustalonych w programie badań statystycznych statystyki publicznej na rok 2017, prowadzonych przez ministra właściwego do spraw budownictwa, planowania i zagospodarowania przestrzennego oraz mieszkalnictwa:
1)
...
2.
Określa się wzory formularzy sprawozdawczych do badań statystycznych, ustalonych w programie badań statystycznych statystyki publicznej na rok 2017, prowadzonych przez ministra właściwego do spraw energii:
1)
...
24)
G-10.6 – sprawozdanie o mocy i produkcji energii elektrycznej w instalacji odnawialnego źródła energii;
25)
...
3.
Określa się wzory formularzy sprawozdawczych do badań statystycznych, ustalonych w programie badań statystycznych statystyki publicznej na rok 2017, prowadzonych przez ministra właściwego do spraw gospodarki morskiej:
1)
...
4.
Określa się wzory formularzy sprawozdawczych do badań statystycznych, ustalonych w programie badań statystycznych statystyki publicznej na rok 2017, prowadzonych przez ministra właściwego do spraw kultury i ochrony dziedzictwa narodowego:
1)
...
5.
Określa się wzory formularzy sprawozdawczych do badań statystycznych, ustalonych w programie badań statystycznych statystyki publicznej na rok 2017, prowadzonych przez ministra właściwego do spraw nauki:
1)
...
6.
Określa się wzór formularza sprawozdawczego do badania statystycznego, ustalonego w programie badań statystycznych statystyki publicznej na rok 2017, prowadzonego przez Ministra Obrony Narodowej: PM-1 – roczne sprawozdanie o pojazdach i maszynach.
7.
Określa się wzory formularzy sprawozdawczych do badań statystycznych, ustalonych w programie badań statystycznych statystyki publicznej na rok 2017, prowadzonych przez ministra właściwego do spraw pracy:
1)
...
4)
załącznik nr 3 do sprawozdania MRPiPS-01 – bezrobotni oraz wolne miejsca pracy i miejsca aktywizacji zawodowej według zawodów i specjalności;
5)
...
13)
MRPiPS-06 – sprawozdanie o instytucjonalnej obsłudze rynku pracy;
14)
MRPiPS-06 – sprawozdanie o instytucjonalnej obsłudze rynku pracy;
15)
MRPiPS-07 – sprawozdanie o osobach niepełnosprawnych bezrobotnych i poszukujących pracy niepozostających w zatrudnieniu.
8.
Określa się wzory formularzy sprawozdawczych do badań statystycznych, ustalonych w programie badań statystycznych statystyki publicznej na rok 2017, prowadzonych przez ministra właściwego do spraw zabezpieczenia społecznego:
1)
...
9.
Określa się wzory formularzy sprawozdawczych do badań statystycznych, ustalonych w programie badań statystycznych statystyki publicznej na rok 2017, prowadzonych przez ministra właściwego do spraw rolnictwa:
1)
...
10.
Określa się wzory formularzy sprawozdawczych do badań statystycznych, ustalonych w programie badań statystycznych statystyki publicznej na rok 2017, prowadzonych przez ministra właściwego do spraw rozwoju wsi:
1)
...
11.
Określa się wzory formularzy sprawozdawczych do badań statystycznych, ustalonych w programie badań statystycznych statystyki publicznej na rok 2017, prowadzonych przez ministra właściwego do spraw rybołówstwa:
1)
...
12.
Określa się wzory formularzy sprawozdawczych do badań statystycznych, ustalonych w programie badań statystycznych statystyki publicznej na rok 2017, prowadzonych przez ministra właściwego do spraw rynków rolnych:
1)
...
13.
Określa się wzory formularzy sprawozdawczych do badań statystycznych, ustalonych w programie badań statystycznych statystyki publicznej na rok 2017, prowadzonych przez Ministra Sprawiedliwości:
1)
...
14.
Określa się wzór formularza sprawozdawczego do badania statystycznego, ustalonego w programie badań statystycznych statystyki publicznej na rok 2017, prowadzonego przez ministra właściwego do spraw szkolnictwa wyższego: EN-1 – sprawozdanie o liczbie kandydatów i przyjętych na studia stacjonarne i niestacjonarne.
15.
Określa się wzory formularzy sprawozdawczych do badań statystycznych, ustalonych w programie badań statystycznych statystyki publicznej na rok 2017, prowadzonych przez ministra właściwego do spraw środowiska:
1)
...
16.
Określa się wzory formularzy sprawozdawczych do badań statystycznych, ustalonych w programie badań statystycznych statystyki publicznej na rok 2017, prowadzonych przez ministra właściwego do spraw wewnętrznych:
1)
...
14)
MSWiA-44 – sprawozdanie z działalności Centrum Krwiodawstwa i Krwiolecznictwa MSW;
15)
...
17.
Określa się wzory formularzy sprawozdawczych do badań statystycznych, ustalonych w programie badań statystycznych statystyki publicznej na rok 2017, prowadzonych przez ministra właściwego do spraw zdrowia:
1)
...
18.
Określa się wzory formularzy sprawozdawczych do badań statystycznych, ustalonych w programie badań statystycznych statystyki publicznej na rok 2017, prowadzonych przez Przewodniczącego Komisji Nadzoru Finansowego:
1)
...
19.
Określa się wzory formularzy sprawozdawczych do badań statystycznych, ustalonych w programie badań statystycznych statystyki publicznej na rok 2017, prowadzonych przez Prezesa Narodowego Banku Polskiego:
1)
...
20.
Określa się wzory formularzy sprawozdawczych do badań statystycznych, ustalonych w programie badań statystycznych statystyki publicznej na rok 2017, prowadzonych przez Prokuratora Krajowego:
1)
...
21.
Wzory formularzy sprawozdawczych, kwestionariuszy i ankiet statystycznych, o których mowa w ust. 1–20, są określone w załączniku nr 3 do rozporządzenia.
§ 3.
1.
Określa się wzory zestawień tabelarycznych, ustalonych w programie badań statystycznych statystyki publicznej na rok 2017, przekazywanych Prezesowi Głównego Urzędu Statystycznego:
1)
