...
| Pole | Wartość |
|---|---|
| Adres publikacyjny | Dz.U. 2017 poz. 892 |
| ISAP | WDU20170000892 |
| Typ aktu | Ustawa |
| Status | akt objęty tekstem jednolitym |
| W mocy | tak |
...
| Źródło | [ISAP](https://isap.sejm.gov.pl/isap.nsf/DocDetails.xsp?id=WDU20170000892) · [PDF](https://api.sejm.gov.pl/eli/acts/DU/2017/892/text.pdf) |

**Art. 1.** W ustawie z dnia 20 lutego 2015 r. o wspieraniu rozwoju obszarów wiejskich z udziałem środków Europejskiego Funduszu Rolnego na rzecz Rozwoju Obszarów Wiejskich w ramach Programu Rozwoju Obszarów Wiejskich na lata 2014–2020 (Dz. U. z 2017 r. poz. 562 i 624) wprowadza się następujące zmiany:
...
- **2)** w art. 55:
    ...
    - **b)** ust. 5a otrzymuje brzmienie: „5a. W przypadku upoważnienia jednostki sektora finansów publicznych do pełnienia funkcji jednostki centralnej:
...
- **5)** w art. 57d w ust. 1 pkt 1 otrzymuje brzmienie: „1) ust. 2 – do jednostki sektora finansów publicznych upoważnionej do pełnienia funkcji jednostki centralnej;”;
- **6)** w art. 57g w ust. 2 w pkt 1 lit. a i b otrzymują brzmienie: „a) umowę na realizację operacji z partnerem KSOW zawiera jednostka sektora finansów publicznych upoważniona do pełnienia funkcji jednostki centralnej, wniosek o refundację partner KSOW składa do instytucji zarządzającej za pośrednictwem tej jednostki,”.
    - **b)** koszty poniesione przez partnera KSOW są refundowane przez urząd obsługujący ministra właściwego do spraw rozwoju wsi na wniosek tego partnera po zweryfikowaniu tego wniosku przez jednostkę sektora finansów publicznych upoważnioną do pełnienia funkcji jednostki centralnej i zatwierdzeniu przez instytucję zarządzającą;
