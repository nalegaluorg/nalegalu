...
source: "eli-html"
---
# Rozporządzenie Ministra Infrastruktury i Rozwojuz dnia 11 września 2014 r. w sprawie warunków eksploatacji lotnisk
...
| Źródło | [ELI HTML](https://eli.gov.pl/api/acts/DU/2014/1420/text.html) · [ELI API](https://api.sejm.gov.pl/eli/acts/DU/2014/1420) |

## Spis treści

- [Treść rozporządzenia](#part_1) [Rozdział 1 - Przepisy ogólne](#chpt_1) [Rozdział 2 - Warunki eksploatacji lotnisk certyfikowanych](#chpt_2) [Rozdział 3 - Warunki eksploatacji lotnisk o ograniczonej certyfikacji](#chpt_3) [Rozdział 4 - Warunki eksploatacji lotnisk użytku wyłącznego](#chpt_4) [Rozdział 5 - Przepis końcowy](#chpt_5)

TOC

## Treść rozporządzenia

Na podstawie art. 83 ust. 1 ustawy z dnia 3 lipca 2002 r. - Prawo lotnicze ([Dz. U. z 2013 r. poz. 1393](https://api.sejm.gov.pl/eli/acts/DU/2013/1393/text.html) oraz [z 2014 r. poz. 768](https://api.sejm.gov.pl/eli/acts/DU/2014/768/text.html)) zarządza się, co następuje:
...
podlegających obowiązkowi certyfikacji zgodnie z art. 59a ust. 1 pkt 1 ustawy z dnia 3 lipca 2002 r. - Prawo lotnicze, zwanej dalej „ustawą”,
...
lotnisku o ograniczonej certyfikacji - należy przez to rozumieć lotnisko, dla którego Prezes Urzędu Lotnictwa Cywilnego wydał decyzję, o której mowa w art. 59a ust. 2 ustawy;
...
pomocy wzrokowych dróg startowych i dróg kołowania;
...
Na lotnisku kontrolowanym poruszanie się pojazdów i pieszych w polu manewrowym może odbywać się wyłącznie po uzyskaniu zezwolenia wydanego przez TWR.
...
Zarządzający lotniskiem informuje podmioty uczestniczące w realizacji LVP i podmioty wykonujące zadania w PRN o każdej zmianie tych procedur.
...
niepowodujący uszkodzenia urządzeń lotniskowych lub kabli zasilających;
...
dokonać uzgodnień z przewoźnikami lotniczymi i innymi użytkownikami statków powietrznych, a na lotniskach kontrolowanych również z TWR - w zakresie zgłaszania danych dotyczących zderzeń statków powietrznych ze zwierzętami oraz obecności ptaków w otoczeniu lotniska;

### 2)

raz do roku, w terminie do dnia 30 kwietnia, przekazywać Prezesowi Urzędu Lotnictwa Cywilnego zbiorcze raporty dotyczące zderzeń statków powietrznych ze zwierzętami odnotowanych na danym lotnisku za rok poprzedni, celem wprowadzenia ich do bazy danych Systemu Informacji o Zderzeniach z Ptakami (IBIS) prowadzonego przez Organizację Międzynarodowego Lotnictwa Cywilnego (ICAO);

### 3)

co najmniej raz na 3 lata dokonać przeglądu i w razie potrzeby uaktualnienia procedury przeciwdziałania zagrożeniom ze strony zwierząt.
...
wyznacza osobę odpowiedzialną za zarządzanie bezpieczeństwem na lotnisku;

### 2)

przeprowadza, nie rzadziej niż raz na rok:

### a)

identyfikację zagrożeń, polegającą na wskazaniu czynników mających negatywny wpływ na poziom bezpieczeństwa na lotnisku,

### b)

audyty i inspekcje bezpieczeństwa;

### 3)

przeprowadza postępowania wyjaśniające dotyczące zdarzeń na lotnisku mających wpływ na bezpieczeństwo.
...
ruchu pojazdów i pieszych w PRN;

### 4)

zarządzania płytą postojową, w przypadku lotnisk z drogą startową o nawierzchni sztucznej;
