...
# (Dz. U. 169, poz. 1200, 2008 157, poz. 976 oraz 2009 18, poz. 97) wprowadza się następujące zmiany:
...
- **3)** s przedanych, zbytych innej formie lub zużytych przez nie na potrzeby własne innych paliw odnawialnych, określeniem zawartości biokomponentów tych paliwach;
- **4)** r odzajów biokomponentów wykopośrednikiem a wytwórcą;
- **3)** surowców rolniczych pozyskanych produkcji własnej wytwórców; rzystanych paliwach ciekłych, biopaliwach ciekłych innych paliwach odnawialnych, których mowa 1—3, ze wskazaniem pochodzenia tych biokomponentów według podziału określonego art. 30a 1.
