...
- **3)** wykonawcy mogą polegać na zdolnościach innych podmiotów, których mowa 36, pochodzących trzecich niebędących stronami umów międzynarodowych;
- **4)** wykonawcy mogą powierzyć wykonanie części umowy koncesji podwykonawcom pochodzącym trzecich niebędących stronami umów międzynarodowych;
- **5)** podwykonawcy mogą powierzyć wykonanie części umowy koncesji dalszym podwykonawcom pochodzącym trzecich niebędących stronami umów międzynarodowych.

2. Zamawiający, odniesieniu do wykonawców pochodzących trzecich niebędących stronami umów międzynarodowych robót budowlanych, dostaw usług pochodzących tych państw, określić wymagania dotyczące postępowania zawarcie umowy koncesji warunki umowy koncesji mniej korzystne niż odniesieniu do wykonawców pochodzących państw, których mowa 12a, robót budowlanych, dostaw usług pochodzących tych państw.”;

- **2)** 54 ust. 1 ust. 1a „1a. Środki ochrony prawnej określone niniejszym dziale nie przysługują wykonawcy ani innemu podmiotowi, którym mowa ust. 1, pochodzącym trzecich niebędących stronami umów międzynarodowych.”.

**Art. 3.**

1. Do postępowań udzielenie zamówienia publicznego postępowań zawarcie umowy ramowej wszczętych niezakończonych przed dniem wejścia życie niniejszej ustawy stosuje przepisy ustawy zmienianej 1, brzmieniu dotychczasowym, tym że: do tych postępowań stosuje przepis 16a ustawy zmienianej 1;

- **2)** zamawiający do zakończenia tych postępowań odrzucić ofertę na podstawie 226 ust. 1 pkt 5a ustawy zmienianej 1, również przypadku ponownej oceny ofert.

2. Przepis ust. 1 pkt 2 stosuje odpowiednio do możliwości odrzucenia wniosków dopuszczenie do udziału postępowaniu na podstawie 146 ust. 1 pkt 4a ustawy zmienianej 1.

3. Do konkursów rozpoczętych niezakończonych przed dniem wejścia życie niniejszej ustawy stosuje przepisy ustawy zmienianej 1, brzmieniu dotychczasowym, tym że przepis 16a ustawy zmienianej 1 stosuje również do konkursów rozpoczętych niezakończonych przed dniem wejścia życie niniejszej ustawy. Przepis ust. 1 pkt 2 stosuje odpowiednio do możliwości odrzucenia wniosków dopuszczenie do udziału konkursie na podstawie 343 ust. 3 pkt 4a ustawy zmienianej 1.

4. Do dynamicznego systemu zakupów systemu kwalifikowania wykonawców, których mowa ustawie zmienianej 1, ustanowionych przed dniem wejścia życie niniejszej ustawy stosuje przepisy ustawy zmienianej 1, brzmieniu dotychczasowym, tym że przepis 16a ustawy zmienianej 1 stosuje również do dynamicznego systemu zakupów systemu kwalifikowania wykonawców, których mowa ustawie zmienianej 1, ustanowionych przed dniem wejścia życie niniejszej ustawy. Przepis ust. 1 pkt 2 stosuje odpowiednio do możliwości odrzucenia wniosków dopuszczenie do udziału dynamicznym systemie zakupów na podstawie 146 ust. 1 pkt 4a ustawy zmienianej 1 uzasadnienia odmowy dopuszczenia do udziału systemie kwalifikowania wykonawców, której mowa 373 ust. 4 ustawy zmienianej 1, skreślenia wykazu, którym mowa 374 ust. 1 ustawy zmienianej 1.

**Art. 4.**

1. Do postępowań odwoławczych prowadzonych na podstawie ustawy zmienianej 1, wszczętych nieArt. 5. 1. Do postępowań zawarcie umowy koncesji na roboty budowlane usługi, wszczętych niezakończonych przed dniem wejścia życie niniejszej ustawy, stosuje przepisy ustawy zmienianej 2, brzmieniu dotychczasowym, tym że: do tych postępowań stosuje przepis 12a ustawy zmienianej 2;

- **2)** zamawiający ponownie ocenić odrzucić ofertę wykonawcy wniosek dopuszczenie do udziału postępowaniu zawarcie umowy koncesji na roboty budowlane usługi, ile nie narusza to warunków określonych dokumentach koncesji.

2. Do postępowań odwoławczych prowadzonych na podstawie ustawy zmienianej 2, wszczętych niezakończonych przed dniem wejścia życie niniejszej ustawy, stosuje przepisy ustawy zmienianej 2, brzmieniu dotychczasowym.

3. Do postępowań odwoławczych prowadzonych na podstawie ustawy zmienianej 2, wszczętych od wejścia życie niniejszej ustawy, które dotyczą postępowań zawarcie umowy koncesji na roboty budowlane usługi wszczętych przed dniem wejścia życie niniejszej ustawy, stosuje przepisy ustawy zmienianej 2, brzmieniu dotychczasowym, uwzględnieniem ust. 1.

**Art. 6.** Ustawa wchodzi życie upływie 14 dni od ogłoszenia.
