...
- **1)** zasady funkcjonowania ogólnopolskiego systemu zgłaszania: podejrzanych transakcji lub prób dokonania takich transakcji dotyczących substancji wymienionych w załącznikach I i II do rozporządzenia Parlamentu Europejskiego i Rady (UE) nr 98/2013 z dnia 15 stycznia 2013 r. w sprawie wprowadzania do obrotu i używania prekursorów materiałów wybuchowych (Dz. Urz. UE L 39 z 09.02.2013, str. 1), zwanego dalej „rozporządzeniem (UE) nr 98/2013”, lub w aktach delegowanych wydanych na podstawie art. 12 tego rozporządzenia oraz mieszanin lub substancji zawierających te substancje, zniknięć i kradzieży znacznych ilości substancji, o których mowa w lit. a, oraz mieszanin lub substancji zawierających te substancje;
    - **a)**
    - **b)**
...
- **1)** dane o zgłaszającym: imię i nazwisko, nazwę i adres wykonywania działalności lub siedziby, inne niż w lit. b dane teleadresowe, jeżeli zostały podane;
    - **a)**
    - **b)**
    - **c)**

- **2)** dane o zgłaszanym zdarzeniu: datę i miejsce wystąpienia zdarzenia, charakter zdarzenia (podejrzana transakcja, próba dokonania podejrzanej transakcji, zniknięcie, kradzież), informacje na temat substancji lub mieszaniny, której dotyczy zdarzenie (nazwa, stężenie, ilość);
    - **a)**
    - **b)**
    - **c)**
