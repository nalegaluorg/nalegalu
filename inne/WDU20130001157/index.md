...
- **2)** w art. 2: uchyla się ust. 2, ust. 3 otrzymuje brzmienie: „
    - **a)**
    - **b)**
...
- **2)** wyrażenia zgody przez dotychczasowego właściciela na dokonanie rozliczenia wartości zabudowań w gotówce lub w innej formie. ” , po ust. 3 dodaje się ust. 3a w brzmieniu: „
    - **c)**
...
- **4)** w art. 4: w ust. 1 w pkt 3 kropkę zastępuje się średnikiem i dodaje się pkt 4 i 5 w brzmieniu: „
    - **a)**

- **4)** o scalenie wystąpi inwestor, którego działalność spowodowała lub spowoduje skutki, o których mowa w pkt 2;
- **5)** o scalenie wystąpi organ właściwy w zakresie ochrony przyrody, w przypadku gdy korzystanie z gruntów, na których ochronie podlegają zagrożone wyginięciem gatunki roślin i zwierząt, lub siedlisk przyrody stało się niemożliwe lub istotnie ograniczone. ” , dodaje się ust. 3 w brzmieniu: „
    - **b)**
...
- **6)** w art. 8: ust. 1–3 otrzymują brzmienie: „
    - **a)**
...
3. Na zgodny wniosek zainteresowanych uczestników scalenia można im wydzielić grunty o innej wartości szacunkowej stosując dopłaty. ” , po ust. 3 dodaje się ust. 3a w brzmieniu: „
