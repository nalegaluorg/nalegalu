...
# ku docelowego je terminie dnia 28 lutego roku na po roku podatkowym, którym dopisano mieszkanio osobom, których rachunku dopisa no
...
2) skarbowemu ze na miejsce zamieszkania osoby, której mowa pkt 1." wspieraniu przez na cele mieszka niowe, roczna, której mowa wart. 13 ust. naliczana jest wyso nie 0,1% sumy aktywów bilansowych gwarancji nych ryzykiem."
19. Ustawa wchodzi po 3 mie od dnia art. 17, który wchodzi dniem 1 stycznia 1998 r.
Prezydent Rzeczypospolitej Polskiej: A.
USTAWA dnia 27 czerwca 1997 r.
bibliotekach.
1 Przepisy ogólne
1. Ustawa ogólne zasady bliotek.
...
2) na:
a)
b) prowadzenie bibliotecznej, cza zakup
c) doskonalenie zawodowe pracowników.
Biblioteka albo innej nostki.
1. Biblioteka na podstawie aktu utwo rzeniu biblioteki statutu nadanego przez organiza tora.
2. Akt utworzeniu biblioteki teren zakres biblioteki,
2) finansowania.
3. Statut cele zadania biblioteki,
2) organy biblioteki jej tym zakres filii
3) jednostki nadzór merytoryczny nad biblioteki odniesieniu blioteki ogólnokrajowej bibliotecznej,
4) sposób gospodarowania finansowymi biblioteki.
4. ministrowie drodze ramowe statuty dla bibliotek, których orga nizatorem jest jednostka organizacyjna nadzorowana przez tych ministrów.
Zadania, naczelne centralne organy administracji kres biblioteki innej nostki organizacyjnej regulamin nadany przez
2) wojewodowie, kierownika tej jednostki.
3) gminy lub komunalne. 1. Organizator lub likwidacji biblioteki.
4. lub likwidacja biblioteki ogólnokrajowej sieci bibliotecznej po przez organizatora opinii jednostki nadzór merytoryczny nad dzia biblioteki. Przepis ten stosuje odpowied nio filii bibliotecznych.
5. Przepisów ust. 2-4 nie stosuje innej jednostki organizacyjnej.
6. Przepisów ust. 1-4 nie stosuje szkolnych pedagogicznych.
14. 1. bibliotek, których organizatorami podmioty wart. 8 ust. 2, ogólnie ust. 2.
2. pobierane: za informacyjne, bibliograficzne, reprogra ficzne
2) za audiowizualnych,
3) formie kaucji za biblio teczne,
4) za niezwrócenie terminie mate
5) za uszkodzenie, zniszczenie lub niezwrócenie mate bibliotecznych.
3. których mowa ust. 2 pkt 1 2, nie kosztów wykonania
4. Zasady warunki korzystania biblioteki regulamin nadany przez jej dyrektora (kierownika).
15. Przy bibliotece rada biblio teczna lub inny organ charakterze doradczym opi niodawczym, na zasadach statucie.
4 Biblioteka Narodowa
16. 1. Biblioteka Narodowa jest
2. Biblioteka Narodowa posiada
3. Nadzór nad sprawuje Mini nych Polsce za a doty Polski,
2) opracowywanie wydawanie bibliografii narodo wej,
3) prowadzenie zakresu bibliotekoznawstwa, nauki pokrewnych dziedzin wiedzy,
...
19. 1. Biblioteki publiczne organizowane.
sposób dogodny bibliotecznych informacji. W tym celu województwie jest organizowana pro wadzona wojewódzka biblioteka publiczna, a gminie co najmniej jedna gminna (komunalna) biblio teka publiczna, wraz filii oddzia punktów bibliotecznych.
2. Biblioteki publiczne za or ganizatora, porozumienia innymi bibliotekami insty tucjami sprawie wspólnego prowadzenia bliotecznej
20. 1. Wojewoda jest organizatorem woje wódzkiej biblioteki publicznej, której gionalnym, badanie stanu stopnia zaspokojenia potrzeb kowników, analizowanie stanu, organizacji roz mieszczenia przed stawianie organizatorom propozycji zmian tym zakresie, udzielanie bibliotekom pomocy instrukcyjno-meto dycznej szkoleniowej sprawowanie nadzoru merytorycznego, zakresie realizacji przez gmin ne (komunalne) biblioteki publiczne nych wart. 27 ust. 5.
2. Biblioteka publiczna, której organizatorem jest gmina lub komunalny, wojewody, zada nia, których mowa ust. l, na podstawie porozumie nia wojewody organem tery torialnego.
...
2. Biblioteki pedagogiczne potrzebom wychowania, doskonalenia kadry pedagogicznej.
3. Zasady organizowania szkolnych pedagogicznych przepi sy.
8 Biblioteki fachowe
23. pracy biblioteki fachowe
24. 1. Biblioteki fachowe pracy potrzebom doskona lenia zawodowego pracowników.
2. Biblioteki zaspokajaniu potrzeb kulturalnych pracowników pracy ich rodzin.
9 specjalnych grup
25. Centralna Biblioteka Niewidomych zapew nia niewidomych koordynu je pokrewnych instytucji.
