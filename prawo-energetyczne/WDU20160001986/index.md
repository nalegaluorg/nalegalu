...
- **4)** w art. 33: w ust. 1a pkt 2 i 3 otrzymują brzmienie: „
    - **a)**
...
- **5)** w art. 41: w ust. 2 pkt 4 otrzymuje brzmienie: „
    - **a)**
...
- **7)** w art. 43 w ust. 11: wprowadzenie do wyliczenia otrzymuje brzmienie: „ Prezes URE publikuje w Biuletynie Informacji Publicznej URE wykaz podmiotów posiadających promesę koncesji, obejmujący: ” , pkt 1 otrzymuje brzmienie: „
    - **a)**
    - **b)**

- **1)** oznaczenie podmiotu; ” ;
- **8)** w art. 43d: w ust. 1 po wyrazach „a także ich przeznaczeniu” skreśla się przecinek i wyrazy „poprzez wskazanie formy rozporządzenia nimi lub przedstawienie informacji o zużyciu ich na potrzeby własne”, w ust. 3 po wyrazach „Minister właściwy do spraw finansów publicznych” dodaje się przecinek oraz wyrazy „minister właściwy do spraw energii”;
    - **a)**
    - **b)**
...
- **c)**
- **d)**
- **8)** pkt 48 wynosi 10 000 zł oddzielnie dla każdego rodzaju i lokalizacji infrastruktury paliw ciekłych; ” , w ust. 4 skreśla się przecinek i wyrazy „z zastrzeżeniem ust. 2b”;
    - **e)**
...
- **1)** w art. 2 w ust. 1: pkt 14 otrzymuje brzmienie: „
    - **a)**

- **14)** wprowadzanie do obrotu – rozporządzenie biokomponentami, paliwami ciekłymi lub biopaliwami ciekłymi poprzez dokonanie jakiejkolwiek czynności prawnej lub faktycznej, poza procedurą zawieszenia poboru akcyzy, w rozumieniu przepisów o podatku akcyzowym; ” , pkt 18–19 otrzymują brzmienie: „
    - **b)**
...
- **19)** pośrednik – przedsiębiorcę w rozumieniu ustawy z dnia 2 lipca 2004 r. o swobodzie działalności gospodarczej, wykonującego działalność gospodarczą w zakresie: zakupu, importu lub nabycia wewnątrzwspólnotowego biomasy przeznaczonej do wytwarzania biokomponentów, a następnie rozporządzenia nią poprzez dokonanie jakiejkolwiek czynności prawnej lub faktycznej lub zakupu biokomponentów, a następnie rozporządzenia nimi poprzez dokonanie jakiejkolwiek czynności prawnej lub faktycznej; ” , pkt 20a otrzymuje brzmienie: „
    - **a)**
    - **b)**
    - **c)**

- **20a)** podmiot sprowadzający – przedsiębiorcę w rozumieniu ustawy z dnia 2 lipca 2004 r. o swobodzie działalności gospodarczej, wykonującego działalność gospodarczą w zakresie importu lub nabycia wewnątrzwspólnotowego biokomponentów, a następnie rozporządzenia nimi poprzez dokonanie jakiejkolwiek czynności prawnej lub faktycznej; ” , pkt 39 otrzymuje brzmienie: „
    - **d)**
...
- **5)** w art. 12b: pkt 2 otrzymuje brzmienie: „
    - **a)**

- **2)** prowadzić dokumentację dotyczącą importu lub nabycia wewnątrzwspólnotowego biokomponentów oraz rozporządzenia nimi poprzez dokonanie jakiejkolwiek czynności prawnej lub faktycznej; ” , pkt 4 otrzymuje brzmienie: „
    - **b)**
...
- **13)** w art. 28b ust. 1 i 2 otrzymują brzmienie: „ l. Biokomponenty spełniają kryterium ograniczenia emisji gazów cieplarnianych, jeżeli ograniczenie emisji tych gazów wynosi co najmniej: 35% – do dnia 31 grudnia 2017 r.;
    - **l)**
