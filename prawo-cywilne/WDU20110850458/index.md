...
# Kodeks cywilny (Dz. U. 16, 93, późn. zm. ) „§ 3. Do długów spadkowych należą także koszty wprowadza następujące zmiany: pogrzebu spadkodawcy takim zakresie, jakim pogrzeb ten odpowiada zwyczajom
...
1) 156 otrzymuje brzmienie: przyjętym danym środowisku, koszty postępowania spadkowego, obowiązek zaspo„Art. 156. J eżeli zawarcie umowy przenoszącej kojenia roszczeń zachowek oraz obowiązek własność następuje wykonaniu zobo- wykonania zapisów zwykłych poleceń, jak wiązania wynikającego uprzednio za- również inne obowiązki przewidziane przewartej umowy zobowiązującej do prze- pisach księgi niniejszej.”;
niesienia własności, zapisu zwykłego, bezpodstawnego wzbogacenia lub 4) 932 dodaje § 6 brzmieniu: innego zdarzenia, ważność umowy „§ 6. Jeżeli jedno rodziców nie dożyło otwarcia przenoszącej własność zależy od istnie- spadku brak jest rodzeństwa spadkodawcy nia tego zobowiązania.”;
2) 510 § 2 otrzymuje brzmienie: „§ 2. Jeżeli zawarcie umowy przelewu następuje wykonaniu zobowiązania wynikającego uprzednio zawartej umowy zobowiązującej do przeniesienia wierzytelności, zapisu zwykłego, bezpodstawnego wzbogacenia lub innego zdarzenia, ważność umowy przelewu zależy od istnienia tego zobowiązania.”;
lub ich zstępnych, udział spadkowy rodzica dziedziczącego zbiegu małżonkiem spadkodawcy wynosi połowę spadku.”;
...
Art. 981 2 Zapis windykacyjny jest bezskuteczny, jeżeli chwili otwarcia spadku przedmiot zapisu nie należy do spadkodawcy albo spadkodawca był zobowiązany do jego zbycia. Jeżeli przedmiotem zapisu jest ustanowienie dla zapisobiercy użytkowania lub służebności, zapis jest bezskuteczny, gdy chwili otwarcia spadku przedmiot majątkowy, który miał być obciążony użytkowaniem lub służebnością nie należy do spadku albo spadkodawca był zobowiązany do jego zbycia.
Art. 981 3 § 1. Zastrzeżenie warunku lub terminu uczynione przy ustanawianiu zapisu windykacyjnego uważa za nieistniejące. Jeżeli jednak treści testamentu lub okoliczności wynika, że bez takiego zastrzeżenia zapis nie zostałby uczyniony, zapis windykacyjny jest nieważny. Przepisów tych nie stosuje się, jeżeli ziszczenie lub nieziszczenie warunku albo nadejście terminu nastąpiło przed otwarciem spadku.
§ 2. Zapis windykacyjny nieważny ze względu na zastrzeżenie warunku lub terminu wywołuje skutki zapisu zwykłego uczynionego pod warunkiem lub zastrzeżeniem terminu, chyba że co innego wynika treści testamentu lub okoliczności.
Art. 981 4 Spadkodawca może obciążyć zapisem zwykłym osobę, na której rzecz uczynił zapis windykacyjny.
Art. 981 5 Przepisy powołaniu spadkobiercy, przyjęciu odrzuceniu spadku, zdolno12) po 986 dodaje 986 brzmieniu: „Art. 986 Spadkodawca może powołać wykonawcę testamentu do sprawowania zarządu spadkiem, jego zorganizowaną częścią lub oznaczonym składnikiem.”;
13) 988 989 otrzymują brzmienie: „Art. 988. § 1. Jeżeli spadkodawca nie postanowił inaczej, wykonawca testamentu powinien zarządzać majątkiem spadkowym, spłacić długi spadkowe, szczególności wykonać zapisy zwykłe polecenia, a następnie wydać spadkobiercom majątek spadkowy zgodnie wolą spadkodawcy ustawą, a każdym razie niezwłocznie po dokonaniu działu spadku.
§ 2. Wykonawca testamentu może pozywać być pozywany sprawach wynikających zarządu spadkiem, jego zorganizowaną częścią lub oznaczonym składnikiem. Może również pozywać sprawach prawa należące do spadku być pozwany sprawach długi spadkowe.
...
**Art. 996.** Zapis windykacyjny oraz darowiznę dokonane przez spadkodawcę na rzecz uprawnionego do zachowku zalicza na należny mu zachowek. Jeżeli uprawnionym do zachowku jest dalszy zstępny spadkodawcy, zalicza na należny mu zachowek także zapis windykacyjny oraz darowiznę dokonane przez spadkodawcę na rzecz jego wstępnego.”;

**Art. 1004.**

§ 1. Zmniejszenie zapisów zwykłych poleceń następuje stosunku do ich wartości, chyba że treści testamentu wynika odmienna wola spadkodawcy.
...
- **23)** 1033 otrzymuje brzmienie: „Art. 1033. Odpowiedzialność spadkobiercy tytułu zapisów zwykłych poleceń ogranicza do wartości stanu czynnego spadku.”;
- **24)** po 1034 dodaje 1034 —1034 brzmieniu: „Art. 1034 § 1. Do chwili działu spadku wraz ze spadkobiercami solidarną odpowiedzialność za długi spadkowe ponoszą także osoby, na których rzecz spadkodawca uczynił zapisy windykacyjne.

§ 2. Rozliczenia między spadkobiercami osobami, na których rzecz zostały uczynione zapisy windykacyjne, następują proporcjonalnie do wartości otrzymanych przez nich przysporzeń. Spadkobiercom uwzględnia ich udział wartości ustalonego inwentarzu stanu czynnego spadku. Art. 1034 2 Od chwili działu spadku spadkobiercy osoby, na których rzecz zostały uczynione zapisy windykacyjne, ponoszą odpowiedzialność za długi spadkowe proporcjonalnie do wartości otrzymacyjnych, chyba że oświadczenia spadkodawcy lub okoliczności wynika, że darowizna lub zapis windykacyjny zostały dokonane ze zwolnieniem od obowiązku zaliczenia.

§ 2. Spadkodawca może włożyć obowiązek zaliczenia darowizny lub zapisu windykacyjnego na schedę spadkową także na spadkobiercę ustawowego nie wymienionego paragrafie poprzedzającym.

§ 3. Nie podlegają zaliczeniu na schedę spadkową drobne darowizny zwyczajowo danych stosunkach przyjęte.

**Art. 1040.** Jeżeli wartość darowizny lub zapisu windykacyjnego podlegających zaliczeniu przewyższa wartość schedy spadkowej, spadkobierca nie jest obowiązany do zwrotu nadwyżki. W wypadku takim nie uwzględnia przy dziale spadku ani darowizny lub zapisu windykacyjnego, ani spadkobiercy zobowiązanego do ich zaliczenia.
