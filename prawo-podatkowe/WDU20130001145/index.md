...
1. Wniosek doręczenie pisma pochodzący od obcej władzy organ wyznaczony zgodnie art. 154a 7 przekazuje naczelnikowi urzędu skarbowego właściwemu ze względu na miejsce zamieszkania lub siedzibę podmiotu, którego dotyczy wniosek. Naczelnik urzędu skarbowego doręcza pismo stosując odpowiednio przepisy art. 144–154.

2. Organ wyznaczony zgodnie art. 154a 7 niezwłocznie informuje obcą władzę, za pomocą środków komunikacji elektronicznej, przy użyciu standardowego formularza, według wzoru określonego załączniku nr 3 rozporządzenia Komisji (UE) nr 1156/2012 6 grudnia r. ustanawiającego szczegółowe zasady wykonywania niektórych przepisów dyrektywy Rady 2011/16/UE sprawie współpracy administracyjnej dziedzinie opodatkowania, działaniach podjętych na podstawie wniosku doręczenie, szczególności dacie doręczenia pisma.”;

- **2)** art. 291a otrzymuje brzmienie:
- **3)** art. 294 1 pkt 6 otrzymuje brzmienie: „6) przedstawiciele obcej władzy przebywający siedzibach organów podatkowych, obecni toku postępowania podatkowego lub obecni toku czynności kontrolnych, związku wymianą informacji.”;
- **4)** art. 305b art. 305c otrzymują brzmienie: „Art. 305b. Wymiana informacji obejmuje wszelkie informacje, które mogą być istotne celów stosowania wykonywania przepisów prawa podatkowego, wyjątkiem informacji:
- **1)** objętych przepisami Europejskiej dotyczącymi współpracy administracyjnej między państwami członkowskimi podatku od towarów usług, ceł oraz podatku akcyzowego;
- **2)** dotyczących składek na ubezpieczenie społeczne;
- **3)** dotyczących opłaty skarbowej;
- **4)** dotyczących należności charakterze umownym, szczególności wynagrodzeń za usługi użyteczności publicznej.

**Art. 305c.**

1. Organ podatkowy występuje wnioskiem obcej władzy udzielenie informacji oraz udziela jej informacji za pośrednictwem organu wyznaczonego przez ministra właściwego spraw finansów publicznych.

2. Wójt, burmistrz (prezydent miasta), starosta, marszałek województwa oraz samorządowe kolegium odwoławcze przekazują wniosek informacje organu wyznaczonego przez ministra właściwego spraw finansów publicznych za pośrednictwem dyrektora izby skarbowej właściwego miejscowo ze względu na siedzibę wójta, burmistrza (prezydenta miasta), starosty, marszałka województwa albo samorządowego kolegium odwoławczego.

3. Minister właściwy spraw finansów publicznych może upoważnić pracowników izb skarbowych, urzędów skarbowych urzędów kontroli skarbowej bezpośredniej wymiany informacji związku realizowaniem zadań zakresu planowanych lub trwających jednoczesnych kontroli oraz uczestnictwa spotkaniach organizacyjnych dotyczących tych kontroli.
