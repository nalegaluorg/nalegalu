...
3) na plantacjach nasiennych roślin zbożowych, na 1 ha występowanie roślin owsa głuchego , w sztukach, nie może być większe niż:
...
8) występowanie RNQP na plantacjach nasiennych odpowiednich kategorii powinno być zgodne z wymogami określonymi poniżej: III. Wymagania dotyczące wytwarzania materiału siewnego roślin oleistych i włóknistych
...
2) występowanie na plantacji nasiennej chwastów w ilości powodującej ograniczenie wykształcenia nasion lub uniemożliwiającej przeprowadzenie oceny polowej może być podstawą do dyskwalifikacji plantacji nasiennej.
9. Występowanie RNQP na plantacjach nasiennych odpowiednich kategorii powinno być zgodne z wymogami określonymi poniżej: IV. Wymagania dotyczące wytwarzania materiału siewnego buraka cukrowego i pastewnego
...
SZCZEGÓŁOWEWYMAGANIA DOTYCZĄCE WYTWARZANIA I JAKOŚCI SADZENIAKÓW ZIEMNIAKA ORAZ DOPUSZCZALNA WIELKOŚĆPARTII W OBROCIE
...
3. Oceny polowej, pobierania prób do oceny weryfikacyjnej, oceny weryfikacyjnej oraz oceny cech zewnętrznych dokonuje się zgodnie z metodami określonymi w przepisach wydanych na podstawie art. 51 ustawy z dnia 9 listopada 2012 r. o nasiennictwie (Dz. U.
z 2019 r. poz. 568 oraz z 2020 r. poz. 425 i 875).
...
e) partie sadzeniaków przedbazowych są zgodne z następującymi progami dotyczącymi występowania RNQP lub objawów wywołanych przez odnośne RNQP, zgodnie z poniższą tabelą:
...
f) partie sadzeniaków przedbazowych są zgodne z następującymi progami dotyczącymi występowania RNQP lub objawów wywołanych przez odnośne RNQP, zgodnie z poniższą tabelą:
...
22. Partia sadzeniaków ziemniaka kategorii kwalifikowane unijnej klasy B powinna spełniać następujące minimalne wymagania:
1) w ocenie polowej i ocenie weryfikacyjnej:
...
SZCZEGÓŁOWEWYMAGANIA DOTYCZĄCE JAKOŚCI ORAZ DOPUSZCZALNA WIELKOŚĆ PARTII W OBROCIE DLA MATERIAŁU SIEWNEGO ROŚLIN ROLNICZYCH Dopuszczalna wielkość partii oraz minimalna masa prób do badań dla roślin zbożowych W Dopuszczalna wielkość partii oraz minimalna masa prób do badań dla roślin pastewnych W W W W Dopuszczalna wielkość partii oraz minimalna masa prób do badań roślin oleistych i włóknistych W W W W SZCZEGÓŁOWEWYMAGANIA DOTYCZĄCE JAKOŚCI ORAZ DOPUSZCZALNA WIELKOŚĆ PARTII W OBROCIE DLA MATERIAŁU SIEWNEGO ROŚLIN WARZYWNYCH Wielkość partii nasion oraz masa próby do oceny laboratoryjnej Wymagania jakościowe dla nasion roślin warzywnych wszystkich kategorii Wymagania dotyczące chorób i szkodników: Występowanie regulowanych agrofagów niekwarantannowych dla Unii (RNQP) na materiale siewnym warzyw, stwierdzonych przynajmniej na podstawie oceny wzrokowej, nie przekracza odpowiednich progów określonych w tabeli:
