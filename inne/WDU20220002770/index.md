...
- **1)** zaświadczenie wydane przez podmiot, w którym odbył szkolenie praktyczne, obejmujące informacje i dane dotyczące: czasu realizacji szkolenia praktycznego i miejsca jego odbywania, osoby, która dokonała końcowego zaliczenia szkolenia praktycznego – imię, nazwisko i funkcja;
    - **a)**
    - **b)**
...
- **1)** zaświadczenie wydane przez podmiot leczniczy, w którym odbył szkolenie praktyczne, oraz dokumenty obejmujące informacje i dane dotyczące: czasu realizacji szkolenia praktycznego i miejsca jego odbywania, osoby, która dokonała końcowego zaliczenia szkolenia praktycznego – imię, nazwisko i funkcja;
    - **a)**
    - **b)**
...
- **7)** w art. 43a: w ust. 3 wyrazy „z budżetu państwa” zastępuje się wyrazami „przez Fundusz”, uchyla się ust. 5;
    - **a)**
    - **b)**

- **8)** w art. 43b: w ust. 7 wyrazy „z budżetu państwa” zastępuje się wyrazami „przez Fundusz”, uchyla się ust. 9;
    - **a)**
    - **b)**
...
- **5)** pkt 31, 31a i 31b. ” ;
- **12)** w art. 73: pkt 1 otrzymuje brzmienie: „
    - **a)**

- **1)** uczniów, o których mowa w art. 66 ust. 1 pkt 17, powstaje z dniem przyjęcia do szkoły, a wygasa z dniem ukończenia szkoły albo skreślenia z listy uczniów; ” , pkt 4 otrzymuje brzmienie: „
    - **b)**
...
- **c)**
- **16)** w art. 87: w ust. 2 we wprowadzeniu do wyliczenia skreśla się wyrazy „oraz świadczeń pieniężnych dla cywilnych niewidomych ofiar działań wojennych”, w ust. 4 pkt 1 otrzymuje brzmienie: „
    - **a)**
    - **b)**

- **1)** osób wymienionych w art. 66 ust. 1 pkt 1 lit. a i c-i, pkt 1a, 3–8, 8b-16a, 19, 21–23 i 24 – pobierających zasiłek dla bezrobotnych lub stypendium, pkt 24a i 25 – pobierających zasiłek przedemerytalny lub świadczenie przedemerytalne, pkt 26–30 i 32–33 oraz w art. 68 są opłacane i ewidencjonowane w Zakładzie Ubezpieczeń Społecznych, z zastrzeżeniem pkt 2; ” , ust. 5 otrzymuje brzmienie: „
    - **c)**

5. Niezwłocznie, nie później niż w ciągu 5 dni roboczych od dnia wpływu składek na ubezpieczenie zdrowotne, Kasa Rolniczego Ubezpieczenia Społecznego przekazuje pobrane składki na ubezpieczenie zdrowotne wraz z pobranymi odsetkami za zwłokę do centrali Funduszu. ” , po ust. 10g dodaje się ust. 10h w brzmieniu: „

- **d)**

10h. Zakład Ubezpieczeń Społecznych, inne właściwe organy emerytalne i rentowe wypłacające rentę rodzinną działając za pośrednictwem Zakładu Ubezpieczeń Społecznych oraz Kasa Rolniczego Ubezpieczenia Społecznego, przekazują do centrali Funduszu dane dotyczące osób pobierających rentę rodzinną, które nie ukończyły 18. roku życia, określone w art. 188 ust. 4 pkt 1, 3, 4, 7, 9 i 10 oraz datę, od której przysługuje wypłata renty rodzinnej i datę zaprzestania pobierania renty rodzinnej. ” , ust. 11 otrzymuje brzmienie: „
...
- **23)** w art. 118: w ust. 2 w pkt 1 w lit. e w tiret czwartym średnik zastępuje się przecinkiem i dodaje się lit. f w brzmieniu: „ kosztów realizacji zadań, o których mowa w art. 97 ust. 3 pkt 3d i 3e; ” , uchyla się ust. 6;
    - **a)**
    - **f)**
    - **b)**
...
- **1)** w art. 21: w ust. 3 uchyla się pkt 5, w ust. 5 pkt 1 otrzymuje brzmienie: „
    - **a)**
    - **b)**
...
1. Zadania zespołów ratownictwa medycznego, z wyłączeniem lotniczych zespołów ratownictwa medycznego, są finansowane na zasadach i w trybie określonych w ustawie z dnia 27 sierpnia 2004 r. o świadczeniach opieki zdrowotnej finansowanych ze środków publicznych, przez Narodowy Fundusz Zdrowia. ” , w ust. 3: – uchyla się pkt 1, – w pkt 2 przecinek zastępuje się średnikiem, – w pkt 3 dodaje się kropkę, – uchyla się część wspólną, w ust. 4 wyrazy „zadań, o których mowa w ust. 1” zastępuje się wyrazami „dyspozytorni medycznych oraz wsparcia psychologicznego dyspozytorów medycznych”, uchyla się ust. 5–8;

- **b)**
- **c)**
- **d)**
- **4)** w art. 49: uchyla się ust. 1–5, ust. 5a otrzymuje brzmienie: „
    - **a)**
    - **b)**

5a. Dysponenci zespołów ratownictwa medycznego mogą wspólnie ubiegać się o zawarcie umowy na wykonywanie zadań zespołów ratownictwa medycznego. ” , w ust. 6 wyrazy „, o których mowa w ust. 1, przez zespoły ratownictwa medycznego” zastępuje się wyrazami „na zadania zespołów ratownictwa medycznego”;
...
5. Szczepionki służące do przeprowadzania obowiązkowych szczepień ochronnych nabywa minister właściwy do spraw zdrowia zgodnie z przepisami o zamówieniach publicznych, a finansuje Narodowy Fundusz Zdrowia. ” , uchyla się ust. 7;

- **b)**
- **2)** w art. 18a: ust. 2 otrzymuje brzmienie: „
    - **a)**

2. Szczepionki oraz immunologiczne produkty lecznicze, stosowane w razie wystąpienia zagrożenia epidemicznego lub epidemii, nabywa minister właściwy do spraw zdrowia zgodnie z przepisami o zamówieniach publicznych, a finansuje Narodowy Fundusz Zdrowia. ” , uchyla się ust. 3.
...
- **1)** w art. 37: w ust. 6 wyrazy „ustawy z dnia 11 września 2003 r. o służbie wojskowej żołnierzy zawodowych (Dz. U. z 2021 r. poz. 1131, 1666 i 2333)” zastępuje się wyrazami „ustawy z dnia 11 marca 2022 r. o obronie Ojczyzny (Dz. U. poz. 2305)”, w ust. 7 wyrazy „ustawy z dnia 11 września 2003 r. o służbie wojskowej żołnierzy zawodowych” zastępuje się wyrazami „ustawy z dnia 11 marca 2022 r. o obronie Ojczyzny”;
    - **a)**
    - **b)**
...
- **1)** w art. 144: w ust. 1–3 we wprowadzeniu do wyliczenia i w ust. 5 wyrazy „1 stycznia 2023 r.” zastępuje się wyrazami „1 stycznia 2024 r.”, w ust. 5 po wyrazach „martwego urodzenia” dodaje się wyrazy „oraz karta zgonu”;
    - **a)**
    - **b)**
...
- **1)** w ust. 1: we wprowadzeniu do wyliczenia wyrazy „W latach 2017–2026” zastępuje się wyrazami „W latach 2017–2022”, uchyla się pkt 7–10;
    - **a)**
    - **b)**

- **2)** w ust. 2: we wprowadzeniu do wyliczenia wyrazy „W latach 2017–2026” zastępuje się wyrazami „W latach 2017–2022”, uchyla się pkt 7–10;
    - **a)**
    - **b)**
...
- **40)** w art. 16rc: ust. 2 otrzymuje brzmienie: „
    - **a)**

2. PES dla każdej specjalności jest składany w formie egzaminu testowego i egzaminu ustnego, z zastrzeżeniem ust. 10, w kolejności tych egzaminów ustalonej przez dyrektora CEM, obejmujących zakres odbytego szkolenia specjalizacyjnego, ze szczególnym uwzględnieniem procedur diagnostycznych i leczniczych, z wyłączeniem wykonywania inwazyjnych zabiegów i procedur medycznych. ” , ust. 5 i 6 otrzymują brzmienie: „
...
6. Pytania testowe wraz z poprawnymi odpowiedziami po ich wykorzystaniu w danej sesji egzaminacyjnej są publikowane w terminie 7 dni od dnia przeprowadzenia egzaminu na stronie internetowej CEM. ” , uchyla się ust. 7, dodaje się ust. 8–10 w brzmieniu: „
...
- **4)** w art. 28 w pkt 1 lit. f otrzymuje brzmienie: „ pkt 25 lit. c w zakresie art. 16f ust. 3 pkt 1, pkt 2 lit. c-e, f oraz j, pkt 2a i 3, pkt 29 lit. f, pkt 32 lit. b i c, pkt 51 lit. a tiret trzecie, lit. b oraz lit. c w zakresie art. 19f ust. 9a i 9b, które wchodzą w życie z dniem 1 stycznia 2023 r., ” .
    - **f)**
