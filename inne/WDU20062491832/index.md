...
2. Do przychodów własnych nie zalicza się dochodów z najmu i dzierżawy oraz innych umów o podobnym charakterze dotyczących składników majątkowych Skarbu Państwa. ” , po ust. 2 dodaje się ust. 2a w brzmieniu: „
...
- **12)** w art. 26: w ust. 2 zdanie drugie otrzymuje brzmienie: „ Do przychodów własnych nie zalicza się dochodów z najmu lub dzierżawy oraz innych umów o podobnym charakterze dotyczących składników majątkowych Skarbu Państwa. ” , po ust. 2 dodaje się ust. 2a w brzmieniu: „
    - **a)**
    - **b)**
...
1. Jednostki podsektora rządowego, o których mowa w art. 4 ust. 1 pkt 12, sporządzają projekty rocznych planów finansowych, zgodnie z przepisami stanowiącymi podstawę ich utworzenia, z uwzględnieniem przepisów niniejszej ustawy.
...
- **21)** w art. 53 w ust. 5: zdanie wstępne otrzymuje brzmienie: „ Audytor wewnętrzny przedstawia kierownikowi jednostki i Ministrowi Finansów: ” , w pkt 2 kropkę zastępuje się średnikiem i dodaje się pkt 3 w brzmieniu: „
    - **a)**
    - **b)**

- **3)** w każdym czasie, na ich wniosek, informację o przeprowadzanych audytach wewnętrznych. ” ;
- **22)** w art. 56: ust. 1 otrzymuje brzmienie: „
    - **a)**

1. Sprawozdanie z przeprowadzenia audytu wewnętrznego jest przekazywane kierownikowi jednostki oraz Ministrowi Finansów na jego wniosek. ” , ust. 3 otrzymuje brzmienie: „
...
- **25)** w art. 62: uchyla się ust. 2–4, ust. 5 otrzymuje brzmienie: „
    - **a)**
    - **b)**
...
1b. W zakresie środków, o których mowa w art. 5 ust. 3, zadania Ministra Finansów, o których mowa w ust. 1 pkt 5 i 6, wykonuje Generalny Inspektor Kontroli Skarbowej. ” , uchyla się ust. 3 i 4;
...
- **33)** w art. 101 w ust. 1 zdanie wstępne otrzymuje brzmienie: „ Z budżetu państwa, w zakresie ustalonym w ustawie budżetowej, mogą być udzielane pożyczki: ” ;
- **34)** w art. 103 w ust. 2: pkt 6 otrzymuje brzmienie: „
    - **a)**

- **6)** przychody i rozchody związane z finansowaniem potrzeb pożyczkowych budżetu państwa; ” , dodaje się pkt 7 w brzmieniu: „
    - **b)**
...
- **37)** w art. 120: uchyla się ust. 2, ust. 3 otrzymuje brzmienie: „
    - **a)**
    - **b)**

3. Materiały do projektu ustawy budżetowej opracowują i przedstawiają Ministrowi Finansów dysponenci części budżetowych, z zastrzeżeniem ust. 3a. ” , po ust. 3 dodaje się ust. 3a w brzmieniu: „
...
- **40)** w art. 137 w ust. 1: pkt 5 otrzymuje brzmienie: „
    - **a)**

- **5)** tryb i zasady wydawania decyzji dotyczących zapewnienia finansowania z budżetu państwa projektów finansowanych z udziałem środków, o których mowa w art. 5 ust. 1 pkt 2; ” , dodaje się pkt 6 w brzmieniu: „
    - **b)**
...
- **43)** w art. 148: po ust. 1 dodaje się ust. 1a w brzmieniu: „
    - **a)**

1a. Przeniesienie polegające na zmniejszeniu lub zwiększeniu wydatków przeznaczonych na finansowanie programów realizowanych z udziałem środków, o których mowa w art. 5 ust. 3 pkt 2, wymaga zgody ministra właściwego do spraw rozwoju regionalnego. ” , ust. 6 otrzymuje brzmienie: „
...
- **55)** w art. 172: w ust. 1 pkt 2 otrzymuje brzmienie: „
    - **a)**
...
- **57)** w art. 184 w ust. 1: pkt 1 otrzymuje brzmienie: „
    - **a)**

- **1)** prognozowane dochody jednostki samorządu terytorialnego według źródeł i działów klasyfikacji w podziale na dochody: bieżące i majątkowe; ” , pkt 6 otrzymuje brzmienie: „
    - **b)**
...
- **58)** w art. 186 w ust. 8: uchyla się pkt 3, pkt 4 otrzymuje brzmienie: „
    - **a)**
    - **b)**

- **4)** terminy odprowadzania dochodów budżetu państwa, pobranych przez jednostki samorządu terytorialnego. ” ;
- **59)** w art. 188: po ust. 1 dodaje się ust. 1a i 1b w brzmieniu: „
    - **a)**
...
1b. Zmiany, o których mowa w ust. 1a, mogą być dokonywane w związku z wnioskiem beneficjenta pomocy udzielanej ze środków przewidzianych na realizację regionalnych programów operacyjnych, wyłącznie w ramach przyznanych środków. ” , w ust. 2 w pkt 2 kropkę zastępuje się średnikiem i dodaje się pkt 3 w brzmieniu: „
...
- **61)** w art. 191: ust. 1 otrzymuje brzmienie: „
    - **a)**

1. Niezrealizowane kwoty wydatków zamieszczonych w budżecie jednostki samorządu terytorialnego, wygasają z upływem roku budżetowego, z zastrzeżeniem ust. 1a i 2. ” , po ust. 1 dodaje się ust. 1a w brzmieniu: „
...
1. Środki, o których mowa w art. 5 ust. 3 pkt 2–4, są gromadzone na wyodrębnionych rachunkach bankowych, prowadzonych w euro.
...
1. Środki, o których mowa w art. 5 ust. 3 pkt 2–4, są przeznaczone na cele określone w umowie międzynarodowej, przepisach odrębnych lub deklaracji dawcy.
...
1. Samorząd województwa, będący instytucją zarządzającą w rozumieniu ustawy o zasadach prowadzenia polityki rozwoju, otrzymuje z budżetu państwa, w formie zaliczki, dotację rozwojową na realizację regionalnego programu operacyjnego.
...
1. Samorząd województwa, będący instytucją zarządzającą, udziela dotacji beneficjentom regionalnych programów operacyjnych.
...
- **2)** środki na realizację programu, w tym: środki pochodzące z budżetu Unii Europejskiej, środki pochodzące z budżetu państwa, środki pochodzące z budżetów jednostek samorządu terytorialnego, inne publiczne środki krajowe, inne środki;
    - **a)**
    - **b)**
    - **c)**
    - **d)**
...
1. Szczegółowe warunki przekazywania i wykorzystania dotacji rozwojowej, o której mowa w art. 202, określa umowa zawarta przez dysponenta środków z beneficjentem dotacji.
...
1. W przypadku gdy środki, o których mowa w art. 5 ust. 3 pkt 2, 3a i 4, a także środki przeznaczone na finansowanie programów i projektów realizowanych z tych środków lub dotacji, o których mowa w art. 202, są:
...
- **2)** roczne sprawozdanie finansowe Agencji, w tym bilans, rachunek zysków i strat, informację dodatkową oraz sprawozdanie z przepływu środków pieniężnych. ” , ust. 2 otrzymuje brzmienie: „
    - **b)**
...
**Art. 14.** W ustawie z dnia 20 kwietnia 2004 r. o Narodowym Planie Rozwoju (Dz. U. Nr 116, poz. 1206, z 2005 r. Nr 90, poz. 759 i Nr 267, poz. 2251 oraz z 2006 r. Nr 149, poz. 1074) w art. 56b ust. 4 otrzymuje brzmienie: „ 4. W posiedzeniach komitetu, o którym mowa w ust. 1, mogą uczestniczyć w charakterze obserwatorów przedstawiciele Prezesa Najwyższej Izby Kontroli oraz ministra właściwego do spraw finansów publicznych. ” .
...
- **2)** sprawozdanie z realizacji rocznego programu działalności jednostki doradztwa rolniczego, o którym mowa w art. 8 ust. 1 pkt 1 – w terminie do dnia 31 stycznia roku następującego po roku, który sprawozdanie obejmuje. ” , po ust. 1 dodaje się ust. 1a w brzmieniu: „
    - **b)**
