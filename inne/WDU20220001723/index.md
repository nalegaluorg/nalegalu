...
- **4)** po art. 16 dodaje się art. 16 w brzmieniu:
...
- **5)** po art. 16b dodaje się art. 16c w brzmieniu:
  ...
  > 4. W przypadku braku:  
  > 1) zgody na dostosowanie lub wymianę instalacji i urządzeń, wyrażonej przez podmioty, o których mowa w ust. 3, lub 2) technicznych możliwości dostosowania lub wymiany instalacji i urządzeń u podmiotów, o których mowa w ust. 3, lub 3) dostosowania lub wymiany instalacji i urządzeń, o których mowa w ust. 2, po otrzymaniu informacji od operatora systemu dystrybucyjnego gazowego albo przesyłowego gazowego, o której mowa w ust. 1 – operator systemu przesyłowego gazowego lub dystrybucyjnego gazowego, do którego sieci dany odbiorca jest przyłączony, może wstrzymać dostarczanie paliw gazowych, z uwzględnieniem ust. 5.  
...
- **8)** po art. 52 dodaje się art. 52 w brzmieniu:
