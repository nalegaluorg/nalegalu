...
- **2)** w art. 44: w ust. 1 po pkt 12b dodaje się pkt 12c w brzmieniu: „
    - **a)**

- **12c)** nakazać posiadaczowi gospodarstwa podjęcie określonych działań w celu umożliwienia wykonania odstrzału sanitarnego zwierząt wolno żyjących (dzikich) lub zakazać działań uniemożliwiających lub utrudniających wykonanie tego odstrzału; ” , po ust. 1a dodaje się ust. 1b w brzmieniu: „
    - **b)**

1b. Jeżeli na obszarze innego powiatu istnieje konieczność zastosowania środków, o których mowa w ust. 1 pkt 12a oraz 13–15 i 17, powiatowy lekarz weterynarii wnioskuje o zastosowanie tych środków do właściwego powiatowego lekarza weterynarii, który wydaje decyzję w sprawie zastosowania tych środków. ” , ust. 2 otrzymuje brzmienie: „

- **c)**

2. Decyzjom, o których mowa w ust. 1–1b, nadaje się rygor natychmiastowej wykonalności. ” ;

- **3)** w art. 45 w ust. 1: po pkt 3 dodaje się pkt 3a w brzmieniu: „
    - **a)**

- **3a)** zakazać utrzymywania, chowu lub hodowli zwierząt z gatunków wrażliwych; ” , pkt 8c otrzymuje brzmienie: „
    - **b)**

- **8c)** nakazać zarządcom dróg publicznych wykładanie mat dezynfekcyjnych, a także ich utrzymywanie po wyłożeniu w stanie zapewniającym skuteczne działanie środka dezynfekcyjnego; ” , po pkt 8e dodaje się pkt 8f w brzmieniu: „
    - **c)**

- **8f)** nakazać pobieranie próbek do badań laboratoryjnych i określić sposób ich pobierania; ” ;
- **4)** w art. 46 w ust. 3: po pkt 3 dodaje się pkt 3a w brzmieniu: „
    - **a)**

- **3a)** zakazać utrzymywania, chowu lub hodowli zwierząt z gatunków wrażliwych, lub ” , pkt 8d otrzymuje brzmienie: „
    - **b)**

- **8d)** nakazać zarządcom dróg publicznych wykładanie mat dezynfekcyjnych, a także ich utrzymywanie po wyłożeniu w stanie zapewniającym skuteczne działanie środka dezynfekcyjnego, lub ” , po pkt 8f dodaje się pkt 8g w brzmieniu: „
    - **c)**
