...
Zakres Podstawowa ocena stanu zdrowia w przypadku skaz krwotocznych ma świadczenia na celu kontrolę przebiegu skazy krwotocznej, wczesne wykrycie powikłań związanych z chorobą, jak i stosowaną terapią oraz ustalenie optymalnego sposobu leczenia.
Świadczenie obejmuje:
...
Zapewnienie Panel badań laboratoryjnych stosowanych do podstawowej oceny stanu realizacji zdrowia obejmuje następujące badania: badań 1) morfologia krwi, z pełnym różnicowaniem granulocytów;
2) ferrytyna;
...
d) badań wątrobowych,
e) innych badań uwarunkowanych oceną kliniczną pacjenta.
Zapewnienie Panel badań laboratoryjnych i obrazowych stosowanych do rozszerzonej realizacji oceny stanu zdrowia obejmuje następujące badania: badań 1) morfologia krwi, z pełnym różnicowaniem granulocytów;
