...
poz. 806).
§ 2. Symulator powinien spełniać wymagania następujących norm:
...
§ 4. Symulator powinien być oznakowany tabliczką znamionową umieszczoną w łatwo dostępnym miejscu na zasadniczym elemencie konstrukcyjnym symulatora, zawierającą co najmniej:
...
§ 11. Symulator powinien być wyposażony w system generujący efekty dźwiękowe słyszane przez osobę szkoloną w kabinie rzeczywistego pojazdu:
...
§ 12. 1. Symulator powinien być wyposażony w komputerowy układ generowania „trójwymiarowego”, barwnego obrazu wirtualnego środowiska widzianego z kabiny symulatora.
...
1) przyspieszeń translacyjnych z przedziału co najmniej ± 4 m/s ;
2) prędkości translacyjnych z przedziału co najmniej ± 0,3 m/s;
3) przyspieszeń kątowych z przedziału co najmniej ± 200 stopni/s ;
4) prędkości kątowych z przedziału co najmniej ± 30 stopni/s.
§ 14. 1. Stanowisko instruktora powinno umożliwiać realizację następujących funkcji:
...
§ 15. 1. System informatyczny symulatora, o którym mowa w § 9 pkt 2, powinien:
1) umożliwiać:
