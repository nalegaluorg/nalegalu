...
1. Podmiot, o którym mowa w art. 16 ust. 3, który na podstawie przepisów o podatku akcyzowym nie podlega obowiązkowi produkcji wina gronowego w składzie podatkowym, jest obowiązany spełniać następujące warunki: Dopracować w formie pisemnej oraz wdrożyć system kontroli wewnętrznej wyrobu i rozlewu wina gronowego, obejmujący określenie: częstotliwości i sposobu pobierania próbek jakościowych, metod badań, sposobu postępowania z winami gronowymi nieodpowiadającymi wymaganiom jakościowym, zabezpieczania i usuwania odpadów powstających podczas produkcji;
