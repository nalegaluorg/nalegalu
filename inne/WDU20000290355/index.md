...
| Pole | Wartość |
|---|---|
| Adres publikacyjny | Dz.U. 2000 nr 29 poz. 355 |
| ISAP | WDU20000290355 |
| Typ aktu | Ustawa |
| Status | akt objęty tekstem jednolitym |
| W mocy | tak |
...
4. Do lokalu mogą przynależeć, jako jego części składowe, pomieszczenia, choćby nawet do niego bezpośrednio nie przylegały lub były położone w granicach nieruchomości gruntowej poza budynkiem, w którym wyodrębniono dany lokal, a w szczególności: piwnica, strych, komórka, garaż, zwane dalej «pomieszczeniami przynależnymi». ” , po ust. 4 dodaje się ust. 5 i ust. 6 w brzmieniu: „
...
3. Udział właściciela lokalu wyodrębnionego w nieruchomości wspólnej odpowiada stosunkowi powierzchni użytkowej lokalu wraz z powierzchnią pomieszczeń przynależnych do łącznej powierzchni użytkowej wszystkich lokali wraz z pomieszczeniami do nich przynależnymi. Udział właściciela samodzielnych lokali niewyodrębnionych w nieruchomości wspólnej odpowiada stosunkowi powierzchni użytkowej tych lokali wraz z powierzchnią pomieszczeń przynależnych do łącznej powierzchni użytkowej wszystkich lokali wraz z pomieszczeniami do nich przynależnymi. ” , w ust. 5 po wyrazie „przynależnymi” przecinek zastępuje się kropką oraz skreśla się wyrazy „znajdującymi się w tych budynkach”, ust. 6 otrzymuje brzmienie: „

- **b)**
- **c)**

6. W wypadku gdy na podstawie jednej czynności prawnej dokonanej przez właściciela lub przez wszystkich współwłaścicieli nieruchomości następuje wyodrębnienie wszystkich lokali, wysokość udziałów, o których mowa w ust. 1, określają odpowiednio w umowie właściciel lub współwłaściciele. ” , po ust. 6 dodaje się ust. 7 w brzmieniu: „
...
- **3)** w art. 5: dotychczasową treść oznacza się jako ust. 1, dodaje się ust. 2 w brzmieniu: „
    - **a)**
    - **b)**
...
- **5)** w art. 18: w ust. 2a wyrazy „sporządzonej w formie aktu notarialnego” zastępuje się wyrazami „zaprotokołowanej przez notariusza”, ust. 3 otrzymuje brzmienie: „
    - **a)**
    - **b)**
...
- **12)** w art. 26: dotychczasową treść oznacza się jako ust. 1, dodaje się ust. 2 w brzmieniu: „
    - **a)**
    - **b)**
...
- **13)** w art. 29: ust. 1 i ust. 1a otrzymują brzmienie: „
    - **a)**
...
1a. Okresem rozliczeniowym wspólnoty mieszkaniowej jest rok kalendarzowy. ” , po ust. 1a dodaje się ust. 1b-1e w brzmieniu: „
...
1e. Zarząd lub zarządca, któremu zarząd nieruchomością wspólną powierzono w sposób określony w art. 18 ust. 1, może żądać od właścicieli lokali okazania dokumentów potwierdzających prawo własności lokali. ” , w ust. 2 po wyrazie „zarządowi” dodaje się wyrazy „lub zarządcy, któremu zarząd nieruchomością wspólną powierzono w sposób określony w art. 18 ust. 1,”;
...
- **3)** zwoływać zebranie ogółu właścicieli co najmniej raz w roku, nie później niż w pierwszym kwartale każdego roku. ” , po ust. 1 dodaje się ust. 1a w brzmieniu: „
    - **b)**

1a. W wypadku gdy zarząd lub zarządca, któremu zarząd nieruchomością wspólną powierzono w sposób określony w art. 18 ust. 1, nie zwoła zebrania ogółu właścicieli lokali w terminie, o którym mowa w ust. 1 pkt 3, zebranie coroczne może zwołać każdy z właścicieli. ” , w ust. 2 w pkt 2 skreśla się przecinek i dodaje się wyrazy „lub zarządcy, któremu zarząd nieruchomością wspólną powierzono w sposób określony w art. 18 ust. 1,”;
...
mogą być także, w razie potrzeby, zwoływane przez zarząd lub zarządcę, któremu zarząd nieruchomością wspólną powierzono w sposób określony w art. 18 ust. 1, zwoływane są na wniosek właścicieli lokali dysponujących co najmniej 1/10 udziałów w nieruchomości wspólnej przez zarząd lub zarządcę, któremu zarząd nieruchomością wspólną powierzono w sposób określony w art. 18 ust. 1. ” ;

- **a)**
- **b)**
- **16)** w art. 32: w ust. 1 po wyrazie „zarząd” dodaje się wyrazy „lub zarządca, któremu zarząd nieruchomością wspólną powierzono w sposób określony w art. 18 ust. 1,” w ust. 2 wyraz „czas” zastępuje się wyrazami „dzień, godzinę”;
    - **a)**
    - **b)**
