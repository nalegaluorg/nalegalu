...
# RZECZYPOSPOLITEJ POLSKIEJ Poz. 1104 ROZPORZĄDZENIE MINISTRA ZDROWIA z dnia 6 czerwca 2017 r.

| Pole | Wartość |
|---|---|
| Adres publikacyjny | Dz.U. 2017 poz. 1104 |
| ISAP | WDU20170001104 |
...
| Źródło | [ISAP](https://isap.sejm.gov.pl/isap.nsf/DocDetails.xsp?id=WDU20170001104) · [PDF](https://api.sejm.gov.pl/eli/acts/DU/2017/1104/text.pdf) |

w sprawie niepowtarzalnego oznakowania, sposobu oznaczania i monitorowania komórek, tkanek i narządów Na podstawie art. 37e ustawy z dnia 1 lipca 2005 r. o pobieraniu, przechowywaniu i przeszczepianiu komórek, tkanek i narządów (Dz. U. z 2017 r. poz. 1000) zarządza się, co następuje:
...
§ 3. 1. Niepowtarzalne oznakowanie komórek lub tkanek w postaci zastosowania jednolitego kodu europejskiego wykorzystuje elementy systemów kodowania (ISBT 128, Eurocode, EUTC) i obejmuje:
1) kod ISO kraju;
...
§ 4. Niepowtarzalne oznakowanie komórek lub tkanek bez zastosowania jednolitego kodu europejskiego obejmuje co najmniej:
...
d) datę ważności.
§ 5. Niepowtarzalne oznakowanie narządów obejmuje:
1) kod kraju;
...
6) kod narządu;
7) grupę krwi.
§ 6. 1. Niepowtarzalne oznakowanie zapisuje się na etykiecie ostatecznej, która powinna być trwała i nie ulegać zniszczeniu pod wpływem warunków, w jakich jest przeprowadzane:
...
§ 9. Analiza i weryfikacja, o których mowa w § 8 pkt 3, dotyczą następujących danych:
...
§ 10. Analiza i weryfikacja, o których mowa w § 8 pkt 4, dotyczą:
...
§ 11. Analiza i weryfikacja, o których mowa w § 8 pkt 5, dotyczą powtarzalności stosowanych procesów i czynności testowania.
§ 12. Analiza i weryfikacja, o których mowa w § 8 pkt 6, dotyczą:
...
§ 13. Analiza i weryfikacja, o których mowa w § 8 pkt 7, dotyczą:
...
§ 14. Analiza i weryfikacja, o których mowa w § 8 pkt 8, dotyczą następujących danych:
...
§ 15. 1. W ramach monitorowania podejrzenia istotnego zdarzenia niepożądanego i istotnej reakcji niepożądanej, o którym mowa w § 8 pkt 9, związanego z:
...
§ 16. W ramach monitorowania, w celu zapewnienia bezpieczeństwa zdrowotnego biorcy, niepowtarzalne oznakowanie umieszcza się, po przeszczepieniu komórek, tkanek lub narządów lub po zastosowaniu komórek lub tkanek, w dokumentacji medycznej biorcy.
§ 17. 1. Banki tkanek i komórek dostosują swoją działalność do wymogów określonych w niniejszym rozporządzeniu, w zakresie oznaczania komórek i tkanek za pomocą jednolitego kodu europejskiego, w terminie 18 miesięcy od dnia jego wejścia w życie.
...
Minister Zdrowia: K. Radziwiłł STRUKTURA JEDNOLITEGO KODU EUROPEJSKIEGO SEKWENCJA IDENTYFIKACYJNA DONACJI SEKWENCJA IDENTYFIKACYJNA TKANEK I KOMÓREK Europejski kod banku tkanek Kod tkanek i komórek i komórek Niepowtarzalny Identyfikator Numer Data Kod ISO Numer banku numer donacji systemu Numer tkanek podziału ważności kraju tkanek kodowania i komórek (rrrr-mm-dd) tkanek i komórek 2 znaki 6 znaków 13 znaków 1 znak 7 znaków 3 znaki 8 znaków alfabetyczne alfanumerycznych alfanumerycznych alfabetyczny alfanumerycznych alfanumeryczne numerycznych
