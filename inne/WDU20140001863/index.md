...
| Pole | Wartość |
|---|---|
| Adres publikacyjny | Dz.U. 2014 poz. 1863 |
| ISAP | WDU20140001863 |
| Typ aktu | Ustawa |
| Status | akt posiada tekst jednolity |
| W mocy | tak |
...
- **2)** drogą elektroniczną, za pośrednictwem ministra właściwego do spraw rodziny z systemu informacji oświatowej, o którym mowa w przepisach o systemie informacji oświatowej – odpowiednio informacji, o których mowa w art. 21 ust. 1 pkt 1, 2, 5, 7, 8, 8a, 10 i

11. Przedstawienie dokumentu potwierdzającego prawo do zamieszkania na terytorium Rzeczypospolitej Polskiej nie jest wymagane w przypadku, gdy wójt może bezpłatnie uzyskać dostęp do danych potwierdzających to prawo, dane te są mu znane z urzędu lub możliwe do ustalenia na podstawie danych, którymi rozporządza.
