...
§ 4.
Wskaźnik stężenia promieniotwórczego izotopów promieniotwórczych potasu K-40, radu Ra-226 i toru Th-232 (wskaźnik I) wyznacza się według wzoru: \( I = {{C_{K – 40} } \over {3000Bq/kg}} + {{C_{Ra – 226} } \over {300Bq/kg}} + {{C_{Th – 232} } \over {200Bq/kg}} \) gdzie: aaaCK-40, CRa-226 i CTh-232- oznaczają odpowiednio stężenia promieniotwórcze izotopów potasu K-40, radu Ra-226 i toru Th-232, wyrażone w bekerelach na kilogram (Bq/kg).
§ 5.
