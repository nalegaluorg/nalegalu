...
- **15a)** roślina, zwierzę lub grzyb dziko występujący – roślinę, zwierzę lub grzyba: niepochodzące z uprawy lub hodowli, wprowadzone do środowiska przyrodniczego w celu odbudowy lub zasilenia populacji; ” ;
    - **a)**
    - **b)**

- **3)** w art. 28: w ust. 11 pkt 3a otrzymuje brzmienie: „
    - **a)**

- **3a)** pokrywającego się w całości lub w części z obszarem będącym w zarządzie nadleśnictwa, dla którego ustanowiony plan urządzenia lasu uwzględnia zakres, o którym mowa w ust. 10; ” , po ust. 11 dodaje się ust. 11a-11d w brzmieniu: „
    - **b)**
...
- **4)** w art. 48: w pkt 1 wprowadzenie do wyliczenia otrzymuje brzmienie: „ gatunki roślin: ” , pkt 2 otrzymuje brzmienie: „
    - **a)**
    - **b)**
...
- **5)** w art. 49: w pkt 1: – wprowadzenie do wyliczenia otrzymuje brzmienie: „ gatunki: ” , – uchyla się lit. d, pkt 2 otrzymuje brzmienie: „
    - **a)**
    - **b)**
...
- **6)** w art. 50: w pkt 1 wprowadzenie do wyliczenia otrzymuje brzmienie: „ gatunki grzybów: ” , pkt 2 otrzymuje brzmienie: „
    - **a)**
    - **b)**
...
- **11)** umyślnego wprowadzania do środowiska przyrodniczego. ” , po ust. 1 dodaje się ust. 1a w brzmieniu: „
    - **b)**
...
- **5)** umyślnego wprowadzania do środowiska przyrodniczego. ” , ust. 2 otrzymuje brzmienie: „
    - **c)**
...
- **8)** w art. 52: ust. 1 otrzymuje brzmienie: „
    - **a)**
...
- **16)** umyślnego wprowadzania do środowiska przyrodniczego. ” , po ust. 1 dodaje się ust. 1a w brzmieniu: „
    - **b)**
...
- **8)** umyślnego wprowadzania do środowiska przyrodniczego. ” , ust. 2 otrzymuje brzmienie: „
    - **c)**
...
- **9)** zbierania i przechowywania piór ptaków. ” , uchyla się ust. 3, dodaje się ust. 4 w brzmieniu: „
    - **d)**
    - **e)**
...
- **10)** w art. 56: ust. 1 i 2 otrzymują brzmienie: „
    - **a)**
...
- **2)** objętych ochroną ścisłą – na czynności podlegające zakazom określonym w art. 51 ust. 1 pkt 1–8, 10 i 11 i ust. 1a pkt 1–3 i 5 oraz art. 52 ust. 1 pkt 2, 4–10 i 12–15 i ust. 1a pkt 2–6. ” , po ust. 2 dodaje się ust. 2a i 2b w brzmieniu: „
    - **b)**
...
4a. Warunek wydania zezwolenia, o którym mowa w ust. 4 pkt 6, w przypadku gatunków ptaków dotyczy jedynie wydania zezwolenia na niszczenie siedlisk lub ostoi, będących ich obszarem rozrodu, wychowu młodych, odpoczynku, migracji lub żerowania. ” , po ust. 4a dodaje sie ust. 4b-4d w brzmieniu: „
...
7b. Czynności kontrolne są wykonywane przez osoby posiadające imienne upoważnienie wydane przez organy właściwe do wydania zezwoleń, o których mowa w ust. 1, 2 i 2b. ” , ust. 7j i 7k otrzymują brzmienie: „
...
- **2)** posiadania, darowizny, transportu, wwożenia lub wywożenia przez wewnątrzwspólnotową granicę państwa oraz czynności, które zostały w tym zwolnieniu dopuszczone w stosunku do okazów gatunków. ” , w ust. 8 dodaje się zdanie drugie w brzmieniu: „ Raport zawiera również informację o wydanych upoważnieniach, o których mowa w art. 52 ust. 2 pkt 3. ” , w ust. 8b dodaje się zdanie drugie w brzmieniu: „ Raport zawiera również informację o pomocy udzielonej zwierzętom na podstawie art. 52 ust. 2 pkt 4. ” ;
    - **k)**
    - **l)**
...
- **12)** w art. 58: ust. 1 i 2 otrzymują brzmienie: „
    - **a)**
...
2. Na podstawie informacji, o której mowa w ust. 1, Generalny Dyrektor Ochrony Środowiska podejmuje badania lub działania ochronne, w celu zapewnienia, aby przypadkowe chwytanie i zabijanie nie miało znaczącego negatywnego wpływu na te gatunki. ” , dodaje się ust. 3 w brzmieniu: „
...
- **18)** w art. 120: ust. 2 otrzymuje brzmienie: „
    - **a)**
...
- **2)** przetrzymywanie, hodowlę, rozmnażanie, oferowanie do sprzedaży i zbywanie gatunków, o których mowa w pkt 1 – wydaje właściwy regionalny dyrektor ochrony środowiska. ” , uchyla się ust. 2a, w ust. 2b w pkt 7 średnik zastępuje się kropką i uchyla pkt 8, w ust. 2d wprowadzenie do wyliczenia otrzymuje brzmienie: „ Organ, o którym mowa w ust. 2: ” , w ust. 2e wprowadzenie do wyliczenia otrzymuje brzmienie: „ Organ, o którym mowa w ust. 2, cofa zezwolenie, o którym mowa w tym przepisie, jeżeli: ” , dodaje się ust. 2g i 2h w brzmieniu: „
    - **b)**
    - **c)**
    - **d)**
    - **e)**
...
- **2)** zakaz – poza polowaniami i odłowami, sprawdzianami pracy psów myśliwskich, a także szkoleniami ptaków łowczych i psów myśliwskich, organizowanymi przez Polski Związek Łowiecki – płoszenia, chwytania, przetrzymywania, ranienia i zabijania zwierzyny; ” , w pkt 3 kropkę zastępuje się średnikiem i dodaje pkt 4 w brzmieniu: „
    - **b)**
...
- **4)** w art. 44: w ust. 3b po pkt 5 dodaje się pkt 5a w brzmieniu: „
    - **a)**

- **5a)** określenie warunków realizacji wynikających z potrzeb ochrony populacji gatunków zwierząt łownych i ich siedlisk w rejonie wykonywania czynności; ” , dodaje się ust. 5–12 w brzmieniu: „
    - **b)**
