...
2. W przypadku gdy usługi są świadczone ze stałego miejsca prowadzenia działalności gospodarczej usługodawcy znajdującego miejscem świadczenia tych usług jest to stałe miejsce prowadzenia działalności gospodarczej.
...
- **16)** w art. 42 w ust. 4 pkt 1 i 2 otrzymują brzmienie: miejsca zamieszkania podatnika dokonującego wewnątrzwspólnotowej dostawy towarów oraz nabywcy tych towarów;
...
4. W przypadku gdy płatności z tytułu świadczenia usług, o których mowa w art. 134a ust. 1, odbywały się w innych walutach niż złosami celnymi stosowanymi na potrzeby określenia wartości celnej importowanych towarów.
