...
- **2)** w art. 9:
    - **a)** w ust. 3: – pkt 2a otrzymuje brzmienie: „2a) posiadać w spółkach prawa handlowego prowadzących działalność gospodarczą związaną z realizacją przez ten związek jego zadań statutowych akcji lub udziałów;”, – w pkt 3 kropkę zastępuje się średnikiem i dodaje się pkt 4–10 w brzmieniu:
...
- **6)** w art. 32:
    ...
    - **c)** ust. 7 otrzymuje brzmienie:
      ...
      > 1) szczegółowy tryb przyznawania członkowi kadry narodowej stypendium sportowego, a także wstrzymywania i pozbawiania tego stypendium, 2) przedział wysokości stypendium sportowego, stanowiący krotność kwoty bazowej, 3) czas, na jaki stypendium sportowe może zostać przyznane, 4) sposób i terminy wypłacania stypendium sportowego – uwzględniając zajęte przez członka kadry narodowej miejsce we współzawodnictwie międzynarodowym i sprawną realizację wypłaty stypendiów sportowych.”;  
