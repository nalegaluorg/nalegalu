...
5) zakres danych gromadzonych w rejestrach, o których mowa w art. 19 ust. 16a–16c ustawy z dnia 6 kwietnia 1990 r.
o Policji;
...
§ 4. 1. Wzór rejestru postanowień sądu okręgowego dotyczących kontroli prowadzonej przez Policję jest określony w załączniku nr 6 do rozporządzenia, który zawiera:
...
§ 5. 1. Przekazywanie dokumentacji kontroli odbywa się za pośrednictwem przedstawiciela właściwego organu Policji, posiadającego pisemne upoważnienie.
...
§ 10. 1. Kopię zapisu cyfrowego wykonuje się w tym samym formacie, w którym utrwalono zapis na nośniku pierwotnym lub wtórnym, bez dzielenia plików ani wprowadzania jakichkolwiek zmian w stosunku do zapisu zarejestrowanego podczas prowadzenia kontroli.
