...
| Pole | Wartość |
|---|---|
| Adres publikacyjny | Dz.U. 2001 nr 16 poz. 166 |
| ISAP | WDU20010160166 |
| Typ aktu | Ustawa |
| Status | obowiązujący |
| W mocy | tak |
...
- **1)** w art. 1 ust. 2 i 3 otrzymują brzmienie: „2. Cudzoziemcem w rozumieniu ustawy jest: 1) osoba fizyczna nie posiadająca obywatelstwa polskiego, 2) osoba prawna mająca siedzibę za granicą, 3) nie posiadająca osobowości prawnej spółka osób wymienionych w pkt 1 lub 2, mająca siedzibę za granicą, utworzona zgodnie z ustawodawstwem państw obcych, 4) osoba prawna i spółka handlowa nie posiadająca osobowości prawnej mająca siedzibę na terytorium Rzeczypospolitej Polskiej, kontrolowana bezpośrednio lub pośrednio przez osoby lub spółki wymienione w pkt 1, 2 i 3. 3. W przypadku spółki handlowej za kontrolowaną uważa się spółkę, w której cudzoziemiec lub cudzoziemcy mają pozycję dominującą. Art. 4 § 1pkt 4 Kodeksu spółek handlowych stosuje się odpowiednio.”;
