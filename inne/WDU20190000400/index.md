...
# RZECZYPOSPOLITEJ POLSKIEJ Poz. 400 ROZPORZĄDZENIE MINISTRA SPRAW WEWNĘTRZNYCH I ADMINISTRACJI z dnia 26 lutego 2019 r.

| Pole | Wartość |
|---|---|
| Adres publikacyjny | Dz.U. 2019 poz. 400 |
| ISAP | WDU20190000400 |
...
| Źródło | [ISAP](https://isap.sejm.gov.pl/isap.nsf/DocDetails.xsp?id=WDU20190000400) · [PDF](https://api.sejm.gov.pl/eli/acts/DU/2019/400/text.pdf) |

w sprawie warstwy elektronicznej dowodu osobistego Na podstawie art. 12j ustawy z dnia 6 sierpnia 2010 r. o dowodach osobistych (Dz. U. z 2017 r. poz. 1464, z 2018 r.
poz. 730 oraz z 2019 r. poz. 53 i 60) zarządza się, co następuje:
...
**§ 3.** Nawiązanie połączenia pomiędzy warstwą elektroniczną dowodu osobistego a urządzeniem lub systemem teleinformatycznym za pośrednictwem czytnika kart wymaga podania numeru CAN.
...
**§ 25.** Rozporządzenie wchodzi w życie z dniem 4 marca 2019 r. Minister Spraw Wewnętrznych i Administracji: wz. K. Kozłowski Załączniki do rozporządzenia Ministra Spraw Wewnętrznych i Administracji z dnia 26 lutego 2019 1. Warstwę elektroniczną dowodu osobistego stanowią:
...
3. Warstwa elektroniczna dowodu osobistego wraz z dokumentacją ją opisującą stanowi łącznie przedmiot oceny w rozumieniu normy PN ISO/IEC 15408 lub normy równoważnej. II.
...
2. Dopuszcza się, że poszczególne komponenty warstwy elektronicznej dowodu osobistego będącego przedmiotem oceny bezpieczeństwa mogą mieć certyfikaty uprzednio wydane przez jednostkę certyfikującą, o której mowa w pkt II. 3. V.
...
3. Ocena bezpieczeństwa apletu jest dokonywana na poziomie uzasadnionego zaufania do zabezpieczeń nie niższym niż poziom EAL4, rozszerzonym o odpowiednie komponenty ALC_DVS.2, ATE_DPT.1, AVA_VAN.5. VI. Mikroprocesor spełnia następujące minimalne wymagania:
...
- **10)** zapewnienie identyfikacji mikroprocesora, tzn. umieszczenie danych inicjujących oraz danych przed personalizacją w nieulotnej pamięci mikroprocesora. VII. Mikroprocesor lub mikroprocesor wraz z implementacją bibliotek kryptograficznych spełnia następujące wymagania:
...
- **5)** zapewnia środki bezpieczeństwa przed pozostawieniem informacji szczątkowych w pamięci operacyjnej po zrealizowaniu funkcji kryptograficznej. VIII. Platforma operacyjna warstwy elektronicznej dowodu osobistego spełnia wymagania funkcjonalne i wymagania bezpieczeństwa określone w profilu zabezpieczeń, zawarte w dokumencie „Java Card Protection Profile – Open Configuration, Version 3.0, May 2012” (ANSSI-PP-2010/03-M01) lub nowszym. IX.
...
- **8)** zapewnia poufność i integralność danych użytkownika, danych służących do realizacji funkcji bezpieczeństwa oraz wbudowanego oprogramowania warstwy elektronicznej dowodu osobistego przed naruszeniem bezpieczeństwa fizycznego przez zastosowanie środków chroniących przed atakami polegającymi na: WZÓR Zgłoszenie zawieszenia certyfikatów w dowodzie osobistym WYPEŁNIAJ WIELKIMI LITERAMI WZÓR Zgłoszenie cofnięcia zawieszenia certyfikatów w dowodzie osobistym WYPEŁNIAJ WIELKIMI LITERAMI WZÓR Zaświadczenie o zgłoszeniu zawieszenia certyfikatów w dowodzie osobistym WZÓR Zaświadczenie o zgłoszeniu cofnięcia zawieszenia certyfikatów w dowodzie osobistym
