...
- **2)** w § 6 ust. 1 otrzymuje brzmienie:
  ...
  > 1) na kolejny stopień służbowy w korpusie oficerów, 2) na stopień służbowy w korpusie oficerów, chorążych lub podoficerów w przypadku zamiany korpusu – wypłaca się dodatkowo, w terminie do 30 dni kalendarzowych, równoważnik pieniężny z tytułu uzupełnienia umundurowania i oznak służbowych.”;  
...
**§ 3.** Rozporządzenie wchodzi w życie z dniem 1 stycznia 2014 r. Minister Obrony Narodowej: T. Siemoniak
