...
2) w lp. 3:
a) w części „Etap podstawowy”: – kolumna 2 otrzymuje brzmienie: „1. Kryteria kwalifikacji:
...
2) objęcie kobiety „Kompleksową opieką onkologiczną nad świadczeniobiorcą z nowotworem piersi” realizowaną w ramach ambulatoryjnej opieki specjalistycznej, leczenia szpitalnego lub rehabilitacji leczniczej.”, – w kolumnie 3 w ust. 2: – – w pkt 1 lit. b otrzymuje brzmienie: „b) elektroradiolog;”, – – pkt 2 i 3 otrzymują brzmienie: „2) wyposażenie w sprzęt i aparaturę medyczną: mammograf cyfrowy* ;
...
b) wyposażenie w sprzęt i aparaturę medyczną: mammograf cyfrowy* ;”, – – uchyla się pkt 3;
3) objaśnienie pod tabelą otrzymuje brzmienie: „* Wyposażenie w sprzęt i aparaturę medyczną dla świadczenia: mammografia skryningowa obu piersi.
...
j) oprogramowanie obsługowe zapewniające możliwość umieszczenia na ekranie obrazu cc bok do boku oraz obrazu MLO piersi prawej po stronie lewej, a obrazu MLO piersi lewej po stronie prawej;
możliwość wyłączenia paska narzędzi; zalecana kompatybilność z oprogramowaniem do komputerowego wspomagania diagnozy (typu CAD),
