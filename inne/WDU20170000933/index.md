...
§ 1. Rejestr Należności Publicznoprawnych, zwany dalej „rejestrem”, jest prowadzony systemie teleinformatycznym przez Szefa Krajowej Administracji Skarbowej.

§ 2. Minister właściwy do spraw finansów publicznych może wyznaczyć, drodze rozporządzenia, inny organ Krajowej Administracji Skarbowej do prowadzenia rejestru, mając na względzie konieczność zapewnienia sprawnego funkcjonowania tego rejestru oraz sprawność procesów wymiany informacji.

§ 3. Administratorem danych zgromadzonych rejestrze jest organ prowadzący rejestr.
...
- **1)** z dokumentu, o którym mowa art. 3a § 1;
...
- **4)** z mandatu karnego wydanego postępowaniu sprawach o wykroczenia;
...
- **4)** informacji określonych art. 18f § 1 i 2.

**Art. 18c.**

§ 1. Przed wprowadzeniem do rejestru danych, o których mowa art. 18b § 2, wierzyciel doręcza zobowiązanemu zawiadomienie o zagrożeniu ujawnieniem rejestrze.

§ 2. Zawiadomienie, o którym mowa § 1, może być doręczone wraz z upomnieniem, o którym mowa art. 15 § 1.

§ 3. Dane, o których mowa art. 18b § 2, mogą być wprowadzone do rejestru nie wcześniej niż po upływie 30 dni od dnia doręczenia zobowiązanemu zawiadomienia, o którym mowa § 1.

§ 4. Przepisy § 1–3 nie mają zastosowania, jeżeli wysokość należności pieniężnej, o której dane mają być wprowadzone do rejestru, wraz z odsetkami z tytułu niezapłacenia jej terminie jest niższa niż czterokrotna wysokość kosztów upomnienia, o którym mowa art. 15 § 1.

**Art. 18d.**

§ 1. Wierzyciel wprowadza do systemu teleinformatycznego, którym jest prowadzony rejestr, dane, o których mowa art. 18b § 2.

§ 2. Nie wprowadza się do rejestru danych, o których mowa art. 18b § 2, przypadku wniesienia skargi do sądu administracyjnego na ostateczną decyzję, postanowienie lub inne orzeczenie, o którym mowa art. 18b § 1 pkt 2, do czasu zakończenia prawomocnym orzeczeniem postępowania sądowoadministracyjnego.
...
- **1)** nie ujawnia danych, o których mowa art. 18b § 2, oraz
- **2)** powiadamia wierzyciela, który wprowadził dane do rejestru, o niezgodności tych danych.

**Art. 18e.** Organ prowadzący rejestr ujawnia rejestrze dane, o których mowa art. 18b § 2, gdy łączna kwota należności pieniężnych wraz odsetkami z tytułu niezapłacenia ich terminie wynosi nie mniej niż 5000 zł.
...
- **5)** wstrzymania wykonania ostatecznej decyzji, postanowienia lub innego orzeczenia, o którym mowa art. 18b § 1 pkt 2;
- **6)** wszczęcia postępowania administracyjnego, postępowania podatkowego albo postępowania sądowoadministracyjnego, jeżeli wszczęcie nastąpiło po ujawnieniu danych, o których mowa art. 18b § 2;
- **7)** wszczęcia postępowania trybie nadzwyczajnym sprawie ostatecznej decyzji, postanowienia lub innego orzeczenia, o których mowa art. 18b § 1 pkt 2;
- **8)** wniesienia sprzeciwu, o którym mowa art. 18i;
- **9)** umorzenia postępowania egzekucyjnego na podstawie art. 59 § 2, przypadku gdy nie upłynęło 5 lat od dnia, którym postanowienie o umorzeniu tego postępowania stało się ostateczne;
- **10)** śmierci lub ustania bytu prawnego zobowiązanego.

§ 2. Wierzyciel wprowadza do rejestru znane mu informacje dotyczące ustania okoliczności, o których mowa § 1 pkt 1–9.

§ 3. Informacje, o których mowa § 1 i 2, wprowadzone do rejestru, podlegają ujawnieniu rejestrze, przypadku, o którym mowa art. 18e.

**Art. 18g.** Wierzyciel wprowadza do rejestru zmianę lub wykreśla z rejestru dane, o których mowa art. 18b § 2, niezwłocznie, nie później niż terminie 7 dni od dnia powzięcia przez niego wiadomości o okoliczności uzasadniającej zmianę lub wykreślenie tych danych.

**Art. 18h.** Wykreślenie z rejestru danych, o których mowa art. 18b § 2, następuje przypadku, gdy:

**Art. 18i.**

§ 1. Zobowiązanemu przysługuje prawo wniesienia sprzeciwu sprawie:

- **1)** zagrożenia ujawnieniem rejestrze;
- **2)** wprowadzenia danych, o których mowa art. 18b § 2, do systemu teleinformatycznego, którym jest prowadzony rejestr.
...
§ 8. Jeżeli sprzeciw wniesiony jednocześnie z zarzutami, o których mowa art. 33 § 1, oparto na okoliczności będącej przedmiotem tych zarzutów, postępowanie wszczęte sprzeciwem staje się bezprzedmiotowe.

§ 9. Wniesienie sprzeciwu nie stanowi podstawy do wykreślenia z rejestru danych, o których mowa art. 18b § 2.

§ 10. W przypadku uwzględnienia sprzeciwu wierzyciel wprowadza do rejestru zmianę albo wykreśla z rejestru dane, o których mowa art. 18b § 2, odpowiednim zakresie.
...
§ 12. Postępowanie sprawie sprzeciwu nie wyłącza odpowiedzialności za naruszenie obowiązków wynikających z przepisów ustawy z dnia 29 sierpnia 1997 r. o ochronie danych osobowych (Dz. U. z 2016 r. poz. 922).
...
§ 14. Od postanowienia przedmiocie rozpoznania zażalenia, o którym mowa § 13, przysługuje skarga do wojewódzkiego sądu administracyjnego.

**Art. 18j.**

§ 1. Podmiotowi zainteresowanemu lub podmiotowi, o którym mowa art. 18q § 2, udostępnia się z rejestru dane, o których mowa art. 18b § 2, z zastrzeżeniem § 2 i 3.

§ 2. Dane, o których mowa art. 18b § 2 pkt 1 lit. a tiret drugie i trzecie, lit. b tiret trzecie, lit. d tiret drugie i trzecie, lit. e tiret drugie i trzecie oraz lit. f tiret drugie i trzecie, udostępnia się podmiotowi zainteresowanemu lub podmiotowi, o którym mowa art. 18q § 2, wyłącznie przypadku, którym stanowią one przyjęte kryterium wyszukania zobowiązanego.

§ 3. Dane, o których mowa art. 18b § 2 pkt 3, są udostępniane podmiotowi zainteresowanemu lub podmiotowi, o którym mowa art. 18q § 2, postaci łącznej kwoty należności pieniężnych wraz z odsetkami z tytułu niezapłacenia ich terminie.
...
§ 3. Dane, o których mowa art. 18b § 2, udostępnia się podmiotowi, o którym mowa art. 18q § 2, za pośrednictwem funkcjonalności systemu teleinformatycznego udostępnionej na stronie podmiotowej urzędu obsługującego organ prowadzący rejestr.
...
§ 1. Udostępnienie z rejestru danych, o których mowa art. 18b § 2, jest bezpłatne.
...
§ 3. Podmiot, o którym mowa art. 18q § 2 pkt 6 lub 7, udziela zobowiązanemu bezpłatnie informacje o podmiocie, na rzecz którego wyszukał rejestrze dane, o których mowa art. 18b § 2.

**Art. 18q.**

§ 1. Organ prowadzący rejestr wyraża zgodę na ułatwiony sposób wyszukiwania zobowiązanych rejestrze obejmujący więcej niż jednego zobowiązanego.

§ 2. Zgoda, o której mowa § 1, może być udzielona na wniosek:
...
- **1)** posiada urządzenia umożliwiające odnotowanie systemie, kto i kiedy uzyskał dane, o których mowa art. 18b § 2;
...
§ 4. Organ prowadzący rejestr odmawia, drodze postanowienia, wyrażenia zgody, o której mowa § 1, jeżeli podmiot uprawniony nie spełnia wymagań, o których mowa § 3.

§ 5. Organ prowadzący rejestr cofa, drodze postanowienia, zgodę, o której mowa § 1, jeżeli podmiot uprawniony przestał spełniać wymagania, o których mowa § 3.
...
**Art. 18r.** Dostęp do danych, o których mowa art. 18b § 2, zawartych rejestrze zapewnia się osobom upoważnionym przez wierzycieli oraz organ prowadzący rejestr zakresie, jakim jest to niezbędne do nadzoru, konserwacji i rozwijania systemów informatycznych wierzycieli i systemu teleinformatycznego, ramach którego prowadzony jest rejestr.

**Art. 18s.**

§ 1. Dane, o których mowa art. 18b § 2, udostępnione z rejestru, mogą być przechowywane przez okres do 90 dni od dnia ich uzyskania.

§ 2. Podmiot, który uzyskał z rejestru dane, o których mowa art. 18b § 2, nie może ich ujawnić innym podmiotom.

§ 3. Przepisów § 1 i 2 nie stosuje się do podmiotów uprawnionych, o których mowa art. 18q § 2 pkt 1–5.

§ 4. Podmioty, o których mowa art. 18q § 2 pkt 6 i 7, mogą ujawnić dane, o których mowa art. 18b § 2, wyłącznie podmiotowi, na rzecz którego wyszukały dane rejestrze.
...
**Art. 168g.** Kto przechowuje uzyskane z rejestru dane, o których mowa art. 18b § 2, z naruszeniem przepisu art. 18s § 1, podlega grzywnie do 30 000 zł.
...
**Art. 10b.** Sąd Najwyższy, uwzględniając skargę kasacyjną na postanowienie o odrzuceniu pozwu z uwagi na niedopuszczalność postępowania grupowego, może uchylić zaskarżone postanowienie i postanowić o rozpoznaniu sprawy postępowaniu grupowym.”;
...
- **23)** art. 32 dodaje się ust. 3 brzmieniu: „3. Nadzór ministra właściwego do spraw gospodarki zakresie dokonywania przez biuro analizy wiarygodności płatniczej obejmuje wyłącznie ocenę, czy zakres informacji wykorzystywanych do analizy jest prawidłowy.”;
- **24)** uchyla się art. 37;
- **25)** art. 41 otrzymuje brzmienie: „Art. 41. 1. Przed podpisaniem protokołu kontroli osoba upoważniona do reprezentowania biura ma prawo zgłoszenia kontrolującemu umotywowanych pisemnych zastrzeżeń do ustaleń zawartych protokole kontroli terminie 7 dni roboczych od dnia otrzymania tego protokołu.
...
- **26)** po art. 42 dodaje się art. 42a brzmieniu: „Art. 42a. Postępowanie kontrolne kończy:
...
- **27)** po art. 43 dodaje się art. 43a brzmieniu: „Art. 43a. 1. W razie naruszenia przez biuro przepisów ustawy zakresie realizacji wniosków, o których mowa art. 22a ust. 1, minister właściwy do spraw gospodarki może nałożyć na biuro karę pieniężną wysokości nieprzekraczającej 200 000 złotych.
...
- **28)** po rozdziale 5 dodaje się rozdział 5a brzmieniu: „Rozdział 5a Odpowiedzialność cywilna
...
**Art. 13.** Przepisy ustaw zmienianych art. 2 i art. 10, brzmieniu nadanym niniejszą ustawą, stosuje się do postępowań wszczętych od dnia jej wejścia życie.

**Art. 14.** Do zabezpieczeń udzielonych postępowaniach zabezpieczających wszczętych przed dniem wejścia życie niniejszej ustawy stosuje się art. 754 i art. 757 ustawy zmienianej art. 2, brzmieniu dotychczasowym.

**Art. 15.** Żądanie zobowiązania dłużnika do złożenia wykazu informacji o odpłatnych i nieodpłatnych czynnościach prawnych dokonanych na rzecz osób trzecich, pięcioletnim okresie poprzedzającym wszczęcie egzekucji, wyniku których stał się niewypłacalny albo stał się niewypłacalny wyższym stopniu, niż był przed dokonaniem czynności prawnych, o którym mowa art. 913 § 1 ustawy zmienianej art. 2, brzmieniu nadanym niniejszą ustawą, stosuje się do czynności prawnych dokonanych od dnia wejścia życie niniejszej ustawy.
...
1. Biuro informacji gospodarczej prowadzące działalność dniu wejścia życie niniejszego przepisu jest obowiązane dostosować regulamin zarządzania danymi do przepisów ustawy zmienianej art. 11, brzmieniu nadanym niniejszą ustawą, terminie 3 miesięcy od dnia wejścia życie niniejszego przepisu i przekazać go nie później niż terminie 14 dni od dnia jego uchwalenia ministrowi właściwemu do spraw gospodarki do zatwierdzenia.

2. W razie nieprzekazania przez biuro informacji gospodarczej ministrowi właściwemu do spraw gospodarki do zatwierdzenia regulaminu zarządzania danymi terminie, o którym mowa ust. 1, minister właściwy do spraw gospodarki wydaje decyzję o zakazie wykonywania działalności gospodarczej przez biuro.

3. Regulaminy zarządzania danymi lub zmiany regulaminach przekazane ministrowi właściwemu do spraw gospodarki do zatwierdzenia przed dniem wejścia życie niniejszego przepisu i niezatwierdzone do tego dnia podlegają zwrotowi celem dostosowania, o którym mowa ust. 1.
...
**Art. 22.** Ustawa wchodzi życie z dniem 1 czerwca 2017 r., z wyjątkiem:
