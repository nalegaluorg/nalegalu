...
- **2)** po art. 19 dodaje się art. 19a w brzmieniu: „ Kwota bazowa ustalona na podstawie art. 19 obowiązuje od dnia 1 marca roku, w którym przeprowadzono waloryzację, do końca lutego następnego roku. ” ;
...
- **1)** do 9 roboczego dnia lutego każdego roku: kwotę przeciętnego wynagrodzenia w gospodarce narodowej w poprzednim roku kalendarzowym, kwotę bazową, o której mowa w art. 19,
    - **a)**
    - **b)**

- **2)** do 7 roboczego dnia drugiego miesiąca każdego kwartału kwotę przeciętnego wynagrodzenia w poprzednim kwartale. ” ;
- **4)** w art. 32: ust. 2 otrzymuje brzmienie: „
    - **a)**

2. Dla celów ustalenia uprawnień, o których mowa w ust. 1, za pracowników zatrudnionych w szczególnych warunkach uważa się pracowników zatrudnionych przy pracach o znacznej szkodliwości dla zdrowia oraz o znacznym stopniu uciążliwości lub wymagających wysokiej sprawności psychofizycznej ze względu na bezpieczeństwo własne lub otoczenia w podmiotach, w których obowiązują wykazy stanowisk ustalone na podstawie przepisów dotychczasowych. ” , w ust. 3 zdanie wstępne otrzymuje brzmienie: „ Dla celów ustalenia uprawnień, o których mowa w ust. 1, za pracowników zatrudnionych w szczególnym charakterze uważa się: ” , w ust. 4 kropkę zastępuje się przecinkiem i dodaje się wyrazy „z uwzględnieniem ust. 4a.”, po ust. 4 dodaje się ust. 4a w brzmieniu: „
...
- **1)** waloryzacji i waloryzacji dodatkowej, o których mowa w art. 88 ust. 1 i w art. 91 ust. 1, należne od tego dnia kwoty: najniższej emerytury i renty, dodatku pielęgnacyjnego i dodatku dla sieroty zupełnej,
    - **a)**
    - **b)**
...
- **7)** w art. 103: ust. 3 otrzymuje brzmienie: „
    - **a)**

3. Prawo do emerytury, renty z tytułu niezdolności do pracy lub renty rodzinnej, do której uprawniona jest jedna osoba, może ulec zawieszeniu również na wniosek emeryta lub rencisty. ” , uchyla się ust. 4;
...
- **2)** dodatkowa waloryzacja, o której mowa w art. 91 tej ustawy, obejmuje emerytury i renty osób: którym prawo do świadczenia ustalono przed terminem kolejnej waloryzacji, które nabyły prawo do renty rodzinnej po żołnierzach zawodowych zmarłych nie później niż w ostatnim dniu lutego następującego po roku, w którym przeprowadzono dodatkową waloryzację. ” .
    - **a)**
    - **b)**
...
- **2)** dodatkowa waloryzacja, o której mowa w art. 91 tej ustawy, obejmuje emerytury i renty osób: którym prawo do świadczenia ustalono przed terminem kolejnej waloryzacji, które nabyły prawo do renty rodzinnej po funkcjonariuszach zmarłych nie później niż w ostatnim dniu lutego następującego po roku, w którym przeprowadzono dodatkową waloryzację. ” .
    - **a)**
    - **b)**
