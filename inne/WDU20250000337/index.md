...
2. Dane obywatela Ukrainy uważa się za kompletne, jeżeli w dniu składania wniosku, o którym mowa w art. 42f ust. 1: [1) w rejestrze PESEL znajdują się następujące dane i informacje:
...
- **e)** płeć,
- **f)** obywatelstwo,
- **g)** seria, numer i data ważności ważnego dokumentu podróży obywatela Ukrainy;] <1) w rejestrze PESEL znajdują się następujące dane i informacje:
- **a)** imię (imiona),
- **b)** nazwisko,
- **c)** data urodzenia,
- **d)** płeć,
