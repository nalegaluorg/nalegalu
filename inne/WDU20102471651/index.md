...
1. Skarb Państwa, reprezentowany przez ministra właściwego do spraw transportu, wyniku zapłaty zobowiązań podatkowych, art. 24b 1 art. 24c, nabywa kapitale zakładowym PLK akcje wartości nominalnej odpowiadającej wysokości tych zobowiązań.

2. Przeniesienie własności akcji, którym art. 24b 1 art. 24c, następuje na wniosek SA, na podstawie umowy zawartej formie pisemnej między a ministrem właściwym do spraw transportu, występującym imieniu Skarbu Państwa, porozumieniu ministrem właściwym do spraw finansów publicznych.

3. Z dniem przeniesienia własności akcji zobowiązania podatkowe SA, art. 24b 1 art. 24c, wygasają.

4. Minister właściwy do spraw transportu powiadamia właściwego naczelnika urzędu skarbowego zawarciu umowy, której 2, przesyłając jednocześnie jej kopię.
...
3. Szczegółowe warunki zamiany wierzytelności, 1, na akcje PLK określi umowa zawarta między a ministrem właściwym do spraw finansów publicznych, występującym imieniu Skarbu Państwa, porozumieniu ministrem właściwym do spraw transportu.
