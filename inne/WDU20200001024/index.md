...
| Źródło | [ELI HTML](https://eli.gov.pl/api/acts/DU/2020/1024/text.html) · [ELI API](https://api.sejm.gov.pl/eli/acts/DU/2020/1024) |

## Spis treści

- [Treść rozporządzenia](#part_1)

- [Załącznik nr 1 - Nazwy, definicje i oznaczenia jednostek pochodnych o nazwach specjalnych należących do SI](#part_2)

- [Załącznik nr 2 - Nazwy, definicje i oznaczenia jednostek dopuszczonych](#part_3)

- [Załącznik nr 3 - Nazwy i oznaczenia przedrostków wyrażających czynniki służące do tworzenia dziesiętnych podwielokrotności i wielokrotności jednostek](#part_4)

TOC

## Treść rozporządzenia

Na podstawie art. 5 ust. 2 ustawy z dnia 11 maja 2001 r. - Prawo o miarach ([Dz. U. z 2020 r. poz. 140](https://api.sejm.gov.pl/eli/acts/DU/2020/140/text.html), [285](https://api.sejm.gov.pl/eli/acts/DU/2020/285/text.html) i [568](https://api.sejm.gov.pl/eli/acts/DU/2020/568/text.html)) zarządza się, co następuje:
...
metr, oznaczenie m, jest to jednostka SI długości. Jest ona zdefiniowana poprzez przyjęcie ustalonej wartości liczbowej prędkości światła w próżni c, wynoszącej 299 792 458, wyrażonej w jednostce ms-1, przy czym sekunda zdefiniowana jest za pomocą częstotliwości cezowej ∆νCs;
...
amper, oznaczenie A, jest to jednostka SI prądu elektrycznego. Jest ona zdefiniowana poprzez przyjęcie ustalonej wartości liczbowej ładunku elementarnego e, wynoszącej 1,602 176 634 × 10-19, wyrażonej w jednostce C, która jest równa A s, przy czym sekunda zdefiniowana jest za pomocą ∆νCs;

### 5)

kelwin, oznaczenie K, jest to jednostka SI temperatury termodynamicznej. Jest ona zdefiniowana poprzez przyjęcie ustalonej wartości liczbowej stałej Boltzmanna k, wynoszącej 1,380 649 × 10-23, wyrażonej w jednostce J K-1, która jest równa kg m2 s-2 K-1, przy czym kilogram, metr i sekunda zdefiniowane są za pomocą h, c i ∆νCs;
...
Dopuszcza się do stosowania jednostkę dawki ekspozycyjnej promieniowania X i γ o nazwie „rentgen” i oznaczeniu R odpowiadającą 2,58 × 10-4 C kg1, wyłącznie w odniesieniu do przyrządów pomiarowych dopuszczonych do obrotu lub użytkowania przed dniem 23 kwietnia 2003 r.

### § 19.

Traci moc rozporządzenie Rady Ministrów z dnia 30 listopada 2006 r. w sprawie legalnych jednostek miar ([Dz. U. poz. 1638](https://api.sejm.gov.pl/eli/acts/DU/2006/1638/text.html) oraz [z 2010 r. poz. 61](https://api.sejm.gov.pl/eli/acts/DU/2010/61/text.html)).
