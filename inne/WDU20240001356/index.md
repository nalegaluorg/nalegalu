...
1. Kwoty bazowe waloryzowane są corocznie średniorocznym wskaźnikiem wzrostu wynagrodzeń. Wynagrodzenia osób nieobjętych mnożnikowymi systemami wynagrodzeń waloryzowane są średniorocznym wskaźnikiem wzrostu wynagrodzeń.

3. Średnioroczny wskaźnik wzrostu wynagrodzeń może być różny dla poszczególnych grup pracowników.

**Art. 5.** Pracownikami państwowej sfery są:
...
1. Średnioroczne wskaźniki wzrostu wynagrodzeń dla osób, których mowa art. 5 pkt 2, są corocznie przedmiotem negocjacji ramach Rady Dialogu Społecznego. Rada Ministrów, terminie 15 czerwca każdego roku, przedkłada Radzie Dialogu Społecznego, a także ogólnokrajowym organizacjom związków zawodowych zrzeszających pracowników państwowej sfery celu wyrażenia opinii, propozycję średniorocznych wskaźników wzrostu wynagrodzeń państwowej sferze na rok następny. Wraz tą propozycją Rada Ministrów przedkłada informację o:

- **1)** prognozowanej dynamice produktu krajowego brutto;
- **2)** prognozowanych zmianach cen towarów usług konsumpcyjnych; prognozowanym wzroście wynagrodzeń gospodarce narodowej, tym sektorze przedsiębiorstw;
...
- **7)** wynagrodzeniach roku poprzedniego pozostałych pracowników państwowej sfery nieobjętych mnożnikowymi systemami wynagrodzeń.

3. Nieprzedstawienie przez organizacje związków zawodowych opinii, terminie 20 dni od przedłożenia propozycji, uważa się za rezygnację prawa jej wyrażenia.

4. Jeżeli Rada Dialogu Społecznego uzgodni, drodze uchwały, wysokość średniorocznych wskaźników wzrostu wynagrodzeń państwowej sferze budżetowej, Rada Ministrów jest zobowiązana uwzględnienia projekcie wynagrodzeń zapewniających osiągnięcie uzgodnionej wysokości wskaźników.

5. Jeżeli terminie 30 dni od otrzymania propozycji nie nastąpi uzgodnienie stanowiska Rady Dialogu Społecznego, Rada Ministrów przyjmie projektu średnioroczne wskaźniki wzrostu wynagrodzeń państwowej sferze na rok następny, tym że nie mogą być one niższe od wskaźników zawartych propozycji, której mowa ust.

6. Terminy, których mowa ust. 2, 3 5, Rada Dialogu Społecznego zmienia na wniosek przedstawiciela Rady Ministrów jej składzie, odpowiednio zmiany terminu dokonanej na podstawie art. 19 ust. 2 24 lipca 2015 Radzie Dialogu Społecznego innych instytucjach dialogu społecznego (Dz. 2018 2232, późn. zm. ).

**Art. 8.**

1. Podwyższenie wynagrodzeń dla pracowników państwowej sfery następuje ciągu 3 miesięcy po ogłoszeniu budżetowej, wyrównaniem od 1 stycznia danego roku, zastrzeżeniem ust. Podwyższenie wynagrodzeń dla nauczycieli zatrudnionych szkołach placówkach prowadzonych przez organy administracji rządowej następuje terminie określonym zgodnie przepisami 26 stycznia 1982 Karta Nauczyciela.

**Art. 9.**

1. W ustawie ustala się:

- **1)** (uchylony)
- **2)** kwoty bazowe; średnioroczne wskaźniki wzrostu wynagrodzeń państwowej sferze budżetowej;
- **4)** kwoty wynagrodzeń dla państwowych jednostek budżetowych, dla poszczególnych grup pracowników, których mowa art. 5, podziale na części działy klasyfikacji dochodów wydatków. (uchylony)
...
**Art. 31.** Traci moc ustawa 23 grudnia 1994 kształtowaniu środków na wynagrodzenia państwowej sferze (Dz. 1995 163, późn. zm. ).
