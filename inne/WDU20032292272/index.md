...
- **1)** w art. 2 ust. 1 otrzymuje brzmienie: „1. Skazany w pierwszej instancji obowiązany jest uiścić opłatę w razie skazania na karę pozbawienia wolności:
...
- **2)** art. 3 otrzymuje brzmienie: „Art. 3. 1. Skazany w pierwszej instancji na karę grzywny obowiązany jest uiścić opłatę w wysokości 10%, nie mniej jednak niż 30 zł, a w razie orzeczenia grzywny obok kary pozbawienia wolności - w wysokości 20% od kwoty wymierzonej grzywny.
...
- **7)** art. 15 otrzymuje brzmienie: „Art. 15. 1. W sprawach karnych uiszcza się opłaty od następujących wniosków i próśb:
...
- **8)** w art. 16 ust. 1 i 2 otrzymują brzmienie: „1. Wysokość przypadającej opłaty określa w orzeczeniu kończącym postępowanie sąd.
...
- **10)** art. 19 otrzymuje brzmienie: „Art. 19. 1. Za zaświadczenia i inne dokumenty, wydawane na wniosek na podstawie akt, pobiera się od wnioskodawcy opłatę kancelaryjną w wysokości 6 zł za każdą stronę.
...
- **11)** art. 21 otrzymuje brzmienie: „Art. 21. Przepisy ustawy stosuje się również w postępowaniu:
