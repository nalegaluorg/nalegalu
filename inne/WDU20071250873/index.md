...
- **11)** w art. 11:
    ...
    - **b)** po ust. 1 dodaje się ust. 1 -1 w brzmieniu: torskiego prawa do lokalu mieszkalnego z następujących przyczyn:
...
1. Z chwilą gdy wygaśnięcie spółdzielczego lokatorskiego prawa do lokalu mieszkalnego na podstawie uchwały, o której mowa w ust. 1 i 1 , stanie się skuteczne, ustaje członkostwo w spółdzielni.”, przy zawieraniu umowy oraz koszty sądowe w postępowaniu wieczystoksięgowym obciążają członka spółdzielni, na rzecz którego spółdzielnia dokonuje przeniesienia własności lokalu.
...
- **15)** w art. 15:
    - **a)** ust. 1 i 2 otrzymują brzmienie: ,,1. W wypadku wygaśnięcia spółdzielczego lokatorskiego prawa do lokalu mieszkalnego w następstwie niedokonania czynności, o których mowa ustanowienie spółdzielczego lokatorskiego prawa do lokalu mieszkalnego przysługują dzieciom i innym osobom bliskim.
