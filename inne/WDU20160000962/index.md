...
# RZECZYPOSPOLITEJ Poz. 962 Załączniki WZÓR WNIOSEK O WYDANIE ZEZWOLENIA NA PROWADZENIE GENETYCZNEJ, W KTÓRYM MA BYĆ PROWADZONE ZAMKNIĘTE

| Pole | Wartość |
|---|---|
| Adres publikacyjny | Dz.U. 2016 poz. 962 |
| ISAP | WDU20160000962 |
...
| Źródło | [ISAP](https://isap.sejm.gov.pl/isap.nsf/DocDetails.xsp?id=WDU20160000962) · [PDF](https://api.sejm.gov.pl/eli/acts/DU/2016/962/text.pdf) |

1. Informacje o wnioskodawcy i osobie, która będzie kierować genetycznej
...
2. Informacje o osobie odpowiedzialnej za bezpieczeństwo w zakładzie inżynierii genetycznej
2.1 Imię i nazwisko
2.2 Kwalifikacje zawodowe
3. Opis pomieszczeń zakładu inżynierii genetycznej oraz wykorzystywane podczas zamkniętego użycia GMO:
...
3.3 Urządzenia do prac w ramach zakładu inżynierii genetycznej Nr pomieszczenia Piętro Wielkość (m ) Przeznaczenie
4. Informacje o czynnościach planowanych podczas zamkniętego
5. Określenie kategorii zagrożenia planowanego zamkniętego użycia I □ II □
6. Informacje o wprowadzonych środkach bezpieczeństwa, które zamkniętego użycia GMO
6.1 Wyposażenie
6.2 System pracy
...
7. Informacje o rodzaju i postaci odpadów powstających podczas GMO oraz o sposobie postępowania z tymi odpadami, w tym
...
(podpis ………………………….
(miejscowość, data) _________________ Właściwe zaznaczyć.
WZÓR WNIOSEK O WYDANIE ZGODY NA ZAMKNIĘTE
1. Informacje o wnioskodawcy ubiegającym się o wydanie zgody
1.1 Imię i nazwisko oraz adres i miejsce zamieszkania albo nazwa oraz adres i siedziba wnioskodawcy, a w przypadku gdy wnioskodawcą jest osoba fizyczna prowadząca działalność gospodarczą, zamiast adresu i miejsca zamieszkania tej osoby – adres i miejsce wykonywania działalności, jeżeli są inne niż adres i miejsce zamieszkania tej osoby
...
2. Informacje o osobie odpowiedzialnej za bezpieczeństwo zamkniętego Imię i nazwisko osoby odpowiedzialnej za bezpieczeństwo zamkniętego użycia GMO
2.2 Kwalifikacje zawodowe osoby odpowiedzialnej za bezpieczeństwo zamkniętego użycia GMO
3. Opis prac z wykorzystaniem GMO
3.1 Cel prac z wykorzystaniem GMO i krótkie streszczenie (maksymalnie
3.1.1 cel prac
3.1.2 streszczenie
4. Charakterystyka typu GMO A. CHARAKTERYSTYKA WYKORZYSTYWANEGO
...
4.11 Klasyfikacja zagrożenia stosownie do istniejących norm dotyczących lub ochrony środowiska
4.11.1 organizm stosowany w produkcji przemysłowej na dużą skalę lub skalę laboratoryjną
4.11.2 kategoria zagrożenia B. CHARAKTERYSTYKA WYKORZYSTYWANEGO
...
4.23 Kategoria zagrożenia C. CHARAKTERYSTYKA STOSOWANEGO
...
4.27 Informacje o tym, w jakim stopniu wektor jest ograniczony do DNA wymaganego do spełnienia planowanych funkcji i jaka część wektora pozostaje w GMO D. ŹRÓDŁO I FUNKCJE KWASU NUKLEINOWEGO DO MODYFIKACJI GENETYCZNEJ
...
4.35 Przewaga selekcyjna w przypadku niekontrolowanego uwolnienia do środowiska E. CECHY IDENTYFIKUJĄCE GMO
...
4.38.2 produkcja F. DANE O LICZBIE GMO WYKORZYSTYWANYCH PODCZAS UŻYCIA GMO
...
5. Opis środków bezpieczeństwa, które będą stosowane podczas zamkniętego
6. Informacje o rodzaju i postaci odpadów powstających podczas GMO oraz o sposobie postępowania z tymi odpadami, w tym
7. Opis pomieszczeń zakładu inżynierii genetycznej, w tym wykorzystywane podczas zamkniętego użycia GMO
7.1 Pomieszczenia (wraz z numerami)
7.2 Urządzenia
8. Data wydania zezwolenia na prowadzenie zakładu inżynierii być prowadzone zamknięte użycie GMO ………………………………………..
(podpis ……………………………… (miejscowość, data) Załącznik do wniosku: Ocena zagrożenia.
