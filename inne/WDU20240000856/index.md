...
# Rozporządzenie Ministra Zdrowiaz dnia 7 czerwca 2024 r. zmieniające rozporządzenie w sprawie programu pilotażowego w zakresie kompleksowej opieki specjalistycznej nad świadczeniobiorcami leczonymi z powodu otyłości olbrzymiej KOS-BAR
...
„
2.
Prezes Funduszu, we współpracy z ośrodkami koordynującymi, sporządza raport:
1)
częściowy, zawierający analizę i ocenę realizacji programu pilotażowego z 4-letniego okresu realizacji programu pilotażowego, i przekazuje go ministrowi właściwemu do spraw zdrowia w terminie do dnia 31 grudnia 2025 r.;
2)
końcowy, zawierający analizę i ocenę realizacji programu pilotażowego, i przekazuje go ministrowi właściwemu do spraw zdrowia nie później niż w terminie 3 miesięcy od dnia przekazania temu ministrowi sprawozdania końcowego z realizacji programu pilotażowego, o którym mowa w § 13 ust. 1.
” ,
b)
...
„
2)
procentowa utrata nadmiernej masy ciała obliczana według wzoru: %EWL = {[waga wyjściowa (kg) – waga aktualna (kg)] / [waga wyjściowa (kg) – waga idealna (kg)]} * 100;
3)
procentowa utrata nadmiaru BMI obliczana według wzoru: %EBMIL = {[wyjściowy BMI (kg/m2) – aktualny BMI (kg/m2)] / [wyjściowy BMI (kg/m2) – 25]} * 100.
” .
§ 2.
