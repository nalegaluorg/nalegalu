...
- **1)** w art. 2 w ust. 1 pkt 3 otrzymuje brzmienie:
  ...
  > a) które nie ukończyły 18. roku życia, lub b) posiadające miejsce zamieszkania na terytorium Rzeczypospolitej Polskiej, które są w okresie ciąży, porodu lub połogu”;  
...
- **5)** po art. 50 dodaje się art. 50a w brzmieniu:
  ...
  > 1) ubezpieczonym, 2) osobom uprawnionym do świadczeń na podstawie przepisów o koordynacji, 3) osobom, o których mowa w art. 2 ust. 1 pkt 2 i 3 oraz art. 12 pkt 2–4, 6 i 9 – świadczeniodawca może przedstawić na jednym rachunku łącznie.”;  
- **6)** w art. 53:
    ...
    - **b)** ust. 2 otrzymuje brzmienie: „2. Jeżeli poświadczenie albo dokument, o których mowa w ust. 1, nie zostaną przedstawione w przypadku: 1) stanu nagłego, 2) porodu – przepisy art. 50 ust. 11–15 i 18–22 stosuje się odpowiednio.”;
...
- **12)** w art. 77:
    ...
    - **b)** po ust. 1 dodaje się ust. 1a w brzmieniu: „1a. Zgłoszenia do ubezpieczenia zdrowotnego oraz zgłoszenia o wyrejestrowaniu z ubezpieczenia zdrowotnego osób, o których mowa w art. 66 ust. 1 pkt 8a, oraz członków ich rodzin kierowane są do centrali Funduszu.”;
