...
- **9)** w art. 29:
    ...
    - **b)** w ust. 2 pkt 4 otrzymuje brzmienie: „4) dociepleniu: a) ścian budynków o wysokości do 12 m, b) dachów budynków;”;
...
- **18)** w art. 48:
    - **a)** w ust. 2 pkt 1 otrzymuje brzmienie:
      ...
      > a) ustaleniami obowiązującego miejscowego planu zagospodarowania przestrzennego albo b) ustaleniami ostatecznej, w dniu wszczęcia postępowania, decyzji o warunkach zabudowy i zagospodarowania terenu, w przypadku braku obowiązującego miejscowego planu zagospodarowania przestrzennego;”,  
...
- **20)** w art. 49b:
    ...
    - **b)** ust. 5 otrzymuje brzmienie:
      ...
      > „5. Do opłaty legalizacyjnej stosuje się odpowiednio przepisy art. 59g, z tym ¿e wysokość opłaty w przypadku budowy, o której mowa w:  
...
- **21)** art. 51 otrzymuje brzmienie:
  ...
  > 1) o stwierdzeniu wykonania obowiązku albo 2) w przypadku nie wykonania obowiązku - nakazującą zaniechanie dalszych robót budowlanych bądź rozbiórkę obiektu lub jego części, bądź doprowadzenie obiektu do stanu poprzedniego.  
...
- **31)** art. 71 otrzymuje brzmienie:
  ...
  > a) zagrożenia bezpieczeństwa ludzi lub mienia, b) pogorszenie stanu środowiska lub stanu zachowania zabytków, c) pogorszenie warunków zdrowotno-sanitarnych, d) wprowadzenie, utrwalenie bądź zwiększenie ograniczeń lub uciążliwości dla terenów sąsiednich.  
