...
source: "eli-html"
---
# Obwieszczenie Ministra Sprawiedliwościz dnia 16 października 2023 r. w sprawie ogłoszenia jednolitego tekstu rozporządzenia Ministra Sprawiedliwości w sprawie zespołu do przygotowania pytań testowych na egzamin wstępny na aplikację adwokacką i radcowską oraz wykazu tytułów aktów prawnych

| Pole | Wartość |
|---|---|
| Adres publikacyjny | Dz.U. 2023 poz. 2366 |
| ISAP | WDU20230002366 |
...
| Źródło | [ELI HTML](https://eli.gov.pl/api/acts/DU/2023/2366/text.html) · [ELI API](https://api.sejm.gov.pl/eli/acts/DU/2023/2366) |

## Spis treści

- [Treść obwieszczenia](#part_1)

- [Załącznik - Rozporządzenie Ministra Sprawiedliwości z dnia 29 kwietnia 2009 r. w sprawie zespołu do przygotowania pytań testowych na egzamin wstępny na aplikację adwokacką i radcowską oraz wykazu tytułów aktów prawnych](#part_2)
...
Na podstawie art. 16 ust. 3 ustawy z dnia 20 lipca 2000 r. o ogłaszaniu aktów normatywnych i niektórych innych aktów prawnych ([Dz. U. z 2019 r. poz. 1461](https://api.sejm.gov.pl/eli/acts/DU/2019/1461/text.html)) ogłasza się w załączniku do niniejszego obwieszczenia jednolity tekst rozporządzenia Ministra Sprawiedliwości z dnia 29 kwietnia 2009 r. w sprawie zespołu do przygotowania pytań testowych na egzamin wstępny na aplikację adwokacką i radcowską oraz wykazu tytułów aktów prawnych ([Dz. U. z 2017 r. poz. 2398](https://api.sejm.gov.pl/eli/acts/DU/2017/2398/text.html)), z uwzględnieniem zmian wprowadzonych:

### 1)

rozporządzeniem Ministra Sprawiedliwości z dnia 30 marca 2020 r. zmieniającym rozporządzenie w sprawie zespołu do przygotowania pytań testowych na egzamin wstępny na aplikację adwokacką i radcowską oraz wykazu tytułów aktów prawnych ([Dz. U. poz. 579](https://api.sejm.gov.pl/eli/acts/DU/2020/579/text.html));

### 2)

rozporządzeniem Ministra Sprawiedliwości z dnia 7 marca 2023 r. zmieniającym rozporządzenie w sprawie zespołu do przygotowania pytań testowych na egzamin wstępny na aplikację adwokacką i radcowską oraz wykazu tytułów aktów prawnych ([Dz. U. poz. 447](https://api.sejm.gov.pl/eli/acts/DU/2023/447/text.html)).
...
§ 2 rozporządzenia Ministra Sprawiedliwości z dnia 30 marca 2020 r. zmieniającego rozporządzenie w sprawie zespołu do przygotowania pytań testowych na egzamin wstępny na aplikację adwokacką i radcowską oraz wykazu tytułów aktów prawnych ([Dz. U. poz. 579](https://api.sejm.gov.pl/eli/acts/DU/2020/579/text.html)), który stanowi:
...
§ 2 rozporządzenia Ministra Sprawiedliwości z dnia 7 marca 2023 r. zmieniającego rozporządzenie w sprawie zespołu do przygotowania pytań testowych na egzamin wstępny na aplikację adwokacką i radcowską oraz wykazu tytułów aktów prawnych ([Dz. U. poz. 447](https://api.sejm.gov.pl/eli/acts/DU/2023/447/text.html)), który stanowi:
...
tryb i sposób ustalania wykazu tytułów aktów prawnych, o którym mowa w art. 75b ust. 6 ustawy z dnia 26 maja 1982 r. - Prawo o adwokaturze, zwanej dalej „ustawą”;
...
### 1[1) W brzmieniu ustalonym przez § 1 pkt 1 rozporządzenia Ministra Sprawiedliwości z dnia 7 marca 2023 r. zmieniającego rozporządzenie w sprawie zespołu do przygotowania pytań testowych na egzamin wstępny na aplikację adwokacką i radcowską oraz wykazu tytułów aktów prawnych (Dz. U. poz. 447), które weszło w życie z dniem 10 marca 2023 r.](#gloss-0:1:))
...
### § 2a[2) W brzmieniu ustalonym przez § 1 pkt 2 rozporządzenia, o którym mowa w odnośniku 1.](#gloss-0:2:).
...
Każdy członek zespołu zgłasza przewodniczącemu zespołu, w terminie przez niego wskazanym, w postaci elektronicznej lub papierowej, propozycje tytułów aktów prawnych, które mogą być umieszczone w wykazie tytułów aktów prawnych, o którym mowa w art. 75b ust. 6 ustawy.
...
### § 3a[3) Dodany przez § 1 rozporządzenia Ministra Sprawiedliwości z dnia 30 marca 2020 r. zmieniającego rozporządzenie w sprawie zespołu do przygotowania pytań testowych na egzamin wstępny na aplikację adwokacką i radcowską oraz wykazu tytułów aktów prawnych (Dz. U. poz. 579), które weszło w życie z dniem 3 kwietnia 2020 r.](#gloss-0:3:).
...
Rozporządzenie wchodzi w życie z dniem ogłoszenia[4) Rozporządzenie zostało ogłoszone w dniu 4 maja 2009 r.](#gloss-0:4:).

1) W brzmieniu ustalonym przez § 1 pkt 1 rozporządzenia Ministra Sprawiedliwości z dnia 7 marca 2023 r. zmieniającego rozporządzenie w sprawie zespołu do przygotowania pytań testowych na egzamin wstępny na aplikację adwokacką i radcowską oraz wykazu tytułów aktów prawnych (Dz. U. poz. 447), które weszło w życie z dniem 10 marca 2023 r. 2) W brzmieniu ustalonym przez § 1 pkt 2 rozporządzenia, o którym mowa w odnośniku 1. 3) Dodany przez § 1 rozporządzenia Ministra Sprawiedliwości z dnia 30 marca 2020 r. zmieniającego rozporządzenie w sprawie zespołu do przygotowania pytań testowych na egzamin wstępny na aplikację adwokacką i radcowską oraz wykazu tytułów aktów prawnych (Dz. U. poz. 579), które weszło w życie z dniem 3 kwietnia 2020 r. 4) Rozporządzenie zostało ogłoszone w dniu 4 maja 2009 r.
