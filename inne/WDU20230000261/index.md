...
- **2)** informację o: posiadaniu przez uznaną organizację oddziału na terytorium Rzeczypospolitej Polskiej, statkach o polskiej przynależności klasyfikowanych przez uznaną organizację. ” , ust. 3 otrzymuje brzmienie: „
    - **a)**
    - **b)**
    - **c)**

3. W przypadku zawarcia umowy, o której mowa w ust. 1, minister właściwy do spraw gospodarki morskiej upoważnia, w drodze decyzji, uznaną organizację do wykonywania powierzonych w umowie zadań administracji morskiej. ” , po ust. 6 dodaje się ust. 6a i 6b w brzmieniu: „
...
- **1)** minister właściwy do spraw gospodarki morskiej: opracowuje program nadzoru państwa bandery nad działalnością upoważnionych uznanych organizacji zgodnie z przepisami rezolucji IMO MSC.349(92) Kodeks dla uznanych organizacji (Kodeks RO), zatwierdza harmonogramy działań przewidzianych w programie nadzoru, o którym mowa w lit. a, w tym plan audytów centrali lub oddziałów upoważnionych uznanych organizacji, oraz plan przeprowadzania inspekcji doraźnych i audytów dodatkowych, przeprowadza audyty upoważnionych uznanych organizacji nie rzadziej niż co 2 lata, sprawuje nadzór nad działaniami dyrektora urzędu morskiego w zakresie jego zadań związanych z monitorowaniem działalności upoważnionych uznanych organizacji, opiniuje opracowane przez upoważnioną uznaną organizację projekty przepisów klasyfikacyjnych, procedur nadzoru nad statkami oraz projekty zmian tych przepisów i procedur;
    - **a)**
    - **b)**
    - **c)**
    - **d)**
...
- **2)** właściwi dyrektorzy urzędów morskich: prowadzą bieżący monitoring działalności upoważnionej uznanej organizacji uczestniczącej w klasyfikacji lub certyfikacji statków znajdujących się w ich właściwości, sporządzają harmonogram działań przewidzianych w programie nadzoru, o którym mowa w pkt 1 lit. a, kontrolują działalność upoważnionych uznanych organizacji podczas wizyt na statku oraz w siedzibie armatora, w tym: – przeprowadzają inspekcje doraźne, o których mowa w art. 20 ust. 2 pkt 3, – przeprowadzają audyty dodatkowe, o których mowa w art. 22 ust. 2 i 2a, – biorą udział w charakterze obserwatora, zgodnie z art. 19a ust. 3, w inspekcjach i audytach przeprowadzanych przez upoważnioną uznaną organizację, po zatrzymaniu statku przeprowadzają inspekcje doraźne, o których mowa w art. 20 ust. 1 pkt 5 lit. e, oraz audyty dodatkowe, o których mowa w art. 22 ust. 2 i 2a, biorą udział w opiniowaniu opracowanych przez upoważnioną uznaną organizację projektów przepisów klasyfikacyjnych, procedur nadzoru nad statkami oraz projektów zmian do takich przepisów i procedur, raz na rok sporządzają i przekazują ministrowi właściwemu do spraw gospodarki morskiej sprawozdanie z czynności wykonanych w ramach nadzoru wraz z całościową oceną działalności upoważnionej uznanej organizacji i wypełniania przez nią zobowiązań określonych w umowach, o których mowa w ust. 1, w zakresie klasyfikacji lub certyfikacji statków znajdujących się w ich właściwości. ” , po ust. 8 dodaje się ust. 8a-8c w brzmieniu: „
    - **a)**
    - **b)**
    - **c)**
    - **d)**
...
- **2)** kujawsko-pomorskiego, lubelskiego, mazowieckiego, podlaskiego, podkarpackiego, pomorskiego, świętokrzyskiego oraz warmińsko-mazurskiego – właściwym jest dyrektor urzędu morskiego, którego terytorialny zakres działania obejmuje port w Gdyni. ” , uchyla się ust. 1b, po ust. 1b dodaje się ust. 1c i 1d w brzmieniu: „
    - **b)**
    - **c)**
...
- **4)** kopie posiadanych autoryzacji producenta na poszczególne urządzenia i wyposażenie. ” , ust. 2 otrzymuje brzmienie: „
    - **d)**

2. Uznania, odnowienia uznania i zmiany zakresu uznania dokonuje się w drodze decyzji, po przeprowadzeniu kontroli polegającej na sprawdzeniu spełnienia wymagań w zakresie bazy technicznej podmiotów, o których mowa w ust. 1, kwalifikacji jego personelu oraz posiadanego przez podmiot systemu jakości. Potwierdzeniem uznania, odnowienia uznania i zmiany zakresu uznania jest świadectwo uznania. ” , ust. 4 otrzymuje brzmienie: „

- **e)**

4. Dyrektor urzędu morskiego może przeprowadzić kontrole sprawdzające w celu stwierdzenia, czy podmioty w okresie ważności świadectwa uznania spełniają wymagania, o których mowa w ust. 2. ” , po ust. 5 dodaje się ust. 5a w brzmieniu: „

- **f)**

5a. W przypadku wydania decyzji o cofnięciu uznania podmioty mogą ponownie ubiegać się o uznanie po upływie 30 dni od dnia wydania tej decyzji. ” , w ust. 7 pkt 1–3 otrzymują brzmienie: „
...
- **8)** w art. 20: w ust. 1 pkt 5 otrzymuje brzmienie: „
    - **a)**

- **5)** doraźnej – przeprowadzanej w przypadku, gdy: stwierdzono lub podejrzewa się, że statek został uszkodzony lub nastąpiła zmiana w jego kadłubie, urządzeniach lub wyposażeniu, jeżeli uszkodzenie lub zmiana mogą wpłynąć na stan bezpieczeństwa statku, statek zmienia klasę lub przedsiębiorstwo odpowiedzialne za eksploatację statku w rozumieniu Kodeksu ISM, stwierdzono lub podejrzewa się, że położenie linii ładunkowej statku nie odpowiada wskazaniom zawartym w świadectwie wolnej burty, statek został zatrzymany w obcym porcie, statek został zwolniony z zatrzymania w obcym porcie – w okresie 3 miesięcy od dnia tego zwolnienia, w raporcie z inspekcji PSC, która nie zakończyła się zatrzymaniem, wskazano 10 i więcej uchybień – w okresie 30 dni od dnia zakończenia inspekcji PSC; ” , po ust. 1b dodaje się ust. 1c i 1d w brzmieniu: „
    - **a)**
    - **b)**
    - **c)**
    - **d)**
...
- **10)** w art. 23: w ust. 1 dodaje się zdanie trzecie w brzmieniu: „ Certyfikaty i karty bezpieczeństwa mogą być wydane w postaci elektronicznej. ” , w ust. 5 pkt 1 otrzymuje brzmienie: „
    - **a)**
    - **b)**
...
- **12)** w art. 28: po ust. 3 dodaje się ust. 3a w brzmieniu: „
    - **a)**

3a. Przepisy ust. 1–3 stosuje się odpowiednio przed wpisaniem do polskiego rejestru okrętowego statku o długości co najmniej 24 m, uprzednio zarejestrowanego w rejestrze administracyjnym polskich statków żeglugi śródlądowej. ” , ust. 4 otrzymuje brzmienie: „
...
- **14)** w art. 62: ust. 3 otrzymuje brzmienie: „
    - **a)**

3. Uprawianie żeglugi jachtem rekreacyjnym oraz jachtem komercyjnym odpłatnie udostępnianym bez załogi o napędzie żaglowym i o długości kadłuba powyżej 7,5 m lub o napędzie mechanicznym o mocy silnika powyżej 10 kW wymaga posiadania dokumentu kwalifikacyjnego. ” , dodaje się ust. 4 i 5 w brzmieniu: „
...
- **16)** w art. 64: w ust. 1 wprowadzenie do wyliczenia otrzymuje brzmienie: „ Osoby ubiegające się o uzyskanie dokumentów kwalifikacyjnych, o których mowa w art. 63 pkt 1 i 2 lub art. 70 ust. 1 pkt 1 i 2, są obowiązane: ” , w ust. 4 pkt 2 otrzymuje brzmienie: „
    - **a)**
    - **b)**

- **2)** egzamin składa się z co najmniej 1 pytania z każdej funkcji wskazanej w wymaganiach egzaminacyjnych na poziomie operacyjnym odpowiednim do kierunku i specjalności studiów, określonych w przepisach wydanych na podstawie art. 70 ust. 4 i 5 lub art. 74 ust. 4; ” , ust. 5 i 6 otrzymują brzmienie: „
    - **c)**
...
- **17)** w art. 69: ust. 1 otrzymuje brzmienie: „
    - **a)**
...
- **18)** w art. 70: w ust. 1 wprowadzenie do wyliczenia otrzymuje brzmienie: „ Potwierdzeniem posiadania kwalifikacji niezbędnych do zajmowania stanowisk na jachtach komercyjnych są również następujące dokumenty kwalifikacyjne: ” , uchyla się ust. 2, ust. 3 otrzymuje brzmienie: „
    - **a)**
    - **b)**
    - **c)**

3. Szkolenia i przeszkolenia niezbędne do uzyskania dokumentów kwalifikacyjnych, o których mowa w ust. 1, są prowadzone przez morskie jednostki edukacyjne, o których mowa w art. 74 ust. 2. ” , w ust. 5 uchyla się pkt 1, 3 i 6;

- **d)**
- **19)** w art. 71: w ust. 1 pkt 4 otrzymuje brzmienie: „
    - **a)**

- **4)** oryginału lub uwierzytelnionej kopii dokumentu potwierdzającego spełnienie wymagań, o których mowa w art. 64 ust. 1 pkt 1 i 2. ” , ust. 3a otrzymuje brzmienie: „
    - **b)**
...
- **20)** w art. 72: ust. 1–3 otrzymują brzmienie: „
    - **a)**
...
3. Zawieszenia uprawnień dokonuje się w drodze decyzji, po przeprowadzeniu postępowania. ” , po ust. 4 dodaje się ust. 4a w brzmieniu: „

- **b)**

4a. Zawieszenie uprawnień dokonane na podstawie prawomocnego orzeczenia izby morskiej lub sądu, w tym sądu państwa obcego, następuje na okres wskazany w tym orzeczeniu. ” , ust. 6 i 7 otrzymują brzmienie: „
...
- **21)** w art. 74: po ust. 3a dodaje się ust. 3b w brzmieniu: „
    - **a)**
...
- **3)** stanu zdrowia umożliwiającego realizację programu przeszkolenia. ” , ust. 4 otrzymuje brzmienie: „
    - **b)**
...
- **22)** w art. 75: w ust. 1 wprowadzenie do wyliczenia otrzymuje brzmienie: „ Minister właściwy do spraw gospodarki morskiej uznaje morskie jednostki edukacyjne w zakresie szkolenia członków załóg statków morskich oraz zgodności z przepisami ustawy lub postanowieniami Konwencji STCW oraz sprawuje nadzór nad tymi jednostkami w tym zakresie przez dokonywanie audytów dotyczących: ” , po ust. 6 dodaje się ust. 6a-6c w brzmieniu: „
    - **a)**
    - **b)**
...
6c. Zawieszenie uznania może nastąpić także na wniosek podmiotu, o którym mowa w ust. 1. ” , ust. 7 otrzymuje brzmienie: „
...
- **5)** na wniosek podmiotu, o którym mowa w ust. 1. ” , po ust. 7 dodaje się ust. 7a i 7b w brzmieniu: „
    - **d)**
...
- **27)** w art. 86: ust. 2 otrzymuje brzmienie: „
    - **a)**

2. Statek oraz jednostka pływająca Straży Granicznej, Policji i Służby Ochrony Państwa są obowiązane przestrzegać zasad bezpieczeństwa żeglugi określonych postanowieniami rozdziału V Konwencji SOLAS. ” , ust. 4 otrzymuje brzmienie: „
...
- **28)** w art. 87: w ust. 1 wprowadzenie do wyliczenia otrzymuje brzmienie: „ Armator, kapitan lub przedstawiciel kapitana statku zmierzającego do portu polskiego jest obowiązany przekazać właściwemu dyrektorowi urzędu morskiego informację dotyczącą identyfikacji statku, portu przeznaczenia, przewidywanego czasu przybycia do portu i przewidywanego czasu wyjścia z portu oraz liczby wszystkich osób na pokładzie: ” , uchyla się ust. 2, po ust. 3 dodaje się ust. 3a w brzmieniu: „
    - **a)**
    - **b)**
    - **c)**

3a. Obowiązku, o którym mowa w ust. 1 i 3, nie stosuje się do armatora, kapitana lub przedstawiciela kapitana statku, o którym mowa w art. 4 ust. 2. ” , ust. 4 i 5 otrzymują brzmienie: „
...
- **30)** w art. 91: ust. 1a otrzymuje brzmienie: „
    - **a)**
...
- **34)** w art. 107: ust. 6 otrzymuje brzmienie: „
    - **a)**

6. Szkolenie kandydatów na pilotów morskich i pilotów morskich prowadzą ośrodek szkolenia pilotów morskich lub stacja pilotowa uznane przez ministra właściwego do spraw gospodarki morskiej. ” , po ust. 6 dodaje się ust. 6a w brzmieniu: „

- **b)**

6a. Praktykę pilotową prowadzi stacja pilotowa właściwa dla rejonu pilotowego, dla którego przeprowadzono nabór na szkolenie kandydatów na pilotów morskich. ” , ust. 7–9 otrzymują brzmienie: „
...
- **35)** w art. 107a: ust. 1 otrzymuje brzmienie: „
    - **a)**

1. Minister właściwy do spraw gospodarki morskiej sprawuje nadzór nad ośrodkami szkolenia pilotów morskich i stacjami pilotowymi w zakresie zgodności prowadzenia szkoleń kandydatów na pilotów morskich i pilotów morskich z przepisami ustawy przez dokonywanie audytów dotyczących uznania, zmiany zakresu uznania oraz odnowienia ważności uznania. ” , ust. 3 otrzymuje brzmienie: „

- **b)**

3. W przypadku uzasadnionego podejrzenia wystąpienia nieprawidłowości w szkoleniu kandydatów na pilotów morskich lub pilotów morskich minister właściwy do spraw gospodarki morskiej przeprowadza audyt dodatkowy. ” , ust. 5 otrzymuje brzmienie: „

- **c)**

5. Jeżeli w wyniku przeprowadzonego audytu zostały stwierdzone nieprawidłowości w szkoleniu kandydatów na pilotów morskich lub pilotów morskich, minister właściwy do spraw gospodarki morskiej może, w drodze decyzji, zawiesić lub cofnąć uznanie ośrodka szkolenia pilotów morskich lub stacji pilotowej, w zależności od rodzaju stwierdzonych nieprawidłowości. ” , po ust. 5 dodaje się ust. 5a-5d w brzmieniu: „
...
5d. Decyzja o zawieszeniu lub cofnięciu uznania podlega natychmiastowemu wykonaniu. ” , ust. 6 i 7 otrzymują brzmienie: „
...
- **36)** w art. 107b w ust. 6: pkt 3 otrzymuje brzmienie: „
    - **a)**

- **3)** warunki wymagane do uzyskania i odnawiania dokumentów kwalifikacyjnych i dokumentów potwierdzających szczególne uprawnienia pilotowe, wzory tych dokumentów oraz terminy ich ważności, ” , pkt 7 i 8 otrzymują brzmienie: „
    - **b)**
...
1. Kto uzyska wiadomość o zagrożeniu życia ludzkiego na morzu, jest obowiązany niezwłocznie poinformować o tym Morskie Ratownicze Centrum Koordynacyjne lub Centrum Powiadamiania Ratunkowego (112) w rozumieniu ustawy z dnia 22 listopada 2013 r. o systemie powiadamiania ratunkowego (Dz. U. z 2022 r. poz. 2175, 2666 i 2705) lub terenowe jednostki organizacyjne Morskiej Służby Poszukiwania i Ratownictwa, organy administracji morskiej, jednostki Sił Zbrojnych Rzeczypospolitej Polskiej, Straży Granicznej, Państwowej Straży Pożarnej lub Policji.
...
- **44)** w art. 122: ust. 2 i 3 otrzymują brzmienie: „
    - **a)**
...
3. Przepisy ust. 2 stosuje się odpowiednio do zmian w treści Planu SAR, z uwzględnieniem ust. 4. ” , dodaje się ust. 4 i 5 w brzmieniu: „
...
- **48)** w załączniku do ustawy w części I: po pkt 18.1 dodaje się pkt 18.1a i 18.1b w brzmieniu:
    - **a)**
...
18. 1b. Za przeprowadzenie audytu dodatkowego w związku z zatrzymaniem statku lub uchybieniami stwierdzonymi przez inspekcję państwa portu w obcym porcie, o którym mowa w art. 22 ust. 2 pkt 2 i 3 i ust. 2a pkt 2 – 1000 PLN. ” , w pkt 18.8 wyraz „stacji” zastępuje się wyrazami „podmiotu dokonującego”, pkt 19.2 otrzymuje brzmienie:
...
- **4)** udziałów albo akcji na rzecz spółki handlowej: której wyłącznym udziałowcem albo akcjonariuszem jest Skarb Państwa, będącej operatorem systemu przesyłowego albo posiadającej koncesję na przesyłanie paliw ciekłych, w rozumieniu ustawy z dnia 10 kwietnia 1997 r. – Prawo energetyczne (Dz. U. z 2022 r. poz. 1385, 1723, 2127, 2243, 2370 i 2687), która jest operatorem systemu dystrybucyjnego gazowego w rozumieniu ustawy z dnia 10 kwietnia 1997 r. – Prawo energetyczne, w przypadku nabycia nieruchomości położonej w granicach portu o podstawowym znaczeniu dla gospodarki narodowej na cele związane z budową, modernizacją lub rozbudową systemu dystrybucyjnego gazowego;
    - **a)**
    - **b)**
...
§ 5. Statek wpisuje się do rejestru okrętowego na wniosek właściciela lub wszystkich współwłaścicieli. ” , po § 5 dodaje się § 5a i § 5b w brzmieniu: „
...
§ 1. Statek niestanowiący polskiej własności ani nieuważany za stanowiący polską własność wpisuje się do rejestru okrętowego, na wniosek armatora, po spełnieniu wymogów określonych w art. 13 § 1 oraz art. 23 § 5a, z uwzględnieniem § 2. ” . W ustawie z dnia 4 września 2008 r. o ochronie żeglugi i portów morskich (Dz. U. z 2022 r. poz. 2257) wprowadza się następujące zmiany:
...
- **3)** w art. 4 w pkt 8 lit. g otrzymuje brzmienie: „ współdziałania z PFSO, CSO, właściwym terytorialnie wojewodą, Strażą Graniczną, Policją, Państwową Strażą Pożarną oraz Służbą Celno-Skarbową w celu realizacji ochrony żeglugi i portów, w sposób określony w ustawie, ” ;
    - **g)**

- **4)** w art. 18: ust. 6 otrzymuje brzmienie: „
    - **a)**

6. Organ ochrony portu uzgadnia ocenę stanu ochrony i plan ochrony portu z właściwym terytorialnie wojewodą w zakresie zadań wynikających z art. 22 ustawy z dnia 23 stycznia 2009 r. o wojewodzie i administracji rządowej w województwie (Dz. U. z 2023 r. poz. 190) w terminie 14 dni. ” , po ust. 9 dodaje się ust. 9a w brzmieniu: „
...
- **6)** w art. 21: po ust. 3 dodaje się ust. 3a i 3b w brzmieniu: „
    - **a)**
...
- **2)** w odniesieniu do portów: przedstawiciele ministra właściwego do spraw gospodarki morskiej oraz dyrektorów urzędów morskich, funkcjonariusze Policji wyznaczeni przez Komendanta Głównego Policji;
    - **a)**
    - **b)**

- **3)** w odniesieniu do obiektów portowych: przedstawiciele dyrektora właściwego urzędu morskiego, funkcjonariusze Policji wyznaczeni przez Komendanta Głównego Policji. ” , uchyla się ust. 3, ust. 4 otrzymuje brzmienie: „
    - **a)**
    - **b)**
    - **c)**
    - **d)**
...
- **2)** wydaje dokumenty identyfikacyjne DAO oraz prowadzi listę DAO na stronie podmiotowej urzędu morskiego. ” , dodaje się ust. 5 w brzmieniu: „
    - **e)**
...
- **13)** w art. 36: w ust. 1 po wyrazie „weryfikacji” dodaje się wyrazy „ochrony obiektu portowego”, w ust. 3 skreśla się wyrazy „portem lub”;
    - **a)**
    - **b)**

- **14)** w art. 37: wprowadzenie do wyliczenia otrzymuje brzmienie: „ Minister właściwy do spraw gospodarki morskiej określi, w drodze rozporządzenia, sposób przeprowadzania weryfikacji i prób efektywności w zakresie ochrony żeglugi i portów, mając na uwadze: ” , uchyla się pkt 2;
    - **a)**
    - **b)**
...
3. Organem właściwym do monitorowania wykorzystania limitu wydatków, o którym mowa w ust. 1, oraz wdrożenia mechanizmu korygującego, o którym mowa w ust. 2, jest minister właściwy do spraw gospodarki morskiej. Ustawa wchodzi w życie po upływie 30 dni od dnia ogłoszenia, z wyjątkiem:
