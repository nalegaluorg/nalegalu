...
3) odczytuje sens całego tekstu (a w nim znaczenia wyrazów, związków frazeologicznych, zdań, grup zdań uporządkowanych w akapicie, odróżnia znaczenie realne i etymologiczne) oraz wydzielonych przez siebie fragmentów;
...
10) stosuje uczciwe zabiegi perswazyjne, zdając sobie sprawę z ich wartości i funkcji;
...
13) recytuje utwory literackie, dbając o prawidłowe akcentowanie i intonację;
interpretując je głosowo.
2. Pisanie. Uczeń:
...
3. Świadomość językowa.
Zgodnie z opisem umiejętności oraz kręgami tematycznymi (leksyka).
Teksty kultury Teksty poznawane w całości (nie mniej niż 8 pozycji książkowych oraz wybrane przez nauczyciela teksty o mniejszej objętości, przy czym nie można pominąć autorów i utworów oznaczonych gwiazdką): Miron Białoszewski, wybrane utwory;
*Bogurodzica;
...
Teksty poznawane w całości lub w części: Irit Amiel, wybrane opowiadanie z tomu Osmaleni;
...
Wybrane polskie komiksy Wybrane filmy: Miś, reżyser Stanisław Bareja;
...
Wybrane inscenizacje polskiego dramatu Kręgi tematyczne: ja i moi bliscy:
...
10) synchronizuje najważniejsze wydarzenia z historii Polski w drugiej połowie XX w.
z wydarzeniami europejskimi i powszechnymi.
