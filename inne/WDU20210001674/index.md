...
# RZECZYPOSPOLITEJ POLSKIEJ Poz. 1674 ROZPORZĄDZENIE MINISTRA ROZWOJU, PRACY I TECHNOLOGII z dnia 5 sierpnia 2021 r.
...
Minister Rozwoju, Pracy i Technologii: J. Gowin SZCZEGÓŁOWE WYMOGI PROWADZENIA KARTY KWALIFIKACYJNEJ OBIEKTU MAGAZYNOWEGO, W KTÓRYM SĄ PRZECHOWYWANE MATERIAŁY WYBUCHOWE, BROŃ, AMUNICJA ORAZ WYROBY I TECHNOLOGIA O PRZEZNACZENIU WOJSKOWYM LUB POLICYJNYM
...
§ 1. 1. Magazyn bazowy, w którym są przechowywane materiały wybuchowe i amunicja zaklasyfikowane do podklasy
...
Tabela 1. Dopuszczalne wielkości nadciśnienia fali uderzeniowej dla różnych obiektów Dopuszczalna wielkość Lp. Rodzaj zagrożonego obiektu, w stosunku do którego jest wyznaczana nadciśnienia fali minimalna dopuszczalna odległość (L ) uderzeniowej (P ) w kilopaskalach (kPa) Magazyn materiałów wybuchowych i amunicji przechowywanych 1 w opakowaniach transportowych; budynek służący do produkcji mate- 80 kPa riałów wybuchowych bez stałej obsady.
Budynek typu bunkrowego ze stałą obsadą, służący do produkcji mate2 riałów wybuchowych, a także obiekt towarzyszący oraz magazyn półfa- 60 kPa brykatów.
...
§ 2. 1. W magazynie podręcznym przechowuje się materiał wybuchowy oraz amunicję zaklasyfikowane do podklasy
1.1 i 1.5 oraz klas 3 i 4.1 w ilościach netto nieprzekraczających wielkości podanych w tabeli 2.
Tabela 2. Ilość materiału wybuchowego netto dopuszczona do przechowywania w magazynie podręcznym Lp. Podklasa materiału Grupa Dopuszczalna masa netto przechowywanego materiału wybuchowego zgodności wybuchowego 1 1.1 A 1 kg 2 1.1 B 1 kg 3 1.1 C 25 kg 4 1.1 i 1.5 D 5 kg 5 w ilościach uzasadnionych z punktu widzenia bezpieczeństwa ludzi,
1.1 E, F, J, K, L mienia i środowiska naturalnego w magazynie podręcznym oraz jego otoczeniu, stosownie do zapisu w karcie oceny materiału wybuchowego pod względem bezpieczeństwa 6 1.1 G 25 kg 7 3 i 4.1 25 kg
...
Tabela 1. Kryteria lokalizacji magazynu bazowego nieobwałowanego w stosunku do innych obiektów wymienionych w tabeli Podklasa Magazyn Obiekt przechowy- i obiekt produkcyjny Droga Autostrada Obszar wanego Dodatkowe produkcyjny niezawiera- dojazdowa i droga o dużym zamieszkały materiału uwarunkowania zawierający jący i droga lokalna natężeniu ruchu wybucho- materiał materiału wego wybuchowy wybuchowego przy wybuchu
1.2 nie tworzą się odległość odległość Ld = 3 x G L = 58 × G odłamki min. 90 m min. 90 m o dużej masie przy wybuchu
1.2 mogą tworzyć odległość odległość L = 51 × G L = 76 × G się odłamki min. 135 m min. 135 m min. 90 m min. 135 m o dużej masie Masa netto nie jest wymagane wyznaczanie minimalnej dopuszczalnej odległości, muszą być jedmateriałów nak zachowane środki bezpieczeństwa, aby skutki ewentualnego zapłonu lub wybuchu
...
1.3 wybuchowych odległość odległość odległość min. odległość min. 60 m przekracza min. 40 m min. 60 m 40 m 1000 kg Masa netto materiałów
