...
# Rozporządzenie Ministra Zdrowiaz dnia 8 marca 2023 r. w sprawie szczególnej ochrony niektórych kategorii osób w związku z ekspozycją medyczną w badaniach diagnostycznych, zabiegach i leczeniu
...
1)
należy stosować dodatkową filtrację oraz wysokie napięcie o wartości wyższej od wartości wysokiego napięcia stosowanego u pacjentów dorosłych;
2)
