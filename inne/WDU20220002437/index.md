...
| Źródło | [ELI HTML](https://eli.gov.pl/api/acts/DU/2022/2437/text.html) · [ELI API](https://api.sejm.gov.pl/eli/acts/DU/2022/2437) |

## Treść rozporządzenia

Na podstawie art. 46 ust. 5 i 6 ustawy z dnia 10 kwietnia 1997 r. - Prawo energetyczne ([Dz. U. z 2022 r. poz. 1385](https://api.sejm.gov.pl/eli/acts/DU/2022/1385/text.html), [1723](https://api.sejm.gov.pl/eli/acts/DU/2022/1723/text.html), [2127](https://api.sejm.gov.pl/eli/acts/DU/2022/2127/text.html), [2243](https://api.sejm.gov.pl/eli/acts/DU/2022/2243/text.html) i [2370](https://api.sejm.gov.pl/eli/acts/DU/2022/2370/text.html)) zarządza się, co następuje:

### § 1.

W rozporządzeniu Ministra Klimatu z dnia 7 kwietnia 2020 r. w sprawie szczegółowych zasad kształtowania i kalkulacji taryf oraz rozliczeń z tytułu zaopatrzenia w ciepło ([Dz. U. poz. 718](https://api.sejm.gov.pl/eli/acts/DU/2020/718/text.html), [z 2021 r. poz. 158](https://api.sejm.gov.pl/eli/acts/DU/2021/158/text.html) i [788](https://api.sejm.gov.pl/eli/acts/DU/2021/788/text.html) oraz [z 2022 r. poz. 37](https://api.sejm.gov.pl/eli/acts/DU/2022/37/text.html) i [597](https://api.sejm.gov.pl/eli/acts/DU/2022/597/text.html)) wprowadza się następujące zmiany:
...
w ust. 2 objaśnienie symbolu Cr otrzymuje brzmienie: „ Cr - cenę referencyjną obliczaną dla jednostki kogeneracji, o której mowa w ust. 1, w zależności od rodzaju zużywanego w niej paliwa, o którym mowa w art. 23 ust. 2 pkt 18 lit. c ustawy [w zł/GJ], ” ,
...
\( \left( {{{C_{CSn} } \over {C_{CSn - 1} }} - 1} \right) \times 100 + 3 + \left( {Xc - 1} \right) \times 100 \) dla przedsiębiorstw, których jednoskładnikowa cena ciepła (Cn-1) [w zł/GJ] obliczona na podstawie taryfy obowiązującej w dniu poprzedzającym dzień złożenia wniosku taryfowego i planowanej wielkości sprzedaży ciepła, mocy zamówionej oraz nośnika ciepła na pierwszy rok stosowania taryfy spełniała warunek: \( {{C_{n - 1} } \over {C_{CSn} * Xc}} \le 0,8, \)

### 2)

\( \left( {{{C_{CSn} } \over {C_{CSn - 1} }} - 1} \right) \times 100 + 2,75 + \left( {Xc - 1} \right) \times 100 \) dla przedsiębiorstw, których jednoskładnikowa cena ciepła (Cn-1) [w zł/GJ] obliczona na podstawie taryfy obowiązującej w dniu poprzedzającym dzień złożenia wniosku taryfowego i planowanej wielkości sprzedaży ciepła, mocy zamówionej oraz nośnika ciepła na pierwszy rok stosowania taryfy spełniała warunek: \( 0,8 \lt {{C_{n - 1} } \over {C_{CSn} * Xc}} \le 0,9, \)

### 3)

\( \left( {{{C_{CSn} } \over {C_{CSn - 1} }} - 1} \right) \times 100 + 2,25 + \left( {Xc - 1} \right) \times 100 \) dla przedsiębiorstw, których jednoskładnikowa cena ciepła (Cn-1) [w zł/GJ] obliczona na podstawie taryfy obowiązującej w dniu poprzedzającym dzień złożenia wniosku taryfowego i planowanej wielkości sprzedaży ciepła, mocy zamówionej oraz nośnika ciepła na pierwszy rok stosowania taryfy spełniała warunek: \( 0,9 \lt {{C_{n - 1} } \over {C_{CSn} * Xc}} \)
