...
# Rozporządzenie Ministra Zdrowiaz dnia 27 grudnia 2023 r. w sprawie sposobu ustalenia wysokości ryczałtu dla Krajowego Ośrodka Monitorującego i poszczególnych Wojewódzkich Ośrodków Monitorujących oraz wysokości współczynników korygujących
...
| Źródło | [ISAP](https://isap.sejm.gov.pl/isap.nsf/DocDetails.xsp?id=WDU20230002801) · [PDF](https://api.sejm.gov.pl/eli/acts/DU/2023/2801/text.pdf) |
...
§ 5.
1.
Wysokość współczynników korygujących, o których mowa w art. 35 ust. 3 ustawy o KSO, ustala się według wzoru: \( W_k = 1 + \delta \times \left( {{{W{}_{KU} + W{}_{KN} + W{}_{KR}} \over {PLNS_k }}} \right) \) gdzie \( W_k = \left\{ {\matrix{ {W_k ,W_k \le \max (W_k )} \cr {\max (W_k ),W_k > \max (W_k )} \cr } } \right. \) gdzie: patrz oryginał
§ 6.
1.
