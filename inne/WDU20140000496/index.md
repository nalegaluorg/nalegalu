...
- **2)** po art. 61 dodaje się art. 62 w brzmieniu: „
...
- **11)** w art. 16: w ust. 1 pkt 2 otrzymuje brzmienie: „
    - **a)**

- **2)** renta z tytułu niezdolności do pracy, jeżeli zostali uznani za niezdolnych do pracy. ” , ust. 3 i 4 otrzymują brzmienie: „
    - **b)**
...
- **1)** pomocy doraźnej – jednorazowej: w przypadku trudnej sytuacji materialnej, także w razie zaistnienia zdarzeń losowych – do wysokości 150% najniższej emerytury, na częściowe pokrycie kosztów: – zakupu wózka inwalidzkiego, sprzętu rehabilitacyjnego, przedmiotów ortopedycznych i środków pomocniczych ułatwiających pracę i życie, – dostosowania pomieszczeń mieszkalnych do rodzaju inwalidztwa – do wysokości 300% najniższej emerytury;
    - **a)**
    - **b)**
...
3g. Prezes Głównego Urzędu Statystycznego ogłasza, w formie komunikatu, w Dzienniku Urzędowym Rzeczypospolitej Polskiej „Monitor Polski”, w terminie do dnia 31 stycznia każdego roku, średnioroczny wskaźnik cen konsumpcyjnych nośników energii w poprzednim roku kalendarzowym. ” , ust. 5a otrzymuje brzmienie: „
...
- **16)** w art. 201: po ust. 2 dodaje się ust. 2a w brzmieniu: „
    - **a)**

2a. Świadczenie w wysokości dodatku kombatanckiego, dodatek kompensacyjny oraz ryczałt energetyczny są wypłacane osobom, o których mowa w ust. 1, kwartalnie w trzecim miesiącu kwartału. ” , ust. 3 otrzymuje brzmienie: „
...
- **17)** w art. 22: ust. 1 otrzymuje brzmienie: „
    - **a)**
...
- **1)** art. 5 otrzymuje brzmienie: „ Organem właściwym w sprawie przyznania świadczenia pieniężnego jest Szef Urzędu do Spraw Kombatantów i Osób Represjonowanych. ” ;
