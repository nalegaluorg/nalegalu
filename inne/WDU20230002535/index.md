...
§ 8. 1. Policjant przy zatrzymywaniu osoby:
...
§ 11. 1. Wymaz ze śluzówki policzków od osób lub materiał biologiczny ze zwłok ludzkich o nieustalonej tożsamości pobiera się przy użyciu przeznaczonych specjalnie do tych celów pakietów kryminalistycznych, oznakowanych indywidualnym kodem kreskowym.
...
§ 15. 1. Policjant podczas czynności służbowych wykonuje uprawnienie do obserwowania i rejestrowania obrazu lub dźwięku zdarzeń w sposób:
...
§ 29. 1. Policjant realizuje uprawnienie, o którym mowa w art. 15 ust. 1 pkt 10 ustawy, gdy jest to niezbędne do sprawnego i zgodnego z przepisami ustawy wykonania czynności służbowych.
...
§ 30. Dotychczasowe wzory dokumentów określone w załącznikach do rozporządzenia Rady Ministrów z dnia 4 lutego 2020 r. w sprawie postępowania przy wykonywaniu niektórych uprawnień policjantów (Dz. U. poz. 192 oraz z 2022 r.
