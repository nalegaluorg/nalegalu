...
§ 1. W testamencie sporządzonym formie aktu notarialnego spadkodawca może postanowić, że oznaczona osoba nabywa przedmiot zapisu z chwilą otwarcia spadku (zapis windykacyjny).
...
**Art. 981².** Zapis windykacyjny jest bezskuteczny, jeżeli chwili otwarcia spadku przedmiot zapisu nie należy do spadkodawcy albo spadkodawca był zobowiązany do jego zbycia. Jeżeli przedmiotem zapisu jest ustanowienie dla zapisobiercy użytkowania lub służebności, zapis jest bezskuteczny, kodawca był zobowiązany do jego zbycia.
...
**Art. 981⁶.** W sprawach nieuregulowanych niniejszym rozdziale oraz przepisach szczególnych do zapisu windykacyjnego stosuje się odpowiednio przepisy o zapisie zwykłym.”;
...
§ 1. Zmniejszenie zapisów zwykłych i poleceń następuje stosunku do ich wartości, chyba że z treści testamentu wynika odmienna wola spadkodawcy.
...
§ 1. Jeżeli spadkobierca obowiązany do zaspokojenia roszczenia z tytułu zachowku sam jest uprawniony do zachowku, może on żądać zmniejszenia zapisów zwykłych i poleceń takim stopniu, ażeby pozostał mu jego własny zachowek.
...
- **21)** księdze czwartej tytuł tytułu VI otrzymuje brzmienie:
- **22)** po art. 1029 dodaje się art. 1029 brzmieniu: „Art. 1029 . Przepisy niniejszego tytułu stosuje się odpowiednio do stwierdzenia nabycia przedmiotu zapisu windykacyjnego.”;
...
- **24)** po art. 1034 dodaje się art. 1034 – 1034 brzmieniu: „Art. 1034 . § 1. Do chwili działu spadku wraz ze spadkobiercami solidarną odpowiedzialność za długi spadkowe ponoszą także osoby, na których rzecz spadkodawca uczynił zapisy windykacyjne.

§ 2. Rozliczenia między spadkobiercami i osobami, na których rzecz zostały uczynione zapisy windykacyjne, następują proporcjonalnie do wartości otrzymanych przez nich przysporzeń. Spadkobiercom uwzględnia się ich udział wartości ustalonego inwentarzu stanu czynnego spadku.
...
**Art. 7.** W ustawie z dnia 28 lutego 2003 r. – Prawo upadłościowe i naprawcze (Dz. U. z 2009 r. Nr 175, poz. 1361, z późn. zm. ) art. 123 otrzymuje brzmienie: „Art. 123. Oświadczenie upadłego o odrzuceniu spadku lub zapisu windykacyjnego jest bezskuteczne stosunku do masy upadłości, jeżeli zostało złożone po ogłoszeniu upadłości.”.

**Art. 8.** Do roszczeń, o których mowa art. 1007 ustawy, o której mowa art. 1, powstałych przed dniem wejścia życie niniejszej ustawy i tym dniu jeszcze nie przedawnionych, stosuje się przepisy tego artykułu brzmieniu nadanym niniejszą ustawą.
