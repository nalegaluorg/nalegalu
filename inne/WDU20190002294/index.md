...
4. Do organu gminy przepisów ust. 1–3 nie stosuje się. Osobie fizycznej, po uprzednim jej uwierzytelnieniu w sposób określony w art. 20a ust. 1, zapewnia się wgląd do dotyczących jej danych, o których mowa w art. 20j ust. 1. ” ;
...
- **2)** nazwisko;
- **3)** numer PESEL;
- **4)** adres zameldowania na pobyt: stały albo czasowy oraz datę upływu deklarowanego terminu pobytu. ” ;
    - **a)**
    - **b)**
...
- **1)** w art. 2: w ust. 2: – pkt 1 i 2 otrzymują brzmienie: „ 1) budowy systemów lub rozwiązań teleinformatycznych, 2) rozbudowy lub unowocześnienia istniejących systemów lub rozwiązań teleinformatycznych, ” , – dodaje się pkt 3 w brzmieniu: „ 3) utrzymania systemów lub rozwiązań teleinformatycznych ” , ust. 3 i 4 otrzymują brzmienie: „
    - **a)**
    - **b)**
...
- **2)** w art. 9 w ust. 2: pkt 1 i 2 otrzymują brzmienie: „
    - **a)**

- **1)** przedmiot umowy obejmujący zadania, w tym usługi, powierzane do wykonania przez spółkę celową;
- **2)** sposób realizacji przez spółkę celową przedmiotu umowy, o którym mowa w pkt 1; ” , uchyla się pkt 3, pkt 5 otrzymuje brzmienie: „
    - **b)**
    - **c)**
...
- **4)** art. 45 pkt 1, 2, 4 i 5, które wchodzą w życie z dniem 1 stycznia 2020 r.; ” . Do kontroli prowadzonych na podstawie art. 25 ust. 3 ustawy zmienianej w art. 1, wszczętych i niezakończonych przed dniem wejścia w życie niniejszej ustawy, stosuje się przepisy dotychczasowe. Tworzy się rejestr danych kontaktowych osób fizycznych.
...
- **4)** art. 7: pkt 4, który wchodzi w życie z dniem 28 kwietnia 2020 r., pkt 1–3 i 5–7, które wchodzą w życie z dniem 28 maja 2020 r.;
    - **a)**
    - **b)**
