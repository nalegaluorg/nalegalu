...
*USTAWA 16 lipca wsparciu rynku ubezpieczeń należności handlowych związku przeciwdziałaniem skutkom gospodarczym COVID-19*
...
3. W przypadku przedsiębiorcy, którym 2 pkt 1 lit. a, przejęcie ryzyka dotyczy należności handlowych tytułu:

- **1)** sprzedaży towarów lub świadczenia usług terytorium Rzeczypospolitej Polskiej lub
...
1. Rada Ministrów celu minimalizacji skutków gospodarczych rozprzestrzeniania się COVID-19 może przyjąć rządowy program wsparcia rynku ubezpieczeń należności handlowych, zwany dalej „Programem”.
...
1. Skarb Państwa, reprezentowany przez ministra właściwego do spraw gospodarki, ramach realizacji Programu, drodze umowy zawartej zakładem ubezpieczeń, może zobowiązać się do przejęcia 80% ryzyka ubezpieczeniowego wynikającego portfela ubezpieczeń należności handlowych.

2. Po przekroczeniu kwoty odszkodowań wypłaconych przez zakład ubezpieczeń tytułu objęcia ochroną ubezpieczeniową należności handlowych, pomniejszonej kwoty uzyskane przez zakład ubezpieczeń tytułu roszczeń regresowych dotyczących tych należności handlowych, równej 243,75% składki przypisanej brutto zakładu ubezpieczeń ubezpieczenia należności handlowych 2019 r., Skarb Państwa przejmuje 100% ryzyka ubezpieczeniowego.
...
1. W przypadku zawarcia umowy, której 4 1, Skarbowi Państwa przysługuje udział:
...
- **2)** kwotach uzyskanych przez zakład ubezpieczeń wyniku postępowań regresowych dotyczących należności handlowych wysokości proporcjonalnej do udziału Skarbu Państwa wypłaconym odszkodowaniu dotyczącym danej należności handlowej.

2. Z tytułu zarządzania portfelem ubezpieczeń należności handlowych, którym 4 1, zakładowi ubezpieczeń przysługuje od Skarbu Państwa prowizja wysokości 28% zainkasowanej składki należnej zakładowi ubezpieczeń tytułu objęcia ochroną ubezpieczeniową należności handlowych.
...
4. Przed wydaniem opinii Komisja Nadzoru Finansowego może zwrócić się do ministra właściwego do spraw gospodarki przekazanie dodatkowych informacji.
