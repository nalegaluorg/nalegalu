...
- **1)** do tytułu ustawy dodaje się odnośnik nr 1 w brzmieniu: „ 1) Niniejsza ustawa w zakresie swojej regulacji wdraża dyrektywę Parlamentu Europejskiego i Rady 2009/126/WE z dnia 21 października 2009 r. w sprawie odzyskiwania oparów paliwa na etapie II podczas tankowania pojazdów silnikowych na stacjach paliw (Dz. Urz. UE L 285 z 31.10.2009, str. 36 oraz Dz. Urz. UE L 304 z 23.10.2014, str. 89). ” ;
...
- **1a)** urządzeniach do odzyskiwania par paliwa – należy przez to rozumieć urządzenia zainstalowane na stacjach paliw płynnych, służące do odzyskiwania par produktów naftowych I klasy ulatniających się podczas ich wydawania do zbiornika pojazdu i przekazujące te pary do zbiornika magazynowego tych produktów lub do odmierzacza paliw płynnych; ” , pkt 2 otrzymuje brzmienie: „
    - **b)**
...
- **1)** wstępu za okazaniem upoważnienia i legitymacji służbowej, o których mowa w art. 24 ust. 1, bez potrzeby uzyskiwania przepustki, do pomieszczeń i obiektów, w których znajdują się urządzenia techniczne lub urządzenia do odzyskiwania par paliwa; ” , pkt 3 otrzymuje brzmienie: „
    - **b)**

- **3)** dostępu do urządzeń technicznych lub urządzeń do odzyskiwania par paliwa; ” , po pkt 5 dodaje się pkt 5a w brzmieniu: „
    - **c)**
...
- **12)** w art. 37: po pkt 1 dodaje się pkt 1a w brzmieniu: „
    - **a)**

- **1a)** nadzór i kontrola przestrzegania przepisów o dozorze technicznym dotyczących urządzeń do odzyskiwania par paliwa; ” , po pkt 2 dodaje się pkt 2a w brzmieniu: „
    - **b)**
...
- **14)** w art. 44 w ust. 1: w pkt 1 w lit. e średnik zastępuje się przecinkiem i dodaje się lit. f w brzmieniu: „ urządzeniami do odzyskiwania par paliwa zainstalowanymi na obszarach kolejowych, bocznicach kolejowych, na terenie portów i przystani morskich oraz żeglugi śródlądowej; ” , po pkt 1 dodaje się pkt 1a w brzmieniu: „
    - **a)**
    - **f)**
    - **b)**

- **1a)** nadzór i kontrola przestrzegania przepisów o dozorze technicznym dotyczących urządzeń do odzyskiwania par paliwa, o których mowa w pkt 1 lit. f; ” , pkt 3 otrzymuje brzmienie: „
    - **c)**

- **3)** wydawanie decyzji w sprawach wynikających z wykonywania dozoru technicznego nad urządzeniami, o których mowa w pkt 1; ” ;
- **15)** w art. 50 w ust. 1: w pkt 1 wprowadzenie do wyliczenia otrzymuje brzmienie: „
    - **a)**

- **1)** wykonywanie dozoru technicznego nad urządzeniami technicznymi oraz urządzeniami do odzyskiwania par paliwa zainstalowanymi i eksploatowanymi w: ” , pkt 2 otrzymuje brzmienie: „
    - **b)**
