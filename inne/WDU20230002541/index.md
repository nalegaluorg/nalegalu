...
# Rozporządzenie Ministra Edukacji i Naukiz dnia 21 listopada 2023 r. zmieniające rozporządzenie w sprawie szczegółowego zakresu danych dziedzinowych gromadzonych w systemie informacji oświatowej oraz terminów przekazywania niektórych danych do bazy danych systemu informacji oświatowej
...
2)
w § 12 wprowadzenie do wyliczenia otrzymuje brzmienie: „ W ramach danych, o których mowa w art. 8 pkt 2c lit. c ustawy, w SIO gromadzi się dane dziedzinowe dotyczące organizacji i działalności placówek kształcenia ustawicznego, centrów kształcenia zawodowego oraz branżowych centrów umiejętności, które obejmują: ” ;
3)
w § 14 w pkt 2 lit. c otrzymuje brzmienie:
„
c)
...
5)
w § 22 po wyrazach „Kodeksu pracy,” skreśla się wyrazy „ustawy o systemie oświaty,”;
6)
...
b)
w pkt 14 kropkę zastępuje się średnikiem i dodaje się pkt 15–21 w brzmieniu:
„
15)
...
– w pkt 7 lit. b otrzymuje brzmienie: „ b) rozpoczęcia przygotowania do zawodu nauczyciela, o którym mowa w art. 9a ust. 2 ustawy – Karta Nauczyciela. ” ,
b)
