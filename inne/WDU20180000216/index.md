...
# Rozporządzenie Ministra Spraw Wewnętrznych i Administracjiz dnia 22 stycznia 2018 r. zmieniające rozporządzenie w sprawie umundurowania funkcjonariuszy Straży Granicznej Minister Spraw Wewnętrznych i Administracji kieruje działem administracji rządowej – sprawy wewnętrzne, na podstawie § 1 ust. 2 pkt 2 rozporządzenia Prezesa Rady Ministrów z dnia 10 stycznia 2018 r. w sprawie szczegółowego zakresu działania Ministra Spraw Wewnętrznych i Administracji (Dz. U. poz. 97).

| Pole | Wartość |
|---|---|
| Adres publikacyjny | Dz.U. 2018 poz. 216 |
| ISAP | WDU20180000216 |
...
| Źródło | [ISAP](https://isap.sejm.gov.pl/isap.nsf/DocDetails.xsp?id=WDU20180000216) · [PDF](https://api.sejm.gov.pl/eli/acts/DU/2018/216/text.pdf) |
...
§ 1.
W rozporządzeniu Ministra Spraw Wewnętrznych i Administracji z dnia 25 marca 2016 r. w sprawie umundurowania funkcjonariuszy Straży Granicznej (Dz. U. poz. 424) wprowadza się następujące zmiany:
1)
...
3)
w § 25 pkt 1 otrzymuje brzmienie: „
1)
...
6)
w § 31 w ust. 4 pkt 1 otrzymuje brzmienie: „
1)
...
b)
w pkt 5 ppkt 3 i 4 otrzymują brzmienie: „
3)
...
10)
w załączniku nr 9 do rozporządzenia w tabeli w kolumnie „Opis przypadku” lp. 1 otrzymuje brzmienie: „ Powołanie na stanowisko Komendanta lub zastępcy Komendanta Biura Spraw Wewnętrznych Straży Granicznej, komendanta lub zastępcy komendanta oddziału, ośrodka szkolenia lub ośrodka Straży Granicznej ” ;
11)
w załączniku nr 10 do rozporządzenia uwaga nr 7 do tabeli 2 otrzymuje brzmienie: „
7.
