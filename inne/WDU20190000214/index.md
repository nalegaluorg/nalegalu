...
# RZECZYPOSPOLITEJ POLSKIEJ Poz. 214 ROZPORZĄDZENIE MINISTRA FINANSÓW z dnia 14 stycznia 2019 r.
...
w sprawie kontroli celno-skarbowej wydobycia niektórych kopalin Na podstawie art. 92 ustawy z dnia 16 listopada 2016 r. o Krajowej Administracji Skarbowej (Dz. U. z 2018 r.
...
§ 4. 1. Ewidencje, o których mowa w § 3 ust. 1 i 3, są prowadzone w sposób umożliwiający identyfikację czynności podlegających ewidencjonowaniu przy zachowaniu ciągłości zapisów.
...
§ 5. 1. Wpisów do ewidencji, o której mowa w § 3 ust. 1, dokonuje się bezpośrednio po przyjęciu zakupionego urobku rudy miedzi, przekazaniu zakupionego urobku rudy miedzi do produkcji koncentratu oraz określeniu ilości koncentratu wyprodukowanego z zakupionego urobku rudy miedzi.
...
§ 6. 1. Wpisów do ewidencji, o której mowa w § 3 ust. 3, dokonuje się bezpośrednio po podłączeniu lub odłączeniu przyrządu pomiarowego podlegającego ewidencjonowaniu.
...
Minister Finansów: T. Czerwińska WZÓR EWIDENCJA ZAKUPIONEGO UROBKU RUDY MIEDZI, WYPRODUKOWANEGO Z NIEGO KONCENTRATU ORAZ ZAWARTOŚCI W TYM KONCENTRACIE MIEDZI I SREBRA Lp. Data wpisu Ilość Ilość Ilość Ilość miedzi i srebra przyjęta zakupionego koncentratu w otrzymanym koncentracie zakupionego urobku rudy wyprodukowana urobku rudy miedzi z zakupionego miedzi srebra miedzi przekazana urobku rudy [t] [kg] [t] do produkcji miedzi koncentratu [t] [t] 1 2 3 4 5 6 7 WZÓR EWIDENCJA PRZYRZĄDÓW POMIAROWYCH UŻYWANYCH DO POMIARU ILOŚCI GAZU ZIEMNEGO LUB ROPY NAFTOWEJ Lp. Data Rodzaj Miejsce Rodzaj i cechy Osoba Stan licznika przyrządu Uwagi wpisu czynności zainstalowania przyrządu odpowiedzialna pomiarowego przyrządu pomiarowego za nadzór nad podłączenie/ pomiarowego użytkowaniem początkowy końcowy odłączenie przyrządu pomiarowego 1 2 3 4 5 6 7 8 9 ____________________________
