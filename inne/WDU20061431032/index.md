...
- **12)** inny zakład spełniający warunki określone w ustawie. ” , ust. 5 otrzymuje brzmienie: „
    - **b)**
...
- **4)** w art. 8: w ust. 1 po pkt 3a dodaje się pkt 3b w brzmieniu: „
    - **a)**

- **3b)** Centrum Medyczne Kształcenia Podyplomowego, ” , ust. 2 otrzymuje brzmienie: „
    - **b)**
...
3a. Do wolontariatu stosuje się przepisy działu III ustawy z dnia 24 kwietnia 2003 r. o działalności pożytku publicznego i o wolontariacie. ” , ust. 5 otrzymuje brzmienie: „
...
- **11)** w art. 18: po ust. 2 dodaje się ust. 2a w brzmieniu: „
    - **a)**
...
- **4)** datę sporządzenia. ” , po ust. 4 dodaje się ust. 4a-4f w brzmieniu: „
    - **b)**
...
- **3)** skierowań na badania lub zleceń lekarza, które są przechowywane przez okres 5 lat, licząc od końca roku kalendarzowego, w którym zrealizowano świadczenie będące przedmiotem skierowania lub zlecenia. ” , dodaje się ust. 8 i 9 w brzmieniu: „
    - **c)**
...
- **2)** jako członkowie: przedstawiciel ministra właściwego do spraw zdrowia, przedstawiciel wojewody, przedstawiciel przewodniczącego zarządu samorządu województwa, przedstawiciel okręgowej izby lekarskiej, przedstawiciel okręgowej rady pielęgniarek i położnych, osoby powołane przez dyrektora Centrum Medycznego Kształcenia Podyplomowego – w liczbie nieprzekraczającej 5 osób.
    - **a)**
    - **b)**
    - **c)**
    - **d)**
...
- **34)** w art. 54: w ust. 1 po pkt 2 dodaje się pkt 2a w brzmieniu: „
    - **a)**

- **2a)** na realizację programów współfinansowanych ze środków pochodzących z budżetu Unii Europejskiej, ” , po ust. 2 dodaje się ust. 2a w brzmieniu: „
    - **b)**
...
- **38)** w art. 60: ust. 4a i 4b otrzymują brzmienie: „
    - **a)**
...
- **5)** oznaczenie dnia zakończenia czynności likwidacyjnych. ” , ust. 5 otrzymuje brzmienie: „
    - **b)**

5. Rozporządzenie, zarządzenie lub uchwała o likwidacji samodzielnego publicznego zakładu opieki zdrowotnej stanowi podstawę do wykreślenia zakładu z Krajowego Rejestru Sądowego. ” , uchyla się ust. 5a, ust. 6 otrzymuje brzmienie: „
...
- **1)** przeprowadzania kontroli, pod względem zgodności z prawem, celowości i gospodarności, działalności prowadzonej przez zakład, obejmującej w szczególności: wizytację pomieszczeń zakładu, obserwowanie czynności związanych z udzielaniem świadczeń zdrowotnych, z zastrzeżeniem art. 19 ust. 1 pkt 4, sprawdzanie przestrzegania spełniania wymagań dotyczących dopuszczenia do stosowania i sposobu użytkowania, przy udzielaniu świadczeń zdrowotnych, wyrobów medycznych oraz ambulansów sanitarnych, żądanie informacji i dokumentacji, w tym również dokumentacji medycznej, z zastrzeżeniem art. 18, ocenę realizacji zadań statutowych, w tym dostępności i poziomu udzielanych świadczeń zdrowotnych, ocenę prawidłowości gospodarowania mieniem w publicznym zakładzie opieki zdrowotnej, ocenę prawidłowości gospodarowania środkami publicznymi,
    - **a)**
    - **b)**
    - **c)**
    - **d)**
...
- **42)** w art. 69: ust. 1 otrzymuje brzmienie: „
    - **a)**

1. Do zakładów opieki zdrowotnej utworzonych przez Ministra Sprawiedliwości nie stosuje się przepisów działu II rozdziału 2, z wyjątkiem art. 40, i rozdziału 3 oraz działu III, z wyjątkiem art. 66 i 66a. ” , po ust. 1 dodaje się ust. 1a w brzmieniu: „

- **b)**

1a. Do zakładów opieki zdrowotnej utworzonych przez ministra właściwego do spraw wewnętrznych nie stosuje się przepisów działu II rozdziału 2, z wyjątkiem art. 36, 40 i 43h, i rozdziału 3 oraz działu III, z wyjątkiem art. 66 i 66a. ” , ust. 2 otrzymuje brzmienie: „
...
- **45)** w art. 70d: uchyla się ust. 1, ust. 2 i 3 otrzymują brzmienie: „
    - **a)**
    - **b)**
...
- **2)** zakład opieki zdrowotnej wymieniony w ust. 2 stosuje się odpowiednio przepisy art. 35 i 35a. ” , uchyla się ust. 4–6;
    - **c)**
...
4. Rekompensata, o której mowa w ust. 3, będzie polegać na przekazaniu Akademii Medycznej w Warszawie środków finansowych z budżetu państwa na sfinansowanie remontów i inwestycji w trybie określonym w art. 55 ustawy, o której mowa w art. 1, w brzmieniu nadanym niniejszą ustawą. Pracownicy Akademii Medycznej w Warszawie będący jednocześnie pracownikami zakładów, o których mowa w art. 6 ust. 1, z dniem wejścia w życie ustawy stają się, z mocy prawa, pracownikami Centrum Medycznego Kształcenia Podyplomowego, chyba że w terminie 14 dni od dnia wejścia w życie ustawy, złożą rektorowi Akademii Medycznej oświadczenie, że nadal pozostają pracownikami tej uczelni.
...
- **1)** art. 1: pkt 11, 13 i 33, które wchodzą w życie z dniem ogłoszenia, pkt 36 i 37, które wchodzą w życie z dniem 1 stycznia 2007 r., pkt 43–46, które wchodzą w życie z dniem 1 stycznia 2008 r.;
    - **a)**
    - **b)**
    - **c)**
