...
| Pole | Wartość |
|---|---|
| Adres publikacyjny | Dz.U. 2018 poz. 535 |
| ISAP | WDU20180000535 |
...
| Źródło | [ISAP](https://isap.sejm.gov.pl/isap.nsf/DocDetails.xsp?id=WDU20180000535) · [PDF](https://api.sejm.gov.pl/eli/acts/DU/2018/535/text.pdf) |
...
” ,
pkt 2:
– – wprowadzenie do wyliczenia otrzymuje brzmienie: „ sposobie wykorzystania działek rolnych zgłaszanych do płatności, z podaniem w szczególności: ” ,
– w lit. d:
...
2a.
W oświadczeniu, o którym mowa w ust. 2 pkt 1 lit. c tiret trzecie, podaje się powierzchnię:
1)
