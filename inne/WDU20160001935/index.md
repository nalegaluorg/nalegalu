...
- **10)** w art. 39b1wust. 3 pkt 1 otrzymuje brzmienie: „
...
- **12)** w art. 50 w pkt 2 w lit. g średnik zastępuje się przecinkiem i dodaje się lit. h w brzmieniu: „ dotyczących spełniania lub niespełniania wymogu dobrej reputacji, o których mowa w art. 7d ust. 1–6, w przypadkach, o których mowa w art. 7 ust. 2 pkt 2; ” ;
    - **h)**
...
- **17)** imię i nazwisko osoby zarządzającej transportem oraz: datę i miejsce urodzenia, adres zamieszkania, numer posiadanego certyfikatu kompetencji zawodowych, datę wydania certyfikatu kompetencji zawodowych, kraj wydania certyfikatu kompetencji zawodowych;
    - **a)**
    - **b)**
    - **c)**
    - **d)**
...
- **18)** imię i nazwisko osoby fizycznej, o której mowa w art. 7c, oraz: datę i miejsce urodzenia, adres zamieszkania, numer posiadanego certyfikatu kompetencji zawodowych, datę wydania certyfikatu kompetencji zawodowych, kraj wydania certyfikatu kompetencji zawodowych.
    - **a)**
    - **b)**
    - **c)**
    - **d)**
...
- **1)** firmę przedsiębiorcy oraz oznaczenie jego adresu i siedziby albo miejsca zamieszkania przedsiębiorcy;
- **2)** imię i nazwisko osoby zarządzającej transportem oraz: datę i miejsce urodzenia, adres zamieszkania, numer posiadanego certyfikatu kompetencji zawodowych, datę wydania certyfikatu kompetencji zawodowych, kraj wydania certyfikatu kompetencji zawodowych;
    - **a)**
    - **b)**
    - **c)**
    - **d)**
...
- **3)** imię i nazwisko osoby fizycznej, o której mowa w art. 7c, oraz: datę i miejsce urodzenia, adres zamieszkania, numer posiadanego certyfikatu kompetencji zawodowych, datę wydania certyfikatu kompetencji zawodowych, kraj wydania certyfikatu kompetencji zawodowych;
    - **a)**
    - **b)**
    - **c)**
    - **d)**
...
**Art. 3.** Wstosunku do przedsiębiorcy, zarządzającego transportem lub osoby fizycznej, o której mowa w art. 7c ustawy zmienianej w art. 1, którzy przed dniem wejścia w życie niniejszej ustawy:
...
**Art. 6.** Główny Inspektor Transportu Drogowego podejmie działania zmierzające do utworzenia Krajowego Rejestru Elektronicznego Przedsiębiorców Transportu Drogowego. 1. W latach 2016–2025 maksymalny limit wydatków budżetu państwa będący skutkiem finansowym ustawy wynosi 55,89 mln zł, z tego:
