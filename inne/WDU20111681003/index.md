...
- **3)** rozdział 6a otrzymuje brzmienie: „Rozdział 6a Usługi informacji rzecznej (RIS)
...
- **2)** podejmowaniu działań dotyczących aktualnej sytuacji żeglugowej w ruchu lokalnym (taktyczne informacje o
...
- **4)** art. 70 otrzymuje brzmienie: „Art. 70. 1. Płatnikami opłat są:
