...
- **1)** w art. 1 w pkt 1 w lit. d średnik zastępuje się przecinkiem i dodaje się lit. e w brzmieniu: „ Międzynarodowej konwencji o kontroli i postępowaniu ze statkowymi wodami balastowymi i osadami, 2004, sporządzonej w dniu 13 lutego 2004 r. w Londynie, zwanej dalej „Konwencją BWM”; ” ;
    - **e)**
...
4a. Za zatwierdzanie dokumentacji technicznej i planów oraz zatwierdzanie systemów obróbki wód balastowych pobiera się opłaty określone w załączniku nr 2 do ustawy. ” , ust. 5 i 6 otrzymują brzmienie: „
...
- **9)** w art. 10: ust. 6 otrzymuje brzmienie: „
    - **a)**

6. Organy Państwowej Inspekcji Sanitarnej mogą uzależnić przyjęcie odpadów ze statków od wyniku przeprowadzonej przez nie kontroli. ” , ust. 8 otrzymuje brzmienie: „
...
9. Opłata, o której mowa w ust. 8, stanowi dochód budżetu państwa. Do statków uprawiających żeglugę wyłącznie pomiędzy portami Morza Bałtyckiego nie ma zastosowania prawidło D-1 załącznika do Konwencji BWM.
...
- **1)** podstawowe dane o statku i armatorze: nazwę i numer identyfikacyjny statku, nazwę portu macierzystego statku, pojemność brutto GT, nazwę armatora, znak wywoławczy statku;
    - **a)**
    - **b)**
    - **c)**
    - **d)**
...
1a. Jeżeli przeprowadzona inspekcja wykaże, że wody balastowe statku stanowią zagrożenie dla środowiska, zdrowia ludzkiego, zasobów lub mienia, właściwy dyrektor urzędu morskiego zakazuje zrzutu wód balastowych do czasu usunięcia zagrożenia. ” , ust. 3 otrzymuje brzmienie: „
...
1. Do postępowania określonego w przepisach niniejszego rozdziału stosuje się odpowiednio przepisy ustawy z dnia 14 czerwca 1960 r. – Kodeks postępowania administracyjnego (Dz. U. z 2018 r. poz. 2096 oraz z 2019 r. poz. 60, 730 i 1133).
...
- **24)** w art. 36aa: po ust. 3 dodaje się ust. 3a w brzmieniu: „
    - **a)**

3a. Jeżeli armator statku niezgodnie z prawidłem 14 załącznika VI do Konwencji MARPOL przewozi do celów spalania paliwo olejowe przeznaczone do napędu lub obsługi statku niespełniające wymogów dotyczących zawartości siarki, podlega karze pieniężnej do wysokości 600 000 SDR. ” , dodaje się ust. 6 w brzmieniu: „
...
- **26)** w art. 37: po pkt 2 dodaje się pkt 2a w brzmieniu: „
    - **a)**

- **2a)** nie prowadzi zapisów balastowych w sposób zgodny z wymogami prawidła B-2 załącznika do Konwencji BWM, ” , pkt 3 otrzymuje brzmienie: „
    - **b)**

- **3)** nie zgłasza statku do przeglądu lub inspekcji, utrudnia bądź uniemożliwia przegląd lub inspekcję w zakresie przewidzianym w Konwencji MARPOL lub Konwencji BWM, ” , w pkt 18 na końcu dodaje się przecinek i dodaje się pkt 19–22 w brzmieniu: „
    - **c)**
...
**Art. 37b.** Armator albo kapitan statku, który nie przestrzega warunków określonych w decyzji w sprawie zwolnienia, o którym mowa w art. 20d ust. 1, podlega karze pieniężnej do wysokości 200 000 SDR. Podmiot zarządzający portem lub przystanią morską albo podmiot prowadzący działalność i użytkujący nabrzeże w granicach portu morskiego lub przystani morskiej, który nie wykonuje obowiązków sporządzania nowych lub aktualizacji istniejących planów, zgodnie z art. 23b, podlega karze pieniężnej do wysokości 50 000 SDR. ” ;
...
30. Za inspekcję wstępną przed oddaniem statku do eksploatacji i wydanie międzynarodowego świadectwa pod nazwą „Międzynarodowy Certyfikat Postępowania z Wodami Balastowymi” – 4000 PLN.
