...
- **1)** w art. 1:
    ...
    - **b)** ust. 2 otrzymuje brzmienie: „2. Przepisy ustawy o: 1) umowie spółki i jej zmianie – stosuje się odpowiednio do aktów założycielskich spółek, statutów spółek i ich zmiany; 2) czynnościach cywilnoprawnych – stosuje się odpowiednio do przedmiotów opodatkowania określonych w ust. 1 pkt 2 i 3.”,
...
- **2)** w art. 1a:
    - **a)** pkt 2 i 3 otrzymują brzmienie: „2) spółka kapitałowa – spółkę: z ograniczoną odpowiedzialnością, akcyjną lub europejską; 3) siedziba spółki – siedzibę spółki określoną w umowie spółki;”,
    - **b)** uchyla się pkt 6;
