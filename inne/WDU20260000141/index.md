---
title: Obwieszczenie Marszałka Sejmu Rzeczypospolitej Polskiej z dnia 21 stycznia 2026 r. w sprawie ogłoszenia jednolitego tekstu ustawy o Państwowym Ratownictwie Medycznym
address: WDU20260000141
eli: DU/2026/141
publisher: DU
year: 2026
pos: 141
...
| Pole | Wartość |
|---|---|
| Adres publikacyjny | Dz.U. 2026 poz. 141 |
| ISAP | WDU20260000141 |
...
**Art. 12.** Do prowadzenia szkoleń zakresie kwalifikowanej pierwszej pomocy, których 16 ust. ustawy zmienianej 1, wszczętych i niezakończonych przed dniem wejścia życie niniejszej stosuje się przepisy dotychczasowe.

**Art. 13.** Zaświadczenia ukończeniu szkolenia zakresie kwalifikowanej pierwszej pomocy i uzyskaniu tytułu ratownika oraz zaświadczenia zdaniu egzaminu potwierdzającego posiadanie tytułu ratownika wydane na podstawie przepisów wydanych na podstawie 16 ust. 2 ustawy zmienianej zachowują ważność okres, na jaki zostały wydane.

**Art. 14.** Do postępowań zakresie wpisu i wykreślenia z rejestru jednostek współpracujących z systemem Państwowe Ratownictwo Medyczne, wszczętych i niezakończonych przed dniem wejścia życie niniejszej ustawy wydaniem decyzji, 17 ust. 2 2 i ust. 5 ustawy zmienianej 1, stosuje się przepisy ustawy zmienianej 1, brzmieniu dotychczasowym, jednak nie później niż do dnia 31 grudnia 2025 r.
...
**Art. 18.** Upoważnienia konsultantów krajowych i konsultantów wojewódzkich, wydane na podstawie 24c ust. 2 ustawy zmienianej 1, brzmieniu dotychczasowym, wygasają z dniem wejścia życie niniejszej ustawy.

**Art. 19.** Nagrania rozmów zarejestrowanych Systemie Wspomagania Dowodzenia Państwowego Ratownictwa Medycznego, których 24f ust. ustawy zmienianej 1, nie wcześniej niż okresie 3 lat przed dniem wejścia życie niniejszej ustawy są przechowywane okres, którym 24f ust. ustawy zmienianej 1, brzmieniu nadanym niniejszą ustawą.

**Art. 20.** Do kontroli przeprowadzanych wojewodę na podstawie 31 ust. 2 i 3 ustawy zmienianej 1, wszczętych i niezakończonych przed dniem wejścia życie niniejszej stosuje się przepisy dotychczasowe.

**Art. 21.** Lekarz systemu i pielęgniarka systemu, którzy dniu wejścia życie niniejszej ustawy są zatrudnieni jednostkach systemu, których 32 ust. ustawy zmienianej 1, którzy spełniają wymagania odpowiednio dla lekarza systemu, którym 3 3 lit. c–f ustawy zmienianej 1, brzmieniu nadanym niniejszą ustawą, i dla pielęgniarki systemu, 3 6 lit. b–d ustawy zmienianej 1, brzmieniu nadanym niniejszą ustawą, są obowiązani ukończyć kursy zakresie postępowania z osobami stanie nagłego zagrożenia zdrowotnego, których 38a ust. i 2 ustawy zmienianej 1, zwane dalej „kursami stanów nagłych”, terminie do dnia 31 grudnia 2029 r. 2. Lekarz systemu i pielęgniarka systemu, których ust. 1, którzy ukończyli nie wcześniej niż 24 miesiące przed dniem wejścia życie niniejszej ustawy kurs, którego program odpowiada programowi kursu stanów nagłych, są obowiązani ukończyć kurs stanów nagłych terminie 48 miesięcy od dnia ukończenia kursu, którego program odpowiada programowi kursu stanów nagłych. 3. Dysponent jednostki rozumieniu 3 ustawy zmienianej 1, lekarz systemu i pielęgniarka systemu, których ust. 2, są zatrudnieni, weryfikuje, czy program kursu, którego program odpowiada programowi kursu stanów nagłych, ukończonego lekarza systemu i pielęgniarkę systemu, których ust. 2, odpowiada programowi kursu stanów nagłych.

**Art. 22.** Dyrektor Centrum Medycznego Kształcenia Podyplomowego podaje do publicznej wiadomości po raz pierwszy, sposób określony 38a ust. 8 ustawy zmienianej 1, programy kursów stanów nagłych zatwierdzone ministra właściwego do spraw zdrowia, terminie 6 miesięcy od dnia wejścia życie niniejszej ustawy.
...
**Art. 2.** Ustawa określa zasady organizacji, funkcjonowania i finansowania systemu oraz zasady zapewnienia edukacji zakresie udzielania pierwszej pomocy. 2. W ramach systemu działają:
...
**Art. 8.** Podstawa programowa, przepisach wydanych na podstawie 47 ust. ustawy z dnia 14 grudnia 2016 r. Prawo oświatowe (Dz. U. z 2025 r. poz. 1043, 1160 i 1837), uwzględnia edukację zakresie udzielania pierwszej pomocy. 2. Zajęcia edukacyjne zakresie udzielania pierwszej pomocy są realizowane z udziałem:

**Art. 9.** Ustanawia się dzień 13 października Dniem Ratownictwa Medycznego.

#### Rozdział 2 Ratownicy

**Art. 10.** Zawód ratownika medycznego wykonuje się na zasadach określonych ustawie z dnia grudnia 2022 r. zawodzie ratownika medycznego oraz samorządzie ratowników medycznych (Dz. U. z 2025 r. poz. 339 i 637).
...
**Art. 13.** Ratownikiem może być osoba:

**Art. 14.** Zakres czynności wykonywanych ratownika ramach kwalifikowanej pierwszej pomocy obejmuje:

**Art. 15.** Jednostkami współpracującymi z systemem są:

**Art. 16.** Minister właściwy do spraw wewnętrznych oraz Minister Obrony Narodowej zapewniają przeszkolenie pracowników podległych lub nadzorowanych nich służb, policjantów, funkcjonariuszy, strażaków oraz żołnierzy zakresie kwalifikowanej pierwszej pomocy, i uzyskanie nich tytułu ratownika oraz aktualizację wiedzy tym zakresie. 2. (uchylony)

**Art. 16a.**

- **17)** Szkolenie zakresie kwalifikowanej pierwszej pomocy na potrzeby szkolenia policjantów, funkcjonariuszy, strażaków i pracowników służb podległych ministrowi właściwemu do spraw wewnętrznych lub niego nadzorowanych, zwane dalej „szkoleniem KPP MSWiA”, lub egzamin z zakresu wiedzy i umiejętności objętych programem tego szkolenia przeprowadzają jednostka organizacyjna, jednostka szkoleniowa, ośrodek lub centrum szkolenia lub kształcenia służb podległych ministrowi właściwemu do spraw wewnętrznych lub niego nadzorowanych, lub inny podmiot wybrany te służby, zwane dalej „podmiotami szkolącymi”, które:
...
- **3)** zapewniają bazę dydaktyczną niezbędną do przeprowadzenia szkolenia KPP MSWiA lub przeprowadzenia egzaminu z zakresu wiedzy i umiejętności objętych programem tego szkolenia zgodnie z przepisami wydanymi na podstawie 13 ust. 8, tym do szkolenia praktycznego;
...
- **5)** prowadzą ewidencję wydanych zaświadczeń ukończeniu szkolenia KPP MSWiA i uzyskaniu tytułu ratownika lub zaświadczeń potwierdzających kwalifikacje ratownika.

2. Programy szkoleń KPP MSWiA opracowują koordynatorzy szkolenia, których ust. 5, na podstawie ramowego programu kursu określonego przepisach wydanych na podstawie 13 ust. 8, z uwzględnieniem specyfiki zadań realizowanych Policję, Państwową Straż Pożarną, Straż Graniczną albo Służbę Ochrony Państwa.
...
- **1)** dokonuje oceny jakości prowadzonych szkoleń KPP MSWiA i egzaminów, których 16b ust. 1;
- **2)** opiniuje kandydatów na koordynatorów szkolenia KPP służby i koordynatorów szkolenia jednostkach;
- **3)** zatwierdza przedkładane koordynatorów szkolenia KPP służby coroczne sprawozdania z realizacji szkoleń KPP MSWiA lub przeprowadzanych egzaminów z zakresu wiedzy i umiejętności objętych programem tych szkoleń;
...
- **5)** opracowuje i aktualizuje materiały i pomoce szkoleniowe oparciu wytyczne krajowych i międzynarodowych towarzystw naukowych działających obszarze ratownictwa medycznego i medycyny ratunkowej;
...
- **3)** analizuje oceny jakości szkoleń KPP MSWiA przeprowadzanych koordynatorów szkolenia jednostkach;
...
- **2)** posiadają co najmniej 3-letnie doświadczenie udzielaniu świadczeń zdrowotnych jednostkach systemu, których 32 ust. 1, lub 5-letnie doświadczenie wykonywaniu zawodu medycznego zakresie udzielania świadczeń zdrowotnych służbach podległych ministrowi właściwemu do spraw wewnętrznych lub niego nadzorowanych;
...
- **2)** spełnienia podmiot szkolący wymagań zakresie kadry i bazy dydaktycznej;
- **3)** optymalnego wykorzystania podmiot szkolący kadry i bazy dydaktycznej;
...
- **17)** Szkolenie KPP MSWiA kończy się egzaminem z zakresu wiedzy i umiejętności objętych programem tego szkolenia.

2. Egzamin, którym ust. 1, jest przeprowadzany komisję egzaminacyjną powoływaną kierownika podmiotu szkolącego, składającą się z 3 osób:

- **1)** przewodniczącego komisji egzaminacyjnej, którym jest koordynator szkolenia KPP służby albo wskazani niego:
    - **a)** koordynator szkolenia jednostce albo
    - **b)** osoba będąca lekarzem systemu, pielęgniarką systemu albo ratownikiem medycznym, która posiada co najmniej 5-letnie doświadczenie udzielaniu świadczeń zdrowotnych jednostkach systemu, których 32 ust. 1;

- **2)** konsultanta wojewódzkiego dziedzinie medycyny ratunkowej właściwego ze względu na siedzibę podmiotu szkolącego albo wskazanej niego osoby będącej lekarzem systemu, pielęgniarką systemu albo ratownikiem medycznym, która posiada co najmniej 5-letnie doświadczenie udzielaniu świadczeń zdrowotnych jednostkach systemu, których 32 ust. 1;
- **3)** przedstawiciela podmiotu szkolącego, którym jest lekarz, pielęgniarka, ratownik medyczny albo ratownik, wskazanego kierownika podmiotu szkolącego.

3. Do składu komisji egzaminacyjnej nie może zostać powołana osoba, która jest małżonkiem, krewnym albo powinowatym do drugiego stopnia włącznie osoby, która przystępuje do egzaminu, którym ust.

4. Egzamin, którym ust. 1, składa się z dwóch części: egzaminu teoretycznego i egzaminu praktycznego, przy czym każda część egzaminu jest oceniana oddzielnie.
...
7. Przewodniczący wyklucza z egzaminu teoretycznego osobę, która postąpiła wbrew zakazowi, którym ust. 6. Informację wykluczeniu osoby z egzaminu zamieszcza się protokole egzaminu.

8. Pozytywny wynik egzaminu teoretycznego stanowi warunek konieczny dopuszczenia do egzaminu praktycznego.

9. W przypadku gdy osoba, ust. 5, nie zda całości egzaminu lub jego części albo nie przystąpi do części egzaminu, może przystąpić do egzaminu lub jego części następnym terminie, niewięcej jednak niż 2 razy okresie 12 miesięcy od dnia egzaminu. Po upływie tego okresu osoba ta jest obowiązana powtórzyć szkolenie KPP MSWiA całości.

10. W przypadku dwukrotnego niezdania egzaminu, którym ust. 1, osobę, ust. 5 2, zaświadczenie, którym 16c ust. 1, traci ważność. Okoliczność dwukrotnego niezdania egzaminu jest odnotowywana protokole egzaminu, a fakt utraty ważności zaświadczenia jest odnotowywany ewidencji wydanych zaświadczeń. O utracie ważności zaświadczenia kierownik podmiotu szkolącego zawiadamia niezwłocznie komendanta jednostki kierującej na szkolenie KPP MSWiA, ta osoba pełni służbę, lub pracodawcę, u którego ta osoba jest zatrudniona. Utrata ważności zaświadczenia następuje z dniem niezdania egzaminu.

11. W przypadku stwierdzenia, ramach oceny jakości, 16a ust. 7 1, nieprawidłowości prowadzeniu szkoleń KPP MSWiA lub przeprowadzaniu egzaminów z zakresu wiedzy i umiejętności objętych programem tych szkoleń, prowadzonych podmioty szkolące, ustalonych na podstawie kryteriów, których 16a ust. 12, koordynator szkolenia KPP MSWiA może wstrzymać ich prowadzenie lub przerwać egzaminy i przekazać do: Komendanta Głównego Policji, Komendanta Głównego Państwowej Straży Pożarnej, Komendanta Głównego Straży Granicznej albo Komendanta Służby Ochrony Państwa informacje wstrzymaniu prowadzonego szkolenia lub przerwaniu egzaminu wraz z zaleceniami dotyczącymi usunięcia stwierdzonych nieprawidłowości.
...
- **17)** Ukończenie szkolenia KPP MSWiA i zdanie egzaminu, którym 16b ust. 1, jest potwierdzane wydawanym kierownika podmiotu szkolącego zaświadczeniem ukończeniu szkolenia KPP MSWiA i uzyskaniu tytułu ratownika. Zdanie egzaminu z zakresu wiedzy i umiejętności objętych programem szkolenia KPP MSWiA jest potwierdzane wydawanym kierownika podmiotu szkolącego zaświadczeniem potwierdzającym kwalifikacje ratownika. Zaświadczenia są wydawane terminie miesiąca od dnia zdania egzaminu i są ważne okres 3 lat od dnia ich wydania.

2. Zaświadczenia, których ust. 1, zawierają następujące dane:
...
- **17)** Ratownik pełniący służbę albo wykonujący zadania zawodowe służbach podległych ministrowi właściwemu do spraw wewnętrznych lub niego nadzorowanych ma obowiązek aktualizacji wiedzy i umiejętności ratownika zakresie kwalifikowanej pierwszej pomocy.
...
- **3)** wzór zaświadczenia ukończeniu szkolenia KPP MSWiA i uzyskaniu tytułu ratownika oraz wzór zaświadczenia potwierdzającego kwalifikacje ratownika mając na celu zapewnienie przejrzystości dokumentowania potwierdzenia uzyskania tych kwalifikacji;
...
- **17)** Szkolenie żołnierzy i pracowników resortu obrony narodowej zakresie kwalifikowanej pierwszej pomocy, zwane dalej „szkoleniem KPP MON”, lub egzamin z zakresu wiedzy i umiejętności objętych programem tego szkolenia przeprowadzają jednostki organizacyjne podległe Ministrowi Obrony Narodowej lub niego nadzorowane, które:
- **1)** realizują program szkolenia KPP MON opracowany na podstawie ramowego programu kursu określonego przepisach wydanych na podstawie 13 ust. 8;
...
- **3)** zapewniają bazę dydaktyczną niezbędną do prowadzenia szkolenia KPP MON, zgodnie z przepisami wydanymi na podstawie 13 ust. 8, tym do prowadzenia zajęć praktycznych, lub przeprowadzania egzaminu z zakresu wiedzy i umiejętności objętych programem tego szkolenia;
...
- **1)** posiadają tytuł zawodowy magistra lub równorzędny albo tytuł zawodowy licencjata lub równorzędny;
- **2)** posiadają co najmniej 3-letnie doświadczenie udzielaniu świadczeń zdrowotnych jednostkach systemu, których 32 ust. 1, lub 5-letnie doświadczenie wykonywaniu zawodu medycznego jednostkach podległych Ministrowi Obrony Narodowej lub niego nadzorowanych;
- **3)** posiadają aktualną wiedzę i umiejętności z zakresu objętego programem szkolenia KPP MON;
- **4)** realizują obowiązek doskonalenia zawodowego, aktualizacji wiedzy albo ustawicznego rozwoju zawodowego.

7. Koordynator szkolenia KPP MON:

- **1)** dokonuje nierzadziej niż raz na kwartał oceny jakości prowadzonych szkoleń KPP MON i przeprowadzanych egzaminów z zakresu wiedzy i umiejętności objętych programem tych szkoleń jednostkach organizacyjnych, których ust. 1;
- **2)** dokonuje analizy spełniania wymagań, których ust. 1, i rekomenduje Ministrowi Obrony Narodowej prowadzenie szkoleń KPP MON i przeprowadzanie egzaminów z zakresu wiedzy i umiejętności objętych programem tych szkoleń jednostki spełniające te wymagania;
- **3)** zatwierdza programy szkoleń KPP MON opracowane jednostki organizacyjne, których ust. 1;
- **4)** analizuje i zatwierdza coroczne sprawozdania z realizacji szkoleń KPP MON oraz przeprowadzonych egzaminów z zakresu wiedzy i umiejętności objętych programem tych szkoleń sporządzane jednostki organizacyjne, których ust. 1;
- **5)** współpracuje z kierownikiem komórki organizacyjnej Ministerstwa Obrony Narodowej właściwej do spraw zdrowia zakresie opracowywania i opiniowania projektów aktów prawnych, instrukcji, wytycznych i innych dokumentów związanych z organizacją i prowadzeniem szkoleń KPP MON oraz przeprowadzaniem egzaminów z zakresu wiedzy i umiejętności objętych programem tych szkoleń jednostkach organizacyjnych, których ust. 1;
...
- **2)** spełniania jednostki organizacyjne, których ust. 1, wymagań zakresie kadry i bazy dydaktycznej;
- **3)** optymalnego wykorzystania jednostki organizacyjne, których ust. 1, kadry i bazy dydaktycznej;
- **4)** dostępności jednostkach organizacyjnych, których ust. 1, aktualnych materiałów i pomocy szkoleniowych;
- **5)** prawidłowości przeprowadzania egzaminów z zakresu wiedzy i umiejętności objętych programem szkolenia KPP MON.

**Art. 16g.**

- **17)** Szkolenie KPP MON kończy się egzaminem z zakresu wiedzy i umiejętności objętych programem tego szkolenia.

2. Egzamin, którym ust. 1, jest przeprowadzany komisję egzaminacyjną powoływaną kierownika jednostki organizacyjnej, 16f ust. 1, składającą się z 3 osób:

- **1)** przewodniczącego komisji egzaminacyjnej, którym jest kierownik jednostki organizacyjnej, 16f ust. 1, albo wskazani niego lekarz, pielęgniarka albo ratownik medyczny;
- **2)** dwóch członków komisji egzaminacyjnej, którymi są:
    - **a)** konsultant wojewódzki dziedzinie medycyny ratunkowej właściwy ze względu na siedzibę jednostki organizacyjnej, 16f ust. 1, albo wskazana niego osoba będąca lekarzem systemu, pielęgniarką systemu albo ratownikiem medycznym, która posiada co najmniej 5-letnie doświadczenie udzielaniu świadczeń zdrowotnych jednostkach systemu, których 32 ust. 1, albo konsultant wojskowej służby zdrowia dziedzinie medycyny ratunkowej albo wskazana niego osoba będąca lekarzem systemu, pielęgniarką systemu albo ratownikiem medycznym, która posiada co najmniej 5-letnie doświadczenie udzielaniu świadczeń zdrowotnych jednostkach systemu, których 32 ust. 1,
    - **b)** przedstawiciel jednostki organizacyjnej, 16f ust. 1, którym jest lekarz, pielęgniarka, ratownik medyczny albo ratownik, wskazany kierownika jednostki organizacyjnej, 16f ust.

3. Do składu komisji egzaminacyjnej nie może zostać powołana osoba, która jest małżonkiem, krewnym albo powinowatym do drugiego stopnia włącznie osoby, która przystępuje do egzaminu, którym ust.

4. Egzamin, którym ust. 1, składa się z dwóch części: egzaminu teoretycznego i egzaminu praktycznego, przy czym każda część egzaminu jest oceniana oddzielnie.

5. Do egzaminu, którym ust. 1, może przystąpić osoba, która:

- **1)** odbyła szkolenie KPP MON i uzyskała pozytywny wynik ze wszystkich zajęć teoretycznych i praktycznych przypadku osoby, która nie posiada ważnego zaświadczenia ukończeniu szkolenia KPP MON i uzyskaniu tytułu ratownika albo ważnego zaświadczenia potwierdzającego kwalifikacje ratownika, albo
- **2)** posiada ważne zaświadczenie ukończeniu szkolenia KPP MON i uzyskaniu tytułu ratownika albo ważne zaświadczenie potwierdzające kwalifikacje ratownika przypadku osoby, która potwierdza te kwalifikacje.
...
12. Do czasu usunięcia stwierdzonych nieprawidłowości jednostka organizacyjna, 16f ust. 1, nie może prowadzić szkolenia KPP MON lub przeprowadzać egzaminu z zakresu wiedzy i umiejętności objętych programem tego szkolenia. Koordynator szkolenia KPP MON nie wstrzymuje prowadzenia szkolenia KPP MON lub egzaminu z zakresu wiedzy i umiejętności objętych programem tego szkolenia przypadku możliwości usunięcia stwierdzonych nieprawidłowości bez szkody dla jakości szkolenia KPP MON.

13. Zgody na wznowienie prowadzenia szkolenia KPP MON lub przeprowadzania egzaminu z zakresu wiedzy i umiejętności objętych programem tego szkolenia jednostce organizacyjnej, 16f ust. 1, po ponownej ocenie, udziela koordynator szkolenia KPP MON.

14. O wstrzymaniu prowadzenia szkolenia KPP MON lub egzaminu z zakresu wiedzy i umiejętności objętych programem tego szkolenia lub podjęciu decyzji, ust. 13, koordynator szkolenia KPP MON informuje Ministra Obrony Narodowej.

15. Osoby uczestniczące szkoleniu KPP MON lub egzaminie z zakresu wiedzy i umiejętności objętych programem tego szkolenia, prowadzonych jednostkach organizacyjnych, których 16f ust. 1, stosunku do których wstrzymano prowadzenie tego szkolenia lub egzaminu, odbywają to szkolenie lub zdają ten egzamin ponownie, niezależnie od etapu, na którym to szkolenie lub egzamin zostały wstrzymane.

**Art. 16h.**

- **17)** Ukończenie szkolenia KPP MON i zdanie egzaminu, którym 16g ust. 1, jest potwierdzane wydawanym kierownika jednostki organizacyjnej, 16f ust. 1, zaświadczeniem ukończeniu szkolenia KPP MON i uzyskaniu tytułu ratownika. Zdanie egzaminu z zakresu wiedzy i umiejętności objętych programem szkolenia KPP MON jest potwierdzane wydawanym kierownika jednostki organizacyjnej, 16f ust. 1, zaświadczeniem potwierdzającym kwalifikacje ratownika. Zaświadczenia są wydawane terminie miesiąca od dnia zdania egzaminu i są ważne okres 3 lat od dnia ich wydania.

2. Zaświadczenia, których ust. 1, zawierają następujące dane:

- **1)** oznaczenie jednostki organizacyjnej podległej Ministrowi Obrony Narodowej lub niego nadzorowanej prowadzącej szkolenie KPP MON lub przeprowadzającej egzamin z zakresu wiedzy i umiejętności objętych programem tego szkolenia;
- **2)** datę i miejsce wydania zaświadczenia;
- **3)** numer zaświadczenia;
...
- **17)** Ratownik pełniący służbę albo wykonujący zadania zawodowe jednostce organizacyjnej podległej Ministrowi Obrony Narodowej lub niego nadzorowanej ma obowiązek aktualizacji wiedzy i umiejętności ratownika zakresie kwalifikowanej pierwszej pomocy.

**Art. 16j.**

- **17)** Minister Obrony Narodowej porozumieniu z ministrem właściwym do spraw zdrowia określi, drodze rozporządzenia:
...
- **3)** wzór zaświadczenia ukończeniu szkolenia KPP MON i uzyskaniu tytułu ratownika oraz wzór zaświadczenia potwierdzającego kwalifikacje ratownika mając na celu zapewnienie przejrzystości dokumentowania potwierdzenia uzyskania tych kwalifikacji;
- **4)** formy i sposoby aktualizacji wiedzy i umiejętności ratownika zakresie kwalifikowanej pierwszej pomocy mając na celu właściwą realizację zadań ratownika na zajmowanym stanowisku służbowym lub jego zadań zawodowych.

**Art. 17.**

- **18)** Wojewoda prowadzi rejestr jednostek współpracujących z systemem, zwany dalej „rejestrem”. Rejestr jest prowadzony systemie teleinformatycznym.

1a. Wpisu do rejestru prowadzonego wojewodę właściwego ze względu na miejsce stacjonowania jednostek, których 15 ust. 1:

- **1)** i 2, dokonuje właściwy komendant wojewódzki Państwowej Straży Pożarnej albo osoba niego upoważniona;
- **2)** 8, dokonuje dyrektor Morskiej Służby Poszukiwania i Ratownictwa albo osoba niego upoważniona.

1b. Jednostki, których 15 ust. 3–7 i 9, są wpisywane na ich wniosek do rejestru wojewodę właściwego ze względu na miejsce stacjonowania tych jednostek.

2. W przypadku jednostek, których 15 ust. 1, 2 i 8, dane, których ust. 3, są wprowadzane do rejestru postaci elektronicznej i zatwierdzane za pomocą kwalifikowanego podpisu elektronicznego albo podpisu zaufanego.

2a. W przypadku jednostek, których 15 ust. 3–7 i 9, osoba upoważniona do reprezentowania danej jednostki składa wniosek wpis do rejestru do wojewody właściwego ze względu na miejsce jej stacjonowania systemie teleinformatycznym, którym ust. 1, i zatwierdza go za pomocą kwalifikowanego podpisu elektronicznego albo podpisu zaufanego. Wniosek zawiera dane, których ust. 3.
...
4. Jednostka współpracująca z systemem jest obowiązana niezwłocznie, jednak niepóźniej niż terminie 7 dni od dnia zaistnienia zmiany, informować wojewodę wszelkich zmianach dotyczących danych, których ust. 3.

5. W przypadku jednostek, których 15 ust. 3–7 i 9, lub ich jednostek organizacyjnych wojewoda, drodze decyzji administracyjnej:

- **1)** wpisuje jednostkę do rejestru, jeżeli jednostka spełnia wymagania, których 15 ust. 1a;
- **2)** odmawia jednostce wpisu do rejestru, jeżeli jednostka nie spełnia wymagań, których 15 ust. 1a;
- **3)** wykreśla z rejestru jednostkę, jeżeli:
    - **a)** nie spełnia wymagań, których 15 ust. 1a,
    - **b)** nie wykona terminie obowiązku, którym ust. 4.

5a. Decyzja, ust. 5 1, podlega natychmiastowemu wykonaniu.

6. Dane, których ust. 3, wojewoda udostępnia dyspozytorom medycznym, wojewódzkiemu koordynatorowi ratownictwa medycznego oraz krajowemu koordynatorowi ratownictwa medycznego.

6a. Wojewoda zawiadamia ministra właściwego do spraw wewnętrznych wydaniu decyzji, których ust. 5, stosunku do jednostek, których 15 ust. 5 i 6.
...
**Art. 18.** Organami administracji rządowej właściwymi zakresie wykonywania zadań systemu są:

**Art. 19.** Nadzór nad systemem na terenie kraju sprawuje minister właściwy do spraw zdrowia. 2. Planowanie, organizowanie, koordynowanie systemu oraz nadzór nad systemem na terenie województwa jest zadaniem wojewody. 3. Minister właściwy do spraw zdrowia do realizacji zadania, którym ust. 1, oraz wojewoda do realizacji zadań, których ust. 2, wykorzystują System Wspomagania Dowodzenia Państwowego Ratownictwa Medycznego, zwany dalej „SWD PRM”.

**Art. 20.** W ramach nadzoru, którym 19 ust. 1, minister właściwy do spraw zdrowia:
...
- **40)** Zatwierdzony plan jest podstawą do zawierania dyrektorów oddziałów wojewódzkich Narodowego Funduszu Zdrowia umów na wykonywanie medycznych czynności ratunkowych i umów na świadczenia opieki zdrowotnej udzielane szpitalne oddziały ratunkowe.

2. Dysponenci zespołów ratownictwa medycznego mogą wspólnie ubiegać się zawarcie umowy na wykonywanie medycznych czynności ratunkowych, ust.

**Art. 22a.**

- **42)** Dyrektor oddziału wojewódzkiego Narodowego Funduszu Zdrowia niepóźniej niż na 7 dni przed dniem zawarcia umowy na zadania zespołów ratownictwa medycznego lub przed dniem zmiany tej umowy przekazuje wojewodzie aktualizację danych dotyczących zespołów ratownictwa medycznego włączonych do systemu, których przepisach wydanych na podstawie 21 ust. 17.

2. Dyrektor oddziału wojewódzkiego Narodowego Funduszu Zdrowia informuje wojewodę stwierdzonych nieprawidłowościach związanych z realizacją umowy udzielanie świadczeń opieki zdrowotnej podmioty lecznicze, których skład wchodzą jednostki systemu, których 32 ust.

3. Dyrektor oddziału wojewódzkiego Narodowego Funduszu Zdrowia informuje wojewodę rozwiązaniu umowy, ust. 2, terminie 7 dni od dnia jej rozwiązania. Wojewoda następnie dokonuje aktualizacji planu.

**Art. 23.** (uchylony)

**Art. 23a.** Wojewoda prowadzi ewidencję szpitalnych oddziałów ratunkowych, centrów urazowych, centrów urazowych dla dzieci i jednostek organizacyjnych szpitali wyspecjalizowanych zakresie udzielania świadczeń zdrowotnych niezbędnych dla ratownictwa medycznego na terenie województwa. Ewidencja jest prowadzona systemie teleinformatycznym. 2. Ewidencja, ust. 1, zawiera następujące dane:

**Art. 23b.** Wojewoda przekazuje do systemu informacji ochronie zdrowia, którym ustawie z dnia 28 kwietnia 2011 r. systemie informacji ochronie zdrowia (Dz. U. z 2025 r. poz. 302, 779, 1537 i 1705) dane, których 17 i 23a.

**Art. 24.** Wojewoda podejmuje działania organizacyjne zmierzające do zapewnienia następujących parametrów czasu dotarcia na miejsce zdarzenia dla zespołu ratownictwa medycznego od chwili przyjęcia zgłoszenia dyspozytora medycznego:

**Art. 24a.** Minister właściwy do spraw zdrowia:

**Art. 24b.** Dysponent lotniczych zespołów ratownictwa medycznego będący jednostką nadzorowaną ministra właściwego do spraw zdrowia administruje SWD PRM, który umożliwia bezpieczne przetwarzanie danych, tym kontrolę dostępu użytkowników do danych, oraz dokumentuje dokonywane nich zmiany, umożliwiając szczególności odtworzenie historii każdego zgłoszenia alarmowego i powiadomienia zdarzeniu. 2. Minister właściwy do spraw zdrowia, wojewodowie, dysponent lotniczych zespołów ratownictwa medycznego będący jednostką nadzorowaną ministra właściwego do spraw zdrowia i dysponenci zespołów ratownictwa medycznego przetwarzają dane zarejestrowane SWD PRM, tym nagrania rozmów, dane osobowe osoby zgłaszającej, dane innych osób wskazanych trakcie przyjmowania zgłoszenia, pozycje geograficzne, dane teleadresowe lub opis zdarzenia, i udostępniają je na wniosek sądu, prokuratury, Policji, Rzecznika Praw Pacjenta lub Narodowego Funduszu Zdrowia. 3. Mechanizmy, które jest wyposażony SWD PRM, zapewniają zachowanie ciągłości jego funkcjonowania. 4. SWD PRM zawiera rozwiązania techniczne przeznaczone do szkolenia dyspozytorów medycznych.

**Art. 24c.** Minister właściwy do spraw zdrowia, wojewodowie, dysponent lotniczych zespołów ratownictwa medycznego będący jednostką nadzorowaną ministra właściwego do spraw zdrowia i dysponenci zespołów ratownictwa medycznego są współadministratorami danych SWD PRM oraz innych danych uzyskanych związku z przyjmowaniem oraz obsługą zgłoszeń alarmowych i powiadomień zdarzeniach z wykorzystaniem SWD PRM. 2. Minister właściwy do spraw zdrowia:

**Art. 24d.** SWD PRM uzyskuje za pośrednictwem centralnego punktu systemu powiadamiania ratunkowego, którym 337 ust. 4 ustawy z dnia 12 lipca 2024 r. Prawo komunikacji elektronicznej (Dz. U. poz. 1221 oraz z 2025 r. poz. 637 i 820), informacje dotyczące lokalizacji zakończenia sieci, z którego zostało wykonane połączenie do numeru alarmowego 112 albo innego numeru alarmowego, oraz dane dotyczące abonenta, których 337 ust. 2 ustawy z dnia 12 lipca 2024 r. Prawo komunikacji elektronicznej. 2. SWD PRM uzyskuje nieodpłatnie dostęp do danych przestrzennych i związanych z nimi usług, udostępnianych za pośrednictwem systemu, którym 40 ust. 3e ustawy z dnia 17 maja 1989 r. Prawo geodezyjne i kartograficzne (Dz. U. z 2024 r. poz. 1151 i 1824 oraz z 2025 r. poz. 1019, 1542 i 1792).

**Art. 24e.** Dyspozytorzy medyczni, wojewódzcy koordynatorzy ratownictwa medycznego, zespoły ratownictwa medycznego oraz krajowy koordynator ratownictwa medycznego wykonują zadania z wykorzystaniem SWD PRM. 2. Minister właściwy do spraw zdrowia, wojewodowie, dysponent lotniczych zespołów ratownictwa medycznego będący jednostką nadzorowaną ministra właściwego do spraw zdrowia oraz dysponenci zespołów ratownictwa medycznego przy użyciu SWD PRM przetwarzają i udostępniają dane:

**Art. 24f.**

- **69)** W ramach Podsystemu Zintegrowanej Łączności Systemu Wspomagania Dowodzenia Państwowego Ratownictwa Medycznego zapewnia się rejestrowanie nagrań rozmów oraz korespondencji radiowej prowadzonych na stanowisku dyspozytora medycznego, wojewódzkiego koordynatora ratownictwa medycznego oraz krajowego koordynatora ratownictwa medycznego, z wykorzystaniem dostępnych form łączności, i ich przechowywanie okres 20 lat, licząc od dnia dokonania nagrania.

1a. Nagrania, których ust. 1, mogą zostać udostępnione przez:

- **1)** właściwego dysponenta zespołów ratownictwa medycznego, zakresie rozmów i korespondencji radiowej prowadzonych zespoły ratownictwa medycznego z dyspozytorem medycznym oraz wojewódzkim koordynatorem ratownictwa medycznego,
- **2)** właściwego wojewodę, zakresie rozmów i korespondencji radiowej prowadzonych dyspozytorów medycznych oraz wojewódzkiego koordynatora ratownictwa medycznego,
- **3)** dysponenta lotniczych zespołów ratownictwa medycznego będącego jednostką nadzorowaną ministra właściwego do spraw zdrowia, zakresie rozmów i korespondencji radiowej:
    - **a)** których i 2,
    - **b)** prowadzonych krajowego koordynatora ratownictwa medycznego podmiotom, których 24b ust. 2.

2. Do nagrań, których ust. i 4, stosuje się przepisy 24 oraz 26 ust. 1, 2 i 3 2, 2a i 3 ustawy z dnia 6 listopada 2008 r. prawach pacjenta i Rzeczniku Praw Pacjenta.

3. Administrator SWD PRM niszczy nagrania, których ust. 1, po upływie terminu, którym ust.

4. W przypadku awarii Podsystemu Zintegrowanej Łączności Systemu Wspomagania Dowodzenia Państwowego Ratownictwa Medycznego wojewoda zapewnia rejestrowanie nagrań rozmów i korespondencji radiowej prowadzonych na stanowisku dyspozytora medycznego oraz wojewódzkiego koordynatora ratownictwa medycznego i przechowywanie tych nagrań okres 20 lat, licząc od dnia dokonania nagrania.

5. Wojewoda niszczy nagrania, których ust. 4, po upływie terminu, którym tym przepisie.

**Art. 24g.** Minister właściwy do spraw zdrowia określi, drodze rozporządzenia:

**Art. 24h.** Minister właściwy do spraw zdrowia określi, drodze rozporządzenia, rodzaje dokumentacji dyspozytorni medycznej prowadzonej SWD PRM, mając na uwadze potrzebę zapewnienia sprawnej realizacji zadań dyspozytorów medycznych oraz współpracy SWD PRM z systemem teleinformatycznym rozumieniu 2 4 ustawy z dnia 22 listopada 2013 r. systemie powiadamiania ratunkowego.

**Art. 25.** (uchylony)

**Art. 25a.** Wojewoda tworzy i prowadzi jedną dyspozytornię medyczną województwie. 2. W województwach liczących powyżej:

**Art. 25b.** Osobą odpowiedzialną za funkcjonowanie dyspozytorni medycznej, zatrudnioną na podstawie stosunku pracy, jest kierownik dyspozytorni medycznej, zwany dalej „kierownikiem dyspozytorni”. 2. Kierownikiem dyspozytorni może być osoba, która:
...
- **1)** dyspozytorem medycznym, którym 26 ust. 1:
    - **a)** 1, jest dysponent lotniczych zespołów ratownictwa medycznego będący jednostką nadzorowaną ministra właściwego do spraw zdrowia,
    - **b)** 2, jest urząd wojewódzki;

- **2)** psychologiem, którym 26a ust. 1, jest urząd wojewódzki.
...
- **85)** Dysponent zespołów ratownictwa medycznego zapewnia członkom zespołów ratownictwa medycznego dostęp do wsparcia psychologicznego udzielanego psychologa spełniającego wymagania, których 26a ust. 2.
...
- **2)** zwiększenie efektywności realizacji zadań członków zespołów ratownictwa medycznego.
...
4. Zadania, których ust. 3, są podejmowane psychologa sytuacjach:

- **1)** zgłoszenia członka zespołu ratownictwa medycznego problemów psychicznych mogących wpływać na poziom jego funkcjonowania psychicznego;
- **2)** zaobserwowanych albo zgłoszonych dysponenta zespołów ratownictwa medycznego trudności członków tych zespołów pracy zespołowej lub indywidualnej;
- **3)** stwierdzenia u członka zespołu ratownictwa medycznego symptomów świadczących trudnościach psychicznych.

5. Zadania, których ust. 3, są realizowane wyłącznie za zgodą członka zespołu ratownictwa medycznego, z zachowaniem zasad etyki zawodowej psychologa.

6. Psycholog udzielający wsparcia psychicznego członkom zespołów ratownictwa medycznego opracowuje i przekazuje dysponentowi zespołów ratownictwa medycznego, do dnia 31 marca, raport roczny za rok poprzedni z realizacji zadań, których ust. 3, obejmujący wskazanie liczby i rodzaju zrealizowanych zadań oraz liczby osób, wobec których te zadania zostały zrealizowane.

**Art. 27.** Do zadań dyspozytorów medycznych należy szczególności:

**Art. 27a.** Dysponent lotniczych zespołów ratownictwa medycznego będący jednostką nadzorowaną ministra właściwego do spraw zdrowia tworzy komórkę organizacyjną pod nazwą „Krajowe Centrum Monitorowania Ratownictwa Medycznego”, zwaną dalej „KCMRM”. 2. Do zadań KCMRM należy:

**Art. 27b.** Kursy, których 27a ust. 2 7, odbywają się na podstawie programu, który zawiera:

**Art. 28.** (uchylony)

**Art. 29.** W urzędzie wojewódzkim działają wojewódzcy koordynatorzy ratownictwa medycznego, zatrudnieni wojewodę na podstawie stosunku pracy, liczbie niezbędnej do zapewnienia całodobowej realizacji zadań, których ust. 5. 2. Pracodawcą dla wojewódzkich koordynatorów ratownictwa medycznego jest urząd wojewódzki. 3. (uchylony) 4. Działalność wojewódzkiego koordynatora ratownictwa medycznego jest finansowana z budżetu państwa, z części, dysponentem jest wojewoda. 5. Do zadań wojewódzkiego koordynatora ratownictwa medycznego należy:
...
**Art. 36.** Zespoły ratownictwa medycznego dzielą się na:
...
- **103)** Lekarze, których 3 3 lit. c–f, są obowiązani do ukończenia kursu zakresie postępowania z osobami stanie nagłego zagrożenia zdrowotnego nierzadziej niż raz na 48 miesięcy.

2. Pielęgniarki, których 3 6 lit. b–d, są obowiązane do ukończenia kursu zakresie postępowania z osobami stanie nagłego zagrożenia zdrowotnego nierzadziej niż raz na 48 miesięcy.

3. Kursy, których ust. i 2, zwane dalej „kursami stanów nagłych”, prowadzą:
...
5. Programy kursów stanów nagłych są opracowywane zespoły ekspertów na podstawie zakresu problematyki kursów stanów nagłych.
...
7. Programy kursów stanów nagłych opracowane zespoły ekspertów dyrektor CMKP redaguje i przedstawia do zatwierdzenia ministrowi właściwemu do spraw zdrowia.

8. Dyrektor CMKP podaje do publicznej wiadomości zatwierdzone programy kursów stanów nagłych ich publikację na stronie internetowej CMKP.
...
- **7)** informację zakończeniu kursu stanów nagłych egzaminem;
...
- **1)** zakres problematyki kursów stanów nagłych, uwzględniając zakres wiedzy i umiejętności niezbędnych do wykonywania określonych świadczeń opieki zdrowotnej lekarza systemu lub pielęgniarkę systemu;
...
13. Dysponent jednostki jest obowiązany do zweryfikowania na podstawie zaświadczenia ukończeniu kursu stanów nagłych, czy obowiązek, którym ust. i 2, został zrealizowany.

14. Koszty kursów stanów nagłych ponosi dysponent jednostki, u którego lekarz, którym ust. 1, lub pielęgniarka, ust. 2, wykonuje zawód, lub podmiot prowadzący kurs. Koszty tych kursów mogą być również pokrywane ramach dofinansowania pochodzącego ze środków europejskich rozumieniu 2 5 ustawy z dnia 27 sierpnia 2009 r. finansach publicznych (Dz. U. z 2025 r. poz. 1483, 1844 i 1846).

**Art. 38b.**

- **103)** Dysponent zespołów ratownictwa medycznego jest obowiązany przeprowadzić przeszkolenie wszystkich członków zespołu ratownictwa medycznego zakresie samoobrony oraz technik deeskalacyjnych nierzadziej niż raz na 5 lat.

2. Przeszkolenie, którym ust. 1, obejmuje co najmniej:
...
3. Przeszkolenie, którym ust. 1:

- **1)** obejmuje zajęcia teoretyczne i praktyczne, z uwzględnieniem co najmniej elementów, których ust. 2;
- **2)** trwa niekrócej niż 8 godzin dydaktycznych, przy czym godzina dydaktyczna trwa 45 minut.

4. Przeszkolenie, którym ust. 1, jest finansowane wojewodę właściwego ze względu na siedzibę dysponenta zespołów ratownictwa medycznego.

5. Przeszkolenie, którym ust. 1, może być również finansowane albo dofinansowywane:

- **1)** dysponenta zespołów ratownictwa medycznego;
...
**Art. 39c.** Centrum urazowe przyjmuje, kompleksowo diagnozuje i wielospecjalistycznie leczy pacjenta urazowego, zgodnie z aktualną wiedzą medyczną zakresie leczenia ciężkich, mnogich lub wielonarządowych obrażeń ciała. 2. Centrum urazowe, po zakończeniu udzielania świadczeń zdrowotnych, których ust. 1, kieruje pacjenta urazowego do innego oddziału szpitala, którym znajduje się centrum urazowe lub do zakładu leczniczego innego podmiotu leczniczego celu kontynuowania leczenia lub rehabilitacji. 3. Zespół urazowy zaleca wskazania co do dalszego leczenia lub rehabilitacji pacjenta urazowego oddziale szpitala lub zakładzie leczniczym podmiotu leczniczego, których ust. 2, właściwych ze względu na jego stan zdrowia.

**Art. 39d.** Minister właściwy do spraw zdrowia określi, drodze rozporządzenia:
...
- **106)** Minister właściwy do spraw zdrowia określi, drodze rozporządzenia, maksymalny czas na przyjęcie pacjenta od zespołu ratownictwa medycznego szpitalach, których 44 ust. i 45.

**Art. 45b.**

- **107)** Odmowa przyjęcia szpital osoby stanie nagłego zagrożenia zdrowotnego, pacjenta urazowego lub pacjenta urazowego dziecięcego od jednostek systemu albo niewykonanie decyzji, których 20a ust. 4 lub 29 ust. 9a, skutkuje zastosowaniem kary umownej określonej umowie udzielanie świadczeń opieki zdrowotnej lub niezwłocznym rozwiązaniem tej umowy.

2. Informacja odmowie przyjęcia szpital osoby stanie nagłego zagrożenia zdrowotnego, pacjenta urazowego lub pacjenta urazowego dziecięcego od jednostek systemu albo niewykonaniu decyzji, których 20a ust. 4 lub 29 ust. 9a, jest przekazywana dysponenta jednostki albo krajowego koordynatora ratownictwa medycznego lub wojewódzkiego koordynatora ratownictwa medycznego do dyrektora właściwego oddziału wojewódzkiego Narodowego Funduszu Zdrowia terminie 7 dni od dnia udzielenia tej odmowy albo dnia niewykonania decyzji.

**Art. 45c.**

- **107)** W przypadku zgonu pacjenta specjalistycznym środku transportu sanitarnego zespołu ratownictwa medycznego zwłoki pacjenta przewozi się do wskazanego dyspozytora medycznego albo wojewódzkiego koordynatora ratownictwa medycznego zakładu medycyny sądowej albo prosektorium szpitala.

2. W przypadku martwego urodzenia dziecka specjalistycznym środku transportu sanitarnego zespołu ratownictwa medycznego zwłoki martwo urodzonego dziecka przewozi się do najbliższego pod względem czasu dotarcia szpitala udzielającego świadczeń zdrowotnych zakresie położnictwa i ginekologii albo do szpitala wskazanego dyspozytora medycznego albo wojewódzkiego koordynatora ratownictwa medycznego.
...
4. Przewozu zwłok pacjenta albo martwo urodzonego dziecka oraz ich przyjęcia do zakładu medycyny sądowej, prosektorium szpitala, szpitala udzielającego świadczeń zdrowotnych zakresie położnictwa i ginekologii albo szpitala wskazanego dyspozytora medycznego albo wojewódzkiego koordynatora ratownictwa medycznego dokonuje się niezwłocznie.

5. Podmiot, którym ust. i 2, jest obowiązany przyjąć zwłoki pacjenta albo martwo urodzonego dziecka i wykonać czynności, których 28 ust. 2 i ust. 4 oraz 28a ust. 2 ustawy z dnia 15 kwietnia 2011 r. działalności leczniczej, a także przepisach wydanych na podstawie 28 ust. 7 tej ustawy. Przepisy 28 ust. 3, 5 i 6 ustawy z dnia 15 kwietnia 2011 r. działalności leczniczej stosuje się odpowiednio.

**Art. 45d.**

- **107)** Przepisów 44–45c nie stosuje się do motocyklowych jednostek ratunkowych.
...
**Art. 48.** Działalność lotniczych zespołów ratownictwa medycznego jest finansowana formie dotacji podmiotowej z budżetu państwa, z części, dysponentem jest minister właściwy do spraw zdrowia. 2. Do zadań lotniczego zespołu ratownictwa medycznego należy wykonywanie medycznych czynności ratunkowych. 3. Warunkiem finansowania, którym ust. 1, jest zapewnienie ciągłej gotowości lotniczego zespołu ratownictwa medycznego do wykonywania medycznych czynności ratunkowych zakresie określonym umowie, ust. 5. 4. Kalkulacja kosztów działalności lotniczych zespołów ratownictwa medycznego dokonywana jest z uwzględnieniem kosztów bezpośrednich i pośrednich, a szczególności:
...
2. Zakup, którym ust. 1, może być również finansowany albo dofinansowywany ze środków europejskich rozumieniu 2 5 ustawy z dnia 27 sierpnia 2009 r. finansach publicznych.

#### Rozdział 7 Zmiany przepisach obowiązujących

#### Rozdział 8 Przepisy przejściowe, dostosowujące i końcowe

**Art. 56a.** W 2009 r. na podstawie założeń, których 46 ust. 3, minister właściwy do spraw zdrowia, do dnia 15 stycznia 2009 r., przedstawia ministrowi właściwemu do spraw finansów publicznych wysokość środków na finansowanie zadań, których 46 ust. 1, wraz z podziałem tych środków pomiędzy poszczególne województwa. 2. W celu ustalenia wysokości środków na finansowanie zespołów ratownictwa medycznego pomiędzy poszczególne województwa należy kolejno obliczyć:

**Art. 57.** Do dnia 31 grudnia 2020 r. lekarzem systemu może być lekarz posiadający:

**Art. 58.** Osoby, które przed dniem:
...
**Art. 67.** Ustawa wchodzi życie z dniem stycznia 2007 r., z wyjątkiem:
