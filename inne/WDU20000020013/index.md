...
Artykuł 2 Konwencję niniejszą stosuje się do orzeczeń i ugód niezależnie od ich nazwy.
...
1. zostało wydane przez organ, któremu przysługiwała jurysdykcja na podstawie artykułów 7 lub 8, oraz
...
Artykuł 8 Bez uszczerbku dla postanowień artykułu 7, organy jednego z Umawiających Państw, które orzekały o roszczeniu alimentacyjnym, uważane są za jurysdykcję w rozumieniu niniejszej konwencji, jeżeli alimenty należą się z rozwodu lub separacji prawnej albo orzeczenia o unieważnieniu lub małżeństwa, wydanego przez organ tego Państwa, który posiadał jurysdykcję w tej, zgodnie z prawem Państwa wezwanego.
...
Artykuł 10 Jeżeli orzeczenie dotyczy kilku żądań pozwu o alimenty i jeżeli nie można uznać lub wykonać całego orzeczenia, organ Państwa wezwanego zastosuje niniejszą do tej części orzeczenia, która może być uznana lub wykonana.
Artykuł 11 Jeżeli orzeczenie nakazuje okresowe płacenie alimentów, wykonuje się zarówno w części dotyczącej należności już wymaganych, jak i przyszłych.
...
Artykuł 29 Niniejsza konwencja, w stosunkach między Państwami, które są jej stronami, zastępuje Konwencję o uznawaniu i wykonywaniu orzeczeń w przedmiocie obowiązków alimentacyjnych w stosunku do dzieci, sporządzoną w Hadze dnia 15 kwietnia 1958 r.
...
Następnie konwencja wejdzie w życie: - w stosunku do każdego Państwa-sygnatariusza, które ratyfikuje ją, przyjmie lub zatwierdzi w terminie późniejszym, pierwszego dnia trzeciego miesiąca kalendarzowego po złożeniu jego dokumentu ratyfikacji, przyjęcia lub zatwierdzenia;
...
Article 28 If a Contracting State has two or more territorial units in which different systems of law apply in relation to the recognition and enforcement of maintenance decisions –
...
#### Rozdział IV Postanowienia uzupełniające dotyczące instytucji publicznych Artykuł 18 Orzeczenie wydane przeciwko dłużnikowi alimentacyjnemu na podstawie pozwu instytucji publicznej, która dochodzi zwrotu świadczeń udzielonych wierzycielowi alimentacyjnemu, podlega uznaniu i wykonaniu zgodnie z niniejszą konwencją, jeżeli:
