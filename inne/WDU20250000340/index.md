...
- **1)** w art. 2 w ust. 1:
    ...
    - **c)** po pkt 34 dodaje się pkt 34a–34f w brzmieniu: „34a) jednorazowe papierosy elektroniczne – urządzenia umożliwiające wytworzenie i spożycie aerozolu z płynu do papierosów elektronicznych zawartego w tych urządzeniach, które nie są przeznaczone do ponownego napełniania płynem do papierosów elektronicznych lub wymiany zbiornika z płynem do papierosów elektronicznych, również te, które wymagają zewnętrznego zasilania lub sterowania;
...
- **34f)** zestaw części do urządzenia do waporyzacji – komplet części, który może służyć do wytworzenia urządzenia do waporyzacji poprzez złożenie lub połączenie części wchodzących w skład tego kompletu;”,
    - **d)** pkt 36 otrzymuje brzmienie: „36) wyroby nowatorskie – wyroby będące:
    ...
    - **e)** po pkt 36 dodaje się pkt 36a i 36b w brzmieniu: „36a) saszetki nikotynowe – wyroby niezawierające tytoniu, lecz zawierające nikotynę lub jej związki lub pochodne, zmieszane lub niezmieszane z włóknami roślinnymi lub innymi dodatkami, znajdujące się w porcjowanych saszetkach lub w równoważnej postaci, które mogą być używane doustnie do wchłaniania nikotyny lub jej związków lub pochodnych przez ludzi;
...
- **2)** w art. 5 wyrazy „w art. 8 ust. 1–5” zastępuje się wyrazami „w art. 8 ust. 1–5a”;
- **3)** w art. 8 po ust. 5 dodaje się ust. 5a w brzmieniu: „5a. W przypadku zestawu części do urządzenia do waporyzacji przedmiotem opodatkowania akcyzą jest:
...
- **4)** w art. 10 w ust. 8 wyrazy „w art. 8 ust. 2 pkt 3 i ust. 5” zastępuje się wyrazami „w art. 8 ust. 2 pkt 3, ust. 5 i ust. 5a pkt 1”;
- **5)** w art. 13:
    - **a)** w ust. 1a w pkt 3 na końcu dodaje się przecinek i dodaje się pkt 4–6 w brzmieniu: „4) urządzeń do waporyzacji, o której mowa w art. 99ca ust. 1,

- **5)** saszetek nikotynowych, o której mowa w art. 99cc ust. 1,
- **6)** innych wyrobów nikotynowych, o której mowa w art. 99cd ust. 1”,
    - **b)** w ust. 1b w pkt 3 na końcu dodaje się przecinek i dodaje się pkt 4–6 w brzmieniu: „4) urządzeń do waporyzacji, o której mowa w art. 99ca ust. 1,

- **5)** saszetek nikotynowych, o której mowa w art. 99cc ust. 1,
- **6)** innych wyrobów nikotynowych, o której mowa w art. 99cd ust. 1”,
    - **c)** w ust. 4 wyrazy „o których mowa w art. 8 ust. 1 pkt 3 oraz ust. 2, 3 i 5” zastępuje się wyrazami „o których mowa w art. 8 ust. 1 pkt 3 oraz ust. 2, 3, 5 i 5a”;

- **6)** po art. 24b dodaje się art. 24ba w brzmieniu: „Art. 24ba. W przypadku zestawu części do urządzenia do waporyzacji podatnik jest obowiązany, bez wezwania organu podatkowego, składać właściwemu naczelnikowi urzędu skarbowego deklaracje podatkowe według ustalonego wzoru oraz obliczać i wpłacać akcyzę na rachunek właściwego urzędu skarbowego, za miesięczne okresy rozliczeniowe, w terminie do 25. dnia miesiąca następującego po miesiącu, w którym powstał obowiązek podatkowy.”;
- **7)** w art. 24d w ust. 1 po wyrazach „art. 24b ust. 1,” dodaje się wyrazy „art. 24ba,”;
- **8)** w art. 24e w ust. 1a wyrazy „i art. 24b ust. 1” zastępuje się wyrazami „ , art. 24b ust. 1 i art. 24ba”;
- **9)** w art. 34:
    - **a)** w ust. 1a wyrazy „lub wyrobów nowatorskich” zastępuje się wyrazami „ , wyrobów nowatorskich, urządzeń do waporyzacji, saszetek nikotynowych lub innych wyrobów nikotynowych”,
    - **b)** w ust. 3 w pkt 4 kropkę zastępuje się średnikiem i dodaje się pkt 5–7 w brzmieniu: „5) urządzenia do waporyzacji – 2 sztuki;
...
- **10)** w art. 36 w ust. 1:
    ...
    - **b)** po pkt 6 dodaje się pkt 6a–6c w brzmieniu: „6a) urządzenia do waporyzacji – 2 sztuki;
...
- **6c)** inne wyroby nikotynowe:
    - **a)** 0,04 kilograma – w przypadku podróżnych w transporcie lotniczym lub morskim,
    - **b)** 0,004 kilograma – w przypadku podróżnych w transporcie innym niż lotniczy lub morski;”,
    - **c)** w pkt 7 wyrazy „i pkt 6 lit. a” zastępuje się wyrazami „ , pkt 6 lit. a, pkt 6b lit. a lub pkt 6c lit. a”,
    - **d)** w pkt 8 wyrazy „i pkt 6 lit. b” zastępuje się wyrazami „ , pkt 6 lit. b, pkt 6b lit. b lub pkt 6c lit. b”;

- **11)** w art. 37a:
    - **a)** w ust. 1 we wprowadzeniu do wyliczenia wyrazy „lub wyrobów nowatorskich” zastępuje się wyrazami „ , wyrobów nowatorskich, urządzeń do waporyzacji, saszetek nikotynowych lub innych wyrobów nikotynowych”,
    - **b)** w ust. 2: – we wprowadzeniu do wyliczenia wyrazy „Wyroby akcyzowe” zastępuje się wyrazami „Płyn do papierosów elektronicznych, wyroby nowatorskie, saszetki nikotynowe i inne wyroby nikotynowe”, – pkt 2 otrzymuje brzmienie: „2) wyroby nowatorskie – 0,008 kilograma, albo”, – dodaje się pkt 3 i 4 w brzmieniu: „3) saszetki nikotynowe – 0,004 kilograma, albo

- **4)** inne wyroby nikotynowe – 0,004 kilograma.”,
    - **c)** po ust. 2 dodaje się ust. 2a w brzmieniu: „2a. Urządzenia do waporyzacji, o których mowa w ust. 1, są zwolnione od akcyzy w liczbie 2 sztuk.”,
    - **d)** ust. 3 otrzymuje brzmienie: „3. W przypadku gdy ilość lub liczba wyrobów akcyzowych, o których mowa w ust. 1, przekracza normy, o których mowa w ust. 2 lub 2a, opodatkowaniu podlegają wszystkie te wyroby akcyzowe importowane w przesyłce, o której mowa w ust. 1.”;

- **12)** w art. 39 w ust. 1 w pkt 5 na końcu dodaje się przecinek i dodaje się pkt 6 w brzmieniu: „6) uzasadnia to przeznaczenie próbek niektórych wyrobów akcyzowych do badań naukowych, laboratoryjnych lub jakościowych”;
- **13)** w art. 40 ust. 7 otrzymuje brzmienie: „7. Procedury zawieszenia poboru akcyzy nie stosuje się do energii elektrycznej, wyrobów gazowych, wyrobów węglowych, suszu tytoniowego i zestawów części do urządzeń do waporyzacji.”;
- **14)** w art. 47 w ust. 1 w pkt 9 kropkę zastępuje się średnikiem i dodaje się pkt 10 w brzmieniu: „10) zestawów części do urządzeń do waporyzacji.”;
- **15)** w art. 48:
    ...
    - **b)** w ust. 4a pkt 4 otrzymuje brzmienie: „4) płynu do papierosów elektronicznych, wyrobów nowatorskich, urządzeń do waporyzacji, saszetek nikotynowych lub innych wyrobów nikotynowych – 350 mln zł.”;

- **16)** w art. 85 dodaje się ust. 11 w brzmieniu: „11. Przepisy ust. 1–4, 8 i 9 oraz przepisy wydane na podstawie ust. 5 i 7 nie mają zastosowania do ubytków urządzeń do waporyzacji.”;
- **17)** w dziale IV w tytule rozdziału 3 wyrazy „i wyroby nowatorskie” zastępuje się wyrazami „ , wyroby nowatorskie, urządzenia do waporyzacji, zestawy części do urządzeń do waporyzacji, saszetki nikotynowe i inne wyroby nikotynowe”;
- **18)** w art. 99b po ust. 4 dodaje się ust. 4a w brzmieniu: „4a. W przypadku płynu do papierosów elektronicznych zawartego w jednym jednorazowym papierosie elektronicznym akcyzę obliczoną według stawki, o której mowa w ust. 4, powiększa się o kwotę 40 zł.”;
- **19)** po art. 99c dodaje się art. 99ca–99cd w brzmieniu: „Art. 99ca. 1. Produkcją urządzeń do waporyzacji w rozumieniu ustawy jest ich wytwarzanie poprzez złożenie lub połączenie różnych części, a także pakowanie.
...
- **20)** w art. 120 w ust. 4:
    ...
    - **b)** w pkt 2 wyrazy „lub wyrobu nowatorskiego” zastępuje się wyrazami „ , wyrobu nowatorskiego, saszetek nikotynowych lub innego wyrobu nikotynowego”;
...
- **21)** w art. 136:
    ...
    - **b)** w ust. 2 pkt 1 otrzymuje brzmienie: „1) opakowania jednostkowe wyrobów spirytusowych, wyrobów winiarskich, cygar, cygaretek, urządzeń do waporyzacji, saszetek nikotynowych lub innych wyrobów nikotynowych lub”;

- **22)** po art. 138j dodaje się art. 138ja w brzmieniu: „Art. 138ja. 1. Ewidencję zestawów części do urządzeń do waporyzacji prowadzi podmiot prowadzący działalność gospodarczą w zakresie sprzedaży tych zestawów na terytorium kraju osobom fizycznym nie na potrzeby prowadzenia działalności gospodarczej.
...
- **23)** w art. 138q po ust. 3 dodaje się ust. 3a w brzmieniu: „3a. Faktury i inne dokumenty, o których mowa w art. 138ja ust. 2 pkt 3, powinny być przechowywane do celów kontroli przez okres 5 lat, licząc od końca roku kalendarzowego, w którym zostały wystawione.”;
- **24)** po art. 165a dodaje się art. 165b i art. 165c w brzmieniu: „Art. 165b. W okresie od dnia 1 sierpnia 2025 r. do dnia 31 grudnia 2026 r. stawka akcyzy na saszetki nikotynowe, o której mowa w art. 99cc ust. 4, wynosi:
...
- **1)** od dnia 1 sierpnia 2025 r. do dnia 31 grudnia 2025 r. – 150,00 zł za każdy kilogram;
- **2)** od dnia 1 stycznia 2026 r. do dnia 31 grudnia 2026 r. – 200,00 zł za każdy kilogram.”;
- **25)** w załączniku nr 1 do ustawy dodaje się poz. 48–51 w brzmieniu: 48 bez względu na kod CN Urządzenia do waporyzacji 49 bez względu na kod CN Zestawy części do urządzeń do waporyzacji 50 bez względu na kod CN Saszetki nikotynowe 51 bez względu na kod CN Inne wyroby nikotynowe
- **26)** w załączniku nr 3 do ustawy dodaje się poz. 14–16 w brzmieniu: 14 bez względu na kod CN Urządzenia do waporyzacji 15 bez względu na kod CN Saszetki nikotynowe 16 bez względu na kod CN Inne wyroby nikotynowe

**Art. 2.** W ustawie z dnia 11 września 2015 r. o zdrowiu publicznym (Dz. U. z 2024 r. poz. 1670) wprowadza się następujące zmiany:

- **1)** użyte w art. 12c w ust. 1 we wprowadzeniu do wyliczenia, w art. 12h w ust. 1 i w art. 12j w ust. 1 i 2 wyrazy „o której mowa w art. 12i ust. 1” zastępuje się wyrazami „o której mowa w art. 12i ust. 1 i 1a”;
- **2)** w art. 12i:
    - **a)** ust. 1 otrzymuje brzmienie: „1. W przypadku gdy podmiot obowiązany do zapłaty opłaty, o którym mowa w art. 12d ust. 1:
...
- **3)** nie złożył w terminie informacji, o której mowa w art. 12g ust. 1 pkt 1, ani nie wpłacił w terminie opłaty w należnej wysokości – organ właściwy w sprawie opłaty, w drodze decyzji, określa wysokość należnej opłaty oraz ustala dodatkową opłatę w wysokości do 50 % podstawy ustalenia wysokości dodatkowej opłaty.”,
    - **b)** po ust. 1 dodaje się ust. 1a–1d w brzmieniu: „1a. Jeżeli podmiot obowiązany do zapłaty opłaty, o którym mowa w art. 12d ust. 1, w okresie 14 dni po zakończeniu kontroli podatkowej, w przypadku, o którym mowa w ust. 1:

- **1)** pkt 1 – złożył korektę informacji, o której mowa w art. 12g ust. 1 pkt 1, z wykazaną opłatą w należnej wysokości i najpóźniej w dniu jej złożenia wpłacił opłatę w należnej wysokości wraz z odsetkami za zwłokę,
- **2)** pkt 2 – wpłacił opłatę w należnej wysokości wraz z odsetkami za zwłokę,
- **3)** pkt 3 – złożył informację, o której mowa w art. 12g ust. 1 pkt 1, z wykazaną opłatą w należnej wysokości i najpóźniej w dniu jej złożenia wpłacił opłatę w należnej wysokości wraz z odsetkami za zwłokę – organ właściwy w sprawie opłaty, w drodze decyzji, ustala dodatkową opłatę w wysokości do 25 % podstawy ustalenia wysokości dodatkowej opłaty.

1b. Podstawą ustalenia wysokości dodatkowej opłaty jest wysokość niewpłaconej należnej opłaty, a w przypadku wpłacenia opłaty w wysokości niższej od należnej – wysokość zaniżenia należnej opłaty.

1c. Ustalając wysokość dodatkowej opłaty, organ właściwy w sprawie opłaty bierze pod uwagę:

- **1)** okoliczności powstania nieprawidłowości;
- **2)** rodzaj i stopień naruszenia ciążącego na podmiocie obowiązanym do zapłaty opłaty, o którym mowa w art. 12d ust. 1, obowiązku, które skutkowało powstaniem nieprawidłowości;
...
- **5)** działania podjęte przez podmiot obowiązany do zapłaty opłaty, o którym mowa w art. 12d ust. 1, po stwierdzeniu nieprawidłowości w celu usunięcia skutków nieprawidłowości.

1d. Dodatkowej opłaty nie ustala się:

- **1)** jeżeli przed dniem wszczęcia kontroli podatkowej podmiot obowiązany do zapłaty opłaty, o którym mowa w art. 12d ust. 1, w przypadku, o którym mowa w ust. 1:
...
**Art. 3.** W ustawie z dnia 26 lipca 1991 r. o podatku dochodowym od osób fizycznych (Dz. U. z 2025 r. poz. 163) w art. 23 w ust. 1 pkt 16f otrzymuje brzmienie: „16f) dodatkowej opłaty, o której mowa w art. 12i ust. 1 i 1a ustawy z dnia 11 września 2015 r. o zdrowiu publicznym (Dz. U. z 2024 r. poz. 1670 oraz z 2025 r. poz. 340);”.

**Art. 4.** W ustawie z dnia 15 lutego 1992 r. o podatku dochodowym od osób prawnych (Dz. U. z 2025 r. poz. 278) w art. 16 w ust. 1 pkt 19f otrzymuje brzmienie: „19f) dodatkowej opłaty, o której mowa w art. 12i ust. 1 i 1a ustawy z dnia 11 września 2015 r. o zdrowiu publicznym (Dz. U. z 2024 r. poz. 1670 oraz z 2025 r. poz. 340);”.
