...
- **2)** w art. 4 w ust. 1 dodaje się pkt 4 w brzmieniu: "4) wykupieniu ze środków budżetu państwa części zadłużenia kredytobiorców z tytułu skapitalizowanych odsetek.";
- **3)** w art. 6:
    - **a)** ust. 1 otrzymuje brzmienie: "1. Z budżetu państwa przekazywane są bankom środki w wysokości oprocentowania obliczanego według stopy procentowej ustalonej przez Radę Ministrów, pod warunkiem dokonywania przez kredytobiorcę spłat w wysokości wynikającej z przepisów art. 7 i 8.",
