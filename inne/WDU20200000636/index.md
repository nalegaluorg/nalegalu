...
ROZPORZĄDZENIE MINISTRA FINANSÓW z dnia 7 kwietnia 2020 r.
...
poz. 505 i 568) zarządza się, co następuje: § 1. Rozporządzenie określa:
...
§ 6. 1. Wymiany legitymacji służbowej dokonuje wydający na wniosek funkcjonariusza albo pracownika.
2. Wymiana legitymacji służbowej następuje po uprzednim dokonaniu zwrotu legitymacji, o ile nie nastąpiła jej utrata.
Przepis § 5 ust. 2 stosuje się odpowiednio.
§ 7. 1. Legitymacja służbowa podlega złożeniu do depozytu w przypadku:
...
Minister Finansów: T. Kościński Załącznik nr WZÓRLEGITYMACJI SŁUŻBOWEJFUNKCJONARIUSZASŁUŻBYCELNO-SKARBOWEJ Awers Rewers I. OPIS LEGITYMACJI FUNKCJONARIUSZA SŁUŻBY CELNO-SKARBOWEJ Część wewnętrzna legitymacji ma formę karty identyfikacyjnej o wymiarach 85,60 x 53,98 mm (ID-1) wykonanej z poliwęglanu, spersonalizowanej metodą grawerowanialaserowego.
1.Awers:
...
a) RZECZPOSPOLITA POLSKA napis wydrukowany farbą optyczniezmienną,
b) KRAJOWA ADMINISTRACJA SKARBOWA,
c) Legitymacjasłużbowa, WZÓR LEGITYMACJI SŁUŻBOWEJ FUNKCJONARIUSZA SŁUŻBY CELNO-SKARBOWEJ Awers Rewers I. OPIS LEGITYMACJI FUNKCJONARIUSZA SŁUŻBY CELNO-SKARBOWEJ Część wewnętrzna legitymacji ma formę karty identyfikacyjnej o wymiarach 85,60 × 53,98 mm (ID-1) wykonanej z poliwęglanu, spersonalizowanej metodą grawerowania laserowego.
1. Awers:
1) tło reliefowe, zadruk techniką offsetową w technice druku irysowego;
2) mikrodruki;
3) tłoczenie powierzchni liniami z mikrodrukiem;
...
II. OKŁADKALEGITYMACJI Okładka legitymacji jest wykonana z materiału skóropodobnego w kolorze czarnym oraz z tłoczeniami wpostaci:
1) napisu: „RZECZPOSPOLITA POLSKA”;
2) wizerunku orła ustalonego dla godła Rzeczypospolitej Polskiej;
II. OKŁADKA LEGITYMACJI Okładka legitymacji jest wykonana z materiału skóropodobnego w kolorze czarnym oraz z tłoczeniami w postaci:
1) napisu: „RZECZPOSPOLITA POLSKA”;
2) wizerunku orła ustalonego dla godła Rzeczypospolitej Polskiej;
3) napisu: „KRAJOWA ADMINISTRACJA SKARBOWA”.
Na środku okładki legitymacji znajduje się miejsce na patkę/pasek umożliwiający zamocowanie znaku identyfikacji indywiWZÓRLEGITYMACJI SŁUŻBOWEJOSOBYZATRUDNIONEJW JEDNOSTCE ORGANIZACYJNEJKRAJOWEJADMINISTRACJI SKARBOWEJ Awers Rewers I. OPIS LEGITYMACJI OSOBY ZATRUDNIONEJ W JEDNOSTCE ORGANIZACYJNEJ KRAJOWEJADMINISTRACJI SKARBOWEJ Część wewnętrzna legitymacji ma formę karty identyfikacyjnej o wymiarach 85,60 x 53,98 mm (ID-1) wykonanej z poliwęglanu, spersonalizowanej metodą grawerowanialaserowego.
1.Awers:
1) tło reliefowe, zadruk techniką offsetową w technice druku irysowego;
2) mikrodruki;
3) tłoczenie powierzchni liniami z mikrodrukiem;
...
b) danepersonalnepracownika;
6) numeracjaindywidualna blankietugrawerowanalaserowo;
7) napisy różnej wielkości:
a) RZECZPOSPOLITA POLSKA wydrukowanyfarbą optycznie zmienną
b) KRAJOWA ADMINISTRACJA SKARBOWA,
c) Legitymacjasłużbowa, WZÓR LEGITYMACJI SŁUŻBOWEJ OSOBY ZATRUDNIONEJ W JEDNOSTCE ORGANIZACYJNEJ KRAJOWEJ ADMINISTRACJI SKARBOWEJ Awers Rewers I. OPIS LEGITYMACJI OSOBY ZATRUDNIONEJ W JEDNOSTCE ORGANIZACYJNEJ KRAJOWEJ ADMINISTRACJI SKARBOWEJ Część wewnętrzna legitymacji ma formę karty identyfikacyjnej o wymiarach 85,60 × 53,98 mm (ID-1) wykonanej z poliwęglanu, spersonalizowanej metodą grawerowania laserowego.
1. Awers:
1) tło reliefowe, zadruk techniką offsetową w technice druku irysowego;
2) mikrodruki;
3) tłoczenie powierzchni liniami z mikrodrukiem;
