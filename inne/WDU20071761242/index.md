...
- **2)** w art. 5: w ust. 3 w pkt 6 kropkę zastępuje się średnikiem i dodaje się pkt 7 w brzmieniu: „
    - **a)**

- **7)** gdy otrzymali ze sprawdzianu sprawności fizycznej ocenę niedostateczną. ” , w ust. 4 w pkt 3 kropkę zastępuje się średnikiem i dodaje się pkt 4 w brzmieniu: „
    - **b)**

- **4)** gdy nie przystąpił w nakazanym terminie do sprawdzianu sprawności fizycznej. ” , w ust. 5 pkt 2 otrzymuje brzmienie: „
    - **c)**
...
- **1)** w korpusie oficerów zawodowych: powołuje się żołnierza mianowanego na stopień wojskowy podporucznika (podporucznika marynarki) po uzyskaniu przez niego tytułu zawodowego magistra (równorzędnego), ukończeniu szkolenia wojskowego i zdaniu egzaminu na oficera, może być powołany oficer rezerwy posiadający tytuł zawodowy magistra (równorzędny) i stopień wojskowy równy lub bezpośrednio niższy od stopnia etatowego stanowiska służbowego, na jakie ma być wyznaczony po powołaniu do służby;
    - **a)**
    - **b)**
...
- **9)** w art. 14: ust. 1 i 2 otrzymują brzmienie: „
    - **a)**
...
2. Z żołnierzem zawodowym pełniącym zawodową służbę wojskową w ramach kontraktu na pełnienie służby terminowej może być podpisany, na jego wniosek, kontrakt na pełnienie służby stałej, jeżeli posiada bardzo dobrą ocenę w ostatniej opinii służbowej. ” , dodaje się ust. 4 w brzmieniu: „
...
- **2)** z podjęciem przez żołnierza zawodowego pracy, o której mowa w ust. 1a, czas pozostawania w rezerwie kadrowej nie może być dłuższy niż pięć lat w okresie zawodowej służby wojskowej. ” , dodaje się ust. 5 w brzmieniu: „
    - **c)**
...
- **3)** oficerów zawodowych: od stopnia etatowego podporucznika (podporucznika marynarki) – posiadanie tytułu zawodowego magistra (równorzędnego), od stopnia etatowego majora (komandora podporucznika) – ukończenie studiów podyplomowych w uczelni wojskowej, od stopnia etatowego generała brygady (kontradmirała) – ukończenie podyplomowych studiów polityki obronnej.
    - **a)**
    - **b)**
    - **c)**
...
2. Okres kadencji na stanowisku wynosi od osiemnastu miesięcy do trzech lat. ” , po ust. 2 dodaje się ust. 2a w brzmieniu: „

- **b)**

2a. Jeżeli jest to uzasadnione potrzebami Sił Zbrojnych, okres kadencji, o którym mowa w ust. 2, może być przez organ właściwy do wyznaczenia na stanowisko służbowe przedłużony do dwunastu miesięcy. ” , ust. 4 otrzymuje brzmienie: „
...
- **28)** w art. 45: w ust. 1 w pkt 3 kropkę zastępuje się średnikiem i dodaje się pkt 4 w brzmieniu: „
    - **a)**

- **4)** wskutek wymierzenia kary dyscyplinarnej odwołania z zajmowanego stanowiska służbowego. ” , ust. 2 otrzymuje brzmienie: „
    - **b)**

2. Żołnierza zawodowego można zwolnić z zajmowanego stanowiska służbowego w przypadku:

- **1)** zaistnienia potrzeb Sił Zbrojnych;
- **2)** wszczęcia postępowania w sprawie cofnięcia żołnierzowi zawodowemu poświadczenia bezpieczeństwa o klauzuli wymaganej na tym stanowisku. ” , po ust. 2 dodaje się ust. 2a i 2b w brzmieniu: „
    - **c)**
...
2b. W przypadku, o którym mowa w ust. 2 pkt 2, żołnierza zawodowego przenosi się do rezerwy kadrowej na czas prowadzonego postępowania. Na zwolnione stanowisko służbowe nie wyznacza się do czasu zakończenia postępowania w sprawie cofnięcia żołnierzowi zawodowemu poświadczenia bezpieczeństwa innego żołnierza zawodowego, a powierza się obowiązki służbowe na tym stanowisku innemu żołnierzowi zawodowemu w trybie określonym w art. 25. ” , ust. 3 otrzymuje brzmienie: „

- **d)**

3. Żołnierza zawodowego w przypadkach wymienionych w ust. 1 i 2 oraz żołnierza zawodowego pozostającego w rezerwie kadrowej zwalnia się z zawodowej służby wojskowej, gdy odmówi pełnienia służby na innym równorzędnym lub wyższym stanowisku służbowym. ” , po ust. 3 dodaje się ust. 3a w brzmieniu: „
...
- **32)** w art. 58: ust. 1–3 otrzymują brzmienie: „
    - **a)**
...
3. Oświadczenie, o którym mowa w ust. 1, składa się co roku do dnia 31 marca, według stanu na dzień 31 grudnia roku poprzedniego. ” , dodaje się ust. 7 w brzmieniu: „
...
- **37)** w art. 83: po ust. 1 dodaje się ust. 1a w brzmieniu: „
    - **a)**

1a. Żołnierz zawodowy, o którym mowa w art. 20 ust. 1a, nabywa prawo do dodatkowego uposażenia rocznego w wysokości proporcjonalnej do liczby miesięcy kalendarzowych, za które żołnierzowi przysługiwało uposażenie miesięczne w pełnej wysokości. ” , ust. 2 otrzymuje brzmienie: „
...
- **39)** w art. 90: ust. 2 otrzymuje brzmienie: „
    - **a)**

2. Należności pieniężne określone w art. 83, art. 85 i 94–98, przysługujące żołnierzowi zawodowemu, o którym mowa w ust. 1, albo członkom jego rodziny, wypłaca się w wysokości ustalonej, z uwzględnieniem pełnej kwoty uposażenia zasadniczego wraz z dodatkami o charakterze stałym, należnego żołnierzowi na ostatnio zajmowanym stanowisku służbowym oraz zmian mających wpływ na prawo do uposażenia lub jego wysokość, powstałych w okresie, w którym żołnierz zawodowy otrzymywał uposażenie w wysokości 75%. ” , dodaje się ust. 3 w brzmieniu: „
...
- **42)** w art. 96: ust. 2 otrzymuje brzmienie: „
    - **a)**
...
- **4)** niewyznaczenia na stanowisko służbowe na kolejną kadencję. ” , dodaje się ust. 8–10 w brzmieniu: „
    - **b)**
...
- **46)** w art. 111: pkt 2 otrzymuje brzmienie: „
    - **a)**

- **2)** wybrania na posła, w tym do Parlamentu Europejskiego, senatora, na kierownicze stanowisko państwowe obsadzane na podstawie wyboru oraz do organów wykonawczych samorządu terytorialnego; ” , pkt 6 otrzymuje brzmienie: „
    - **b)**

- **6)** otrzymania niedostatecznej ogólnej oceny w opinii służbowej; ” , po pkt 6 dodaje się pkt 6a-6c w brzmieniu: „
    - **c)**
...
- **6c)** złożenia niezgodnego z prawdą oświadczenia lustracyjnego ” , pkt 7 otrzymuje brzmienie: „
    - **d)**
...
- **53)** w art. 120: ust. 1 otrzymuje brzmienie: „
    - **a)**

1. Byty żołnierz zawodowy, o którym mowa w art. 119 ust. 1, w okresie dwóch lat od zwolnienia z zawodowej służby wojskowej może korzystać z pomocy w zakresie przekwalifikowania, doradztwa zawodowego i pośrednictwa pracy, udzielanej przez właściwe organy. ” , ust. 4 otrzymuje brzmienie: „
...
- **62)** w art. 137: w ust. 1 uchyla się pkt 5, w ust. 2 uchyla się pkt 5;
    - **a)**
    - **b)**
