...
# RZECZYPOSPOLITEJ POLSKIEJ Poz. 2041 ROZPORZĄDZENIE MINISTRA KULTURY I DZIEDZICTWA NARODOWEGO z dnia 26 września 2023 r.

| Pole | Wartość |
|---|---|
| Adres publikacyjny | Dz.U. 2023 poz. 2041 |
| ISAP | WDU20230002041 |
...
| Źródło | [ISAP](https://isap.sejm.gov.pl/isap.nsf/DocDetails.xsp?id=WDU20230002041) · [PDF](https://api.sejm.gov.pl/eli/acts/DU/2023/2041/text.pdf) |
...
§ 1. W rozporządzeniu Ministra Kultury i Dziedzictwa Narodowego z dnia 28 sierpnia 2019 r. w sprawie oceniania, klasyfikowania i promowania uczniów w publicznych szkołach artystycznych (Dz. U. z 2023 r. poz. 147) wprowadza się następujące zmiany:
1) w § 2 pkt 2 otrzymuje brzmienie: „2) o przedmiocie głównym – należy przez to rozumieć następujące zajęcia edukacyjne:
...
7) w § 19 w ust. 2:
a) pkt 2 otrzymuje brzmienie: „2) w ogólnokształcącej szkole muzycznej II stopnia:
...
b) po pkt 2 dodaje się pkt 2a w brzmieniu: „2a) w szkole muzycznej II stopnia:
...
11) w § 26 w ust. 1 pkt 1 otrzymuje brzmienie: „1) część praktyczną polegającą na wykonaniu:
...
12) po § 26 dodaje się § 26a w brzmieniu: „§ 26a. 1. W szkole sztuki cyrkowej egzamin dyplomowy obejmuje:
...
13) w § 27 ust. 1 otrzymuje brzmienie: „1. W szkole policealnej muzycznej egzamin dyplomowy obejmuje:
...
17) w § 34 ust. 1 otrzymuje brzmienie: „1. Egzamin dyplomowy w części teoretycznej:
...
18) § 36 otrzymuje brzmienie: „§ 36. W przypadku części praktycznej egzaminu dyplomowego, o której mowa w:
...
19) w § 38 pkt 1 otrzymuje brzmienie: „1) w części praktycznej – co najmniej ocenę dostateczną, a w przypadku części praktycznej, o której mowa w:
