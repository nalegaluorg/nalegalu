...
- **1)** w art. 8: w ust. 3 pkt 1 otrzymuje brzmienie: „
    - **a)**

- **1)** miesięczne obciążenie podatkiem dochodowym od osób fizycznych i koszty uzyskania przychodu; ” , w ust. 4 w pkt 10 kropkę zastępuje się średnikiem i dodaje się pkt 11–13 w brzmieniu: „
    - **b)**
...
- **3)** w art. 22: w pkt 5 skreśla się wyrazy „w szczególności w zakresie wskazania im miejsca zamieszkania,”, pkt 7 otrzymuje brzmienie: „
    - **a)**
    - **b)**

- **7)** realizacja lub zlecanie jednostkom samorządu terytorialnego lub podmiotom uprawnionym, o których mowa w art. 25 ust. 1, zadań wynikających z programów rządowych lub programów ustanowionych przez ministra właściwego do spraw zabezpieczenia społecznego; ” , w pkt 9 i 9a po wyrazach „kontrola jakości usług” dodaje się wyrazy „oraz zgodności zatrudnienia pracowników z wymaganymi kwalifikacjami”;
    - **c)**
...
- **7)** w art. 48a: w ust. 2g pkt 2 otrzymuje brzmienie: „
    - **a)**

- **2)** opiekunów posiadających: wykształcenie zasadnicze branżowe lub zasadnicze zawodowe, co najmniej roczne doświadczenie w pracy z osobami bezdomnymi oraz ukończone szkolenie z zakresu udzielania pierwszej pomocy lub wykształcenie co najmniej średnie lub średnie branżowe oraz ukończone szkolenie z zakresu udzielania pierwszej pomocy. ” , w ust. 2h w pkt 2 lit. b otrzymuje brzmienie: „ co najmniej wykształcenie zasadnicze branżowe lub zasadnicze zawodowe, udokumentowane co najmniej roczne doświadczenie zawodowe polegające na świadczeniu usług opiekuńczych osobom niepełnosprawnym, przewlekle chorym lub osobom w podeszłym wieku oraz ukończone szkolenie z zakresu udzielania pierwszej pomocy. ” , ust. 3a otrzymuje brzmienie: „
    - **a)**
    - **b)**
    - **b)**
    - **b)**
...
- **2)** wykształcenie co najmniej średnie lub średnie branżowe oraz ukończone szkolenie z zakresu udzielania pierwszej pomocy. ” , ust. 4a otrzymuje brzmienie: „
    - **d)**
...
- **9)** w art. 51b: uchyla się ust. 1, ust. 2 otrzymuje brzmienie: „
    - **a)**
    - **b)**

2. Korzystanie z usług świadczonych w ośrodkach wsparcia osobom z zaburzeniami psychicznymi, niebędących usługami całodobowymi oraz korzystanie z usług klubów samopomocy dla osób z zaburzeniami psychicznymi jest nieodpłatne. ” , w ust. 4 wyrazy „ust. 1 i 3” zastępuje się wyrazami „ust. 3”, w ust. 5 po wyrazie „usług” dodaje się wyraz „całodobowych”, w ust. 6 i 7 po wyrazie „usługi” dodaje się wyraz „całodobowe”;
...
- **14)** w art. 68a: pkt 4 otrzymuje brzmienie: „
    - **a)**

- **4)** zapewnić wykonywanie czynności, o których mowa w art. 68 ust. 1 pkt 1, przez osoby posiadające kwalifikacje niezbędne do wykonywania zawodu lekarza, pielęgniarki, położnej, ratownika medycznego, opiekuna w domu pomocy społecznej, opiekuna osoby starszej, asystenta osoby niepełnosprawnej, opiekunki środowiskowej, opiekuna medycznego albo osoby posiadające udokumentowane co najmniej 2-letnie doświadczenie zawodowe polegające na świadczeniu usług opiekuńczych osobom niepełnosprawnym, przewlekle chorym lub osobom w podeszłym wieku oraz ukończone szkolenie z zakresu udzielania pierwszej pomocy; ” , w pkt 5 wyrazy „zatrudniać osoby, o których mowa w pkt 4,” zastępuje się wyrazami „zapewnić, aby osoby, o których mowa w pkt 4, świadczyły pracę na podstawie umowy o pracę lub innej umowy”;
    - **b)**
...
- **16)** w art. 91: uchyla się ust. 11, dodaje się ust. 12 w brzmieniu: „
    - **a)**
    - **b)**
...
- **17)** w art. 93 w ust. 1: w pkt 1 lit. c otrzymuje brzmienie: „ pomocy w uzyskaniu możliwości zamieszkania, w tym w przypadku, gdy cudzoziemiec spełnia przesłanki udzielenia tego typu wsparcia – w mieszkaniu chronionym, ” , w pkt 2 lit. a otrzymuje brzmienie: „ wskazania miejsca zamieszkania, ” ;
    - **a)**
    - **c)**
    - **b)**
    - **a)**

- **18)** w art. 94: uchyla się ust. 2, w ust. 3 po wyrazach „z realizacji programu” dodaje się wyrazy „na terenie tego województwa”, ust. 6 otrzymuje brzmienie: „
    - **a)**
    - **b)**
    - **c)**
...
- **2)** starosta właściwy ze względu na nowe miejsce zamieszkania cudzoziemca wydaje decyzję o przyznaniu pomocy dla cudzoziemca na okres wskazany w pierwszej decyzji o przyznaniu pomocy, z uwzględnieniem okresu pomocy wykorzystanej w dotychczasowym miejscu zamieszkania. ” , ust. 8 otrzymuje brzmienie: „
    - **d)**
...
- **20)** w art. 101: po ust. 2 dodaje się ust. 2a w brzmieniu: „
    - **a)**

2a. W przypadku osoby przebywającej w placówce zapewniającej całodobową opiekę lub domu pomocy społecznej na podstawie umowy cywilnej właściwa miejscowo jest gmina miejsca zamieszkania tej osoby sprzed rozpoczęcia pobytu w tego typu placówce lub domu. ” , ust. 6 otrzymuje brzmienie: „
...
- **21)** w art. 103: w ust. 2 skreśla się wyrazy „, przy czym opłata ta nie powinna być zwiększana w przypadku gdy jedna z osób jest zwalniana z odpłatności z mocy prawa lub z powodów, o których mowa w art. 64, art. 64a albo art. 64b”, dodaje się ust. 3 w brzmieniu: „
    - **a)**
    - **b)**
...
1. Pracownik socjalny korzysta z prawa pierwszeństwa przy wykonywaniu swoich zadań w urzędach, instytucjach, podmiotach wykonujących działalność leczniczą i innych placówkach. ” , po ust. 1 dodaje się ust. 1a w brzmieniu: „

- **b)**

1a. Organy i instytucje administracji publicznej, podmioty wykonujące działalność leczniczą i organizacje pozarządowe są obowiązane do udzielania pracownikowi socjalnemu pomocy w wykonywaniu jego zadań. ” , po ust. 2 dodaje się ust. 2a-2c w brzmieniu: „
...
- **33)** w art. 130: w ust. 1 wyrazy „od 200 do 6000 zł” zastępuje się wyrazami „od 500 do 12 000 zł”, ust. 2 otrzymuje brzmienie: „
    - **a)**
    - **b)**
...
- **3)** powyżej 20 osób – podlega karze pieniężnej w wysokości 30 000 zł. ” , w ust. 4 i 4a wyrazy „40 000 zł” zastępuje się wyrazami „60 000 zł”.
    - **c)**
...
- **2)** w ust. 2: w pkt 1 wyrazy „31 maja 2021 r.” zastępuje się wyrazami „31 maja 2022 r.”, w pkt 2 wyrazy „od dnia 1 czerwca 2021 r. do dnia 31 maja 2022 r.” zastępuje się wyrazami „od dnia 1 czerwca 2022 r. do dnia 31 maja 2023 r.”, w pkt 3 wyrazy „1 czerwca 2022 r.” zastępuje się wyrazami „1 czerwca 2023 r.”, w części wspólnej wyrazy „31 maja 2022 r.” zastępuje się wyrazami „31 maja 2023 r.”.
    - **a)**
    - **b)**
    - **c)**
    - **d)**
