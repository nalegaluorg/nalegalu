...
- **1)** w art. 2 w ust. 1: o giełdach towarowych, nabywającą wyroby gazowe z tytułu pełnienia funkcji opisanej w art. 5 ust. 3a ustawy z dnia 26 października 2000 r. o giełdach towarowych, lub
    ...
    - **b)** po pkt 19 dodaje się pkt 19a w brzmieniu: „19a) finalny nabywca gazowy – podmiot, który:
    ...
    - **c)** po pkt 23c dodaje się pkt 23d w brzmieniu: „23d) pośredniczący podmiot gazowy – podmiot mający siedzibę lub miejsce zamieszkania na terytorium kraju lub posiadający koncesję na obrót gazem ziemnym na terytorium kraju:
    ...
    - **d)** będący spółką prowadzącą giełdę towarową w rozumieniu ustawy z dnia 26 października 2000 r.
...
- **3)** po art. 9b dodaje się art. 9c w brzmieniu: „Art. 9c. 1. W przypadku wyrobów gazowych przedmiotem opodatkowania akcyzą jest:
...
- **4)** po art. 11a dodaje się art. 11b w brzmieniu: „Art. 11b. 1. W przypadku wyrobów gazowych obowiązek podatkowy powstaje z dniem:
...
- **5)** w art. 13:
    - **a)** w ust. 1 w pkt 11 kropkę zastępuje się średnikiem i dodaje się pkt 12 i 13 w brzmieniu: „12) będący pośredniczącym podmiotem gazowym używającym wyrobów gazowych;

- **13)** będący finalnym nabywcą gazowym – w przypadku, o którym mowa w art. 9c ust. 1 pkt 5.”,
    - **b)** ust. 5 i 6 otrzymują brzmienie: „5. Podatnikiem w przypadku nabycia wewnątrzwspólnotowego:
...
- **3)** nieprzesłania w terminie przez nabywcę końcowego podmiotowi reprezentującemu kopii faktury, o której mowa w art. 24 ust. 1 pkt 1 – podatnikiem z tytułu nabycia wewnątrzwspólnotowego energii elektrycznej od podmiotu zagranicznego niemającego siedziby, miejsca zamieszkania lub stałego miejsca prowadzenia działalności na terytorium kraju jest nabywca końcowy, który dokonał nabycia wewnątrzwspólnotowego energii elektrycznej.”,
    - **c)** po ust. 6 dodaje się ust. 6a w brzmieniu: „6a. W przypadku:
...
- **11)** po art. 31a dodaje się art. 31b w brzmieniu: „Art. 31b. 1. Zwalnia się od akcyzy czynności podlegające opodatkowaniu, których przedmiotem są wyroby gazowe przeznaczone do celów opałowych:
...
- **12)** w art. 32 w ust. 1 w pkt 3 kropkę zastępuje się średnikiem i dodaje się pkt 4 i 5 w brzmieniu: „4) używane do celów, o których mowa w art. 31b ust. 1, wyroby energetyczne o kodzie CN 2901 10 00 w przypadkach, o których mowa w ust. 3, jeżeli spełnione są warunki, o których mowa w ust. 5–13;
...
- **15)** w art. 88 dodaje się ust. 7 i 8 w brzmieniu: „7. Do celów poboru akcyzy ustala się wartości opałowe, które wynoszą:
...
- **17)** po art. 91a dodaje się art. 91b w brzmieniu: „Art. 91b. 1. Pośredniczący podmiot gazowy dokonujący sprzedaży wyrobów gazowych na terytorium kraju finalnemu nabywcy gazowemu jest obowiązany prowadzić ewidencję wyrobów gazowych zawierającą następujące dane:
