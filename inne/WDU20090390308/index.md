...
1. Wsparcie może być udzielane wformie:

- **1)** gwarancji Skarbu Państwa;
- **2)** pożyczek skarbowych papierów wartościowych;
- **3)** sprzedaży skarbowych papierów wartościowych zodroczonym terminem płatności;
- **4)** sprzedaży skarbowych papierów wartościowych zrozłożeniem płatności na raty;
- **5)** sprzedaży skarbowych papierów wartościowych wdrodze oferty kierowanej do określonej instytucji finansowej.
...
4. Minister właściwy do spraw finansów publicznych może udzielać, imieniu Skarbu Państwa, gwarancji spełnienia emitenta świadczeń pieniężnych wynikających tytułu dłużnych papierów wartościowych, których mowa 3, wyłącznie dla papierów wartościowych wyemitowanych terminem zapadalności nie krótszym niż 3 miesiące nie dłuższym niż 5 lat.
...
3. Wartość nominalną zobowiązań ztytułu wyemitowanych skarbowych papierów wartościowych, których mowa niniejszej ustawie, zalicza się do długu Skarbu Państwa, zgodnie ustawą dnia 30czerwca 2005r. ofinansach publicznych.

**Art. 15.**

1. Wsparcia, którym mowa art. 3 ust.1, udziela, wimieniu Skarbu Państwa, na wniosek instytucji finansowej minister właściwy do spraw finansów publicznych, wdrodze umowy.

2. Wniosek, októrym mowa wust.1, powinien zawierać wszczególności:
...
- **1)** organ, który go wystawił na rzecz którego egzekucja ma być prowadzona;
- **2)** dłużnika zobowiązanego do zapłaty;
- **3)** wysokość zobowiązań dłużnika wraz odsetkami iterminami ich płatności;
...
1. Wsparcie na zasadach określonych ustawie może być udzielane nie dłużej niż do dnia 31 grudnia 2009r.
