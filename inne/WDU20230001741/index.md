...
§ 4. 1. Orzeczenie podlega wykonaniu, jeżeli odpis orzeczenia jest:
...
W przypadku uzasadnionego przypuszczenia, że pozbawienie wolności lub zwolnienie osadzonego nastąpiło niezgodnie z prawem, dyrektor powiadamia o tym natychmiast sędziego penitencjarnego.
§ 8. 1. Organ dysponujący ustala się na podstawie nazwy sądu lub prokuratury w połączeniu z sygnaturą akt sprawy.
...
§ 17. Dyrektor może samodzielnie polecić dokonanie przetransportowania osadzonego, o którym mowa w § 16, jeżeli jednocześnie:
...
§ 18. W przypadku uchylenia wyroku skazującego sądu pierwszej instancji lub zastosowania tymczasowego aresztowania w innej sprawie wobec osadzonego odbywającego karę w zakładzie karnym, transportuje się go do aresztu śledczego wyznaczonego przez dyrektora okręgowego jako właściwy dla tymczasowo aresztowanych, którzy nie mogą przebywać w danym zakładzie karnym, nie później niż następnego dnia roboczego.
§ 19. 1. O skierowaniu osadzonego do aresztu śledczego niezgodnie z rejonizacją osadzania, ustaloną dla danego organu dysponującego lub wzywającego, dyrektor zawiadamia ten organ oraz dyrektora okręgowego. Przepisu nie stosuje się w przypadkach, o których mowa w § 13 ust. 1.
...
§ 21. 1. Prawidłowość przyjęcia podlega kontroli przez kierownika.
...
§ 22. 1. Dokumentem niezbędnym do przyjęcia tymczasowo aresztowanego jest odpis postanowienia o zastosowaniu albo przedłużeniu tymczasowego aresztowania, którego termin stosowania nie minął, wraz z nakazem przyjęcia.
...
5. Jeżeli tymczasowo aresztowany został zwolniony w przypadku, w którym mowa w § 110 ust. 2 pkt 9, ponowne przyjęcie do aresztu śledczego w tej samej sprawie, może nastąpić na podstawie dokumentów, o których mowa w ust. 1;
nakaz przyjęcia może wystawić również prokurator.
§ 23. 1. Dokumentem niezbędnym do przyjęcia skazanego lub ukaranego jest:
...
§ 24. 1. Dokumentem niezbędnym do przyjęcia dłużnika, wobec którego zastosowano środek przymusu, jest odpis orzeczenia, którym sąd orzekł grzywnę z zamianą na areszt, wraz z nakazem przyjęcia.
...
§ 25. 1. Dokumentem niezbędnym do przyjęcia osoby skazanej za granicą i przekazanej z terytorium innego państwa na terytorium Rzeczypospolitej Polskiej w celu wykonania kary pozbawienia wolności jest odpis postanowienia sądu okręgowego o zastosowaniu tymczasowego aresztowania, którego termin stosowania nie minął, wraz z nakazem przyjęcia. Przepis stosuje się także wobec osoby skazanej za granicą przebywającej na terytorium Rzeczypospolitej Polskiej.
...
§ 26. 1. Przyjęcie skazanego lub ukaranego, korzystającego z przerwy w wykonaniu kary, do jednostki penitencjarnej, w której znajdują się jego akta ewidencyjne, następuje w przypadku:
...
§ 27. 1. Do przyjęcia osadzonego, który zbiegł albo w wyznaczonym terminie nie powrócił z przepustki, jest niezbędne potwierdzenie tego faktu przez jednostkę penitencjarną, w której ewidencji pozostaje osadzony. Dokument potwierdzający uzgodnienie włącza się do akt ewidencyjnych.
...
7. W razie wątpliwości co do tożsamości osoby zgłaszającej się do odbycia kary, w szczególności z przyczyn określonych w ust. 2, powiadamia się najbliższą jednostkę organizacyjną Policji o potrzebie potwierdzenia tożsamości takiej osoby.
Do czasu potwierdzenia tożsamości przez Policję osoba zgłaszająca się nie może być przyjęta.
...
§ 35. 1. W przypadku doprowadzenia skazanego lub ukaranego, organ doprowadzający doręcza dokument stwierdzający datę, godzinę i minutę jego zatrzymania.
...
§ 38. 1. O przyjęciu oraz o przetransportowaniu tymczasowo aresztowanego zawiadamia się organ dysponujący. Zawiadomienie przesyła się nie później niż pierwszego dnia roboczego po przyjęciu lub przetransportowaniu.
...
§ 42. 1. W celu zapewnienia właściwej izolacji osób powiązanych na grupy dzieli się:
1) cele mieszkalne;
2) osoby powiązane.
...
§ 46. 1. Wymiar kary odnotowuje się w aktach i dokumentach ewidencyjnych w takich jednostkach czasu, w jakich kara została określona w wyroku lub innym orzeczeniu, którym wymierzono karę podlegającą wykonaniu.
...
§ 47. 1. Początek wykonywania kary liczy się od chwili:
...
§ 50. 1. Zmiany ustalonego okresu wykonywania zastępczej kary pozbawienia wolności lub zastępczej kary aresztu, w przypadku uiszczenia grzywny w części, dokonuje się po otrzymaniu zarządzenia określającego wymiar kary zastępczej pozostałej do wykonania.
...
§ 51. 1. W przypadku przyjęcia albo powrotu osadzonego, który zbiegł albo w wyznaczonym terminie nie powrócił z przepustki, końcem okresu podlegającego zaliczeniu na poczet kary jest dzień ucieczki lub dzień wyznaczony jako termin powrotu z przepustki.
...
§ 52. 1. W przypadku, gdy sąd zawiadomił o odroczeniu wykonania kary lub zawieszeniu postępowania wykonawczego w sprawie, w której termin początku okresu wykonywania kary jeszcze nie nastąpił, orzeczenie wraz z nakazem przyjęcia zwraca się.
...
§ 53. 1. Jeżeli względy penitencjarne przemawiają za wykonaniem kar w innej kolejności niż określona w art. 80 § 1 k.k.w., dyrektor występuje do sędziego penitencjarnego z wnioskiem o wydanie zarządzenia w tej sprawie.
...
§ 54. 1. Obliczenia okresu wykonywania kary dokonuje wyznaczony funkcjonariusz lub pracownik działu ewidencji, sprawdza kierownik, a zatwierdza dyrektor.
...
§ 55. Skazanego lub ukaranego informuje się o terminach początku i końca kary. Przepis § 108 ust. 1 stosuje się odpowiednio.
§ 56. 1. Obliczenie okresu wykonywania kary przesyła się do właściwego sądu w celu kontroli prawidłowości obliczenia okresu wykonywania kary.
...
§ 62. W aktach ewidencyjnych przechowuje się dokumenty stanowiące podstawę prawną pozbawienia wolności, izolowania osób powiązanych oraz zwolnienia osadzonego, a także inne dokumenty, jeżeli obowiązek ich przechowywania w aktach ewidencyjny wynika z odrębnych przepisów.
§ 63. 1. W przypadku przyjęcia osadzonego, który dokonał ucieczki albo korzystał z przepustki lub przerwy w wykonaniu kary, do jednostki penitencjarnej niedysponującej jego aktami ewidencyjnymi, należy:
...
§ 67. 1. Do księgi głównej osadzonych wpisywane są podstawowe dane o osobach przyjmowanych lub przetransportowanych, w takiej kolejności, w jakiej osoby te przybyły do danej jednostki penitencjarnej.
...
przepisy dotyczące przetransportowania stosuje się.
...
§ 68. 1. W razie czasowego pobytu w jednostce penitencjarnej:
...
§ 72. 1. W książce stanu osadzonych oblicza się, według stanu na godzinę 00.00, codzienny ogólny stan liczbowy osadzonych oraz stan liczbowy osadzonych według miejsc ich aktualnego pobytu.
...
§ 73. W rejestrze osób czasowo przebywających w jednostce penitencjarnej wpisuje się osadzonych, o których mowa w § 67 ust. 4 zdanie pierwsze.
§ 74. 1. W rejestrze orzeczeń oczekujących na wykonanie odnotowuje się dane o skazanych i ukaranych, którzy mają zgłosić się lub zostać doprowadzeni do odbycia kary.
...
§ 76. 1. W rejestrze wydanych akt ewidencyjnych odnotowuje się dane osobowe osadzonych, których akta zostały czasowo przekazane z działu ewidencji innym służbom jednostki penitencjarnej.
...
§ 77. 1. W rejestrze korespondencji odnotowuje się przesyłki z korespondencją urzędową adresowaną do osadzonych, przesyłaną bez zwrotnych pokwitowań odbioru, zwanych dalej „potwierdzeniami odbioru”, a podlegające doręczeniu adresatom.
...
§ 78. 1. W rejestrze osadzonych wydanych poza teren jednostki penitencjarnej, odnotowuje się dane osobowe osadzonych wydanych czasowo:
1) za granicę:
...
§ 80. 1. W kalendarzu zwolnień tymczasowo aresztowanych, na stronie odpowiadającej terminowi upływu tymczasowego aresztowania, odnotowuje się dane osobowe wszystkich osadzonych, którym termin tymczasowego aresztowania upływa w danym roku kalendarzowym, a ponadto wyznaczoną godzinę i minutę zwolnienia z jednostki penitencjarnej, o których mowa w § 112 ust. 2 pkt 1.
2. Przepis ust. 1 stosuje się w razie poszukiwania w innej sprawie osoby już przebywającej w jednostce penitencjarnej.
Czas trwania tymczasowego aresztowania określony w postanowieniu o jego zastosowaniu liczy się od chwili wpływu tego postanowienia, wraz z nakazem przyjęcia do jednostki, w ewidencji której osoba ta pozostaje.
...
§ 83. 1. W przypadku uchylenia wyroku skazującego sądu pierwszej instancji wobec osoby, o której mowa w § 82 ust. 1, ewidencjonuje się ją jako tymczasowo aresztowaną.
...
§ 88. 1. Jeżeli jednostka penitencjarna otrzyma nakaz wydania do udziału w czynności procesowej osadzonego:
...
§ 89. 1. W razie zaistnienia przyczyny uniemożliwiającej udział osadzonego w czynności procesowej dokonywanej poza terenem jednostki penitencjarnej, informuje się o tym organ wzywający i na jego żądanie przesyła stosowny dokument.
...
§ 90. Jeżeli osadzony wzywany do udziału w czynności procesowej jest pozbawiony wolności także w innej sprawie niż ta, w której jest przeprowadzana czynność, zawiadamia się o tym organ wzywający. Zawiadomienie przekazuje się, za pokwitowaniem, organowi doprowadzającemu.
§ 91. 1. W razie otrzymania nakazów wydania osadzonego do udziału w kilku czynnościach procesowych, które mają być dokonane w tym samym dniu, zawiadamia się o tym organy wzywające oraz wnosi się o uzgodnienie terminów czynności.
2. W przypadku, gdy organy wzywające nie dokonają uzgodnień terminów czynności, osadzonego wydaje się do udziału w czynności procesowej temu organowi doprowadzającemu, który zgłosi się po niego pierwszy.
§ 92. 1. Osadzonego, wzywanego do udziału w czynności procesowej dokonywanej w innej miejscowości, wydaje się organowi doprowadzającemu w celu przetransportowania do aresztu śledczego wskazanego przez organ wzywający, na podstawie wystawionego przez sąd lub prokuratora nakazu wydania z zawartą w nim informacją o mającym nastąpić przetransportowaniu.
...
5. W przypadku, gdy polecenie przetransportowania tymczasowo aresztowanego wydał jeden z kilku organów dysponujących, zawiadamia się o tym organ wzywający oraz wnosi się o uzgodnienie przetransportowania z innymi organami.
Do czasu otrzymania pisemnej informacji o dokonanych uzgodnieniach, tymczasowo aresztowanego nie transportuje się.
...
§ 93. 1. Po zakończeniu czynności procesowych z udziałem osadzonego ustala się, czy ma on powrócić do jednostki penitencjarnej, w której uprzednio przebywał, czy też odstępuje się od przetransportowania lub kieruje się osadzonego do innej właściwej jednostki penitencjarnej.
...
§ 94. Skazany, ukarany oraz tymczasowo aresztowany, wobec którego stosuje się przepisy o wykonywaniu kary pozbawienia wolności, może być wydawany do udziału w czynnościach procesowych z zakładu karnego, w którym przebywa.
Jeżeli w trakcie takiej czynności procesowej zastosowano wobec osadzonego tymczasowe aresztowanie w kolejnej sprawie, doprowadza się go do zakładu karnego, z którego został wydany; przepis § 18 stosuje się.
§ 95. Wydawanie i przyjmowanie osadzonych w związku z udziałem w czynnościach procesowych dokonywanych poza terenem jednostki penitencjarnej odbywa się każdego dnia przez całą dobę, z zachowaniem zasad bezpieczeństwa tej jednostki.
§ 96. 1. W razie zwolnienia osadzonego po dokonaniu czynności procesowej, organ doprowadzający, któremu został on wydany, doręczając do jednostki penitencjarnej odpis postanowienia o uchyleniu tymczasowego aresztowania albo odpis postanowienia o uchyleniu aresztowania wykonywanego w związku z wymierzeniem kary porządkowej, wraz z nakazem zwolnienia, przekazuje informację dotyczącą miejsca i czasu zwolnienia, jeżeli nie zawiera jej nakaz zwolnienia.
...
§ 111. 1. Zwolnienie skazanego lub ukaranego ze sprawy następuje na skutek wykonania w całości kary lub środka przymusu.
...
1) czynności związane ze zwolnieniem osadzonego należy realizować z uwzględnieniem terminu końca kary lub środka przymusu albo terminu stosowania tymczasowego aresztowania, określonych datą kalendarzową, godziną i minutą;
jeżeli sąd w postanowieniu o tymczasowym aresztowaniu określił jedynie datę kalendarzową, a nie określił godziny i minuty, zwolnienie następuje nie później niż o godzinie i minucie odpowiadającej godzinie i minucie rozpoczęcia nieprzerwanego pozbawienia wolności, w związku z przyjęciem osadzonego;
...
§ 113. Zwolnienie z jednostki penitencjarnej osoby osadzonej w kilku sprawach, może nastąpić wyłącznie w przypadku, gdy w każdej z tych spraw istnieją podstawy zwolnienia.
§ 114. Poszczególne służby potwierdzają przygotowanie osadzonego do zwolnienia.
§ 115. 1. Przed zwolnieniem osadzonego z jednostki penitencjarnej kierownik:
1) sprawdza:
...
§ 120. 1. O każdym cudzoziemcu skazanym wyrokiem na podlegającą wykonaniu karę pozbawienia wolności, któremu pozostał do odbycia co najmniej 1 rok pozbawienia wolności, dyrektor zawiadamia wojewodę oraz komendanta oddziału Straży Granicznej, właściwych miejscowo dla jednostki penitencjarnej.
...
§ 121. W przypadku, gdy w stosunku do osadzonego podjęto decyzję o przekazaniu go za granicę, w dniu zwolnienia wydaje się go organowi doprowadzającemu na podstawie, odpowiednio, nakazu wydania albo pisemnego upoważnienia kierownika jednostki organizacyjnej tego organu.
§ 122. Dokumenty osobiste osadzonego zwalnianego z jednostki penitencjarnej, który jest wydany w związku z jego przejęciem, przekazuje się organowi doprowadzającemu za pokwitowaniem na obwolucie akt ewidencyjnych.
§ 123. Jeżeli skazanego uznano za osobę stwarzającą zagrożenie, w trybie przepisów ustawy z dnia 22 listopada 2013 r.
o postępowaniu wobec osób z zaburzeniami psychicznymi stwarzających zagrożenie życia, zdrowia lub wolności seksualnej innych osób, a dyrektor otrzymał odpis prawomocnego postanowienia sądu o umieszczeniu osoby stwarzającej zagrożenie w KOZZD wraz z poleceniem doprowadzenia, w dniu zwolnienia z jednostki penitencjarnej przenosi się go do tego ośrodka.
§ 124. Jeżeli wpłynie pisemna informacja sądu lub prokuratora, że Europejski Trybunał Praw Człowieka zastosował wobec skazanego środek tymczasowy, dyrektor zawiadamia właściwe komórki organizacyjne w Ministerstwie Sprawiedliwości oraz Prokuraturze Krajowej o wszczęciu wobec tego skazanego postępowania przed sądem penitencjarnym w sprawie o warunkowe zwolnienie, udzielenie przerwy w wykonaniu kary albo zezwolenia na odbycie kary pozbawienia wolności w systemie dozoru elektronicznego.
§ 125. 1. Osadzonemu opuszczającemu jednostkę penitencjarną w związku z udzieloną przepustką wydaje się kartę tożsamości oraz wypełniony druk przepustki podpisany przez dyrektora.
...
§ 133. Dokumentację osadzonego zwolnionego, zmarłego lub skreślonego z ewidencji jednostki penitencjarnej przekazuje się do archiwum. Przekazanie następuje po odnotowaniu faktu zwolnienia, zgonu lub skreślenia z ewidencji w Centralnej Bazie.
§ 134. 1. Początek przerwy w wykonaniu kary liczy się od daty zwolnienia skazanego lub ukaranego z jednostki penitencjarnej. Jeżeli sąd penitencjarny w postanowieniu nie określił terminu zgłoszenia się osadzonego, termin ten ustala się na dzień następujący po dacie, do której przerwa została udzielona.
...
§ 135. 1. Jeżeli w czasie przerwy w wykonaniu kary wpłynie wyrok łączny obejmujący wszystkie lub niektóre z kar wykonywanych przed zwolnieniem na przerwę w wykonaniu kary:
