...
- **6)** 2,5% Produktu Krajowego Brutto – w roku 2030 i latach kolejnych. ” , po ust. 1 dodaje się ust. 1a w brzmieniu: „
    - **b)**
...
- **4)** w art. 11 w ust. 3: pkt 4 otrzymuje brzmienie: „
    - **a)**

- **4)** przychody, o których mowa w art. 61 ust. 2 ustawy wymienionej w pkt 2; ” , pkt 7 otrzymuje brzmienie: „
    - **b)**

- **7)** odszkodowania lub kary umowne otrzymane w toku realizacji umów, dla których źródłem finansowania są wydatki budżetowe w części budżetu państwa „obrona narodowa”, dotyczących: zakupu uzbrojenia i sprzętu wojskowego, usług związanych z modernizacją, modyfikacją, naprawą lub remontem uzbrojenia i sprzętu wojskowego, badań naukowych i prac rozwojowych w zakresie uzbrojenia i sprzętu wojskowego; ” , w pkt 8 kropkę zastępuje się średnikiem i dodaje się pkt 9 w brzmieniu: „
    - **a)**
    - **b)**
    - **c)**
    - **c)**
...
- **6)** w art. 12b: ust. 2 otrzymuje brzmienie: „
    - **a)**

2. Wysokość jednorazowej zaliczki nie może przekraczać 33% wartości wynagrodzenia wykonawcy za dane zamówienie. ” , ust. 6 otrzymuje brzmienie: „
