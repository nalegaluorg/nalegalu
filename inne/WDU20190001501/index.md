...
Tabela nr 1 Rodzaj informacji Zanieczyszczenia Szereg czasowy Terminy przekazywania informacji Całkowite krajowe emisje z podziałem na kategorie źródeł według NFR – SO , NO , NMLZO, NH , CO – metale ciężkie (Cd, Hg, Pb) – TZO (ogółem WWA benzo(a)piren, benzo(b)fluoranten, benzo(k)fluoranten, indeno (1,2,3-cd)piren, dioksyny/furany, PCB , HCB Raz w roku, z uwzględnieniem 15 lutego.
danych od 1990 r. do roku Jeżeli informacje zawierały sprawozdawczego minus 2 błędy, ponowne przekaza(X − 2) nie informacji, wraz z wyjaśnieniem wprowadzonych zmian, następuje najpóźniej w ciągu 4 tygodni od dnia 15 lutego.
) Całkowite krajowe emisje z podziałem na kategorie źródeł według NFR – PM , PM Raz w roku, z uwzględnieniem 15 lutego.
– sadza, jeżeli dane są danych od 2000 r. do roku Jeżeli informacje zawierały dostępne sprawozdawczego minus 2 błędy, ponowne przekaza(X − 2) nie informacji, wraz z wyjaśnieniem wprowadzonych zmian, następuje najpóźniej w ciągu 4 tygodni od dnia 15 lutego.
...
Tabela nr 2 Rodzaj informacji Zanieczyszczenia Szereg czasowy Termin przekazywania informacji Całkowite krajowe emisje z podziałem na kategorie źródeł według NFR – metale ciężkie (As, Cr, Cu, Ni, Se i Zn oraz ich związki) – TSP Raz w roku, począwszy od 1990 r. 15 lutego (2000 r. dla TSP) do roku sprawozdawczego minus 2 (X − 2) Objaśnienia: Informacje o emisjach ze źródeł naturalnych są sprawozdawane zgodnie z metodami ustanowionymi w Konwencji LRTAP oraz z przewodnikiem EMEP/EEA dotyczącym bilansu emisji zanieczyszczeń powietrza. Nie są włączane do krajowych wartości całkowitych i są zgłaszane oddzielnie.
...
Tabela nr 3 Rodzaj informacji Zanieczyszczenia Szereg czasowy Terminy przekazywania informacji Krajowe dane w postaci – SO siatki dotyczące emisji z podziałem na kategorie źródeł (GNFR) , NO NMLZO, CO, NH , PM , PM Co 4 lata dla roku spra- 1 maja.
wozdawczego minus 2 Jeżeli informacje zawierały błę– metale ciężkie (Cd, Hg, (X – 2), począwszy od dy, ponowne przekazanie inforPb) 2017 r. macji, wraz z wyjaśnieniem – TZO (ogółem WWA, wprowadzonych zmian, następuje HCB, PCB, dioksy- najpóźniej w ciągu 4 tygodni od ny/furany) dnia 1 maja.
– sadza, jeżeli dane są dostępne Duże źródła punktowe – SO według kategorii źródła (GNFR) , NO , NMLZO, CO, NH , PM , PM Co 4 lata dla roku spra- 1 maja.
wozdawczego minus 2 – metale ciężkie (Cd, Hg, (X – 2), począwszy od Pb) 2017 r.
– TZO (ogółem WWA, HCB, PCB, dioksyny/furany) – sadza, jeżeli dane są dostępne Jeżeli informacje zawierały błędy, ponowne przekazanie informacji, wraz z wyjaśnieniem wprowadzonych zmian, następuje najpóźniej w ciągu 4 tygodni od dnia 1 maja.
Prognozowane emisje – SO według zagregowanych kategorii NFR , NO , NH , NMLZO, PM Co 2 lata, począwszy od 15 marca 2017 r., w odniesieniu – sadza, jeżeli dane są do lat, których dotyczą dostępne prognozy, czyli 2020 r., 2025 r., 2030 r. oraz, jeżeli dane są dostępne – 2040 r. i 2050 r.
...
Tabela nr 4 Rodzaj informacji Zanieczyszczenia Szereg czasowy Termin przekazywania informacji Raport metodyczny IIR – SO , NO , NMLZO, NH , CO, PM , PM Wszystkie lata (jak podano w 15 marca części 1 ust. 6, części 2 ust. 4) – metale ciężkie (Cd, Hg, Pb) i sadza – TZO (ogółem WWA, benzo(a)piren, benzo(b)fluoranten, benzo(k)fluoranten, indeno (1,2,3-cd)piren, dioksyny/furany, HCB, PCB, HCB) – metale ciężkie (As, Cr, Cu, Ni, Se i Zn oraz ich związki) i TSP, jeżeli dane są dostępne
...
KRAJOWE ZOBOWIĄZANIA W ZAKRESIE REDUKCJI EMISJI SUBSTANCJI Zobowiązania w zakresie redukcji emisji substancji w porównaniu Nazwa substancji z 2005 r.
...
Przez pył drobny (PM ) rozumie się cząstki o średnicy aerodynamicznej wynoszącej nie więcej niż 2,5 mikrometra (µm).
