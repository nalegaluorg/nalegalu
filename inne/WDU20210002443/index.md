...
a) finansowanie, o którym mowa w art. 26ha ust. 2–5 ustawy, z wyjątkiem wydatków: – poniesionych przez podatnika będącego założycielem uczelni niepublicznej – w przypadku finansowania, o którym mowa w art. 26ha ust. 5 ustawy, – które nie zostały poniesione na podstawie umowy zawartej przez podatnika z uczelnią – w przypadku finansowania, o którym mowa w art. 26ha ust. 5 pkt 3–5 ustawy,
...
d) nabycie udziałów (akcji) w alternatywnej spółce inwestycyjnej, jeżeli podatnik będzie posiadał te udziały (akcje) nieprzerwanie przez okres dwóch lat od dnia ich nabycia – jeżeli nie zostały podatnikowi zwrócone w jakiejkolwiek formie.
