...
# RZECZYPOSPOLITEJ POLSKIEJ Poz. 2390 ROZPORZĄDZENIE MINISTRA INFRASTRUKTURY z dnia 29 listopada 2019 r.
...
w sprawie szczegółowych czynności diagnostów związanych z odczytem wskazania drogomierza oraz wysokości opłaty z tym związanej Na podstawie art. 81b ust. 9 ustawy z dnia 20 czerwca 1997 r. – Prawo o ruchu drogowym (Dz. U. z 2018 r. poz. 1990, z późn. zm. ) zarządza się, co następuje:
...
- **8)** numer, którego struktura powinna mieć następującą budowę:
    - **a)** L /XXXXX /XXX/YYY/P /XXXX – dla podstawowej stacji kontroli pojazdów,
    - **b)** L /XXXXX /XXX/YYY /XXXX – dla okręgowej stacji kontroli pojazdów ‒ gdzie: L – oznacza, że dokument dotyczy drogomierza, pięcioznakowy numer odczytu zaczynający się z prawej strony, np. 00001, kod rozpoznawczy stacji kontroli pojazdów: XXX – właściwy wyróżnik województwa i powiatu oznaczony według przepisów dotyczących rejestracji i oznaczania pojazdów (dwie lub odpowiednio trzy litery), YYY – numer kolejny stacji kontroli pojazdów, P – stały element kodu rozpoznawczego podstawowych stacji kontroli pojazdów, czterocyfrowe pełne oznakowanie roku.

**§ 8.** Rozporządzenie wchodzi w życie z dniem 1 stycznia 2020 r. Minister Infrastruktury: wz. R. Weber
