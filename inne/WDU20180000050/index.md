...
- **2)** po art. 10 dodaje się art. 10a w brzmieniu: „Art. 10a. 1. Na gruntach położonych w pasie drogi granicznej można wykonywać urządzenia lub budowle służące zapobieganiu lub zwalczaniu chorób zakaźnych zwierząt.
...
- **5)** w art. 29a po ust. 2 dodaje się ust. 2a–2c w brzmieniu: „2a. Wydzierżawiający może wypowiedzieć umowę dzierżawy bez zachowania terminów wypowiedzenia:
...
- **3)** w art. 47a w ust. 3 pkt 1 i 2 otrzymują brzmienie: „1) myśliwemu wykonującemu odstrzał sanitarny zwierząt – w wysokości 80% ryczałtu;
