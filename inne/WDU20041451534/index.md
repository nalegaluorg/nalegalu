...
- **5)** w art. 32:
    - **a)** w ust. 1 pkt 4 otrzymuje brzmienie:
      ...
      > a) imiona i nazwisko, b) datę urodzenia, c) adres zamieszkania, d) nazwę, serię i numer dokumentu tożsamości, e) nr PESEL,”,  
    - **b)** po ust. 1 dodaje się ust. 1a w brzmieniu:
      ...
      > 1) imiona i nazwisko, 2) datę urodzenia, 3) adres zamieszkania, 4) rodzaj, serię i numer dokumentu tożsamości, 5) nr PESEL.”,  
...
- **7)** art. 36 otrzymuje brzmienie:
  ...
  > 1) w przypadkach, o których mowa w ust. 1 pkt 3 i w art. 36a ust. 2, 2) w razie braku możliwości ustalenia likwidatora, o którym mowa w ust. 4.  
