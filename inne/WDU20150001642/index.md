...
2. Rada Ministrów określi, drodze rozporządzenia, szczegółowy przebieg zewnętrznej granicy strefy przyległej formie tekstowej i graficznej zgodnie z państwowym systemem odniesień przestrzennych, z uwzględnieniem zasad określonych Konwencji, o której mowa art. 5 ust. 2.

**Art. 13b.** W strefie przyległej Rzeczpospolita Polska ma prawo do:

**Art. 27r.**

1. Właściwy terytorialnie dyrektor urzędu morskiego wydaje, drodze decyzji, pozwolenie na czasowe zajęcie morskich wód wewnętrznych lub morza terytorialnego celu zrealizowania przedsięwzięć związanych z wykonywaniem infrastruktury transportowej, energetycznej lub służącej do uprawiania rekreacji, turystyki lub sportów wodnych.
...
- **18)** art. 35a po ust. 3 dodaje się ust. 3a brzmieniu: „3a. W przypadku gdy podczas przeszukania wraku statku lub jego pozostałości zostaną wykryte materiały mogące zagrażać bezpieczeństwu osób lub środowisku, szczególności: amunicja, torpedy lub miny, podmiot, który uzyskał pozwolenie, o którym mowa ust. 1, jest obowiązany niezwłocznie poinformować o tym właściwego terytorialnie dyrektora urzędu morskiego i przekazać opis wykrytego niebezpieczeństwa oraz dane umożliwiające jego lokalizację i identyfikację.”;
- **19)** art. 36 ust. 1 otrzymuje brzmienie: „1. Pasem nadbrzeżnym jest obszar lądowy przyległy do linii brzegu morskiego.”;
- **20)** art. 37:
    - **a)** ust. 1 otrzymuje brzmienie: „1. Pas techniczny może być wykorzystywany do innego celu niż określony art. 36 ust. 2 pkt 1, za zgodą właściwego terytorialnie dyrektora urzędu morskiego, wydaną drodze decyzji, która jednocześnie określa warunki takiego wykorzystania.”,
    - **b)** po ust. 1 dodaje się ust. 1a–1d brzmieniu: „1a. W celu zapewnienia bezpieczeństwa brzegu morskiego pasie technicznym określa się minimalne poziomy bezpieczeństwa brzegu morskiego oraz położenie granicznej linii ochrony niezbędnej dla utrzymania brzegu.

1b. Minimalny poziom bezpieczeństwa brzegu morskiego pasie technicznym określa się przez prawdopodobieństwo zdarzenia sztormu na tym obszarze.
...
3. Funkcje podstawowe oznaczają wiodące przeznaczenia obszaru wydzielonego planie, o którym mowa ust. 1, którego pozostałe dopuszczalne funkcje nie mogą zakłócać. Dopuszczalne funkcje obszaru oznaczają możliwe sposoby wykorzystania obszaru, których współistnienie nie wpłynie negatywnie na zrównoważony rozwój obszaru.

4. Plany zagospodarowania przestrzennego morskich wód wewnętrznych, morza terytorialnego i wyłącznej strefy ekonomicznej mogą zawierać ustalenia informacyjne zakresie przewidywanego rozmieszczenia inwestycji celu publicznego, inne niż określone ust. 2.

5. Organami właściwymi sprawie morskiego planowania przestrzennego jest odpowiednio minister właściwy do spraw gospodarki morskiej i dyrektor urzędu morskiego.

6. Minister właściwy do spraw gospodarki morskiej przekazuje Komisji Europejskiej i odpowiednim państwom członkowskim kopie oraz wszelkie kolejne zmiany planów terminie trzech miesięcy od dnia ich ogłoszenia.”;
...
- **1)** wsparcie zrównoważonego rozwoju sektorze morskim z uwzględnieniem aspektów gospodarczych, społecznych i środowiskowych, tym poprawy stanu środowiska i odporności na zmiany klimatu;
- **2)** obronność i bezpieczeństwo państwa;
- **3)** koordynację działań odpowiednich podmiotów i sposobów wykorzystania morza.”,
    - **b)** po ust. 1 dodaje się ust. 1a brzmieniu: „1a. Podejście ekosystemowe, o którym mowa ust. 1, oznacza, że zarządzaniu działalnością człowieka spełnione zostaną łącznie następujące warunki:
...
- **1)** podaje do publicznej wiadomości, poprzez ogłoszenie prasie ogólnopolskiej, wywieszenie na tablicy ogłoszeń i zamieszczenie Biuletynie Informacji Publicznej na stronie podmiotowej urzędu obsługującego tego dyrektora, informacje o:
...
- **3)** rozpatruje uwagi i wnioski, o których mowa pkt 1 lit. b, rozstrzyga o sposobie ich uwzględnienia projekcie planu i sporządza wykaz uwag i wniosków złożonych do projektu planu, którym umieszcza uwagi i wnioski, wraz ze złożonym opisem przedsięwzięcia, o którym mowa art. 37f ust. 3, a także ogólne uzasadnienie dotyczące sposobu uwzględnienia wniosków do projektu planu;
- **4)** wykłada wykaz, o którym mowa pkt 3, do publicznego wglądu i udostępnia Biuletynie Informacji Publicznej na stronie podmiotowej urzędu obsługującego tego dyrektora, do dnia zakończenia wyłożenia projektu planu, o którym mowa pkt 10, oraz podaje informacje o tym do publicznej wiadomości, wskazując miejsce jego wyłożenia;
...
1. W odniesieniu do uwag i wniosków, o których mowa art. 37e ust. 1 pkt 9, właściwy terytorialnie dyrektor urzędu morskiego sporządza każdorazowo uzasadnienie sposobu ich rozpatrzenia.
...
3. W przypadku wniosku, o którym mowa art. 37e ust. 1 pkt 1 lit. b, dotyczącego uwzględnienia planie przedsięwzięcia należącego do przedsięwzięć mogących zawsze znacząco lub potencjalnie znacząco oddziaływać na środowisko do wniosku dołącza się opis przedsięwzięcia zawierający dane, o których mowa art. 3 ust. 1 pkt 5 ustawy z dnia 3 października 2008 r. o udostępnianiu informacji o środowisku i jego ochronie, udziale społeczeństwa ochronie środowiska oraz o ocenach oddziaływania na środowisko.

**Art. 37g.**

1. Organy, o których mowa art. 37e ust. 1, zakresie swojej właściwości rzeczowej i miejscowej są obowiązane do współpracy przy sporządzaniu planu, polegającej na wyrażaniu opinii, składaniu wniosków oraz udostępnianiu informacji.

2. Koszty związane ze współpracą, o której mowa ust. 1, obciążają organy współpracujące.

3. Organy, o których mowa art. 37e ust. 1 pkt 7, 8, 13, dokonują uzgodnień albo przedstawiają opinie terminie nie dłuższym niż 45 dni od dnia udostępnienia projektu planu.

4. Dyrektor urzędu morskiego może uznać za uzgodniony projekt planu przypadku, którym organy, o których mowa art. 37e ust. 1 pkt 7, 8, 13, nie określą warunków, na jakich uzgodnienie może nastąpić.

5. Nieprzedstawienie stanowiska lub warunków, o których mowa ust. 4, terminie, o którym mowa ust. 3, uważa się za równoznaczne odpowiednio z uzgodnieniem lub zaopiniowaniem projektu planu.

**Art. 37h.** Dyrektor urzędu morskiego, podejmując rozstrzygnięcia, o których mowa art. 37e ust. 1 pkt 3, 6 i 11, ma na względzie:

**Art. 37i.**

1. Plan podlega okresowej ocenie, co najmniej raz na 10 lat.

2. W celu oceny aktualności planów właściwy terytorialnie dyrektor urzędu morskiego występuje do organów, o których mowa art. 37e ust. 1 pkt 7 i 8, o przekazanie informacji dotyczących zmian zagospodarowaniu przestrzennym obszaru objętego planem oraz dokonuje analizy zmian na tym obszarze, z uwzględnieniem wydanych pozwoleń, o których mowa art. 23 ust. 1 i art. 26 ust. 1, oraz uzgodnienia, o którym mowa art. 27 ust. 1.
...
1. Minister właściwy do spraw gospodarki morskiej prowadzi współpracę transgraniczną zakresie planowania i zagospodarowania przestrzennego morskich wód wewnętrznych, morza terytorialnego i wyłącznej strefy ekonomicznej oraz wymianę transgraniczną zakresie danych przestrzennych niezbędnych procesie planowania przestrzennego obszarów morskich.
...
1. Zadania państwa związane z prowadzeniem, koordynowaniem i nadzorowaniem prac zakresie hydrografii i kartografii morskiej, publikacji nautycznych i informacji nautycznej wykonuje Państwowa Morska Służba Hydrograficzna, zwana dalej „służbą hydrograficzną”.
...
- **2)** prowadzenie i koordynowanie prac geodezyjnych na polskich obszarach morskich oraz pasie nadbrzeżnym, portach i przystaniach morskich dla potrzeb bezpieczeństwa żeglugi i kartografii morskiej;
...
- **6)** reprezentowanie Rzeczypospolitej Polskiej Międzynarodowej Organizacji Hydrograficznej;
...
- **9)** przekazywanie nieodpłatnie Głównemu Geodecie Kraju danych batymetrycznych oraz danych dotyczących linii brzegowej celu wykonywania zadań przewidzianych ustawie z dnia 4 marca 2010 r. o infrastrukturze informacji przestrzennej (Dz. U. Nr 76, poz. 489 oraz z 2012 r. poz. 951);
...
2. Biuro Hydrograficzne Marynarki Wojennej celu realizacji zadań, o których mowa ust. 1 pkt 7 i 8, zawiera porozumienia określające formę i zakres przekazywanych danych oraz ilość i rodzaje map i publikacji nautycznych.
...
3. Dyplomy, o których mowa ust. 2, wydaje Szef Biura Hydrograficznego Marynarki Wojennej.
...
- **11b)** nadzoru nad zapewnieniem ochrony przed powodzią od strony wód morskich tym poprzez budowę, rozbudowę i utrzymywanie budowli hydrotechnicznych oraz umocnień brzegowych pasie technicznym;”,
...
- **27)** art. 45 po ust. 2 dodaje się ust. 2a i 2b brzmieniu: „2a. Morski port wojenny obejmuje obszar portu morskiego lub te jego części, które są przeznaczone do wykorzystywania przez Siły Zbrojne Rzeczypospolitej Polskiej oraz przez nie zarządzane i utrzymywane.
...
- **4)** podmiotów wykonujących zadania związane z ochroną przeciwpożarową portach.

3. Inspekcje i kontrole, o których mowa ust. 2, na podstawie upoważnienia dyrektora urzędu morskiego, przeprowadza inspektor ochrony przeciwpożarowej, zwany dalej „inspektorem”.

4. Inspektorem może być osoba, która posiada kwalifikacje, doświadczenie oraz wiedzę zakresie ochrony przeciwpożarowej.

5. Inspektor jest uprawniony do wstępu do wszystkich obiektów zlokalizowanych porcie oraz na wszystkie statki znajdujące się polskich obszarach morskich, za okazaniem dokumentu identyfikacyjnego.

6. W ramach wykonywanych czynności służbowych inspektor jest uprawniony do wydawania doraźnych poleceń zakresie posiadanego upoważnienia podmiotom poddanym kontroli lub inspekcji.

7. Z przeprowadzonych inspekcji i kontroli inspektor sporządza protokół zawierający szczególności opis stwierdzonego wyniku kontroli lub inspekcji stanu faktycznego, tym ujawnionych nieprawidłowości, wraz z określeniem terminu ich usunięcia.

8. Podmioty zarządzające portem, przystanią, terminalem lub stocznią remontową zakresie ochrony przeciwpożarowej, oprócz obowiązków wynikających z przepisów o ochronie przeciwpożarowej, są obowiązane do:

- **1)** sporządzania, zgodnie z przepisami o zapobieganiu zanieczyszczaniu morza przez statki, planów zwalczania zagrożeń i zanieczyszczeń wód portowych oraz, zależności od prowadzonej działalności, instrukcji technologicznych i technologiczno-ruchowych oraz instrukcji bezpiecznej obsługi statku oraz ich uzgadniania;
...
- **33)** art. 55:
    ...
    - **b)** ust. 2 otrzymuje brzmienie: „2. Tej samej karze podlega, kto wznosi lub wykorzystuje sztuczne wyspy, konstrukcje, urządzenia albo układa lub utrzymuje kable lub rurociągi bez uzyskania pozwolenia, o którym mowa odpowiednio art. 23 ust. 1 i art. 26 ust. 1, albo uzgodnienia, o którym mowa art. 27 ust. 1, albo niezgodnie z warunkami określonymi tych decyzjach.”;

- **34)** art. 56:
    - **a)** uchyla się pkt 3,
    - **b)** po pkt 9 dodaje się pkt 9a brzmieniu: „9a) wykorzystuje pas techniczny do innego celu niż utrzymanie brzegu stanie zgodnym z wymogami bezpieczeństwa i ochrony środowiska bez zgody dyrektora urzędu morskiego albo wykorzystuje pas techniczny niezgodnie z warunkami określonymi przez dyrektora urzędu morskiego,”,
    - **c)** po pkt 17 dodaje się pkt 17a brzmieniu: „17a) utrudnia lub uniemożliwia przeprowadzenie inspekcji, o której mowa art. 50 ust. 1,”,
    - **d)** część wspólna otrzymuje brzmienie: „– podlega karze pieniężnej do wysokości nieprzekraczającej dwudziestokrotnego przeciętnego miesięcznego wynagrodzenia gospodarce narodowej za rok poprzedzający, ogłaszanego przez Prezesa Głównego Urzędu Statystycznego.”;
...
1. Do wszczętych i niezakończonych decyzją ostateczną postępowań sprawach o wydanie pozwolenia, o którym mowa art. 26 ust. 1, i uzgodnienia, o którym mowa art. 27 ust. 1 ustawy zmienianej art. 1, brzmieniu dotychczasowym, stosuje się przepisy dotychczasowe.

2. Pozwolenie, o którym mowa art. 23 ust. 1 ustawy zmienianej art. 1, brzmieniu dotychczasowym, wydane dla morskich farm wiatrowych od dnia 30 lipca 2011 r. do dnia wejścia życie niniejszej ustawy ulegają przedłużeniu na okres 35 lat, liczony od dnia wydania pozwolenia.

3. Do wszczętych i niezakończonych decyzją ostateczną postępowań administracyjnych sprawach o wymierzenie kary pieniężnej stosuje się przepisy dotychczasowe.

4. Do wszczętych i niezakończonych decyzją ostateczną postępowań sprawie o wydanie pozwolenia, o którym mowa art. 23 ust. 1b pkt 2 lit. b ustawy zmienianej art. 1 brzmieniu dotychczasowym dotyczących przedsięwzięć niewymagających pozwolenia na budowę, stosuje się przepisy dotychczasowe.

**Art. 13.** Dotychczasowe przepisy wykonawcze wydane na podstawie art. 3 ust. 2 i art. 37b ust. 4 ustawy zmienianej art. 1 zachowują moc do dnia wejścia życie przepisów wykonawczych wydanych na podstawie art. 3 ust. 2 i art. 37b ust. 4 ustawy zmienianej art. 1, brzmieniu nadanym niniejszą ustawą, nie dłużej jednak niż przez 18 miesięcy od dnia wejścia życie niniejszej ustawy.

**Art. 14.** Ustawa wchodzi życie po upływie 30 dni od dnia ogłoszenia. Prezydent Rzeczypospolitej Polskiej: A. Duda
