...
1. Jeżeli sprzedawca pobiera rażąco wysoką cenę, Minister do Spraw Cen może wydać decyzję nakładającą na niego obowiązek obniżenia ceny lub stosowania na czas określony, nie dłuższy niż rok, ceny regulowanej na inne towary lub inne usługi niż ustalone na podstawie art. 7.
...
- **3)** w art. 11: w ust. 4 wyraz „ustalaniu” zastępuje się wyrazem „uzgadnianiu”, ust. 5 otrzymuje brzmienie: „
    - **a)**
    - **b)**
...
- **4)** w art. 13: w ust. 1: – w pkt 2 po wyrazie „poza” dodaje się wyrazy „określonymi przez nią”, – pkt 3 skreśla się, ust. 2 otrzymuje brzmienie: „
    - **a)**
    - **b)**
...
- **3)** określić zasady stosowania cen skupu, zbytu, hurtowych i detalicznych odpowiednio do szczebli obrotu towarowego. ” , dodaje się ust. 3 w brzmieniu: „
    - **c)**
...
- **5)** w art. 14: w ust. 1 powołanie ust. 2 zastępuje się powołaniem ust. 1a, 2 i 3, po ust. 1 dodaje się ust. 1a w brzmieniu: „
    - **a)**
    - **b)**

1a. Marże urzędowe są marżami maksymalnymi. ” , ust. 3 otrzymuje brzmienie: „
...
- **2)** marże wynikowe, stanowiące różnicę między ceną dla producenta a ceną pobieraną przez jednostkę handlową. ” , po ust. 3 dodaje się ust. 3a w brzmieniu: „
    - **d)**
...
- **3)** umówienia się o cenę właściwą dla usługi z terminem wykonania przyspieszonym (usługa ekspresowa), a wykonania jej w terminie zwykłym. ” , w ust. 2 wyrazy „jakości towaru lub usługi” zastępuje się wyrazami „jakości, ilości, masie i objętości towaru oraz jakości, zupełności i terminowi wykonania usługi”;
    - **b)**
...
- **8)** w art. 19: w ust. 1 powołanie art. 13 ust. 1 zastępuje się powołaniem art. 13, ust. 2 otrzymuje brzmienie: „
    - **a)**
    - **b)**

2. Jeżeli nienależna kwota nie zostanie zwrócona nabywcy, a okoliczność tę stwierdzi organ przeprowadzający kontrolę cen, sprzedawca jest obowiązany, niezależnie od zobowiązania wobec nabywcy, wpłacić do budżetu państwa kwotę dodatkową w wysokości 150% kwoty nienależnej. Obowiązek ten ciąży na sprzedawcy również wtedy, gdy zwrócił on nabywcy kwotę nienależną po rozpoczęciu kontroli. ” , po ust. 3 dodaje się ust. 3a w brzmieniu: „

- **c)**

3a. Inwestor będący jednostką gospodarki uspołecznionej przekazuje w całości do budżetu państwa otrzymaną od wykonawcy obiektów budowlanych i robót budowlanych kwotę nienależną. ” , po ust. 7 dodaje się ust. 7a w brzmieniu: „
...
- **9)** w art. 23: w ust. 1 pkt 1 otrzymuje brzmienie: „
    - **a)**

- **1)** opłat za najem lokali, opłat taryfowych za usługi pocztowe i telekomunikacyjne oraz innych opłat ustalanych na podstawie odrębnych ustaw ” , w ust. 3 pkt 3 otrzymuje brzmienie: „
    - **b)**
...
1. Jednostki gospodarcze uiszczają podatek od ponadnormatywnych wypłat wynagrodzeń, obciążający ich zysk do podziału.
...
3. Minister Pracy, Płac i Spraw Socjalnych, w wypadkach uzasadnionych potrzebą wzrostu zatrudnienia, może ustalać jako podstawę opodatkowania kwotę stanowiącą iloczyn przeciętnego zatrudnienia oraz nadwyżki przeciętnego wynagrodzenia ponad przeciętne wynagrodzenie wolne od podatku. Kwotę wolną od podatku, o której mowa w art. 29a ust. 2 pkt 1, ustala się jako sumę kwoty wolnej od podatku w roku poprzedzającym rok podatkowy oraz iloczynu tej kwoty i wyrażonego procentowo wzrostu lub spadku produkcji sprzedanej netto, skorygowanego współczynnikiem określającym możliwości wzrostu wynagrodzeń w stosunku do zmian wielkości produkcji. Rada Ministrów, w drodze rozporządzenia:

- **1)** ustala: wysokość współczynnika, o którym mowa w art. 29b, zasady ustalania wskaźnika, o którym mowa w art. 29a ust. 2 pkt 2, wysokość podatku według skali progresywnej od 40 do 500% w odniesieniu do opodatkowania wynagrodzeń wypłaconych w ciężar kosztów oraz od 100 do 400% w odniesieniu do opodatkowania wypłat nagród i premii, zasady pomniejszania podstawy opodatkowania z tytułu sprzedaży eksportowej oraz oszczędności w zużyciu surowców i materiałów,
    - **a)**
    - **b)**
    - **c)**
    - **d)**

- **2)** może dla niektórych jednostek gospodarczych w dostosowaniu do specyficznych warunków działania: wprowadzić inny niż produkcja sprzedana netto miernik o podobnym charakterze, ustalić inne niż określone w art. 29b zasady ustalania kwoty wolnej od podatku oraz stawki podatku dostosowane do tych zasad. Rada Ministrów może określać w centralnym planie rocznym zakres, warunki i wysokość dodatkowych kwot wolnych od podatku.
    - **a)**
    - **b)**

1. Minister Pracy, Płac i Spraw Socjalnych, w porozumieniu z Ministrem Finansów, w drodze rozporządzenia, określa:
...
1. Jednostki gospodarcze, w których kwota wypłaconych wynagrodzeń w ciężar kosztów w roku podatkowym jest niższa od kwoty wolnej od podatku, mogą utworzyć rezerwę na wynagrodzenia do wysokości tej różnicy, obciążając koszty działalności roku podatkowego.
...
3. Rada Ministrów, w drodze rozporządzenia, może określać jednostki gospodarcze przekazujące kwoty podatku na scentralizowane rachunki oraz zasady ich wykorzystywania. W 1986 r. jako kwotę wolną od podatku w roku poprzedzającym rok podatkowy, o której mowa w art. 29b, przyjmuje się kwotę określoną wskaźnikiem przyrostu wolnego od obciążeń na Państwowy Fundusz Aktywizacji Zawodowej w 1985 r. ” ;

- **6)** w art. 32: w ust. 4 w pkt 2 kropkę na końcu zastępuje się przecinkiem i dodaje się wyrazy „z tym, że od gruntów rolnych i leśnych zajętych na inne cele po dniu 1 stycznia 1986 r. – 15 zł od 1 m2 powierzchni.”; ust. 5 otrzymuje brzmienie: „
    - **a)**
    - **b)**

5. Rady narodowe stopnia podstawowego mogą obniżać stawki podatku od nieruchomości. ” ;

- **7)** w art. 33: w pkt 1 przecinek na końcu skreśla się i dodaje się wyrazy „oraz państwową jednostkę organizacyjną „Polska Poczta, Telegraf i Telefon”, po pkt 3 dodaje się pkt 3a w brzmieniu: „
    - **a)**
    - **b)**

- **3a)** jednostki organizacyjne zrzeszone w Krajowym Związku Rolników, Kółek i Organizacji Rolniczych, z wyjątkiem budynków, budowli i gruntów: przedsiębiorstw (zakładów) produkcji materiałów budowlanych i prefabrykatów, wojewódzkich spółdzielni budownictwa wiejskiego, wojewódzkich zakładów gospodarki materiałowej i zaopatrzenia. ” ; w pkt 7 lit. a) otrzymuje brzmienie: „ pozostaje we władaniu Naczelnej Rady Spółdzielczej, centralnych związków spółdzielczych i Centralnego Związku Rzemiosła, a stanowiące własność Państwa lub jednostek gospodarczych innych niż wymienione jednostki, ” ; w pkt 8 w lit. d) przecinek na końcu skreśla się i dodaje się wyrazy „oraz przez zarządy tych dróg,”; dodaje się pkt 12 w brzmieniu: „
    - **a)**
    - **b)**
    - **c)**
    - **c)**
...
- **8)** w art. 35: po ust. 1 dodaje się ust. 1a i 1b w brzmieniu: „
    - **a)**
...
1b. Kwota podatku dochodowego, o którym mowa w art. 1a, obciąża rozliczenie wyniku finansowego za rok obliczeniowy. ” , dodaje się ust. 4 w brzmieniu: „
...
1. Podatek dochodowy wynosi 65% podstawy opodatkowania.
...
1. Fundusz efektów wdrożeniowych tworzy przedsiębiorstwo:
...
2. Fundusz efektów wdrożeniowych przedsiębiorstwo przeznacza w szczególności na nagrody dla autorów (współautorów) wdrożonych nowych rozwiązań technicznych lub organizacyjnych i osób bezpośrednio współdziałających w realizacji pracy badawczej oraz we wdrożeniu wyniku pracy badawczej.
...
- **6)** w art. 10 w ust. 1 dodaje się zdanie w brzmieniu: „ Jeżeli na rachunku zakładowego funduszu socjalnego lub zakładowego funduszu mieszkaniowego przedsiębiorstwa wystąpi nadwyżka kosztów danej działalności nad funduszem, to z funduszu załogi w pierwszej kolejności uzupełnia się odpowiedni fundusz zakładowy do wysokości poniesionych kosztów. ” ;
- **7)** w art. 12 w ust. 2 w pkt 1 wyrazy „w tym również zasiłków chorobowych wypłacanych w czasie trwania stosunku pracy” skreśla się;
- **8)** art. 34 otrzymuje brzmienie: „

**Art. 34.**

1. Przedsiębiorstwo może samodzielnie przekazywać na finansowanie przedsięwzięć wspólnych środki obrotowe oraz środki funduszów, o których mowa w art. 7 i 26, innym przedsiębiorstwom, zrzeszeniom i jednostkom gospodarki uspołecznionej oraz ministrom koordynującym.
...
- **9)** po art. 34 dodaje się art. 34a i 34b w brzmieniu: „ Przedsiębiorstwa mogą udzielać innym jednostkom gospodarki uspołecznionej pożyczek. Warunki udzielenia pożyczki, w tym oprocentowanie i sposób spłaty, określa umowa.

1. Przedsiębiorstwo może gromadzić środki finansowe na cele rozwojowe i modernizację w drodze emisji obligacji. Dokonanie emisji obligacji wymaga zgody Ministra Finansów.
...
- **10)** w art. 41: w ust. 4 wyrazy „inwestycji rozpoczętych przed 1984 r.” zastępuje się wyrazami „inwestycji przedsiębiorstw rozpoczętych przed 1984 r. oraz inwestycji centralnych”, dodaje się ust. 8–10 w brzmieniu: „
    - **a)**
    - **b)**

8. Rada Ministrów, w drodze rozporządzenia, określa szczegółowe warunki korzystania przez przedsiębiorstwa z ulg we wpłatach części odpisów amortyzacyjnych do budżetu centralnego lub na scentralizowany rachunek amortyzacji, o których mowa w ust. 1 pkt 2.

9. W razie nieterminowego przekazania ustalonej części odpisów amortyzacyjnych na scentralizowany rachunek amortyzacji, o którym mowa w ust. 1 pkt 2, albo na scentralizowany fundusz rozwoju tworzony w myśl przepisów wydanych na podstawie art. 38 lub na inny fundusz scentralizowany tworzony na podstawie odrębnych przepisów, przedsiębiorstwo wpłaca na odpowiedni rachunek odsetki za zwłokę w wysokości odsetek pobieranych za nieterminowe regulowanie zobowiązań podatkowych.
