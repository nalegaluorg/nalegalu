...
- **2)** jednostka: organizacyjna służb podległych lub nadzorowanych przez ministra właściwego do spraw wewnętrznych, organizacyjna podległa lub nadzorowana przez Ministra Obrony Narodowej, ministra właściwego do spraw zdrowia, ministra właściwego do spraw nauki i szkolnictwa wyższego lub ministra właściwego do spraw transportu, ochrony przeciwpożarowej, systemu Państwowego Ratownictwa Medycznego.
    - **a)**
    - **b)**
    - **c)**
    - **d)**
