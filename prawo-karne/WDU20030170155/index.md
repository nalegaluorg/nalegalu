...
**Art. 1.** W ustawie z dnia 6 czerwca 1997 r. – Kodeks postępowania karnego (Dz. U. Nr 89, poz. 555, z 1999 r. Nr 83, poz. 931, z 2000 r. Nr 50, poz. 580, Nr 62, poz. 717, Nr 73, poz. 852 i Nr 93, poz. 1027, z 2001 r. Nr 98, poz. 1071 i Nr 106, poz. 1149 oraz z 2002 r. Nr 74, poz. 676) wprowadza się następujące zmiany:
...
- **13)** w art. 40 w § 1: w pkt 6 skreśla się wyrazy „w niższej instancji”, w pkt 7 skreśla się wyrazy „lub stwierdzono jego nieważność”, uchyla się pkt 8, w pkt 9 kropkę zastępuje się przecinkiem i dodaje się pkt 10 w brzmieniu: „
    - **a)**
    - **b)**
    - **c)**
    - **d)**
...
§ 1. W razie śmierci pokrzywdzonego prawa, które by mu przysługiwały, mogą wykonywać osoby najbliższe, a w wypadku ich braku lub nieujawnienia – prokurator, działając z urzędu.
...
- **21)** w art. 74: w § 2: – w pkt 1 wyrazy „w szczególności wolno” zastępuje się wyrazami „wolno także w szczególności”, – w pkt 2 po wyrazach „pobraniu krwi” dodaje się przecinek oraz wyraz „włosów”, § 3 otrzymuje brzmienie: „
    - **a)**
    - **b)**

§ 3. W stosunku do osoby podejrzanej można dokonać badań lub czynności, o których mowa w § 2 pkt 1, a także, przy zachowaniu wymagań określonych w § 2 pkt 2, pobrać krew, włosy lub wydzieliny organizmu. ” , § 4 otrzymuje brzmienie: „
...
- **22)** w art. 75: w § 2 wyrazy „można sprowadzić go przymusowo” zastępuje się wyrazami „można zatrzymać go i sprowadzić przymusowo”, dodaje się § 3 w brzmieniu: „
    - **a)**
    - **b)**
...
- **24)** w art. 79: w § 1 w pkt 3 na końcu przecinek zastępuje się kropką oraz uchyla się pkt 4, § 4 otrzymuje brzmienie: „
    - **a)**
    - **b)**
...
- **29)** w art. 88: § 2 otrzymuje brzmienie: „
    - **a)**

§ 2. Pełnomocnikiem instytucji państwowej, samorządowej lub społecznej może być również radca prawny. ” , w § 3 skreśla się wyraz „jej”;
...
- **36)** w art. 117: po § 2 dodaje się § 2a w brzmieniu: „
    - **a)**

§ 2a. Usprawiedliwienie nieobecności z powodu choroby wymaga przedstawienia zaświadczenia, wystawionego przez uprawnionego lekarza, potwierdzającego niemożność stawienia się na wezwanie lub zawiadomienie organu prowadzącego postępowanie. ” , § 4 otrzymuje brzmienie: „
...
§ 1. Wezwania, zawiadomienia oraz inne pisma, od których daty doręczenia biegną terminy, doręcza się przez pocztę lub inny uprawniony podmiot zajmujący się doręczaniem korespondencji albo pracownika organu wysyłającego, a w razie niezbędnej konieczności – przez Policję. ” , dodaje się § 3 w brzmieniu: „
...
- **42)** w art. 139: uchyla się § 2, § 3 otrzymuje brzmienie: „
    - **a)**
    - **b)**
...
- **49)** w art. 156: w § 1 po wyrazie „Stronom” dodaje się przecinek i wyrazy „podmiotowi określonemu w art. 416”, § 2 otrzymuje brzmienie: „
    - **a)**
    - **b)**

§ 2. Na wniosek oskarżonego lub jego obrońcy wydaje się odpłatnie kserokopie dokumentów z akt sprawy. Kserokopie takie można wydać odpłatnie, na wniosek, również innym stronom, podmiotowi określonemu w art. 416, pełnomocnikom i przedstawicielom ustawowym. ” , w § 3 po wyrazach „zarządzić wydanie” dodaje się wyraz „odpłatnie”, w § 5 wyrazy „wydaje odpisy uwierzytelnione” zastępuje się wyrazami „wydaje odpłatnie uwierzytelnione odpisy lub kserokopie”, dodaje się § 6 w brzmieniu: „
...
- **55)** w art. 176: uchyla się § 3, w § 4 skreśla się zdanie drugie;
    - **a)**
    - **b)**
...
- **69)** w art. 213: w § 1 po wyrazach „źródła dochodu” dodaje się wyrazy „oraz dane o jego karalności”, § 2 otrzymuje brzmienie: „
    - **a)**
    - **b)**
...
- **84)** w art. 246: w § 1 wyrazy „zasadności i legalności zatrzymania oraz prawidłowości jego wykonania” zastępuje się wyrazami „zasadności, legalności oraz prawidłowości jego zatrzymania”, § 4 otrzymuje brzmienie: „
    - **a)**
    - **b)**
...
- **85)** w art. 247: w § 1 wyrazy „Sąd lub prokurator” zastępuje się wyrazem „Prokurator”, w § 2 skreśla się przecinek oraz wyrazy „z tym że na zatrzymanie zarządzone przez sąd zażalenie nie przysługuje”;
    - **a)**
    - **b)**

- **86)** w art. 249: w § 3 dodaje się zdanie trzecie w brzmieniu: „ O terminie przesłuchania sąd zawiadamia prokuratora. ” , § 5 otrzymuje brzmienie: „
    - **a)**
    - **b)**
...
- **87)** w art. 254: w § 1 skreśla się zdanie drugie, § 2 otrzymuje brzmienie: „
    - **a)**
    - **b)**

§ 2. Na postanowienie w przedmiocie wniosku oskarżonemu zażalenie przysługuje tylko wtedy, gdy wniosek został złożony po upływie co najmniej 3 miesięcy od dnia wydania postanowienia w przedmiocie tymczasowego aresztowania dotyczącego tego samego oskarżonego. ” , dodaje się § 3 w brzmieniu: „
...
- **99)** w art. 285: w § 1 wyrazy „nieprzekraczającej najniższego miesięcznego wynagrodzenia” zastępuje się wyrazami „do 3 000 złotych”, § 2 otrzymuje brzmienie: „
    - **a)**
    - **b)**
...
- **104)** w art. 295: w § 1 skreśla się zdanie drugie, § 4 otrzymuje brzmienie: „
    - **a)**
    - **b)**
...
- **106)** w art. 297 w § 1: w pkt 4 po wyrazach „w tym ustalenie” dodaje się wyrazy „osób pokrzywdzonych i”, w pkt 5 po wyrazie „dowodów” dodaje się wyrazy „dla sądu”;
    - **a)**
    - **b)**
...
- **112)** w art. 305: w § 1 skreśla się wyrazy „lub dochodzenia”, uchyla się § 2, § 3 otrzymuje brzmienie: „
    - **a)**
    - **b)**
    - **c)**

§ 3. Jeżeli postanowienie o wszczęciu śledztwa wydaje Policja, niezwłocznie przesyła prokuratorowi jego odpis. Postanowienie o odmowie wszczęcia lub o umorzeniu śledztwa wydaje prokurator albo Policja; postanowienie wydane przez Policję zatwierdza prokurator. ” , w § 4 skreśla się wyrazy „lub dochodzenia”;

- **d)**
- **113)** w art. 306: w § 1 skreśla się wyrazy „lub dochodzenia”, w § 3 skreśla się wyrazy „lub dochodzenia”;
    - **a)**
    - **b)**

- **114)** w art. 307: w § 1 skreśla się wyrazy „lub dochodzenia”, uchyla się § 4, w § 5 skreśla się wyrazy „lub dochodzenia”;
    - **a)**
    - **b)**
    - **c)**
...
- **121)** w art. 313: § 1 otrzymuje brzmienie: „
    - **a)**

§ 1. Jeżeli dane istniejące w chwili wszczęcia śledztwa lub zebrane w jego toku uzasadniają dostatecznie podejrzenie, że czyn popełniła określona osoba, sporządza się postanowienie o przedstawieniu zarzutów, ogłasza je niezwłocznie podejrzanemu i przesłuchuje się go, chyba że ogłoszenie postanowienia lub przesłuchanie podejrzanego nie jest możliwe z powodu jego ukrywania się lub nieobecności w kraju. ” , w § 3 wyrazy „postępowania przygotowawczego” zastępuje się wyrazem „śledztwa”;
...
- **128)** w art. 321: § 1 otrzymuje brzmienie: „
    - **a)**

§ 1. Jeżeli istnieją podstawy do zamknięcia śledztwa, na wniosek podejrzanego lub jego obrońcy o końcowe zaznajomienie z materiałami postępowania, prowadzący postępowanie powiadamia podejrzanego i obrońcę o terminie końcowego zaznajomienia, pouczając ich o prawie uprzedniego przejrzenia akt w terminie odpowiednim do wagi lub zawiłości sprawy, określonym przez organ procesowy. ” , w § 3 skreśla się zdanie drugie, w § 4 skreśla się wyrazy „- poza wypadkami określonymi w art. 79 -”, w § 5 skreśla się wyrazy „lub dochodzenia”, w § 6 skreśla się wyrazy „lub dochodzenia”, a wyrazy „strony oraz ich pełnomocników i obrońców” zastępuje się wyrazami „podejrzanego oraz jego obrońcę”;

- **b)**
- **c)**
- **d)**
- **e)**
- **129)** w art. 322: w § 1 wyrazy „postępowanie przygotowawcze” zastępuje się wyrazem „śledztwo”, w § 2 wyraz „postępowania” zastępuje się wyrazem „śledztwa”;
    - **a)**
    - **b)**

- **130)** w art. 323: w § 1 wyraz „postępowania” zastępuje się wyrazem „śledztwa”, § 3 otrzymuje brzmienie: „
    - **a)**
    - **b)**
...
- **131)** w art. 324: dotychczasową treść oznacza się jako § 1 oraz skreśla się wyrazy „lub dochodzenia”, dodaje się § 2 i 3 w brzmieniu: „
    - **a)**
    - **b)**
...
- **143)** w art. 339: w § 1 pkt 3 otrzymuje brzmienie: „
    - **a)**

- **3)** akt oskarżenia zawiera wniosek, o którym mowa w art. 335. ” , w § 3 pkt 7 otrzymuje brzmienie: „
    - **b)**

- **7)** wydania wyroku nakazowego. ” , § 5 otrzymuje brzmienie: „
    - **c)**
...
- **145)** w art. 341: § 1 otrzymuje brzmienie: „
    - **a)**

§ 1. Prokurator, oskarżony i pokrzywdzony mają prawo wziąć udział w posiedzeniu. Udział ich jest obowiązkowy, jeżeli prezes sądu lub sąd tak zarządzi. ” , w § 2 wyrazy „art. 333 § 1–3” zastępuje się wyrazami „art. 333 § 1–2”, dodaje się § 5 w brzmieniu: „
...
- **146)** w art. 342: w § 1 wyrazy „W postanowieniu o warunkowym umorzeniu” zastępuje się wyrazami „W wyroku warunkowo umarzającym postępowanie”, w § 2 wyrazy „W postanowieniu” zastępuje się wyrazami „W wyroku”, w § 3 wyrazy „Postanowienie powinno” zastępuje się wyrazami „Wyrok powinien”, § 4 i 5 otrzymują brzmienie: „
    - **a)**
    - **b)**
    - **c)**
    - **d)**
...
- **152)** w art. 370: w § 1 po wyrazie „biegły” dodaje się przecinek i wyrazy „podmiot, o którym mowa w art. 416”, § 3 otrzymuje brzmienie: „
    - **a)**
    - **b)**
...
- **154)** w art. 377: w § 2 dodaje się zdanie drugie w brzmieniu: „ Stan niezdolności oskarżonego do udziału w rozprawie można stwierdzić także na podstawie badania niepołączonego z naruszeniem integralności ciała, przeprowadzonego za pomocą stosownego urządzenia. ” , § 3 i 4 otrzymują brzmienie: „
    - **a)**
    - **b)**
...
- **156)** w art. 384: w § 2 po wyrazach „w rozprawie” dodaje się przecinek oraz wyrazy „jeżeli się stawi,”, dodaje się § 4 w brzmieniu: „
    - **a)**
    - **b)**
...
- **158)** w art. 387: § 1 otrzymuje brzmienie: „
    - **a)**

§ 1. Do chwili zakończenia pierwszego przesłuchania wszystkich oskarżonych na rozprawie głównej oskarżony, któremu zarzucono występek, może złożyć wniosek o wydanie wyroku skazującego i wymierzenie mu określonej kary lub środka karnego bez przeprowadzania postępowania dowodowego; jeżeli oskarżony nie ma obrońcy z wyboru, sąd może, na jego wniosek, wyznaczyć mu obrońcę z urzędu. ” , § 2 otrzymuje brzmienie: „
...
- **166)** w art. 404: § 2 otrzymuje brzmienie: „
    - **a)**

§ 2. Rozprawę odroczoną prowadzi się w nowym terminie od początku. Sąd może wyjątkowo prowadzić rozprawę odroczoną w dalszym ciągu, chyba że skład sądu uległ zmianie. ” , § 3 otrzymuje brzmienie: „
...
- **173)** w art. 423: w § 1 wyrazy „7 dni” zastępuje się wyrazami „14 dni”, po § 1 dodaje się § 1a w brzmieniu: „
    - **a)**
    - **b)**

§ 1a. W wypadku złożenia wniosku o uzasadnienie wyroku w części odnoszącej się do niektórych oskarżonych sąd może ograniczyć zakres uzasadnienia do tych tylko części wyroku, których wniosek dotyczy. ” , § 2 otrzymuje brzmienie: „
...
- **178)** po art. 439 dodaje się art. 439a w brzmieniu: „ Orzeczenia w sprawie o wykroczenie nie uchyla się z tego tylko powodu, że sąd orzekł w postępowaniu karnym zamiast w postępowaniu w sprawach o wykroczenia. ” ;
...
§ 1. Wniosek oskarżonego, o którym mowa w art. 387 § 1, złożony przed rozprawą, sąd może rozpoznać na posiedzeniu.
...
- **195)** w art. 500: w § 1 wyrazy „nakaz karny” zastępuje się wyrazami „wyrok nakazowy”, w § 3 wyrazy „nakaz karny” zastępuje się wyrazami „wyrok nakazowy”, § 4 otrzymuje brzmienie: „
    - **a)**
    - **b)**
    - **c)**
...
- **197)** w art. 502: § 1 otrzymuje brzmienie: „
    - **a)**

§ 1. Wyrokiem nakazowym można orzec karę ograniczenia wolności lub grzywnę w wysokości do 100 stawek dziennych albo do 200 000 złotych. ” , w § 2 wyrazy „przepadek przedmiotów oraz nawiązkę” zastępuje się wyrazami „środek karny”, w § 3 skreśla się wyrazy „, o którym mowa w § 2”;
...
- **201)** w art. 506: § 1 otrzymuje brzmienie: „
    - **a)**

§ 1. Oskarżonemu i oskarżycielowi przysługuje prawo wniesienia sprzeciwu do sądu, który wydał wyrok nakazowy, w terminie zawitym 7 dni od doręczenia tego wyroku. ” , w § 3 wyrazy „nakaz karny” zastępuje się wyrazami „wyrok nakazowy”, w § 4 wyrazy „nakaz karny” zastępuje się wyrazami „wyrok nakazowy”, dodaje się § 6 w brzmieniu: „
...
- **208)** w art. 531: w § 1 dodaje się zdanie drugie w brzmieniu: „ Sąd kasacyjny wydaje postanowienie bez udziału stron, chyba że prezes Sądu Najwyższego zarządzi inaczej. ” , dodaje się § 3 w brzmieniu: „
    - **a)**
    - **b)**
...
- **211)** w art. 542: w § 1 po wyrazie „strony” dodaje się wyrazy „lub z urzędu”, dodaje się § 3–5 w brzmieniu: „
    - **a)**
    - **b)**
...
- **217)** w art. 552: w § 1 wyrazy „postępowania, kasacji lub stwierdzenia nieważności orzeczenia” zastępuje się wyrazami „postępowania lub kasacji”, w § 2 skreśla się wyrazy „albo stwierdzeniu nieważności”;
    - **a)**
    - **b)**

- **218)** w art. 554: w § 1 dwukrotnie użyty wyraz „wojewódzkim” zastępuje się wyrazem „okręgowym”, w § 2 wyraz „wojewódzki” zastępuje się wyrazem „okręgowy”;
    - **a)**
    - **b)**
...
- **222)** w art. 591: w § 1 po wyrazach „Minister Sprawiedliwości” dodaje się wyrazy „, z urzędu albo z inicjatywy sądu lub prokuratora,”, § 2–4 otrzymują brzmienie: „
    - **a)**
    - **b)**
...
- **231)** w art. 605: w § 1 po wyrazie „sąd” dodaje się wyraz „okręgowy”, w § 2 wyraz „miesiąc” zastępuje się wyrazami „40 dni”;
    - **a)**
    - **b)**
...
- **234)** w art. 615: § 3 otrzymuje brzmienie: „
    - **a)**

§ 3. Przepisy niniejszego działu stosuje się odpowiednio w stosunkach z trybunałami międzynarodowymi i ich organami działającymi na podstawie umów międzynarodowych, których Rzeczpospolita Polska jest stroną, albo powołanymi przez organizacje międzynarodowe ukonstytuowane umową ratyfikowaną przez Rzeczpospolitą Polską. Przepisów art. 602, 603 i 604 nie stosuje się, jeżeli umowa międzynarodowa albo akt prawny regulujący działanie trybunału stanowi odmiennie. ” , dodaje się § 4–6 w brzmieniu: „
...
- **235)** w art. 618: w § 1: – w pkt 9 po wyrazie „opinii” dodaje się wyrazy „lub wystawienia zaświadczenia”, – po pkt 9 dodaje się pkt 9a w brzmieniu: „ 9a) kosztów obserwacji psychiatrycznej oskarżonego w zespole opieki zdrowotnej, z wyłączeniem należności biegłych psychiatrów, ” , – w pkt 12 na końcu kropkę zastępuje się przecinkiem i dodaje się pkt 13 w brzmieniu: „ 13) realizacji umów międzynarodowych, których Rzeczpospolita Polska jest stroną, i postępowań prowadzonych na podstawie działu XIII, także jeżeli nie zostało wydane postanowienie, o którym mowa w art. 303. ” , § 2 otrzymuje brzmienie: „
    - **a)**
    - **b)**
...
- **241)** w art. 654: w § 1 w pkt 2 wyrazy „sądu wojewódzkiego” zastępuje się wyrazami „sądu okręgowego”, w § 5 wyrazy „sądowi wojewódzkiemu” zastępuje się wyrazami „sądowi okręgowemu”;
    - **a)**
    - **b)**
...
§ 1. Sprawę o przestępstwo zagrożone karą pozbawienia wolności nieprzekraczającą 5 lat lub karą łagodniejszą, jeżeli oskarżony pozostaje na wolności, wojskowy sąd garnizonowy rozpoznaje jednoosobowo również na rozprawie głównej.
...
- **246)** po art. 672 dodaje się art. 672a w brzmieniu: „ Kasację, o której mowa w art. 521, do Izby Wojskowej Sądu Najwyższego może wnieść również Naczelny Prokurator Wojskowy. ” ;
- **247)** w art. 673 skreśla się wyrazy „oraz stwierdzenia nieważności z mocy samego prawa”.

**Art. 2.** W ustawie z dnia 6 czerwca 1997 r. – Przepisy wprowadzające Kodeks postępowania karnego (Dz. U. Nr 89, poz. 556 i Nr 160, poz. 1083, z 2000 r. Nr 62, poz. 717, z 2001 r. Nr 106, poz. 1149 oraz z 2002 r. Nr 213, poz. 1801) wprowadza się następujące zmiany:
...
**Art. 3.** W ustawie z dnia 25 czerwca 1997 r. o świadku koronnym (Dz. U. Nr 114, poz. 738 i Nr 160, poz. 1083, z 1999 r. Nr 83, poz. 931 oraz z 2001 r. Nr 5, poz. 40) w art. 1 w ust. 2 wyrazy „przestępstwo określone w art. 258” zastępuje się wyrazami „przestępstwa określone w art. 228 § 1, 3–6, art. 229 § 1, 3–5, art. 231 i 258”.
