...
Tabela nr 1 Terminy przekazywania Rodzaj informacji Zanieczyszczenia Szereg czasowy informacji Całkowite krajowe emisje z podziałem na kategorie źródeł według NFR SO , NO , NMLZO, NH , CO metale ciężkie (Cd, Hg, Pb) TZO (ogółem WWA benzo(a)piren, benzo(b)fluoranten, benzo(k)fluoranten, indeno(1,2,3-cd)piren, dioksyny/furany, PCB , HCB Raz w roku, 15 lutego.
z uwzględnieniem danych Jeżeli informacje zawierały od 1990 r. do roku błędy, ponowne przekazanie sprawozdawczego informacji, wraz minus 2 (X − 2) z wyjaśnieniem wprowadzonych zmian, następuje najpóźniej w ciągu 4 tygodni od dnia 15 lutego.
) Całkowite krajowe emisje z podziałem na kategorie źródeł według NFR PM , PM Raz w roku, 15 lutego.
sadza, jeżeli dane są z uwzględnieniem danych Jeżeli informacje zawierały dostępne od 2000 r. do roku błędy, ponowne przekazanie sprawozdawczego informacji, wraz minus 2 (X − 2) z wyjaśnieniem wprowadzonych zmian, następuje najpóźniej w ciągu 4 tygodni od dnia 15 lutego.
...
Tabela nr 2 Termin przekazywania Rodzaj informacji Zanieczyszczenia Szereg czasowy informacji Całkowite krajowe emisje z podziałem na kategorie źródeł według NFR metale ciężkie (As, Cr, Cu, Ni, Se i Zn oraz ich związki) TSP Raz w roku, począwszy 15 lutego od 1990 r. (2000 r. dla TSP) do roku sprawozdawczego minus 2 (X − 2) Objaśnienia: Informacje o emisjach ze źródeł naturalnych są sprawozdawane zgodnie z metodami ustanowionymi w Konwencji LRTAP oraz z przewodnikiem EMEP/EEA dotyczącym bilansu emisji zanieczyszczeń powietrza. Nie są włączane do krajowych wartości całkowitych i są zgłaszane oddzielnie.
...
Tabela nr 3 Rodzaj informacji Zanieczyszczenia Szereg czasowy Terminy przekazywania informacji Krajowe dane w postaci SO siatki dotyczące emisji z podziałem na kategorie źródeł (GNFR) , NO NMLZO, CO, NH , PM , PM Co 4 lata dla roku 1 maja.
sprawozdawczego minus 2 Jeżeli informacje zawierały metale ciężkie (X 2), począwszy błędy, ponowne przekazanie (Cd, Hg, Pb) od 2017 r. informacji, wraz TZO (ogółem WWA, z wyjaśnieniem HCB, PCB, dioksyny/ wprowadzonych zmian, furany) następuje najpóźniej w ciągu sadza, jeżeli dane są 4 tygodni od dnia 1 maja.
dostępne Duże źródła punktowe SO według kategorii źródła (GNFR) , NO , NMLZO, CO, NH , PM , PM metale ciężkie (Cd, Hg, Pb) TZO (ogółem WWA, HCB, PCB, dioksyny/ furany) sadza, jeżeli dane są dostępne Co 4 lata dla roku 1 maja.
sprawozdawczego minus 2 (X 2), począwszy od 2017 r.
...
Prognozowane emisje w podziale na kategorie źródeł według NFR SO , NO , NH , NMLZO, PM Co 2 lata, począwszy 15 marca od 2017 r., w odniesieniu sadza, jeżeli dane są do lat, których dotyczą dostępne prognozy, czyli 2020 r., 2025 r., 2030 r. oraz, jeżeli dane są dostępne 2040 r. i 2050 r.
...
dwutlenek siarki (SO ) 59 % 70 % tlenek azotu (NO ) 30 % 39 % niemetanowe lotne związki organiczne (NMLZO) 25 % 26 % amoniak (NH ) 1 % 17 % pył drobny (PM ) 16 % 58 % Objaśnienia: Zobowiązania w zakresie redukcji w przypadku transportu drogowego odnoszą się do emisji obliczonych na podstawie sprzedanych paliw, a rokiem odniesienia jest 2005 r.
