...
| Pole | Wartość |
|---|---|
| Adres publikacyjny | Dz.U. 2004 nr 251 poz. 2507 |
| ISAP | WDU20042512507 |
| Typ aktu | Ustawa |
| Status | akt posiada tekst jednolity |
| W mocy | tak |
...
| Źródło | [ELI HTML](https://eli.gov.pl/api/acts/DU/2004/2507/text.html) · [ELI API](https://api.sejm.gov.pl/eli/acts/DU/2004/2507) |
...
przygotowuje i wprowadza jednolite sposoby działania ośrodków doradztwa w zakresie realizowanych przez nie zadań;
...
prowadzi szkolenia dla pracowników ośrodków doradztwa:
...
koordynuje zadania w zakresie rolnictwa ekologicznego wykonywane przez ośrodki doradztwa;
...
szkołami, szkołami wyższymi, jednostkami badawczo-rozwojowymi i placówkami naukowymi Polskiej Akademii Nauk;
...
ministra właściwego do spraw rozwoju wsi - w przypadku dyrektora Centrum Doradztwa;

### 2)

właściwego wojewodę - w przypadku dyrektora ośrodka doradztwa.
...
kwalifikacje osób ubiegających się o stanowisko dyrektora jednostki doradztwa rolniczego, mając na względzie zapewnienie prawidłowej pracy tej jednostki;

### 2)

warunki i tryb przeprowadzania konkursu na stanowisko dyrektora jednostki doradztwa rolniczego, w szczególności sposób ogłaszania konkursu, skład i zadania komisji konkursowej oraz sposób wyłaniania kandydata na stanowisko dyrektora, mając na względzie prawidłowe przeprowadzenie konkursu.
...
opracowuje corocznie plan działania jednostki doradztwa rolniczego;
...
program rocznej działalności doradczej jednostki doradztwa rolniczego;
...
opiniowanie planu działania, o którym mowa w art. 8 ust. 1 pkt 1, i sprawozdania z realizacji tego planu;
...
minister właściwy do spraw rozwoju wsi - w przypadku Rady działającej przy Centrum Doradztwa;

### 2)

wojewoda - w przypadku Rady działającej przy ośrodku doradztwa.
...
Rada działa na podstawie regulaminu zatwierdzonego przez organ, któremu podlega jednostka doradztwa rolniczego.
...
przychodów z innych źródeł, w szczególności z tytułu darowizn, zapisów, spadków oraz środków finansowych pochodzenia zagranicznego i odsetek bankowych od środków zgromadzonych na rachunkach bankowych.

### 2.

Jednostki doradztwa rolniczego otrzymują z budżetu państwa dotacje podmiotowe na wykonywanie zadań z zakresu doradztwa rolniczego, o których mowa w art. 4 ust. 1 i 2, w tym na wynagrodzenia dla pracowników i utrzymanie jednostek.
...
plan działania, o którym mowa w art. 8 ust. 1 pkt 1 - w terminie do dnia 30 listopada roku poprzedzającego rok, na który ten plan został sporządzony;

### 2)

sprawozdanie z realizacji planu działania, o którym mowa w art. 8 ust. 1 pkt 1 - w terminie do dnia 31 stycznia roku następującego po roku, który sprawozdanie obejmuje.
...
Wysokość wynagrodzenia za wykonywanie usług, o których mowa w art. 4 ust. 4, określa cennik zatwierdzany, na wniosek dyrektora jednostki doradztwa rolniczego, przez organ, któremu ta jednostka podlega.
