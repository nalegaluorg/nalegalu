...
1. Procedury są wykonywane zgodnie z zasadami zastąpienia, ograniczenia i udoskonalenia. ” , po ust. 2 dodaje się ust. 2a w brzmieniu: „
...
- **2)** udzielić, w wyjątkowych przypadkach, zgody na wykorzystanie w procedurze zwierząt, o których mowa w ust. 1 pkt 3, jeżeli celem procedury jest zbadanie zdrowia i dobrostanu tych zwierząt lub zapobieżenie poważnemu zagrożeniu powodowanemu przez te zwierzęta dla zdrowia ludzi lub zwierząt lub dla środowiska i cel ten można osiągnąć wyłącznie z wykorzystaniem tych zwierząt. ” , dodaje się ust. 3 i 4 w brzmieniu: „
    - **b)**
...
- **2)** środowisku życia zwierzęcia dzikiego, jeżeli cel procedury może zostać osiągnięty przez jej wykonanie w tym środowisku i zmniejsza to stres zwierzęcia związany z jej wykonaniem. ” , uchyla się ust. 3;
    - **b)**
...
- **20)** po art. 24 dodaje się art. 24a w brzmieniu: „ Hodowca, dostawca i użytkownik, w zakresie uzasadnionym rodzajem prowadzonej przez siebie działalności w zakresie wykorzystywania zwierząt do celów naukowych lub edukacyjnych, opracowują programy:
...
- **2)** niespełnienie wymagań niezbędnych do prowadzenia działalności, o której mowa w art. 26, jeżeli nie są spełnione wymagania określone w art. 17, art. 18, art. 20, art. 21, art. 21b ust. 1 i 2, art. 23–24a, art. 25 ust. 1 lub 3 lub w przepisach wydanych na podstawie art. 19. ” , w ust. 3 pkt 3 i 4 otrzymują brzmienie: „
    - **b)**
...
- **25)** w art. 29: w ust. 3 wyrazy „art. 27 ust. 3 pkt 3 i 4” zastępuje się wyrazami „art. 27 ust. 3 pkt 1 i 3–5”, w ust. 4 po wyrazach „wykorzystywanych w procedurach” dodaje się wyrazy „w ośrodku”, dodaje się ust. 6 w brzmieniu: „
    - **a)**
    - **b)**
    - **c)**
...
2. Komisja przekazuje ministrowi właściwemu do spraw szkolnictwa wyższego i nauki corocznie, w terminie do dnia 30 czerwca, informacje o realizacji zadań lokalnych komisji, o których mowa w art. 36 ust. 1. ” , w ust. 3 skreśla się wyrazy „w sprawach udzielania zgód, o których mowa w art. 36 ust. 1 pkt 1,”, ust. 6 otrzymuje brzmienie: „
...
- **29)** w art. 34: w ust. 1 pkt 1 i 2 otrzymują brzmienie: „
    - **a)**
...
- **2)** 3 osoby posiadające co najmniej tytuł zawodowy magistra i dorobek naukowy lub zawodowy z zakresu filozofii, etyki lub prawa, w szczególności związany z etycznymi lub prawnymi aspektami wykorzystywania zwierząt do celów naukowych lub edukacyjnych; ” , w ust. 2 pkt 1 otrzymuje brzmienie: „
    - **b)**

- **1)** skazana prawomocnym wyrokiem za umyślne przestępstwo lub umyślne przestępstwo skarbowe; ” , po ust. 2 dodaje się ust. 2a-2e w brzmieniu: „
    - **c)**
...
2e. Organizacja społeczna, której statutowym celem działania jest ochrona zwierząt, do zgłoszenia kandydata na członka Komisji dołącza statut i aktualny odpis z Krajowego Rejestru Sądowego. ” , w ust. 6 po wyrazie „członków” dodaje się wyrazy „oraz udostępnia w Biuletynie Informacji Publicznej na swojej stronie podmiotowej informację o powołanych członkach Komisji, podając ich imiona i nazwiska”;
...
- **d)**
- **32)** w art. 37: w ust. 1 pkt 1 i 2 otrzymują brzmienie: „
    - **a)**
...
- **2)** 3 osób posiadających co najmniej tytuł zawodowy magistra i dorobek naukowy lub zawodowy z zakresu filozofii, etyki lub prawa, w szczególności związany z etycznymi lub prawnymi aspektami wykorzystywania zwierząt do celów naukowych lub edukacyjnych; ” , dodaje się ust. 3 i 4 w brzmieniu: „
    - **b)**
...
- **35)** w art. 39: ust. 2 otrzymuje brzmienie: „
    - **a)**

2. Członkom Komisji i lokalnych komisji przysługuje:

- **1)** wynagrodzenie za udział w posiedzeniu tych komisji;
- **2)** zwrot kosztów podróży związanych z realizacją zadań tych komisji na zasadach określonych w przepisach wydanych na podstawie art. 775 § 2 ustawy z dnia 26 czerwca 1974 r. – Kodeks pracy (Dz. U. z 2020 r. poz. 1320 oraz z 2021 r. poz. 1162). ” , dodaje się ust. 3 w brzmieniu: „
    - **b)**
...
- **2)** zgodnie ze wzorem określonym przez Komisję Europejską w przepisach wydanych na podstawie art. 43 ust. 4 dyrektywy Parlamentu Europejskiego i Rady 2010/63/UE z dnia 22 września 2010 r. w sprawie ochrony zwierząt wykorzystywanych do celów naukowych. ” , ust. 2 otrzymuje brzmienie: „
    - **b)**
...
- **42)** w art. 47: w ust. 1 w pkt 6 kropkę zastępuje się średnikiem i dodaje się pkt 7 i 8 w brzmieniu: „
    - **a)**
...
- **8)** informacje zawarte w nietechnicznym streszczeniu doświadczenia są zgodne z informacjami zawartymi we wniosku o wyrażenie zgody na przeprowadzenie doświadczenia oraz czy nietechniczne streszczenie doświadczenia zostało sporządzone zgodnie z art. 45 ust. 1a. ” , w ust. 2 pkt 1 otrzymuje brzmienie: „
    - **b)**

- **1)** dziedzin nauki, w ramach których jest planowane przeprowadzenie doświadczenia, w tym stosowania zasad zastąpienia, ograniczenia i udoskonalenia w tych dziedzinach; ” , uchyla się ust. 3;
    - **c)**

- **43)** w art. 50 po wyrazach „produkcyjnych lub diagnostycznych” dodaje się wyrazy „za pomocą ustalonych metod”;
- **44)** w art. 51: w ust. 2 dodaje się zdanie drugie w brzmieniu: „ Do wniosku dołącza się nietechniczne streszczenie doświadczenia uwzględniające zmiany planowane w doświadczeniu. ” , w ust. 3 wyrazy „art. 47 ust. 3” zastępuje się wyrazami „art. 52a”;
    - **a)**
    - **b)**
...
- **48)** w art. 53: ust. 2 otrzymuje brzmienie: „
    - **a)**
...
- **3)** czy wnioski wynikające z przeprowadzonego doświadczenia mogą przyczynić się do dalszego wdrażania zasad zastąpienia, ograniczenia i udoskonalenia. ” , po ust. 2 dodaje się ust. 2a w brzmieniu: „
    - **b)**

2a. Lokalna komisja może wystąpić do użytkownika o przedstawienie wyjaśnień dotyczących przekazanej dokumentacji, o której mowa w art. 52 ust. 1, w zakresie niezbędnym do przeprowadzenia oceny retrospektywnej. ” , ust. 4 otrzymuje brzmienie: „
...
- **49)** w art. 54: po ust. 1 dodaje się ust. 1a w brzmieniu: „
    - **a)**

1a. W przypadku gdy hodowca, dostawca ani użytkownik nie posiadają ośrodka, ich kontrolę przeprowadza powiatowy lekarz weterynarii właściwy ze względu na siedzibę albo miejsce zamieszkania hodowcy, dostawcy lub użytkownika. ” , w ust. 3 wyrazy „w ust. 1 i 2” zastępuje się wyrazami „w ust. 1–2”;
...
- **51)** po art. 55 dodaje się art. 55a w brzmieniu: „ Minister właściwy do spraw szkolnictwa wyższego i nauki lub Komisja może wystąpić do powiatowego lekarza weterynarii z wnioskiem o przeprowadzenie kontroli, o której mowa w art. 54 ust. 1. ” ;
