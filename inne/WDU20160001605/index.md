...
- **1)** w pkt 3 lit. c otrzymuje brzmienie: „ posiadaczem zwierzęcia lub posiadaczem zwierzęcia w rozumieniu przepisów o systemie identyfikacji i rejestracji zwierząt; ” ;
    - **c)**
...
- **1)** imię, nazwisko, numer PESEL, a w przypadku osoby nieposiadającej obywatelstwa polskiego – numer paszportu lub innego dokumentu potwierdzającego tożsamość oraz miejsce zamieszkania i adres albo nazwę, numer REGON, jeżeli numer taki został nadany, siedzibę i adres podmiotu; ” , ust. 4 otrzymuje brzmienie: „
    - **b)**
...
- **12b)** nakazać posiadaczowi gospodarstwa podjęcie określonych działań w celu zabezpieczenia gospodarstwa przed przenikaniem czynnika zakaźnego; ” , w ust. 1a w pkt 6 w lit. c kropkę zastępuje się średnikiem i dodaje się pkt 7 w brzmieniu: „
    - **b)**
...
- **11)** w art. 85 w ust. 1: pkt 3 otrzymuje brzmienie: „
    - **a)**

- **3)** nie stosuje się do nakazów, zakazów lub ograniczeń, wydanych w celu zwalczania choroby zakaźnej zwierząt lub zapobiegania takiej chorobie, wymienionych w art. 44 ust. 1 pkt 10 lit. a i b oraz ust. 1a pkt 6 lit. a i b, ” , uchyla się pkt 9;
    - **b)**

- **12)** po art. 85a dodaje się art. 85aa w brzmieniu: „ Art. 85aa.
...
- **1)** art. 44 ust. 1 pkt 1 i art. 44 ust. 1a pkt 1: nie odosabnia lub nie strzeże zwierząt chorych lub zakażonych albo podejrzanych o zakażenie lub o chorobę, podlega karze pieniężnej w wysokości od 0,25 do 1,3, nie obserwuje zwierząt chorych lub zakażonych albo podejrzanych o zakażenie lub o chorobę, podlega karze pieniężnej w wysokości od 0,2 do 0,8,
    - **a)**
    - **b)**
...
- **16)** art. 45 ust. 1 pkt 7 i art. 46 ust. 3 pkt 7: nie oczyszcza, nie odkaża, nie przeprowadza deratyzacji lub dezynsekcji miejsc przebywania zwierząt, a także nie oczyszcza lub nie odkaża środków transportu, podlega karze pieniężnej w wysokości od 0,25 do 1,3, nie oczyszcza, nie odkaża, nie przeprowadza deratyzacji lub dezynsekcji miejsc przechowywania lub przetwarzania zwłok zwierzęcych, produktów lub pasz, podlega karze pieniężnej w wysokości od 0,5 do dwukrotności,
    - **a)**
    - **b)**
...
- **13)** po art. 85c dodaje się art. 85ca w brzmieniu: „ W przypadku ponownego popełnienia takiego samego czynu, o którym mowa w art. 85aa ust. 1 i 2, wysokość kary pieniężnej, o której mowa w art. 85aa ust. 1 i 2:
...
- **5)** siedziby stada bydła, owiec albo kóz mogą być usunięte z rejestru zwierząt gospodarskich oznakowanych po upływie 5 lat od dnia zaprzestania przetrzymywania, utrzymywania lub hodowli zwierząt gospodarskich w danej siedzibie stada, z zastrzeżeniem ust. 2a. ” , po ust. 2 dodaje się ust. 2a w brzmieniu: „
    - **b)**
...
- **1)** nie później niż w dniu: wprowadzenia pierwszego zwierzęcia gospodarskiego do siedziby stada lub miejsca gromadzenia zwierząt, uboju pierwszego zwierzęcia gospodarskiego, unieszkodliwienia zwłok zwierzęcia gospodarskiego w zakładzie przetwórczym lub spalarni;
    - **a)**
    - **b)**
    - **c)**

- **2)** w terminie 14 dni od dnia: wydania decyzji powiatowego lekarza weterynarii o nadaniu weterynaryjnego numeru identyfikacyjnego podmiotowi prowadzącemu działalność w zakresie organizowania targów, wystaw, pokazów lub konkursów zwierząt, wydania decyzji stwierdzającej spełnianie wymagań weterynaryjnych dla prowadzenia działalności w zakresie obrotu zwierzętami, pośrednictwa w tym obrocie lub skupu zwierząt. ” , ust. 3–5 otrzymują brzmienie: „
    - **a)**
    - **b)**
    - **b)**
...
- **3)** w art. 12: w ust. 3 wprowadzenie do wyliczenia otrzymuje brzmienie: „ Posiadacz świń jest obowiązany zgłosić kierownikowi biura w terminie 7 dni: ” , po ust. 3 dodaje się ust. 3a w brzmieniu: „
    - **a)**
    - **b)**
...
- **1)** utrzymywania zwierząt: nieoznakowanych, bez wymaganego dla bydła paszportu albo duplikatu paszportu;
    - **a)**
    - **b)**

- **2)** wprowadzania do obrotu zwierząt: nieoznakowanych, bez wymaganego dla bydła paszportu albo duplikatu paszportu;
    - **a)**
    - **b)**

- **3)** nabywania zwierząt: nieoznakowanych, bez wymaganego dla bydła paszportu albo duplikatu paszportu. ” ;
    - **a)**
    - **b)**
...
- **2)** zgłasza kierownikowi biura fakt oznakowania świni zgodnie z pkt 1, w terminie 7 dni od dnia oznakowania, określając liczbę oznakowanych zwierząt. ” , po ust. 2 dodaje się ust. 2a i 2b w brzmieniu: „
    - **b)**
...
- **1)** przekazuje, przed wprowadzeniem zwierząt na targ, wystawę, pokaz lub konkurs albo do miejsca gromadzenia zwierząt, podmiotowi prowadzącemu te miejsca: opatrzony podpisem wykaz wprowadzanych zwierząt zawierający ich numery identyfikacyjne, świadectwa zdrowia tych zwierząt, jeżeli wymóg posiadania takich świadectw jest określony w przepisach o ochronie zdrowia zwierząt oraz o zwalczaniu chorób zakaźnych zwierząt;
    - **a)**
    - **b)**
...
- **11)** w art. 31: w ust. 4 pkt 1 otrzymuje brzmienie: „
    - **a)**

- **1)** wstępu do siedziby stada, miejsc gromadzenia zwierząt, miejsc prowadzenia działalności w zakresie organizowania targów, wystaw, pokazów lub konkursów zwierząt, miejsc prowadzenia działalności w zakresie obrotu zwierzętami, pośrednictwa w tym obrocie lub skupu zwierząt, rzeźni i miejsc unieszkodliwiania zwłok zwierząt; ” , ust. 6–8 otrzymują brzmienie: „
    - **b)**
...
8. Powiatowy lekarz weterynarii i kierownik biura przekazują sobie nawzajem protokoły, o których mowa w ust. 5. ” , dodaje się ust. 11–16 w brzmieniu: „
...
- **15)** nabywa zwierzęta nieoznakowane lub bez wymaganego dla bydła paszportu lub duplikatu paszportu albo dokumentu identyfikacyjnego – w przypadku koniowatych, ” , po pkt 15 dodaje się pkt 15a w brzmieniu: „
    - **g)**
...
- **1)** w art. 27: uchyla się ust. 2, ust. 3 otrzymuje brzmienie: „
    - **a)**
    - **b)**
...
- **1)** lit. c otrzymuje brzmienie: „ w 2017 r. kwoty 7 000 000 zł, ” ;
    - **c)**

- **2)** dodaje się lit. d i e w brzmieniu: „ w 2018 r. kwoty 7 000 000 zł, w latach 2019–2024 kwoty 0 zł. ” .
    - **d)**
    - **e)**
