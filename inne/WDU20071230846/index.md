...
| Pole | Wartość |
|---|---|
| Adres publikacyjny | Dz.U. 2007 nr 123 poz. 846 |
| ISAP | WDU20071230846 |
| Typ aktu | Ustawa |
| Status | akt objęty tekstem jednolitym |
| W mocy | tak |
...
| Źródło | [ISAP](https://isap.sejm.gov.pl/isap.nsf/DocDetails.xsp?id=WDU20071230846) · [PDF](https://api.sejm.gov.pl/eli/acts/DU/2007/846/text.pdf) |

**Art. 1.** W ustawie z dnia 21 grudnia 2000 r. o żegludze śródlądowej (Dz. U. z 2006 r. Nr 123, poz. 857) wprowadza się następujące zmiany:
...
- **3)** w art. 20: ust. 4a otrzymuje brzmienie: „
    - **a)**

4a. Po wpisaniu statku do rejestru statków używanych wyłącznie do uprawiania sportu lub rekreacji właściwy polski związek sportowy wydaje dokument rejestracyjny stanowiący dowód polskiej przynależności statku. ” , skreśla się ust. 4b i ust. 4c;
...
- **6)** w załączniku do ustawy zatytułowanym „Wysokości opłat”: część IIIa tabeli otrzymuje brzmienie: „ IIIa Rejestr statków używanych wyłącznie do uprawiania sportu lub rekreacji
    - **a)**
...
4. za wyciąg lub odpis z rejestru – 15 zł ” , skreśla się część Va tabeli.
