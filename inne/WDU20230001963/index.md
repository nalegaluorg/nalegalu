...
**Art. 2.** Inwestycjami dla Odry są następujące inwestycje:

**Art. 3.**

1. Państwowe Gospodarstwo Wodne Wody Polskie może otrzymywać dotacje celowe z budżetu państwa na dofinansowanie lub finansowanie inwestycji dla Odry, o których mowa art. 2 pkt 10–14, 16–19, 24–27, 29, 31 lit. a i c–i, pkt 32–41, 42 lit. b i c, pkt 44–46 i 48–50.
...
- **1)** wniosku o wydanie decyzji o pozwoleniu na realizację inwestycji, o którym mowa art. 6 ust. 1 ustawy z dnia 8 lipca 2010 r. o szczególnych zasadach przygotowania do realizacji inwestycji zakresie budowli przeciwpowodziowych (Dz. U. z 2021 r. poz. 1812 oraz z 2023 r. poz. 1890);
- **2)** wniosku o pozwolenie na budowę;
- **3)** odpowiedniej zgody wodnoprawnej, jeżeli jest wymagana.

**Art. 194c.** Do inwestycji, o której mowa art. 194a, stosuje się przepisy ustawy z dnia 8 lipca 2010 r. o szczególnych zasadach przygotowania do realizacji inwestycji zakresie budowli przeciwpowodziowych dotyczące inwestycji, o których mowa art. 1 pkt 1 tej ustawy.

**Art. 194d.** Miejscowy plan zagospodarowania przestrzennego, którym wyznaczono tereny rolnicze, tereny zabudowy zagrodowej gospodarstwach rolnych, leśnych, hodowlanych i ogrodniczych lub tereny łąk lub pastwisk, umożliwia również lokalizację na tych terenach, z wyjątkiem obszarów objętych przynajmniej jedną formą ochrony przyrody, o której mowa art. 6 ust. 1 pkt 1‒9 ustawy z dnia 16 kwietnia 2004 r. o ochronie przyrody, systemów retencyjno-dozujących lub ich części, chyba że ustalenia tego planu miejscowego zakazują ich lokalizacji.”; „3a. W skład Wód Polskich wchodzi Inspekcja Wodna.”;
...
- **1)** koordynacja działalności regionalnych inspekcji wodnych i nadzór nad tą działalnością, szczególności poprzez wydawanie poleceń dotyczących sposobu realizacji zadań oraz żądanie przekazania informacji;
- **2)** określanie ryzyka wystąpienia potencjalnych zdarzeń mogących powodować negatywne skutki dla wód lub zasobów ryb wodach celu eliminacji tych skutków;
...
2. Regionalny inspektor wodny wykonuje zadania, o których mowa art. 251b, zakresie swojej właściwości, oraz przekazuje właściwym organom Wód Polskich dokumentację sporządzoną ramach czynności służbowych, celu ewentualnego wszczęcia właściwego postępowania lub podjęcia innych czynności przewidzianych ustawie.

3. Podczas wykonywania zadań regionalnej inspekcji wodnej, o których mowa ust. 2, inspektorzy regionalnej inspekcji wodnej są uprawnieni do:
...
1. W przypadkach, o których mowa art. 11 pkt 1–3, 8, 10 i 12–14 ustawy z dnia 24 maja 2013 r. o środkach przymusu bezpośredniego i broni palnej (Dz. U. z 2023 r. poz. 202, 547, 1053, 1088, 1489 i 1963), inspektor regionalnej inspekcji wodnej może użyć środków przymusu bezpośredniego, o których mowa art. 12 ust. 1 pkt 1, 2 lit. a, pkt 7, 12 lit. a i pkt 13 tej ustawy, lub wykorzystać te środki.

2. W przypadkach, o których mowa art. 45 pkt 1 lit. a i pkt 2 oraz art. 47 pkt 1, 2 lit. a, pkt 3, 5 i 6 ustawy z dnia 24 maja 2013 r. o środkach przymusu bezpośredniego i broni palnej, inspektor regionalnej inspekcji wodnej może użyć broni palnej lub ją wykorzystać.
...
1. Krajowy Inspektor Wodny wskazuje stanowiska pracy Inspekcji Wodnej, na których wykonuje się zadania związane z wykonywaniem czynności terenie.

2. Na stanowiskach, o których mowa ust. 1, może być zatrudniona osoba, która:

- **1)** ukończyła 21. rok życia;
- **2)** jest obywatelem polskim;
- **3)** korzysta z pełni praw publicznych;
- **4)** nie była skazana prawomocnym wyrokiem za umyślne przestępstwo;
- **5)** ma wykształcenie wyższe lub przez okres co najmniej 5 lat pełniła służbę Policji, Straży Granicznej, Biurze Ochrony Rządu, Służbie Ochrony Państwa, Państwowej Straży Pożarnej, Służbie Więziennej, Agencji Bezpieczeństwa Wewnętrznego, Agencji Wywiadu, Służbie Wywiadu Wojskowego, Służbie Kontrwywiadu Wojskowego, Urzędzie Ochrony Państwa lub pełniła zawodową służbę wojskową.

**Art. 251h.**

1. Organy administracji publicznej oraz organizacje społeczne współdziałają z Inspekcją Wodną przy wykonywaniu jej zadań.

2. Współdziałanie, o którym mowa ust. 1, polega szczególności na bezpłatnym udzielaniu informacji lub udostępnianiu dokumentów lub danych niezbędnych do podjęcia czynności służbowych wynikających z posiadanych uprawnień.

3. Inspekcja Wodna przy wykonywaniu zadań zakresie zapobiegania wykroczeniom i przestępstwom oraz wykrywania wykroczeń i przestępstw, o których mowa ustawie z dnia 18 kwietnia 1985 r. o rybactwie śródlądowym, współdziała z Państwową Strażą Rybacką.

**Art. 251i.**

1. Inspekcja Wodna może przekazać dane osobowe państwu trzeciemu lub organizacjom międzynarodowym, na ich wniosek, przypadku gdy są spełnione warunki przekazywania informacji określone art. 18a–18d ustawy z dnia 16 września 2011 r. o wymianie informacji z organami ścigania państw członkowskich Unii Europejskiej, państw trzecich, agencjami Unii Europejskiej oraz organizacjami międzynarodowymi (Dz. U. z 2023 r. poz. 783).

2. Wystąpienie z żądaniem, o którym mowa art. 18 ust. 1 rozporządzenia Parlamentu Europejskiego i Rady (UE) 2016/679 z dnia 27 kwietnia 2016 r. sprawie ochrony osób fizycznych związku z przetwarzaniem danych osobowych i sprawie swobodnego przepływu takich danych oraz uchylenia dyrektywy 95/46/WE (ogólne rozporządzenie o ochronie danych) (Dz. Urz. UE L 119 z 04.05.2016, str. 1, z późn. zm. ), nie wstrzymuje wykonywania przez Inspekcję Wodną zadań, o których mowa art. 251b i art. 251c.”;

- **14)** art. 255 po pkt 1 dodaje się pkt 1a brzmieniu: „1a) wpływy z tytułu administracyjnych kar pieniężnych nakładanych przez Wody Polskie;”;
    - **a)** ust. 2 otrzymuje brzmienie: „2. Opłaty stałej nie ponosi się za pobór wód:
...
- **4)** do celów pomp ciepła i akumulatorów ciepła warstwy wodonośnej, które pobierają, wykorzystują, a następnie odprowadzają do wód lub tej samej warstwy wodonośnej wodę tej samej ilości i niepogorszonej jakości, z wyjątkiem zmiany jej temperatury.”,
...
- **17)** art. 272:
    - **a)** po ust. 3 dodaje się ust. 3a i 3b brzmieniu: „3a. Wysokość opłaty zmiennej za pobór wód do celów, o których mowa art. 270 ust. 2 pkt 4, ustala się jako sumę iloczynów jednostkowej stawki opłaty i ilości energii cieplnej wyprodukowanej lub pobranej instalacji, wyrażonej MWh, oraz stawki opłaty i ilości wód podziemnych lub wód powierzchniowych pobranych bezzwrotnie na potrzeby technologiczne, wyrażonej m , nieprzeznaczonej wprost do produkcji energii cieplnej.

3b. Wysokość opłaty zmiennej za wprowadzanie wód pochodzących z pomp ciepła lub akumulatorów ciepła warstwy wodonośnej do wód ustala się jako iloczyn jednostkowej stawki opłaty i ilości wód wprowadzanych do wód, pochodzących z pomp ciepła lub akumulatorów ciepła warstwy wodonośnej, wyrażonej m , z uwzględnieniem ich temperatury.”, „4a. W przypadku poboru wód podziemnych lub wód powierzchniowych bez wymaganego pozwolenia wodnoprawnego albo pozwolenia zintegrowanego ilości pobranych wód podziemnych lub wód powierzchniowych ustala się toku kontroli gospodarowania wodami, przyjmując pobór wynikający z maksymalnej technicznej wydajności eksploatowanych instalacji lub urządzeń do poboru wód, a także przyjmując okres eksploatacji instalacji lub urządzenia do poboru wód przez jeden kwartał, jeżeli toku kontroli gospodarowania wodami nie ustalono tego okresu eksploatacji.”,

- **c)** po ust. 5 dodaje się ust. 5a brzmieniu: „5a. W przypadku odprowadzania wód opadowych lub roztopowych z przelewów kanalizacji deszczowej do wód zakresie ustalonym pozwoleniu wodnoprawnym albo pozwoleniu zintegrowanym opłatę zmienną za odprowadzanie wód opadowych lub roztopowych z tych przelewów ustala się za każdy przelew wysokości stanowiącej równowartość 10% ustalonej opłaty zmiennej, o której mowa ust. 5, należnej za okres rozliczeniowy, którym doszło do uruchomienia przelewu.”,
- **d)** po ust. 6 dodaje się ust. 6a–6d brzmieniu: „6a. Wysokość opłaty zmiennej za wprowadzanie ścieków do wód lub ziemi ustala się także z uwzględnieniem ilości ścieków oczyszczonych lub podczyszczonych systemie oczyszczania lub podczyszczania ścieków zasolonych, odprowadzanych z zakładu odprowadzającego ścieki o zwiększonym zasoleniu oraz zastosowania systemu retencyjno-dozującego lub innego systemu pozwalającego uzyskać ten sam efekt, co system retencyjno-dozujący.

6b. W przypadku wprowadzania ścieków do wód lub ziemi bez wymaganego pozwolenia wodnoprawnego albo pozwolenia zintegrowanego ilość ścieków wprowadzonych do wód lub ziemi ustala się toku kontroli gospodarowania wodami, przyjmując ilość ścieków wynikającą z maksymalnej technicznej wydajności instalacji lub urządzeń służących do wprowadzania ścieków do wód lub ziemi, a także przyjmując okres eksploatacji instalacji lub urządzenia do wprowadzania ścieków do wód lub ziemi przez jeden kwartał, jeżeli toku kontroli gospodarowania wodami nie ustalono tego okresu eksploatacji.

6c. W przypadku wprowadzania ścieków do wód lub ziemi bez wymaganego pozwolenia wodnoprawnego albo pozwolenia zintegrowanego ilości substancji wprowadzanych ze ściekami do wód lub ziemi, tym substancji wyrażonych jako wskaźnik:
...
- **e)** po ust. 7 dodaje się ust. 7a i 7b brzmieniu: „7a. W przypadku wprowadzania wód pochodzących z obiegów chłodzących elektrowni lub elektrociepłowni do wód lub ziemi bez wymaganego pozwolenia wodnoprawnego albo pozwolenia zintegrowanego ilość wód pochodzących z obiegów chłodzących elektrowni lub elektrociepłowni ustala się toku kontroli gospodarowania wodami na podstawie maksymalnej technicznej wydajności instalacji lub urządzeń służących do wprowadzania wód pochodzących z obiegów chłodzących elektrowni lub elektrociepłowni do wód lub ziemi.

7b. W przypadku wprowadzania wód pochodzących z obiegów chłodzących elektrowni lub elektrociepłowni do wód lub ziemi bez wymaganego pozwolenia wodnoprawnego albo pozwolenia zintegrowanego temperaturę wód pochodzących z obiegów chłodzących elektrowni lub elektrociepłowni ustala się, przyjmując najwyższą dopuszczalną temperaturę określoną przepisach wydanych na podstawie art. 99 ust. 1.”, „9a. W przypadku wydobywania z wód powierzchniowych, tym morskich wód wewnętrznych wraz z wodami wewnętrznymi Zatoki Gdańskiej oraz wód morza terytorialnego, kamienia, żwiru, piasku oraz innych materiałów, a także wycinania roślin z wód lub brzegu bez wymaganego pozwolenia wodnoprawnego ilość wydobytego kamienia, żwiru, piasku oraz innych materiałów, a także wyciętych roślin z wód lub brzegu ustala się na podstawie badań, pomiarów lub innych czynności kontrolnych wykonywanych ramach kontroli gospodarowania wodami.”,

- **g)** po ust. 16b dodaje się ust. 16c i 16d brzmieniu: „16c. Podmiot obowiązany do ponoszenia opłat za usługi wodne za pobór wód do celów, o których mowa art. 270 ust. 2 pkt 4, jest obowiązany przekazywać Wodom Polskim deklaracje kwartalne o ilości energii cieplnej wyprodukowanej lub pobranej instalacji do chłodzenia lub ogrzewania, wyrażonej MWh, zgodnie ze wzorem zamieszczonym Biuletynie Informacji Publicznej na stronie podmiotowej Wód Polskich, terminie 14 dni od dnia, którym upływa dzień przypadający na koniec każdego kwartału.

16d. Deklaracja, o której mowa ust. 16c, zawiera:
...
- **3)** określenie ilości energii cieplnej wyprodukowanej lub pobranej instalacji;
...
- **27)** art. 394 ust. 1 pkt 13 kropkę zastępuje się średnikiem i dodaje się pkt 14 brzmieniu: „14) wykonanie, odbudowa, rozbudowa, przebudowa lub rozbiórka urządzeń pomiarowych ilości wód i jakości wód służących do badania przewodności i temperatury wody celu szacowania sumarycznego stężenia chlorków i siarczanów, a także lokalizowanie tych urządzeń na obszarach szczególnego zagrożenia powodzią.”;
    ...
    - **b)** pkt 20 kropkę zastępuje się średnikiem i dodaje się pkt 21 brzmieniu: „21) średnią roczną liczbę zrzutów z poszczególnych przelewów burzowych.”;

- **29)** art. 409:
    - **a)** ust. 4 pkt 11 otrzymuje brzmienie: „11) opis jakości wód miejscu zamierzonego wprowadzania ścieków do wód lub ziemi, a przypadku wprowadzania ścieków przemysłowych lub wód pochodzących z odwodnienia zakładów górniczych, zawierających chlorki i siarczany, przez zakłady odprowadzające ścieki o zwiększonym zasoleniu, także opis ilościowy wód tym miejscu, określający co najmniej SNQ tych wód;”,
    - **b)** po ust. 4 dodaje się ust. 4a brzmieniu: „4a. Operat, na podstawie którego wydaje się pozwolenie wodnoprawne na wprowadzanie ścieków do wód z uwzględnieniem wprowadzania ścieków z przelewów burzowych kanalizacji ogólnospławnej, zawiera także określenie średniej rocznej liczby zrzutów z poszczególnych przelewów burzowych.”,
    - **c)** po ust. 6 dodaje się ust. 6a brzmieniu: „6a. Operat, na podstawie którego wydaje się pozwolenie wodnoprawne na odprowadzanie wód opadowych lub roztopowych, ujętych otwarte lub zamknięte systemy kanalizacji deszczowej służące do odprowadzania opadów atmosferycznych albo systemy kanalizacji zbiorczej granicach administracyjnych miast do wód, z uwzględnieniem odprowadzania wód opadowych lub roztopowych z przelewów burzowych kanalizacji deszczowej do wód, zawiera także określenie średniej rocznej liczby zrzutów z poszczególnych przelewów kanalizacji deszczowej.”;

- **30)** art. 415 pkt 8 kropkę zastępuje się średnikiem i dodaje się pkt 9 brzmieniu: „9) dalsze korzystanie z wód na warunkach ustalonych pozwoleniu wodnoprawnym stwarza stan zagrażający życiu lub zdrowiu ludzi lub stan zagrażający powstaniu poważnych szkód środowisku, szczególności z uwagi na występujące zmiany środowisku wodnym.”;
...
- **37)** po art. 478 dodaje się art. 478a brzmieniu: „Art. 478a. Kto utrudnia lub udaremnia przeprowadzenie kontroli gospodarowania wodami albo wykrywanie i zwalczanie przestępstw lub wykroczeń przez Inspekcję Wodną, podlega karze ograniczenia wolności albo grzywny.”;
- **38)** art. 479 otrzymuje brzmienie: „Art. 479. Orzekanie sprawach o czyny, o których mowa art. 476‒478a, następuje na zasadach i trybie przepisów ustawy z dnia 24 sierpnia 2001 r. ‒ Kodeks postępowania sprawach o wykroczenia (Dz. U. z 2022 r. poz. 1124 oraz z 2023 r. poz. 1963).”;
    - **a)** po ust. 2h dodaje się ust. 2ha brzmieniu: „2ha. W celu ustalenia wysokości opłat, o których mowa art. 272 ust. 5a i 6d, oświadczenia, o których mowa ust. 2a pkt 2, zawierają także informacje o terminach, których doszło odpowiednio do uruchomienia przelewu kanalizacji deszczowej lub przelewu burzowego komunalnej kanalizacji ogólnospławnej.”,
    - **b)** po ust. 2o dodaje się ust. 2p–2s brzmieniu: „2p. W celu ustalenia wysokości opłaty, o której mowa art. 272 ust. 3a, oświadczenia, o których mowa ust. 2a pkt 2, zawierają wyrażoną MWh ilość energii cieplnej wyprodukowanej lub pobranej instalacji oraz wyrażoną m ilość wód podziemnych lub wód powierzchniowych pobranych bezzwrotnie na potrzeby technologiczne, nieprzeznaczonych wprost do produkcji energii cieplnej.
...
1. Do postępowań wszczętych i niezakończonych przed dniem wejścia życie niniejszej ustawy prowadzonych dla inwestycji dla Odry stosuje się przepisy dotychczasowe, z wyjątkiem przepisów art. 3 zakresie możliwości uzyskania finansowania lub dofinansowania inwestycji dla Odry, o których mowa art. 2 pkt 10–14, 16–19, 24–27, 29, 31 lit. a i c–i, pkt 32–41, 42 lit. b i c, pkt 44–46 i 48–50.

2. Do postępowań wszczętych i niezakończonych przed dniem wejścia życie niniejszej ustawy prowadzonych dla inwestycji dla Odry, dla których nie uzyskano decyzji o środowiskowych uwarunkowaniach, jeżeli była ona wymagana, stosuje się przepisy niniejszej ustawy.

**Art. 15.**

1. Państwowe Gospodarstwo Wodne Wody Polskie opracuje „Program odbudowy środowiska ichtiofauny rzeki Odry” terminie 6 miesięcy od dnia wejścia życie niniejszej ustawy.
...
- **1)** opis i ocenę środowiska wodnego rzeki Odry po katastrofie ekologicznej 2022 r., szczególności ichtiofauny;
- **2)** ustalenie bieżącego stanu ekosystemu wodnego rzeki Odry;
- **3)** wykaz działań mających na celu przywrócenie zrównoważonego stanu ichtiofauny rzeki Odry oraz niezbędnego do jej odbudowy ekosystemu, szczególności planowane działania zarybieniowe i planowane terminy ich realizacji;
...
3. W przypadku niezłożenia wniosku, o którym mowa ust. 1, organy właściwe sprawach pozwoleń wodnoprawnych wzywają zakłady, o których mowa ust. 1, do dopełnienia obowiązku, o którym mowa ust. 1, informując jednocześnie o skutkach jego niedopełnienia.

**Art. 17.**

1. Wydane do dnia 1 stycznia 2024 r. pozwolenia wodnoprawne na wprowadzanie ścieków do wód lub ziemi, których nie określono sposobu pobierania próbek ścieków, wygasają po upływie okresu, na jaki zostały wydane.

2. Do postępowań wszczętych i niezakończonych przed dniem 1 stycznia 2024 r. sprawie wydania pozwolenia wodnoprawnego na wprowadzanie ścieków do wód lub ziemi stosuje się przepisy dotychczasowe.

**Art. 18.** Do postępowań mandatowych wszczętych i niezakończonych przed dniem 1 stycznia 2024 r. sprawach o czyny określone art. 476 ust. 1 i 2, art. 477 pkt 4–8 oraz art. 478 pkt 2, 6 i 12–16 ustawy zmienianej art. 13 stosuje się przepisy dotychczasowe.

**Art. 19.**

1. Do postępowań wszczętych i niezakończonych przed dniem 1 stycznia 2024 r. sprawie opłaty podwyższonej, o której mowa art. 280 pkt 1 ustawy zmienianej art. 13, stosuje się przepisy dotychczasowe.

2. Do opłaty podwyższonej, o której mowa art. 280 pkt 1 ustawy zmienianej art. 13, należnej i nieuiszczonej do dnia 1 stycznia 2024 r., stosuje się przepisy dotychczasowe.

3. Za korzystanie z usług wodnych, o którym mowa art. 280 pkt 1 ustawy zmienianej art. 13, do dnia 1 stycznia 2024 r. ponosi się opłatę podwyższoną na zasadach określonych przepisach ustawy zmienianej art. 13 brzmieniu dotychczasowym.

**Art. 20.** Do dnia wydania przepisów wykonawczych na podstawie art. 251 ust. 6 ustawy zmienianej art. 13 brzmieniu nadanym niniejszą ustawą inspektorzy Inspekcji Wodnej noszą umundurowanie, którego wzór został określony przepisach wykonawczych wydanych na podstawie art. 251 ust. 6 ustawy zmienianej art. 13 brzmieniu dotychczasowym.

**Art. 21.**

1. Przepisy wykonawcze wydane na podstawie art. 251 ust. 6 ustawy zmienianej art. 13 brzmieniu dotychczasowym zachowują moc do dnia wejścia życie przepisów wykonawczych wydanych na podstawie art. 251 ust. 6 ustawy zmienianej art. 13 brzmieniu nadanym niniejszą ustawą, jednak nie dłużej niż do dnia 1 lipca 2026 r., i mogą być zmieniane na podstawie przepisów art. 251 ust. 6 ustawy zmienianej art. 13 brzmieniu dotychczasowym.

2. Przepisy wykonawcze wydane na podstawie art. 387 ust. 3 ustawy zmienianej art. 13 brzmieniu dotychczasowym zachowują moc do dnia wejścia życie przepisów wykonawczych wydanych na podstawie art. 387 ust. 3 ustawy zmienianej art. 13 brzmieniu nadanym niniejszą ustawą, jednak nie dłużej niż do dnia 1 stycznia 2026 r., i mogą być zmieniane na podstawie art. 387 ust. 3 ustawy zmienianej art. 13 brzmieniu dotychczasowym.
...
3. W przypadku przekroczenia lub zagrożenia przekroczeniem przyjętego na dany rok budżetowy maksymalnego limitu wydatków określonego ust. 1 minister właściwy do spraw gospodarki wodnej wdraża mechanizm korygujący, polegający na obniżeniu kosztów realizacji zadań, o których mowa ust. 1.
...
3. W przypadku przekroczenia lub zagrożenia przekroczeniem przyjętego na dany rok budżetowy maksymalnego limitu wydatków określonego ust. 1 minister właściwy do spraw klimatu wdraża mechanizm korygujący, polegający na obniżeniu kosztów realizacji zadań, o których mowa ust. 1.
