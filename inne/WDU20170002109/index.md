...
- **1)** sporządza i udostępnia: informacje o odmianach wpisanych do rejestru odmian, opisy botaniczne odmian wpisanych do rejestru odmian, listy odmian rolniczych, warzywnych i sadowniczych wpisanych do rejestru odmian, listy opisowe odmian, w których umieszcza się informacje o plonach, cechach jakościowych i użytkowych odmian, informacje o wynikach porejestrowego doświadczalnictwa odmianowego;
    - **a)**
    - **b)**
    - **c)**
    - **d)**
...
- **2)** współpracuje z: zagranicznymi jednostkami odpowiedzialnymi za rejestrację odmian i ochronę prawną odmian, Międzynarodowym Związkiem Ochrony Nowych Odmian Roślin (UPOV), Komisją Europejską i Wspólnotowym Urzędem Odmian Roślin (CPVO);
    - **a)**
    - **b)**
...
- **1)** przychodów z prowadzonej działalności, a w szczególności: przychodów z działalności rolniczej, przychodów z usług doświadczalnych, odsetek od środków zgromadzonych na rachunkach bankowych, innych przychodów;
    - **a)**
    - **b)**
    - **c)**
    - **d)**

- **2)** budżetu państwa w formie dotacji: podmiotowej – na dofinansowanie działalności bieżącej, celowej – na finansowanie lub dofinansowanie zadań.
    - **a)**
    - **b)**
