...
**Art. 3.** W ustawie dnia 27 sierpnia 2004 o świadczeniach opieki zdrowotnej finansowanych ze środków publicznych (Dz. U. poz. 146, 858 i 1222) 81: 2 zdaniu pierwszym wyrazy „art. 24 1–2b” zastępuje wyrazami „art. 14c, 22 4a i 4b 24 1–2b”;

**Art. 4.** W ustawie dnia 29 października o zmianie o podatku dochodowym od osób fizycznych, o podatku dochodowym od osób prawnych niektórych innych ustaw (Dz. U. poz. 2105, późn. zm. ) wprowadza następujące zmiany: 1 pkt 39 lit. d, 8 pkt 2 otrzymuje brzmienie: „2) grupy podmiotów zwolnionych obowiązku prowadzenia księgi, ksiąg rachunkowych i ewidencji środków trwałych wartości niematerialnych i prawnych przy użyciu programów komputerowych lub przesyłania księgi, ksiąg rachunkowych całości albo części lub ewidencji środków trwałych wartości niematerialnych i prawnych na podstawie 1e”;
