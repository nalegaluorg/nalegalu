...
2) 14a:
d) 6
a) 1 „6. Okres zawieszenia wykonywania „1. Przedsiębiorca niezatrudniający pracowników gospodarczej rozpoczyna się od dnia wskamoże zawiesić wykonywanie gos- zanego we wniosku wpis informacji zapodarczej na okres od 30 dni 24 miesięcy, wieszeniu wykonywania gospozastrzeżeniem 1a.”, darczej, nie wcześniej niż dniu złożenia wniosku, trwa dnia złożenia wniosku
...
wego, za minimalny okres zawieszenia wy- 3) 22b 2 konywania gospodarczej przyj- „2. W łaściwe organy zapewnią kompletność akmuje się liczbę dni miesiąca lutego przypa- tualność informacji, których mowa 1 dającą danym roku kalendarzowym. pkt 1—6 8.”;
4) 22c 4 „4. W łaściwy organ odpowiada niezwłocznie, nie później niż terminie 7 dni roboczych, na wnioski udzielenie informacji, których mowa 22b 1. W przypadku spraw wymagających konsultacji innymi właściwymi organami, termin ten może być przedłużony 14 dni roboczych. Jeżeli wniosek jest błędny, nieuzasadniony lub zawiera braki, właściwy organ jest obowiązany niezwłocznie poinformować wnioskodawcę.”;
5) 22f „Art. 22f. Rada Ministrów może określić, drodze rozporządzenia, szczegółowe warunki po pkt 1 dodaje się pkt 1a brzmieniu: „1a) data urodzenia przedsiębiorcy;”, pkt 5 6 otrzymują „5) znaczenie miejsca zamieszkania adresu zamieszkania przedsiębiorcy, adres doręczeń przedsiębiorcy oraz adresy, pod którymi jest wykonywana działalność gospodarcza, tym adres głównego miejsca wykonywania oddziału, jeżeli został utworzony; dane te są zgodne oznaczeniami kodowymi przyjętymi krajowym rejestrze urzędowym podziału terytorialnego kraju, ile to danym przypadku możliwe;
6) adres poczty elektronicznej przedsiębiorcy oraz jego strony internetowej, ile przedsiębiorca takie posiada zgłosił te informacje we wniosku wpis CEIDG;”, pkt 10 „10) n umer identyfikacji podatkowej (NIP) oraz numer identyfikacyjny REGON spółek cywilnych, jeżeli przedsiębiorca zawarł umowy takich spółek;”, pkt 11 „11) d ane pełnomocnika upoważnionego prowadzenia spraw przedsiębiorcy, wraz ze wskazaniem zakresu spraw, które obejmuje dane pełnomocnictwo, ile przedsiębiorca udzielił pełnomocnictwa zgłosił informację jego udzieleniu we wniosku wpis CEIDG;”, pkt 13 „13) informacja ograniczeniu lub utracie zdolności czynności prawnych oraz ustanowieniu kurateli lub opieki;”, pkt 16 „16) informacja zakazie prowadzenia działalności gospodarczej;”, dodaje się pkt 17—19 brzmieniu: „17) informacja zakazie wykonywania określonego zawodu, którego wykonywanie przez przedsiębiorcę podlega wpisowi CEIDG;
...
12) 30 2 „2. D wniosku sprawie zmian albo wykreślenia wpisu stosuje się odpowiednio przepisy 26—29, wyłączeniem przepisu 27 2 pkt 5.”;
13) 31 „Art. 31. 1. Wpisowi urzędu CEIDG podlegają informacje, których mowa 25 1 pkt 13—19.
...
c) pkt 3 „3) niezłożenia wniosku wpis informacji wznowieniu wykonywania gospodarczej przed upływem okresu 24 miesięcy od dnia zawieszenia wykonywania gospodarczej;”;
15) 35 „Art. 35. 1. W przypadku, gdy wpis zawiera dane niezgodne rzeczywistym stanem rzeczy, minister właściwy spraw gospodarki wzywa przedsiębiorcę dokonania odpowiedniej zmiany wpisu terminie 7 dni od dnia doręczenia wezwania.
...
c) uchyla się 6;
18) 38:
a) 2 „2. Dane informacje, których mowa 37 1 2, są udostępniane na stronie internetowej CEIDG.”,
b) uchyla się 3,
c) 4 „4. Zaświadczenia wpisie CEIDG dotyczące przedsiębiorców będących osobami fizycznymi zakresie jawnych danych, których mowa 25 1, mają formę dokumentu elektronicznego albo wydruku ze strony internetowej CEIDG.”,
d) uchyla się 6;
19) 65 3 „3. Przedsiębiorca podlegający wpisowi ewidencji może złożyć wniosek wraz oświadczeniem również urzędzie gminy, wskazując organ prowadzący rejestr regulowanej.”.
...
**Art. 6.** W ustawie dnia 19 listopada 1999 Prawo gospodarczej (Dz. U. 101, 1178, późn. zm. ) 7b 5 „5. Dane wniosku wpis ewidencji gospodarczej, organ ewidencyjny niezwłocznie, nie później niż ciągu 3 dni od dnia dokonania niu: albo prezydent miasta pozostaje organem ewidencyjnym. W takim przypadku przepisu 68 „1a. Dane przetwarzane rejestrach, których mowa nie stosuje się.”; 124 1 pkt 1 lit. a—e oraz j, prowadzonych Systemie Pobyt udostępnia się ministro- 2) 67 wi właściwemu spraw gospodarki zakresie „Art. 67. 1. O rgany koncesyjne, organy prowadzące niezbędnym prowadzenia Centralnej Ewiden- rejestry regulowanej oraz cji Informacji Działalności Gospodarczej.”. organy właściwe spraw zezwoleń
...
**Art. 12.** W ustawie dnia 4 lutego 2011 opiece nad dziećmi wieku lat 3 (Dz. U. 45, 235) 28 1 pkt 2 „2) oświadczenie numerze identyfikacyjnym REGON identyfikacji podatkowej NIP, ile wnioskodawcy te numery nadano;”.
