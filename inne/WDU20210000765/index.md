...
# RZECZYPOSPOLITEJ POLSKIEJ Poz. 765 ROZPORZĄDZENIE RADY MINISTRÓW z dnia 5 marca 2021 r.

| Pole | Wartość |
|---|---|
| Adres publikacyjny | Dz.U. 2021 poz. 765 |
| ISAP | WDU20210000765 |
...
| Źródło | [ISAP](https://isap.sejm.gov.pl/isap.nsf/DocDetails.xsp?id=WDU20210000765) · [PDF](https://api.sejm.gov.pl/eli/acts/DU/2021/765/text.pdf) |

w sprawie stanowiska mającego istotne znaczenie dla zapewnienia bezpieczeństwa jądrowego i ochrony radiologicznej Na podstawie art. 12b ust. 1 ustawy z dnia 29 listopada 2000 r. – Prawo atomowe (Dz. U. z 2021 r. poz. 623) zarządza się, co następuje:
...
**§ 3.** Szkolenie przeprowadza się w formie wykładów, ćwiczeń obliczeniowych, ćwiczeń laboratoryjnych oraz szkolenia na stanowisku pracy w zależności od zakresu szkolenia.
...
**§ 6.** Opłata za egzamin w przypadku egzaminu na uprawnienia do zajmowania stanowiska mającego istotne znaczenie dla bezpieczeństwa jądrowego i ochrony radiologicznej o określonej specjalności wynosi 300 zł.

**§ 7.** Wynagrodzenie członka komisji egzaminacyjnej uczestniczącego w składzie egzaminacyjnym przeprowadzającym egzamin wynosi 30 zł za każdą osobę przystępującą do egzaminu.
...
**§ 10.** Rozporządzenie wchodzi w życie po upływie 14 dni od dnia ogłoszenia. Prezes Rady Ministrów: M. Morawiecki Załączniki do rozporządzenia z dnia 5 marca 2021 r. (poz. ) Załącznik nr 1 SPECJALNOŚCI SPECJALNOŚCI W W ZAKRESIE ZAKRESIE STANOWISKA STANOWISKA MAJĄCEGO MAJĄCEGOISTOTNE ISTOTNE ZNACZENIE ZNACZENIE DLA ZAPEWNIENIA DLA ZAPEWNIENIA BEZPIECZEŃSTWA BEZPIECZEŃSTWA JĄDROWEGO JĄDROWEGOIOCHRONY I OCHRONY RADIOLOGICZNEJ ORAZ RADIOLOGICZNEJ SZCZEGÓŁOWE WARUNKI ORAZ SZCZEGÓŁOWE NADAWANIA UPRAWNIEŃ WARUNKINADAWANIA DO ZAJMOWANIA STANOWISKA UPRAWNIEŃ O DANEJ SPECJALNOŚCI DOZAJMOWANIA STANOWISKAO DANEJ SPECJALNOŚCI Wykształcenie Staż pracy (w latach) Zakres Lp. Specjalność wyższe średnie w warunkach szkolenia w zakresie w zakresie narażenia 1 2 3 4 5 6 1 Operator reaktora fizyki, chemii, nukleoniki, 2 R-O badawczego elektryki, energetyki, w jednostce elektroniki, elektryki, eksploatującej reaktor mechaniki, mechaniki, jądrowy informatyki elektroniki, i pokrewnych elektromechaniki i pokrewnych 2 Dozymetrysta reaktora fizyki, chemii, elektroniki, 1 R-D badawczego elektryki, chemii, w pracowni lub elektroniki, elektromechaniki, zakładzie dozymetrii mechaniki, nukleoniki w jednostce informatyki eksploatującej reaktor i pokrewnych jądrowy 3 Starszy dozymetrysta fizyki, chemii, – 2 R-D reaktora badawczego elektryki, na stanowisku elektroniki, o specjalności mechaniki, dozymetrysty reaktora informatyki badawczego i pokrewnych 4 Kierownik zmiany fizyki, chemii, nukleoniki, z ukończonymi R-OK reaktora badawczego elektryki, energetyki, studiami wyższymi – 1 elektroniki, elektryki, z wykształceniem mechaniki, mechaniki, średnim – 3 informatyki elektroniki, – na stanowisku i pokrewnych elektromechaniki o specjalności i pokrewnych operatora reaktora badawczego 5 Kierownik reaktora fizyki, chemii, – 1 R-OK badawczego elektryki, na stanowisku elektroniki, o specjalności mechaniki, kierownika zmiany informatyki reaktora badawczego i pokrewnych 1 2 3 4 5 6 6 Zastępca dyrektora do fizyki, chemii, – 1 R-OK + spraw bezpieczeństwa elektryki, na stanowisku R-D jądrowego i ochrony elektroniki, o specjalności radiologicznej mechaniki, kierownika reaktora w jednostce informatyki badawczego lub organizacyjnej i pokrewnych kierownika zmiany posiadającej reaktor reaktora badawczego badawczy 7 Specjalista do spraw dowolnym dowolnym 1 S-E ewidencji materiałów w jednostce jądrowych posiadającej materiały w obiekcie jądrowym, jądrowe w składowisku odpadów promieniotwórczych, lub w jednostce organizacyjnej wykonującej działalność z materiałami jądrowymi w ilości równej lub większej niż:

- **1)** 200 g uranu wzbogaconego U-235, plutonu lub uranu U-233 lub
- **2)** 100 sztuk materiałów jądrowych podlegających ewidencji zgodnie z rozporządzeniem Komisji (Euratom) nr 302/2005 z dnia 8 lutego 2005 r. w sprawie stosowania zabezpieczeń przyjętych przez Euratom (Dz. Urz. UE L 54 z 28.02.2005, str. 1 oraz Dz. Urz. UE L 158 z 10.06.2013, str. 74) 8 Operator fizyki, chemii, elektryki, chemii, 1 S-O przechowalnika elektryki, mechaniki, w jednostce wypalonego paliwa elektroniki, nukleoniki eksploatującej jądrowego mechaniki, przechowalnik informatyki wypalonego paliwa i pokrewnych jądrowego 1 2 3 4 5 6 9 Kierownik składowiska fizyki, chemii, elektryki, chemii, z ukończonymi S-O odpadów elektryki, mechaniki, studiami wyższymi – 1, promieniotwórczych elektroniki, nukleoniki z wykształceniem mechaniki, średnim – 3 informatyki – w składowisku i pokrewnych odpadów promieniotwórczych lub zakładzie unieszkodliwiania odpadów promieniotwórczych 10 Kierownik zakładu fizyki, chemii, – 3 S-O unieszkodliwiania elektryki, w składowisku odpadów elektroniki, odpadów promieniotwórczych mechaniki, promieniotwórczych informatyki lub zakładzie i pokrewnych unieszkodliwiania odpadów promieniotwórczych 11 Operator akceleratora fizyki, chemii, elektryki, z ukończonymi A-A stosowanego do celów informatyki, elektroniki, studiami wyższymi – 0, innych niż medyczne, dowolnym mechaniki, z wykształceniem z wyłączeniem technicznym, nukleoniki średnim – 1 akceleratorów dowolnym i pokrewnych – w pracowni stosowanych do przyrodniczym akceleratorowej kontroli pojazdów 12 Operator akceleratora dowolnym dowolnym 0 A-A stosowanego do kontroli pojazdów 13 Operator akceleratora fizyki, chemii, elektryki, z ukończonymi S-A stosowanego do celów biologii, elektroniki, studiami wyższymi – 0, medycznych oraz dowolnym mechaniki, z wykształceniem urządzeń do medycznym, medycyny, średnim – 1 teleradioterapii dowolnym nukleoniki – w pracowni technicznym akceleratorowej 14 Operator urządzeń do fizyki, chemii, elektryki, z ukończonymi S-Z brachyterapii ze biologii, elektroniki, studiami wyższymi – 0, źródłami dowolnym mechaniki, z wykształceniem promieniotwórczymi medycznym, medycyny, średnim – 1 dowolnym nukleoniki – w pracowni technicznym radioterapeutycznej ze źródłami promieniotwórczymi ZAKRESY SZKOLEŃ DLA OSÓB, KTÓRE UBIEGAJĄ SIĘ O UPRAWNIENIA UMOŻLIWIAJĄCE ZATRUDNIENIE NA STANOWISKU MAJĄCYM ISTOTNE ZNACZENIE DLA ZAPEWNIENIA BEZPIECZEŃSTWA JĄDROWEGO I OCHRONY RADIOLOGICZNEJ

1. Szkolenie typu A-A Tematy wykładów:
...
- **9)** zasady postępowania w sytuacjach zdarzeń radiacyjnych (min. 1 godzina). Analiza dokumentacji techniczno-technologicznej akceleratora i źródeł promieniowania jonizującego oraz stosowanych w pracowni procedur, w formie ćwiczeń laboratoryjnych wraz ze szkoleniem stanowiskowym (min. 2 godziny).

2. Szkolenie typu S-A Tematy wykładów jak w szkoleniu typu A-A oraz:
...
- **3)** program zapewnienia jakości w pracowni akceleratorowej i teleradioterapeutycznej (min. 4 godziny). Analiza dokumentacji techniczno-technologicznej akceleratora i urządzeń do teleradioterapii oraz stosowanych w pracowni procedur, w formie ćwiczeń laboratoryjnych wraz ze szkoleniem stanowiskowym (min. 2 godziny).

3. Szkolenie typu S-Z Tematy wykładów jak w szkoleniu typu A-A, z wyłączeniem zasad fizyki akceleratorów, oraz:
...
- **4)** podstawowe wiadomości z zakresu budowy oraz zasady działania urządzeń do brachyterapii (min. 2 godziny). Analiza dokumentacji techniczno-technologicznej urządzeń do brachyterapii ze źródłami promieniotwórczymi oraz stosowanych w pracowni procedur, w formie ćwiczeń laboratoryjnych wraz ze szkoleniem stanowiskowym (min. 2 godziny).

4. Szkolenie typu S-E Tematy wykładów:
...
5. Szkolenie typu S-O Tematy wykładów jak w szkoleniu typu S-E oraz:
...
- **5)** przygotowanie dokumentów w jednostce organizacyjnej: regulamin pracy, technologiczne instrukcje pracy, rejestry dawek, rejestry źródeł, zakładowy plan postępowania awaryjnego (min. 2 godziny). Analiza dokumentacji techniczno-technologicznej, łącznie z planami postępowania awaryjnego, składowiska odpadów promieniotwórczych (min. 2,5 godziny) lub przechowalnika wypalonego paliwa jądrowego (min. 6 godzin), w formie ćwiczeń laboratoryjnych.

6. Szkolenie typu R-O Tematy wykładów jak w szkoleniu typu S-E oraz:
...
- **12)** limity i warunki eksploatacyjne w reaktorze badawczym (min. 1 godzina). Analiza dokumentacji techniczno-technologicznej, w tym raportu bezpieczeństwa, reaktora badawczego, w formie ćwiczeń laboratoryjnych (min. 8 godzin), ze szczególnym uwzględnieniem następujących tematów:
...
- **13)** procedury eksploatacyjne. Ćwiczenia laboratoryjne i obliczeniowe z zakresu fizyki reaktorowej, obejmujące w szczególności kalibrację prętów regulacyjnych, metody sterowania reaktorem, pomiary efektów reaktywnościowych, gęstości strumienia neutronów i dawek, kontrolę stanu elementów paliwowych w reaktorze, kontrolę uwolnień z reaktora badawczego (min. 8 godzin). Szkolenie stanowiskowe na pracującym reaktorze, w wybranych zespołach służb eksploatacyjnych i pracowni reaktora, według programu indywidualnego przygotowanego przez kierownika jednostki (min. 4 godziny).

7. Szkolenie typu R-OK Tematy wykładów jak w szkoleniu typu R-O oraz:

- **1)** fizyka reaktorowa – uzupełnienie (min. 4 godziny);
- **2)** planowanie awaryjne (min. 5 godzin);
- **3)** określanie narażenia radiacyjnego w obiekcie reaktora badawczego (min. 2 godziny). Analiza dokumentacji techniczno-technologicznej reaktora, w formie ćwiczeń laboratoryjnych, szczególnie w zakresie procedur eksploatacyjnych, postępowania awaryjnego i ochrony fizycznej reaktora (min. 8 godzin).

8. Szkolenie typu R-D Tematy wykładów jak w szkoleniu typu S-E oraz:
...
- **8)** kontrola narażenia indywidualnego od skażeń promieniotwórczych (powierzchniowych i przestrzennych) (min. 1 godzina). Analiza dokumentacji techniczno-technologicznej, w tym raportu bezpieczeństwa, reaktora badawczego, w formie ćwiczeń laboratoryjnych (min. 8 godzin), ze szczególnym uwzględnieniem następujących tematów:
