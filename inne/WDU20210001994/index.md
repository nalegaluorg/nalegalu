...
w § 26:
a)
w ust. 1 zdanie pierwsze otrzymuje brzmienie: „ Komisja przygotowuje dla każdej dyscypliny naukowej i artystycznej propozycje zestawów wartości referencyjnych dla kategorii naukowych A, B+ i B. ” ,
b)
w ust. 2 wprowadzenie do wyliczenia otrzymuje brzmienie: „ Komisja przygotowuje propozycje zestawów wartości referencyjnych, o których mowa w ust. 1, biorąc pod uwagę: ” ,
c)
