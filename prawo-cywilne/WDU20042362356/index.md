...
- **2)** art. 7 otrzymuje brzmienie:
  ...
  > 5. Minister Sprawiedliwości, w terminie do dnia 31 marca każdego roku, ogłasza, w drodze obwieszczenia w Dzienniku Urzędowym Rzeczypospolitej Polskiej „Monitor Polski”,  

  wykaz rewirów i siedzib kancelarii komorniczych.”;
- **3)** w art. 8 ust. 1-4 otrzymują brzmienie:
  ...
  > 4. Z wyłączeniem spraw o egzekucję z nieruchomości komornik może, na pisemny wniosek wierzyciela, prowadzić egzekucję na obszarze właściwości sądu apelacyjnego, jeżeli w zakresie prowadzonych przez tego komornika egzekucji zaległość nie przekracza sześciu miesięcy. Zaległość oblicza się, dzieląc liczbą spraw niezałatwionych w roku poprzednim przez średni miesięczny wpływ spraw w roku poprzednim - z wyłączeniem spraw o egzekucję świadczeń powtarzających się.”;  
...
- **5)** po art. 11dodaje się art. 11a w brzmieniu:
...
- **11)** po art. 27dodaje się art. 27a w brzmieniu:
...
- **26)** art. 63 otrzymuje brzmienie:
  ...
  > „Art. 63.  
  > 1. Z zastrzeżeniem odmiennej umowy zawartej między komornikiem i zastępcą komornika, o którym mowa w art. 26, zastę pca komornika pobiera 25% dochodu zastępowanego komornika w pierwszym miesiącu sprawowania zastępstwa, a w następnych miesiącach - 50% tego dochodu.  
...
- **27)** w art. 64 ust. 2 i ust. 3 otrzymują brzmienie:
...
- **29)** w art. 71 w pkt 4 kropkę zastępuje się przecinkiem i dodaje się pkt 5 i pkt 6 w brzmieniu: „5) podejmowanie czynności z rażącą zwłoką, 6) naruszenie właściwości określonej w art. 8.”;
