...
998866 Załącznik nr 2 WZÓR KARTA PRZEDSIĘBIORSTWA Załącznik nr 3 WZÓR KARTA WARSZTATOWA Załącznik nr 4 WZÓR KARTA KONTROLNA Załącznik nr 5 OPIS WZORÓW KART DO TACHOGRAFÓW CYFROWYCH I. POSTANOWIENIA OGÓLNE
...
f) cyfry i litery, które oznaczają: 1 nazwisko kierowcy, 2 imię (imiona) kierowcy, 3 datę urodzenia kierowcy (w formacie „dd.mm.rrrr”), 4a datę początku okresu ważności karty (w formacie „dd.mm.rrrr”), 4b datę ważności karty (w formacie „dd.mm.rrrr”), 4c nazwę podmiotu wydającego kartę, 4d numer PESEL kierowcy, a w przypadku osoby nieposiadającej numeru PESEL numer i nazwę dokumentu potwierdzającego tożsamość oraz nazwę organu, który wydał ten dokument, 5a numer prawa jazdy kierowcy, 5b numer karty, 6 zdjęcie kierowcy, 7 podpis posiadacza karty.
...
1. Nazwisko
2. Imię (Imiona)
3. Data urodzenia 4a. Data początku okresu ważności karty 4b. Data ważności karty 4c. Podmiot wydający kartę 4d. Numer PESEL 5a. Numer prawa jazdy 5b. Numer karty
6. Zdjęcie
7. Podpis.
...
e) cyfry i litery, które oznaczają: 1 nazwę przedsiębiorstwa, 4a datę początku okresu ważności karty (w formacie „dd.mm.rrrr”), 4b datę ważności karty (w formacie „dd.mm.rrrr”), 4c nazwę podmiotu wydającego kartę, 5b numer karty, 8 adres pocztowy przedsiębiorstwa.
...
1. Nazwa przedsiębiorstwa 4a. Data początku okresu ważności karty 4b. Data ważności karty 4c. Podmiot wydający kartę 5b. Numer karty
8. Adres.
...
f) cyfry i litery, które oznaczają: 1 nazwę warsztatu, 2 nazwisko posiadacza karty, 3 imię (imiona) posiadacza karty, 4a datę początku okresu ważności karty (w formacie „dd.mm.rrrr”), 4b datę ważności karty (w formacie „dd.mm.rrrr”), 4c nazwę podmiotu wydającego kartę, 4d numer PESEL technika warsztatu, a w przypadku osoby nieposiadającej numeru PESEL numer i nazwę dokumentu potwierdzającego tożsamość oraz nazwę organu, który wydał ten dokument, 5b numer karty, 6 zdjęcie technika warsztatu, 7 podpis posiadacza karty, 8 adres pocztowy warsztatu.
...
1. Nazwa warsztatu
2. Nazwisko
3. Imię (Imiona) 4a. Data początku okresu ważności karty 4b. Data ważności karty 4c. Podmiot wydający kartę 4d. Numer PESEL 5b. Numer karty
6. Zdjęcie
7. Podpis
8. Adres warsztatu.
...
f) cyfry i litery, które oznaczają: 1 skróconą nazwę organu kontrolnego, 2 nazwisko kontrolera, 3 imię (imiona) kontrolera, 4a datę początku okresu ważności karty (w formacie „dd.mm.rrrr”), 4b datę ważności karty (w formacie „dd.mm.rrrr”), 4c nazwę podmiotu wydającego kartę, 5b numer karty, 6 zdjęcie kontrolera, 7 podpis posiadacza karty, 8 adres pocztowy organu kontrolnego.
...
1. Organ kontrolny
2. Nazwisko
3. Imię (Imiona) 4a. Data początku okresu ważności karty 4b. Data ważności karty 4c. Podmiot wydający kartę 5b. Numer karty
6. Zdjęcie
7. Podpis
