...
| Pole | Wartość |
|---|---|
| Adres publikacyjny | Dz.U. 2004 nr 281 poz. 2780 |
| ISAP | WDU20042812780 |
| Typ aktu | Ustawa |
| Status | akt objęty tekstem jednolitym |
| W mocy | tak |
...
- **1)** uchyla się art. 12;
- **2)** w art. 33a: Pobrana należność za przewóz i opłata dodatkowa, po uiszczeniu opłaty manipulacyjnej odpowiadającej kosztom poniesionym przez przewoźnika, podlegają zwrotowi, a w przypadku wezwania do zapłaty – umorzeniu, w przypadku udokumentowania przez podróżnego, nie później niż w terminie 7 dni od dnia przewozu, uprawnień do bezpłatnego lub ulgowego przejazdu.
    - **a)** ust. 3 otrzymuje brzmienie: „3. W razie stwierdzenia braku odpowiedniego dokumentu przewozu przewoźnik lub osoba przez niego upoważniona pobierają właściwą należność za przewóz i opłatę dodatkową albo wystawiają wezwanie do zapłaty.”,
    - **b)** po ust. 3 dodaje się ust. 3a-3c w brzmieniu: „3a. W razie stwierdzenia braku ważnego dokumentu poświadczającego uprawnienie do bezpłatnego albo ulgowego przejazdu przewoźnik lub osoba przez niego upoważniona pobierają właściwą należność za przewóz i opłatę dodatkową albo wystawiają wezwanie do zapłaty.
...
- **4)** po art. 34 dodaje się art. 34a w brzmieniu: „Art. 34a. 1. Minister właściwy do spraw transportu określi, w drodze rozporządzenia:
...
- **7)** art. 79 otrzymuje brzmienie: „Art. 79. Minister właściwy do spraw transportu określi, w drodze rozporządzenia:
