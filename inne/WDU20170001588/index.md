...
| Źródło | [ELI HTML](https://eli.gov.pl/api/acts/DU/2017/1588/text.html) · [ELI API](https://api.sejm.gov.pl/eli/acts/DU/2017/1588) |
...
w § 2 w ust. 1 w pkt 6 wyrazy „budowy lub przebudowy” zastępuje się wyrazem „rozwoju”;
...
w ust. 1 w pkt 4 po wyrazie „inwestycje” dodaje się wyrazy „trwale związane z nieruchomością”,

### b)

w ust. 3 w pkt 1 wyrazy „organizację pożytku publicznego będącą organizacją pozarządową” zastępuje się wyrazami „organizację pozarządową w rozumieniu art. 3 ust. 2 ustawy z dnia 24 kwietnia 2003 r. o działalności pożytku publicznego i o wolontariacie (Dz. U. z 2016 r. poz. 1817 i 1948 oraz z 2017 r. poz. 60 i 573), zwaną dalej „organizacją pozarządową”,”;
...
w pkt 3 wyrazy „7-9” zastępuje się wyrazami „7 i 9”,
...
granty zostaną udzielone grantobiorcom na podstawie umowy o powierzenie grantu, do wysokości limitu, który wynosi 100 tys. złotych na jednego grantobiorcę w ramach projektów grantowych realizowanych przez daną LGD;
...
w pkt 6 wyrazy „zakupu środków” zastępuje się wyrazami „zakupu nowych środków”,

### b)

w pkt 7 po wyrazie „zakupu” dodaje się wyraz „nowych”;
...
w pkt 2 przed wyrazami „63,63%” dodaje się wyrazy „nie wyższej niż”;

### 7)

w § 22 w ust. 1 we wprowadzeniu do wyliczenia wyraz „3” zastępuje się wyrazem „4”;
...
w ust. 1a we wprowadzeniu do wyliczenia skreśla się wyrazy „i 5”,

### c)

w ust. 2 we wprowadzeniu do wyliczenia skreśla się wyrazy „przepisu ust. 1 pkt 5 nie stosuje się, a”;
...
kwoty grantów udzielonych grantobiorcom w wysokości przekraczającej limit wynoszący 100 tys. złotych na jednego grantobiorcę w ramach projektów grantowych realizowanych przez daną LGD;
...
w ust. 6 wyrazy „ust. 4 pkt 1” zastępuje się wyrazami „§ 13 ust. 1 pkt 4”.
