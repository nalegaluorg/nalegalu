...
ROZPORZĄDZENIE MINISTRA FINANSÓW z dnia 9 grudnia 2023 r.
w sprawie elektronicznej wymiany danych z Systemu Informacji Finansowej Na podstawie art. 28 ustawy z dnia 1 grudnia 2022 r. o Systemie Informacji Finansowej (Dz. U. z 2023 r. poz. 180) zarządza się, co następuje: § 1. Rozporządzenie określa:
...
§ 3. 1. Podmiot uprawniony prowadzi wymianę danych z użyciem protokołu HTTPS oraz bezpiecznego połączenia VPN.
...
§ 5. 1. GUI umożliwia podmiotowi uprawnionemu dostęp do danych zawierających:
...
§ 6. 1. Udostępnienie informacji rejestrowanej następuje na podstawie:
...
§ 7. 1. Zapytanie od osoby upoważnionej na podstawie art. 21 ust. 1 ustawy uzupełnia o dane zawierające:
1) unikalny identyfikator dostępu do SInF nadany użytkownikowi przez podmiot uprawniony;
2) informację o dacie nadania upoważnienia do dostępu do SInF osobie posługującej unikalnym identyfikatorem dostępu do SInF.
dostępu do SInF podmiot uprawniony przekazuje do organu właściwego za pośrednictwem kanału łączności, o którym mowa w § 4 ust. 1.
