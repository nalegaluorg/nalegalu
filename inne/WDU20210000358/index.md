...
- **1)** w § 5:
    ...
    - **b)** pkt 2 otrzymuje brzmienie:
      ...
      > a) wyszkolenie bojowe, b) odpowiedzialność, c) determinacja w dążeniu do celu, d) trafność i szybkość podejmowania decyzji, e) odporność na stres, f) komunikatywność i umiejętność pracy w zespole, g) stosowanie się do przepisów, norm i reguł, h) rozwój własny i podnoszenie kwalifikacji, i) dbałość o sprzęt i mienie, j) kultura osobista i dbałość o wygląd zewnętrzny.”;  
...
- **4)** § 7 otrzymuje brzmienie:
  ...
  > „§ 7.  
  > 1. Ocenę poszczególnych kryteriów kompetencji i predyspozycji opiniowanego, o których mowa w § 5 pkt 2, wyraża się punktowo:  
...
**§ 3.** Rozporządzenie wchodzi w życie po upływie 14 dni od dnia ogłoszenia. Minister Obrony Narodowej: z up. W. Skurkiewicz Załącznikdo rozporządzenia Ministra ObronyNarodowejzdnia 16 lutego 2021 r.(poz. .) WZÓR WZÓR OPINIA SŁUŻBOWA ODWOŁANIE OD OPINII SŁUŻBOWEJ ODWOŁANIE OD OPINII SŁUŻBOWEJ WERYFIKOWANIE OPINII SŁUŻBOWEJ
