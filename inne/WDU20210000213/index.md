...
# Obwieszczenie Marszałka Sejmu Rzeczypospolitej Polskiejz dnia 22 stycznia 2021 r. w sprawie ogłoszenia jednolitego tekstu ustawy o ochronie prawnej odmian roślin
...
Treść obwieszczenia
Załącznik – Tekst jednolity ustawy z dnia 26 czerwca 2003 r. o ochronie prawnej odmian roślin Rozdział 1 – Przepisy ogólne Rozdział 2 – Wyłączne prawo hodowcy do odmiany Rozdział 2a – Dochodzenie roszczeń w postępowaniu cywilnym Rozdział 3 – Przepisy karne Rozdział 4 – Przepisy przejściowe i końcowe
Treść obwieszczenia
1.
...
- **9)** art. 21, który wchodzi w życie z dniem 27 lutego 2020 r. ” . Załącznik – Tekst jednolity ustawy z dnia 26 czerwca 2003 r. o ochronie prawnej odmian roślin
...
- **7)** hodowca – oznacza osobę, która: wyhodowała albo odkryła i wyprowadziła odmianę albo jest lub była pracodawcą osoby, o której mowa w lit. a, albo zawarła umowę, w ramach której inna strona tej umowy wyhodowała albo odkryła i wyprowadziła odmianę, albo jest następcą prawnym osób, o których mowa w lit. a i b;
    - **a)**
    - **b)**
    - **c)**
...
- **2)** w pozostałych państwach: przez okres dłuższy niż sześć lat – w przypadku drzew i winorośli, przez okres dłuższy niż cztery lata – w przypadku pozostałych odmian licząc do dnia złożenia wniosku o przyznanie wyłącznego prawa.
    - **a)**
    - **b)**

2. Odmianę również uważa się za nową, jeżeli hodowca przed dniem złożenia wniosku o przyznanie wyłącznego prawa:

- **1)** sprzedał albo w inny sposób udostępnił: materiał siewny odmiany podmiotom podległym lub nadzorowanym przez ministra właściwego do spraw rolnictwa, które w ramach swojej działalności statutowej prowadzą badania odmian, lub części roślin wytworzone w wyniku prac hodowlanych, rozmnożeniowych lub doświadczalnych, które nie są materiałem siewnym, materiał siewny odmiany na międzynarodową wystawę organizowaną zgodnie z Konwencją z dnia 22 listopada 1928 r. o wystawach międzynarodowych (Dz. U. z 1994 r. poz. 232);
    - **a)**
    - **b)**
    - **c)**
...
- **1)** umożliwić Centralnemu Ośrodkowi: przeprowadzenie kontroli zachowania odmiany, wgląd do dokumentów dotyczących zachowania odmiany;
    - **a)**
    - **b)**
...
- **2)** materiał siewny roślin ozdobnych i sadowniczych, jeżeli jest on ponownie używany w celach zarobkowych jako: materiał rozmnożeniowy do produkcji roślin ozdobnych albo kwiat cięty, albo materiał siewny drzew, krzewów i bylin;
    - **a)**
    - **b)**
    - **c)**

- **3)** odmiany: pochodne, odkryte lub wytworzone z chronionej odmiany macierzystej niebędącej odmianą pochodną, które nie różnią się wyraźnie od odmiany chronionej, w przypadku których wytworzenie materiału siewnego wymaga powtarzalnego używania odmiany chronionej wyłącznym prawem.
    - **a)**
    - **b)**
    - **c)**
...
- **1)** dotyczy materiału siewnego następujących roślin: bobiku, grochu siewnego, jęczmienia, kukurydzy, lnu zwyczajnego (oleistego), lucerny siewnej, łubinu wąskolistnego, łubinu żółtego, owsa, pszenicy twardej, pszenicy zwyczajnej, pszenżyta, rzepaku, rzepiku, wyki siewnej, żyta, ziemniaka, soi;
    - **a)**
    - **b)**
    - **c)**
    - **d)**
...
- **5)** sposób i termin rozliczenia pobranej przez organizację hodowców opłaty, o której mowa w ust. 1, na rzecz hodowcy. (uchylony)
...
7. W przypadku odmowy albo braku możliwości podpisania protokołu przez przetwórcę, protokół podpisuje przeprowadzający kontrolę i dokonuje w protokole adnotacji o tej odmowie albo o przyczynach uniemożliwiających podpisanie tego protokołu. Po przyznaniu wyłącznego prawa hodowca jest obowiązany:
...
- **3)** jeżeli hodowca: nie zachowuje odmiany, zalega ponad 6 miesięcy z uiszczaniem opłat, o których mowa w art. 19 ust. 1, uniemożliwia przeprowadzenie kontroli zachowania odmiany i sprawdzenie dokumentacji dotyczącej zachowania odmiany, nie udziela informacji i wyjaśnień niezbędnych do przeprowadzenia badań OWT, nie dostarczył bezpłatnie materiału siewnego w ilości niezbędnej do przeprowadzenia badań OWT, nie nadał odmianie nowej nazwy, w przypadku gdy nazwa odmiany wpisanej do księgi ochrony wyłącznego prawa, o której mowa w art. 36 ust. 1, nie spełnia wymagań wymienionych w art. 9 ust. 1.
    - **a)**
    - **b)**
    - **c)**
    - **d)**
...
- **2)** oznacza nazwą odmiany chronionej wyłącznym prawem materiał siewny lub materiał ze zbioru innej lub nieznanej odmiany podlega grzywnie, karze ograniczenia wolności albo pozbawienia wolności do roku. Kto:
