...
# RZECZYPOSPOLITEJ POLSKIEJ Poz. 2267 ROZPORZĄDZENIE RADY MINISTRÓW z dnia 14 grudnia 2015 r.

| Pole | Wartość |
|---|---|
| Adres publikacyjny | Dz.U. 2015 poz. 2267 |
| ISAP | WDU20150002267 |
...
| Źródło | [ISAP](https://isap.sejm.gov.pl/isap.nsf/DocDetails.xsp?id=WDU20150002267) · [PDF](https://api.sejm.gov.pl/eli/acts/DU/2015/2267/text.pdf) |

w sprawie odpadów promieniotwórczych i wypalonego paliwa jądrowego Na podstawie art. 57a ustawy z dnia 29 listopada 2000 r. – Prawo atomowe (Dz. U. z 2014 r. poz. 1512 oraz z 2015 r.
poz. 1505 i 1893) zarządza się, co następuje:
...
**§ 5.** Nie kwalifikuje się do kategorii odpadów promieniotwórczych niskoaktywnych:

- **1)** mas ziemnych lub skalnych przemieszczanych w związku z wydobywaniem kopalin ze złóż,
- **2)** odpadów wydobywczych,
- **3)** niezanieczyszczonej gleby i innych materiałów występujących w stanie naturalnym, wydobytych w trakcie robót budowlanych – zawierających naturalne izotopy promieniotwórcze, jeżeli suma stosunków maksymalnych stężeń tych izotopów, wynikających z niejednorodności odpadów, do wartości określonych w załączniku nr 1 do rozporządzenia nie przekracza 10 dla reprezentatywnej próbki odpadów o masie 1 kg.
...
**§ 37.** Maksymalna moc dawki na powierzchni opakowania do składowania odpadów promieniotwórczych zawierającego odpady promieniotwórcze nie może przekraczać 2 mSv/h, a w odległości 1 m od powierzchni opakowania – 0,1 mSv/h, przy czym skażenia niezwiązane na powierzchni opakowania nie mogą przekraczać 40 kBq/m dla izotopów beta- i gammapromioniotwórczych oraz 4 kBq/m dla izotopów alfapromieniotwórczych.
