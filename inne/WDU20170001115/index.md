...
# RZECZYPOSPOLITEJ POLSKIEJ Poz. 1115 RozpoRządzenie MinistRa infRastRuktuRy i Budownictwa z dnia 19 maja 2017 r.
...
**§ 59.** Licencję kontrolera ruchu lotniczego wydaje się kandydatowi, który spełnił wymagania określone w ATCO.B.005 lit. c w załączniku I do rozporządzenia nr 2015/340 oraz wykazał się biegłością językową w zakresie języka polskiego co najmniej na poziomie 4 operacyjnym, poświadczoną odpowiednim dokumentem.
...
- **5)** wykonywania czynności informatora AFIS z zastosowaniem ustalonych procedur i instrukcji operacyjnych, w szczególności:
    - **a)** prowadzenia korespondencji radiotelefonicznej z zachowaniem następujących standardów: – stosowanie technik pracy z mikrofonem, – wymowa we właściwym tempie i z prawidłową dykcją, – stosowanie frazeologii lotniczej, – zrozumiała komunikacja, gdy zakres przekazywanych informacji wykracza poza obowiązującą frazeologię,
    - **b)** odbioru informacji z różnych źródeł, ich analizy i przekazywania właściwym odbiorcom we właściwym czasie;
...
- **2)** § 68 pkt 4, § 70 pkt 2, § 72 pkt 2, § 74 pkt 3, § 81 ust. 1 pkt 2, § 84 pkt 2, § 86 ust. 1 pkt 4, § 90 pkt 2, § 92 pkt 2, § 94 ust. 1 pkt 3, § 97 ust. 1 pkt 2, § 100 pkt 3, które wchodzą w życie z dniem 1 maja 2020 r. Minister Infrastruktury i Budownictwa: A. Adamczyk Załącznik nr 1 Załącznik nr 1

1. Nazwy SKRÓTY poszczególnych NAZW UPRAWNIEŃ świadectw WPISYWANYCH kwalifikacji. DO ŚWIADECTWA KWALIFIKACJI

1. Nazwy poszczególnych świadectw kwalifikacji. Nazwa specjalności Symbol świadectwa w języku polskim Nazwa specjalności w języku angielskim Symbol kwalifikacji świadectwa informator w języku służby polskim informacji w języku angielskim flight information service officer kwalifikacji FISC powietrznej informator służby informacji informator lotniskowej służby flight aerodrome information flight service information officer FISC powietrznej AFISC informacji powietrznej service officer informator lotniskowej służby aerodrome flight information AFISC informacji powietrznej service officer

2. Skróty nazw uprawnień i uprawnień uzupełniających wpisywane do świadectw kwalifikacji.

2. Skróty nazw uprawnień i uprawnień uzupełniających wpisywane do świadectw kwalifikacji. Symbol/skrót Nazwa w języku polskim Nazwa w języku angielskim Symbol/skrót Wpisy do świadectwa Nazwa kwalifikacji w języku polskim informatora służby Nazwa informacji w języku powietrznej angielskim uprawnienie obszarowej służby Flight Information Service FIS Wpisy do świadectwa kwalifikacji informatora służby informacji powietrznej informacji powietrznej Rating uprawnienie obszarowej służby Flight Information Service FIS uprawnienie radarowej obszarowej Radar Information Service RIS informacji powietrznej Rating służby informacji powietrznej Rating uprawnienie radarowej obszarowej Radar Information Service RIS uzupełniające uprawnienie On-the-Job Training Instructor OJTI służby informacji powietrznej Rating instruktorskie Endorsement uzupełniające uprawnienie On-the-Job Training Instructor OJTI uprawnienie uzupełniające instruktora instruktorskie Endorsement szkolenia na szkoleniowych Synthetic Training Device STDI uprawnienie uzupełniające instruktora urządzeniach symulacji ruchu Instructor Endorsement szkolenia na szkoleniowych Synthetic Training Device STDI lotniczego urządzeniach symulacji ruchu Instructor Endorsement Wpisy do świadectwa kwalifikacji informatora lotniskowej służby informacji lotniczego powietrznej Wpisy do świadectwa kwalifikacji informatora lotniskowej służby informacji uzupełniające uprawnienie On-the-Job Training Instructor OJTI powietrznej instruktorskie Endorsement uzupełniające uprawnienie On-the-Job Training Instructor OJTI uprawnienie uzupełniające instruktora instruktorskie Endorsement szkolenia na szkoleniowych Synthetic Training Device STDI uprawnienie uzupełniające instruktora urządzeniach symulacji ruchu Instructor Endorsement szkolenia na szkoleniowych Synthetic Training Device STDI lotniczego urządzeniach symulacji ruchu Instructor Endorsement lotniczego Oprócz wymienionych w tabeli uprawnień oraz uprawnień uzupełniających do świadectw kwalifikacji wpisuje się uprawnienie uzupełniające w jednostce w formie skrótu odpowiedniej nazwy lotniska albo części przestrzeni Oprócz wymienionych powietrznej, opublikowanego w tabeli uprawnień w Zintegrowanym oraz uprawnień Pakiecie uzupełniających Informacji do Lotniczych, świadectw w części kwalifikacji Zbiór Informacji wpisuje się Lotniczych uprawnienie (AIP uzupełniające Polska). w jednostce w formie skrótu odpowiedniej nazwy lotniska albo części przestrzeni powietrznej, opublikowanego w Zintegrowanym Pakiecie Informacji Lotniczych, w części Zbiór Informacji Lotniczych (AIP Polska).

3. Treść wpisów do świadectw kwalifikacji potwierdzających spełnienie wymogu posiadania biegłości językowej. Wpis w języku polskim Wpis w języku angielskim Spełnienie wymogu posiadania biegłości językowej Polski/poziom … /data Polish/level …/date Angielski/poziom …/data English/level …/date Objaśnienia:
...
- **2)** standardowe części oznaczone numeracją rzymską, zawierające wpisy do świadectwa kwalifikacji stałe i zmienne: 7 Załącznik nr 3 SZCZEGÓŁOWE WARUNKI I SPOSÓB PROWADZENIA SZKOLENIA LOTNICZEGO W celu zapewnienia właściwych warunków i sposobu prowadzenia szkolenia lotniczego w celu uzyskania świadectw kwalifikacji oraz uprawnień do nich wpisywanych organizacja szkoleniowa:
    ...
    - **g)** część VI jest przeznaczona na wpisanie obywatelstwa w języku polskim i angielskim, 6
...
- **9)** posiada, z zastrzeżeniem pkt 11, system zarządzania jakością, za pomocą którego:
    ...
    - **b)** określa program zapewnienia jakości, zawierający procedury przeznaczone do weryfikacji zgodności systemów oraz wszystkich zachodzących procesów z mającymi zastosowanie wymogami, standardami i procedurami, 8
...
- **10)** posiada, z wyjątkiem organizacji, która szkoli wyłącznie w celu uzyskania świadectwa AFIS, instrukcję systemu jakości, która zawiera co najmniej: 9
...
- **16)** utrzymuje aktualność informacji zawartych w instrukcji szkolenia i dokonuje zmian, jeżeli co najmniej:
    ...
    - **b)** wynikają z doświadczenia w pracy operacyjnej, lub 10
...
- **24)** wykazuje formę świadczenia pracy na jej rzecz przez osoby niebędące jej etatowymi pracownikami; 11
...
- **30)** szczegółowo określa kwalifikacje osób prowadzących egzaminy w ramach szkolenia wstępnego, w tym również szkolenia na urządzeniach symulacji ruchu lotniczego; 12
...
- **40)** ustanawia i prowadzi system archiwizacji procesu szkolenia gwarantujący:
    - **a)** kompletność danych w celu umożliwienia rekonstrukcji historii szkolenia każdego kandydata i instruktora lub wykładowcy w organizacji, 13
    - **b)** integralność danych w celu ochrony przechowywanych danych przed usunięciem lub zmianą;

- **41)** ustanawia procedurę archiwizacji procesu szkolenia oraz określa zakres archiwizowanej dokumentacji i przechowuje: 14 Załącznik nr 4 MINIMUM WYMAGANYCH INFORMACJI, JAKIE POWINNA ZAWIERAĆ INSTRUKCJA SZKOLENIA
...
1. 1. Wstęp. Informacje dotyczące zakresu stosowania instrukcji.
...
- **1)** planowanie i organizacja szkolenia; 16
- **2)** przebieg szkolenia;
- **3)** kontrola postępów i wyników szkolenia;
- **4)** dokumentacja i sprawozdawczość szkoleniowa;
- **5)** dokumentacja podlegająca archiwizacji.
...
5. 7. Procedury zawieszenia kandydata w obowiązkach uczestnika szkolenia. 17
...
9. 1. Wzory dokumentów. 18 MINIMA PROGRAMOWE DO SZKOLEŃ KANDYDATÓW UBIEGAJĄCYCH SIĘ O ŚWIADECTWO Załącznik FIS nr 5 I UPRAWNIENIA DO NIEGO WPISYWANE ORAZ O ŚWIADECTWO AFIS
...
- **8)** środowisko zawodowe: cywilne i wojskowe służby ATS, użytkownicy przestrzeni powietrznej i ich potrzeby, ochrona środowiska;
- **9)** lotniska: charakterystyczne dane lotniska, informacje przekazywane pomiędzy AFIS i zarządzającym lotniskiem, pole ruchu naziemnego, pole manewrowe, drogi startowe, przeszkody, lokalizacja naziemnego wyposażenia lotniskowego. SZCZEGÓŁOWE WYMAGANIA DOTYCZĄCE SZKOLENIA PERSONELU FIS W CELU UTRZYMANIA Załącznik nr 6 UPRAWNIEŃ UZUPEŁNIAJĄCYCH W JEDNOSTCE
...
- **2)** obejmuje zagadnienia dotyczące frazeologii lotniczej oraz zrozumiałej komunikacji. MINIMUM PROGRAMOWE DO SZKOLENIA W ZAKRESIE OJTI LUB STDI Załącznik nr 7
