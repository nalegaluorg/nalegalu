---
title: Rozporządzenie Ministra Nauki i Szkolnictwa Wyższego z dnia 8 maja 2026 r. zmieniające rozporządzenie w sprawie studiów
address: WDU20260000643
eli: DU/2026/643
publisher: DU
year: 2026
pos: 643
...
# RZECZYPOSPOLITEJ POLSKIEJ Warszawa, dnia ROZPORZĄDZENIE 13 maja 2026 r.

| Pole | Wartość |
|---|---|
| Adres publikacyjny | Dz.U. 2026 poz. 643 |
| ISAP | WDU20260000643 |
...
| Źródło | [ISAP](https://isap.sejm.gov.pl/isap.nsf/DocDetails.xsp?id=WDU20260000643) · [PDF](https://api.sejm.gov.pl/eli/acts/DU/2026/643/text.pdf) |
...
rewers rewers Opis:
1. Blankiet elektronicznej Opis: legitymacji studenckiej (ELS) jest wykonany z wielowarstwowej karty z tworzywa sztucznego (PVC), o wymiarach 53,98 × 85,60 mm (format ID-1), umożliwiającej trwałe naniesienie szaty graficznej oraz danych personalnych i identyfikacyjnych. 1. Blankiet elektronicznej legitymacji studenckiej (ELS) jest wykonany
2. Podłoże karty z nie wielowarstwowej wykazuje luminescencji karty w promieniowaniu z tworzywa sztucznego ultrafioletowym (PVC), (UV). Blankiet o wymiarach jest zabezpieczony 53,98 × war- 85,60 mm stwą ochronną (format (overlay) ID-1), niewykazującą umożliwiającej luminescencji trwałe w promieniowaniu naniesienie ultrafioletowym. szaty graficznej oraz danych personalnych
3. Blankiety są przystosowane i identyfikacyjnych. do procesu personalizacji z wykorzystaniem technik termotransferowych i termosublimacyjnych.
2. Podłoże karty nie wykazuje luminescencji w promieniowaniu ultrafioletowym (UV).
4. Awers zawiera:
1) zabezpieczenia Blankiet w druku jest offsetowym: zabezpieczony warstwą ochronną (overlay) niewykazującą luminescencji
a) tło w giloszowe, promieniowaniu ultrafioletowym.
b) mikrodruki 3. – Blankiety powtarzające są się przystosowane napisy o treści: „RZECZPOSPOLITAPOLSKA”, do procesu personalizacji „LEGITYMACJASTU- z wykorzystaniem technik DENCKASTUDENTCARD”, „RP”,
c) element termotransferowych reliefowy – cienkie i termosublimacyjnych. linie giloszowe tworzące powtarzające się napisy: „LEGITYMACJA STUDENCKA”, „STUDENT CARD”;
4. Awers zawiera:
2) zabezpieczenia farbą irydyscentną – obiekt graficzny „biret” w kolorze różowo-perłowym – zabezpieczenie sitodrukiem; 1) zabezpieczenia w druku offsetowym:
3) wizerunek orła a) ustalony tło dla giloszowe, godła Rzeczypospolitej Polskiej oraz napis: „Rzeczpospolita Polska” w kolorze czarnym w dwóch wierszach;
b) mikrodruki – powtarzające się napisy o treści: „RZECZPOSPOLITAPOLSKA”,
4) chip;
5) czarne napisy: „LEGITYMACJASTUDENCKASTUDENTCARD”, „RP”,
a) Data wydania, c) element reliefowy – cienkie linie giloszowe tworzące powtarzające się napisy:
b) Nr albumu, „LEGITYMACJA STUDENCKA”, „STUDENT CARD”;
c) Data urodzenia,
2) zabezpieczenia farbą irydyscentną – obiekt graficzny „biret” w kolorze różowo-perłowym
d) Nr PESEL;
6) granatowy napis: – zabezpieczenie „LEGITYMACJA sitodrukiem; STUDENCKA”, „STUDENT CARD”;
...
c) imię do 24 znaków oraz nazwisko w dwóch wierszach, do 28 znaków każdy, w kolorze czarnym, wykonane krojem Arial Narrow Bold o wielkości 8 pkt, wyjustowane centralnie; notacja: „Pierwsze Litery Wielkie”;
pozycjonowanie: oś pionowa tekstu 43,6 mm w poziomie i 24 mm w pionie, licząc od górnej krawędzi bloku tekstu,
...
§ 2. 1. Elektroniczne legitymacje studenckie wydane przed dniem wejścia w życie rozporządzenia zmienianego w § 1 i ważne w tym dniu zachowują ważność do dnia ukończenia studiów, zawieszenia w prawach studenta lub skreślenia z listy studentów, a w przypadku ukończenia studiów pierwszego stopnia – do dnia 31 października roku ukończenia tych studiów.
