...
- **3)** w art. 31e: ust. 1 i 1a otrzymują brzmienie: „
    - **a)**
...
- **6)** w art. 31g w ust. 1: wprowadzenie do wyliczenia otrzymuje brzmienie: „ Prezes Agencji po otrzymaniu zlecenia ministra właściwego do spraw zdrowia w zakresie, o którym mowa w art. 31e ust. 1a, dokonuje oceny świadczenia opieki zdrowotnej i przygotowuje, zgodnie ze zleceniem, raport pełny albo skrócony, w sprawie: ” , pkt 2 otrzymuje brzmienie: „
    - **a)**
    - **b)**

- **2)** zmiany poziomu lub sposobu finansowania świadczenia gwarantowanego, albo ” , dodaje się pkt 3 w brzmieniu: „
    - **c)**

- **3)** zmiany technologii medycznej ” ;
- **7)** w art. 31h: w ust. 2: – pkt 2 otrzymuje brzmienie: „ 2) zmiany poziomu lub sposobu finansowania świadczenia gwarantowanego, albo ” , – dodaje się pkt 3 w brzmieniu: „ 3) zmiany technologii medycznej. ” , w ust. 3: – pkt 2 otrzymuje brzmienie: „ 2) zmiany poziomu lub sposobu finansowania świadczenia gwarantowanego, albo ” , – dodaje się pkt 3 w brzmieniu: „ 3) zmiany technologii medycznej. ” ;
    - **a)**
    - **b)**
...
- **9)** art. 31lb otrzymuje brzmienie: „ Art. 31lb.
...
- **1)** opis świadczenia opieki zdrowotnej podlegającego taryfikacji, ze szczególnym uwzględnieniem: wpływu świadczenia opieki zdrowotnej na stan zdrowia obywateli, w tym zapadalności, chorobowości, umieralności lub śmiertelności, skutków następstw choroby lub stanu zdrowia;
    - **a)**
    - **b)**
...
- **10)** w art. 31lc: ust. 1 i 2 otrzymują brzmienie: „
    - **a)**
...
- **3)** dotyczących udzielania oraz finansowania świadczeń opieki zdrowotnej. ” , ust. 4 i 5 otrzymują brzmienie: „
    - **b)**
...
- **11)** w art. 31n: w pkt 1 w lit. a dodaje się tiret czwarte w brzmieniu: „ – zmiany technologii medycznej, ” , pkt 1a otrzymuje brzmienie: „
    - **a)**
    - **b)**

- **1a)** realizacja zadań związanych z określeniem taryf świadczeń w zakresie: określania taryfy świadczeń, opracowywania raportów w sprawie ustalenia taryfy świadczeń; ” , pkt 2 otrzymuje brzmienie: „
    - **a)**
    - **b)**
    - **c)**

- **2)** opracowywanie, weryfikacja, gromadzenie, udostępnianie i upowszechnianie informacji o metodyce przeprowadzania oceny technologii medycznych oraz o technologiach medycznych opracowywanych w Rzeczypospolitej Polskiej i w innych krajach; ” , po pkt 2 dodaje się pkt 2a w brzmieniu: „
    - **d)**

- **2a)** opracowywanie, weryfikacja, gromadzenie, udostępnianie i upowszechnianie informacji o zasadach określania taryfy świadczeń; ” , po pkt 3 dodaje się pkt 3a w brzmieniu: „
    - **e)**

- **3a)** wydawanie opinii, o których mowa w art. 47f ust. 1 i 2; ” ;
- **12)** w art. 31o: w ust. 2 w pkt 5 lit. b otrzymuje brzmienie: „ stanowisk i opinii Rady Przejrzystości oraz Rady do spraw Taryfikacji, ” , ust. 4 otrzymuje brzmienie: „
    - **a)**
    - **b)**
    - **b)**
...
- **13)** w art. 31p: ust. 2 i 3 otrzymują brzmienie: „
    - **a)**
...
3. Kadencja Prezesa Agencji oraz zastępcy Prezesa Agencji trwa 5 lat. ” , w ust. 5 wprowadzenie do wyliczenia otrzymuje brzmienie: „ Minister właściwy do spraw zdrowia odwołuje Prezesa Agencji i zastępcę Prezesa Agencji z zajmowanego stanowiska przed upływem kadencji w przypadku: ” , ust. 6 otrzymuje brzmienie: „
...
- **15)** w art. 31s: ust. 3 otrzymuje brzmienie: „
    - **a)**

3. Członków Rady Przejrzystości powołuje i odwołuje minister właściwy do spraw zdrowia, z tym że członkowie, o których mowa w ust. 2 pkt 3–5, są powoływani na wniosek właściwych organów. ” , po ust. 9 dodaje się ust. 9a w brzmieniu: „

- **b)**

9a. W przypadku niezłożenia deklaracji o braku konfliktu interesów minister właściwy do spraw zdrowia odwołuje członka Rady Przejrzystości. ” , uchyla się ust. 16;

- **c)**
- **16)** w art. 31sa: ust. 2 i 3 otrzymują brzmienie: „
    - **a)**

2. Do zadań Rady do spraw Taryfikacji należy:

- **1)** opiniowanie: planu taryfikacji Agencji, metodyki taryfikacji świadczeń;
    - **a)**
    - **b)**
...
3. W skład Rady do spraw Taryfikacji wchodzi dziesięciu członków powoływanych i odwoływanych przez ministra właściwego do spraw zdrowia, w tym dwóch członków zgłaszanych przez Prezesa Funduszu. ” , uchyla się ust. 4, uchyla się ust. 6, po ust. 9 dodaje się ust. 9a w brzmieniu: „
...
- **17)** w art. 31t: w ust. 2: – pkt 1 i 1a otrzymują brzmienie: „ 1) przychody z tytułu opłat za przygotowywanie analiz weryfikacyjnych Agencji; 1a) odpis dla Agencji, o którym mowa w ust. 5–9; ” , – uchyla się pkt 3, ust. 5–11 otrzymują brzmienie: „
    - **a)**
    - **b)**
...
- **18)** w art. 31u: ust. 3 otrzymuje brzmienie: „
    - **a)**

3. Fundusz zapasowy Agencji tworzy się z zysku netto z przeznaczeniem na finansowanie inwestycji lub pokrycie straty netto. ” , dodaje się ust. 8 i 9 w brzmieniu: „
...
- **2)** decyzji administracyjnych w sprawie wydania zgód, o których mowa w art. 47d ust. 1 i 2: dane, o których mowa w art. 47g ust. 1 pkt 1–8, maksymalną kwotę, o której mowa w art. 47g ust. 1 pkt 9, a w przypadku kontynuacji leczenia – sumaryczne zestawienie kosztów leku obejmujące wszystkie wydane zgody, datę przekazania do Agencji zlecenia sporządzenia opinii, o której mowa w art. 47f ust. 1 lub 2, datę sporządzenia tej opinii przez Agencję oraz stanowisko Agencji w niej wyrażone.
    - **a)**
    - **b)**
    - **c)**
...
- **28)** po art. 188b dodaje się art. 188ba w brzmieniu: „ Art. 188ba.
...
- **1)** w art. 4d w ust. 3 w pkt 5 lit. a i b otrzymują brzmienie: „ imię i nazwisko oraz adres miejsca zamieszkania pacjenta, numer PESEL pacjenta, a w przypadku jego braku – rodzaj, serię i numer dokumentu potwierdzającego tożsamość, ” ;
    - **a)**
    - **b)**
...
- **3)** w art. 96a w ust. 1 w pkt 1 lit. d otrzymuje brzmienie: „ datę urodzenia pacjenta, w przypadku gdy nie można jej ustalić na podstawie innych danych zamieszczonych na recepcie; ” ;
    - **d)**
...
- **3)** w art. 11: w ust. 3: – uchyla się pkt 1, – w pkt 2 wyrazy „od 3 do 5 lat” zastępuje się wyrazami „dłuższy niż 3 lata”, w ust. 8 wyrazy „wynosi 5 lat” zastępuje się wyrazami „wynosi 3 lata”;
    - **a)**
    - **b)**
...
- **5)** w art. 40: w ust. 1 wprowadzenie do wyliczenia otrzymuje brzmienie: „ Jeżeli jest to niezbędne dla ratowania zdrowia i życia świadczeniobiorców, minister właściwy do spraw zdrowia, po zasięgnięciu opinii Rady Przejrzystości oraz konsultanta krajowego w odpowiedniej dziedzinie medycyny, może wydać z urzędu, przy uwzględnieniu: ” , dodaje się ust. 3–6 w brzmieniu: „
    - **a)**
    - **b)**
