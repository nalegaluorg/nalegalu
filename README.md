...
Repozytorium zawiera kompaktowe indeksy orzecznictwa — łącznie **649 790** powiązań między orzeczeniami a aktami prawnymi.
...
| [Inne](inne/README.md) | 13135 | [Pełna lista aktów →](inne/README.md) (1045 z orzecznictwem) |
...
| | Wartość |
|---|---:|
| Opublikowane akty | **13,831** |
| Odrzucone (jakość) | 256 |
| Artykuły | 193,004 |
| Znaki treści | 472.1M |
| Śr. znaków/akt | 34,132 |
...
*Odrzucone: 0 skanów bez OCR, 157 zablokowanych przez bramkę jakości, 256 inne*

*Od 2026-05-18: +510 aktów*
...
*13831 aktów • wygenerowano automatycznie przez [nalegalu](https://github.com/nalegaluorg/nalegalu) • źródło danych: [ISAP](https://isap.sejm.gov.pl) + [SAOS](https://www.saos.org.pl) • aktualizacja: 2026-05-23*
