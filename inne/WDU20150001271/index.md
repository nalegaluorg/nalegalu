...
b)
w ust. 6 wprowadzenie do wyliczenia otrzymuje brzmienie: „ Mięso zbadane na obecność włośni metodą badania trychinoskopowego określoną w załączniku nr 3 do rozporządzenia: ” ;
2)
w § 9:
a)
...
II.
Pobieranie próbek W przypadku całych tusz pobiera się kilka próbek wielkości orzecha laskowego z każdego zwierzęcia:
1)
