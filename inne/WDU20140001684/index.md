...
# RZECZYPOSPOLITEJ POLSKIEJ Poz. 1684 ROZPORZĄDZENIE MINISTRA SPRAWIEDLIWOŚCI z dnia 12 listopada 2014 r.
...
§ 1. W rozporządzeniu Ministra Sprawiedliwości z dnia 25 września 2014 r. w sprawie określenia sądów rejonowych prowadzących księgi wieczyste oraz obszarów ich właściwości miejscowej (Dz. U. poz. 1398) w § 1 wprowadza się następujące zmiany:
...
3) w pkt 8 w lit. d średnik na końcu zdania zastępuje się przecinkiem i dodaje się lit. e w brzmieniu: „e) Sąd Rejonowy w Sulęcinie – dla obszaru właściwości tego Sądu;”;
...
5) pkt 12 otrzymuje brzmienie: „12) w obszarze właściwości Sądu Okręgowego w Kielcach:
...
6) pkt 14–17 otrzymują brzmienie: „14) w obszarze właściwości Sądu Okręgowego w Koszalinie:
...
7) w pkt 18 w lit. k średnik na końcu zdania zastępuje się przecinkiem i dodaje się lit. l w brzmieniu: „l) Sąd Rejonowy we Włodawie – dla obszaru właściwości tego Sądu;”;
8) pkt 22 i 23 otrzymują brzmienie: „22) w obszarze właściwości Sądu Okręgowego w Olsztynie:
...
9) pkt 28–30 otrzymują brzmienie: „28) w obszarze właściwości Sądu Okręgowego w Przemyślu:
...
10) pkt 33 otrzymuje brzmienie: „33) w obszarze właściwości Sądu Okręgowego w Słupsku:
...
11) pkt 35 otrzymuje brzmienie: „35) w obszarze właściwości Sądu Okręgowego w Szczecinie:
...
h) Sąd Rejonowy w Stargardzie Szczecińskim – dla obszaru właściwości tego Sądu,
...
12) pkt 37 otrzymuje brzmienie: „37) w obszarze właściwości Sądu Okręgowego w Tarnobrzegu:
...
13) pkt 39 otrzymuje brzmienie: „39) w obszarze właściwości Sądu Okręgowego w Toruniu:
...
14) pkt 42–45 otrzymują brzmienie: „42) w obszarze właściwości Sądu Okręgowego we Włocławku:
