...
source: "eli-html"
---
# Rozporządzenie Ministra Finansówz dnia 30 sierpnia 2013 r. w sprawie warunków emitowania bonów skarbowych

| Pole | Wartość |
|---|---|
| Adres publikacyjny | Dz.U. 2013 poz. 1088 |
| ISAP | WDU20130001088 |
...
Rejestrze - rozumie się przez to prowadzony przez agenta emisji Rejestr Papierów Wartościowych, w którym agent emisji dokonuje rejestracji stanu i zmian stanu posiadania bonów.

### § 3.

### 1.

Bony są nabywane i zbywane w drodze przetargu z dyskontem, z zastrzeżeniem ust. 2.
...
Wartość nominalna bonów oferowanych na przetargu uzupełniającym nie może być większa niż 20% wartości nominalnej bonów oferowanych w dniu przetargu sprzedaży.
...
Oferta zakupu bonów na przetargu uzupełniającym powinna zawierać w szczególności:
...
Wartość nominalna oferty zakupu złożonej na przetargu uzupełniającym przez jednego uczestnika przetargu nie może być większa od wartości, o której mowa w § 24 pkt 6.
...
Zakup bonów na przetargu uzupełniającym przez poszczególnych uczestników przetargu następuje proporcjonalnie do wartości bonów nabytych przez nich na przetargu sprzedaży.
...
W przypadku gdy łączna wartość nominalna ofert zakupu złożonych na przetargu uzupełniającym jest niższa od wartości, o której mowa w § 24 pkt 6, oferty poszczególnych uczestników przetargu są realizowane w całości.
...
Zapłata ceny zakupu następuje przez obciążenie rachunku, o którym mowa w § 18 pkt 5, a w przypadku przetargu uzupełniającego - rachunku, o którym mowa w § 25 ust. 1 pkt 5. Termin zapłaty za bony nabyte na przetargu jest podawany w komunikacie.
...
Traci moc rozporządzenie Ministra Finansów z dnia 20 grudnia 2010 r. w sprawie warunków emitowania bonów skarbowych ([Dz. U. Nr 250, poz. 1679](https://api.sejm.gov.pl/eli/acts/DU/2010/1679/text.html)).
