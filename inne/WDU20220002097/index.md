...
# RZECZYPOSPOLITEJ POLSKIEJ Poz. 22009977 RAMY PROGRAMOWE KSZTAŁCENIA UZUPEŁNIAJĄCEGO DLA SZKÓŁ POLSKICH SZKOŁA PODSTAWOWA Celem kształcenia uzupełniającego w szkole podstawowej jest:

| Pole | Wartość |
|---|---|
| Adres publikacyjny | Dz.U. 2022 poz. 2097 |
| ISAP | WDU20220002097 |
...
| Źródło | [ISAP](https://isap.sejm.gov.pl/isap.nsf/DocDetails.xsp?id=WDU20220002097) · [PDF](https://api.sejm.gov.pl/eli/acts/DU/2022/2097/text.pdf) |
...
20) Wybrane polskie komiksy, np. Henryk Jerzy Chmielewski, Tytus, Romek i AʼTomek (do wyboru).
...
– 8 – Treści nauczania ‒ wymagania szczegółowe Treści nauczania należy dostosować do poziomów biegłości językowej uczniów (poziom A ‒ podstawowy, poziom B ‒ średni, poziom C ‒ zaawansowany) Klasy IV‒VI I. Odbiór wypowiedzi i wykorzystanie zawartych w nich informacji
1. Słuchanie Uczeń:
...
9) Melchior Wańkowicz, Bitwa o Monte Casino (fragmenty) lub inne utwory literackie i teksty kultury wybrane przez nauczyciela, w tym wiersze poetów współczesnych i reportaże.
Kręgi tematyczne:
1) ja i moi bliscy:
...
Tabela diagnostyczna poziomu biegłości językowej Kompetencje językowe (5‒9 lat) Kompetencje A ‒ poziom podstawowy B ‒ poziom średni C ‒ poziom (średnio zaawansowany) zaawansowany 1 2 3 4 Słuchanie Uczeń: Uczeń: Uczeń:
1) rozróżnia większość 1) rozróżnia głoski 1) rozróżnia wszystkie głosek istotnych dla współczesnej głoski współczesnej języka polskiego; polszczyzny, polszczyzny;
2) rozumie proste z wyjątkiem 2) rozumie polecenia; najtrudniejszych; rozbudowane
3) rozumie proste 2) rozumie polecenia; polecenia;
wypowiedzi 3) rozumie proste 3) rozumie wypowiedzi monologowe wypowiedzi monologowe i dialogowe, o ile monologowe i dialogowe;
otrzymuje dodatkowe i dialogowe bez 4) rozumie utwory wyjaśnienia; dodatkowych literackie i inne
4) rozumie proste teksty wyjaśnień; teksty kultury literackie wspierane 4) rozumie proste teksty obrazkami, gestami literackie (zwłaszcza i rekwizytami oraz pisane współczesną inne teksty kultury, polszczyzną), o ile otrzymuje wspierane obrazkami, dodatkowe gestami i rekwizytami wyjaśnienia oraz inne teksty kultury – 19 – Mówienie Uczeń: Uczeń: Uczeń:
1) wymawia poznane wymawia poznane 1) poprawnie wymawia słowa w sposób na słowa w sposób słowa i zwroty;
ogół zrozumiały; zrozumiały; 2) wypowiada się skutecznie
2) tworzy, z pomocą porozumiewa się płynnie;
nauczyciela, krótką w codziennych 3) opisuje, opowiada wypowiedź sytuacjach, stosując i charakteryzuje składającą się właściwe formy postać literacką;
z prostych zdań; komunikowania się; 4) uczestniczy
3) porozumiewa się uczestniczy w rozmowie w prostych w rozmowie, wyraża i w prostej dyskusji;
w prosty sposób sytuacjach własne zdanie; 5) stosuje formuły komunikacyjnych; 4) formułuje grzecznościowe;
4) stosuje podstawowe kilkuzdaniową 6) recytuje wiersze, formuły wypowiedź, opowiada stosując pauzę grzecznościowe; o własnych i intonację
5) odtwarza z pamięci doświadczeniach, rymowanki i inne opisuje ludzi, krótkie, proste teksty przedmioty, miejsca i sytuacje;
5) formułuje życzenia i zaproszenie;
6) opowiada w prosty sposób akcję utworu oraz opisuje bohaterów i relacje między nimi, a także świat przedstawiony tekstów kultury;
7) stosuje formuły grzecznościowe;
8) recytuje wiersze Czytanie Uczeń: Uczeń: Uczeń:
1) zna wszystkie litery 1) czyta na głos, 1) czyta na głos, i odpowiadające im poprawnie akcentując poprawnie głoski; wyrazy; i wyraziście krótki
2) dzieli wyraz na 2) rozumie krótkie teksty i prosty tekst (także sylaby; użytkowe; nieznany);
3) czyta na głos i cicho 3) rozpoznaje formy 2) rozumie utwory proste, krótkie teksty; użytkowe (np. literackie i inne
4) rozumie proste życzenia, zaproszenie, teksty kultury;
i krótkie teksty ogłoszenie, list, prostą 3) określa podstawowe użytkowe; instrukcję); elementy świata – 20 –
5) rozumie proste 4) rozumie krótkie utwory przedstawionego i krótkie utwory literackie i inne teksty w utworze literackie, wspierane kultury; literackim lub innym materiałem 5) w tekście literackim tekście kultury;
ilustracyjnym, i inne zaznacza wybrane 4) rozumie podstawowe teksty kultury; fragmenty, określa oraz przenośne
6) korzysta czas i miejsce akcji znaczenie wyrazów z obrazkowych oraz wskazuje w tekście;
słowników głównych bohaterów; 5) korzysta ze i encyklopedii 6) wyszukuje w tekście słowników potrzebne informacje; i encyklopedii
7) korzysta z obrazkowych słowników i encyklopedii Pisanie Uczeń: Uczeń: Uczeń:
1) pisze wszystkie małe 1) przepisuje krótkie 1) pisze z pamięci i wielkie litery, teksty; (pojedyncze zdania) dostrzega różnicę 2) pisze z pamięci (kilka i ze słuchu (krótkie między literą wyrazów) i ze słuchu teksty);
i głoską; (proste, krótkie teksty); 2) tworzy krótką
2) przepisuje wyrazy 3) tworzy, z pomocą wypowiedź (dialog, i proste zdania; nauczyciela, krótką opowiadanie
3) pisze z pamięci wypowiedź (opis, list i przepis);
(pojedyncze wyrazy) prywatny, życzenia 3) tworzy wypowiedź i ze słuchu (proste i zaproszenie); na znane mu tematy zdania), po 4) pisze według wzoru (np. związane z jego omówieniu pisowni proste teksty na znane zainteresowaniami);
z nauczycielem; mu tematy 4) tworzy wypowiedź
4) tworzy, z pomocą (np. związane z jego związaną nauczyciela, krótką zainteresowaniami); z poznanymi wypowiedź 5) pisze proste teksty utworami literackimi składającą się związane z poznanymi i innymi tekstami z prostych zdań (opis, utworami literackimi kultury;
pozdrowienia i innymi tekstami 5) stosuje podstawowe i życzenia); kultury; formuły
5) pisze według wzoru 6) stosuje podstawowe grzecznościowe;
krótki tekst o sobie; formuły 6) zna i na ogół stosuje
6) stosuje podstawowe grzecznościowe; zasady ortografii formuły 7) na ogół pisze poprawnie i interpunkcji grzecznościowe; ortograficznie i stosuje
7) dba o poprawność podstawową graficzną polskich interpunkcję – 21 – liter Kompetencje językowe (10‒13 lat) Kompetencje A ‒ poziom podstawowy B ‒ poziom średni C ‒ poziom (średnio zaawansowany) zaawansowany 1 2 3 4 Słuchanie Uczeń: Uczeń: Uczeń:
1) rozróżnia większość 1) rozróżnia większość 1) rozróżnia wszystkie głosek języka głosek języka głoski języka polskiego polskiego; polskiego;
(z wyjątkiem 2) rozumie złożone 2) rozumie złożone najtrudniejszych); polecenia, proste polecenia, proste
2) rozumie polecenia instrukcje oraz instrukcje oraz oraz proste wypowiedzi wypowiedzi wypowiedzi monologowe monologowe monologowe i dialogowe, w tym i dialogowe, i dialogowe; nadawane za pomocą włącznie
3) rozumie proste, środków z wypowiedziami współczesne utwory audiowizualnych; w dyskusjach;
literackie wspierane 3) rozumie utwory 3) rozumie utwory ilustracjami, gestami literackie (zwłaszcza literackie (z różnych i rekwizytami oraz pisane współczesną epok) i inne teksty inne teksty kultury; polszczyzną) i inne kultury;
4) rozumie proste teksty kultury; 4) rozumie wypowiedzi 4) rozumie wypowiedzi rozbudowane o charakterze o charakterze wypowiedzi informacyjnym informacyjnym o charakterze i użytkowym i użytkowym informacyjnym i użytkowym Mówienie Uczeń: Uczeń: Uczeń:
1) wymawia poznane 1) mówi w sposób na 1) poprawnie wymawia słowa w sposób na ogół zrozumiały, słowa i zdania;
ogół zrozumiały; stosując akcent 2) wypowiada się
2) tworzy samodzielnie zdaniowy; płynnie i logicznie;
na ogół poprawną 2) spontanicznie 3) opisuje, opowiada kilkuzdaniową i w miarę płynnie i charakteryzuje wypowiedź; porozumiewa się postać literacką,
3) porozumiewa się w codziennych streszcza i relacjonuje w typowych sytuacjach, stosując zdarzenia;
sytuacjach właściwe formy 4) rozpoczyna dyskusję komunikacyjnych; komunikowania się; i uczestniczy
4) stosuje podstawowe 3) opowiada o własnych w dyskusji nad – 22 – formuły doświadczeniach, poznanymi tekstami grzecznościowe; opisuje ludzi, kultury;
5) odtwarza z pamięci przedmioty, miejsca 5) stosuje proste teksty i sytuacje; zróżnicowane
4) formułuje życzenia, formuły gratulacje grzecznościowe;
i zaproszenie; 6) recytuje utwory
5) formułuje w miarę literackie, stosując spójną wypowiedź na właściwą modulację znane mu tematy głosową (np. związane z jego zainteresowaniami oraz poznanymi utworami literackimi i innymi tekstami kultury);
6) opowiada akcję utworu, opisuje bohaterów i relacje między nimi, a także świat przedstawiony w tekstach kultury, w tym nazywa swoje reakcje czytelnicze i wyraża swój stosunek do postaci;
7) uczestniczy w rozmowie, wyraża własne zdanie i uzasadnia je;
8) stosuje zróżnicowane formuły grzecznościowe;
9) recytuje utwory literackie, dbając o prawidłowe akcentowanie Czytanie Uczeń: Uczeń: Uczeń:
1) zna wszystkie litery 1) czyta na głos, 1) czyta na głos, i odpowiadające im prawidłowo akcentując prawidłowo głoski języka wyrazy, i stosuje akcentując wyrazy, polskiego; akcent zdaniowy; i zachowuje
2) czyta na głos i cicho 2) rozumie dłuższe teksty intonację zdania;
– 23 – proste teksty informacyjne 2) czyta, z pomocą literackie i użytkowe; nauczyciela, i nieliterackie; 3) rozróżnia teksty wybrane utwory
3) rozumie proste teksty informacyjne literackie (z różnych informacyjne i argumentacyjne; epok);
i użytkowe; 4) odróżnia zdania 3) rozumie utwory
4) rozumie proste informujące o faktach literackie, utwory literackie oraz od zdań wyrażających informacyjne inne teksty kultury; opinię; i użytkowe oraz inne
5) wskazuje w tekście 5) rozumie dłuższe teksty kultury;
najważniejsze utwory literackie oraz 4) odróżnia język informacje; inne teksty kultury; literacki od
6) korzysta ze 6) rozpoznaje wpisanego nieliterackiego;
słowników w tekst literacki 5) wyodrębnia dwujęzycznych nadawcę i odbiorcę; wszystkie elementy i encyklopedii 7) rozpoznaje wybrane świata elementy świata przedstawionego przedstawionego w tekście literackim;
w tekście literackim; 6) korzysta
8) korzysta ze szkolnych z informacji słowników oraz innych zawartych źródeł informacji; w encyklopediach
9) rozróżnia oficjalną oraz słownikach i nieoficjalną odmianę jednojęzycznych języka i dwujęzycznych.
Pisanie Uczeń: Uczeń: Uczeń:
1) poprawnie zapisuje 1) zapisuje dyktowane 1) sporządza notatkę wszystkie litery teksty; z tekstu czytanego;
polskiego alfabetu; 2) opisuje wydarzenia, 2) swobodnie tworzy
2) przepisuje wyrazy swoje przeżycia wypowiedzi i proste zdania; i doświadczenia; pisemne
3) pisze z pamięci i ze 3) tworzy wypowiedź w poznanych słuchu wyrazy związaną z poznanymi formach i proste zdania; utworami literackimi gatunkowych,
4) zapisuje proste i innymi tekstami stosując informacje o sobie; kultury oraz na znane urozmaicone
5) pisze według wzoru mu tematy (np. o jego słownictwo;
proste teksty na znane zainteresowaniach); 3) stosuje mu tematy 4) tworzy proste w wypowiedzi (np. związane z jego wypowiedzi pisemne pisemnej zainteresowaniami); w wybranych formach odpowiednią
6) tworzy krótką, na gatunkowych (opis, kompozycję i układ ogół poprawną, charakterystyka, graficzny;
kilkuzdaniową opowiadanie, dialog, 4) posługuje się wypowiedź list prywatny, kartka oficjalną składającą się z dziennika, i nieoficjalną z prostych zdań (opis, ogłoszenie, odmianą języka;
dialog, pozdrowienia zaproszenie, życzenia 5) pisze poprawnie pod i życzenia); i notatka); względem
7) stosuje podstawowe 5) sporządza plan ortograficznym formuły wypowiedzi; i interpunkcyjnym grzecznościowe; 6) stosuje formuły
8) na ogół pisze grzecznościowe;
poprawnie 7) pisze poprawnie pod ortograficznie względem i stosuje poprawną ortograficznym interpunkcję i interpunkcyjnym Kompetencje językowe (od 14 lat) Kompetencje A ‒ poziom podstawowy B ‒ poziom średni C ‒ poziom (średnio zaawansowany) zaawansowany 1 2 3 4 Słuchanie Uczeń: Uczeń: Uczeń:
1) rozróżnia większość 1) rozróżnia głoski języka 1) rozróżnia wszystkie głosek języka polskiego, z wyjątkiem głoski języka polskiego; najtrudniejszych; polskiego;
2) rozumie polecenia 2) rozumie wypowiedzi 2) rozumie wypowiedzi i proste wypowiedzi monologowe o złożonej monologowe i dialogowe, w tym strukturze, w tym i dialogowe, w tym nadawane za pomocą nadawane za nadawane za pomocą środków pomocą środków środków audiowizualnych; audiowizualnych, audiowizualnych; 3) rozumie utwory i odbiera zawarte
3) rozumie proste literackie i inne teksty w nich informacje utwory literackie kultury; zarówno jawne, jak (zwłaszcza pisane 4) rozumie wypowiedzi i ukryte;
współczesną informacyjne 3) rozumie utwory polszczyzną) i inne i użytkowe oraz literackie (z różnych teksty kultury; odróżnia informacje epok) i inne teksty
4) rozumie proste o faktach od opinii; kultury;
wypowiedzi 5) rozumie intencję 4) rozumie wypowiedzi informacyjne wypowiedzi (np. o charakterze i użytkowe; aprobatę, dezaprobatę, popularnonaukowym
5) rozpoznaje intencję prowokację) oraz i publicystycznym;
wypowiedzi rozpoznaje środki 5) rozumie jawną (np. aprobatę, językowe służące jej i ukrytą intencję dezaprobatę) wyrażeniu wypowiedzi wspomaganą (sugestię intonacją lub gestem i manipulację językową oraz ironię);
6) rozpoznaje środki językowe pełniące różne funkcje stylistyczne Mówienie Uczeń: Uczeń: Uczeń:
1) wymawia poznane 1) mówi w sposób na ogół 1) poprawnie wymawia słowa w sposób na zrozumiały i stosuje słowa i zdania;
ogół zrozumiały; akcent zdaniowy; 2) wypowiada się
2) tworzy samodzielnie 2) swobodnie spontanicznie, na ogół poprawną i spontanicznie płynnie i logicznie;
kilkuzdaniową porozumiewa się 3) prezentuje fabułę wypowiedź; w różnych sytuacjach, i charakteryzuje
3) porozumiewa się stosując właściwe postać mówiącą, w typowych formy komunikowania wypowiada się sytuacjach się; precyzyjnie komunikacyjnych; 3) formułuje spójną w rozmaitych
4) w prosty sposób wypowiedź na tematy formach;
wypowiada się związane z otaczającą 4) w dyskusji (opisuje swoje rzeczywistością, i wystąpieniu reakcje) na temat opowiada o własnych publicznym poznanych tekstów doświadczeniach, formułuje swoje kultury; opisuje ludzi, zdanie, uzasadnia je
5) stosuje formuły przedmioty, miejsca i broni go, grzecznościowe; i sytuacje; podejmuje
6) odtwarza teksty 4) streszcza i omawia polemikę;
z pamięci przeczytane utwory 5) przestrzega zasad literackie oraz inne etykiety językowej, teksty kultury, dostosowuje sposób wskazuje ich temat, wyrażania do stylu problematykę, właściwego dla charakteryzuje postaci, danej sytuacji;
przedstawia przebieg 6) recytuje utwory akcji oraz tworzy literackie, spójne, dłuższe interpretując je wypowiedzi na zadany głosowo lub wybrany przez siebie temat;
5) uczestniczy w dyskusji na znany sobie temat, potrafi przedstawić swój punkt widzenia i uzasadnia własne zdanie;
6) stosuje podstawowe zasady etykiety językowej, dostosowując odmianę i styl języka do sytuacji, w której się wypowiada;
7) recytuje utwory literackie, dbając o poprawną intonację.
Czytanie Uczeń: Uczeń: Uczeń:
1) zna wszystkie litery 1) czyta na głos, 1) rozumie utwory i odpowiadające im prawidłowo akcentując literackie i inne głoski; wyrazy, i stosuje teksty kultury,
2) czyta na głos i cicho akcent zdaniowy; a w ich interpretacji proste teksty 2) rozumie dłuższe teksty uwzględnia różne literackie informacyjne oraz konteksty;
i nieliterackie; użytkowe; 2) identyfikuje
3) rozumie proste teksty 3) rozpoznaje elementy informacyjne podstawowe funkcje konstrukcyjne i użytkowe; wypowiedzi; struktury tekstu
4) rozumie proste 4) wyszukuje informacje literackiego utwory literackie według wskazanego i dostrzega relacje i inne teksty kultury; kryterium i porządkuje między nimi;
5) wyodrębnia części je; 3) odczytuje sens składowe całego 5) rozumie dłuższe całego tekstu tekstu i akapitu utwory literackie oraz i wydzielonych (wstęp, rozwinięcie inne teksty kultury; fragmentów oraz ich i zakończenie); 6) wskazuje funkcję na tle
6) odróżnia w prostym i charakteryzuje całości;
tekście informacje podstawowe kategorie 4) rozpoznaje jawną ważne od świata i ukrytą intencję drugorzędnych; przedstawionego; wypowiedzi, ironię
7) korzysta ze 7) rozpoznaje jawną i manipulację słowników i ukrytą intencję językową;
i encyklopedii wypowiedzi (np. 5) czyta wybrane aprobatę, dezaprobatę, utwory literackie sugestię); (z różnych epok);
8) dostrzega 6) korzysta z rozmaitych w wypowiedzi źródeł informacji ewentualne przejawy manipulacji;
9) wskazuje w tekście argumentacyjnym tezę, argumenty, przykłady i wnioski Pisanie Uczeń: Uczeń: Uczeń:
1) poprawnie zapisuje 1) zapisuje dyktowane 1) sporządza notatkę wszystkie litery teksty; z tekstu słuchanego polskiego alfabetu, 2) tworzy podstawowe i czytanego;
przepisuje wyrazy formy użytkowe (list 2) tworzy formy i proste zdania; oficjalny, podanie użytkowe (list
2) pisze z pamięci i ze i życiorys); oficjalny, podanie, słuchu wyrazy 3) opowiada życiorys, CV i list i proste zdania; o rzeczywistych lub motywacyjny);
3) zapisuje proste fikcyjnych zdarzeniach 3) przedstawia informacje o sobie; i doświadczeniach oraz (opracowuje
4) w prosty sposób opisuje uczucia; w pełni) dowolnie nazywa swoje emocje 4) tworzy wypowiedzi wybrany temat, i opisuje swoje pisemne w poznanych zwracając uwagę na doświadczenia; formach gatunkowych, strukturę
5) tworzy proste, stosując urozmaicone wypowiedzi;
kilkuzdaniowe słownictwo; 4) wypowiada się wypowiedzi (opis, 5) tworzy spójną pod w różnych formach dialog, pozdrowienia, względem logicznym gatunkowych (list życzenia, list i składniowym prywatny, dziennik, prywatny i krótką wypowiedź na zadany streszczenie, w tym wiadomość); temat; streszczenie tekstu
6) tworzy 6) przedstawia własną argumentacyjnego, kilkuzdaniową, na opinię na temat sprawozdanie ogół poprawną, poznanych tekstów i rozprawka), wypowiedź na znane kultury i uzasadnia ją; stosując mu tematy (np. 7) posługuje się oficjalną urozmaicone związane z jego i nieoficjalną odmianą słownictwo;
zainteresowaniami języka; 5) analizuje lub 8) stosuje formuły i interpretuje doświadczeniami); grzecznościowe; wskazane utwory
7) w prosty sposób 9) pisze poprawnie pod literackie oraz inne wypowiada się względem teksty kultury;
(opisuje swoje ortograficznym 6) stosuje formuły reakcje) na temat i interpunkcyjnym, grzecznościowe poznanych tekstów posługując się odpowiednie do kultury; słownikiem sytuacji;
8) stosuje formuły ortograficznym 7) stosuje grzecznościowe; obowiązujące normy
9) na ogół pisze poprawnościowe, poprawnie pod posługując się względem słownikami;
ortograficznym 8) redaguje i edytuje i interpunkcyjnym, własny tekst posługując się słownikiem ortograficznym Kręgi tematyczne 5‒9 lat 10‒13 lat od 14 lat 1 2 3 Ja i moi bliscy: Ja i moi bliscy: Ja i moi bliscy:
1) podstawowe informacje 1) dane osobowe (imię, 1) dane osobowe (imię, o sobie (imię, nazwisko, nazwisko, wiek, adres, data nazwisko, wiek, adres, wiek i miejsce i miejsce urodzenia); data i miejsce urodzenia zamieszkania); 2) wygląd zewnętrzny i cechy oraz wykształcenie);
2) wygląd zewnętrzny; charakteru; 2) wygląd zewnętrzny, cechy
3) umiejętności 3) zainteresowania, hobby; charakteru, talenty i zainteresowania; 4) uczucia, emocje, marzenia, i zdolności;
4) emocje, marzenia, świat świat wyobraźni; 3) zainteresowania, hobby, wyobraźni; 5) zawody i umiejętności; pasje;
5) najbliższa rodzina; 6) rodzina i relacje rodzinne; 4) uczucia, emocje,
6) przyjaciele, koledzy 7) przyjaciele, koledzy, marzenia, plany;
znajomi 5) praca i kariera;
6) rodzina, relacje rodzinne i stopnie pokrewieństwa;
7) życie towarzyskie;
8) konflikty i problemy (w tym problemy etyczne) Dom i otoczenie: Dom i otoczenie: Dom i otoczenie:
1) dom (pomieszczenia, 1) dom (pomieszczenia, 1) dom i otoczenie domu;
meble); wyposażenie); 2) miejsce zamieszkania
2) zabawki; 2) otoczenie domu (ogród, i okolice;
3) podwórko, plac zabaw; ulica); 3) urzędy i instytucje;
4) ciekawe miejsca 3) najbliższa okolica; 4) atrakcje w miejscu
4) atrakcje w miejscu zamieszkania i okolicy zamieszkania Życie codzienne: Życie codzienne: Życie codzienne:
1) kalendarz (miesiące, dni 1) kalendarz (miesiące, dni 1) kalendarz (miesiące, dni tygodnia, godziny i pory tygodnia, godziny, pory tygodnia, godziny, pory dnia); dnia, plan: dnia, tygodnia dnia, lata, wieki, plan:
2) podstawowe czynności i miesiąca); dnia, tygodnia i miesiąca);
dnia codziennego; 2) codzienne czynności 2) codzienne czynności
3) moja klasa i obowiązki i obowiązki; i obowiązki (domowe, szkolne; 3) moja klasa i szkoła; szkolne i koleżeńskie);
4) gry, zabawy, koła 4) rozrywki (np. kino, park 3) klasa, szkoła, system zainteresowań; rozrywki); edukacji;
5) żywienie (artykuły 5) żywienie (artykuły 4) sposoby spędzania spożywcze, posiłki spożywcze, posiłki wolnego czasu (np. kino, i potrawy); i potrawy, ich teatr, klub);
6) zakupy (kupowanie, przygotowanie, sposoby 5) żywienie (artykuły sprzedawanie, cyfry odżywiania się); spożywcze, posiłki i liczby); 6) zakupy (sklepy, towary, i potrawy, lokale
7) usługi (np. biblioteka); miary i wagi, pieniądze); gastronomiczne, sposoby
8) ubranie (części garderoby) 7) usługi (np. poczta, fryzjer); odżywiania się);
8) ubranie i moda 6) zakupy (sklepy, towary, miary i wagi, pieniądze, reklama, reklamacja);
7) usługi (np. bank, punkty naprawy);
8) ubranie, moda i styl Zdrowie i sport: Zdrowie i sport: Zdrowie i sport:
1) najważniejsze części ciała; 1) części ciała; 1) budowa człowieka;
2) czystość i schludność; 2) higiena osobista; 2) higiena osobista;
3) samopoczucie; 3) choroby i leczenie; 3) choroby i leczenie,
4) umiejętności sportowe 4) zdrowa żywność; wypadki;
5) dyscypliny i wydarzenia 4) uzależnienia;
sportowe; 5) zdrowy styl życia, dieta;
6) sprzęt i obiekty sportowe 6) dyscypliny i wydarzenia sportowe;
7) sprzęt i obiekty sportowe Podróże i turystyka: Podróże i turystyka: Podróże i turystyka:
1) wakacje; 1) wakacje, wypoczynek; 1) planowanie wypoczynku
2) ciekawostki turystyczne; 2) znane miejsca, obiekty; i podróży;
3) komunikacja lokalna 3) informacja turystyczna; 2) znane miejsca i zabytki;
4) środki transport 3) informacja turystyczna;
4) baza turystyczna;
5) transport Środowisko naturalne: Środowisko naturalne: Środowisko naturalne:
1) pogoda i pory roku; 1) klimat, pogoda i pory roku; 1) klimat, pogoda i pory
2) rośliny i zwierzęta 2) rośliny i zwierzęta; roku;
3) ochrona przyrody 2) świat roślin i zwierząt;
3) krajobraz;
4) ekologia;
5) katastrofy naturalne;
6) przestrzeń kosmiczna Technika, media: Technika, media: Technika, media:
1) domowe urządzenia 1) odkrycia i wynalazki; 1) rozwój techniki techniczne; 2) urządzenia techniczne; i informatyki;
2) telewizja, radio i internet 3) telewizja, radio, prasa 2) motoryzacja i internet i telekomunikacja;
3) telewizja, radio, prasa i internet Wiedza o Polsce: Wiedza o Polsce: Wiedza o Polsce:
1) symbole narodowe; 1) wybitni twórcy kultury i ich 1) twórcy kultury i ich dzieła;
2) znani Polacy; dzieła; 2) święta, tradycje
3) święta i zwyczaje; 2) święta, tradycje i zwyczaje; i zwyczaje, rocznice;
4) polonica w miejscu 3) polonica w miejscu 3) polonica w miejscu zamieszkania zamieszkania zamieszkania i okolicy Język nauki: Język nauki: Język nauki:
1) podstawowe terminy 1) podstawowe terminy 1) podstawowe terminy z zakresu wiedzy o języku; z zakresu wiedzy o języku; z zakresu wiedzy o języku;
2) podstawowe terminy 2) podstawowe terminy 2) podstawowe terminy z zakresu wiedzy z zakresu wiedzy z zakresu wiedzy o literaturze; o literaturze; o literaturze;
3) podstawowe terminy 3) podstawowe terminy 3) podstawowe terminy historyczne i geograficzne historyczne i geograficzne historyczne i geograficzne WIEDZA O POLSCE (elementy historii, geografii, kultury) Klasy IV‒VIII szkoły podstawowej Cele kształcenia ‒ wymagania ogólne w zakresie historii Polski i kultury Uczeń zdobywa podstawowe wiadomości na temat historii Polski od X do XXI w., które pozwolą mu lepiej poznać kraj jego pochodzenia oraz dostrzec związki teraźniejszości z przeszłością. Uczeń zdobywa podstawowe informacje o kulturze i społeczeństwie. Zdobyta wiedza pozwoli mu na identyfikację z kulturą i tradycją polską. Uczeń rozbudza swoje zainteresowania dziejami Polski, stawia pytania dotyczące przyczyn i skutków analizowanych wydarzeń historycznych i współczesnych, posługuje się zdobytymi pojęciami, przedstawiając własne stanowisko i próbując je uzasadnić.
...
2. Ojczyzna ‒ najważniejsze elementy polskiego dziedzictwa kulturowego Uczeń:
...
3. Postacie i wydarzenia o doniosłym znaczeniu dla kształtowania polskiej tożsamości kulturowej Uczeń sytuuje w czasie wymienione poniżej postaci i opowiada o:
...
Treści dodatkowe, nieobowiązkowe, do wyboru przez nauczyciela lub ucznia Uczeń sytuuje w czasie wymienione poniżej postaci, wydarzenia, organizacje, budowle i miasta oraz opowiada o:
...
4. Polska w okresie wczesnopiastowskim (X w. ‒ I połowa XII w.) Uczeń:
...
5. Polska w okresie rozbicia dzielnicowego (II połowa XII w. ‒ XIII w.) Uczeń:
...
7. Polska i Litwa w czasach ostatnich Jagiellonów Uczeń:
...
8. Początki Rzeczypospolitej Obojga Narodów Uczeń:
...
11. Rzeczpospolita w dobie stanisławowskiej Uczeń:
...
13. Sprawa polska w epoce napoleońskiej Uczeń:
...
14. Ziemie polskie w latach 1815‒1848 Uczeń:
...
17. Sprawa polska w czasie I wojny światowej Uczeń:
...
18. Odrodzenie państwa polskiego po I wojnie światowej Uczeń:
...
20. Społeczeństwo i gospodarka II Rzeczypospolitej Uczeń:
...
21. Wrzesień 1939 r. Agresja Niemiec (1 września) i Związku Sowieckiego (17 września) Uczeń:
...
22. Polska pod okupacją niemiecką i sowiecką Uczeń:
...
23. Sprawa polska w czasie II wojny światowej Uczeń:
...
24. Początki komunizmu w Polsce Uczeń:
...
25. Stalinizm w Polsce i jego skutki Uczeń:
...
26. Polska w latach 1957‒1981 Uczeń:
...
27. Polska w latach 1981‒1989 Uczeń:
...
28. Narodziny III Rzeczypospolitej Uczeń:
...
29. Miejsce Polski w pojałtańskim świecie Uczeń:
...
30. Polska we współczesnym świecie Uczeń:
...
33. Obywatelstwo polskie i udział obywateli w życiu publicznym Uczeń:
...
34. Współczesne społeczeństwo polskie Uczeń:
...
Treści nauczania ‒ wymagania szczegółowe W liceum ogólnokształcącym obowiązuje utrwalanie, poszerzanie i doskonalenie wiadomości i umiejętności nabytych w szkole podstawowej.
...
11) korzysta z zasobów multimedialnych (np. z bibliotek, słowników on-line, wydawnictw e-book, autorskich stron internetowych twórców) dokonuje wyboru źródeł internetowych, uwzględniając kryterium poprawności rzeczowej i krytycznie ocenia ich zawartość;
...
40) Marek Nowakowski, Raport o stanie wojennym (wybrane opowiadanie); Górą „Edek” (z tomu Prawo prerii);
...
Warunki i sposób realizacji Ramy programowe kształcenia uzupełniającego dla liceum ogólnokształcącego zawierają chronologiczny układ treści, który pozwala na poznawanie utworów literackich w naturalnym porządku, tak jak one powstawały, z uwzględnieniem różnorodnych kontekstów, w tym kulturowych, historycznych i filozoficznych. Nauczanie języka polskiego na tym etapie edukacyjnym nie może sprowadzać się jedynie do uczenia historii literatury, może to bowiem prowadzić do encyklopedyzmu czy mnożenia faktów. Chronologia ma stanowić punkt odniesienia, umożliwić rozwijanie świadomości historycznoliterackiej uczniów, co powinno dokonywać się przez porównywanie zjawisk literackich w czasie. Należy przyjąć perspektywę współczesną jako punkt wyjścia do wprowadzania do tradycji.
Kształcenie literackie i kulturowe w liceum ogólnokształcącym powinno akcentować egzystencjalne aspekty doświadczenia siebie, innych, świata, otwierać ciekawą przestrzeń myślenia i wartościowania przez kontakty z wartościową literaturą i innymi tekstami kultury.
Powinno równocześnie wprowadzać w tradycję jako strażnika pamięci zbiorowej, łącznika między dawnymi i współczesnymi latami.
Jednym z ważnych zadań edukacji polonistycznej w liceum ogólnokształcącym jest kontynuowanie kształcenia umiejętności świadomego posługiwania się językiem polskim.
...
WIEDZA O POLSCE (elementy historii, geografii, kultury) Klasy I‒IV liceum ogólnokształcącego Cele kształcenia ‒ wymagania ogólne w zakresie historii Polski i kultury Uczeń zdobywa usystematyzowaną wiedzę na temat historii Polski, kultury i społeczeństwa polskiego na przestrzeni od X w. do czasów współczesnych, która pozwoli mu lepiej poznać historię Polski oraz dostrzec korzenie wielu współczesnych zjawisk politycznych, społecznych, gospodarczych i kulturowych.
...
Treści nauczania ‒ wymagania szczegółowe w zakresie historii Polski i kultury
1. Polska w okresie wczesnopiastowskim Uczeń:
...
2. Polska w okresie rozbicia dzielnicowego Uczeń:
...
4. Kultura polskiego średniowiecza Uczeń:
...
5. Państwo polsko-litewskie w czasach ostatnich Jagiellonów Uczeń:
...
na tle wojen religijnych trwających na skutek reformacji na Zachodzie;
...
8. Pierwsze wolne elekcje i ich rezultaty Uczeń:
...
11. Rzeczpospolita w XVIII w. (od czasów saskich do Konstytucji 3 maja) Uczeń:
...
12. Kultura doby oświecenia w Rzeczypospolitej Obojga Narodów Uczeń:
...
13. Schyłek Rzeczypospolitej (wojna z Rosją i powstanie kościuszkowskie) Uczeń:
...
14. Sprawa polska w dobie wojen napoleońskich Uczeń:
...
15. Ziemie polskie i ich mieszkańcy w latach 1815‒1848 Uczeń:
...
16. Powstanie styczniowe i jego następstwa Uczeń:
...
17. Ziemie polskie pod zaborami w II połowie XIX w. i na początku XX w Uczeń:
...
18. Kultura i nauka polska w II połowie XIX w. i na początku XX w Uczeń:
...
19. Sprawa polska w przededniu i podczas I wojny światowej Uczeń:
...
20. Walka o odrodzenie państwa polskiego po I wojnie światowej Uczeń:
...
21. Dzieje polityczne II Rzeczypospolitej Uczeń:
...
22. Gospodarka i społeczeństwo polskie w okresie międzywojennym Uczeń:
...
5) charakteryzuje i ocenia osiągnięcia gospodarcze II Rzeczypospolitej z lat 30. (m.in.
reformy Eugeniusza Kwiatkowskiego, rozwój Gdyni i Centralny Okręg Przemysłowy);
6) dostrzega obecność Polonii poza granicami kraju w okresie II Rzeczypospolitej.
23. Kultura i nauka polska w latach 1918‒1939 Uczeń:
...
24. Polska w obliczu II wojny światowej Uczeń:
...
25. Wojna obronna Polski we wrześniu 1939 r. Agresja Niemiec (1 września) i Związku Sowieckiego (17 września) Uczeń:
1) charakteryzuje położenie międzynarodowe Polski w przededniu wybuchu II wojny światowej;
...
26. Polska pod okupacją niemiecką i sowiecką Uczeń:
...
27. Niemiecka polityka eksterminacji Uczeń:
...
29. Proces przejmowania władzy przez komunistów w Polsce (1944–1948) Uczeń:
...
30. Stalinizm w Polsce i jego skutki Uczeń:
...
31. Polska w latach 1957‒1981 Uczeń:
...
9) charakteryzuje ruch społeczny „Solidarność” i ocenia jego wpływ na przemiany społeczno-polityczne.
32. Polska w latach 1981‒1989 Uczeń:
...
5) charakteryzuje różne wizje wyjścia Polski z postkomunizmu i wyjaśnia, na czym polegało polityczne znaczenie wyborów parlamentarnych i prezydenckich w 2005 r.
w Polsce;
...
34. Rzeczpospolita Polska jako demokracja konstytucyjna Uczeń:
...
35. System wyborczy i partyjny w Polsce Uczeń:
...
36. Władza ustawodawcza i władza wykonawcza w Polsce Uczeń:
...
37. Polska w Europie i świecie w latach 1989‒2004 Uczeń:
...
38. Migracje we współczesnej Polsce Uczeń:
1) wyjaśnia, czym są: migracja, imigracja, emigracja i repatriacja;
2) charakteryzuje zasięg i skalę przemieszczeń ludnościowych na ziemiach polskich w XX w.
i XXI w.;
...
39. Wyzwania współczesnej Polski Uczeń:
...
4) posługuje się planem, mapą topograficzną, turystyczną i samochodową Polski (m.in.
orientuje mapę oraz identyfikuje obiekty geograficzne na mapie, planuje podróż do Polski i wycieczki po kraju);
...
2. Położenie i regionalne zróżnicowanie środowiska przyrodniczego Polski Uczeń:
...
3. Zróżnicowanie społeczne Polski Uczeń:
...
4. Zróżnicowanie gospodarcze Polski Uczeń:
...
5. Zróżnicowanie kulturowe Polski Uczeń:
...
Indywidualizacja pracy w grupie odgrywa istotną rolę w nauczaniu w oddziałach dziecięcych.
Dobór metod pracy oraz zakresu realizowanych treści uwzględnia nie tylko wiek dzieci w grupie i wynikające z niego potrzeby rozwojowe, ale też poziom znajomości języka polskiego, specyfikę kraju zamieszkania i relacje w grupie rówieśniczej.
...
– 2 – W efekcie dziecko w naturalny sposób poznaje i utrwala język polski oraz buduje poczucie przynależności do narodu polskiego.
...
PLAN NAUCZANIA DLA ODDZIAŁÓW DZIECIĘCYCH W SZKOŁACH ZA GRANICĄ I SZKOŁACH POLSKICH Obowiązkowe zajęcia edukacyjne Maksymalna liczba godzin w semestrze Edukacja w oddziałach dziecięcych 72 Godziny do dyspozycji dyrektora 18 Godziny do dyspozycji dyrektora, po ustaleniu przez dyrektora w porozumieniu z radą rodziców, mogą być przeznaczone na zwiększenie liczby godzin obowiązkowych zajęć edukacyjnych wskazanych w planie nauczania dla oddziałów dziecięcych lub realizację religii albo innych zajęć służących rozwijaniu znajomości języka polskiego i wiedzy na temat Polski.
