...
| Pole | Wartość |
|---|---|
| Adres publikacyjny | Dz.U. 2018 poz. 1613 |
| ISAP | WDU20180001613 |
| Typ aktu | Ustawa |
| Status | akt objęty tekstem jednolitym |
| W mocy | tak |
...
- **2)** w art. 59:
    ...
    - **b)** ust. 2c otrzymuje brzmienie: „2c. Zarząd Zakładu uruchamia środki FRD na cel, o którym mowa w ust. 1 pkt 1, do wysokości ujętej w planie finansowym FUS.”;

- **3)** w art. 63:
    - **a)** uchyla się ust. 3,
    - **b)** dodaje się ust. 4 w brzmieniu: „4. Środki pochodzące z wykupu aktywów, o których mowa w art. 58 ust. 2 pkt 4a, oraz przychody uzyskane od tych aktywów zwiększają aktywa FRD.”;

- **4)** w art. 65 w ust. 3 uchyla się pkt 3;
- **5)** w art. 76 po ust. 1 dodaje się ust. 1a w brzmieniu: „1a. Należności z tytułu poniesionych kosztów, o których mowa w ust. 1 pkt 2 i 3, Zakład pobiera w formie potrącenia z dokonanych wpłat.”.
