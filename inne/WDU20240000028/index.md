...
**§ 2.** Rozporządzenie wchodzi w życie po upływie 14 dni od dnia ogłoszenia . SZCZEGÓŁOWE WYMAGANIA W ZAKRESIE JAKOŚCI HANDLOWEJ NIEKTÓRYCH RODZAJÓW MLEKA ZAGĘSZCZONEGO I MLEKA W PROSZKU 1. Mleko zagęszczone jest produktem płynnym, słodzonym albo niesłodzonym:
...
- **3)** laktozy, stanowiącej naturalny składnik mleka otrzymywany zwykle z serwatki i zawierający co najmniej 99,0 % m/m laktozy bezwodnej w suchej masie; użyta laktoza może być bezwodna lub zawierać jedną cząsteczkę wody krystalizacyjnej, lub stanowić kombinację obu form. METODY ANALIZ NIEKTÓRYCH RODZAJÓW MLEKA ZAGĘSZCZONEGO I MLEKA W PROSZKU I. PRZEPISY OGÓLNE
...
- **3)** w celu zminimalizowania absorpcji wody podczas przygotowywania próbki należy unikać wystawiania próbki mleka na bezpośrednie oddziaływanie powietrza atmosferycznego. II. METODA OZNACZANIA ZAWARTOŚCI SUCHEJ MASY ORAZ SUCHEJ MASY BEZTŁUSZCZOWEJ W MLEKU ZAGĘSZCZONYM (suszenie w temperaturze 99 ºC)

1. Metoda oznaczania zawartości suchej masy w mleku zagęszczonym, zwana dalej „metodą”, polega na rozcieńczeniu próbki mleka zagęszczonego wodą, wymieszaniu z piaskiem i wysuszeniu w temperaturze 99 ºC ± 1 ºC; masa po wysuszeniu stanowi suchą masę i jest wyrażana jako ułamek masowy próbki w procentach.
...
- **3)** suszarki pod ciśnieniem atmosferycznym, dobrze wentylowanej, z termostatyczną regulacją temperatury 99 ºC ± 1 ºC, zapewniającej jednolitą temperaturę w całej suszarce;
...
13. Wynik zamieszczony w protokole analizy laboratoryjnej powinien spełniać kryteria powtarzalności określone dla metody. III. METODA OZNACZANIA ZAWARTOŚCI WODY W MLEKU W PROSZKU (suszenie w temperaturze 102 °C)
...
- **2)** przykryte wieczkiem naczynko wagowe przenosi się do eksykatora, schładza do temperatury pokojowej i waży z dokładnością do 0,1 mg, a masę odnotowuje się jako m ;
- **3)** do naczynka wagowego przenosi się około 2 g próbki mleka w proszku, naczynko wagowe przykrywa się wieczkiem i możliwie jak najszybciej waży z dokładnością do 0,1 mg, a masę odnotowuje się jako m ;
...
8. Wynik zamieszczony w protokole analizy laboratoryjnej powinien spełniać kryteria powtarzalności określone dla metody. IV. METODA OZNACZANIA ZAWARTOŚCI SACHAROZY W MLEKU ZAGĘSZCZONYM SŁODZONYM (METODA POLARYMETRYCZNA)
...
- **1)** roztwór octanu cynku, o stężeniu 1 mol/l, uzyskany przez rozpuszczenie w wodzie 21,9 g krystalicznego 2 · hydratu octanu cynku (Zn(C H O )2 · 2 H O) i 3 ml kwasu octowego lodowatego i uzupełnienie wodą do objętości 100 ml;
- **2)** roztwór heksacyjanożelazianu(II) potasu, o stężeniu 0,25 mol/l, uzyskany przez rozpuszczenie w wodzie 10,6 g krystalicznego heksacyjanożelazianu(II) potasu K [Fe(CN) ] · 3 H O i uzupełnienie wodą do 100 ml;
...
13. Wynik zamieszczony w protokole analizy laboratoryjnej powinien spełniać kryteria powtarzalności określone dla metody. V. METODA OZNACZANIA ZAWARTOŚCI KWASU MLEKOWEGO I MLECZANÓW W MLEKU W PROSZKU
...
- **1)** roztwór siarczanu(VI) miedzi(II) otrzymywany przez rozpuszczenie w wodzie 250 g siarczanu(VI) miedzi(II) (CuSO · 5 H O) i uzupełnienie wodą do objętości 1000 ml;
- **2)** zawiesiny wodorotlenku wapnia przygotowane bezpośrednio przed użyciem w następujący sposób:
    - **a)** 300 g wodorotlenku wapnia (Ca(OH) ) rozciera się w moździerzu z wodą i uzupełnienia wodą do objętości 900 ml,
    - **b)** 300 g wodorotlenku wapnia (Ca(OH) ) rozciera się w moździerzu z wodą i uzupełnienia wodą do objętości 1400 ml;

- **3)** roztwór kwasu siarkowego(VI) i siarczanu(VI) miedzi(II) otrzymywany przez dodanie do 300 ml kwasu siarkowego(VI) (H SO ), o stężeniu od 95,9 % do 97,0 % (m/m), 0,5 ml roztworu siarczanu(VI) miedzi(II);
- **4)** roztwór p-hydroksydwufenylu (C H C H OH) przygotowany w następujący sposób:
...
- **5)** roztwór wzorcowy kwasu mlekowego, którego 1 ml odpowiada 0,1 mg kwasu mlekowego, otrzymywany bezpośrednio przed użyciem przez rozpuszczenie w wodzie, w kolbie pomiarowej, 0,1067g mleczanu litu (CH CHOHCOOLi) i uzupełnienie wodą do 1000 ml;
...
- **2)** odważa się g próbki z dokładnością do 0,1 g, gdzie „a” jest równe zawartości suchej masy beztłuszczowej próbki oznaczonej zgodnie z pkt 1;
...
14. Wynik zamieszczony w protokole analizy laboratoryjnej powinien spełniać kryteria powtarzalności określone dla metody. VI. METODA OZNACZANIA AKTYWNOŚCI FOSFATAZY W MLEKU W PROSZKU (ZMODYFIKOWANA METODA SANDERSA I SAGERA)
...
- **2)** substrat buforowy otrzymywany przez rozpuszczenie w kolbie pomiarowej 1,5 g p-nitrofenylofosforanu dwusodu w roztworze buforowym, o którym mowa w pkt 1, i uzupełnienie tym roztworem buforowym do 1000 ml;
- **3)** roztwory klarujące:
    - **a)** roztwór siarczanu(VI) cynku otrzymywany przez rozpuszczenie w kolbie pomiarowej 30,0 g siarczanu(VI) cynku (ZnSO ) i uzupełnienie wodą do 100 ml,
    - **b)** roztwór heksacyjanożelazianu(II) potasu otrzymywany przez rozpuszczenie w kolbie pomiarowej 17,2 g heksacyjanożelazianu(II) potasu K [Fe(CN) ] · 3 H O i uzupełnienie wodą do 100 ml.
...
- **1)** rozpuszcza się 10 g mleka w proszku w 90 ml wody, przy czym temperatura podczas rozpuszczania nie może przekroczyć 35 ºC;
...
- **4)** probówkę zamyka się korkiem, miesza przez odwracanie i umieszcza w łaźni wodnej o temperaturze 37 ºC ± 1 ºC;
