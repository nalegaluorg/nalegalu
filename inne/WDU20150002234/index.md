...
# RZECZYPOSPOLITEJ POLSKIEJ Poz. 2234 ROZPORZĄDZENIE MINISTRA FINANSÓW z dnia 21 grudnia 2015 r.
...
w sprawie szczegółowych warunków dotyczących miejsca odbioru wyrobów akcyzowych oraz prowadzenia składu podatkowego Na podstawie art. 59 ust. 7 ustawy z dnia 6 grudnia 2008 r. o podatku akcyzowym (Dz. U. z 2014 r. poz. 752, z późn.
...
**§ 2.** Miejsce odbioru wyrobów akcyzowych powinno:
...
**§ 3.** Miejsce prowadzenia składu podatkowego powinno:

- **1)** być wydzielone od pozostałej części terenu lub pomieszczenia, w szczególności za pomocą ogrodzenia lub innego trwałego oznaczenia;
- **2)** być oznaczone poprzez umieszczenie tablicy zawierającej wyrazy „Skład podatkowy” oraz imię i nazwisko lub naz– wę podmiotu prowadzącego skład podatkowy;
...
- **2)** wyrobów energetycznych, o których mowa w art. 47a ust. 3 ustawy – odbywa się w zbiornikach, które podlegają prawnej kontroli metrologicznej, na podstawie odrębnych przepisów.
...
- **2)** o których mowa w art. 47a ust. 3 ustawy – odbywa się w zbiornikach, które podlegają prawnej kontroli metrologicznej, na podstawie odrębnych przepisów.
...
**§ 5.** W przypadku wystąpienia braków ilościowych wyrobów akcyzowych podmiot prowadzący skład podatkowy informuje o tym fakcie niezwłocznie, nie później niż w terminie 3 dni roboczych, licząc od dnia stwierdzenia braków, właś– ciwego naczelnika urzędu celnego.
...
**§ 7.** Rozporządzenie wchodzi w życie z dniem 1 stycznia 2016 r. Minister Finansów: P. Szałamacha
