...
| Źródło | [ELI HTML](https://eli.gov.pl/api/acts/DU/2005/1200/text.html) · [ELI API](https://api.sejm.gov.pl/eli/acts/DU/2005/1200) |
...
Planowane nakłady na realizację działań z zakresu wczesnego wykrywania chorób nowotworowych muszą stanowić:

### 1)

20% rocznych nakładów na Program przez pierwszy i drugi rok;

### 2)

25% rocznych nakładów na Program przez trzeci i czwarty rok;

### 3)

30% rocznych nakładów na Program przez piąty i szósty rok;

### 4)

35% rocznych nakładów na Program przez lata następne do zakończenia Programu.
