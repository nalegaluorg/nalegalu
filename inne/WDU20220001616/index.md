...
1. W przypadku uzasadnionych wątpliwości właściwy organ może wystąpić do właściwych organów państwa usługodawcy o potwierdzenie, że usługodawca wykonuje zawód regulowany albo działalność regulowaną zgodnie z prawem i z dołożeniem należytej staranności oraz że nie zostały na niego nałożone kary dyscyplinarne lub nie został skazany prawomocnym wyrokiem sądu w związku z wykonywaniem zawodu regulowanego albo działalności regulowanej. ” , w ust. 2 po wyrazach „informacji dotyczących kształcenia lub szkolenia ukończonego przez usługodawcę” dodaje się przecinek i wyrazy „w zakresie niezbędnym do oceny, czy różnice wykazane w istotnie różniącym się materiale mogą być szkodliwe dla zdrowia lub bezpieczeństwa publicznego”;

- **b)**
- **8)** w art. 39: w ust. 1 wyrazy „różnic w zakresie zawodu i niemożliwości wyrównania brakującej wiedzy, umiejętności i kompetencji, wymaganych” zastępuje się wyrazami „niewyrównania w całości istotnie różniącego się materiału w zakresie kształcenia lub szkolenia wymaganego”, ust. 4 otrzymuje brzmienie: „
    - **a)**
    - **b)**
...
- **10)** w art. 50b w ust. 5: wprowadzenie do wyliczenia otrzymuje brzmienie: „ W ramach oceny w zakresie, o którym mowa w ust. 3 pkt 6, uwzględnia się wymóg zawarty w przepisach regulacyjnych, dotyczący: ” , w części wspólnej wyraz „występują” zastępuje się wyrazem „występuje”;
    - **a)**
    - **b)**

- **11)** w art. 50e w ust. 3: we wprowadzeniu do wyliczenia wyraz „wymogi” zastępuje się wyrazem „wymóg”, w części wspólnej wyraz „występują” zastępuje się wyrazem „występuje”;
    - **a)**
    - **b)**
