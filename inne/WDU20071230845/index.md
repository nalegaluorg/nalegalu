...
- **4)** po art. 129a dodaje się art. 129b-129f w brzmieniu: „Art. 129b. 1. Kontrola ruchu drogowego w gminach lub miastach, które utworzyły straż gminną (miejską) może być wykonywana przez strażników gminnych (miejskich).

2. Straż nicy gminni (miejscy) są uprawnieni do wykonywania kontroli ruchu drogowego wobec:
