...
| Źródło | [ISAP](https://isap.sejm.gov.pl/isap.nsf/DocDetails.xsp?id=WDU19950970481) · [PDF](https://api.sejm.gov.pl/eli/acts/DU/1995/481/text.pdf) |
...
**Art. 2.** Kościół jest częścią ogólnoświatowego Kościoła Adwentystów Dnia Siódmego i uznaje Generalną Konferencję Kościoła Adwentystów Dnia Siódmego za najwyższą władzę w sprawach doktrynalnych i kanonicznych.
...
**Art. 7.** Kościelne wydawnictwa, zakłady charytatywno-opiekuńcze, szkoły, placówki oświatowo-wychowawcze, zakłady opieki zdrowotnej, a także zakłady gospodarcze, nie posiadające osobowości prawnej, działają w ramach tych kościelnych osób prawnych, które je powołały.
...
**Art. 20.** Kościół, jego osoby prawne i inne jednostki organizacyjne Kościoła określone w jego Statucie mają prawo prowadzenia właściwej dla każdej z nich działalności charytatywno-opiekuńczej.
...
- **2)** wysyłane przez kościelne osoby prawne za granicę dary: na rzecz zagranicznych i międzynarodowych organizacji adwentystycznych, przeznaczone dla ofiar klęsk żywiołowych i osób znajdujących się w szczególnej potrzebie.
    - **a)**
    - **b)**
