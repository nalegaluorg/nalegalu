...
- **1)** wydawania, przedłużania ważności, wykorzystywania i unieważniania profilu zaufanego, w tym: o informatyzacji działalności podmiotów realizujących zadania publiczne,
...
**§ 26.** Rozporządzenie wchodzi w życie z dniem następującym po dniu ogłoszenia . Zakres danych oraz oświadczenia wymagane we wniosku o potwierdzenie profilu zaufanego:
...
- **4)** * adnotacje osoby upoważnionej do potwierdzania profilu zaufanego: Zakres danych wymagany we wniosku o potwierdzenie profilu zaufanego w sposób, o którym mowa w art. 20cb ustawy :
...
- **6)** inne lub uzupełniające adnotacje. Zakres danych oraz oświadczenia wymagane we wniosku o przedłużenie ważności profilu zaufanego:
- **1)** dane dotyczące osoby wnioskującej:
    - **a)** imię (imiona),
    - **b)** nazwisko,
    - **c)** numer PESEL,
...
- **3)**  miejscowość i data oraz czytelny podpis osoby wnioskującej;
- **4)** * adnotacje osoby upoważnionej do potwierdzania profilu zaufanego: Zakres danych oraz oświadczenia wymagane we wniosku o unieważnienie profilu zaufanego:
    - **a)** dane dotyczące punktu potwierdzającego: – nazwa punktu potwierdzającego, – znak sprawy nadany w punkcie potwierdzającym,
    - **b)** dane dotyczące osoby upoważnionej do potwierdzania profilu zaufanego: – imię (imiona), – nazwisko, – stanowisko służbowe,
