...
- **2)** w art. 10: ust. 1c otrzymuje brzmienie: „
    - **a)**

1c. Członek rodziny wielodzietnej we wniosku, o którym mowa w ust. 1, podaje adres poczty elektronicznej i numer telefonu komórkowego każdego członka rodziny wielodzietnej, o ile je posiadają. ” , po ust. 1c dodaje się ust. 1d-1g w brzmieniu: „
...
1g. Funkcjonalność, o której mowa w ust. 1f, jest udostępniana rodzicowi oraz małżonkowi rodzica. ” , po ust. 19 dodaje się ust. 19a w brzmieniu: „
...
1a. W przypadku gdy członkowi rodziny wielodzietnej, na jego wniosek, została już udostępniona karta elektroniczna i następnie członek rodziny wielodzietnej wnioskuje o wydanie karty tradycyjnej, wydanie Karty podlega opłacie w wysokości 10,00 zł. ” , w ust. 2 wyrazy „9,21 zł” zastępuje się wyrazami „10,00 zł”;
...
- **3)** przeniesienie poszczególnych wydatków budżetowych zostanie uzgodnione przez ministrów odpowiedzialnych za realizację danego zadania. ” , uchyla się ust. 3, w ust. 4a wyrazy „limitu wydatków, o których mowa” zastępuje się wyrazami „limitu, o którym mowa”, ust. 5 otrzymuje brzmienie: „
    - **c)**
    - **d)**
    - **e)**
...
- **1)** może być wydany użytkownikowi publicznej aplikacji mobilnej: uwierzytelnionemu w sposób określony w art. 20a ust. 1 lub o którym mowa w przepisach wydanych na podstawie art. 11 ust. 2 ustawy z dnia 7 września 1991 r. o systemie oświaty (Dz. U. z 2020 r. poz. 1327 oraz z 2021 r. poz. 4), lub o którym mowa w przepisach wydanych na podstawie art. 81 ustawy z dnia 20 lipca 2018 r. – Prawo o szkolnictwie wyższym i nauce; ” ;
    - **a)**
    - **b)**
    - **c)**

- **2)** po art. 19e dodaje się art. 19ea w brzmieniu: „ Art. 19ea.
...
- **3)** w art. 39 w ust. 1: pkt 4 otrzymuje brzmienie: „
    - **a)**

- **4)** nie figuruje w bazie danych Rejestru Sprawców Przestępstw na Tle Seksualnym z dostępem ograniczonym; ” , po pkt 4 dodaje się pkt 4a w brzmieniu: „
    - **b)**
...
- **7)** w art. 62: ust. 7 otrzymuje brzmienie: „
    - **a)**

7. Do środków z Funduszu Pracy stosuje się odpowiednio art. 57, art. 168 i art. 169 ustawy z dnia 27 sierpnia 2009 r. o finansach publicznych (Dz. U. z 2021 r. poz. 305), z tym że organem właściwym do umarzania, odraczania terminów lub rozkładania na raty spłat należności Funduszu Pracy, a także wydania decyzji o zwrocie w związku z niewykorzystaniem środków, wykorzystaniem środków niezgodnie z przeznaczeniem albo pobrania ich nienależnie lub w nadmiernej wysokości, jest wojewoda. ” , dodaje się ust. 8 i 9 w brzmieniu: „
...
- **8)** w art. 64 w ust. 4: pkt 1 otrzymuje brzmienie: „
    - **a)**

- **1)** liczba osób zatrudnionych w żłobku lub klubie dziecięcym według stanowiska pracy, z uwzględnieniem informacji o ich płci, a w przypadku pielęgniarek i położnych również o tym, czy dla tych osób jest to główne miejsce pracy; ” , po pkt 1 dodaje się pkt 1a w brzmieniu: „
    - **b)**

- **1a)** liczba wolontariuszy udzielających w danym roku pomocy instytucji opieki nad dziećmi w wieku do lat 3; ” , pkt 5 otrzymuje brzmienie: „
    - **c)**

- **5)** wysokość otrzymywanych dotacji ze środków publicznych, w tym ze środków Unii Europejskiej, oraz liczbę dzieci lub miejsc objętych dofinansowaniem; ” , w pkt 6 kropkę zastępuje się średnikiem i dodaje się pkt 7–11 w brzmieniu: „
    - **d)**
