---
title: "Ustawa z dnia 12 lipca 1995 r. o zmianie Kodeksu karnego, Kodeksu karnego wykonawczego oraz o podwyższeniu dolnych i górnych granic grzywien i nawiązek w prawie karnym."
address: WDU19950950475
eli: DU/1995/475
publisher: DU
year: 1995
pos: 475
...
| Pole | Wartość |
|---|---|
| Adres publikacyjny | Dz.U. 1995 nr 95 poz. 475 |
| ISAP | WDU19950950475 |
| Typ aktu | Ustawa |
| Status | obowiązujący |
| W mocy | tak |
| Data ogłoszenia | 1995-07-12 |
| Data wydania | 1995-08-19 |
| Wejście w życie | 1995-11-20 |
| Ostatnia zmiana | 2024-11-25 |
| Źródło | [ISAP](https://isap.sejm.gov.pl/isap.nsf/DocDetails.xsp?id=WDU19950950475) · [PDF](https://api.sejm.gov.pl/eli/acts/DU/1995/475/text.pdf) |
...
- **3)** w art. 36: § 3 otrzymuje brzmienie: „
    - **a)**

§ 3. Sąd może orzec grzywnę określoną w § 2, jeżeli sprawca działał w celu osiągnięcia korzyści majątkowej lub taką korzyść osiągnął, oraz orzeka grzywnę w wypadkach wskazanych w ustawie. ” , skreśla się § 4;
...
- **7)** w art. 59: § 1 otrzymuje brzmienie: „
    - **a)**

§ 1. Charakter chuligański występku sąd uwzględnia jako okoliczność wpływającą na zaostrzenie kary. ” , skreśla się § 2, w § 3 wyrazy „Sąd orzeka” zastępuje się wyrazami „Sąd może orzec”;
...
- **11)** w art. 68 dodaje się § 11 w brzmieniu: „
...
- **16)** w art. 85: § 1 otrzymuje brzmienie: „
    - **a)**
...
- **22)** w art. 93: w § 2 skreśla się wyrazy „lub 3”, dodaje się § 3 w brzmieniu: „
    - **a)**
    - **b)**
...
- **25)** w art. 108: dotychczasowa treść otrzymuje oznaczenie § 1, dodaje się § 2 w brzmieniu: „
    - **a)**
    - **b)**
...
§ 4. Sprawca czynu określonego w § 1 lub 2, który zbiegł z miejsca zdarzenia, podlega karze pozbawienia wolności od roku do lat 10. ” ;

- **28)** w art. 184 § 2 otrzymuje brzmienie: „

§ 2. Jeżeli następstwem czynu jest targnięcie się pokrzywdzonego na własne życie albo sprawca działa ze szczególnym okrucieństwem, podlega karze pozbawienia wolności od roku do lat 10. ” ;

- **29)** art. 202 otrzymuje brzmienie: „

**Art. 202.** Kto wykorzystując działalność gospodarczą osoby fizycznej, prawnej albo innej jednostki organizacyjnej nie mającej osobowości prawnej, w porozumieniu z innymi osobami, zagarnia mienie tej osoby lub jednostki, nabywców lub dostawców, podlega karze pozbawienia wolności od roku do lat 10. ” ;
...
- **32)** w art. 214: w § 1 wyrazy „do lat 3” zastępuje się wyrazami „od 6 miesięcy do lat 5”, § 2 i § 3 otrzymują brzmienie: „
    - **a)**
    - **b)**
...
§ 3. Jeżeli czyn określony w § 1 popełniono używając przemocy lub grożąc natychmiastowym jej użyciem albo doprowadzając człowieka do stanu nieprzytomności lub bezbronności, sprawca podlega karze pozbawienia wolności od lat 2 do 10. ” , dodaje się § 4 w brzmieniu: „
...
§ 1. Kto dopuszcza się czynnej napaści na funkcjonariusza publicznego albo osobę do pomocy mu przybraną, w związku z pełnieniem obowiązków służbowych, podlega karze pozbawienia wolności od 6 miesięcy do lat 8.

§ 2. Kto dopuszcza się czynnej napaści, o której mowa w § 1, polegającej na spowodowaniu ciężkiego uszkodzenia ciała lub ciężkiego rozstroju zdrowia, podlega karze pozbawienia wolności na czas nie krótszy od lat 3. ” ;

- **34)** skreśla się art. 234;
- **35)** w art. 253 wyrazy „od 6 miesięcy do lat 5” zastępuje się wyrazami „od 6 miesięcy do lat 8.”;
- **36)** w art. 276: w § 1 wyrazy „w związku mającym” zastępuje się wyrazami „w związku lub w zorganizowanej grupie mających”, w § 2 wyraz „związek” zastępuje się wyrazami „związek lub zorganizowana grupa”, § 3 otrzymuje brzmienie: „
    - **a)**
    - **b)**
    - **c)**

§ 3. Kto związek lub zorganizowaną grupę określone w § 1 lub 2 zakłada albo związkiem lub grupą kieruje, podlega karze pozbawienia wolności od lat 2 do 10. ” ;
...
- **4)** w art. 39: § 1 otrzymuje brzmienie: „
    - **a)**
...
- **5)** zakłady karne dla odbywających karę aresztu wojskowego. ” , dodaje się § 11 i § 12 w brzmieniu: „
    - **b)**
...
§ 12. Zakłady karne różnią się w szczególności stopniem zabezpieczenia, stopniem izolacji skazanych oraz związanym z tym zakresem ich obowiązków i uprawnień. ” , w § 2 po wyrazach „odmiennego typu” dodaje się wyrazy „lub rodzaju”, a po wyrazach „w § 1” dodaje się wyrazy „i § 11 ”;

- **c)**
- **5)** skreśla się art. 40;
- **6)** w art. 44: w § 1 skreśla się wyrazy „oznacza rygor” i poprzedzający je przecinek, w § 2 skreśla się wyrazy „i rygor, według którego skazany odbywa karę”, w § 3 wyrazy „w art. 39 § 1 pkt 6” zastępuje się wyrazami „w art. 39 § 1 pkt 4”, po § 3 dodaje się § 4 w brzmieniu: „
    - **a)**
    - **b)**
    - **c)**
    - **d)**
...
- **9)** w art. 49: w § 3 po wyrazie „skazany” dodaje się wyrazy „, chyba że skazany wyrazi zgodę na niższe wynagrodzenie”, § 4 otrzymuje brzmienie: „
    - **a)**
    - **b)**

§ 4. Za prace porządkowe oraz pomocnicze o charakterze administracyjno-gospodarczym, wykonywane na rzecz zakładu karnego w wymiarze nie przekraczającym 60 godzin miesięcznie, wynagrodzenie skazanemu nie przysługuje. Za sumienną pracę mogą być przyznawane nagrody pieniężne. ” , dodaje się § 5 w brzmieniu: „
...
- **10)** w art. 52: w § 1 liczbę „5” zastępuje się liczbą „10”, a liczbę „25” zastępuje się liczbą „50”, w § 2 skreśla się wyrazy „, od rygoru, według którego odbywa się karę”;
    - **a)**
    - **b)**

- **11)** w art. 53: dodaje się § 21 w brzmieniu: „
    - **a)**

§ 21. Zakres i wysokość wolnych od egzekucji kwot pochodzących z innych źródeł niż wymienione w § 1 i 2 określi regulamin. ” , w § 3 po wyrazach „wysokość tej kwoty”, dodaje się wyrazy „oraz zasady jej gromadzenia”;
...
§ 1. W zakresie wykonywania pracy, o której mowa w art. 85 § 1 Kodeksu karnego, stosuje się odpowiednio przepisy odnoszące się do kary ograniczenia wolności polegającej na wykonywaniu nieodpłatnej dozorowanej pracy na cele publiczne, z wyjątkiem art. 124.
...
- **15)** w art. 175: po § 1 dodaje się § 11 w brzmieniu: „
    - **a)**

§ 11. Należność Skarbu Państwa z tytułu nie uiszczonych kosztów sądowych może być przez sąd umorzona lub zapłata tej należności odroczona albo rozłożona na raty, jeżeli jej ściągnięcie byłoby połączone z niewspółmiernymi trudnościami lub groziłoby dłużnikowi zbyt ciężkimi skutkami. ” , w § 2 wyraz „Zasady” zastępuje się wyrazami „Szczegółowe zasady”;
...
1. Określone w Kodeksie karnym i w ustawie z dnia 19 kwietnia 1969 r. – Przepisy wprowadzające Kodeks karny (Dz. U. Nr 13, poz. 95, z 1982 r. Nr 40, poz. 271, z 1985 r. Nr 23, poz. 100, z 1990 r. Nr 72, poz. 422 i z 1992 r. Nr 24, poz. 101), w Kodeksie wykroczeń oraz w innych ustawach: dolne granice grzywny i nawiązek ustala się – w wysokości dwukrotnej, a górne ich granice – w wysokości dziesięciokrotnej, kwoty grzywny nie podlegającej zamianie na karę zastępczą ustala się – w wysokości dwukrotnej, dolne kwoty określające zastępczą karę pozbawienia wolności lub aresztu albo ograniczenia wolności na wypadek nieuiszczenia grzywny w terminie lub zaliczenia okresu tymczasowego aresztowania na poczet grzywny ustala się – w wysokości dwukrotnej, a górne – w wysokości dziesięciokrotnej.
...
3. W Kodeksie postępowania karnego i w Kodeksie postępowania w sprawach o wykroczenia: dolne granice grzywny orzekanej w postępowaniu nakazowym ustala się – w wysokości dwukrotnej, a górne – w wysokości pięciokrotnej, dolne granice kar pieniężnych i porządkowych ustala się – w wysokości dwukrotnej, a górne – w wysokości dziesięciokrotnej, górną granicę grzywny, o której mowa w art. 450 Kodeksu postępowania karnego, ustala się – w wysokości pięciokrotnej, wartość przedmiotu przestępstwa albo szkody wyrządzonej lub zamierzonej w postępowaniu przyspieszonym (art. 447 § 1 pkt 2 Kodeksu postępowania karnego) ustala się – w wysokości pięciokrotnej, dolne granice grzywny nałożonej w drodze mandatu karnego ustala się – w wysokości dwukrotnej, a górne – w wysokości dziesięciokrotnej.
...
1. Jeżeli skazanie za przestępstwo popełnione w warunkach określonych w art. 60 § 1 Kodeksu karnego nastąpiło przed dniem wejścia w życie ustawy, warunkowe zwolnienie może nastąpić nie wcześniej niż po odbyciu przez skazanego połowy orzeczonej kary.
...
**Art. 5.** W okresie 5 lat od dnia wejścia w życie ustawy nie wykonuje się kary śmierci.
