...
- **17a)** strategiczna infrastruktura badawcza – dużą infrastrukturę badawczą oraz infrastrukturę budowlaną, ujęte w wykazie przedsięwzięć w zakresie strategicznej infrastruktury badawczej, który stanowi Polską Mapę Drogową Infrastruktury Badawczej; ” , pkt 18 otrzymuje brzmienie: „
    - **f)**
...
- **2)** dane dotyczące wnioskodawcy: nazwę, siedzibę i adres wnioskodawcy, imię i nazwisko kierownika wnioskodawcy, imię i nazwisko, numer telefonu i adres e-mail osoby odpowiedzialnej za sporządzenie wniosku;
    - **a)**
    - **b)**
    - **c)**
...
- **4)** działalność statutową; ” , uchyla się pkt 5, pkt 6 otrzymuje brzmienie: „
    - **b)**
    - **c)**

- **6)** inwestycje w zakresie dużej i strategicznej infrastruktury badawczej oraz inwestycje budowlane służące badaniom naukowym lub pracom rozwojowym; ” , pkt 10 otrzymuje brzmienie: „
    - **d)**

- **10)** programy i przedsięwzięcia ustanawiane przez Ministra, w tym ukierunkowane na wspieranie młodych naukowców lub osób rozpoczynających karierę naukową; ” , pkt 11 otrzymuje brzmienie: „
    - **e)**

- **11)** nagrody za wybitne osiągnięcia naukowe lub naukowo-techniczne; ” , po pkt 11 dodaje się pkt 11a w brzmieniu: „
    - **f)**

- **11a)** stypendia naukowe dla wybitnych młodych naukowców; ” ;
- **6)** w art. 6: ust. 3 i 4 otrzymują brzmienie: „
    - **a)**
...
4. Na zadania, o których mowa w art. 5 pkt 3, Minister przeznacza nie mniej niż 10% środków finansowych na naukę na zadania, o których mowa w art. 5 pkt 4, 7 i 9–13. ” , ust. 6 otrzymuje brzmienie: „
...
- **7)** w art. 9: pkt 1 i 2 otrzymują brzmienie: „
    - **a)**
...
- **9)** w art. 11: ust. 2 otrzymuje brzmienie: „
    - **a)**

2. Osoby fizyczne po zakwalifikowaniu projektu do finansowania uzyskują promesę finansowania badań naukowych lub prac rozwojowych. ” , dodaje się ust. 4 w brzmieniu: „
...
- **3)** działalności upowszechniającej naukę, o której mowa w art. 25 ust. 6. ” , po ust. 1 dodaje się ust. 1a w brzmieniu: „
    - **b)**
...
- **2)** nagród za wybitne osiągnięcia naukowe lub naukowo-techniczne, o których mowa w art. 28 ust. 1. ” , uchyla się ust. 3;
    - **c)**

- **12)** po art. 13 dodaje się art. 13a-13d w brzmieniu: „

**Art. 13a.** Środki finansowe na zadania, o których mowa w art. 23 ust. 1 pkt 1, 2 i 5, art. 24–26 i art. 28a, są przekazywane uprawnionym podmiotom na podstawie umowy określającej warunki jej realizacji, finansowania i rozliczania przyznanych środków finansowych. 1. Przy przyznawaniu środków finansowych na naukę uwzględnia się w szczególności kryteria:
...
- **13)** w art. 14: ust. 1 i 2 otrzymują brzmienie: „
    - **a)**
...
2. Wniosek o ponowne rozpatrzenie sprawy jest opiniowany przez zespół, o którym mowa w art. 52 ust. 2, w terminie 30 dni od dnia, w którym zespół ten otrzymał wniosek. ” , po ust. 2 dodaje się ust. 2a w brzmieniu: „

- **b)**

2a. Minister informuje w formie pisemnej o rozpatrzeniu wniosku o ponowne rozpatrzenie sprawy, złożonego od informacji, o której mowa w art. 13 ust. 1a. ” , uchyla się ust. 4;
...
- **6)** połączenia lub podziału jednostek naukowych. ” , ust. 4 otrzymuje brzmienie: „
    - **c)**
...
- **6)** środków finansowych zaplanowanych na ten cel w budżecie państwa. ” , po ust. 4 dodaje się ust. 4a i 4b w brzmieniu: „
    - **d)**
...
4b. Minister przyznaje środki finansowe na utrzymanie specjalnego urządzenia badawczego lub specjalnego urządzenia badawczego w zakresie infrastruktury informatycznej nauki na okres nie dłuższy niż 3 lata, określając wysokość tych środków w kolejnych latach. ” , w ust. 5 wprowadzenie do wyliczenia otrzymuje brzmienie: „ Wniosek o finansowanie kosztów restrukturyzacji jednostki naukowej wymaga zaopiniowania przez: ” , dodaje się ust. 6 i 7 w brzmieniu: „
...
1. Środki finansowe na naukę przeznaczone na działalność statutową określoną w art. 18 ust. 1 pkt 1, 2 i 2a są przekazywane w formie dotacji podmiotowej, a środki finansowe na naukę przeznaczone na działalność statutową określoną w art. 18 ust. 1 pkt 1a, 3 i 4 są przekazywane w formie dotacji celowej. ” , ust. 3 otrzymuje brzmienie: „

- **b)**

3. Jednostce naukowej, której została przyznana kategoria naukowa C, przyznaje się dotację na utrzymanie potencjału badawczego przez okres 6 miesięcy roku następującego po roku przyznania kategorii w wysokości połowy dotacji ustalonej na podstawie algorytmu określonego w przepisach wydanych na podstawie ust. 7. ” , po ust. 3 dodaje się ust. 3a i 3b w brzmieniu: „
...
3b. Jednostka naukowa, której została przyznana kategoria naukowa C, otrzymuje, wyłącznie na rok następujący po roku przyznania tej kategorii, dotację na działalność polegającą na prowadzeniu badań naukowych lub prac rozwojowych oraz zadań z nimi związanych, służących rozwojowi młodych naukowców oraz uczestników studiów doktoranckich, finansowanych w wewnętrznym trybie konkursowym. ” , po ust. 4 dodaje się ust. 4a w brzmieniu: „

- **d)**

4a. Jednostka naukowa, która w wyniku ponownej oceny otrzymała kategorię naukową C, do dnia uzyskania wyższej kategorii naukowej nie otrzymuje środków finansowych na naukę przeznaczonych na działalność statutową, o której mowa w art. 18. ” , ust. 7 otrzymuje brzmienie: „

- **e)**

7. Minister właściwy do spraw nauki określi, w drodze rozporządzenia:

- **1)** sposób ustalania wysokości dotacji oraz rozliczania środków finansowych na cele określone w art. 18 ust. 1 pkt 1 i 3, w tym: wielkości i składowe algorytmu ustalania wysokości dotacji na utrzymanie potencjału badawczego jednostki naukowej dla jednostek posiadających kategorię naukową A+, A, B albo C, sposób ustalania dotacji dla Polskiej Akademii Umiejętności, sposób ustalania dotacji dla jednostki naukowej, której: – przyznano po raz pierwszy kategorię naukową, – nie przyznano dotacji na utrzymanie potencjału badawczego w roku poprzedzającym rok, na który ma być przyznana dotacja, – kategoria naukowa została zmieniona w wyniku przeprowadzenia kompleksowej oceny działalności naukowej lub badawczo-rozwojowej jednostki naukowej, sposób ustalania dotacji dla jednostek naukowych powstałych w wyniku podziału lub wydzielenia się z istniejącej jednostki naukowej oraz powstałych w wyniku połączenia istniejących jednostek naukowych, sposób zwiększania dotacji na utrzymanie potencjału badawczego dla jednostek naukowych, w tym na zadania związane z zapewnieniem warunków udziału niepełnosprawnych naukowców i uczestników studiów doktoranckich w realizacji badań naukowych i prac rozwojowych, sposób ustalania dotacji na cele określone w art. 18 ust. 1 pkt 1 z tytułu zdarzeń losowych, wielkości i składowe algorytmu ustalania dotacji na działalność polegającą na prowadzeniu badań naukowych lub prac rozwojowych oraz zadań z nimi związanych, służących rozwojowi młodych naukowców oraz uczestników studiów doktoranckich, finansowanych w wewnętrznym trybie konkursowym, dla jednostek naukowych uczelni, jednostek naukowych Polskiej Akademii Nauk, instytutów badawczych i międzynarodowych instytutów naukowych, posiadających kategorię naukową A+, A, B albo C,
    - **a)**
    - **b)**
    - **c)**
    - **d)**
...
- **1)** finansowanie kosztów inwestycji w zakresie dużej i strategicznej infrastruktury badawczej: zakup, wytworzenie lub rozbudowę aparatury naukowo-badawczej, rozbudowę infrastruktury informatycznej nauki, udział w przedsięwzięciu inwestycyjnym w zakresie dużej lub strategicznej infrastruktury badawczej, w tym w ramach współpracy międzynarodowej, inwestycje z zakresu dużej infrastruktury badawczej, współfinansowane ze środków funduszy strukturalnych;
    - **a)**
    - **b)**
    - **c)**
    - **d)**

- **2)** finansowanie kosztów inwestycji budowlanych oraz inwestycji budowlanych dotyczących strategicznej infrastruktury badawczej: budowę nowych obiektów budowlanych, przebudowę lub rozbudowę obiektów budowlanych, zakup nieruchomości, udział w przedsięwzięciu budowlanym, w tym w ramach współpracy międzynarodowej, inwestycje budowlane współfinansowane ze środków funduszy strukturalnych. ” ;
    - **a)**
    - **b)**
    - **c)**
    - **d)**
...
- **1)** szczegółowe kryteria i tryb przyznawania oraz rozliczania środków finansowych na cele określone w art. 20, w tym: tryb oceny wniosków dotyczących zadań przewidzianych do finansowania, tryb oceny realizacji zadań,
    - **a)**
    - **b)**
...
- **1)** warunki i tryb przyznawania oraz rozliczania pomocy publicznej lub pomocy de minimis na cele określone w art. 20, w tym: przeznaczenie pomocy, rodzaje kosztów kwalifikujących się do objęcia pomocą,
    - **a)**
    - **b)**
...
- **1)** szczegółowe kryteria i tryb przyznawania oraz rozliczania środków finansowych na cele określone w ust. 1, w tym tryb: oceny wniosków dotyczących zadań przewidzianych do finansowania, oceny realizacji finansowanych zadań, rozliczania przyznanych środków finansowych,
    - **a)**
    - **b)**
    - **c)**
...
- **1)** warunki i tryb przyznawania oraz rozliczania pomocy publicznej lub pomocy de minimis na cele określone w ust. 1, w tym: przeznaczenie pomocy, rodzaje kosztów kwalifikujących się do objęcia pomocą,
    - **a)**
    - **b)**
...
- **4)** podejmowanie innych działań szczególnie ważnych dla upowszechniania nauki. ” , uchyla się ust. 2, ust. 3 i 4 otrzymują brzmienie: „
    - **b)**
    - **c)**
...
4. Wniosek o przyznanie środków finansowych bibliotekom naukowym składa podmiot organizujący i prowadzący bibliotekę, o którym mowa w art. 8 ustawy z dnia 27 czerwca 1997 r. o bibliotekach (Dz. U. z 2012 r. poz. 642 i 908 oraz z 2013 r. poz. 829). ” , po ust. 4 dodaje się ust. 4a w brzmieniu: „
...
- **5)** wdrożenie procedur zabezpieczających oryginalność publikacji naukowych. ” , ust. 5–8 otrzymują brzmienie: „
    - **e)**
...
- **1)** szczegółowe kryteria i tryb przyznawania oraz rozliczania przyznanych środków finansowych na cele określone w ust. 1 i 4a, w tym tryb: oceny wniosków obejmujących zadania z zakresu działalności upowszechniającej naukę, planowane do realizacji w ciągu całego roku kalendarzowego, oceny realizacji finansowanych zadań, rozliczania przyznanych środków finansowych,
    - **a)**
    - **b)**
    - **c)**
...
- **1)** warunki i tryb przyznawania oraz rozliczania pomocy publicznej lub pomocy de minimis na cele określone w ust. 1 i 4a, w tym: przeznaczenie pomocy, rodzaje kosztów kwalifikujących się do objęcia pomocą,
    - **a)**
    - **b)**
...
- **2)** warunki i tryb przyznawania oraz rozliczania pomocy, o której mowa w pkt 1, w tym: przeznaczenie pomocy, rodzaje kosztów kwalifikujących się do objęcia pomocą,
    - **a)**
    - **b)**
...
- **1)** szczegółowe kryteria i tryb przyznawania oraz rozliczania przyznanych środków finansowych w ramach programu „Diamentowy Grant”, w tym tryb: oceny wniosków dotyczących zadań przewidzianych do finansowania, oceny realizacji finansowanych zadań, rozliczania przyznanych środków finansowych,
    - **a)**
    - **b)**
    - **c)**
...
- **30)** w art. 34: w ust. 1 pkt 1 i 2 otrzymują brzmienie: „
    - **a)**
...
- **2)** projekty obejmujące badania naukowe lub prace rozwojowe, w których całkowita wartość przyznanego dofinansowania przekracza 3 000 000 zł; ” , dodaje się ust. 3–5 w brzmieniu: „
    - **b)**
...
- **31)** w art. 37 w ust. 3: pkt 7 otrzymuje brzmienie: „
    - **a)**

- **7)** przewodniczącego lub wiceprzewodniczącego Rady Głównej Nauki i Szkolnictwa Wyższego; ” , pkt 9 otrzymuje brzmienie: „
    - **b)**

- **9)** członka Polskiej Komisji Akredytacyjnej; ” ;
- **32)** w art. 42: po ust. 2 dodaje się ust. 2a w brzmieniu: „
    - **a)**

2a. W przypadku uczelni, w których zgodnie ze statutem uczelni, nie wyodrębniono podstawowych jednostek organizacyjnych, kompleksową ocenę jakości działalności naukowej lub badawczo-rozwojowej przeprowadza się w stosunku do całej uczelni. ” , uchyla się ust. 6;
...
- **36)** w art. 50: ust. 1 otrzymuje brzmienie: „
    - **a)**

1. Komitet Polityki Naukowej powołuje Minister. ” , po ust. 1 dodaje się ust. 1a-1c w brzmieniu: „
...
- **9)** członka Polskiej Komisji Akredytacyjnej;
- **10)** członka Komitetu Ewaluacji Jednostek Naukowych. Członkostwo w Komitecie Polityki Naukowej wygasa w przypadku:
- **1)** śmierci;
...
3. Minister może odwołać członka Komitetu Polityki Naukowej przed upływem kadencji w przypadku niewnoszenia przez niego należytego wkładu w prace Komitetu, na wniosek Przewodniczącego, lub niezłożenia oświadczeń, o których mowa w ust. 1. W przypadku wygaśnięcia członkostwa w Komitecie Polityki Naukowej lub odwołania, o którym mowa w art. 50c ust. 3, przed upływem kadencji, na miejsce tego członka jest powoływana na okres do końca kadencji nowa osoba spośród kandydatów zgłoszonych na daną kadencję. Niepełnej kadencji nie wlicza się do okresu określonego w art. 50 ust. 1c.
...
- **39)** w art. 52: po ust. 2 dodaje się ust. 2a w brzmieniu: „
    - **a)**

2a. Minister powołuje zespół doradczy – Radę Młodych Naukowców, którego zadaniem jest wspieranie Ministra w działaniach służących rozwojowi kariery młodych naukowców i osób rozpoczynających karierę naukową. ” , ust. 3 otrzymuje brzmienie: „
...
- **7)** w art. 49: w ust. 1 po pkt 1 dodaje się pkt 1a w brzmieniu: „
    - **a)**

- **1a)** fundusz rezerwowy; ” , ust. 3 otrzymuje brzmienie: „
    - **b)**
...
- **8)** w art. 41: w ust. 1 po pkt 1 dodaje się pkt 1a w brzmieniu: „
    - **a)**
...
**Art. 10.** Komitet Polityki Naukowej powołany przed dniem wejścia w życie niniejszej ustawy działa do dnia powołania Komitetu Polityki Naukowej na podstawie ustawy, o której mowa w art. 1, w brzmieniu nadanym niniejszą ustawą, nie dłużej jednak niż przez okres 12 miesięcy od dnia wejścia w życie niniejszej ustawy.
