...
# DZIENNIK USTAW l RZECZYPOSPOLITEJ POLSKIEJ Warszawa, dnia 20 kwietnia 2012 v r.

| Pole | Wartość |
|---|---|
| Adres publikacyjny | Dz.U. 2012 poz. 436 |
| ISAP | WDU20120000436 |
...
| Źródło | [ISAP](https://isap.sejm.gov.pl/isap.nsf/DocDetails.xsp?id=WDU20120000436) · [PDF](https://api.sejm.gov.pl/eli/acts/DU/2012/436/text.pdf) |

Poz. 436 o ROZPORZĄDZENIE MINISTRA TRANSPORTU, BUDOWNICTWA I GOSPODARKI MORSKIEJ z dnia 13 kwietnia g 2012 r.
w sprawie ciśnieniowych urządzeń transportowych Na podstawie art. 72 ustawy z dnia 19 sierpnia 2011 r. o przewozie towarów niebezpiecznych (Dz. U. Nr 227, poz. 1367 i Nr 244, poz. 1454) zarządza się, co następuje: .

**§ 1.** Rozporządzenie określa: l

- **1)** procedury oceny zgodności ciśnieniowych urządzeń transportowych; c
...
- **4)** dokumentację techniczną umożliwiającą dokonanie oceny zgodności z obowiązującymi wymaganiami i zgodną z 1.8.7.7 w odpowiednio ADR lub RID;
...
- **2)** nadzoru nad wytwarzaniem oraz badań odbiorczych i prób – wnioskujący nanosi na ciśnieniowym urządzeniu transportowym oznakowanie wymagane przepisami odpowiednio ADR lub o RID oraz dostarcza jednostce notyfikowanej dokumentację techniczną określoną w 1.8.7.7 odpowiednio ADR lub RID.

**§ 3.**

1. W ramach zatwierdzenia typu jednostka notyfikowana wykonuje czynności określone w 1.8.7.2.2 odpowiednio ADR lub RID. g
...
- **3)** wskazanie aktualnej wersji wymagań oraz norm, na podstawie których wykonano badanie typu; l
- **4)** wymagania wynikające z przeprowadzonych badań;
- **5)** dane niezbędne do identyfikacji typu c i jego odmian, zgodnie z odpowiednią normą;
- **6)** wskazanie sprawozdania z badania typu;
- **7)** okres ważności zatwierdzenia typu. r
...
4. Jeżeli typ nie odpowiada mającym zastosowanie wymaganiom, to jednostka notyfikowana informuje pisemnie producenta ciśnieniowego urządzenia transportowego o niespełnieniu wymagań. w
...
- **1)** spełnia wymagania:
    ...
    - **b)** wystawia świadectwo zgodności wytwarzania, zawierające co najmniej: – nazwę i adres właściwej jednostki notyfikowanej, – nazwę i adres producenta oraz nazwę i adres wnioskującego, w przypadku gdy nie jest producentem, – wskazanie wersji wymagań oraz norm, na podstawie których dokonano badań odbiorczych i prób, – wyniki badań odbiorczych i prób, – dane identyfikacyjne zbadanego ciśnieniowego urządzenia transportowego, zawierające co najmniej numer seryjny, a w przypadku butli jednorazowego użytku – numer partii, – numer zatwierdzenia typu;
...
1. Właściciel lub użytkownik ciśnieniowego urządzenia transportowego składa wniosek o poddanie tego urządzenia ponownej ocenie zgodności do wybranej jednostki notyfikowanej do ponownej o oceny zgodności.

2. Wniosek, o którym mowa w ust. 1, zawiera:

- **1)** nazwę i adres wnioskującego;
- **2)** pisemne oświadczenie stwierdzające, że taki sam wniosek g nie został skierowany do innej jednostki notyfikowanej;
...
1. Właściciel lub użytkownik ciśnieniowego urządzenia transportowego składa wniosek o poddanie tego urządzenia badaniu okresowemu do wybranej jednostki notyfikowanej do przeprowadzania v badań okresowych.

2. Wniosek, o którym mowa w ust. 1, powinien zawierać:

- **1)** nazwę i adres wnioskującego; o
- **2)** pisemne oświadczenie stwierdzające, że taki sam wniosek nie został skierowany do innej jednostki notyfikowanej;
- **3)** oświadczenie o zapewnieniu dostępu jednostce notyfikowanej do miejsca przeprowadzania badań okresowych, wykonywania badań i prób, miejsca przechowywania danych oraz gotowości udostępnienia wszelkich niezbędnych informacji. g
...
- **1)** pozytywne – jednostka notyfikowana po przeprowadzonym badaniu okresowym umieszcza na ciśnieniowym urządzew niu transportowym:
...
2. Znak zgodności П powinien być czytelny oraz powinien zostać umieszczony w sposób trwały w widocznym miejscu na ciśnieniowym urządzeniu transportowym lub jego tablicy znamionowej, o a także na demontowalnych częściach takiego ciśnieniowego urządzenia transportowego, które umożliwiają jego ponowne napełnienie i spełniają bezpośrednio funkcję bezpieczeństwa.

3. Znak zgodności Π umieszcza się również na nowych zaworach oraz innym wyposażeniu ciśnieniowego urządzenia transportowego mającym bezpośredni wpływ na bezpieczeństwo. g
...
**§ 20.** Przepisy rozporządzenia stosuje się do naczyń ciśnieniowych, ich zaworów i innego wyposażenia, przeznaczonych do przewozu towarów niebezpiecznych o numerach l UN 1745, UN 1746 i UN 2495 od dnia 1 lipca 2013 r.

**§ 21.** Rozporządzenie wchodzi w życie c po upływie 7 dni od dnia ogłoszenia. Minister Transportu, Budownictwa i Gospodarki Morskiej: S. Nowak r . w Załączniki Ministra Transportu, WYKAZ TOWARÓW NIEBEZPIECZNYCH INNYCH KLAS NIŻ . KLASA 2 Budownictwa PRZEWOŻONYCH CIŚNIENIOWYMI URZĄDZENIAMI TRANSPORTOWYMI z dnia…. Numer UN Klasa Towar niebezpieczny ZAŁĄCZNIK 1051 6.1 CYJANOWODÓR, STABILIZOWANY WYKAZ Zawierający TOWARÓW mniej NIEBEZPIECZNYCH niż 3% wody INNYCH KLAS o 1052 8 FLUOROWODÓR, BEZWODNY Numer UN Klasa Towar niebezpieczny 1745 5.1 1051 PIECIOFLUOREK 6.1 BROMU CYJANOWODÓR, STABILIZOWANY Z wyjątkiem przewozu w cysternach Zawierający mniej niż 3% wody g 1746 5.1 1052 TRÓJFLUOREK BROMU 8 FLUOROWODÓR, BEZWODNY Z wyjątkiem przewozu w cysternach 1745 5.1 PIECIOFLUOREK BROMU 1790 8 KWAS FLUOROWODOROWY Z wyjątkiem przewozu w cysternach . Zawierający więcej niż 85% fluorowodoru 1746 5.1 TRÓJFLUOREK BROMU 2495 5.1 l PIĘCIOFLUOREK JODU Zwyjątkiem przewozu w cysternach Z wyjątkiem przewozu w cysternach c 1790 8 KWAS FLUOROWODOROWY Zawierający więcej niż 85% fluorowodoru 2495 5.1 PIĘCIOFLUOREK JODU Z wyjątkiem przewozu w cysternach r . WZÓR ZNAKU ZGODNOŚCI Π w W przypadku pomniejszenia lub powiększenia znaku Π należy zachować proporcje podane na powyższym rysunku. Kratka nie stanowi części znaku.
