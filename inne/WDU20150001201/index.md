...
4. Działalność w zakresie określonym w ust. 1–3 może być prowadzona wyłącznie w formie spółki akcyjnej lub spółki z ograniczoną odpowiedzialnością, mającej siedzibę na terytorium Rzeczypospolitej Polskiej, z zastrzeżeniem art. 7a. ” , po ust. 5 dodaje się ust. 5a w brzmieniu: „

- **b)**

5a. Przepisu ust. 5 nie stosuje się do spółek, o których mowa w art. 7a ust. 1. ” , uchyla się ust. 6;
...
2. W spółkach, o których mowa w ust. 1, nie może być akcji (udziałów) uprzywilejowanych. ” , dodaje się ust. 6 i 7 w brzmieniu: „
...
**Art. 11.** Działalność w zakresie, o którym mowa w art. 6 ust. 1–3, może być prowadzona, pod warunkiem że:
...
- **12)** w art. 35: pkt 1 otrzymuje brzmienie: „
    - **a)**

- **1)** w przypadku spółki posiadającej siedzibę na terytorium Rzeczypospolitej Polskiej odpis aktu notarialnego umowy lub statutu spółki oraz numer w Krajowym Rejestrze Sądowym; ” , po pkt 1 dodaje się pkt 1a w brzmieniu: „
    - **b)**

- **1a)** w przypadku spółki, o której mowa w art. 7a ust. 1, odpis umowy lub statutu spółki oraz: numer z odpowiedniego rejestru handlowego państwa siedziby spółki oraz kopię umowy z przedstawicielem, albo numer w Krajowym Rejestrze Sądowym oddziału tej spółki; ” , pkt 4 otrzymuje brzmienie „
    - **a)**
    - **b)**
    - **c)**

- **4)** dane osobowe (imiona, nazwiska, obywatelstwo, miejsce zamieszkania, rodzaj oraz serię i numer dokumentu tożsamości, informacje dotyczące posiadanego wykształcenia oraz doświadczenia zawodowego) akcjonariuszy (wspólników) będących osobami fizycznymi, reprezentujących co najmniej 10% kapitału zakładowego spółki, członków zarządu, rady nadzorczej i komisji rewizyjnej spółki oraz osób mających sprawować zarząd nad kasynem gry; w przypadku spółek handlowych będących akcjonariuszami (wspólnikami) – również informacje o ich obecnym i przeszłym statusie prawnym oraz o sytuacji finansowej; ” , w pkt 16 lit. a otrzymuje brzmienie: „ w przypadku akcjonariusza (wspólnika) będącego osobą fizyczną, reprezentującego co najmniej 10% kapitału zakładowego spółki – zaświadczenie właściwego naczelnika urzędu skarbowego o pokryciu udziałów lub akcji z ujawnionych źródeł przychodów, ” , pkt 18 i 19 otrzymują brzmienie: „
    - **d)**
    - **a)**
    - **e)**
...
- **13)** w art. 36: pkt 1 otrzymuje brzmienie: „
    - **a)**
...
- **15)** w art. 38 w ust. 1: pkt 2 otrzymuje brzmienie: „
    - **a)**

- **2)** nazwę i status prawny podmiotu występującego z wnioskiem, w przypadku spółek handlowych również numer w Krajowym Rejestrze Sądowym, a w przypadku przedsiębiorcy zagranicznego prowadzącego działalność za pośrednictwem oddziału, numer w Krajowym Rejestrze Sądowym tego oddziału; ” , w pkt 10 lit. a otrzymuje brzmienie: „ zaświadczenie właściwego naczelnika urzędu skarbowego o pokryciu kapitału zakładowego z ujawnionych źródeł przychodów – w przypadku akcjonariusza (wspólnika) będącego osobą fizyczną, reprezentującego co najmniej 10% kapitału zakładowego spółki, jeżeli podmiotem występującym z wnioskiem jest spółka handlowa, ” ;
    - **b)**
    - **a)**

- **16)** w art. 39: wprowadzenie do wyliczenia otrzymuje brzmienie: „Wniosek o udzielenie zezwolenia na urządzenie loterii promocyjnej zawiera:”, uchyla się pkt 1, pkt 2 otrzymuje brzmienie: „
    - **a)**
    - **b)**
    - **c)**
...
- **2)** w przypadku spółki, o której mowa w art. 7a ust. 1, odpis umowy lub statutu spółki oraz: numer z odpowiedniego rejestru handlowego państwa siedziby spółki oraz kopię umowy z przedstawicielem albo numer w Krajowym Rejestrze Sądowym oddziału tej spółki;
    - **a)**
    - **b)**
...
- **20)** w art. 54: uchyla się ust. 1, ust. 2 otrzymuje brzmienie: „
    - **a)**
    - **b)**
...
- **24)** w art. 56: w ust. 3 uchyla się zdanie drugie, dodaje się ust. 4 w brzmieniu: „
    - **a)**
    - **b)**
...
- **26)** po art. 57 dodaje się art. 57a i art. 57b w brzmieniu: „ Dokumenty sporządzone w języku obcym lub ich odpisy przedkłada się wraz z uwierzytelnionym tłumaczeniem na język polski.
...
- **28)** w art. 63 w ust. 3: pkt 2 otrzymuje brzmienie: „
    - **a)**

- **2)** złożeniu właściwej kwoty na rachunku bankowym wskazanym przez organ udzielający koncesji lub zezwoleń. ” , uchyla się pkt 3;
    - **b)**
...
- **30)** w art. 71: ust. 1 otrzymuje brzmienie: „
    - **a)**

1. Podatnikiem podatku od gier jest osoba fizyczna, osoba prawna oraz jednostka organizacyjna niemająca osobowości prawnej, która prowadzi działalność w zakresie gier hazardowych na podstawie udzielonej koncesji lub udzielonego zezwolenia, z wyłączeniem loterii promocyjnych, podmiot urządzający gry objęte monopolem państwa oraz uczestnik turnieju gry pokera. ” , w ust. 2 pkt 1 otrzymuje brzmienie: „

- **b)**
- **1)** urządzanie gier hazardowych, z wyłączeniem urządzania loterii promocyjnych, loterii fantowych i gry bingo fantowe, o których mowa w art. 7 ust. 1a, oraz urządzania pokera rozgrywanego w formie turnieju gry pokera; ” , w ust. 3 zdanie pierwsze otrzymuje brzmienie: „Obowiązek podatkowy w podatku od gier powstaje z dniem rozpoczęcia urządzania gier hazardowych.”, ust. 4 i 5 otrzymują brzmienie: „
    - **c)**
    - **d)**
...
- **36)** w art. 135: ust. 2 otrzymuje brzmienie: „
    - **a)**

2. Zmiana zezwolenia nie może obejmować zmiany miejsc urządzania gier, z wyjątkiem zmniejszenia liczby punktów gier na automatach o niskich wygranych. ” , po ust. 2 dodaje się ust. 2a w brzmieniu: „
