...
# RZECZYPOSPOLITEJ POLSKIEJ Warszawa, dnia 22 kwietnia 2014 Poz. 506 RozpoRządzenie MinistRa adMinistRacji i cyfRyzacji dnia 3 kwietnia 2014 w sprawie oddawczych skrzynek pocztowych Na podstawie art. 40 ust. 5 ustawy dnia 23 listopada 2012 – Prawo pocztowe 1529) zarządza się, co następuje: § 1. Rozporządzenie określa:

| Pole | Wartość |
|---|---|
| Adres publikacyjny | Dz.U. 2014 poz. 506 |
| ISAP | WDU20140000506 |
...
§ 4. 1. Skrzynkę oznacza się cyframi arabskimi, zgodnie numeracją porządkową nieruchomości, w sposób umożliwiający jednoznaczne jej przyporządkowanie do budynku lub wyodrębnionych w nim lokali, jeżeli posiadają osobny adres.
...
2. W budynku wielorodzinnym kilkoma wejściami przy każdym nich może być zainstalowany zestaw skrzynek liczbą skrzynek odpowiadającą liczbie lokali znajdujących się w danej części budynku.
...
§ 7. Dla operatorów pocztowych miejscem dostępu do skrzynki jest otwór wrzutowy, o którym mowa w § 3 ust. 3, wyłączeniem skrzynek, o których mowa w art. 40 ust. 3 ustawy dnia 23 listopada 2012 – Prawo pocztowe, do których dostęp jest zapewniony zgodnie art. 66 i 67 tej ustawy.
§ 8. Skrzynki otworem wrzutowym o wysokości niższej niż określona w § 3 ust. 3 pkt 2 zainstalowane zgodnie przepisami dotychczasowymi mogą być użytkowane do momentu ich fizycznego zużycia i wymiany skrzynki albo wymiany jej elementu konstrukcyjnego otworem wrzutowym.
