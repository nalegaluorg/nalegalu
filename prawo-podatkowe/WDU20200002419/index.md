...
- **3)** w art. 29a:
    ...
    - **e)** uchyla się ust. 16,
    - **f)** dodaje się ust. 17 i 18 w brzmieniu: „17. W przypadku gdy podstawa opodatkowania uległa zwiększeniu, korekty tej podstawy dokonuje się w rozliczeniu za okres rozliczeniowy, w którym zaistniała przyczyna zwiększenia podstawy opodatkowania. 18. W przypadku eksportu towarów i wewnątrzwspólnotowej dostawy towarów zwiększenie podstawy opodatkowania, o którym mowa w ust. 17, następuje nie wcześniej niż w deklaracji podatkowej składanej za okres rozliczeniowy, w którym wykazane zostały te transakcje.”;
