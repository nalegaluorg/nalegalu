...
# RZECZYPOSPOLITEJ POLSKIEJ Poz. 940 ROZPORZĄDZENIE MINISTRA ROZWOJU z dnia 16 czerwca 2016 r.

| Pole | Wartość |
|---|---|
| Adres publikacyjny | Dz.U. 2016 poz. 940 |
| ISAP | WDU20160000940 |
...
| Źródło | [ISAP](https://isap.sejm.gov.pl/isap.nsf/DocDetails.xsp?id=WDU20160000940) · [PDF](https://api.sejm.gov.pl/eli/acts/DU/2016/940/text.pdf) |
...
1) ust. 1 otrzymuje brzmienie: „1. Infrastruktura wytworzona lub zakupiona w ramach realizacji projektu objętego wsparciem na wyposażenie, w okresie amortyzacji, może być wykorzystywana do wykonywania działalności, która nie stanowi działalności gospodarczej.”;
...
3) dodaje się ust. 3 w brzmieniu: „3. Projekt nie może zostać poddany znaczącej modyfikacji przez okres co najmniej 5 lat od dnia zakończenia jego realizacji.”.
...
Minister Rozwoju: wz. J. Kwieciński Zmiany wymienionego rozporządzenia zostały ogłoszone w Dz. Urz. UE L 329 z 15.12.2015, str. 28 oraz w Dz. Urz. UE L 149 z 7.06.2016, str. 10.
