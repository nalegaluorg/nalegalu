...
| Źródło | [ELI HTML](https://eli.gov.pl/api/acts/DU/2014/1990/text.html) · [ELI API](https://api.sejm.gov.pl/eli/acts/DU/2014/1990) |

## Spis treści

- [Treść rozporządzenia](#part_1) [Rozdział 1 - Przepisy ogólne](#chpt_1) [Rozdział 2 - Szczegółowe przeznaczenie i warunki udzielania wsparcia na rozwój ośrodków innowacyjności](#chpt_2) [Rozdział 3 - Tryb udzielania wsparcia na rozwój ośrodków innowacyjności](#chpt_3) [Rozdział 4 - Przepisy końcowe](#chpt_4)
...
projekcie - należy przez to rozumieć przedsięwzięcie realizowane na podstawie umowy o udzielenie wsparcia, w ramach działania I.3 Wspieranie innowacji Programu;

### 8)

umowie o udzielenie wsparcia - należy przez to rozumieć umowę o dofinansowanie projektu realizowanego przez beneficjenta w ramach Programu, zawartą między Agencją a beneficjentem;
...
zapewnienia przedsiębiorcom prowadzącym działalność badawczą, rozwojową lub innowacyjną równego dostępu do usług, szkoleń, wartości niematerialnych i prawnych, środków trwałych i wyposażenia nabytego w ramach projektu,
...
na realizację projektów indywidualnych, o których mowa w art. 28 ust. 1 pkt 1 ustawy z dnia 6 grudnia 2006 r. o zasadach prowadzenia polityki rozwoju ([Dz. U. z 2014 r. poz. 1649](https://api.sejm.gov.pl/eli/acts/DU/2014/1649/text.html)), w trybie, o którym mowa w ust. 2 oraz ust. 5-7, z zastrzeżeniem § 12;
...
W przypadku zatwierdzenia projektu, o którym mowa w ust. 7, Agencja zawiera z beneficjentem umowę o udzielenie wsparcia.

### § 12.

### 1.

Beneficjent odpowiedzialny za opracowanie dużego projektu składa wniosek o potwierdzenie udzielenia pomocy, w terminie wskazanym w powiadomieniu, o którym mowa w § 11 ust. 2.

### 2.

Po zakończeniu procedury oceny wniosku dla dużego projektu Agencja przekazuje do weryfikacji Instytucji Zarządzającej Programem zatwierdzony wniosek.
...
Pomoc publiczna oraz pomoc de minimis będzie udzielana przedsiębiorcom przez beneficjentów do dnia 30 czerwca 2021 r.

### § 15.

Traci moc rozporządzenie Ministra Rozwoju Regionalnego z dnia 27 kwietnia 2009 r. w sprawie udzielania przez Polską Agencję Rozwoju Przedsiębiorczości pomocy finansowej na rozwój ośrodków innowacyjności w ramach Programu Operacyjnego Rozwój Polski Wschodniej 2007-2013 ([Dz. U. Nr 70, poz. 604](https://api.sejm.gov.pl/eli/acts/DU/2009/604/text.html), z [2013 r. poz. 1633](https://api.sejm.gov.pl/eli/acts/DU/2013/1633/text.html) oraz z [2014 r. poz. 830](https://api.sejm.gov.pl/eli/acts/DU/2014/830/text.html)).
