...
- **1)** w art. 2: uchyla się pkt 2–4, pkt 5 otrzymuje brzmienie: „
    - **a)**
    - **b)**

- **5)** znaku budowlanym – należy przez to rozumieć znak wskazujący, że wyrób budowlany oznaczony tym znakiem może być udostępniany na rynku krajowym i stosowany przy wykonywaniu robót budowlanych; ” , pkt 10 otrzymuje brzmienie: „
    - **c)**

- **10)** wprowadzeniu do obrotu – należy przez to rozumieć wprowadzenie do obrotu, o którym mowa w art. 2 pkt 17 rozporządzenia Nr 305/2011; ” , dodaje się pkt 11–16 w brzmieniu: „
    - **d)**
...
- **1)** powołuje i odwołuje członków Rady Wyrobów Budowlanych spośród osób: rekomendowanych przez izby samorządów zawodowych architektów i inżynierów budownictwa, organizacje zrzeszające producentów wyrobów budowlanych oraz osób wskazanych przez jednostki oceny technicznej lub dysponujących szczególną wiedzą techniczną, ekonomiczną lub prawną w sprawach wyrobów budowlanych;
    - **a)**
    - **b)**
...
5c. Producent, deklarując właściwości użytkowe wyrobu budowlanego w krajowej deklaracji stosuje krajowe systemy oceny i weryfikacji stałości właściwości użytkowych wyrobu budowlanego określone w przepisach wydanych na podstawie ust. 8. ” , uchyla się ust. 6 i 7, dodaje się ust. 8 w brzmieniu: „
...
- **1)** prowadzi ewidencję: skarg, wyrobów budowlanych niespełniających wymagań określonych w niniejszej ustawie, wyrobów budowlanych wycofanych z obrotu lub z użytkowania;
    - **a)**
    - **b)**
    - **c)**
...
- **11)** w art. 13 w ust. 1: pkt 2 otrzymuje brzmienie: „
    - **a)**

- **2)** prowadzenie postępowań administracyjnych w pierwszej instancji, z zastrzeżeniem art. 14 ust. 3a; ” , pkt 5 otrzymuje brzmienie: „
    - **b)**
...
- **12)** w art. 14: w ust. 1 pkt 5 otrzymuje brzmienie: „
    - **a)**

- **5)** gromadzenie informacji o wynikach zleconych badań próbek, przeprowadzonych kontrolach wyrobów budowlanych wprowadzonych do obrotu lub udostępnianych na rynku krajowym, wydanych postanowieniach, decyzjach i opiniach; ” , w ust. 2 w pkt 3 kropkę zastępuje się średnikiem i dodaje się pkt 4 i 5 w brzmieniu: „
    - **b)**
...
- **5)** wydawać wojewódzkim inspektorom nadzoru budowlanego wytyczne i zalecenia, zapewniające jednolitość postępowań w sprawach wyrobów budowlanych. ” , po ust. 3 dodaje się ust. 3a w brzmieniu: „
    - **c)**

3a. Główny Inspektor Nadzoru Budowlanego może prowadzić postępowania administracyjne w pierwszej instancji na podstawie ustaleń dokonanych w wyniku kontroli. W takim przypadku wojewódzki inspektor nadzoru budowlanego nie wszczyna postępowania administracyjnego. ” , ust. 4 otrzymuje brzmienie: „
...
- **21)** w art. 26: ust. 1 otrzymuje brzmienie: „
    - **a)**

1. Właściwy organ może zlecić badanie pobranych próbek wyrobu budowlanego lub próbek kontrolnych akredytowanemu laboratorium, albo – w przypadku, gdy żadne laboratorium nie posiada akredytacji w zakresie kontrolowanego wyrobu budowlanego – laboratorium właściwej przedmiotowo jednostki oceny technicznej lub laboratorium właściwej przedmiotowo krajowej jednostki oceny technicznej. Badanie próbki kontrolnej przeprowadza się na wniosek kontrolowanego. ” , dodaje się ust. 7 w brzmieniu: „
...
- **22)** w art. 30: w ust. 1 pkt 1–3 otrzymują brzmienie: „
    - **a)**
...
- **3)** decyzję nakazującą wycofanie z obrotu wyrobu budowlanego przez sprzedawcę, jeżeli producent lub importer ma siedzibę poza terytorium Rzeczypospolitej Polskiej. ” , po ust. 1 dodaje się ust. 1a w brzmieniu: „
    - **b)**

1a. Na postanowienie, o którym mowa w ust. 1 pkt 1, przysługuje zażalenie. ” , ust. 2 otrzymuje brzmienie: „
...
- **23)** w art. 31: w ust. 1 pkt 1–3 otrzymują brzmienie: „
    - **a)**
...
- **3)** decyzję nakazującą ograniczenie udostępniania wyrobu budowlanego użytkownikowi, konsumentowi i sprzedawcy. ” , po ust. 1 dodaje się ust. 1a w brzmieniu: „
    - **b)**
...
- **24)** w art. 31a: ust. 1 otrzymuje brzmienie: „
    - **a)**

1. W decyzjach nakazujących wycofanie z obrotu wyrobu budowlanego, o których mowa w art. 30 ust. 1 pkt 2 i art. 31 ust. 1 pkt 2, właściwy organ może nakazać producentowi, importerowi lub sprzedawcy odkupienie wyrobu budowlanego na żądanie osób, które faktycznie nim władają. ” , dodaje się ust. 4 i 5 w brzmieniu: „
...
- **7)** w art. 81 w ust. 1 w pkt 1 lit. e otrzymuje brzmienie: „ stosowania przy wykonywaniu robót budowlanych wyrobów zgodnie z art. 10; ” ;
    - **e)**
...
2. Dotychczasowe przepisy wykonawcze wydane na podstawie w art. 7 ustawy wymienionej w art. 2 zachowują moc do dnia wejścia w życie nowych przepisów wykonawczych i mogą być zmieniane. Przepisów, o których mowa w art. 2 pkt 1 w brzmieniu nadanym niniejszą ustawą, nie stosuje się, jeżeli przed dniem wejścia w życie niniejszej ustawy:
