...
- **3)** w art. 3 w ust. 1:
    - **a)** pkt 2 otrzymuje brzmienie: „2) o dopuszczalnej masie całkowitej nieprzekraczającej 3,5 tony:
...
- **7)** w art. 7a:
    ...
    - **e)** w ust. 7 w pkt 5 kropkę zastępuje się średnikiem i dodaje się pkt 6 i 7 w brzmieniu: „6) dopuszczalną masę całkowitą;
...
- **7)** oświadczenie o wykorzystaniu pojazdu wyłącznie do transportu drogowego rzeczy pojazdem lub zespołem pojazdów o dopuszczalnej masie całkowitej nieprzekraczającej 3,5 tony, w przypadku gdy zgłoszonym pojazdem będzie wykonywany wyłącznie tego rodzaju transport.”,
    - **f)** dodaje się ust. 8 w brzmieniu: „8. Po uzyskaniu zezwolenia na wykonywanie zawodu przewoźnika drogowego przedsiębiorca przedkłada corocznie organowi, o którym mowa w art. 7 ust. 2, w terminie do dnia 31 marca roku następnego:
...
- **11)** art. 7e otrzymuje brzmienie: „Art. 7e. Przez środki rehabilitacyjne, o których mowa w art. 6 ust. 3 rozporządzenia (WE) nr 1071/2009, należy rozumieć:
...
- **14)** w art. 11a:
    - **a)** ust. 1 otrzymuje brzmienie: „1. Zabrania się przedsiębiorcy posiadającemu zezwolenie na wykonywanie zawodu przewoźnika drogowego lub licencję wspólnotową:
...
- **16)** w art. 16b:
    ...
    - **b)** po ust. 4 dodaje się ust. 4a–4c w brzmieniu: „4a. Warunkiem przywrócenia zarządzającemu transportem zdolności do kierowania operacjami transportowymi jest:
...
- **c)** dodaje się ust. 6 w brzmieniu: „6. Minister właściwy do spraw transportu określi, w drodze rozporządzenia:
...
- **21)** w art. 33:
    - **a)** ust. 6 otrzymuje brzmienie: „6. Wniosek o wydanie zaświadczenia, o którym mowa w ust. 1, zawiera:
...
- **28)** w art. 55 w ust. 1:
    ...
    - **b)** w pkt 6 kropkę zastępuje się średnikiem i dodaje się pkt 7 w brzmieniu: „7) żądania okazywania i badania dokumentów dotyczących głównej działalności przewoźnika drogowego, w tym:
...
- **32)** w art. 82h w ust. 1 w pkt 18 w lit. f kropkę zastępuje się średnikiem i dodaje się pkt 19–21 w brzmieniu: „19) liczbę osób zatrudnionych, o której mowa w art. 7a ust. 8 pkt 1, w tym liczbę kierowców;
...
- **37)** w art. 89:
    ...
    - **b)** dodaje się ust. 6 w brzmieniu: „6. Wydając rozporządzenie, o którym mowa w ust. 5, należy uwzględnić:
...
- **1)** w art. 2 pkt 7 otrzymuje brzmienie: „7) podróż służbowa – każde zadanie służbowe wykonywane w ramach krajowych przewozów drogowych polegające na wykonywaniu, na polecenie pracodawcy:
...
- **2)** art. 21 i art. 21a otrzymują brzmienie: „Art. 21. W przypadku gdy praca jest wykonywana w porze nocnej, czas pracy kierowcy nie może przekraczać 10 godzin między dwoma kolejnymi okresami dziennego odpoczynku albo dziennego i tygodniowego okresu odpoczynku.

**Art. 21a.** Kierowcy wykonującemu krajowe przewozy drogowe w podróży służbowej przysługują należności na pokrycie kosztów związanych z wykonywaniem tego zadania służbowego, ustalane na zasadach określonych w przepisach art. 77 § 3–5 ustawy z dnia 26 czerwca 1974 r. – Kodeks pracy.”;

- **3)** po art. 21a dodaje się art. 21b w brzmieniu: „Art. 21b. 1. Kierowca wykonujący zadania służbowe w ramach międzynarodowych przewozów drogowych nie jest w podróży służbowej w rozumieniu art. 77 § 1 ustawy z dnia 26 czerwca 1974 r. – Kodeks pracy.
...
- **5)** art. 25 otrzymuje brzmienie: „Art. 25. 1. Pracodawca prowadzi dla każdego kierowcy ewidencję czasu pracy do celów prawidłowego ustalenia jego wynagrodzenia i innych świadczeń związanych z pracą.
