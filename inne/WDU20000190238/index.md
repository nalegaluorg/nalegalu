...
- **2)** w art. 4 w ust. 1 wyrazy „art. 27a i art. 31d” zastępuje się wyrazami „art. 24a, art. 27a, art. 31a, art. 33g ust. 1 i 2 i art. 33p”;
- **3)** w art. 12a: po ust. 1 dodaje się ust. 1a w brzmieniu: „
    - **a)**

1a. Administracja rządowa i samorząd terytorialny współdziałają na zasadach partnerstwa, pomocniczości, profesjonalizmu, równego dostępu, jawności, efektywności ekonomicznej i jakości, z podmiotami, o których mowa w ust. 1. ” , ust. 2 otrzymuje brzmienie: „
...
- **5)** w art. 21: w ust. 1 wyrazy „oraz domach pomocy społecznej, w tym mieszkanie chronione” zastępuje się wyrazami „mieszkaniach chronionych oraz przez domy pomocy społecznej dla społeczności lokalnej”, po ust. 2 dodaje się ust. 3 w brzmieniu: „
    - **a)**
    - **b)**
...
- **8)** w art. 31b: w ust. 2 wyrazy „nie przekracza dwukrotnego dochodu określonego” zastępuje się wyrazami „przekracza dwukrotnie dochód ustalony” oraz po wyrazie „tytułów” dodaje się wyrazy „lub otrzymuje rentę albo emeryturę, z zastrzeżeniem ust. 8”, w ust. 6 w pkt 2 po wyrazie „okresowego” dodaje się wyrazy „chyba że legitymuje się w przypadku kobiet 20-letnim, a w przypadku mężczyzn 25-letnim okresem ubezpieczenia (składkowym i nieskładkowym)”, ust. 8 otrzymuje brzmienie: „
    - **a)**
    - **b)**
    - **c)**
...
- **23)** w art. 55: w ust. 1 po wyrazie „ustawie” dodaje się wyrazy „, z zastrzeżeniem ust. 2”, ust. 2 otrzymuje brzmienie: „
    - **a)**
    - **b)**
...
**Art. 4.** Minister właściwy do spraw zabezpieczenia społecznego ogłosi w Dzienniku Ustaw Rzeczypospolitej Polskiej jednolity tekst ustawy o pomocy społecznej z uwzględnieniem zmian wynikających z przepisów ogłoszonych przed dniem wydania jednolitego tekstu.
