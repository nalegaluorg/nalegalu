...
§ 5. 1. Rejestr jest prowadzony w postaci elektronicznej przy użyciu systemu teleinformatycznego. Integralną częścią rejestru jest zbiór dokumentów w postaci papierowej, otrzymanych od zarządzającego lotniskiem lub wytworzonych w postępowaniu o wpisanie lotniska do rejestru lotnisk.
...
§ 8. 1. Zakładający lotnisko lub zarządzający lotniskiem:
