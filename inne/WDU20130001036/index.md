...
| Pole | Wartość |
|---|---|
| Adres publikacyjny | Dz.U. 2013 poz. 1036 |
| ISAP | WDU20130001036 |
| Typ aktu | Ustawa |
| Status | obowiązujący |
| W mocy | tak |
...
| Źródło | [ISAP](https://isap.sejm.gov.pl/isap.nsf/DocDetails.xsp?id=WDU20130001036) · [PDF](https://api.sejm.gov.pl/eli/acts/DU/2013/1036/text.pdf) |
...
**Art. 3.** W zależności od zasad funkcjonowania systemu ten sam uczestnik może działać jako partner centralny, agent rozrachunkowy lub izba rozliczeniowa oraz realizować część lub całość ich zadań.
...
**Art. 11.** W razie ogłoszenia upadłości uczestnika systemu do jego praw i obowiązków związanych z uczestnictwem w systemie stosuje się przepisy prawa polskiego, z zastrzeżeniem art. 12.
...
**Art. 20.** Jeżeli podmiotem prowadzącym system jest spółka handlowa w rozumieniu Kodeksu spółek handlowych, na spółkę przejmującą lub spółkę nowo zawiązaną – powstałą w związku z połączeniem lub podziałem – nie przechodzi zgoda, o której mowa w art. 16.
...
1. Kto nie dopełnia obowiązku przekazania informacji, o którym mowa w art. 17 ust. 4, podlega grzywnie do 500 000 zł.
